...
define(function (require, exports, module) {
    ...
    function setupLivePreviewTests(livePreviewTestMode) {
        ...
        beforeAll(async function () {
            ...
            if (!testWindow) {
                ...
                if(livePreviewTestMode === CONSTANTS.LIVE_EDIT_MODE){
        ...
        async function endPreviewSession() {
            await _setLivePreviewMode(livePreviewTestMode);
        ...
        it("should live highlight css classes highlight all elements", async function () {
            if(livePreviewTestMode === CONSTANTS.LIVE_EDIT_MODE){
                // todo fixme! this should work in edit mode as well
                return;
            }
    ...
    exports.setupLivePreviewTests = setupLivePreviewTests;
});
