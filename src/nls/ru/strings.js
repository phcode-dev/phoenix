...
define({
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Чтобы улучшить {APP_NAME}, мы периодически отправляем ограниченную <strong>псевдонимную</strong> статистику в core.ai о том, как вы используете {APP_NAME}. Эта информация помогает определять приоритеты функций, находить ошибки и проблемы с удобством использования.</p><p> Ниже приведен предварительный просмотр данных, которые будут отправлены в вашем следующем отчете о работоспособности <em>, если</em> он включен.</p>",
