...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "Файл <code>package.json</code> не обнаружен в текущем проекте. Является ли текущий проект допустимым расширением {APP_NAME}?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "Файл <code>package.json</code> является недопустимым JSON.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "В <code>package.json</code> отсутствуют обязательные поля: [{0}]",
