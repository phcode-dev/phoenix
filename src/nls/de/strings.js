...
define({
  ...
  "DELETE_TO_TRASH": "{0} in den Papierkorb verschieben",
  "DELETE_TO_RECYCLE_BIN": "{0} in den Papierkorb verschieben",
  ...
  "DROP_TO_OPEN_FILES": "Zum Öffnen von Dateien ablegen",
  "DROP_TO_OPEN_FILE": "Zum Öffnen der Datei ablegen",
  "DROP_TO_OPEN_PROJECT": "Ablegen, um den Ordner `{0}` als Projekt zu öffnen",
  ...
  "ERROR_PREFS_RESET_TITLE": "Einstellungen zurücksetzen – Neustart erforderlich",
  ...
  "UNSUPPORTED_DOM_APIS_CONFIRM": "Die APIs „window.confirm“ und „window.prompt“ sind in der eingebetteten Livevorschau von {APP_NAME} nicht verfügbar. Bitte schließen Sie die Livevorschau, um diese APIs im Browser zu verwenden.",
  ...
  "LIVE_DEV_SETTINGS_BANNER": "Richten Sie einen benutzerdefinierten Server ein, um eine Live-Vorschau von ` <b>{0}</b> ` und anderen auf dem Server gerenderten Dateien (PHP, JSP usw.) anzuzeigen.",
  ...
  "CONFIRM_FILE_DELETE_TRASH": "Möchten Sie die Datei <span class='dialog-filename'>{0}</span> wirklich löschen?<br> Sie können diese Datei aus dem Papierkorb wiederherstellen.",
  "CONFIRM_FOLDER_DELETE_TRASH": "Möchten Sie den Ordner <span class='dialog-filename'>{0}</span> wirklich löschen?<br> Sie können diesen Ordner aus dem Papierkorb wiederherstellen.",
  "CONFIRM_FILE_DELETE_RECYCLE_BIN": "Möchten Sie die Datei <span class='dialog-filename'>{0}</span> wirklich löschen?<br> Sie können diese Datei aus dem Papierkorb wiederherstellen.",
  ...
  "KEYBOARD_SHORTCUT_PRESET_TOOLTIP": "Verwenden Sie Tastaturkürzel von Editoren wie VSCode, WebStorm oder Sublime Text",
  "KEYBOARD_SHORTCUT_PRESET_SELECT": "Tastenkombinationsvorgaben auswählen",
  "KEYBOARD_SHORTCUT_PRESET_USING": "Verwenden von {0}",
  "DEFAULT": "Standard",
  ...
  "STATUSBAR_AUTO_INDENT": "<span title=\"Klicken Sie hier, um zu festen Einzügen zu wechseln. Derzeit so eingestellt, dass Einzüge basierend auf der aktuellen Datei automatisch erkannt und angewendet werden.\">Auto</span>",
  "STATUSBAR_FIXED_INDENT": "<span title=\"Klicken Sie hier, um zur automatischen Einzugserkennung zu wechseln. Derzeit auf „Fester Einzug“ eingestellt.\">Behoben</span>",
  ...
  "SINGLE_ERROR_FIXABLE": "1 {0} Problem, {1} Behebbar - {2}",
  "MULTIPLE_ERRORS": "{0} {1} Probleme - {2}",
  "MULTIPLE_ERRORS_FIXABLE": "{0} {1} Probleme, {2} Behebbar - {3}",
  ...
  "CLICK_VIEW_PROBLEM": "Klicken Sie hier, um das Problem im Fenster anzuzeigen",
  "FILE_MENU": "Datei",
  ...
  "CMD_TOGGLE_INDENT_GUIDES": "Einzugshilfslinien",
  ...
  "CMD_GOTO_NEXT_PROBLEM": "Zum nächsten Problem",
  ...
  "CMD_ENABLE_DRAG_AND_DROP": "Dateien per Drag & Drop verschieben",
  ...
  "UPDATE_READY_RESTART_TITLE": "Starten Sie die App zum Aktualisieren neu",
  "UPDATE_READY_RESTART_INSTALL_MESSAGE": "{APP_NAME} wird automatisch aktualisiert, wenn Sie alle geöffneten Fenster schließen.",
  ...
  "UPDATE_FAILED_MESSAGE": "Bitte schließen Sie alle {APP_NAME}-Appfenster und öffnen Sie die Anwendung erneut, um das Update noch einmal zu versuchen.<br/> Sie können das Update auch installieren, indem Sie das Installationsprogramm von <a href='https://phcode.io'>phcode.io</a> herunterladen.",
  ...
  "EXTENSIONS_REGISTRY_TASK_TITLE": "Aktualisieren der Erweiterungsliste",
  "EXTENSIONS_REGISTRY_TASK_MESSAGE": "Wird heruntergeladen…",
  ...
  "JSHINT_CONFIG_JSON_ERROR": "Fehler: JSHint-Konfigurationsdatei `{0}` ist kein gültiges JSON",
  "ESLINT_NAME": "ESLint",
  "CSS_LINT_NAME": "{0}",
  "HTML_LINT_NAME": "HTML",
  ...
  "DESCRIPTION_ESLINT_FAILED": "ESLint ist fehlgeschlagen ({0}). Stellen Sie sicher, dass das Projekt gültige <a href='https://eslint.org/docs/latest/use/configure/configuration-files'>Konfigurationsdateien</a> enthält",
  "DESCRIPTION_ESLINT_USE_NATIVE_APP": "ESLint ist nur in der Desktop-App verfügbar. Laden Sie es von <a href='https://phcode.io'>phcode.io</a> herunter.",
  "DESCRIPTION_ESLINT_LOAD_FAILED": "ESLint konnte für dieses Projekt nicht geladen werden. {APP_NAME} unterstützt nur ESLint-Versionen über 7.",
  "DESCRIPTION_ESLINT_DO_NPM_INSTALL": "Bitte führen Sie `npm install` in Ihrem Projekt aus, um ESLint zu aktivieren",
  ...
  "DESCRIPTION_AUTO_TAB_SPACE": "True, um die in der aktuellen Datei verwendeten Tabulatoren und Leerzeichen automatisch zu erkennen",
  ...
  "DESCRIPTION_EDITOR_LINE_HEIGHT": "Passen Sie den vertikalen Abstand zwischen den Codezeilen im Editor an. Wählen Sie einen Wert zwischen 1 und 3, der Standardwert ist 1,5",
  ...
  "PUBLISH_CONSENT_MESSAGE": "Sehen Sie sich Änderungen schnell in der Vorschau an und teilen Sie Ihre Website mit anderen. {APP_NAME} kann diese Website für Sie unter {0} veröffentlichen. Die veröffentlichten Links sind 3 Tage lang gültig. </br>Möchten Sie Ihre Website veröffentlichen und teilen?",
  ...
  "ERROR_GIT_URL_INVALID": "Bitte geben Sie eine gültige Git-Klon-URL ein.",
  "ERROR_GIT_FOLDER_NOT_EMPTY": "Der ausgewählte Ordner kann nicht zum Git-Klonen verwendet werden, da er nicht leer oder nicht lesbar ist.",
  "ERROR_GIT_FOLDER_NOT_EXIST": "Der ausgewählte Ordner kann nicht zum Git-Klonen verwendet werden, da er nicht existiert.",
  "ERROR_CLONING_TITLE": "Git-Klon fehlgeschlagen",
  ...
  "DOWNLOAD_FAILED_MESSAGE": "Stellen Sie sicher, dass die Download-URL gültig ist. </br>NB: Da Phoenix kostenlos ist, sind Private Repos und GitHub-URLs, die größer als 25 MB sind, nicht zulässig.",
  ...
  "DEFAULT_PROJECT_HTML_CLICK_HERE": "Klicken Sie hier, um dieses &lt;span&gt; in der HTML-Datei zu finden",
  ...
  "ADD_ENDLINE_TO_THE_END_OF_FILE": "Fügen Sie am Ende der Datei eine Endzeile hinzu",
  "ADD_TO_GITIGNORE": "Zu .gitignore hinzufügen",
  "AMEND_COMMIT": "Letztes Commit ändern",
  "SKIP_COMMIT_CHECKS": "Vorab-Überprüfungen überspringen (--no-verify)",
  "AMEND_COMMIT_FORBIDDEN": "Commit kann nicht geändert werden, wenn keine ungepushten Commits vorhanden sind",
  "_ANOTHER_BRANCH": "ein weiterer Zweig",
  "AUTHOR": "Autor",
  "AUTHORS_OF": "Autoren von",
  "SYSTEM_CONFIGURATION": "Systemkonfiguration",
  "BRACKETS_GIT_ERROR": "Bei Git ist ein Fehler aufgetreten …",
  "BRANCH_NAME": "Filialname",
  "BUTTON_CANCEL": "Abbrechen",
  "CHECKOUT_COMMIT": "Kasse",
  "CHECKOUT_COMMIT_DETAIL": "<b>Commit-Nachricht:</b> {0}<br> <b>Commit-Hash:</b> {1}",
  "GIT_CLONE": "Klon",
  "BUTTON_CLOSE": "Schließen",
  "BUTTON_COMMIT": "Begehen",
  "BUTTON_DEFAULTS": "Standardeinstellungen wiederherstellen",
  "BUTTON_FIND_CONFLICTS": "Konflikte finden…",
  "GIT_INIT": "Hitze",
  "BUTTON_MERGE_ABORT": "Zusammenführung abbrechen",
  "BUTTON_OK": "OK",
  "BUTTON_REBASE_ABORT": "Abbrechen",
  "BUTTON_REBASE_CONTINUE": "Setzen Sie die Rebase fort",
  "BUTTON_REBASE_SKIP": "Überspringen",
  "MENU_RESET_HARD": "Änderungen und Commits danach verwerfen (Hard Reset)",
  "MENU_RESET_MIXED": "Commits danach verwerfen, aber Änderungen unstagiert lassen (gemischter Reset)",
  "MENU_RESET_SOFT": "Commits danach verwerfen, aber Änderungen beibehalten (Soft-Reset)",
  "MENU_TAG_COMMIT": "Tag Commit",
  "RESET_HARD_TITLE": "Hard Reset bestätigen",
  "RESET_MIXED_TITLE": "Gemischtes Zurücksetzen bestätigen",
  "RESET_SOFT_TITLE": "Soft-Reset bestätigen",
  "RESET_DETAIL": "<b>Commits nach Folgendem werden verworfen:</b><br> <b>Commit-Nachricht:</b> {0}<br> <b>Git-Befehl:</b> {1}",
  "RESET_HARD_MESSAGE": "Diese Aktion verwirft alle Änderungen und Commits nach dem ausgewählten Commit. <b>Dieser Vorgang kann nicht einfach rückgängig gemacht werden.</b> Möchten Sie wirklich fortfahren?<br><br> ⚠️ Warnung: Dadurch wird der Verlauf neu geschrieben und es sollte nicht für Commits verwendet werden, die in einen freigegebenen Branch gepusht wurden.",
  "RESET_MIXED_MESSAGE": "Diese Aktion verwirft alle Commits nach dem ausgewählten Commit, behält aber alle Änderungen bei. <b>Dieser Vorgang kann nicht einfach rückgängig gemacht werden.</b> Möchten Sie wirklich fortfahren?<br><br> ⚠️ Warnung: Dadurch wird der Verlauf neu geschrieben und es sollte nicht für Commits verwendet werden, die in einen freigegebenen Branch gepusht wurden.",
  "RESET_SOFT_MESSAGE": "Diese Aktion verwirft alle Commits nach dem ausgewählten Commit, behält aber alle Änderungen für ein neues Commit bei. <b>Dieser Vorgang kann nicht einfach rückgängig gemacht werden.</b> Möchten Sie wirklich fortfahren?<br><br> ⚠️ Warnung: Dadurch wird der Verlauf neu geschrieben und es sollte nicht für Commits verwendet werden, die in einen freigegebenen Branch gepusht wurden.",
  "BUTTON_SAVE": "Speichern",
  "RESET": "Zurücksetzen",
  "CHANGE_USER_EMAIL_TITLE": "Git-E-Mail ändern",
  "CHANGE_USER_EMAIL": "Git-E-Mail ändern …",
  "CHANGE_USER_EMAIL_MENU": "Git-E-Mail ändern ({0})…",
  ...
  "REQUIRES_APP_RESTART_SETTING": "Zum Ändern dieser Einstellung ist ein Neustart der App erforderlich.",
  "CLEAN_FILE_END": "Datei bereinigt",
  "CLEAN_FILE_START": "Reinigungsdatei",
  "CLEANING_WHITESPACE_PROGRESS": "Leerzeichen aus Dateien löschen …",
  "CLEAR_WHITESPACE_ON_FILE_SAVE": "Leerzeichen beim Speichern der Datei löschen",
  "CLONE_REPOSITORY": "Repository klonen",
  "CODE_INSPECTION_PROBLEMS": "Probleme bei der Codeinspektion",
  "CODE_INSPECTION_IN_PROGRESS": "Codeprüfung läuft …",
  "CODE_INSPECTION_PROBLEMS_NONE": "Keine Probleme erkannt",
  "CODE_INSPECTION_DONE_FILES": "{0} von {1} Dateien fertig…",
  "PLEASE_WAIT": "Bitte warten…",
  "COMMIT": "Begehen",
  "COMMIT_ALL_SHORTCUT": "Alle Dateien festschreiben…",
  "COMMIT_CURRENT_SHORTCUT": "Aktuelle Datei festschreiben…",
  "COMMIT_MESSAGE_PLACEHOLDER": "Geben Sie hier die Commit-Nachricht ein …",
  "CREATE_NEW_BRANCH": "Neuen Zweig erstellen…",
  "CREATE_NEW_BRANCH_TITLE": "Neuen Zweig anlegen",
  "CREATE_NEW_GITFTP_SCOPE": "Neues Git-FTP-Remote erstellen…",
  "CREATE_NEW_REMOTE": "Neue Fernbedienung erstellen…",
  "CURRENT_TRACKING_BRANCH": "Aktueller Tracking-Zweig",
  "_CURRENT_TRACKING_BRANCH": "aktueller Tracking-Zweig",
  "DEFAULT_GIT_TIMEOUT": "Standardmäßiges Timeout für Git-Vorgänge (in Sekunden)",
  "DELETE_FILE_BTN": "Datei löschen…",
  "DELETE_LOCAL_BRANCH": "Lokalen Zweig löschen",
  "DELETE_LOCAL_BRANCH_NAME": "Möchten Sie den lokalen Zweig \"{0}\" wirklich löschen?",
  "DELETE_REMOTE": "Fernbedienung löschen",
  "DELETE_REMOTE_NAME": "Möchten Sie den Remote-Speicherort \"{0}\" wirklich löschen?",
  "DELETE_SCOPE": "Git-FTP-Bereich löschen",
  "DELETE_SCOPE_NAME": "Möchten Sie den Git-FTP-Bereich „{0}“ wirklich löschen?",
  "DIALOG_CHECKOUT": "Beim Auschecken eines Commits wechselt das Repository in den Zustand DETACHED HEAD. Sie können keine Commits vornehmen, ohne einen darauf basierenden Branch zu erstellen.",
  "DIALOG_PULL_TITLE": "Von der Fernbedienung ziehen",
  "DIALOG_PUSH_TITLE": "Zur Fernbedienung übertragen",
  "SKIP_PRE_PUSH_CHECKS": "Pre-Push-Prüfungen überspringen (--no-verify)",
  "DIFF": "Unterschied",
  "DIFFTOOL": "Vergleichen mit Difftool",
  "DIFF_FAILED_SEE_FILES": "Git diff konnte keine Diff-Ergebnisse liefern. Dies ist die Liste der zu committenden Staging-Dateien:",
  "DIFF_TOO_LONG": "Diff ist zu lang zum Anzeigen",
  "ENABLE_GERRIT_PUSH_REF": "Gerrit-kompatiblen Push-Ref verwenden",
  "ENTER_NEW_USER_EMAIL": "E-Mail eingeben",
  "ENTER_NEW_USER_NAME": "Benutzernamen eingeben",
  "ENTER_PASSWORD": "Passwort eingeben:",
  "ENTER_REMOTE_GIT_URL": "Geben Sie die Git-URL des Repository ein, das Sie klonen möchten:",
  "ENTER_REMOTE_NAME": "Geben Sie den Namen der neuen Fernbedienung ein:",
  "ENTER_REMOTE_URL": "Geben Sie die URL der neuen Fernbedienung ein:",
  "ENTER_USERNAME": "Benutzernamen eingeben:",
  "ERROR_NOTHING_SELECTED": "Es ist nichts ausgewählt!",
  "ERROR_SAVE_FIRST": "Speichern Sie vorher das Dokument!",
  "ERROR_TERMINAL_NOT_FOUND": "Für Ihr Betriebssystem wurde kein Terminal gefunden. Sie können in den Einstellungen einen benutzerdefinierten Terminalbefehl definieren.",
  "EXTENDED_COMMIT_MESSAGE": "ERWEITERT",
  "GETTING_STAGED_DIFF_PROGRESS": "Diff der bereitgestellten Dateien abrufen …",
  "GIT_COMMIT": "Git-Commit…",
  "GIT_COMMIT_IN_PROGRESS": "Git-Commit in Bearbeitung",
  "GIT_DIFF": "Git-Diff –",
  ...
  "GOTO_NEXT_GIT_CHANGE": "Zur nächsten Git-Änderung gehen",
  "GOTO_PREVIOUS_GIT_CHANGE": "Zur vorherigen Git-Änderung gehen",
  "GUTTER_CLICK_DETAILS": "Klicken Sie hier für weitere Details",
  "HIDE_UNTRACKED": "Nicht verfolgte Dateien im Panel ausblenden",
  "HISTORY": "Geschichte",
  "HISTORY_COMMIT_BY": "von",
  "LINES": "Linien",
  "_LINES": "Linien",
  "MARK_MODIFIED_FILES_IN_TREE": "Geänderte Dateien im Dateibaum markieren",
  "MERGE_BRANCH": "Zweig zusammenführen",
  "MERGE_MESSAGE": "Nachricht zusammenführen",
  "MERGE_RESULT": "Zusammenführungsergebnis",
  "NORMALIZE_LINE_ENDINGS": "Zeilenenden normalisieren (auf \\n)",
  "NOTHING_TO_COMMIT": "Nichts zu committen, Arbeitsverzeichnis sauber.",
  "OPERATION_IN_PROGRESS_TITLE": "Git-Vorgang wird ausgeführt …",
  "ORIGIN_BRANCH": "Herkunftszweig",
  "ON_BRANCH": "'{0}' – Aktueller Git-Zweig",
  "PANEL_COMMAND": "Git-Panel anzeigen",
  "PASSWORD": "Passwort",
  "PASSWORDS": "Passwörter",
  "PATH_TO_GIT_EXECUTABLE": "Pfad zur ausführbaren Git-Datei",
  "PULL_AVOID_MERGING": "Vermeiden Sie manuelles Zusammenführen",
  "PULL_DEFAULT": "Standardmäßige Zusammenführung",
  "PULL_FROM": "Ziehen von",
  "PULL_MERGE_NOCOMMIT": "Zusammenführen ohne Commit",
  "PULL_REBASE": "Benutze den Fuchs",
  "PULL_RESET": "Verwenden Sie einen Soft-Reset",
  "PULL_SHORTCUT": "Von der Fernbedienung ziehen…",
  "PULL_SHORTCUT_BEHIND": "Von Remote abrufen ({0} dahinter)…",
  "PULL_BEHAVIOR": "Pull-Verhalten",
  "FETCH_SHORTCUT": "Von Remote abrufen",
  "PUSH_DEFAULT": "Standard-Push",
  "PUSH_DELETE_BRANCH": "Remote-Zweig löschen",
  "PUSH_SEND_TAGS": "Tags senden",
  "PUSH_FORCED": "Erzwungener Schub",
  "PUSH_SHORTCUT": "Auf Fernbedienung übertragen…",
  "PUSH_SHORTCUT_AHEAD": "Auf Remote-Gerät übertragen ({0} voraus)…",
  "PUSH_TO": "Drücken Sie auf",
  "PUSH_BEHAVIOR": "Push-Verhalten",
  "Q_UNDO_CHANGES": "Änderungen an Datei <span class='dialog-filename'>{0}</span> zurücksetzen?",
  "REBASE_RESULT": "Fox-Ergebnis",
  ...
  "RESET_LOCAL_REPO_CONFIRM": "Möchten Sie alle seit dem letzten Commit vorgenommenen Änderungen verwerfen? Diese Aktion kann nicht rückgängig gemacht werden.",
  "UNDO_LOCAL_COMMIT_CONFIRM": "Möchten Sie das letzte nicht gepushte Commit wirklich rückgängig machen?",
  "MORE_OPTIONS": "Weitere Optionen",
  "CREDENTIALS": "Qualifikationen",
  "SAVE_CREDENTIALS_HELP": "Sie müssen Benutzername und Passwort nicht eingeben, wenn Ihre Anmeldeinformationen woanders verwaltet werden. Verwenden Sie dies nur, wenn bei Ihrem Vorgang immer wieder eine Zeitüberschreitung auftritt.",
  "SAVE_CREDENTIALS_IN_URL": "Anmeldeinformationen unter Remote-URL speichern (im Klartext)",
  "SET_THIS_BRANCH_AS_TRACKING": "Diesen Zweig als neuen Tracking-Zweig festlegen",
  "STRIP_WHITESPACE_FROM_COMMITS": "Entfernen Sie nachstehende Leerzeichen aus Commits",
  "TARGET_BRANCH": "Zielzweig",
  "TITLE_CHECKOUT": "Zur Kasse gehen?",
  "TOOLTIP_CLONE": "Vorhandenes Repository klonen",
  "TOOLTIP_COMMIT": "Ausgewählte Dateien festschreiben",
  ...
  "TOOLTIP_MERGE_ABORT": "Brechen Sie den Zusammenführungsvorgang ab und setzen Sie HEAD auf das letzte lokale Commit zurück.",
  "TOOLTIP_PICK_REMOTE": "Bevorzugte Fernbedienung auswählen",
  "TOOLTIP_PULL": "Git-Pull",
  "TOOLTIP_PUSH": "Git-Push",
  "TOOLTIP_REBASE_ABORT": "Brechen Sie den Rebase-Vorgang ab und setzen Sie HEAD auf den ursprünglichen Zweig zurück.",
  "TOOLTIP_REBASE_CONTINUE": "Starten Sie den Rebasing-Prozess neu, nachdem Sie einen Merge-Konflikt gelöst haben",
  "TOOLTIP_REBASE_SKIP": "Starten Sie den Rebasing-Prozess neu, indem Sie den aktuellen Patch überspringen",
  "TOOLTIP_REFRESH_PANEL": "Bereich „Aktualisieren“",
  ...
  "UNDO_LAST_LOCAL_COMMIT": "Letztes lokales (nicht gepushtes) Commit rückgängig machen…",
  "UNDO_COMMIT": "Commit rückgängig machen",
  "URL": "URL",
  "USERNAME": "Benutzername",
  "USER_ABORTED": "Benutzer abgebrochen!",
  "USE_GIT_GUTTER": "Verwenden Sie Git-Randmarkierungen",
  "USE_NOFF": "Erstellen Sie ein Merge-Commit, auch wenn der Merge als Fast-Forward aufgelöst wird (--no-ff).",
  "USE_REBASE": "Verwenden Sie FOX",
  "USE_VERBOSE_DIFF": "Ausführliche Ausgabe in Diffs anzeigen",
  "USE_DIFFTOOL": "Verwenden Sie Difftool für Unterschiede",
  "VIEW_AUTHORS_FILE": "Autoren der Datei anzeigen…",
  "VIEW_AUTHORS_SELECTION": "Autoren der Auswahl anzeigen…",
  "VIEW_THIS_FILE": "Diese Datei ansehen",
  "TAG_NAME_PLACEHOLDER": "Geben Sie hier den Tag-Namen ein …",
  "TAG_NAME": "Etikett",
  "CMD_CLOSE_UNMODIFIED": "Unveränderte Dateien schließen",
  ...
  "FILE_STAGED": "Inszeniert",
  "FILE_UNMERGED": "Nicht zusammengeführt",
  "FILE_UNMODIFIED": "Unverändert",
  "FILE_UNTRACKED": "Nicht verfolgt",
  "GIT_PUSH_SUCCESS_MSG": "Erfolgreich den Schnellvorlauf vorangetrieben",
  "GIT_PUSH_FORCE_UPDATED_MSG": "Erfolgreiches erzwungenes Update",
  "GIT_PUSH_DELETED_MSG": "Referenz erfolgreich gelöscht",
  "GIT_PUSH_NEW_REF_MSG": "Erfolgreich neue Schiedsrichter gepusht",
  "GIT_PUSH_REJECTED_MSG": "Schiedsrichter wurde abgelehnt oder hat nicht gepusht",
  "GIT_PUSH_UP_TO_DATE_MSG": "Schiedsrichter war auf dem neuesten Stand und musste nicht gedrängt werden",
  ...
  "GIT_BRANCH_DELETE_SUCCESS": "Git-Zweig erfolgreich gelöscht",
  "INIT_NEW_REPO_FAILED": "Das neue Repository konnte nicht initialisiert werden",
  "GIT_CLONE_REMOTE_FAILED": "Das Klonen des Remote-Repository ist fehlgeschlagen!",
  "GIT_CLONE_ERROR_EXPLAIN": "Das ausgewählte Verzeichnis `{0}`\nist nicht leer. Git-Klon erfordert ein sauberes, leeres Verzeichnis.\nWenn es leer erscheint, suchen Sie nach versteckten Dateien.",
  "FOLDER_NOT_WRITABLE": "Das ausgewählte Verzeichnis `{0}`\nist nicht beschreibbar.",
  "GIT_NOT_FOUND_MESSAGE": "Git ist nicht installiert oder kann auf Ihrem System nicht gefunden werden. Bitte installieren Sie Git oder geben Sie im Textfeld unten den korrekten Pfad zur ausführbaren Git-Datei an.",
  "ERROR_GETTING_BRANCH_LIST": "Abrufen der Zweigstellenliste ist fehlgeschlagen",
  "ERROR_READING_GIT_HEAD": "Das Lesen der .git/HEAD-Datei ist fehlgeschlagen",
  "ERROR_PARSING_BRANCH_NAME": "Beim Parsen des Zweignamens von {0} ist ein Fehler aufgetreten.",
  "ERROR_READING_GIT_STATE": "Das Lesen des .git-Status ist fehlgeschlagen",
  "ERROR_GETTING_DELETED_FILES": "Abrufen der Liste gelöschter Dateien ist fehlgeschlagen",
  "ERROR_SWITCHING_BRANCHES": "Das Wechseln der Zweige ist fehlgeschlagen",
  "ERROR_GETTING_CURRENT_BRANCH": "Abrufen des aktuellen Zweigstellennamens ist fehlgeschlagen",
  "ERROR_REBASE_FAILED": "Rebase ist fehlgeschlagen",
  "ERROR_MERGE_FAILED": "Zusammenführung fehlgeschlagen",
  "ERROR_BRANCH_DELETE_FORCED": "Erzwungene Zweiglöschung fehlgeschlagen",
  "ERROR_FETCH_REMOTE_INFO": "Das Abrufen der Remote-Informationen ist fehlgeschlagen",
  "ERROR_CREATE_BRANCH": "Erstellen eines neuen Zweigs ist fehlgeschlagen",
  "ERROR_REFRESH_GUTTER": "Das Aktualisieren der Dachrinne ist fehlgeschlagen!",
  "ERROR_GET_HISTORY": "Verlauf konnte nicht abgerufen werden",
  "ERROR_GET_MORE_HISTORY": "Weitere Verlaufszeilen konnten nicht geladen werden",
  "ERROR_GET_CURRENT_BRANCH": "Aktueller Filialname konnte nicht abgerufen werden.",
  ...
  "ERROR_MODIFY_GITIGNORE": "Fehler beim Ändern von .gitignore",
  "ERROR_UNDO_LAST_COMMIT_FAILED": "Das letzte Commit kann nicht rückgängig gemacht werden",
  "ERROR_MODIFY_FILE_STATUS_FAILED": "Dateistatus konnte nicht geändert werden",
  "ERROR_CHANGE_USERNAME_FAILED": "Benutzername kann nicht geändert werden",
  "ERROR_CHANGE_EMAIL_FAILED": "Benutzer-E-Mail kann nicht geändert werden",
  "ERROR_TOGGLE_GERRIT_PUSH_REF_FAILED": "Gerrit-Push-Ref kann nicht umgeschaltet werden",
  "ERROR_RESET_LOCAL_REPO_FAILED": "Zurücksetzen des lokalen Repositorys fehlgeschlagen",
  "ERROR_CREATE_TAG": "Erstellen des Tags fehlgeschlagen",
  "ERROR_CODE_INSPECTION_FAILED": "CodeInspection.inspectFile konnte für die Datei nicht ausgeführt werden",
  ...
  "ERROR_GIT_BLAME_FAILED": "Git Blame ist fehlgeschlagen",
  "ERROR_GIT_DIFF_FAILED": "Git Diff ist fehlgeschlagen",
  "ERROR_DISCARD_CHANGES_FAILED": "Das Verwerfen von Änderungen an einer Datei ist fehlgeschlagen",
  "ERROR_COULD_NOT_RESOLVE_FILE": "Die Datei konnte nicht aufgelöst werden",
  "ERROR_MERGE_ABORT_FAILED": "Zusammenführungsabbruch fehlgeschlagen",
  "ERROR_MODIFIED_DIALOG_FILES": "Die Dateien, die Sie übermitteln wollten, wurden geändert, während der Übermittlungsdialog angezeigt wurde. Abbrechen der Übermittlung, da das Ergebnis anders wäre als das, was im Dialog angezeigt wurde.",
  "ERROR_GETTING_REMOTES": "Das Abrufen der Fernbedienungen ist fehlgeschlagen!",
  "ERROR_REMOTE_CREATION": "Remote-Erstellung ist fehlgeschlagen",
  "ERROR_PUSHING_REMOTE": "Pushen zur Remote-Verbindung ist fehlgeschlagen",
  "ERROR_PULLING_REMOTE": "Das Abrufen von der Fernbedienung ist fehlgeschlagen",
  "ERROR_PULLING_OPERATION": "Der Pullvorgang ist fehlgeschlagen",
  "ERROR_PUSHING_OPERATION": "Push-Vorgang fehlgeschlagen",
  "ERROR_NO_REMOTE_SELECTED": "Für {0} wurde keine Fernbedienung ausgewählt!",
  "ERROR_BRANCH_LIST": "Abrufen der Zweigstellenliste ist fehlgeschlagen",
  "ERROR_FETCH_REMOTE": "Das Abrufen der Remote-Informationen ist fehlgeschlagen"
});