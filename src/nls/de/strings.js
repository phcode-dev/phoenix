...
define({
  ...
  "DESCRIPTION_LIVEDEV_MAIN_HEADING": "Oh nein! Ihr aktueller Browser unterstützt die Live-Vorschau nicht.",
  "DESCRIPTION_LIVEDEV_MAIN_SPAN": "Für das beste Live-Vorschau-Erlebnis laden Sie unsere nativen Apps für Windows, Mac und Linux von {0} herunter.",
  "AI_CHAT_TOOL_READ_FILE_RANGE": "Lese Zeilen {1}-{2} aus {0}.",
  "AI_CHAT_TOOL_READ_FILE_FROM": "Lese {0} ab Zeile {1}.",
  "AI_CHAT_TOOL_APPLIED_DIRECTLY": "Direkt auf Festplatte angewendet · Diff nicht verfügbar",
  "AI_CHAT_TOOL_REJECTED": "Änderung abgelehnt — Datei nicht geändert",
  "AI_CHAT_TOOL_REJECTED_REASON": "Grund: {0}",
  "AI_CHAT_FILE_NOT_FOUND_TITLE": "Datei nicht gefunden",
  "AI_CHAT_FILE_NOT_FOUND_MSG": "Die Datei <span class=\"dialog-filename\">{0}</span> konnte nicht geöffnet werden. Sie wurde möglicherweise verschoben oder gelöscht.",
  ...
  "AI_CHAT_PLAN_WRITE_CONFIRM_BODY": "Claude möchte {0} bearbeiten. Sie befinden sich derzeit im Planungsmodus.",
  "AI_CHAT_PLAN_WRITE_ALLOW": "Zulassen & in den Bearbeitungsmodus wechseln",
  "AI_CHAT_PLAN_WRITE_STAY": "Im Planungsmodus bleiben",
  "AI_CHAT_PLAN_WRITE_ALLOWED": "In den Bearbeitungsmodus gewechselt",
  "AI_CHAT_PLAN_WRITE_STAYED": "Im Planungsmodus geblieben"
});