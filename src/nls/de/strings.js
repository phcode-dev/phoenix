...
define({
  ...
  "ENCODE_FILE_FAILED_ERR": "{APP_NAME} konnte den Inhalt einer Datei nicht codieren.",
  "DECODE_FILE_FAILED_ERR": "{APP_NAME} konnte den Inhalt einer Datei nicht dekodieren.",
  ...
  "ERROR_MOVING_FILE": "Beim Versuch, die {2} {<span class='dialog-filename'>0</span>} zu verschieben, ist ein Fehler aufgetreten. {1}",
  "ERROR_MOVING_NOT_IN_PROJECT": "Die Datei/der Ordner kann nicht verschoben werden, da sie nicht Teil des aktuellen Projekts sind.",
  ...
  "LIVE_DEV_CLICK_POPOUT": "Popout-Live-Vorschau in neuem Fenster",
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "Auf Seite „Vorschau lösen“ anheften",
  ...
  "WINDOW_UNLOAD_WARNING": "Möchten Sie wirklich zu einer anderen URL navigieren und Brackets verlassen?",
  "WINDOW_UNLOAD_WARNING_WITH_UNSAVED_CHANGES": "Sie haben ungespeicherte Änderungen! Möchten Sie wirklich zu einer anderen URL navigieren und Brackets verlassen?",
  "DONE": "Fertig",
  "OK": "OK",
  "CANCEL": "Abbrechen",
  ...
  "FIND_IN_FILES_INDEXING_PROGRESS": "{0} von {1} Dateien für die Sofortsuche werden indexiert...",
  ...
  "STATUSBAR_ENCODING_TOOLTIP": "Wählen Sie die Kodierung",
  ...
  "CMD_BEAUTIFY_CODE_ON_SAVE": "Code beim Speichern verschönern",
  "FIND_MENU": "Suchen",
  "CMD_FIND": "Suchen",
  ...
  "CMD_GOTO_DEFINITION_PROJECT": "Definition schnell im Projekt finden",
  ...
  "ABOUT": "Über",
  "CLOSE": "Schließen",
  "ABOUT_TEXT_LINE1": "Veröffentlichung {VERSION_MAJOR}. {VERSION_MINOR} {BUILD_TYPE} {VERSION}",
  "ABOUT_TEXT_BUILD_TIMESTAMP": "Build-Zeitstempel: ",
  "ABOUT_TEXT_LINE3": "Von uns verwendete Drittanbieter-Bibliotheken — <a href='https://github.com/phcode-dev/phoenix/tree/main/src/thirdparty/licences'>Lizenzen und Zuschreibungen</a>. ",
  ...
  "ABOUT_TEXT_LINE5": "Hergestellt mit ❤ und JavaScript von:",
  ...
  "CMD_ENABLE_LOGGING": "Detaillierte Logs aktivieren",
  ...
  "ERROR_TERN_FAILED": "Daten von Tern können nicht abgerufen werden",
  ...
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "In Variable extrahieren funktioniert nicht in Mehrkursoren",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "In Funktion extrahieren funktioniert nicht in Mehrkursoren",
  "EXTRACTTO_FUNCTION_SELECT_SCOPE": "Zielbereich wählen",
  "EXTRACTTO_VARIABLE_SELECT_EXPRESSION": "Wählen Sie einen Ausdruck",
  "CMD_REFACTORING_RENAME": "Umbenennen…",
  "CMD_REFACTORING_TRY_CATCH": "Einpacken versuchen Catch",
  "CMD_REFACTORING_CONDITION": "Zustand einwickeln",
  "CMD_REFACTORING_GETTERS_SETTERS": "Getters/Setter erstellen",
  "CMD_REFACTORING_ARROW_FUNCTION": "In Pfeilfunktion konvertieren",
  "DESCRIPTION_CODE_REFACTORING": "Aktivieren/Deaktivieren der JavaScript-Code-Refactoring",
  "ERROR_TRY_CATCH": "Wählen Sie einen gültigen Code zum Umschließen in einen Try-Catch-Block",
  "ERROR_WRAP_IN_CONDITION": "Wählen Sie einen gültigen Code zum Umschließen in einen Bedingungsblock",
  "ERROR_ARROW_FUNCTION": "Platzieren Sie den Cursor innerhalb eines Funktionsausdrucks",
  "ERROR_GETTERS_SETTERS": "Platzieren Sie den Cursor auf ein Element eines Objektausdrucks",
  "ERROR_RENAME_MULTICURSOR": "Kann bei Verwendung von mehreren Cursorn nicht umbenannt",
  "ERROR_RENAME_QUICKEDIT": "Dieser Bezeichner kann nicht umbenannt werden, da außerhalb dieser Funktion auf ihn verwiesen wird",
  "ERROR_RENAME_GENERAL": "Ausgewählter Text kann",
  "JSHINT_NAME": "JSHint",
  "CMD_ENABLE_QUICK_VIEW": "Schnelle Farbansicht",
  "CMD_ENABLE_SELECTION_VIEW": "Ansicht „Auswahl“",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "Ein Objekt mit den Standardoptionen für JSHint. Bitte beachten Sie die folgende URL für alle verfügbaren JSHint-Optionen: https://jshint.com/docs/options/",
  ...
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "false um Live Preview Reverse Inspect zu deaktivieren",
  "DOWNLOAD_FAILED": "Der Download ist fehlgeschlagen.",
  "DOWNLOAD_COMPLETE": "Der Download ist abgeschlossen!",
  "UPDATE_SUCCESSFUL": "Update erfolgreich!",
  "UPDATE_FAILED": "Update ist fehlgeschlagen!",
  "VALIDATION_FAILED": "Die Überprüfung ist fehlgeschlagen!",
  "INITIALISATION_FAILED": "Die Initialisierung ist fehlgeschlagen!",
  "CLEANUP_FAILED": "Säuberung ist fehlgeschlagen!",
  "WARNING_TYPE": "Warnung!",
  "CLICK_RESTART_TO_UPDATE": "Klicken Sie auf Neu starten, um Brackets",
  "UPDATE_ON_NEXT_LAUNCH": "Das Update wird beim Relaunch angewendet.",
  ...
  "UPDATEDIR_CLEAN_FAILED": "Das Aktualisierungsverzeichnis konnte nicht gereinigt werden.",
  "INITIAL_DOWNLOAD": "Update wird heruntergeladen...",
  "RETRY_DOWNLOAD": "Der Download ist fehlgeschlagen. Erneut versuchen... Versuch ",
  "VALIDATING_INSTALLER": "Der Download ist abgeschlossen! Das Installationsprogramm wird überprüft...",
  "CHECKSUM_DID_NOT_MATCH": "Die Prüfsumme stimmte nicht überein.",
  "INSTALLER_NOT_FOUND": "Installer wurde nicht gefunden.",
  "DOWNLOAD_ERROR": "Beim Herunterladen ist ein Fehler aufgetreten.",
  "NETWORK_SLOW_OR_DISCONNECTED": "Das Netzwerk ist getrennt oder zu langsam.",
  ...
  "AUTOUPDATE_IN_PROGRESS": "Ein Update ist bereits im Gange.",
  "NUMBER_WITH_PERCENTAGE": "{0}%",
  "CMD_FIND_RELATED_FILES": "Verwandte Dateien suchen",
  "PHP_VERSION_INVALID": "Fehler beim Analysieren der PHP-Version. Bitte überprüfen Sie die Ausgabe des Befehls „php —version“.",
  "PHP_UNSUPPORTED_VERSION": "Installieren Sie die PHP7-Laufzeit, um PHP-bezogene Tools wie Codehinweise, Parameterhinweise, Jump To Definition und mehr zu aktivieren. Version gefunden: {0}",
  "PHP_EXECUTABLE_NOT_FOUND": "PHP-Laufzeit wurde nicht gefunden. Installieren Sie die PHP7-Laufzeitumgebung und aktualisieren Sie „ExecutablePath“ in den PHP-Einstellungen entsprechend. Dies ermöglicht PHP-bezogene Tools wie Codehinweise, Parameterhinweise, Jump To Definition und mehr.",
  "PHP_PROCESS_SPAWN_ERROR": "Beim Starten des PHP-Prozesses ist ein Fehlercode {0} aufgetreten.",
  ...
  "DESCRIPTION_PHP_TOOLING_CONFIGURATION": "Standardeinstellungen für die PHP-Tooling-Konfiguration",
  ...
  "REFERENCE_IN_FILES": "referenzieren",
  ...
  "DESCRIPTION_EXTERNAL_APPLICATION_ASSOCIATE": "Zuordnungen für Dateierweiterungen zu externen Anwendungen. Syntax: \"<file_type>„: „<Default|ApplicationName|ApplicationPath>“, Verwenden Sie „default“, um Dateien in der Systemstandardanwendung für den Dateityp zu öffnen.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "Öffnen Sie Grafikdateien in externen Editoren.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "Ihr aktueller Ordner hat Grafikdateitypen, die von {APP_NAME} nicht unterstützt werden. <br/>Sie können jetzt bestimmte Dateitypen externen Editoren zuordnen. Nach der Verknüpfung können Sie Grafikdateien wie .xd, .psd, .jpg, .png, .ai, .svg in ihren Standardanwendungen öffnen, indem Sie auf die Dateien in der Dateistruktur doppelklicken. <br/><br/>Bitte klicken Sie auf 'Ok', um die Grafikdateitypen ihren jeweiligen Standardanwendungen zuzuordnen.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Die folgenden Dateitypen wurden erfolgreich mit Standardanwendungen verknüpft. <br/>{0} Sie haben die Möglichkeit, Ihre Einstellung zu ändern, ob Sie neue Dateitypzuordnungen in brackets.json löschen/hinzufügen, indem Sie zum Menü „Debug->Einstellungsdatei öffnen“ gehen.",
  ...
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "Phoenix befindet sich immer noch im experimentellen Alpha. Wir haben die Synchronisierung von Projekten mit mehr als 500 Dateien noch nicht aktiviert.",
  "SHARE_WEBSITE": "Website veröffentlichen und teilen?",
  "PUBLISH": "Veröffentlichen",
  "PUBLISH_CONSENT_MESSAGE": "Zeigen Sie schnell eine Vorschau der Änderungen an und teilen Sie Ihre Website für andere Phoenix kann diese Website für Sie unter {0} veröffentlichen. Die veröffentlichten Links sind für einen Zeitraum von 7 Tagen gültig. </br>Möchten Sie Ihre Website veröffentlichen und teilen?",
  "PUBLISH_SYNC_IN_PROGRESS": "Synchronisierung läuft für die Vorschau...",
  "PUBLISH_PAGE": "Hier klicken, um diese Seite zu veröffentlichen und zu teilen",
  "PUBLISH_VIEW_PAGE": "Zum Anzeigen der veröffentlichten Seite hier klicken",
  "MISSING_FIELDS": "Fehlende Felder",
  "PLEASE_FILL_ALL_REQUIRED": "Bitte füllen Sie alle rot markierten Pflichtfelder aus",
  "CODE_EDITOR": "Code-Editor",
  "BUILD_THE_WEB": "Das Web aufbauen",
  ...
  "DOWNLOAD_FAILED_MESSAGE": "Stellen Sie sicher, dass die Download-URL gültig ist. </br>NB: Da sich Phoenix in Alpha befindet, sind Private Repos- und Github-URLs, die größer als 25 MB sind, nicht zulässig.",
  "PLEASE_SELECT_A_FOLDER": "Bitte wählen Sie einen Ordner aus...",
  "UNZIP_IN_PROGRESS": "Dateien werden entpackt...",
  "UNZIP_FAILED": "Fehler: Das Entpacken ist fehlgeschlagen.",
  "CONFIRM_REPLACE_TITLE": "Bestätigen Sie das Ersetzen",
  "KEEP_BOTH": "Beides behalten",
  "EXPLORE": "HTML-Spiele",
  "BLOG": "Blog",
  ...
  "WEBPAGE_HOME_PAGE": "Layouts auf der Startseite",
  ...
  "BEAUTIFY_ERROR": "Code konnte nicht verschönert werden. Prüfen Sie Syntax.",
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Konnte nicht verschönern. Editortext wurde nach der Verschönerung geändert",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Datei {0} verschönern",
