...
define({
  ...
  "INCLUDE_FILE_FILTER": "{0} einschließen",
  "EXCLUDE_FILE_FILTER_DROPDOWN": "Ausschließen",
  "INCLUDE_FILE_FILTER_DROPDOWN": "Enthalten",
  "EDIT_FILE_FILTER": "Bearbeiten…",
  "FILE_FILTER_DIALOG": "Ausschlussfilter bearbeiten",
  "FILE_FILTER_INSTRUCTIONS": "Schließen Sie Dateien und Ordner aus, die einem der folgenden <a href='{0}' title=\"{0}\">Platzhalter zum Ignorieren</a> entsprechen. Geben Sie jede Zeichenfolge in einer neuen Zeile ein. Z.B<ul><li> <code>*.js</code> passt zu <code>a/b/x.js</code> , <code>xyx.js</code> usw.</li><li> <code>./*.css</code> stimmt nur <code>x.css</code> im Projektstamm überein, nicht jedoch <code>y/x.css</code> im Unterordner.</li></ul>",
  "FILE_FILTER_INSTRUCTIONS_INCLUDE": "Schließen Sie nur Dateien und Ordner ein, die einem der folgenden <a href='{0}' title=\"{0}\">Platzhalter zum Ignorieren</a> entsprechen. Geben Sie jede Zeichenfolge in einer neuen Zeile ein. Z.B<ul><li> <code>*.js</code> passt zu <code>a/b/x.js</code> , <code>xyx.js</code> usw.</li><li> <code>./*.css</code> stimmt nur <code>x.css</code> im Projektstamm überein, nicht jedoch <code>y/x.css</code> im Unterordner.</li></ul>",
  ...
  "CMD_HOMEPAGE": "{APP_NAME}-Startseite",
  ...
  "UPDATE_UP_TO_DATE": "Ihre Version von {APP_NAME} ist die neueste und beste!",
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "Um {APP_NAME} zu verbessern, senden wir regelmäßig begrenzte, <strong>pseudonyme</strong> Statistiken und Fehlerberichte darüber, wie Sie {APP_NAME} verwenden, an phcode.dev. Diese Informationen helfen dabei, Funktionen zu priorisieren, Fehler zu finden und Probleme mit der Benutzerfreundlichkeit zu erkennen, während gleichzeitig Ihre Privatsphäre geschützt wird.<br><br> Sie können Ihre Daten anzeigen oder Daten nicht teilen, indem Sie <strong>Hilfe &gt; Gesundheitsbericht</strong> auswählen.<br><br>",
  "HEALTH_DATA_PREVIEW": "{APP_NAME}-Statusbericht",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Um {APP_NAME} zu verbessern, senden wir regelmäßig begrenzte, <strong>pseudonyme</strong> Statistiken und Fehlerberichte darüber, wie Sie {APP_NAME} verwenden, an phcode.dev. Diese Informationen helfen dabei, Funktionen zu priorisieren, Fehler zu finden und Probleme mit der Benutzerfreundlichkeit zu erkennen.</p><p> Unten sehen Sie eine Vorschau der Daten, die in Ihrem nächsten Gesundheitsbericht gesendet werden, <em>wenn</em> er aktiviert ist. (Siehe auch die Entwicklerkonsole für Fehlerprotokolle, die mit „Caught Critical error“ gekennzeichnet sind.)</p>",
  ...
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>Safari löscht Website-Daten automatisch, wenn eine Website nicht innerhalb von 7 Tagen erneut besucht wird. {APP_NAME} ist zum Speichern Ihrer Projekte auf den Browserspeicher angewiesen, der aufgrund dieser Richtlinie möglicherweise entfernt wird.<br/><br/> <strong>Um Datenverlust zu vermeiden</strong> , laden Sie bitte Ihre Projekte <strong>herunter</strong> , bevor Sie die Registerkarte schließen , oder bleiben Sie dran für unsere <strong>kommenden Web - und nativen Mac / iOS - Apps</strong> .</span>",
