...
define({
  ...
  "DEVICE_SIZE_LIMIT_MESSAGE": "Phoenix Pro ermöglicht es Ihnen, Ihre Seite in den in Ihrem CSS definierten Bildschirmgrößen anzuzeigen.",
  "AI_CHAT_TITLE": "Claude Code",
  "AI_CHAT_CLI_NOT_FOUND": "Claude Code nicht installiert",
  "AI_CHAT_CLI_INSTALL_MSG": "Die Claude Code CLI muss auf Ihrem System installiert sein, um die KI-Funktionen in {APP_NAME} zu nutzen. <a class='ai-learn-more-link' href='#'>Mehr erfahren</a>",
  "AI_CHAT_CLI_INSTALL_BTN": "Claude Code installieren",
  "AI_CHAT_CLI_INSTALLING": "Wird installiert…",
  "AI_CHAT_CLI_INSTALLING_MSG": "Claude Code wird installiert, bitte warten Sie. Dies kann eine Weile dauern…",
