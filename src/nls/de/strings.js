...
define({
  ...
  "CMD_HOMEPAGE": "Startseite – Apps herunterladen",
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME} <strong>erhebt oder verarbeitet keine personenbezogenen Daten</strong> , <strong>sammelt jedoch anonyme Nutzungsstatistiken</strong> , um Ihre Privatsphäre zu schützen. Anonyme Daten sind von den DSGVO/CCPA-Meldepflichten ausgenommen, aber wir glauben, dass Sie die Möglichkeit haben müssen, die anonyme Datenerhebung abzulehnen.<br> Diese <strong>anonymen</strong> App-Nutzungsstatistiken und Fehlerberichte helfen dabei, Funktionen zu priorisieren, Fehler zu finden und Benutzerfreundlichkeitsprobleme für Ihr Erlebnis mit {APP_NAME} zu erkennen.</p><p> Nachfolgend finden Sie eine Vorschau der Daten, die in Ihrem nächsten Gesundheitsbericht gesendet werden <em>, sofern</em> diese Option aktiviert ist. (Siehe auch die Entwicklerkonsole für Fehlerprotokolle mit der Markierung „Kritischer Fehler erfasst“.)</p>",
  ...
  "NEW_PROJECT_NOTIFICATION": "Klicken Sie auf dieses Symbol, um ein neues Projekt zu erstellen.</br><img src=\"styles/images/new_project.png\"><br/> <a href='#' style='float:right;'>OK</a>",
  ...
  "POWER_USER_POPUP_TITLE": "Wie können wir {APP_NAME} für Sie verbessern?",
  "POWER_USER_POPUP_TEXT": "<div>Wir würden uns über Ihr Feedback freuen. Ihr Feedback hilft uns bei der Entscheidung, welche Funktionen wir entwickeln und welche Verbesserungen an unserer Plattform vorgenommen werden sollten.<br/> <a>Bitte füllen Sie diese kurze Umfrage aus.</a></div>",
