...
define({
  ...
  "LIVE_DEV_SELECT_FILE_TO_PREVIEW": "Izvēlēties tiešo priekšskatījumu",
  "LIVE_DEV_CLICK_TO_RELOAD_PAGE": "Pārlādēt lapu",
  "LIVE_DEV_CLICK_POPOUT": "Iznirstošais tiešais priekšskatījums uz jaunu logu",
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "Piespraust atspraust priekšskatījuma lappusē",
  ...
  "WINDOW_UNLOAD_WARNING": "Vai tiešām vēlaties pārvietoties uz citu URL un atstāt iekavās?",
  "WINDOW_UNLOAD_WARNING_WITH_UNSAVED_CHANGES": "Jums ir nesaglabātas izmaiņas! Vai tiešām vēlaties pārvietoties uz citu URL un atstāt iekavās?",
  "DONE": "Darīts",
  "OK": "Labi",
  "CANCEL": "Atcelt",
  ...
  "FILTER_NAME_REMAINING": "Atlikušās {0} rakstzīmes",
  ...
  "CMD_GOTO_DEFINITION_PROJECT": "Ātrās atrašanas definīcija projektā",
  ...
  "CMD_NAVIGATE_BACKWARD": "Virzīties atpakaļ",
  "CMD_NAVIGATE_FORWARD": "Pārvietoties uz priekšu",
  ...
  "CMD_HOMEPAGE": "{APP_NAME} Mājas lapa",
  ...
  "PRERELEASE_BUILD": "pirmsizlaides būvēt",
  ...
  "ABOUT": "Par",
  "CLOSE": "Aizvērt",
  "ABOUT_TEXT_LINE1": "Atlaidiet {VERSION_MAJOR}. {VERSION_MINOR} {BUILD_TYPE} {VERSIJA}",
  "ABOUT_TEXT_BUILD_TIMESTAMP": "veidot laikspiedolu: ",
  "ABOUT_TEXT_LINE3": "Trešo pušu bibliotēkas, kuras mēs izmantojam - <a href='https://github.com/phcode-dev/phoenix/tree/main/src/thirdparty/licences'> licences un attiecinājumi</a> . ",
  "ABOUT_TEXT_LINE4": "Dokumentācija un avots <a href='https://github.com/phcode-dev/phoenix/'>: https://github.com/phcode-dev/phoenix/</a>",
  "ABOUT_TEXT_LINE5": "Izgatavots ar ❤ un JavaScript:",
  "ABOUT_TEXT_LINE6": "Daudz cilvēku (bet mums ir problēmas ielādēt šos datus tieši tagad).",
  ...
  "SORT_EXTENSION_METHOD": "Paplašinājumu kārtošana, izmantojot DownloadCount vai PublishedD",
  "INVALID_ZIP_FILE": "Lejupielādētais saturs nav derīga zip datne.",
  "MISSING_PACKAGE_JSON": "Paketē nav iepakojuma.json faila.",
  ...
  "CMD_EXTRACTTO_VARIABLE": "Izraksts uz mainīgo",
  "CMD_EXTRACTTO_FUNCTION": "Izvērst uz funkciju",
  "ERROR_TERN_FAILED": "Nespēj iegūt datus no zīriņš",
  "ERROR_EXTRACTTO_VARIABLE_NOT_VALID": "Atlase neveido izteiksmi",
  "ERROR_EXTRACTTO_FUNCTION_NOT_VALID": "Atlasītajam blokam jāatspoguļo paziņojumu kopums vai izteiksme",
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "Izraksts uz mainīgo nedarbojas multikursoros",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "Izvēršana uz funkciju nedarbojas daudzkursoros",
  "EXTRACTTO_FUNCTION_SELECT_SCOPE": "Izvēlēties mērķa tvērumu",
  "EXTRACTTO_VARIABLE_SELECT_EXPRESSION": "Izvēlēties izteiksmi",
  "CMD_REFACTORING_RENAME": "Pārdēvēt",
  "CMD_REFACTORING_TRY_CATCH": "Iesaiņot mēģināt noķert",
  "CMD_REFACTORING_CONDITION": "Iesaiņot stāvoklī",
  "CMD_REFACTORING_GETTERS_SETTERS": "Izveidot getters/Setters",
  "CMD_REFACTORING_ARROW_FUNCTION": "Konvertēt par bultiņas funkciju",
  "DESCRIPTION_CODE_REFACTORING": "Iespējot/atspējot JavaScript koda refactoring",
  "ERROR_TRY_CATCH": "Atlasiet derīgu kodu, lai iesaiņotu Izvēlēties nozvejas bloku",
  "ERROR_WRAP_IN_CONDITION": "Atlasiet derīgu kodu, lai aplauztu nosacījumu blokā",
  "ERROR_ARROW_FUNCTION": "Novietot kursoru funkcijas izteiksmē",
  "ERROR_GETTERS_SETTERS": "Novietot kursoru pie objekta izteiksmes dalībnieka",
  "ERROR_RENAME_MULTICURSOR": "Nevar pārdēvēt, izmantojot vairākus kursorus",
  "ERROR_RENAME_QUICKEDIT": "Nevar pārdēvēt šo identifikatoru, jo tas ir norādīts citur ārpus šīs funkcijas",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "Objekts ar JShint noklusējuma opcijām. Lūdzu, skatiet šo URL visiem pieejamajiem JShint opcijas: https://jshint.com/docs/options/",
  ...
  "DESCRIPTION_LINEWISE_COPY_CUT": "Doing kopēt un samazināt, ja nav atlases kopēt vai samazināt visas līnijas, kas ir kursori tiem",
  "DESCRIPTION_INPUT_STYLE": "Atlasa veidu, kā CodeMirror apstrādā ievadi un fokusu. Tas var būt textarea, kas ir noklusējuma, vai apmierināms, kas ir labāks ekrāna lasītājiem (nestabils)",
  ...
  "DESCRIPTION_RECENT_FILES_NAV": "Iespējot/atspējot navigāciju pēdējos failos",
  "DESCRIPTION_LIVEDEV_WEBSOCKET_PORT": "Ports, kurā darbojas WebSocket serveris Live Preview",
  "DESCRIPTION_LIVE_DEV_HIGHLIGHT_SETTINGS": "Live Preview izcelšanas iestatījumi",
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "nepatiess, lai atspējotu tiešo priekšskatījumu apgrieztā",
  "DOWNLOAD_FAILED": "Lejupielāde neizdevās.",
  "DOWNLOAD_COMPLETE": "Lejupielādēt pabeigta!",
  "UPDATE_SUCCESSFUL": "Atjaunināt veiksmīgu!",
  ...
  "CLICK_RESTART_TO_UPDATE": "Noklikšķiniet uz Restartēt, lai atjauninātu iekavās.",
  "UPDATE_ON_NEXT_LAUNCH": "Atjauninājums tiks piemērots atsākšanas laikā.",
  "GO_TO_SITE": "Atveriet <a href = \"http://brackets.io/ “> brackets.io </a> , lai mēģinātu vēlreiz.",
  ...
  "INITIAL_DOWNLOAD": "Lejupielādē atjauninājumu...",
  "RETRY_DOWNLOAD": "Lejupielāde neizdevās. Mēģina vēlreiz... Mēģinājums ",
  "VALIDATING_INSTALLER": "Lejupielādēt pabeigta! Apstiprināšana Installer...",
  "CHECKSUM_DID_NOT_MATCH": "Kontrolsumma nesakrita.",
  "INSTALLER_NOT_FOUND": "Installer nav atrasts.",
  "DOWNLOAD_ERROR": "Lejupielādējot, radās kļūda.",
  "NETWORK_SLOW_OR_DISCONNECTED": "Tīkls ir atvienots vai pārāk lēns.",
  "RESTART_BUTTON": "Restartēt",
  "LATER_BUTTON": "Vēlāk",
  "DESCRIPTION_AUTO_UPDATE": "Iespējot/atspējot iekavās automātisko atjaunināšanu",
  "AUTOUPDATE_ERROR": "Kļūda!",
  "AUTOUPDATE_IN_PROGRESS": "Atjauninājums jau notiek.",
  "NUMBER_WITH_PERCENTAGE": "{0}%",
  "CMD_FIND_RELATED_FILES": "Atrast saistītos failus",
  "PHP_VERSION_INVALID": "Kļūda analizējot PHP versiju. Lūdzu, pārbaudiet komandas “php —version” izvadi.",
  "PHP_UNSUPPORTED_VERSION": "Instalējiet PHP7 izpildlaiku, lai iespējotu PHP saistītus rīkus, piemēram, koda padomus, Parametru padomus, Pārlēkt uz definīciju un daudz ko citu. Atrasta versija: {0}",
  "PHP_EXECUTABLE_NOT_FOUND": "PHP izpildlaiks nav atrasts. Instalējiet PHP7 izpildlaiku un atbilstoši atjauniniet “ExecutablePath” PHP Preferences. Tas iespējo PHP saistītus rīkus, piemēram, koda padomus, Parametru padomus, Pārlēkt uz definīciju un daudz ko citu.",
  "PHP_PROCESS_SPAWN_ERROR": "Kļūdas kods {0} radās, uzsākot PHP procesu.",
  ...
  "LANGUAGE_TOOLS_PREFERENCES": "Preferences valodu rīkiem",
  "FIND_ALL_REFERENCES": "Atrast visas atsauces",
  "REFERENCES_IN_FILES": "atsauces",
  "REFERENCE_IN_FILES": "atsauce",
  "REFERENCES_NO_RESULTS": "Pašreizējai kursora pozīcijai atsauces nav pieejamas",
  "CMD_FIND_DOCUMENT_SYMBOLS": "Atrast dokumenta simbolus",
  "CMD_FIND_PROJECT_SYMBOLS": "Atrast projekta simbolus",
  "REMOTE_DEBUGGING_ENABLED": "Localhost iespējota attālā atkļūdošana:",
  "REMOTE_DEBUGGING_PORT_INVALID": "Nevar iespējot attālo atkļūdošanu portā {0}. Portu skaitļiem jābūt starp {1} un {2}.",
  "DESCRIPTION_EXTERNAL_APPLICATION_ASSOCIATE": "Faila paplašinājuma kartējumi ārējām lietojumprogrammām. Sintakse: \"<file_type>“: “<default|ApplicationName|ApplicationPath>”, Izmantojiet “default”, lai atvērtu failus sistēmas noklusējuma lietojumprogrammā faila tipam.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "Atveriet grafiskos failus ārējos redaktoros.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "Jūsu pašreizējā mapē ir grafisko failu tipi, kurus neatbalsta {APP_NAME}. <br/>Tagadvarat saistīt noteiktus failu tipus ar ārējiem redaktoriem. Pēc saistīšanas varat atvērt grafiskos failus, piemēram, .xd, .psd, .jpg, .png, .ai, .svg to noklusējuma lietojumprogrammās, veicot dubultklikšķi uz failiem failu kokā. <br/><br/>Lūdzu, noklikšķiniet uz pogas “Ok”, lai saistītu grafisko failu tipus ar to attiecīgajām noklusējuma lietojumprogrammām.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Sekojošie failu tipi ir veiksmīgi saistīti ar noklusējuma lietojumprogrammām. <br/>{0} Jums ir iespēja mainīt savu izvēli par to, vai dzēst/pievienot jaunas failu tipa asociācijas iekavās.json, dodoties uz “Atkļūdošana->Open Preferences File” izvēlnē.",
  "UNSUPPORTED_BROWSER": "Pārlūks netiek atbalstīts",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Pārlūkprogramma neatbalsta Atvērt mapi",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Lūdzu, izmantojiet kādu no tālāk atbalstītajām pārlūkprogrammām.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Mēs cītīgi strādājam, lai padarītu Phoenix pieejamu vairākās pārlūkprogrammās. Jūs varat aizvērt šo dialogu, bet dažas funkcijas Phoenix nedarbosies šajā pārlūkprogrammā.",
  "CANNOT_PUBLISH_LARGE_PROJECT": "Nevar publicēt lielu projektu",
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "Phoenix joprojām ir eksperimentālā alfa. Mēs vēl neesam iespējojuši sinhronizāciju projektiem ar vairāk nekā 500 failiem.",
  "SHARE_WEBSITE": "Publicēt un kopīgot tīmekļa vietni?",
  "PUBLISH": "Publicēt",
  "PUBLISH_CONSENT_MESSAGE": "Ātri priekšskatiet izmaiņas un kopīgojiet savu vietni ar citiem. Phoenix var publicēt šo tīmekļa vietni, lai jūs pie {0}. Publicētās saites būs derīgas 7 dienas. </br>Vaivēlaties publicēt un dalīties ar savu tīmekļa vietni?",
  "PUBLISH_SYNC_IN_PROGRESS": "Notiek sinhronizācija priekšskatījumam...",
  "PUBLISH_PAGE": "Klikšķināt, lai publicētu un kopīgotu šo vietni",
  "PUBLISH_VIEW_PAGE": "Klikšķināt, lai skatītu publicēto lapu",
  "MISSING_FIELDS": "Trūkst lauki",
  "PLEASE_FILL_ALL_REQUIRED": "Lūdzu, aizpildiet visus obligātos laukus, kas izcelti sarkanā",
  ...
  "UNZIP_FAILED": "Kļūda: Izslēgšana neizdevās.",
  "CONFIRM_REPLACE_TITLE": "Apstiprināt Aizstāt",
  ...
  "BEAUTIFY_ERROR": "Neizdevās izdaiļot kodu. Pārbaudiet sintaksi.",
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Nevarēja izdaiļot. Redaktora teksts mainīts pēc skaistuma.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Skaistumkopšanas fails {0}",
  "BEAUTIFY_ERROR_SELECTION": "Nevarēja izdaiļot. </br>Nepilnīgskoda bloks izvēlēts vai nederīgs sintakse.",
  "BEAUTIFY_OPTIONS": "Opcijas, kas kontrolē, kā darbojas izdaiļot kodu",
  "BEAUTIFY_OPTION_PRINT_WIDTH": "Norādiet līnijas garumu, ko aptins beautifier",
  "BEAUTIFY_OPTION_SEMICOLON": "Semikola pievienošana katra paziņojuma beigās",
  "BEAUTIFY_OPTION_SINGLE_QUOTE": "Izmantojiet atsevišķas pēdiņas, nevis dubultās pēdiņas",
  "BEAUTIFY_OPTION_QUOTE_PROPS": "Mainīt, kad objektos tiek citēti rekvizīti",
  "BEAUTIFY_OPTION_BRACKET_SAME_LINE": "Ievietojiet vairākrindu HTML (HTML, JSX, Vue, Leņķveida) elementu pēdējās rindas beigās, nevis tikai nākamajā rindā (neattiecas uz pašaizvēršanās elementiem)",
  "BEAUTIFY_OPTION_SINGLE_ATTRIBUTE_PER_LINE": "Iedarbināt vienu atribūtu katrā rindā HTML, Vue un JSX",
  "BEAUTIFY_OPTION_PROSE_WRAP": "Aptiniet prozu, ja tas pārsniedz drukas platumu atzīmes failos",
  "BEAUTIFY_OPTION_PRINT_TRAILING_COMMAS": "Kad vien iespējams, drukāt beigu komatus vairākrindu ar komatu atdalītās sintaktiskās struktūrās"
});