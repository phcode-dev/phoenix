...
define({
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Lietotne {APP_NAME} <strong>neapkopo un neapstrādā nekādu personu identificējošu informāciju</strong> , bet <strong>apkopo anonīmu lietošanas statistiku</strong> , lai aizsargātu jūsu konfidencialitāti. Anonīmi dati ir atbrīvoti no GDPR/CCPA paziņošanas prasībām, taču mēs uzskatām, ka jums ir jābūt iespējai izvēlēties, kā pareizi atteikties no anonīmu datu vākšanas.<br> Šī <strong>anonīmā</strong> lietotņu lietojuma statistika un kļūdu pārskati palīdz noteikt funkcijām prioritāti, atrast kļūdas un noteikt lietojamības problēmas saistībā ar lietotni {APP_NAME}.</p><p> Tālāk ir sniegts to datu priekšskatījums, kas tiks nosūtīti nākamajā veselības pārskatā <em>, ja</em> tas ir iespējots. (Skatiet arī izstrādātāja konsoli, lai uzzinātu kļūdu žurnālus ar atzīmi “Pieķerta kritiska kļūda”.)</p>",
