...
define({
  ...
  "CMD_HOMEPAGE": "Pagina de pornire - Descărcați aplicații",
  ...
  "HEALTH_FIRST_POPUP_TITLE": "Raport de sănătate {APP_NAME}",
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME} <strong>nu colectează și nu prelucrează informații de identificare personală</strong> , dar <strong>colectează statistici de utilizare anonime</strong> pentru a vă proteja confidențialitatea. Datele anonime sunt scutite de cerințele de notificare GDPR/CCPA, dar credem că trebuie să aveți de ales să renunțați la colectarea datelor anonime.<br> Aceste statistici <strong>anonime</strong> de utilizare a aplicației și rapoarte de eroare ajută la prioritizarea funcțiilor, la găsirea erorilor și la identificarea problemelor de utilizare pentru experiența dvs. cu {APP_NAME}.</p><p> Mai jos este o previzualizare a datelor care vor fi trimise în următorul raport de sănătate <em>dacă</em> este activat. (Consultați și consola pentru dezvoltatori pentru jurnalele de erori marcate „Eroare critică prinsă”.)</p>",
  ...
  "NEW_PROJECT_NOTIFICATION": "Faceți clic pe această pictogramă pentru a crea un proiect nou.</br><img src=\"styles/images/new_project.png\"><br/> <a href='#' style='float:right;'>Bine</a>",
  ...
  "POWER_USER_POPUP_TITLE": "Cum putem îmbunătăți {APP_NAME} pentru tine?",
  "POWER_USER_POPUP_TEXT": "<div>Ne-ar plăcea să primim feedback-ul dvs. Feedbackul dvs. ne ajută să decidem ce caracteristici să construim și ce îmbunătățiri ar trebui aduse platformei noastre.<br/> <a>Vă rugăm să completați acest scurt sondaj.</a></div>",
