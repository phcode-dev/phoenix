...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "fișierul <code>package.json</code> nu a fost detectat în proiectul curent. Proiectul actual este o extensie {APP_NAME} validă?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "Fișierul <code>package.json</code> este JSON nevalid.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "Câmpuri obligatorii lipsesc în <code>package.json</code> : [{0}]",
