...
define({
  ...
  "ENCODE_FILE_FAILED_ERR": "{APP_NAME} nu a fost capabil de a codifica conținutul fișierului.",
  "DECODE_FILE_FAILED_ERR": "{APP_NAME} nu a fost capabil de a decoda conținutul fișierului.",
  "UNSUPPORTED_UTF16_ENCODING_ERR": "{APP_NAME} în prezent nu acceptă fișiere text codificate UTF-16.",
  ...
  "ERROR_RENAMING_NOT_IN_PROJECT": "Fișierul sau directorul nu face parte din proiectul deschis în prezent. Din păcate, numai fișierele de proiect pot fi redenumite în acest moment.",
  ...
  "ERROR_MOVING_NOT_IN_PROJECT": "Nu se poate muta fișierul/folderul, deoarece acestea nu fac parte din proiectul curent.",
  ...
  "ERROR_PROJ_PREFS_CORRUPT": "Fișierul dvs. de preferințe de proiect nu este valid JSON. Fișierul va fi deschis astfel încât să puteți corecta formatul. Va trebui să reîncărcați proiectul pentru ca modificările să aibă efect.",
  ...
  "LIVE_DEV_SELECT_FILE_TO_PREVIEW": "Selectați fișierul pentru a trăi Previzualizare",
  "LIVE_DEV_CLICK_TO_RELOAD_PAGE": "Reîncarcă pagina",
  "LIVE_DEV_CLICK_POPOUT": "Popout Live Preview la fereastră nouă",
  ...
  "WINDOW_UNLOAD_WARNING": "Sigur doriți să navigați la o altă adresă URL și să părăsiți Brackets?",
  "WINDOW_UNLOAD_WARNING_WITH_UNSAVED_CHANGES": "Ai modificări nesalvate! Sigur doriți să navigați la o altă adresă URL și să părăsiți Brackets?",
  "DONE": "Terminat",
  "OK": "OK",
  "CANCEL": "Revocare",
  "DONT_SAVE": "Nu salva",
  ...
  "FIND_HISTORY_MAX_COUNT": "Numărul maxim de elemente de căutare din istoricul căutărilor",
  ...
  "CMD_RECENT_FILES_OPEN": "Deschide recent...",
  ...
  "CMD_TOGGLE_LIVE_PREVIEW_MB_MODE": "Activați Previzualizare live experimentală",
  ...
  "CMD_TOGGLE_PANELS": "Comutați panourile",
  ...
  "CMD_THEMES": "Teme…",
  "CMD_TOGGLE_SEARCH_AUTOHIDE": "Închideți automat căutarea",
  ...
  "CMD_GOTO_DEFINITION_PROJECT": "Căutare rapidă definiție în proiect",
  ...
  "CMD_NEXT_DOC_LIST_ORDER": "Următorul document în listă",
  "CMD_PREV_DOC_LIST_ORDER": "Documentul anterior în listă",
  ...
  "CMD_SWITCH_PANE_FOCUS": "Focalizarea panoului de comutare",
  "CMD_OPEN_VFS": "Deschideți sistemul de fișiere virtuale",
  ...
  "CMD_HOMEPAGE": "{APP_NAME} Pagina de start",
  ...
  "PRERELEASE_BUILD": "construi pre-lansare",
  ...
  "ABOUT": "Despre",
  "CLOSE": "Închide",
  "ABOUT_TEXT_LINE1": "Eliberați {VERSION_MAJOR}. {VERSION_MINOR} {BUILD_TYPE} {VERSIUNE}",
  "ABOUT_TEXT_BUILD_TIMESTAMP": "construiți marcajul de timp: ",
  "ABOUT_TEXT_LINE3": "Biblioteci terțe părți pe care le folosim - <a href='https://github.com/phcode-dev/phoenix/tree/main/src/thirdparty/licences'> Licențe și Atribuții</a> . ",
  ...
  "FLIPVIEW_BTN_TOOLTIP": "Răsuciți această vizualizare în panoul {0}",
  ...
  "SORT_EXTENSION_METHOD": "Sortați extensiile utilizând DownloadCount sau PublishedDate",
  "INVALID_ZIP_FILE": "Conținutul descărcat nu e un fișier zip valid.",
  "MISSING_PACKAGE_JSON": "Pachetul nu are nici un fișier package.json.",
  ...
  "EXTENSION_MANAGER_DISABLE_ERROR": "Imposibil de dezactivat una sau mai multe extensii: {0}. {APP_NAME} va reîncărca în continuare.",
  ...
  "CMD_LAUNCH_SCRIPT_MAC": "Instalați comanda rapidă pentru linia de comandă",
  ...
  "CREATING_LAUNCH_SCRIPT_TITLE": "{APP_NAME} Comandă rapidă pentru linia de comandă",
  "ERROR_CREATING_LAUNCH_SCRIPT": "A apărut o eroare la instalarea comenzii rapide din linia de comandă. Încercați <a href='https://github.com/adobe/brackets/wiki/Command-Line-Arguments#troubleshooting'>aceste sugestii de depanare</a>. <br/><br/>Motiv: {0}",
  "ERROR_CLTOOLS_RMFAILED": "Imposibil de eliminat legătura simbolică existentă <code>/usr/local/bin/brackets</code> .",
  "ERROR_CLTOOLS_MKDIRFAILED": "Imposibil de creat directorul <code>/usr/local/bin</code> .",
  "ERROR_CLTOOLS_LNFAILED": "Imposibil de creat simbolul <code>/usr/local/bin/brackets</code> .",
  "ERROR_CLTOOLS_SERVFAILED": "Eroare internă.",
  "ERROR_CLTOOLS_NOTSUPPORTED": "Comanda rapidă a liniei de comandă nu este acceptată pe acest sistem de operare.",
  "LAUNCH_SCRIPT_CREATE_SUCCESS": "Succes! Acum puteți lansa cu ușurință {APP_NAME} din linia de comandă: <code>paranteze myFile.txt</code> pentru a deschide un fișier sau <code>paranteze MyFolder</code> pentru a comuta proiecte. <br/><br/><a href='https://github.com/adobe/brackets/wiki/Command-Line-Arguments'>Aflați mai multe</a> despre utilizarea {APP_NAME} din linia de comandă.",
  ...
  "HEALTH_FIRST_POPUP_TITLE": "{APP_NAME} Raport de sănătate",
  "HEALTH_DATA_DO_TRACK": "Distribuiți informații pseudonime despre modul în care folosesc {APP_NAME}",
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "Pentru a îmbunătăți {APP_NAME}, trimitem periodic statistici cu <strong>pseudonime</strong> limitate la core.ai despre modul în care utilizați {APP_NAME}. Aceste informații ajută la prioritizarea funcțiilor, la găsirea erorilor și la identificarea problemelor de utilizare în timp ce vă păzesc confidențialitatea. <br><br>Putețivedea datele dvs. sau puteți alege să nu partajați date selectând <strong>Ajutor > Raport de sănătate</strong>. <br><br>",
  "HEALTH_DATA_PREVIEW": "{APP_NAME} Raport de sănătate",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Pentrua îmbunătăți {APP_NAME}, trimitem periodic statistici cu <strong>pseudonime</strong> limitate la core.ai despre modul în care utilizați {APP_NAME}. Aceste informații ajută la prioritizarea funcțiilor, la găsirea erorilor și la identificarea problemelor de utilizare. </p><p>Maijos este o previzualizare a datelor care vor fi trimise în următorul raport de sănătate <em>dacă</em> este activat. </p>",
  ...
  "CMD_EXTRACTTO_VARIABLE": "Extrageți la variabilă",
  "CMD_EXTRACTTO_FUNCTION": "Extrageți în funcție",
  "ERROR_TERN_FAILED": "Imposibil de obținut date de la Tern",
  "ERROR_EXTRACTTO_VARIABLE_NOT_VALID": "Selecția nu formează o expresie",
  "ERROR_EXTRACTTO_FUNCTION_NOT_VALID": "Blocul selectat trebuie să reprezinte un set de declarații sau o expresie",
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "Extragerea la variabilă nu funcționează în multicursori",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "Extragerea în funcție nu funcționează în multicursori",
  ...
  "CMD_REFACTORING_TRY_CATCH": "Înfășurați încercați prinderea",
  "CMD_REFACTORING_CONDITION": "Înfășurați în stare",
  "CMD_REFACTORING_GETTERS_SETTERS": "Creați Getters/Setteri",
  "CMD_REFACTORING_ARROW_FUNCTION": "Conversia la funcția săgeată",
  "DESCRIPTION_CODE_REFACTORING": "Activați/dezactivați codul JavaScript Refactoring",
  "ERROR_TRY_CATCH": "Selectați codul valid pentru a încheia într-un bloc Try-catch",
  "ERROR_WRAP_IN_CONDITION": "Selectați codul valid pentru a înfășura într-un bloc de condiții",
  "ERROR_ARROW_FUNCTION": "Plasați cursorul în interiorul unei expresii de funcție",
  "ERROR_GETTERS_SETTERS": "Plasați cursorul la un membru al unei expresii obiect",
  "ERROR_RENAME_MULTICURSOR": "Nu se poate redenumi atunci când se utilizează multi-cursoare",
  ...
  "EXPAND_ALL": "Extindeți tot",
  "COLLAPSE_CURRENT": "Reduceți curentul",
  "EXPAND_CURRENT": "Expand curent",
  ...
  "DESCRIPTION_CLOSE_BRACKETS": "adevărat pentru a închide automat bretele, paranteze și paranteze",
  "DESCRIPTION_CLOSE_OTHERS_ABOVE": "false pentru a elimina „Închideți alții deasupra” din meniul contextual al fișierelor de lucru",
  "DESCRIPTION_CLOSE_OTHERS_BELOW": "false pentru a elimina „Închideți alții de mai jos” din meniul contextual al fișierelor de lucru",
  "DESCRIPTION_CLOSE_OTHERS": "false pentru a elimina „Închideți alții” din meniul contextual al fișierelor de lucru",
  "DESCRIPTION_CLOSE_TAGS": "Setează opţiunile de închidere a etichetelor",
  "DESCRIPTION_CLOSE_TAGS_DONT_CLOSE_TAGS": "O serie de etichete care nu ar trebui să fie închise automat",
  "DESCRIPTION_CLOSE_TAGS_WHEN_OPENING": "Închideți când este tastat > a etichetei de deschidere",
  "DESCRIPTION_CLOSE_TAGS_WHEN_CLOSING": "Închideți când este tastat/de etichetă de închidere",
  "DESCRIPTION_CLOSE_TAGS_INDENT_TAGS": "O serie de etichete care, atunci când sunt deschise, are o linie goală",
  "DESCRIPTION_CODE_FOLDING_ALWAY_USE_INDENT_FOLD": "adevărat pentru a genera întotdeauna markeri de secțiune pliabile atunci când schimbările de nivel liniuță",
  "DESCRIPTION_CODE_FOLDING_ENABLED": "adevărat pentru a permite plierea codului",
  "DESCRIPTION_CODE_FOLDING_HIDE_UNTIL_MOUSEOVER": "adevărat pentru a face markeri secţiune-colaps vizibile numai atunci când mutaţi mouse-ul peste jgheab",
  "DESCRIPTION_CODE_FOLDING_MAX_FOLD_LEVEL": "Limită câte niveluri adâncime Colaps Toate se aplică",
  "DESCRIPTION_CODE_FOLDING_MIN_FOLD_SIZE": "Liniile minime înainte de a apărea o pictogramă de secțiune pliabilă",
  "DESCRIPTION_CODE_FOLDING_SAVE_FOLD_STATES": "true să vă amintiți secțiunile restrânse dacă închideți și redeschideți un fișier sau un proiect",
  "DESCRIPTION_CODE_FOLDING_MAKE_SELECTIONS_FOLDABLE": "true pentru a permite plierea codului pe textul selectat în editor",
  "DESCRIPTION_DISABLED_DEFAULT_EXTENSIONS": "Extensiile implicite care sunt dezactivate",
  "DESCRIPTION_ATTR_HINTS": "Activarea/dezactivarea indicii atributelor HTML",
  "DESCRIPTION_CSS_PROP_HINTS": "Activarea/dezactivarea CSS/LESS/SCSS indicii de proprietate",
  "DESCRIPTION_JS_HINTS": "Activați/dezactivați indicii de cod JavaScript",
  "DESCRIPTION_JS_HINTS_TYPE_DETAILS": "Activați/dezactivați detaliile tipului de date în indicii de cod JavaScript",
  "DESCRIPTION_PREF_HINTS": "Activați/dezactivați indicii de cod Preferințe",
  "DESCRIPTION_SPECIAL_CHAR_HINTS": "Activați/dezactivați indicii entitate HTML",
  "DESCRIPTION_SVG_HINTS": "Activați/dezactivați indicii de cod SVG",
  "DESCRIPTION_HTML_TAG_HINTS": "Activați/dezactivați indicii tag-ul HTML",
  "DESCRIPTION_URL_CODE_HINTS": "Activați/dezactivați indicii URL în HTML & CSS/LESS/SCSS",
  ...
  "DESCRIPTION_HIGHLIGHT_MATCHES_SHOW_TOKEN": "Evidențiați toate șirurile care se potrivesc cu simbolul în care se află cursorul (nu este necesară selecția)",
  "DESCRIPTION_HIGHLIGHT_MATCHES_WORDS_ONLY": "Evidențiați numai atunci când selecția este un jeton complet",
  "DESCRIPTION_INSERT_HINT_ON_TAB": "true pentru a insera indiciul de cod selectat în prezent în fila",
  "DESCRIPTION_NO_HINTS_ON_DOT": "adevărat pentru a nu afișa automat indicii de cod JS atunci când. este tastat",
  "DESCRIPTION_JSLINT_OPTIONS": "Un obiect cu opţiunile implicite pentru JSLint",
  "DESCRIPTION_JSLINT_OPTIONS_ASS": "adevărat pentru a permite expresii de atribuire",
  "DESCRIPTION_JSLINT_OPTIONS_BITWISE": "adevărat pentru a permite operatorilor bitwise",
  "DESCRIPTION_JSLINT_OPTIONS_BROWSER": "true dacă globalele standard ale browserului ar trebui să fie predefinite",
  "DESCRIPTION_JSLINT_OPTIONS_CLOSURE": "adevărat pentru a permite idiomuri de închidere Google",
  "DESCRIPTION_JSLINT_OPTIONS_CONTINUE": "adevărat pentru a permite declarația „continua”",
  "DESCRIPTION_JSLINT_OPTIONS_COUCH": "true dacă globalele CouchDB ar trebui să fie predefinite",
  "DESCRIPTION_JSLINT_OPTIONS_DEBUG": "adevărat pentru a permite declarații de depanare",
  "DESCRIPTION_JSLINT_OPTIONS_DEVEL": "true dacă globalele browserului utile în dezvoltare ar trebui să fie predefinite",
  "DESCRIPTION_JSLINT_OPTIONS_EQEQ": "adevărat pentru a permite == și! =",
  "DESCRIPTION_JSLINT_OPTIONS_ES6": "true dacă globalele ES6 ar trebui să fie predefinite",
  "DESCRIPTION_JSLINT_OPTIONS_EVIL": "adevărat pentru a permite eval",
  "DESCRIPTION_JSLINT_OPTIONS_FORIN": "adevărat pentru a permite nefiltrate „pentru... în”",
  "DESCRIPTION_JSLINT_OPTIONS_INDENT": "Setați o lățime specifică a filei",
  "DESCRIPTION_JSLINT_OPTIONS_MAXERR": "Numărul maxim de avertismente raportate",
  "DESCRIPTION_JSLINT_OPTIONS_MAXLEN": "Numărul maxim de caractere dintr-o linie",
  "DESCRIPTION_JSLINT_OPTIONS_NEWCAP": "adevărat pentru a permite constructorilor necapitalizați",
  "DESCRIPTION_JSLINT_OPTIONS_NODE": "true dacă globalele Node.js ar trebui să fie predefinite",
  "DESCRIPTION_JSLINT_OPTIONS_NOMEN": "adevărat pentru a permite sublinierea în identificatori",
  "DESCRIPTION_JSLINT_OPTIONS_PASSFAIL": "adevărat pentru a opri la prima eroare",
  "DESCRIPTION_JSLINT_OPTIONS_PLUSPLUS": "fidel pentru a permite ++ și -",
  "DESCRIPTION_JSLINT_OPTIONS_REGEXP": "fidel pentru a permite. și [^...]. în RegExp",
  "DESCRIPTION_JSLINT_OPTIONS_RHINO": "true dacă globalele rinocerului ar trebui să fie predefinite",
  "DESCRIPTION_JSLINT_OPTIONS_SLOPPY": "adevărat pentru a permite lipsa `utilizați pragma strict`",
  "DESCRIPTION_JSLINT_OPTIONS_STUPID": "true dacă pot fi utilizate metode de blocare („... sincronizare”).",
  "DESCRIPTION_JSLINT_OPTIONS_SUB": "adevărat pentru a permite subscriptarea ineficientă",
  "DESCRIPTION_JSLINT_OPTIONS_TODO": "adevărat pentru a permite comentarii TODO",
  "DESCRIPTION_JSLINT_OPTIONS_UNPARAM": "true pentru a permite parametrii neutilizați",
  "DESCRIPTION_JSLINT_OPTIONS_VARS": "adevărat pentru a permite mai mult de 1 vars într-o funcție",
  "DESCRIPTION_JSLINT_OPTIONS_WHITE": "adevărat pentru a ignora regulile spațiului alb",
  "DESCRIPTION_LANGUAGE": "Setări specifice limbii",
  "DESCRIPTION_LANGUAGE_FILE_EXTENSIONS": "Mapări suplimentare de la extensia de fișier la numele limbii",
  "DESCRIPTION_LANGUAGE_FILE_NAMES": "Mapări suplimentare de la numele fișierului la numele limbii",
  "DESCRIPTION_LINEWISE_COPY_CUT": "Copierea și tăierea atunci când nu există nicio selecție va copia sau tăia liniile întregi care au cursoare în ele",
  "DESCRIPTION_INPUT_STYLE": "Selectează modul în care CodeMirror gestionează intrarea și focalizarea. Acesta poate fi textarea, care este implicit, sau conținut editabil, care este mai bine pentru cititoare de ecran (instabil)",
  "DESCRIPTION_LINTING_ENABLED": "true pentru a activa inspecția codului",
  "DESCRIPTION_ASYNC_TIMEOUT": "Timpul în milisecunde după care linters asincrone timp afară",
  "DESCRIPTION_LINTING_PREFER": "Matrice de linteri pentru a rula mai întâi",
  "DESCRIPTION_LIVE_DEV_MULTIBROWSER": "adevărat pentru a activa experimentale Live Preview",
  "DESCRIPTION_USE_PREFERED_ONLY": "adevărat pentru a rula furnizorii specificați în linting.prefer numai",
  "DESCRIPTION_MAX_CODE_HINTS": "Indicii maxime de cod afișate simultan",
  "DESCRIPTION_PATH": "Setări specifice traseului",
  ...
  "DESCRIPTION_SHOW_CURSOR_WHEN_SELECTING": "Menține cursorul intermitent vizibil atunci când aveți o selecție de text",
  "DESCRIPTION_SHOW_LINE_NUMBERS": "adevărat pentru a afișa numerele de linie într-un „jgheab” în stânga codului",
  "DESCRIPTION_SMART_INDENT": "Indentați automat la crearea unui bloc nou",
  "DESCRIPTION_SOFT_TABS": "false pentru a dezactiva comportamentul filelor moi",
  "DESCRIPTION_SORT_DIRECTORIES_FIRST": "true pentru a sorta directoarele mai întâi în arborele proiectului",
  "DESCRIPTION_SPACE_UNITS": "Numărul de spații de utilizat pentru indentare în funcție de spațiu",
  "DESCRIPTION_STATIC_SERVER_PORT": "Numărul portului pe care serverul încorporat ar trebui să îl utilizeze pentru Live Preview",
  "DESCRIPTION_STYLE_ACTIVE_LINE": "true pentru a evidenția culoarea de fundal a liniei pe care este activată cursorul",
  "DESCRIPTION_TAB_SIZE": "Numărul de spații de afișat pentru file",
  "DESCRIPTION_USE_TAB_CHAR": "true pentru a utiliza file în loc de spații",
  "DESCRIPTION_UPPERCASE_COLORS": "adevărat pentru a genera culori hex majuscule în Inline Color Editor",
  "DESCRIPTION_WORD_WRAP": "Înfășurați linii care depășesc lățimea portului de vizualizare",
  "DESCRIPTION_SEARCH_AUTOHIDE": "Închideți căutarea imediat ce editorul este focalizat",
  "DESCRIPTION_DETECTED_EXCLUSIONS": "O listă de fișiere care au fost detectate pentru a provoca Tern să rămână fără control",
  "DESCRIPTION_INFERENCE_TIMEOUT": "Cantitatea de timp după care Tern va timp când încearcă să înțeleagă fișierele",
  "DESCRIPTION_SHOW_ERRORS_IN_STATUS_BAR": "adevărat pentru a afișa erori în bara de stare",
  "DESCRIPTION_QUICK_VIEW_ENABLED": "true pentru a activa Quick View",
  "DESCRIPTION_EXTENSION_LESS_IMAGE_PREVIEW": "true pentru a afișa previzualizări de imagini pentru adresele URL lipsă extensii",
  "DESCRIPTION_THEME": "Selectați o temă {APP_NAME}",
  "DESCRIPTION_USE_THEME_SCROLLBARS": "adevărat pentru a permite bare de defilare personalizate",
  "DESCRIPTION_LINTING_COLLAPSED": "adevărat să se prăbușească panoul de linting",
  "DESCRIPTION_FONT_FAMILY": "Schimbă familia de fonturi",
  "DESCRIPTION_FONT_SIZE": "Schimbați dimensiunea fontului; de exemplu, 13px",
  "DESCRIPTION_FIND_IN_FILES_NODE": "true pentru a activa căutarea bazată pe noduri",
  "DESCRIPTION_FIND_IN_FILES_INSTANT": "adevărat pentru a activa căutarea instantanee",
  "DESCRIPTION_FONT_SMOOTHING": "Numai MAC: „subpixel-antialiased” pentru a permite antialiasing sub-pixel sau „antialiased” pentru antialiasing scară gri",
  ...
  "DESCRIPTION_OPEN_USER_PREFS_IN_SECOND_PANE": "fals pentru a deschide fișierul de preferințe ale utilizatorului în panoul stânga/superior",
  "DESCRIPTION_MERGE_PANES_WHEN_LAST_FILE_CLOSED": "true pentru a restrânge panourile după ce ultimul fișier din panou este închis prin butonul de închidere a antetului panoului",
  "DESCRIPTION_SHOW_PANE_HEADER_BUTTONS": "Comutați când să afișați butoanele de închidere și flip-view de pe antet.",
  "DEFAULT_PREFERENCES_JSON_HEADER_COMMENT": "/*\n * Acesta este un fișier numai în citire cu preferințele acceptate\n * de {APP_NAME}.\n * Utilizați acest fișier ca referință pentru a modifica preferințele\n * fişierul „brackets.json” deschis în celălalt panou.\n * Pentru mai multe informații despre modul de utilizare a preferințelor în interiorul\n * {APP_NAME}, consultați pagina web la https://github.com/adobe/brackets/wiki/How-to-Use-Brackets#preferences\n */",
  "DEFAULT_PREFERENCES_JSON_DEFAULT": "Implicit",
  "DESCRIPTION_PURE_CODING_SURFACE": "true pentru a activa modul numai cod și ascunde toate celelalte elemente UI în {APP_NAME}",
  "DESCRIPTION_INDENT_LINE_COMMENT": "adevărat pentru a permite indentarea comentariilor liniare",
  "DESCRIPTION_RECENT_FILES_NAV": "Activați/dezactivați navigarea în fișierele recente",
  "DESCRIPTION_LIVEDEV_WEBSOCKET_PORT": "Port pe care rulează WebSocket Server pentru Live Preview",
  "DESCRIPTION_LIVE_DEV_HIGHLIGHT_SETTINGS": "Previzualizare live Evidențiați",
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "false pentru a dezactiva previzualizare live inversa inspecta",
  "DOWNLOAD_FAILED": "Descărcarea a eșuat.",
  "DOWNLOAD_COMPLETE": "Descărcare completă!",
  "UPDATE_SUCCESSFUL": "Actualizați cu succes!",
  "UPDATE_FAILED": "Actualizarea a eșuat!",
  "VALIDATION_FAILED": "Validarea a eșuat!",
  "INITIALISATION_FAILED": "Inițializarea a eșuat!",
  "CLEANUP_FAILED": "Curățarea a eșuat!",
  "WARNING_TYPE": "Avertisment!",
  "CLICK_RESTART_TO_UPDATE": "Faceți clic pe Repornire pentru a actualiza parantezele.",
  "UPDATE_ON_NEXT_LAUNCH": "Actualizarea va fi aplicată la relansare.",
  "GO_TO_SITE": "Mergi la <a href = \"http://brackets.io/ „> brackets.io </a> pentru a reîncerca.",
  ...
  "RETRY_DOWNLOAD": "Descărcarea a eșuat. Retragerea... Încercare ",
  "VALIDATING_INSTALLER": "Descărcare completă! Validarea instalatorului...",
  "CHECKSUM_DID_NOT_MATCH": "Checksum nu s-a potrivit.",
  ...
  "RESTART_BUTTON": "Reporniți",
  "LATER_BUTTON": "Mai târziu",
  "DESCRIPTION_AUTO_UPDATE": "Activare/dezactivare Console Actualizare automată",
  ...
  "PHP_VERSION_INVALID": "Eroare la parsarea versiunii PHP. Vă rugăm să verificați ieșirea comenzii „php —version”.",
  "PHP_UNSUPPORTED_VERSION": "Instalați timpul de execuție PHP7 pentru activarea instrumentelor legate de PHP, cum ar fi Sugestii de cod, Indicii parametrilor, Salt la definiție și multe altele. Versiune gasita: {0}",
  "PHP_EXECUTABLE_NOT_FOUND": "Runtime PHP nu a fost găsit. Instalați runtime PHP7 și actualizați „ExecutablePath” în Preferințe PHP în mod corespunzător. Acest lucru permite instrumente legate de PHP, cum ar fi Sugestii de cod, Indicii parametrilor, Salt la definiție și multe altele.",
  "PHP_PROCESS_SPAWN_ERROR": "Codul de eroare {0} întâlnit la pornirea procesului PHP.",
  "PHP_SERVER_ERROR_TITLE": "Eroare",
  "PHP_SERVER_MEMORY_LIMIT_INVALID": "Limita de memorie pe care ați furnizat-o este nevalidă. Examinați preferințele PHP pentru a seta valoarea corectă.",
  "DESCRIPTION_PHP_TOOLING_CONFIGURATION": "Setările de configurare implicite PHP Tooling",
  "OPEN_PREFERENNCES": "Preferințe deschise",
  "LANGUAGE_TOOLS_PREFERENCES": "Preferințe pentru instrumentele lingvistice",
  ...
  "CMD_FIND_DOCUMENT_SYMBOLS": "Găsiți simbolurile documentului",
  "CMD_FIND_PROJECT_SYMBOLS": "Găsiți simbolurile proiectului",
  "REMOTE_DEBUGGING_ENABLED": "Depanare la distanță activată pe localhost:",
  "REMOTE_DEBUGGING_PORT_INVALID": "Nu se poate activa depanarea la distanță pe portul {0}. Numerele porturilor trebuie să fie între {1} și {2}.",
  "DESCRIPTION_EXTERNAL_APPLICATION_ASSOCIATE": "Mapings pentru extensia de fișier la aplicații externe. Sintaxă: \"<file_type>„: „<Default|ApplicationName|ApplicationPath>”, Utilizați „default” pentru a deschide fișiere în aplicația implicită de sistem pentru tipul de fișier.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "Deschideți fișiere grafice în editori externi.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "Dosarul curent are tipuri de fișiere grafice care nu sunt acceptate de {APP_NAME}. <br/>Acumputeți asocia anumite tipuri de fișiere cu editori externi. Odată asociat, puteți deschide fișiere grafice precum .xd, .psd, .jpg, .png, .ai, .svg în aplicațiile lor implicite făcând dublu clic pe fișierele din File Tree. <br/><br/>Vărugăm să faceți clic pe butonul „Ok” pentru a asocia tipurile de fișiere grafice cu aplicațiile implicite respective.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Următoarele tipuri de fișiere au fost asociate cu succes cu aplicațiile implicite. <br/>{0} Aveți opțiunea de a schimba preferința dacă ștergeți/adăugați noi asocieri de tipuri de fișiere în brackets.json accesând meniul „Debug->Deschidere fișier preferințe”.",
  "UNSUPPORTED_BROWSER": "Browserul nu este acceptat",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Browserul nu acceptă Deschideți folderul",
  ...
  "CANNOT_PUBLISH_LARGE_PROJECT": "Nu se poate publica proiect mare",
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "Phoenix este încă în alfa experimentală. Încă nu am activat sincronizarea proiectelor cu mai mult de 500 de fișiere.",
  "SHARE_WEBSITE": "Publicați și distribuiți site-ul web?",
  "PUBLISH": "Publicare",
  "PUBLISH_CONSENT_MESSAGE": "Previzualizați rapid modificările și partajați site-ul dvs. cu alții. Phoenix poate publica acest site web pentru tine la {0}. Linkurile publicate vor fi valabile pentru o perioadă de 7 zile. </br>Dorițisă publicați și să distribuiți site-ul dvs. web?",
  "PUBLISH_SYNC_IN_PROGRESS": "Sincronizare în curs de previzualizare...",
  ...
  "BUILD_THE_WEB": "Construiți web-ul",
  "IMPORT_PROJECT": "Proiect de import",
  ...
  "UNZIP_IN_PROGRESS": "Dezarhivarea fișierelor...",
  "UNZIP_FAILED": "Eroare: Dezarhivarea a eșuat.",
  "CONFIRM_REPLACE_TITLE": "Confirmați înlocuirea",
  ...
  "WEBPAGE_HOME_PAGE": "Prima pagină Aspecte",
