...
define({
  ...
  "WEBPAGE_HOME_PAGE": "Aspecte de pagină de pornire",
  "WEBPAGE_BLOG": "Pagina de blog",
  "WEBPAGE_DASHBOARD": "Tabloul de bord HTML",
  "WEBPAGE_BOOTSTRAP_EXAMPLES": "Exemple de bootstrap",
  "GUIDED_FILES_SIDEBAR": "Selectați un fișier HTML</br> <a href='#' style='float:right;'>O.K</a>",
  "GUIDED_LIVE_PREVIEW": "Efectuați câteva modificări de cod și salvați fișierul pentru a vedea previzualizarea.</br> <a href='#' style='float:right;'>O.K</a>",
