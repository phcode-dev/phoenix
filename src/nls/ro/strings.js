...
define({
  ...
  "CMD_ENABLE_SELECTION_VIEW": "Vizualizarea selecției",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "Un obiect cu opţiunile implicite pentru JSHint. Vă rugăm să consultați următoarea adresă URL pentru toate opțiunile disponibile JSHint: https://jshint.com/docs/options/",
  ...
  "EXTRACTING_FILES_PROGRESS": "Extragerea {0} a fișierelor {1}.",
  ...
  "BEAUTIFY_ERROR": "Nu s-a putut înfrumuseța codul. Verificați sintaxa.",
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Nu s-a putut înfrumuseța. Textul editorului sa schimbat după înfrumusețare.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Fișier de înfrumusețare {0}",
  "BEAUTIFY_ERROR_SELECTION": "Nu s-a putut înfrumuseța. </br>Blocde cod incomplet selectat sau sintaxă nevalidă.",
  "BEAUTIFY_OPTIONS": "Opțiuni care controlează modul în care funcționează Beautify Code",
  "BEAUTIFY_OPTION_PRINT_WIDTH": "Specificați lungimea liniei pe care o va înfășura înfrumusețatorul",
  "BEAUTIFY_OPTION_SEMICOLON": "Adăugați un punct și virgulă la sfârșitul fiecărei declarații",
  "BEAUTIFY_OPTION_SINGLE_QUOTE": "Utilizați citate simple în loc de ghilimele duble",
  "BEAUTIFY_OPTION_QUOTE_PROPS": "Modificați când proprietățile din obiecte sunt citate",
  "BEAUTIFY_OPTION_BRACKET_SAME_LINE": "Pune > a unui HTML multi-line (HTML, JSX, Vue, Angular) element de la sfârșitul ultimei linii în loc de a fi singur pe linia următoare (nu se aplică elementelor de auto-închidere)",
  "BEAUTIFY_OPTION_SINGLE_ATTRIBUTE_PER_LINE": "Aplicaţi un singur atribut pe linie în HTML, Vue şi JSX",
  "BEAUTIFY_OPTION_PROSE_WRAP": "Înfășurați proza dacă depășește lățimea de imprimare în fișierele de marcare",
  "BEAUTIFY_OPTION_PRINT_TRAILING_COMMAS": "Imprimați virgule finale ori de câte ori este posibil în structuri sintactice separate prin virgulă multi-linie"
});