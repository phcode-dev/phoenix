...
define({
  ...
  "NEW_PROJECT_FROM_GIT": "从 Git 新建项目",
  ...
  "LOCATION": "位置：",
  "ERROR_ONLY_GITHUB": "浏览器版本的 {APP_NAME} 仅支持 GitHub URL。要使用其他 Git URL，请使用桌面应用程序。",
  ...
  "MENU_RESET_HARD": "放弃此提交之后的所有更改和提交（硬重置）",
  "MENU_RESET_MIXED": "放弃此提交之后的所有提交，但保留未暂存的更改（混合重置）",
  "MENU_RESET_SOFT": "放弃此提交之后的所有提交，但保留已暂存的更改（软重置）",
  ...
  "RESET_HARD_MESSAGE": "此操作将丢弃所选提交之后的所有更改和提交。<b>此操作不易撤消。</b> 您确定要继续吗？<br><br>⚠️ 警告：此操作会重写历史记录，不应在已推送到共享分支的提交上使用。",
  "RESET_MIXED_MESSAGE": "此操作将丢弃所选提交之后的所有提交，但会将所有更改保留为未暂存状态。<b>此操作不易撤消。</b> 您确定要继续吗？<br><br>⚠️ 警告：此操作会重写历史记录，不应在已推送到共享分支的提交上使用。",
  "RESET_SOFT_MESSAGE": "此操作将丢弃所选提交之后的所有提交，但会将所有更改暂存以进行新的提交。<b>此操作不易撤消。</b> 您确定要继续吗？<br><br>⚠️ 警告：此操作会重写历史记录，不应在已推送到共享分支的提交上使用。",
  "BUTTON_SAVE": "保存",
  "RESET": "重置",
  ...
  "ENTER_REMOTE_NAME": "输入新的远程仓库名称：",
  "ENTER_REMOTE_URL": "输入新的远程仓库 URL：",
  ...
  "NOTHING_TO_COMMIT": "无需提交，工作目录无变更。",
  ...
  "PUSH_TO": "推送到",
  "PUSH_BEHAVIOR": "推送行为",
  "Q_UNDO_CHANGES": "重置对文件 <span class='dialog-filename'>{0}</span> 的更改？",
  "REBASE_RESULT": "变基结果",
  "REFRESH_GIT": "刷新 Git",
  "REMOVE_BOM": "移除文件的 BOM",
  ...
  "UNDO_LOCAL_COMMIT_CONFIRM": "您确定要撤消上次未推送的提交吗？",
  "MORE_OPTIONS": "更多选项",
  "CREDENTIALS": "凭据",
  ...
  "STRIP_WHITESPACE_FROM_COMMITS": "删除提交中的尾随空格",
  "TARGET_BRANCH": "目标分支",
  "TITLE_CHECKOUT": "检出提交？",
  ...
  "TOOLTIP_INIT": "初始化仓库",
  "TOOLTIP_MERGE_ABORT": "终止合并操作并将 HEAD 重置为上次本地提交",
  "TOOLTIP_PICK_REMOTE": "选择首选远程仓库",
  "TOOLTIP_PULL": "Git 拉取",
  "TOOLTIP_PUSH": "Git 推送",
  "TOOLTIP_REBASE_ABORT": "终止变基操作并将 HEAD 重置为原始分支",
  "TOOLTIP_REBASE_CONTINUE": "解决合并冲突后，重新启动变基过程",
  "TOOLTIP_REBASE_SKIP": "跳过当前补丁，重新启动变基过程",
  "TOOLTIP_REFRESH_PANEL": "刷新面板",
  "TOOLTIP_SHOW_FILE_HISTORY": "显示文件历史记录",
  "TOOLTIP_SHOW_HISTORY": "显示历史记录",
  "UNDO_CHANGES": "丢弃更改",
  "UNDO_CHANGES_BTN": "丢弃更改…",
  "UNDO_LAST_LOCAL_COMMIT": "撤回上次本地（未推送的）提交…",
  "UNDO_COMMIT": "撤销提交",
  "URL": "URL",
  "USERNAME": "用户名",
  "USER_ABORTED": "用户中止！",
  "USE_GIT_GUTTER": "使用 Git 沟槽标记",
  ...
  "GIT_PUSH_UP_TO_DATE_MSG": "引用已是最新的，无需推送",
  ...
  "ERROR_CANT_GET_STAGED_DIFF": "无法获取暂存文件的差异",
  ...
  "ERROR_MODIFIED_DIALOG_FILES": "您要提交的文件在提交对话框显示时被修改。由于结果与对话框中显示的不同，提交已中止。",
  ...
  "ERROR_NO_REMOTE_SELECTED": "未选择 {0} 的远程仓库！",
