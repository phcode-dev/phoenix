...
define({
  ...
  "COPYING": "复制{0}",
  "DELETING": "删除 {0}",
  "DELETE_TO_TRASH": "将 {0} 移至垃圾箱",
  "DELETE_TO_RECYCLE_BIN": "将 {0} 移至回收站",
  "RENAMING": "重命名",
  "STORED_IN_YOUR_BROWSER": "存储在您的浏览器中",
  "SUPPORT_US_OPEN_COLLECTIVE": "通过 GitHub 赞助商支持我们",
  "GENERIC_ERROR": "(错误 {0})",
  ...
  "ENCODE_FILE_FAILED_ERR": "{APP_NAME} 无法对文件内容进行编码。",
  ...
  "DROP_TO_OPEN_PROJECT": "拖放到打开文件夹“{0}”作为项目",
  ...
  "ERROR_PREFS_RESET_TITLE": "设置重置 - 需要重新启动",
  "ERROR_PREFS_PROJECT_LINT": "项目偏好",
  ...
  "ERROR_PREFS_CORRUPT_RESET": "您的 {APP_NAME} 设置已损坏并已重置。请重新启动 {APP_NAME} 以使更改生效。",
  ...
  "LIVE_DEV_STATUS_TIP_CONNECTED": "实时预览服务器处于活动状态",
  ...
  "LIVE_DEV_SETTINGS_BANNER": "设置自定义服务器以实时预览 ` <b>{0}</b> ` 和其他服务器呈现的文件（PHP、JSP 等）",
  "LIVE_DEV_SETTINGS_TITLE": "实时预览设置",
  "LIVE_DEV_SETTINGS_STARTUP": "启动时显示实时预览面板",
  "LIVE_DEV_SETTINGS_SERVER_PREFERENCE": "true 启用自定义开发服务器",
  "LIVE_DEV_SETTINGS_STARTUP_PREFERENCE": "true 在启动时显示实时预览面板",
  "LIVE_DEV_SETTINGS_HOT_RELOAD_PREFERENCE": "如果服务器支持热重载，则为 true，并在保存时禁用实时预览重载",
  "LIVE_DEV_SETTINGS_USE_SERVER": "对该项目使用自定义开发服务器",
  ...
  "LIVE_DEV_SETTINGS_SERVER_ROOT_PREF": "开发服务器提供服务的项目内的路径例如 www/ （默认为 /）",
  "LIVE_DEV_SETTINGS_RELOAD": "服务器支持热重载",
  "LIVE_DEV_SETTINGS_RELOAD_HELP": "一些服务器支持热重载，即将代码更改推送到页面而无需重新加载整个页面。\n如果您不希望 {APP_NAME} 在每次保存时都重新加载页面，请启用此功能。",
  ...
  "CONFIRM_FILE_DELETE_TRASH": "您确实要删除文件<span class='dialog-filename'>{0}</span>吗？<br>您可以从垃圾箱中恢复此文件。",
  "CONFIRM_FOLDER_DELETE_TRASH": "您确实要删除文件夹<span class='dialog-filename'>{0}</span>吗？<br>您可以从垃圾箱中恢复该文件夹。",
  "CONFIRM_FILE_DELETE_RECYCLE_BIN": "您确实要删除文件<span class='dialog-filename'>{0}</span>吗？<br>您可以从回收站恢复该文件。",
  "CONFIRM_FOLDER_DELETE_RECYCLE_BIN": "您确实要删除文件夹<span class='dialog-filename'>{0}</span>吗？<br>您可以从回收站恢复该文件夹。",
  "MOVE_TO_TRASH": "移到废纸篓",
  ...
  "EXT_ALWAYS_MODIFIED_BUTTON_TOOLTIP": "始终覆盖文件，直到项目切换或重新启动",
  "WINDOW_UNLOAD_WARNING": "您确定要导航到其他网址并离开“{APP_NAME}”吗？",
  "WINDOW_UNLOAD_WARNING_WITH_UNSAVED_CHANGES": "您有未保存的更改！您确定要导航到其他网址并离开“{APP_NAME}”吗？",
  "DONE": "完成",
  "OK": "确认",
  "CANCEL": "取消",
  "DONT_SAVE": "不要保存",
  ...
  "FIND_HISTORY_MAX_COUNT": "搜索历史中的最大搜索项数",
  ...
  "FIND_IN_FILES_SEARCHING_IN": "在{0}",
  "FIND_IN_FILES_INDEXING_PROGRESS": "为即时搜索编入 {0} 个文件（共 {1} 个）...",
  ...
  "FILTER_PLACEHOLDER": "例如索引,.css,*.js,src/**/*.css",
  "FILTER_HISTORY_TOOLTIP": "按“Ctrl-空格键”查看历史记录。",
  "FILTER_HISTORY_TOOLTIP_MAC": "按“Cmd-Space”查看历史记录。",
  "FIND_HISTORY_TOOLTIP": "按“Ctrl-空格键”查看历史记录。",
  ...
  "KEYBOARD_OVERLAY_TEXT": "使用箭头进行导航，或通过键入来选择 UI 元素。",
  "KEYBOARD_SHORTCUT_CHANGE_TITLE": "更改键盘快捷键...",
  "KEYBOARD_SHORTCUT_CHANGE_DIALOG_TITLE": "更改键盘快捷键",
  "KEYBOARD_SHORTCUT_CHANGE_DIALOG_TEXT": "按<b>“{0}”</b>的新组合键（当前： <b>{1}</b> ）",
  "KEYBOARD_SHORTCUT_CHANGE_DIALOG_DUPLICATE": "警告：组合键<b>{0}</b>已分配给<b>“{1}”</b> 。重新分配给<b>“{2}”</b> ？",
  "KEYBOARD_SHORTCUT_ASSIGN": "分配",
  "KEYBOARD_SHORTCUT_NONE": "没有任何",
  "KEYBOARD_SHORTCUT_MENU_SHOW_SHORTCUTS": "键盘快捷键…",
  "KEYBOARD_SHORTCUT_MENU_SHOW_SHORTCUTS_BUTTON": "显示所有快捷方式...",
  "KEYBOARD_SHORTCUT_TABLE_BASE_KEY": "基本键",
  "KEYBOARD_SHORTCUT_TABLE_KEY_BINDING": "捷径",
  "KEYBOARD_SHORTCUT_TABLE_COMMAND_ID": "命令ID",
  "KEYBOARD_SHORTCUT_TABLE_COMMAND_NAME": "命令",
  "KEYBOARD_SHORTCUT_TABLE_DOUBLE_CLICK": "双击更改快捷方式",
  "KEYBOARD_SHORTCUT_TABLE_ORIGIN": "起源",
  "KEYBOARD_SHORTCUT_ORIG_EXTENSION": "扩大",
  "KEYBOARD_SHORTCUT_PANEL_TITLE": "键盘快捷键",
  "KEYBOARD_SHORTCUT_PRESET_TOOLTIP": "使用 VSCode、WebStorm 或 Sublime Text 等编辑器的键盘快捷键",
  "KEYBOARD_SHORTCUT_PRESET_SELECT": "选择快捷键预设",
  "KEYBOARD_SHORTCUT_PRESET_USING": "使用 {0}",
  "DEFAULT": "默认",
  "KEYBOARD_SHORTCUT_PANEL_FILTER": "过滤器…",
  "KEYBOARD_SHORTCUT_PANEL_RESET": "重置…",
  "KEYBOARD_SHORTCUT_PANEL_RESET_DEFAULT": "重置为默认快捷方式...",
  "KEYBOARD_SHORTCUT_RESET_DIALOG_TITLE": "重置键盘快捷键",
  "KEYBOARD_SHORTCUT_RESET_DIALOG_MESSAGE": "将所有自定义快捷方式重置为默认值？这不能被撤消。",
  ...
  "STATUSBAR_SELECTION_MULTIPLE": "— {0} 多个光标选择",
  ...
  "STATUSBAR_AUTO_INDENT": "<span title=\"单击可切换到固定缩进。当前设置为根据当前文件自动检测并应用缩进。\">汽车</span>",
  "STATUSBAR_FIXED_INDENT": "<span title=\"单击可切换到自动缩进检测。当前设置为固定缩进。\">固定的</span>",
  ...
  "STATUSBAR_TASKS_HIDE_SPINNER": "隐藏微调器图标",
  "STATUSBAR_TASKS_UNKNOWN_EXTENSION_TASK": "未知的扩展任务...",
  "STATUSBAR_TASKS_PLAY": "开始或继续",
  "STATUSBAR_TASKS_PAUSE": "暂停",
  "STATUSBAR_TASKS_STOP": "停止",
  "STATUSBAR_TASKS_RESTART": "重新开始",
  "ERRORS_NO_FILE": "没有打开文件",
  "ERRORS_PANEL_TITLE_MULTIPLE": "{0} 问题 - {1}",
  "ERRORS_PANEL_TITLE_MULTIPLE_FIXABLE": "{0} 个问题，{1} 可修复 - {2}",
  "SINGLE_ERROR": "1 {0} 问题 - {1}",
  "SINGLE_ERROR_FIXABLE": "1 {0} 个问题，{1} 个可修复 - {2}",
  "MULTIPLE_ERRORS": "{0} {1} 问题 - {2}",
  "MULTIPLE_ERRORS_FIXABLE": "{0} {1} 问题，{2} 可修复 - {3}",
  ...
  "CLICK_VIEW_PROBLEM": "单击查看面板中的问题",
  "FILE_MENU": "文件",
  "CMD_FILE_NEW_UNTITLED": "新建",
  "CMD_FILE_NEW": "新建文件",
  "CMD_FILE_DUPLICATE": "创建副本",
  "CMD_FILE_DUPLICATE_FILE": "重复文件",
  ...
  "CMD_FILE_SHOW_FOLDERS_FIRST": "首先对文件夹进行排序",
  "CMD_QUIT": "退出",
  "CMD_OPEN_IN": "打开方式",
  "CMD_EXIT": "退出",
  "EDIT_MENU": "编辑",
  ...
  "CMD_FIND_ALL_AND_SELECT": "选择所有出现的情况",
  "CMD_ADD_NEXT_MATCH": "添加下一个出现",
  "CMD_SKIP_CURRENT_MATCH": "跳过并添加下一个出现的位置",
  ...
  "CMD_QUICK_EDIT_NEXT_MATCH": "下一个快速编辑项目",
  ...
  "CMD_SHOW_IN_EXPLORER": "Windows 文件资源管理器",
  "CMD_SHOW_IN_FINDER": "macOS 查找器",
  "CMD_SHOW_IN_FILE_MANAGER": "文件管理器",
  "CMD_OPEN_IN_CMD": "命令提示符",
  "CMD_OPEN_IN_POWER_SHELL": "PowerShell",
  "CMD_OPEN_IN_DEFAULT_APP": "系统默认应用程序",
  ...
  "ABOUT": "关于",
  "CLOSE": "关闭",
  "ABOUT_TEXT_LINE1": "发布 {VERSION_MAJOR}。{VERSION_MINOR} {BUILD_TYPE} {VERSION}",
  "ABOUT_TEXT_BUILD_TIMESTAMP": "构建时间戳：",
  "ABOUT_RELEASE_CREDITS": "发行信息：",
  "ABOUT_TEXT_LINE3": "我们使用的第三方库 -<a href='https://github.com/phcode-dev/phoenix/tree/main/src/thirdparty/licences'>许可和署名</a>。",
  "ABOUT_TEXT_LINE4": "<a href='https://github.com/phcode-dev/phoenix/'>https://github.com/phcode-dev/phoenix/</a>上的文档和源代码",
  "ABOUT_TEXT_LINE5": "由 ❤ 和 JavaScript 制作：",
  "ABOUT_TEXT_LINE6": "很多人（但我们现在无法加载这些数据）。",
  ...
  "UPDATE_READY_RESTART_TITLE": "重启应用程序进行更新",
  "UPDATE_READY_RESTART_INSTALL_MESSAGE": "当您关闭所有打开的窗口时，{APP_NAME} 将自动更新。",
  "UPDATE_FAILED_TITLE": "更新失败",
  "UPDATE_INSTALLING": "安装更新…",
  "UPDATE_INSTALLING_MESSAGE": "更新安装正在进行中：{APP_NAME} 当前正在安装最新更新。安装完成后，应用程序将自动关闭。",
  "UPDATE_FAILED_MESSAGE": "请关闭所有{APP_NAME}应用窗口并重新打开该应用程序以再次尝试更新。<br/>您也可以从<a href='https://phcode.io'>phcode.io</a>下载安装程序来安装更新",
  "UPDATE_FAILED_VISIT_SITE_MESSAGE": "要重试，请退出 {APP_NAME} 的所有实例并重新启动该应用程序。<br>您很快就会进入我们的下载页面，您可以在其中手动下载最新版本。",
  "UPDATE_MESSAGE": "有一个新版本的 {APP_NAME}，增加了一些功能：",
  "GET_IT_NOW": "马上获取！",
  "UPDATE_ON_EXIT": "退出时更新",
  "UPDATE_LATER": "稍后提醒我",
  "UPDATE_DONE": "重新启动以更新 {APP_NAME}",
  "UPDATE_RESTART_INSTALL": "重新启动以安装更新",
  "UPDATE_DOWNLOADING": "下载安装程序",
  "INSTALL_WEBAPP": "在您的设备上安装{APP_NAME}",
  "UPDATE_DOWNLOAD_PROGRESS": "正在下载 - {0}，共 {1} MB",
  "UPDATING_APP": "正在更新{APP_NAME}",
  "UPDATING_APP_MESSAGE": "可能还要等一下",
  "UPDATING_APP_DIALOG_MESSAGE": "正在更新。在我们升级期间，您可以继续使用{APP_NAME}。",
  ...
  "THEMES_ERROR": "主题错误",
  "THEMES_ERROR_CANNOT_APPLY": "由于错误，无法应用主题。",
  ...
  "MISSING_PACKAGE_JSON": "该包没有 package.json 文件。",
  ...
  "EXTENSION_VERIFIED_PUBLISHER": "此发布者已验证对 {0} 的所有权",
  ...
  "EXTENSION_DEFAULT_FEATURE_PRESENT": "您可能不需要此扩展。 {APP_NAME} 已有此功能。",
  ...
  "EXTENSION_MANAGER_CREATE_EXTENSION": "+ 创建扩展",
  ...
  "EXTENSION_MANAGER_THEMES_INFO": "要<a class=\"theme_settings\">选择默认主题</a>或修改其他主题设置，<a class=\"theme_settings\">请单击此处</a>。",
  "EXTENSION_MANAGER_THEMES_UNDO": "恢复到以前的主题",
  ...
  "CMD_LOAD_CURRENT_EXTENSION": "加载项目作为扩展",
  "CMD_RELOAD_CURRENT_EXTENSION": "重新加载项目作为扩展",
  "CMD_UNLOAD_CURRENT_EXTENSION": "卸载项目作为扩展",
  "CMD_RELOAD_WITHOUT_USER_EXTS": "以无扩展模式重启",
  "CMD_NEW_BRACKETS_WINDOW": "新窗户",
  ...
  "ERROR_LOADING_EXTENSION": "错误加载扩展",
  "ERROR_NO_EXTENSION_PACKAGE": "当前项目中未检测到<code>package.json</code>文件。当前项目是有效的 {APP_NAME} 扩展吗？</br>有关详细信息，请参阅<a href='https://github.com/phcode-dev/phoenix/wiki/How-To-Write-Extensions-And-Themes'>此链接</a>。",
  "ERROR_INVALID_EXTENSION_PACKAGE": "<code>package.json</code>文件是无效的 JSON。</br>有关详细信息，请参阅<a href='https://github.com/phcode-dev/phoenix/wiki/How-To-Write-Extensions-And-Themes'>此链接</a>。",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "<code>package.json</code>中缺少必填字段：[{0}]</br>有关详细信息，请参阅<a href='https://github.com/phcode-dev/phoenix/wiki/How-To-Write-Extensions-And-Themes'>此链接</a>。",
  "ERROR_NODE_JS_CRASH_TITLE": "哎呀！出了些问题。",
  "ERROR_NODE_JS_CRASH_MESSAGE": "我们遇到了问题，需要重新启动 {APP_NAME}。别担心，我们会尝试在重新启动之前保存您的所有工作。 </br>（错误：ERROR_NODE_JS_CRASH）",
  "LANGUAGE_TITLE": "切换语言",
  ...
  "HEALTH_DATA_DO_TRACK": "分享我如何使用 {APP_NAME} 的匿名信息",
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "{APP_NAME}<strong>不会收集或处理任何个人身份信息</strong>，但<strong>会收集匿名使用情况统计信息</strong>以保护您的隐私。匿名数据不受 GDPR/CCPA 通知要求的约束，但我们认为您也需要选择退出匿名数据收集。<br><br>您可以通过选择<strong>“帮助”&gt;“健康报告”</strong>来查看您的数据或<strong>选择不共享任何匿名数据</strong>。这些<strong>匿名</strong>应用使用情况统计信息和错误报告有助于确定功能的优先级、查找错误和发现可用性问题，从而改善您使用 {APP_NAME} 的体验。如果没有这些数据，我们就不知道哪些功能值得为您构建！<br><br>",
  "HEALTH_DATA_PREVIEW": "{APP_NAME} 健康报告",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME}<strong>不会收集或处理任何个人身份信息</strong>，但<strong>会收集匿名使用情况统计信息</strong>以保护您的隐私。这些<strong>匿名</strong>应用使用情况统计信息和错误报告有助于确定功能的优先级、查找错误和发现可用性问题，从而改善您使用 {APP_NAME} 的体验。</p><p>以下是启用<em>后将</em>在下一份健康报告中发送的数据预览。（另请参阅开发者控制台中标记为“发现严重错误”的错误日志。）</p>",
  ...
  "DETECTED_EXCLUSION_INFO": "{APP_NAME} 处理<span class='dialog-filename'>{0}</span>时遇到问题。<br><br>将不再处理此文件的代码提示、跳转到定义或快速编辑。要重新启用此文件，请在项目中打开<code>.phcode.json</code>并编辑<code>jscodehints.detectedExclusions</code> 。<br><br>这可能是一个“{APP_NAME}”错误。如果您可以提供此文件的副本，请<a href='https://github.com/adobe/brackets/wiki/How-to-Report-an-Issue'>提交一个错误</a>，并提供指向此处指定文件的链接。",
  "CMD_REFACTOR": "重构",
  "CMD_EXTRACTTO_VARIABLE": "提取到变量",
  "CMD_EXTRACTTO_FUNCTION": "提取到函数",
  "ERROR_TERN_FAILED": "无法从 Tern 获取数据",
  "ERROR_EXTRACTTO_VARIABLE_NOT_VALID": "选择不形成表达式",
  "ERROR_EXTRACTTO_FUNCTION_NOT_VALID": "选定的块应该代表一组语句或一个表达式",
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "提取到变量在多游标中不起作用",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "提取到函数在多游标中不起作用",
  ...
  "CMD_REFACTORING_CONDITION": "包裹在条件",
  ...
  "ERROR_TRY_CATCH": "选择要包装在 Try-catch 块中的有效代码",
  "ERROR_WRAP_IN_CONDITION": "选择要包装在 Condition 块中的有效代码",
  "ERROR_ARROW_FUNCTION": "将光标放在函数表达式内",
  "ERROR_GETTERS_SETTERS": "将光标放在对象表达式的成员上",
  "ERROR_RENAME_MULTICURSOR": "使用多光标时无法重命名",
  "ERROR_RENAME_QUICKEDIT": "无法重命名此标识符，因为它在此函数之外的其他地方被引用",
  "ERROR_RENAME_GENERAL": "无法重命名所选文本",
  "JSHINT_NAME": "JSHint",
  "JSHINT_CONFIG_ERROR": "读取 JSHint 配置文件时出错：{0}",
  "JSHINT_CONFIG_JSON_ERROR": "错误：JSHint 配置文件 `{0}` 不是有效的 JSON",
  "ESLINT_NAME": "ESLint",
  "CSS_LINT_NAME": "{0}",
  "HTML_LINT_NAME": "HTML",
  "HTML_LINT_CONFIG_JSON_ERROR": "错误：HTML 验证器配置文件“{0}”不是有效的 JSON",
  "HTML_LINT_CONFIG_UNSUPPORTED": "错误：不支持配置格式“{0}”。请使用 JSON 配置“.htmlvalidate.json”",
  ...
  "DESCRIPTION_DISABLED_DEFAULT_EXTENSIONS": "禁用的默认扩展",
  ...
  "DESCRIPTION_JSHINT_DISABLE": "true 表示在问题面板中禁用 JSHints linter",
  "DESCRIPTION_ESLINT_DISABLE": "true 则在问题面板中禁用 ESLint linter",
  "DESCRIPTION_HTML_LINT_DISABLE": "true 则在问题面板中禁用 HTML linter",
  ...
  "DESCRIPTION_ESLINT_USE_NATIVE_APP": "ESLint 仅在桌面应用程序中可用。从<a href='https://phcode.io'>phcode.io</a>下载",
  "DESCRIPTION_ESLINT_LOAD_FAILED": "无法为该项目加载 ESLint。{APP_NAME} 仅支持 ESLint 7 以上的版本。",
  "DESCRIPTION_ESLINT_DO_NPM_INSTALL": "请在你的项目上运行“npm install”以启用 ESLint",
  "DESCRIPTION_LANGUAGE": "语言特定设置",
  "DESCRIPTION_LANGUAGE_FILE_EXTENSIONS": "扩展名到语言名的附加映射",
  "DESCRIPTION_LANGUAGE_FILE_NAMES": "文件名到语言名的附加映射",
  "DESCRIPTION_LINEWISE_COPY_CUT": "在没有选择时进行复制和剪切将复制或剪切包含光标的整行",
  "DESCRIPTION_INPUT_STYLE": "选择 CodeMirror 处理输入和焦点的方式。它可以是 textarea，这是默认设置，也可以是 contenteditable，它更适合屏幕阅读器（不稳定）",
  ...
  "DESCRIPTION_RULERS_COLORS": "与编辑器中的标尺选项相对应的标尺颜色数组。例如：[\"#3d3d3d\", \"red\"]",
  "DESCRIPTION_RULERS_ENABLED": "true 启用编辑器标尺，否则 false",
  "DESCRIPTION_AUTO_RENAME_TAGS": "true 则自动重命名配对的 HTML/XML 标签，否则为 false",
  "DESCRIPTION_DRAG_AND_DROP_ENABLED": "true 表示从文件资源管理器或 Finder 启用文件和文件夹的拖放功能",
  "DESCRIPTION_TRIPLE_CTRL_PALETTE": "true 启用在连续按下 Ctrl/Cmd 键 3 次时显示可视命令覆盖",
  ...
  "DESCRIPTION_AUTO_TAB_SPACE": "true 表示自动检测当前文件中使用的制表符和空格",
  ...
  "DESCRIPTION_EDITOR_LINE_HEIGHT": "调整编辑器中代码行之间的垂直间距。选择 1 到 3 之间的值，默认值为 1.5",
  "DESCRIPTION_LINTING_COLLAPSED": "值为真时，折叠提示面板",
  "DESCRIPTION_FONT_FAMILY": "改变字体",
  "DESCRIPTION_DESKTOP_ZOOM_SCALE": "选择范围从 0.1（对于更紧凑的视图）到 2（对于更大、更放大的视图）的缩放比例因子。仅在桌面应用程序中可用",
  ...
  "DEFAULT_PREFERENCES_JSON_HEADER_COMMENT": "/*\n * 这是一个只读文件，支持首选项\n * 由{APP_NAME}提供。\n * 使用此文件作为修改您的首选项的参考\n * 文件“phcode.json”在另一个窗格中打开。\n * 有关如何使用里面的首选项的更多信息\n * {APP_NAME}，请参阅网页 https://github.com/adobe/brackets/wiki/How-to-Use-Brackets#preferences\n */",
  ...
  "DESCRIPTION_LIVEDEV_WEBSOCKET_PORT": "为实时预览运行 WebSocket 服务器的端口",
  "DESCRIPTION_LIVE_DEV_HIGHLIGHT_SETTINGS": "实时预览突出显示设置",
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "false 禁用实时预览反向检查",
  "DESCRIPTION_LIVEDEV_NO_PREVIEW": "没有什么可以预览的！",
  "DESCRIPTION_LIVEDEV_EXCLUDED": "自定义服务器无法提供此文件",
  "DESCRIPTION_LIVEDEV_NO_PREVIEW_EXCLUDED": "实时预览设置已配置为仅提供文件夹“{0}”中的文件",
  "DESCRIPTION_LIVEDEV_NO_PREVIEW_DETAILS": "请选择要预览的 HTML 文件",
  "DESCRIPTION_LIVEDEV_PREVIEW_RESTRICTED": "预览不可用！",
  "DESCRIPTION_LIVEDEV_PREVIEW_RESTRICTED_DETAILS": "此 HTML 文件不是当前项目的一部分。出于安全原因，只能实时预览项目文件。要预览此文件，请将其包含文件夹作为单独的项目打开。",
  "DESCRIPTION_LIVEDEV_MAIN_HEADING": "呃哦！<br>您当前的浏览器不支持实时预览。",
  "DESCRIPTION_LIVEDEV_MAIN_SPAN": "从<a href=\"https://phcode.io\" style=\"color: white\">phcode.io</a>下载适用于 Windows、Mac 和 Linux 的本机应用程序，获得最佳的实时预览体验。<br>",
  ...
  "CONFIRM_EXTERNAL_BROWSER_TITLE": "弹出窗口被阻止",
  "CONFIRM_EXTERNAL_BROWSER_MESSAGE": "您想要允许实时预览页面打开此 URL：{0} 吗？",
  ...
  "CLEANUP_FAILED": "清理失败！",
  "WARNING_TYPE": "警告！",
  "CLICK_RESTART_TO_UPDATE": "单击重新启动以更新括号。",
  "UPDATE_ON_NEXT_LAUNCH": "更新将在重新启动时应用。",
  "GO_TO_SITE": "转到<a href = \"http://brackets.io/\">brackets.io</a>重试。",
  "INTERNET_UNAVAILABLE": "没有可用的 Internet 连接。",
  "UPDATEDIR_READ_FAILED": "无法读取更新目录。",
  "UPDATEDIR_CLEAN_FAILED": "无法清理更新目录。",
  "INITIAL_DOWNLOAD": "正在下载更新...",
  "RETRY_DOWNLOAD": "下载失败。重试...尝试",
  "VALIDATING_INSTALLER": "下载完毕！正在验证安装程序...",
  "CHECKSUM_DID_NOT_MATCH": "校验和不匹配。",
  "INSTALLER_NOT_FOUND": "未找到安装程序。",
  "DOWNLOAD_ERROR": "下载时出错。",
  "NETWORK_SLOW_OR_DISCONNECTED": "网络断开或太慢。",
  "RESTART_BUTTON": "重新开始",
  "LATER_BUTTON": "之后",
  ...
  "PHP_UNSUPPORTED_VERSION": "安装 PHP7 运行时以启用与 PHP 相关的工具，例如代码提示、参数提示、跳转到定义等。找到的版本：{0}",
  "PHP_EXECUTABLE_NOT_FOUND": "未找到 PHP 运行时。安装 PHP7 运行时并适当地更新 PHP Preferences 中的“executablePath”。这启用了与 PHP 相关的工具，例如代码提示、参数提示、跳转到定义等。",
  ...
  "DESCRIPTION_PHP_TOOLING_CONFIGURATION": "PHP Tooling 默认配置设置",
  "OPEN_PREFERENNCES": "打开首选项",
  "LANGUAGE_TOOLS_PREFERENCES": "语言工具首选项",
  "FIND_ALL_REFERENCES": "查找所有参考资料",
  "REFERENCES_IN_FILES": "参考",
  "REFERENCE_IN_FILES": "参考",
  "REFERENCES_NO_RESULTS": "当前光标位置没有可用的参考",
  "CMD_FIND_DOCUMENT_SYMBOLS": "查找文档符号",
  "CMD_FIND_PROJECT_SYMBOLS": "查找项目符号",
  "REMOTE_DEBUGGING_ENABLED": "在 localhost 上启用远程调试：",
  "REMOTE_DEBUGGING_PORT_INVALID": "无法在端口 {0} 上启用远程调试。端口号应在 {1} 和 {2} 之间。",
  ...
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "您当前的文件夹包含 {APP_NAME} 不支持的图形文件类型。<br/>您现在可以将特定文件类型与外部编辑器相关联。关联后，您可以通过双击文件树中的文件在其默认应用程序中打开 .xd、.psd、.jpg、.png、.ai、.svg 等图形文件。<br/><br/>请单击“确定”按钮将图形文件类型与其各自的默认应用程序相关联。",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "以下文件类型已成功与默认应用程序关联。<br/> {0}您可以通过转到“调试”-&gt;“打开首选项文件”菜单来更改关于是否在 phcode.json 中删除/添加新文件类型关联的首选项。",
  "UNSUPPORTED_BROWSER_TITLE": "不支持浏览器",
  "UNSUPPORTED_BROWSER_MESSAGE": "请使用现代浏览器（最近 3 年内发布）。",
  "UNSUPPORTED_BROWSER_MOBILE_TITLE": "不支持移动浏览器",
  "UNSUPPORTED_BROWSER_MOBILE": "目前不完全支持手机和平板电脑浏览器。您可以关闭此对话框，但 Phoenix 中的某些功能将无法在此浏览器中使用。<br/><br/>我们正致力于为 iOS 和 Android 开发原生应用程序。<a href=\"https://github.com/phcode-dev/phoenix/discussions/1046\" target=\"_blank\">在这里加入讨论！</a>",
  ...
  "MISSING_FIELDS": "缺少字段",
  "PLEASE_FILL_ALL_REQUIRED": "请填写以红色突出显示的所有必填字段",
  "CODE_EDITOR": "代码编辑器",
  "BUILD_THE_WEB": "构建网络",
  "IMPORT_PROJECT": "导入项目",
  "GIT_PROJECT": "从 Git 获取",
  "NEW_PROJECT_FROM_GIT": "使用 Git 新建项目",
  "GIT_REPO_URL": "Git 仓库网址：",
  "GIT_CLONE_URL": "Git 克隆 URL：",
  "START_PROJECT": "启动项目…",
  "DOWNLOAD_DESKTOP_APP": "下载桌面应用程序",
  "GET_DESKTOP_APP": "获取桌面应用程序",
  "CREATE_PROJECT": "创建项目",
  "SETTING_UP_PROJECT": "设置项目",
  "LOCATION": "地点 ：",
  "ERROR_ONLY_GITHUB": "{APP_NAME} 的浏览器版本仅支持 GitHub URL。要使用其他 Git URL，请使用桌面应用。",
  "ERROR_GIT_URL_INVALID": "请输入有效的 Git 克隆 URL。",
  "ERROR_GIT_FOLDER_NOT_EMPTY": "所选文件夹不能用于 Git 克隆，因为它不为空或不可读。",
  "ERROR_GIT_FOLDER_NOT_EXIST": "所选文件夹不存在，因此不能用于 Git 克隆。",
  "ERROR_CLONING_TITLE": "Git 克隆失败",
  "DOWNLOADING": "正在下载...",
  "DOWNLOADING_FILE": "正在下载 {0}...",
  "EXTRACTING_FILES_PROGRESS": "提取 {0} 个文件，共 {1} 个文件。",
  "COMPRESS_FILES_PROGRESS": "正在压缩 {0} 个文件，共 {1} 个。",
  "DOWNLOAD_FAILED_MESSAGE": "确保下载 URL 有效。</br>注意：由于 Phoenix 是免费的，因此不允许使用大于 25 MB 的 Private Repos 和 GitHub URL。",
  "PLEASE_SELECT_A_FOLDER": "请选择一个文件夹...",
  "UNZIP_IN_PROGRESS": "解压文件...",
  ...
  "BUILD_WEBSITE": "建立网站",
  "VIEW_MORE": "查看更多...",
  "NEW_PROJECT_NOTIFICATION": "单击此图标可以再次打开“新建项目”窗口。</br>查看最近的项目、打开文件夹或从模板启动项目。</br><img src=\"styles/images/new_project.png\"><br/><a href='#' style='float:right;'>好的</a>",
  "BEAUTIFY_CODE_NOTIFICATION": "单击此处或按<b>“{0}”</b>来美化代码。</br><img src=\"styles/images/beautify.gif\"><br/><a href='#' style='float:right;'>好的</a>",
  "DEFAULT_PROJECT_NOTIFICATION": "点击这里打开<br/>凤凰城的<b>默认项目</b>。</br><a href='#' style='float:right;'>好的</a>",
  "DIRECTORY_REPLACE_MESSAGE": "所选文件夹<span class='dialog-filename'>{0}</span>不为空。您确定要将文件夹内容替换为项目吗？",
  "DEFAULT_PROJECT_HTML_CLICK_HERE": "单击此处在 HTML 文件中定位此 &lt;span&gt;",
  "BUILD_WEBSITE_SECTION": "建立网站",
  "LEARN_SECTION": "通过示例学习",
  "CREATE_EXTENSION_SECTION": "创建 {APP_NAME} 扩展和主题",
  "CREATE_EXTENSION": "创建扩展",
  "CREATE_THEME": "创建主题",
  "WEBPAGE_HOME_PAGE": "主页",
  "WEBPAGE_BLOG": "博客页面",
  "WEBPAGE_DASHBOARD": "HTML 仪表板",
  "WEBPAGE_BOOTSTRAP_EXAMPLES": "引导示例",
  "PROJECTS_AT_A_GLANCE": "您的项目一览",
  "PROJECT_AT_GLANCE_DESCRIPTION": "观看视频以开始使用。",
  "PROJECT_FROM_BROWSER": "存储在您的浏览器中",
  "PROJECT_FROM_BROWSER_TERSE": "浏览器存储",
  "PROJECT_SHOW_ON_STARTUP": "启动时显示此对话框",
  "GUIDED_LIVE_PREVIEW": "在 HTML 文件中进行一些代码更改以查看实时预览。</br><a href='#' style='float:right;'>行</a>",
  "GUIDED_LIVE_PREVIEW_POPOUT": "单击此按钮可将实时预览弹出到新选项卡。</br><a href='#' style='float:right;'>好的</a>",
  "ENJOYING_APP": "喜欢{APP_NAME}吗？",
  "GITHUB_STARS_POPUP": "<div>您的支持有助于我们的小团队努力使<b style='color: darkblue'>phcode.dev</b>变得更好。<br/>请为我们加星标或考虑在 GitHub 上赞助我们：",
  "GITHUB_STARS_POPUP_TWITTER": "提供反馈或在 Twitter 上传播信息：",
  "TEST_TRANSLATE": "用它来测试翻译",
  "BEAUTIFY_ERROR": "无法美化代码。检查语法。",
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "无法美化。美化后编辑器文字发生变化。",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "美化档案{0}",
  "BEAUTIFY_ERROR_SELECTION": "无法美化。</br>选择的代码块不完整或语法无效。",
  "BEAUTIFY_OPTIONS": "控制美化代码工作方式的选项",
  "BEAUTIFY_OPTION_PRINT_WIDTH": "指定美化器将换行的行长",
  "BEAUTIFY_OPTION_SEMICOLON": "在每个语句的末尾添加一个分号",
  "BEAUTIFY_OPTION_SINGLE_QUOTE": "使用单引号而不是双引号",
  "BEAUTIFY_OPTION_QUOTE_PROPS": "引用对象中的属性时更改",
  ...
  "ADD_ENDLINE_TO_THE_END_OF_FILE": "在文件末尾添加结束行",
  "ADD_TO_GITIGNORE": "添加到 .gitignore",
  "AMEND_COMMIT": "修改上次提交",
  "SKIP_COMMIT_CHECKS": "跳过预提交检查（--no-verify）",
  "AMEND_COMMIT_FORBIDDEN": "当没有未推送的提交时无法修改提交",
  "_ANOTHER_BRANCH": "另一家分行",
  "AUTHOR": "作者",
  "AUTHORS_OF": "作者",
  ...
  "BUTTON_CANCEL": "取消",
  "CHECKOUT_COMMIT": "查看",
  "CHECKOUT_COMMIT_DETAIL": "<b>提交消息：</b> {0}<br><b>提交哈希：</b> {1}",
  "GIT_CLONE": "克隆",
  "BUTTON_CLOSE": "关闭",
  "BUTTON_COMMIT": "犯罪",
  "BUTTON_DEFAULTS": "恢复默认设置",
  ...
  "MENU_RESET_HARD": "此后放弃更改和提交（硬重置）",
  "MENU_RESET_MIXED": "此后丢弃提交但保持更改未暂存（混合重置）",
  "MENU_RESET_SOFT": "此后丢弃提交但保留更改（软重置）",
  "MENU_TAG_COMMIT": "标签提交",
  "RESET_HARD_TITLE": "确认硬重置",
  "RESET_MIXED_TITLE": "确认混合重置",
  "RESET_SOFT_TITLE": "确认软重置",
  "RESET_DETAIL": "<b>以下之后的提交将被丢弃：</b><br><b>提交消息：</b> {0}<br> <b>Git 命令：</b> {1}",
  "RESET_HARD_MESSAGE": "此操作将放弃所选提交之后的所有更改和提交。<b>此操作无法轻易撤消。</b>您确定要继续吗？<br><br> ⚠️ 警告：这将重写历史记录，不应在已推送到共享分支的提交上使用。",
  "RESET_MIXED_MESSAGE": "此操作将丢弃所选提交之后的所有提交，但保留所有未暂存的更改。<b>此操作无法轻易撤消。</b>您确定要继续吗？<br><br> ⚠️ 警告：这将重写历史记录，不应在已推送到共享分支的提交上使用。",
  "RESET_SOFT_MESSAGE": "此操作将丢弃所选提交之后的所有提交，但保留所有更改以进行新提交。<b>此操作无法轻易撤消。</b>您确定要继续吗？<br><br> ⚠️ 警告：这将重写历史记录，不应在已推送到共享分支的提交上使用。",
  "BUTTON_SAVE": "保存",
  "RESET": "重置",
  "CHANGE_USER_EMAIL_TITLE": "更改 git 邮箱",
  "CHANGE_USER_EMAIL": "更改 git 邮箱…",
  "CHANGE_USER_EMAIL_MENU": "更改 git 电子邮件 ({0})…",
  "CHANGE_USER_NAME_TITLE": "修改 git 用户名",
  "CHANGE_USER_NAME": "更改 git 用户名…",
  "CHANGE_USER_NAME_MENU": "更改 git 用户名 ({0})…",
  "REQUIRES_APP_RESTART_SETTING": "更改此设置需要重启应用才能生效",
  "CLEAN_FILE_END": "文件已清理",
  "CLEAN_FILE_START": "清洁文件",
  "CLEANING_WHITESPACE_PROGRESS": "清除文件中的空白……",
  "CLEAR_WHITESPACE_ON_FILE_SAVE": "保存文件时清除空白",
  "CLONE_REPOSITORY": "克隆存储库",
  "CODE_INSPECTION_PROBLEMS": "代码检查问题",
  "CODE_INSPECTION_IN_PROGRESS": "代码检查正在进行中...",
  "CODE_INSPECTION_PROBLEMS_NONE": "未检测到问题",
  "CODE_INSPECTION_DONE_FILES": "已完成 {0} 个文件（共 {1} 个）…",
  "PLEASE_WAIT": "请稍等…",
  "COMMIT": "犯罪",
  ...
  "CREATE_NEW_GITFTP_SCOPE": "创建新的 Git-FTP 远程…",
  "CREATE_NEW_REMOTE": "创建新的遥控器...",
  "CURRENT_TRACKING_BRANCH": "当前跟踪分支",
  "_CURRENT_TRACKING_BRANCH": "当前跟踪分支",
  "DEFAULT_GIT_TIMEOUT": "默认 Git 操作超时（以秒为单位）",
  "DELETE_FILE_BTN": "删除文件…",
  "DELETE_LOCAL_BRANCH": "删除本地分支",
  "DELETE_LOCAL_BRANCH_NAME": "确实要删除本地分支“{0}”吗？",
  "DELETE_REMOTE": "删除远程",
  "DELETE_REMOTE_NAME": "您确实要删除远程“{0}”吗？",
  "DELETE_SCOPE": "删除 Git-FTP 范围",
  "DELETE_SCOPE_NAME": "您确实希望删除 Git-FTP 范围“{0}”吗？",
  "DIALOG_CHECKOUT": "签出提交时，仓库将进入 DETACHED HEAD 状态。除非您基于此创建分支，否则无法进行任何提交。",
  "DIALOG_PULL_TITLE": "从远程拉取",
  "DIALOG_PUSH_TITLE": "推送至远程",
  "SKIP_PRE_PUSH_CHECKS": "跳过推送前检查（--no-verify）",
  "DIFF": "差异",
  "DIFFTOOL": "使用 difftool 进行差异比较",
  "DIFF_FAILED_SEE_FILES": "Git diff 未能提供差异结果。这是要提交的暂存文件列表：",
  "DIFF_TOO_LONG": "差异太长，无法显示",
  "ENABLE_GERRIT_PUSH_REF": "使用与 Gerrit 兼容的推送引用",
  "ENTER_NEW_USER_EMAIL": "输入电子邮箱",
  "ENTER_NEW_USER_NAME": "输入用户名",
  "ENTER_PASSWORD": "输入密码：",
  "ENTER_REMOTE_GIT_URL": "输入您要克隆的存储库的 Git URL：",
  "ENTER_REMOTE_NAME": "输入新遥控器的名称：",
  "ENTER_REMOTE_URL": "输入新遥控器的 URL：",
  "ENTER_USERNAME": "输入用户名:",
  "ERROR_NOTHING_SELECTED": "沒有任何選擇！",
  "ERROR_SAVE_FIRST": "先保存文档！",
  "ERROR_TERMINAL_NOT_FOUND": "未找到适合您操作系统的终端，您可以在设置中定义自定义终端命令",
  "EXTENDED_COMMIT_MESSAGE": "扩展",
  "GETTING_STAGED_DIFF_PROGRESS": "正在获取暂存文件的差异...",
  "GIT_COMMIT": "Git 提交…",
  "GIT_COMMIT_IN_PROGRESS": "Git 提交正在进行中",
  "GIT_DIFF": "Git 差异 &mdash;",
  "GIT_PULL_RESPONSE": "Git Pull 响应",
  "GIT_PUSH_RESPONSE": "Git Push 响应",
  "GIT_REMOTES": "Git 远程",
  "GIT_SETTINGS": "Git 设置…",
  "GIT_SETTINGS_TITLE": "Git 设置",
  "GOTO_NEXT_GIT_CHANGE": "转到下一个 Git 更改",
  "GOTO_PREVIOUS_GIT_CHANGE": "转到上一个 Git 更改",
  "GUTTER_CLICK_DETAILS": "点击查看更多详情",
  "HIDE_UNTRACKED": "在面板中隐藏未跟踪的文件",
  "HISTORY": "历史",
  "HISTORY_COMMIT_BY": "经过",
  "LINES": "线条",
  "_LINES": "线",
  ...
  "MERGE_MESSAGE": "合并消息",
  "MERGE_RESULT": "合并结果",
  "NORMALIZE_LINE_ENDINGS": "规范化行尾（为 \\n）",
  "NOTHING_TO_COMMIT": "无需提交，工作目录干净。",
  "OPERATION_IN_PROGRESS_TITLE": "Git 操作正在进行中…",
  "ORIGIN_BRANCH": "Origin 分支",
  "ON_BRANCH": "“{0}”- 当前 Git 分支",
  "PANEL_COMMAND": "显示 Git 面板",
  "PASSWORD": "密码",
  "PASSWORDS": "密码",
  "PATH_TO_GIT_EXECUTABLE": "Git 可执行文件的路径",
  "PULL_AVOID_MERGING": "避免手动合并",
  "PULL_DEFAULT": "默认合并",
  "PULL_FROM": "从...拉取",
  "PULL_MERGE_NOCOMMIT": "不提交的情况下合并",
  "PULL_REBASE": "使用狐狸",
  "PULL_RESET": "使用软重置",
  "PULL_SHORTCUT": "从远程拉取…",
  "PULL_SHORTCUT_BEHIND": "从远程拉取 (落后 {0})…",
  "PULL_BEHAVIOR": "拉动行为",
  ...
  "PUSH_FORCED": "强推",
  "PUSH_SHORTCUT": "推送至远程…",
  "PUSH_SHORTCUT_AHEAD": "推送至远程（前方 {0}）…",
  "PUSH_TO": "推至",
  "PUSH_BEHAVIOR": "推送行为",
  "Q_UNDO_CHANGES": "将更改重置至文件<span class='dialog-filename'>{0}</span> ？",
  "REBASE_RESULT": "福克斯结果",
  "REFRESH_GIT": "刷新 Git",
  ...
  "RESET_LOCAL_REPO_CONFIRM": "您是否希望放弃自上次提交以来所做的所有更改？此操作无法恢复。",
  "UNDO_LOCAL_COMMIT_CONFIRM": "您确定要撤消上次未推送的提交吗？",
  "MORE_OPTIONS": "更多选项",
  "CREDENTIALS": "证书",
  "SAVE_CREDENTIALS_HELP": "如果您的凭证在其他地方管理，则无需填写用户名/密码。仅当您的操作不断超时时才使用此选项。",
  "SAVE_CREDENTIALS_IN_URL": "将凭证保存到远程 URL（纯文本）",
  "SET_THIS_BRANCH_AS_TRACKING": "将此分支设置为新的跟踪分支",
  "STRIP_WHITESPACE_FROM_COMMITS": "从提交中删除尾随空格",
  "TARGET_BRANCH": "目标分支",
  "TITLE_CHECKOUT": "结帐提交？",
  "TOOLTIP_CLONE": "克隆现有存储库",
  "TOOLTIP_COMMIT": "提交选定的文件",
  "TOOLTIP_FETCH": "获取所有遥控器并刷新计数器",
  "TOOLTIP_FIND_CONFLICTS": "开始搜索项目中的 Git 合并/变基冲突",
  "TOOLTIP_HIDE_FILE_HISTORY": "隐藏文件历史记录",
  "TOOLTIP_HIDE_HISTORY": "隐藏历史记录",
  "TOOLTIP_INIT": "初始化存储库",
  "TOOLTIP_MERGE_ABORT": "中止合并操作并将 HEAD 重置为最后一次本地提交",
  "TOOLTIP_PICK_REMOTE": "选择首选遥控器",
  "TOOLTIP_PULL": "Git 拉取",
  "TOOLTIP_PUSH": "Git 推送",
  "TOOLTIP_REBASE_ABORT": "中止 rebase 操作并将 HEAD 重置为原始分支",
  "TOOLTIP_REBASE_CONTINUE": "解决合并冲突后重新启动变基过程",
  "TOOLTIP_REBASE_SKIP": "跳过当前补丁，重新启动重新定基过程",
  "TOOLTIP_REFRESH_PANEL": "刷新面板",
  "TOOLTIP_SHOW_FILE_HISTORY": "显示文件历史记录",
  "TOOLTIP_SHOW_HISTORY": "显示历史记录",
  "UNDO_CHANGES": "放弃更改",
  "UNDO_CHANGES_BTN": "放弃更改…",
  "UNDO_LAST_LOCAL_COMMIT": "撤消上次本地（未推送）提交…",
  "UNDO_COMMIT": "撤消提交",
  "URL": "网址",
  "USERNAME": "用户名",
  "USER_ABORTED": "用户已放弃！",
  "USE_GIT_GUTTER": "使用 Git 分隔线",
  "USE_NOFF": "即使合并解析为快进（--no-ff），也要创建合并提交",
  "USE_REBASE": "使用福克斯",
  "USE_VERBOSE_DIFF": "显示差异中的详细输出",
  "USE_DIFFTOOL": "使用 difftool 进行差异分析",
  "VIEW_AUTHORS_FILE": "查看文件作者...",
  "VIEW_AUTHORS_SELECTION": "查看所选作者...",
  ...
  "FILE_UNMODIFIED": "未修改",
  "FILE_UNTRACKED": "未追踪",
  "GIT_PUSH_SUCCESS_MSG": "成功快进",
  "GIT_PUSH_FORCE_UPDATED_MSG": "强制更新成功",
  "GIT_PUSH_DELETED_MSG": "已成功删除 ref",
  "GIT_PUSH_NEW_REF_MSG": "成功推送新 ref",
  "GIT_PUSH_REJECTED_MSG": "裁判被拒绝或未能推动",
  "GIT_PUSH_UP_TO_DATE_MSG": "Ref 已更新，无需推动",
  "GIT_PULL_SUCCESS": "成功完成 git pull",
  "GIT_MERGE_SUCCESS": "成功完成 git 合并",
  "GIT_REBASE_SUCCESS": "成功完成 git rebase",
  "GIT_BRANCH_DELETE_SUCCESS": "成功删除 git 分支",
  "INIT_NEW_REPO_FAILED": "无法初始化新存储库",
  "GIT_CLONE_REMOTE_FAILED": "克隆远程存储库失败！",
  "GIT_CLONE_ERROR_EXPLAIN": "所选目录 `{0}`\n不为空。Git 克隆需要一个干净的空目录。\n如果目录显示为空，请检查是否存在隐藏文件。",
  "FOLDER_NOT_WRITABLE": "所选目录“{0}”不可写。",
  "GIT_NOT_FOUND_MESSAGE": "您的系统上未安装或找不到 Git。请安装 Git 或在下方的文本字段中提供 Git 可执行文件的正确路径。",
  "ERROR_GETTING_BRANCH_LIST": "获取分支列表失败",
  "ERROR_READING_GIT_HEAD": "读取 .git/HEAD 文件失败",
  "ERROR_PARSING_BRANCH_NAME": "解析来自 {0} 的分支名称失败",
  ...
  "ERROR_REBASE_FAILED": "重新定基失败",
  "ERROR_MERGE_FAILED": "合并失败",
  "ERROR_BRANCH_DELETE_FORCED": "强制删除分支失败",
  "ERROR_FETCH_REMOTE_INFO": "获取远程信息失败",
  "ERROR_CREATE_BRANCH": "创建新分支失败",
  "ERROR_REFRESH_GUTTER": "刷新排水沟失败！",
  "ERROR_GET_HISTORY": "获取历史记录失败",
  "ERROR_GET_MORE_HISTORY": "无法加载更多历史记录行",
  "ERROR_GET_CURRENT_BRANCH": "无法获取当前分支名称",
  "ERROR_GET_DIFF_FILE_COMMIT": "无法获取差异",
  "ERROR_GET_DIFF_FILES": "无法加载差异文件列表",
  "ERROR_MODIFY_GITIGNORE": "修改 .gitignore 失败",
  "ERROR_UNDO_LAST_COMMIT_FAILED": "无法撤销上次提交",
  "ERROR_MODIFY_FILE_STATUS_FAILED": "修改文件状态失败",
  "ERROR_CHANGE_USERNAME_FAILED": "无法更改用户名",
  "ERROR_CHANGE_EMAIL_FAILED": "无法更改用户电子邮件",
  "ERROR_TOGGLE_GERRIT_PUSH_REF_FAILED": "无法切换 gerrit push ref",
  "ERROR_RESET_LOCAL_REPO_FAILED": "重置本地存储库失败",
  "ERROR_CREATE_TAG": "创建标签失败",
  "ERROR_CODE_INSPECTION_FAILED": "CodeInspection.inspectFile 执行文件失败",
  "ERROR_CANT_GET_STAGED_DIFF": "无法获取暂存文件的差异",
  "ERROR_GIT_COMMIT_FAILED": "Git 提交失败",
  "ERROR_GIT_BLAME_FAILED": "Git Blame 失败",
  "ERROR_GIT_DIFF_FAILED": "Git Diff 失败",
  "ERROR_DISCARD_CHANGES_FAILED": "放弃对文件的更改失败",
  "ERROR_COULD_NOT_RESOLVE_FILE": "无法解析文件",
  "ERROR_MERGE_ABORT_FAILED": "合并中止失败",
  "ERROR_MODIFIED_DIALOG_FILES": "显示提交对话框时，您要提交的文件已被修改。中止提交，因为结果将与对话框中显示的不同。",
  "ERROR_GETTING_REMOTES": "获取遥控器失败！",
  "ERROR_REMOTE_CREATION": "远程创建失败",
  "ERROR_PUSHING_REMOTE": "推送至远程失败",
  "ERROR_PULLING_REMOTE": "从远程拉取失败",
  "ERROR_PULLING_OPERATION": "拉动操作失败",
  "ERROR_PUSHING_OPERATION": "推送操作失败",
  "ERROR_NO_REMOTE_SELECTED": "尚未为 {0} 选择遥控器！",
  "ERROR_BRANCH_LIST": "获取分支列表失败",
  "ERROR_FETCH_REMOTE": "获取远程信息失败"
});