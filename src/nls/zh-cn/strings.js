...
define({
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME}<strong>不会收集或处理任何个人身份信息</strong>，但<strong>会收集匿名使用统计信息</strong>以保护您的隐私。匿名数据不受 GDPR/CCPA 通知要求的约束，但我们认为您需要有选择退出匿名数据收集的权利。<br>这些<strong>匿名</strong>应用使用情况统计信息和错误报告有助于确定功能的优先顺序、查找错误并发现影响您使用“{APP_NAME}”体验的可用性问题。</p><p>以下是<em>在启用后将</em>在您的下一份健康报告中发送的数据的预览。 （另请参阅开发人员控制台以获取标记为“捕获严重错误”的错误日志。）</p>",
  ...
  "BUILD_WEBSITE": "建立网站",
  "VIEW_MORE": "查看更多...",
  "NEW_PROJECT_NOTIFICATION": "单击此图标可创建一个新项目。</br><img src=\"styles/images/new_project.png\"><br/><a href='#' style='float:right;'>好的</a>",
  ...
  "POWER_USER_POPUP_TITLE": "我们怎样才能让 {APP_NAME} 更适合您？",
  "POWER_USER_POPUP_TEXT": "<div>我们很乐意收到您的反馈。您的反馈有助于我们决定构建哪些功能，以及应该对我们的平台进行哪些改进。<br/><a>请填写这份简短的调查问卷。</a></div>",
