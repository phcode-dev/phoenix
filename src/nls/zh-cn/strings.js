...
define({
  ...
  "UPDATE_READY_RESTART_TITLE": "更新就绪：需要重新启动",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "具有 JSHint 的默认选项的对象。请查看以下 URL 了解所有可用的 JSHint 选项：https://jshint.com/docs/options/",
