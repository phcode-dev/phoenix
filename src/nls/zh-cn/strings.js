...
define({
  ...
  "INCLUDE_FILE_FILTER": "包括{0}",
  "EXCLUDE_FILE_FILTER_DROPDOWN": "排除",
  "INCLUDE_FILE_FILTER_DROPDOWN": "包括",
  "EDIT_FILE_FILTER": "编辑…",
  "FILE_FILTER_DIALOG": "编辑排除过滤器",
  "FILE_FILTER_INSTRUCTIONS": "排除与以下任何<a href='{0}' title=\"{0}\">忽略通配符</a>匹配的文件和文件夹。在新行中输入每个字符串。例如<ul><li><code>*.js</code>将匹配<code>a/b/x.js</code> 、 <code>xyx.js</code>等。</li><li> <code>./*.css</code>只会匹配项目根目录中的<code>x.css</code> ，而不匹配子文件夹中的<code>y/x.css</code> 。</li></ul>",
  "FILE_FILTER_INSTRUCTIONS_INCLUDE": "仅包含与以下任一<a href='{0}' title=\"{0}\">忽略通配符</a>匹配的文件和文件夹。在新行中输入每个字符串。例如<ul><li><code>*.js</code>将匹配<code>a/b/x.js</code> 、 <code>xyx.js</code>等。</li><li> <code>./*.css</code>只会匹配项目根目录中的<code>x.css</code> ，而不匹配子文件夹中的<code>y/x.css</code> 。</li></ul>",
  "FILTER_NAME_PLACEHOLDER": "命名过滤规则 (可选)",
  "FILTER_NAME_REMAINING": "剩余 {0} 个字符",
  ...
  "CMD_KEYBOARD_NAV_OVERLAY": "用户界面导航模式",
  "NAVIGATE_MENU": "导航",
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "为了改进 {APP_NAME}，我们会定期向 phcode.dev 发送有关您如何使用 {APP_NAME} 的有限的<strong>假名</strong>统计数据和错误报告。此信息有助于确定功能的优先级、查找错误和发现可用性问题，同时保护您的隐私。<br><br>您可以通过选择<strong>“帮助”&gt;“健康报告”</strong>查看您的数据或选择不共享数据。<br><br>",
  "HEALTH_DATA_PREVIEW": "{APP_NAME} 健康报告",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>为了改进 {APP_NAME}，我们会定期向 phcode.dev 发送有关您如何使用 {APP_NAME} 的有限的<strong>假名</strong>统计数据和错误报告。此信息有助于确定功能的优先级、查找错误和发现可用性问题。</p><p><em>如果</em>启用，下面是将在您的下一份健康报告中发送的数据的预览。 （另请参阅开发人员控制台以获取标记为“已捕获严重错误”的错误日志。）</p>",
