...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "当前项目中未检测到<code>package.json</code>文件。当前项目是有效的 {APP_NAME} 扩展吗？",
  "ERROR_INVALID_EXTENSION_PACKAGE": "<code>package.json</code>文件是无效的 JSON。",
