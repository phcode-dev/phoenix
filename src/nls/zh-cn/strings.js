...
define({
  ...
  "UNSUPPORTED_BROWSER_MOBILE": "目前不完全支持移动和平板设备。您可以关闭此对话框，但 Phoenix 中的某些功能将无法在此浏览器中使用。",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "浏览器不支持打开文件夹。请使用 Chrome、Edge 或 Opera 打开本地文件夹。",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "请使用以下支持的浏览器之一。",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " 我们正在努力使 Phoenix 在更多浏览器中可用。您可以关闭此对话框，但 Phoenix 中的某些功能将无法在此浏览器中使用。",
