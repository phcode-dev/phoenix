...
define({
  ...
  "AI_CHAT_CLI_NOT_FOUND": "未找到 Claude CLI",
  "AI_CHAT_CLI_INSTALL_MSG": "请安装 Claude CLI 以使用 AI 功能：<br><code>npm install -g @anthropic-ai/claude-code</code><br><br>然后运行 <code>claude login</code> 进行身份验证。",
  "AI_CHAT_RETRY": "重试",
