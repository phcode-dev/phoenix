...
define({
  ...
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "انواع فایل زیر با موفقیت با برنامه های پیش فرض مرتبط شده اند.<br/> {0} شما این گزینه را دارید که با رفتن به منوی «Debug-&gt;Open Preferences File» تنظیمات برگزیده خود را در مورد حذف/افزودن پیوندهای نوع فایل جدید در brackets.json تغییر دهید.",
