...
define({
  ...
  "CMD_ENABLE_SELECTION_VIEW": "نمای انتخاب",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "یک شی با گزینه های پیش فرض برای JSHint. لطفا URL زیر را برای همه گزینه های JSHint در دسترس را ببینید: https://jshint.com/docs/options/",
  ...
  "DESCRIPTION_SELECTION_VIEW_ENABLED": "درست برای فعال کردن انتخاب نمایش",
  ...
  "EXTRACTING_FILES_PROGRESS": "استخراج {0} از {1} فایل.",
  ...
  "BEAUTIFY_ERROR": "نمی تواند کد را زیبا کند. نحو را بررسی کنید.",
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "نمی تواند زیباسازی. متن ویرایشگر پس از زیباسازی تغییر کرد.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "زیباسازی فایل {0}",
  "BEAUTIFY_ERROR_SELECTION": "نمی تواند زیباسازی. </br>بلوککد ناقص نحو انتخاب شده یا نامعتبر است.",
