...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "فایل <code>package.json</code> در پروژه فعلی شناسایی نشد. آیا پروژه فعلی یک برنامه افزودنی معتبر {APP_NAME} است؟",
  "ERROR_INVALID_EXTENSION_PACKAGE": "فایل <code>package.json</code> JSON نامعتبر است.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "فیلدهای الزامی موجود در <code>package.json</code> : [{0}]",
