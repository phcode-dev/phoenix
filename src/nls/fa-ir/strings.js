...
define({
  ...
  "UNSUPPORTED_BROWSER_MOBILE": "دستگاه های موبایل و تبلت در حال حاضر به طور کامل پشتیبانی نمی شوند. ممکن است این گفتگو را ببندید، اما برخی از ویژگی‌های فونیکس در این مرورگر کار نمی‌کنند.",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "مرورگر پوشه باز را پشتیبانی نمی کند. لطفاً از Chrome، Edge یا Opera برای باز کردن پوشه‌های محلی استفاده کنید.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "لطفاً از یکی از مرورگرهای پشتیبانی شده زیر استفاده کنید.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " ما سخت کار می کنیم تا Phoenix را در مرورگرهای بیشتری در دسترس قرار دهیم. ممکن است این گفتگو را ببندید، اما برخی از ویژگی‌های فونیکس در این مرورگر کار نمی‌کنند.",
