...
define({
  ...
  "WEBPAGE_HOME_PAGE": "طرح بندی صفحه اصلی",
  "WEBPAGE_BLOG": "صفحه وبلاگ",
  "WEBPAGE_DASHBOARD": "داشبورد HTML",
  "WEBPAGE_BOOTSTRAP_EXAMPLES": "نمونه های بوت استرپ",
  "GUIDED_FILES_SIDEBAR": "یک فایل HTML را انتخاب کنید</br> <a href='#' style='float:right;'>خوب</a>",
  "GUIDED_LIVE_PREVIEW": "تغییراتی در کد ایجاد کنید و فایل را برای مشاهده پیش نمایش ذخیره کنید.</br> <a href='#' style='float:right;'>خوب</a>",
