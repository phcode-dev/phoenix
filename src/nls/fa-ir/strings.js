...
define({
  ...
  "DESCRIPTION_LIVEDEV_SECURITY": "هشدار امنیتی از phcode.dev<br><br> این پیش‌نمایش زنده تلاش کرد به یک فایل غیر پروژه دسترسی پیدا کند. دسترسی برای ایمنی شما ممنوع شد. لطفاً هنگام کار بر روی پروژه های غیر قابل اعتماد احتیاط کنید.",
