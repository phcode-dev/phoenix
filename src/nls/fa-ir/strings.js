...
define({
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "به منظور بهبود {APP_NAME}، به صورت دوره‌ای آمارهای محدود و <strong>مستعار</strong> را درباره نحوه استفاده شما از {APP_NAME} به core.ai ارسال می‌کنیم. این اطلاعات به اولویت‌بندی ویژگی‌ها، یافتن باگ‌ها و شناسایی مشکلات قابلیت استفاده در حین محافظت از حریم خصوصی شما کمک می‌کند.<br><br> می‌توانید با انتخاب <strong>راهنما &gt; گزارش سلامت،</strong> داده‌های خود را ببینید یا اشتراک‌گذاری داده‌ها را انتخاب نکنید.<br><br>",
  "HEALTH_DATA_PREVIEW": "گزارش سلامت {APP_NAME}",
  "HEALTH_DATA_PREVIEW_INTRO": "<p style=\";text-align:right;direction:rtl\">به منظور بهبود {APP_NAME}، به صورت دوره‌ای آمارهای محدود و <strong>مستعار</strong> را درباره نحوه استفاده شما از {APP_NAME} به core.ai ارسال می‌کنیم. این اطلاعات به اولویت‌بندی ویژگی‌ها، یافتن باگ‌ها و شناسایی مشکلات قابلیت استفاده کمک می‌کند.</p><p style=\";text-align:right;direction:rtl\"> در زیر پیش نمایش داده هایی است که در <em>صورت</em> فعال بودن گزارش سلامت بعدی شما ارسال می شود.</p>",
