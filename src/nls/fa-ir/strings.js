...
define({
  ...
  "ENCODE_FILE_FAILED_ERR": "{APP_NAME} قادر به رمز محتویات فایل نیست.",
  "DECODE_FILE_FAILED_ERR": "{APP_NAME} قادر به رمزگشایی محتویات فایل نیست.",
  "UNSUPPORTED_UTF16_ENCODING_ERR": "{APP_NAME} در حال حاضر از فایل های متنی رمزگذاری شده UTF-16 پشتیبانی نمی کند.",
  ...
  "ERROR_RENAMING_NOT_IN_PROJECT": "فایل یا دایرکتوری بخشی از پروژه باز شده در حال حاضر نیست. متاسفانه، تنها فایل های پروژه را می توان در این نقطه تغییر نام داد.",
  "ERROR_MOVING_FILE_TITLE": "خطا در حرکت {0}",
  "ERROR_MOVING_FILE": "هنگام تلاش برای جابجایی {2} <span class='dialog-filename'>{0}</span>خطایی رخ داد. {1}",
  "ERROR_MOVING_NOT_IN_PROJECT": "نمی تواند فایل/پوشه را حرکت دهد، زیرا آنها بخشی از پروژه فعلی نیستند.",
  ...
  "ERROR_PROJ_PREFS_CORRUPT": "فایل تنظیمات پروژه شما JSON معتبر نیست. فایل باز خواهد شد به طوری که شما می توانید فرمت را اصلاح کنید. شما نیاز به بارگذاری مجدد پروژه برای تغییرات را به اثر.",
  ...
  "LIVE_DEV_CLICK_POPOUT": "Popout پیش نمایش زنده به پنجره جدید",
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "پین در Unpin پیش نمایش صفحه",
  ...
  "CONFIRM_FILE_DELETE": "آیا مطمئن هستید که میخواهید فایل <span class='dialog-filename'>{0}</span>را حذف کنید؟",
  ...
  "WINDOW_UNLOAD_WARNING_WITH_UNSAVED_CHANGES": "شما تغییرات ذخیره نشده! آیا مطمئن هستید که می خواهید به URL دیگری بروید و Brackets را ترک کنید؟",
  "DONE": "انجام",
  "OK": "تائید",
  "CANCEL": "لغو",
  "DONT_SAVE": "ذخیره نکن",
  ...
  "FIND_HISTORY_MAX_COUNT": "حداکثر تعداد آیتم های جستجو در تاریخچه جستجو",
  ...
  "FILTER_NAME_REMAINING": "{0} کاراکتر باقی مانده",
  ...
  "CMD_TOGGLE_SIDEBAR": "ضامن سایدبار",
  "CMD_TOGGLE_PANELS": "پانل های تعویض",
  "CMD_TOGGLE_PURE_CODE": "بدون حواس او را پرت",
  ...
  "CMD_THEMES": "پوسته ها…",
  "CMD_TOGGLE_SEARCH_AUTOHIDE": "جستجو را بطور خودکار ببندید",
  "NAVIGATE_MENU": "انتقال",
  "CMD_QUICK_OPEN": "باز کردن سریع",
  "CMD_GOTO_LINE": "برو به خط",
  "CMD_GOTO_DEFINITION": "تعریف جستجوی سریع",
  "CMD_GOTO_DEFINITION_PROJECT": "سریع پیدا کردن تعریف در پروژه",
  ...
  "CMD_NAVIGATE_BACKWARD": "حرکت به عقب",
  ...
  "CMD_SWITCH_PANE_FOCUS": "سوئیچ پنجره تمرکز",
  ...
  "CMD_HOMEPAGE": "{APP_NAME} صفحه خانگی",
  ...
  "ABOUT": "پیرامون",
  "CLOSE": "بستن",
  "ABOUT_TEXT_LINE1": "انتشار {VERSION_MAJOR}. {VERSION_MINOR} {BUILD_TYPE} {نسخه}",
  "ABOUT_TEXT_BUILD_TIMESTAMP": "ساخت برچسب زمان: ",
  "ABOUT_TEXT_LINE3": "کتابخانه های شخص ثالث که ما استفاده می کنیم - <a href='https://github.com/phcode-dev/phoenix/tree/main/src/thirdparty/licences'> مجوزها و اسناد</a> . ",
  ...
  "ABOUT_TEXT_LINE6": "بسیاری از مردم (اما ما با داشتن مشکل بارگذاری که داده ها در حال حاضر).",
  ...
  "FLIPVIEW_BTN_TOOLTIP": "این نما را به کادر {0} تلنگر کنید",
  ...
  "SORT_EXTENSION_METHOD": "مرتب سازی بر اساس برنامه های افزودنی با استفاده از DownloadCount یا",
  "INVALID_ZIP_FILE": "محتوای دانلود شده دارای پرونده zip معتبر نمی باشد.",
  "MISSING_PACKAGE_JSON": "این بسته هیچ فایل package.json ندارد.",
  ...
  "NPM_INSTALL_FAILED": "دستور نصب npm شکست خورد: {0}",
  ...
  "EXTENSION_MANAGER_DISABLE": "غیر فعال کردن فرمت",
  "EXTENSION_MANAGER_DISABLE_ERROR": "قادر به غیر فعال کردن یک یا چند افزونه نیست: {0}. {APP_NAME} هنوز بارگذاری مجدد خواهد شد.",
  ...
  "MARKED_FOR_DISABLING": "برای غیرفعال کردن مشخص شده است",
  ...
  "DISABLE_AND_RELOAD": "غیر فعال کردن پسوند و بازنگری",
  ...
  "EXTENSIONS_LAST_UPDATED": "آخرین به روز رسانی",
  ...
  "CMD_ENABLE_LOGGING": "فعال کردن سیاهههای مربوط مفصل",
  "CMD_OPEN_BRACKETS_SOURCE": "باز کردن منبع براکتس",
  "CREATING_LAUNCH_SCRIPT_TITLE": "{APP_NAME} میانبر خط فرمان",
  "ERROR_CREATING_LAUNCH_SCRIPT": "هنگام نصب میانبر خط فرمان خطایی رخ داد. لطفا <a href='https://github.com/adobe/brackets/wiki/Command-Line-Arguments#troubleshooting'>این پیشنهادات عیب یابی</a>را امتحان کنید. <br/><br/>دلیل: {0}",
  "ERROR_CLTOOLS_RMFAILED": "قادر به حذف لینک متقارن <code>/usr/محلی/بن/براکت</code> موجود نیست.",
  "ERROR_CLTOOLS_MKDIRFAILED": "قادر به ایجاد دایرکتوری <code>/usr/local/bin</code> نیست.",
  "ERROR_CLTOOLS_LNFAILED": "قادر به ایجاد لینک متقارن <code>/usr/محلی/بن/براکت</code> نیست.",
  "ERROR_CLTOOLS_SERVFAILED": "خطای داخلی",
  "ERROR_CLTOOLS_NOTSUPPORTED": "میانبر خط فرمان در این سیستم عامل پشتیبانی نمی شود.",
  "LAUNCH_SCRIPT_CREATE_SUCCESS": "موفقیت! در حال حاضر شما به راحتی می توانید راه اندازی {APP_NAME} از خط فرمان: <code>براکت myFile.txt</code> برای باز کردن یک فایل یا <code>براکت MyFolder</code> برای تغییر پروژه. <br/><br/><a href='https://github.com/adobe/brackets/wiki/Command-Line-Arguments'>درباره</a> استفاده از {APP_NAME} از خط فرمان بیشتر بدانید.",
  "LANGUAGE_TITLE": "تغییر زبان",
  "LANGUAGE_MESSAGE": "زبان:",
  "LANGUAGE_SUBMIT": "بارگذاری مجدد {APP_NAME}",
  "LANGUAGE_CANCEL": "لغو",
  "LANGUAGE_SYSTEM_DEFAULT": "پیشفرض سیستم",
  "HEALTH_DATA_NOTIFICATION": "ترجیحات گزارش سلامت",
  "HEALTH_FIRST_POPUP_TITLE": "{APP_NAME} گزارش بهداشت",
  "HEALTH_DATA_DO_TRACK": "اطلاعات نام مستعار در مورد نحوه استفاده از {APP_NAME} را به اشتراک بگذارید",
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "به منظور بهبود {APP_NAME}، ما به طور دوره ای آمار محدود و نام <strong>مستعار</strong> را به core.ai در مورد نحوه استفاده از {APP_NAME} ارسال می کنیم. این اطلاعات به اولویت بندی ویژگی ها، یافتن اشکالات و مشکلات قابلیت استفاده در هنگام محافظت از حریم خصوصی شما کمک می کند. <br><br>شمامی توانید داده های خود را ببینید و یا انتخاب کنید برای به اشتراک گذاشتن داده ها با انتخاب <strong>راهنما > گزارش سلامت</strong>. <br><br>",
  "HEALTH_DATA_PREVIEW": "{APP_NAME} گزارش بهداشت",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>بهمنظور بهبود {APP_NAME}، ما به طور دوره ای آمار محدود و نام <strong>مستعار</strong> را به core.ai در مورد نحوه استفاده از {APP_NAME} ارسال می کنیم. این اطلاعات به اولویت بندی ویژگی ها، یافتن اشکالات و مشکلات قابلیت استفاده در نقطه کمک می کند. </p><p><em>درزیر پیش نمایش داده هایی است که در صورت فعال بودن در گزارش سلامتی بعدی شما ارسال می شود.</em> </p>",
  ...
  "COLOR_EDITOR_0X_BUTTON_TIP": "قالب هگز (0x)",
  ...
  "CMD_REFACTOR": "ریفاکتور",
  "CMD_EXTRACTTO_VARIABLE": "استخراج به متغیر",
  "CMD_EXTRACTTO_FUNCTION": "استخراج به عملکرد",
  "ERROR_TERN_FAILED": "قادر به دریافت اطلاعات از پرستوی دریایی",
  "ERROR_EXTRACTTO_VARIABLE_NOT_VALID": "انتخاب یک عبارت را تشکیل نمی دهد",
  "ERROR_EXTRACTTO_FUNCTION_NOT_VALID": "بلوک انتخاب شده باید مجموعه ای از اظهارات یا یک عبارت را نشان دهد",
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "استخراج به متغیر در چند منظوره کار نمی کند",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "استخراج به تابع در چند منظوره کار نمی کند",
  "EXTRACTTO_FUNCTION_SELECT_SCOPE": "دامنه مقصد را انتخاب کنید",
  "EXTRACTTO_VARIABLE_SELECT_EXPRESSION": "یک عبارت را انتخاب کنید",
  "CMD_REFACTORING_RENAME": "تغییر نام",
  "CMD_REFACTORING_TRY_CATCH": "قرار دادن در سعی کنید گرفتن",
  "CMD_REFACTORING_CONDITION": "قرار دادن در شرایط",
  "CMD_REFACTORING_GETTERS_SETTERS": "ایجاد دهندگان/بنگاه",
  "CMD_REFACTORING_ARROW_FUNCTION": "تبدیل به تابع فلش",
  "DESCRIPTION_CODE_REFACTORING": "فعال/غیر فعال کردن کد جاوا اسکریپت refactoring",
  "ERROR_TRY_CATCH": "کد معتبر را انتخاب کنید تا در یک بلوک Try-catch قرار دهید",
  "ERROR_WRAP_IN_CONDITION": "کد معتبر را انتخاب کنید تا در یک بلوک شرط بسته بندی شود",
  "ERROR_ARROW_FUNCTION": "مکان نما را درون یک عبارت تابع قرار دهید",
  "ERROR_GETTERS_SETTERS": "مکان نما را در یک عضو از یک عبارت شی قرار دهید",
  "ERROR_RENAME_MULTICURSOR": "هنگام استفاده از چند مکان نما نمی تواند تغییر نام دهد",
  "ERROR_RENAME_QUICKEDIT": "نمی توان این شناسه را تغییر نام داد، زیرا در جاهای دیگر خارج از این تابع اشاره شده است",
  "ERROR_RENAME_GENERAL": "نمیتوان متن انتخاب شده را تغییر داد",
  "JSLINT_NAME": "JSLint",
  ...
  "COLLAPSE_ALL": "سقوط همه",
  "EXPAND_ALL": "گسترش همه",
  "COLLAPSE_CURRENT": "فروپاشی کنونی",
  "EXPAND_CURRENT": "جریان را گسترش دهید",
  "RECENT_FILES_DLG_HEADER": "فایل های اخیر",
  "RECENT_FILES_DLG_CLEAR_BUTTON_LABEL": "پاک کردن",
  "RECENT_FILES_DLG_CLEAR_BUTTON_TITLE": "پاک کردن پرونده ها در مجموعه کاری نیست",
  "DESCRIPTION_CLOSE_BRACKETS": "درست است که به طور خودکار پرانتز، براکت و پرانتز را ببندید",
  "DESCRIPTION_CLOSE_OTHERS_ABOVE": "نادرست برای حذف «بستن دیگران در بالا» از منوی زمینه فایل های کاری",
  "DESCRIPTION_CLOSE_OTHERS_BELOW": "نادرست برای حذف «بستن دیگران در زیر» از منوی زمینه فایل های کاری",
  "DESCRIPTION_CLOSE_OTHERS": "نادرست برای حذف «بستن دیگران» از منوی زمینه فایل های کاری",
  "DESCRIPTION_CLOSE_TAGS": "گزینه های بستن برچسب را تنظیم می کند",
  "DESCRIPTION_CLOSE_TAGS_DONT_CLOSE_TAGS": "آرایه ای از برچسب ها که نباید خودکار بسته شوند",
  "DESCRIPTION_CLOSE_TAGS_WHEN_OPENING": "بستن زمانی که > باز کردن تگ تایپ شده است",
  "DESCRIPTION_CLOSE_TAGS_WHEN_CLOSING": "بستن زمانی که/برچسب بسته شدن تایپ شده است",
  "DESCRIPTION_CLOSE_TAGS_INDENT_TAGS": "آرایه ای از برچسب هایی که هنگام باز شدن دارای یک خط خالی است",
  "DESCRIPTION_CODE_FOLDING_ALWAY_USE_INDENT_FOLD": "درست است که همیشه نشانگرهای بخش قابل جمع شدن را هنگام تغییر سطح تورفتگی ایجاد کنید",
  "DESCRIPTION_CODE_FOLDING_ENABLED": "درست برای فعال کردن تاشو کد",
  "DESCRIPTION_CODE_FOLDING_HIDE_UNTIL_MOUSEOVER": "درست را به نشانگر بخش سقوط قابل مشاهده تنها زمانی که شما حرکت ماوس بیش از قطره قطره شدن",
  "DESCRIPTION_CODE_FOLDING_MAX_FOLD_LEVEL": "محدود کردن چند سطح عمیق سقوط همه اعمال می شود",
  "DESCRIPTION_CODE_FOLDING_MIN_FOLD_SIZE": "حداقل خطوط قبل از آیکون بخش تاشو ظاهر می شود",
  "DESCRIPTION_CODE_FOLDING_SAVE_FOLD_STATES": "درست به یاد داشته باشید بخش سقوط اگر شما بستن و بازگشایی یک فایل یا پروژه",
  "DESCRIPTION_CODE_FOLDING_MAKE_SELECTIONS_FOLDABLE": "true برای فعال کردن تاشو کد روی متن انتخاب شده در ویرایشگر",
  "DESCRIPTION_DISABLED_DEFAULT_EXTENSIONS": "افزونه های پیش فرض که غیر فعال هستند",
  "DESCRIPTION_ATTR_HINTS": "فعال/غیر فعال کردن نکات ویژگی HTML",
  "DESCRIPTION_CSS_PROP_HINTS": "فعال/غیر فعال کردن CSS/کمتر/SCSS نکات اموال",
  "DESCRIPTION_JS_HINTS": "فعال/غیر فعال کردن نکات کد جاوا اسکریپت",
  "DESCRIPTION_JS_HINTS_TYPE_DETAILS": "فعال/غیر فعال کردن جزئیات نوع داده در نکات کد جاوا اسکریپت",
  "DESCRIPTION_PREF_HINTS": "فعال/غیر فعال کردن تنظیمات نکات کد",
  "DESCRIPTION_SPECIAL_CHAR_HINTS": "فعال/غیر فعال کردن نکات نهاد HTML",
  "DESCRIPTION_SVG_HINTS": "فعال/غیر فعال کردن نکات کد SVG",
  "DESCRIPTION_HTML_TAG_HINTS": "فعال/غیر فعال کردن نکات تگ HTML",
  "DESCRIPTION_URL_CODE_HINTS": "فعال/غیر فعال کردن URL نکات در HTML و CSS/کمتر/SCSS",
  "DESCRIPTION_DRAG_DROP_TEXT": "فعال/غیر فعال کردن کشیدن و رها کردن قابلیت",
  "DESCRIPTION_HEALTH_DATA_TRACKING": "ردیابی داده های بهداشتی را فعال کنید",
  "DESCRIPTION_HIGHLIGHT_MATCHES": "برجسته سازی خودکار رشته های تطبیق در سراسر سند را فعال می کند",
  "DESCRIPTION_HIGHLIGHT_MATCHES_SHOW_TOKEN": "برجسته کردن تمام رشته هایی که با نشانه ای که مکان نما در حال حاضر در آن است مطابقت دارد (هیچ انتخابی لازم نیست)",
  "DESCRIPTION_HIGHLIGHT_MATCHES_WORDS_ONLY": "تنها زمانی که انتخاب یک نشانه کامل است، برجسته کنید",
  "DESCRIPTION_INSERT_HINT_ON_TAB": "true برای وارد کردن اشاره کد انتخاب شده در حال حاضر در تب",
  "DESCRIPTION_NO_HINTS_ON_DOT": "درست به طور خودکار نشان می دهد JS نکات کد زمانی که. تایپ شده است",
  "DESCRIPTION_JSLINT_OPTIONS": "یک شی با گزینه های پیش فرض برای JsLint",
  "DESCRIPTION_JSLINT_OPTIONS_ASS": "درست است که اجازه می دهد عبارات انتساب",
  "DESCRIPTION_JSLINT_OPTIONS_BITWISE": "درست است که به اپراتورهای بیتی اجازه می دهد",
  "DESCRIPTION_JSLINT_OPTIONS_BROWSER": "درست است اگر globals مرورگر استاندارد باید از پیش تعریف شده",
  "DESCRIPTION_JSLINT_OPTIONS_CLOSURE": "درست است که اجازه می دهد اصطلاحات بسته شدن گوگل",
  "DESCRIPTION_JSLINT_OPTIONS_CONTINUE": "درست است که اجازه می دهد «ادامه» بیانیه",
  "DESCRIPTION_JSLINT_OPTIONS_COUCH": "درست است اگر CouchDB globals باید از پیش تعریف شده",
  "DESCRIPTION_JSLINT_OPTIONS_DEBUG": "درست برای اجازه دادن به اظهارات دیباگر",
  "DESCRIPTION_JSLINT_OPTIONS_DEVEL": "درست است اگر globals مرورگر مفید در توسعه باید از پیش تعریف شده",
  "DESCRIPTION_JSLINT_OPTIONS_EQEQ": "درست است که اجازه می دهد == و! =",
  "DESCRIPTION_JSLINT_OPTIONS_ES6": "درست است اگر globals ES6 باید از پیش تعریف شده",
  "DESCRIPTION_JSLINT_OPTIONS_EVIL": "درست اجازه می دهد eval",
  "DESCRIPTION_JSLINT_OPTIONS_FORIN": "درست است که اجازه می دهد فیلتر نشده «برای... در»",
  "DESCRIPTION_JSLINT_OPTIONS_INDENT": "یک عرض برگه خاص را تنظیم کنید",
  "DESCRIPTION_JSLINT_OPTIONS_MAXERR": "حداکثر تعداد هشدارهای گزارش شده",
  "DESCRIPTION_JSLINT_OPTIONS_MAXLEN": "حداکثر تعداد کاراکتر در یک خط",
  "DESCRIPTION_JSLINT_OPTIONS_NEWCAP": "درست است که به سازندگان بی سرمایه اجازه می دهد",
  "DESCRIPTION_JSLINT_OPTIONS_NODE": "درست است اگر globals Node.js باید از پیش تعریف شده",
  "DESCRIPTION_JSLINT_OPTIONS_NOMEN": "درست است که اجازه می دهد تا خط زیرین آویزان در شناسه ها",
  "DESCRIPTION_JSLINT_OPTIONS_PASSFAIL": "درست است که در خطای اول متوقف شود",
  "DESCRIPTION_JSLINT_OPTIONS_PLUSPLUS": "درست اجازه می دهد ++ و -",
  "DESCRIPTION_JSLINT_OPTIONS_REGEXP": "و [^...]. که در RegExp",
  "DESCRIPTION_JSLINT_OPTIONS_RHINO": "درست است اگر Rhino globals باید از پیش تعریف شده",
  "DESCRIPTION_JSLINT_OPTIONS_SLOPPY": "درست است که اجازه می دهد از دست رفته `استفاده سخت` پراگما",
  "DESCRIPTION_JSLINT_OPTIONS_STUPID": "درست اگر مسدود کردن ('... همگام سازی') روش می تواند مورد استفاده قرار گیرد.",
  "DESCRIPTION_JSLINT_OPTIONS_SUB": "درست است که اجازه می دهد اشتراک ناکارآمد",
  "DESCRIPTION_JSLINT_OPTIONS_TODO": "درست اجازه می دهد تا نظرات TODO",
  "DESCRIPTION_JSLINT_OPTIONS_UNPARAM": "درست برای اجازه دادن به پارامترهای استفاده نشده",
  "DESCRIPTION_JSLINT_OPTIONS_VARS": "true برای اجازه دادن به بیش از 1 vars در یک تابع",
  "DESCRIPTION_JSLINT_OPTIONS_WHITE": "درست است که قوانین فضای سفید را نادیده بگیریم",
  "DESCRIPTION_LANGUAGE": "تنظیمات خاص زبان",
  "DESCRIPTION_LANGUAGE_FILE_EXTENSIONS": "نقشه های اضافی از پسوند فایل به نام زبان",
  "DESCRIPTION_LANGUAGE_FILE_NAMES": "نقشه های اضافی از نام فایل به نام زبان",
  "DESCRIPTION_LINEWISE_COPY_CUT": "انجام کپی و برش زمانی که هیچ انتخابی وجود ندارد، تمام خطوطی را که نشانگر در آنها وجود دارد کپی یا برش می دهد",
  "DESCRIPTION_INPUT_STYLE": "روشی را انتخاب می کند که CodeMirror ورودی و فوکوس را این می تواند متن، که به طور پیش فرض، و یا contenteditable است که برای خوانندگان صفحه نمایش بهتر است (ناپایدار)",
  "DESCRIPTION_LINTING_ENABLED": "درست برای فعال کردن بازرسی کد",
  "DESCRIPTION_ASYNC_TIMEOUT": "زمان در میلی ثانیه پس از آن زمان ناهمزمان linters زمان",
  "DESCRIPTION_LINTING_PREFER": "آرایه ای از linters برای اولین بار اجرا",
  "DESCRIPTION_LIVE_DEV_MULTIBROWSER": "درست برای فعال کردن پیش نمایش زنده آزمایشی",
  "DESCRIPTION_USE_PREFERED_ONLY": "درست برای اجرای ارائه دهندگان مشخص شده در linting.revere تنها",
  "DESCRIPTION_MAX_CODE_HINTS": "حداکثر نکات کد نمایش داده شده در یک بار",
  "DESCRIPTION_PATH": "تنظیمات خاص مسیر",
  "DESCRIPTION_PROXY": "URL سرور پروکسی که برای نصب افزونه استفاده می شود",
  "DESCRIPTION_SCROLL_PAST_END": "درست برای فعال کردن پیمایش فراتر از انتهای سند",
  "DESCRIPTION_SHOW_CODE_HINTS": "false برای غیر فعال کردن تمام نکات کد",
  "DESCRIPTION_SHOW_CURSOR_WHEN_SELECTING": "هنگامی که یک انتخاب متن دارید، نشانگر چشمک زدن را قابل مشاهده نگه می دارد",
  "DESCRIPTION_SHOW_LINE_NUMBERS": "درست برای نشان دادن شماره خط در یک «قطره قطره شدن» در سمت چپ کد",
  "DESCRIPTION_SMART_INDENT": "هنگام ایجاد یک بلوک جدید، به طور خودکار به طور خودکار",
  "DESCRIPTION_SOFT_TABS": "نادرست برای خاموش کردن رفتار زبانه های نرم",
  "DESCRIPTION_SORT_DIRECTORIES_FIRST": "true برای مرتب کردن دایرکتوری ها برای اولین بار در درخت پروژه",
  "DESCRIPTION_SPACE_UNITS": "تعداد فضاهای مورد استفاده برای تورفتگی مبتنی بر فضا",
  "DESCRIPTION_STATIC_SERVER_PORT": "شماره پورت که سرور داخلی باید برای پیش نمایش زنده استفاده کند",
  "DESCRIPTION_STYLE_ACTIVE_LINE": "درست برای برجسته کردن رنگ پس زمینه خطی که مکان نما روشن است",
  "DESCRIPTION_TAB_SIZE": "تعداد فضاهای برای نمایش برای زبانه ها",
  "DESCRIPTION_USE_TAB_CHAR": "درست است که از زبانه ها به جای فاصله استفاده کنید",
  "DESCRIPTION_UPPERCASE_COLORS": "درست برای تولید رنگ سحر و جادو بزرگ در درون خطی ویرایشگر رنگ",
  "DESCRIPTION_WORD_WRAP": "خطوطی را که بیش از عرض دید هستند قرار دهید",
  "DESCRIPTION_SEARCH_AUTOHIDE": "به محض متمرکز شدن ویرایشگر، جستجو را ببندید",
  "DESCRIPTION_DETECTED_EXCLUSIONS": "لیستی از فایل هایی که شناسایی شده اند باعث می شوند پرستوی دریایی از کنترل خارج شود",
  "DESCRIPTION_INFERENCE_TIMEOUT": "مقدار زمانی که پس از آن Tern زمان خواهد شد زمانی که تلاش برای درک فایل ها",
  "DESCRIPTION_SHOW_ERRORS_IN_STATUS_BAR": "true برای نشان دادن خطا در نوار وضعیت",
  "DESCRIPTION_QUICK_VIEW_ENABLED": "درست برای فعال کردن نمایش سریع",
  "DESCRIPTION_EXTENSION_LESS_IMAGE_PREVIEW": "درست برای نشان دادن پیش نمایش تصویر برای URL های از دست رفته پسوند",
  "DESCRIPTION_THEME": "یک قالب {APP_NAME} انتخاب کنید",
  "DESCRIPTION_USE_THEME_SCROLLBARS": "درست اجازه می دهد تا میله اسکرول سفارشی",
  "DESCRIPTION_LINTING_COLLAPSED": "درست به سقوط پانل linting",
  "DESCRIPTION_FONT_FAMILY": "تغییر خانواده فونت",
  "DESCRIPTION_FONT_SIZE": "تغییر اندازه فونت؛ به عنوان مثال 13px",
  "DESCRIPTION_FIND_IN_FILES_NODE": "درست برای فعال کردن جستجوی مبتنی بر گره",
  "DESCRIPTION_FIND_IN_FILES_INSTANT": "درست برای فعال کردن جستجوی فوری",
  "DESCRIPTION_FONT_SMOOTHING": "فقط MAC: «subpixel-antialiased» برای فعال کردن ضد عفونی کننده زیر پیکسل یا «antialiased» برای مقیاس خاکستری",
  "DESCRIPTION_OPEN_PREFS_IN_SPLIT_VIEW": "false برای غیر فعال کردن باز کردن فایل تنظیمات در نمای تقسیم",
  "DESCRIPTION_OPEN_USER_PREFS_IN_SECOND_PANE": "نادرست برای باز کردن تنظیمات کاربر فایل در چپ/پنجره بالا",
  "DESCRIPTION_MERGE_PANES_WHEN_LAST_FILE_CLOSED": "درست است که پانل ها را پس از آخرین فایل از پنجره از طریق دکمه بستن هدر پنجره بسته شود",
  "DESCRIPTION_SHOW_PANE_HEADER_BUTTONS": "ضامن زمانی که برای نشان دادن دکمه نزدیک و فلیپ نمایش در هدر.",
  "DEFAULT_PREFERENCES_JSON_HEADER_COMMENT": "/*\n * این یک فایل فقط خواندنی با تنظیمات پشتیبانی شده است\n * توسط {APP_NAME}.\n * استفاده از این فایل به عنوان یک مرجع برای تغییر تنظیمات خود را\n * فایل «brackets.json» باز در پنجره دیگر.\n * برای کسب اطلاعات بیشتر در مورد نحوه استفاده از تنظیمات در داخل\n * {APP_NAME}، به صفحه وب به آدرس https://github.com/adobe/brackets/wiki/How-to-Use-Brackets#preferences مراجعه کنید\n */",
  "DEFAULT_PREFERENCES_JSON_DEFAULT": "پیش فرض",
  "DESCRIPTION_PURE_CODING_SURFACE": "درست برای فعال کردن حالت کد تنها و مخفی کردن تمام عناصر UI دیگر در {APP_NAME}",
  "DESCRIPTION_INDENT_LINE_COMMENT": "درست برای فعال کردن تورفتگی از نظرات خط",
  "DESCRIPTION_RECENT_FILES_NAV": "فعال/غیر فعال کردن ناوبری در فایل های اخیر",
  "DESCRIPTION_LIVEDEV_WEBSOCKET_PORT": "پورت که WebSocket سرور اجرا می شود برای پیش نمایش زنده",
  "DESCRIPTION_LIVE_DEV_HIGHLIGHT_SETTINGS": "پیش نمایش زنده تنظیمات برجسته",
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "نادرست برای غیر فعال کردن پیش نمایش زنده معکوس بازرسی",
  "DOWNLOAD_FAILED": "دانلود شکست خورد.",
  "DOWNLOAD_COMPLETE": "دانلود کامل شد!",
  "UPDATE_SUCCESSFUL": "به روز رسانی موفق!",
  "UPDATE_FAILED": "به روز رسانی ناموفق!",
  "VALIDATION_FAILED": "اعتبار شکست خورد!",
  "INITIALISATION_FAILED": "مقداردهی اولیه شکست خورد!",
  "CLEANUP_FAILED": "تمیز کردن شکست خورد!",
  "WARNING_TYPE": "هشدار!",
  "CLICK_RESTART_TO_UPDATE": "کلیک راه اندازی مجدد برای به روز رسانی براکت.",
  "UPDATE_ON_NEXT_LAUNCH": "به روز رسانی خواهد شد در راه اندازی مجدد اعمال می شود.",
  "GO_TO_SITE": "برای امتحان مجدد به <a href = \"http://brackets.io/ «> brackets.io </a> بروید.",
  "INTERNET_UNAVAILABLE": "بدون اتصال به اینترنت در دسترس.",
  "UPDATEDIR_READ_FAILED": "دایرکتوری به روز رسانی نمی تواند خوانده شود.",
  "UPDATEDIR_CLEAN_FAILED": "دایرکتوری به روز رسانی نمی تواند تمیز شود.",
  "INITIAL_DOWNLOAD": "در حال بارگیری بهروزرسانی...",
  "RETRY_DOWNLOAD": "دانلود شکست خورد. تلاش مجدد... تلاش ",
  "VALIDATING_INSTALLER": "دانلود کامل شد! تأیید اعتبار نصب...",
  "CHECKSUM_DID_NOT_MATCH": "چکسام مطابقت نداشت",
  "INSTALLER_NOT_FOUND": "نصب یافت نشد.",
  "DOWNLOAD_ERROR": "خطا در هنگام دانلود رخ داده است.",
  "NETWORK_SLOW_OR_DISCONNECTED": "شبکه قطع شده یا خیلی آهسته است.",
  "RESTART_BUTTON": "راهاندازی مجدد",
  "LATER_BUTTON": "بعدا",
  "DESCRIPTION_AUTO_UPDATE": "فعال/غیر فعال کردن براکت خودکار به روز رسانی",
  "AUTOUPDATE_ERROR": "خطا!",
  "AUTOUPDATE_IN_PROGRESS": "به روز رسانی در حال حاضر در حال انجام است.",
  "NUMBER_WITH_PERCENTAGE": "{0}%",
  "CMD_FIND_RELATED_FILES": "فایلهای مرتبط را پیدا کنید",
  "PHP_VERSION_INVALID": "خطا در تجزیه نسخه پی اچ پی. لطفا خروجی دستور «php —version» را بررسی کنید.",
  "PHP_UNSUPPORTED_VERSION": "زمان اجرا PHP7 را برای فعال کردن ابزارهای مرتبط با PHP مانند نکات کد، نکات پارامتر، پرش به تعریف و موارد دیگر نصب کنید. نسخه یافت شده: {0}",
  "PHP_EXECUTABLE_NOT_FOUND": "پی اچ پی در زمان اجرا یافت نشد. زمان اجرا PHP7 را نصب کنید و «ExecutablePath» را در تنظیمات PHP مناسب به روز کنید. این ابزار مربوط به PHP مانند نکات کد، نکات پارامتر، پرش به تعریف و موارد دیگر را قادر می سازد.",
  "PHP_PROCESS_SPAWN_ERROR": "کد خطا {0} مواجه می شوند در حالی که شروع فرایند پی اچ پی.",
  "PHP_SERVER_ERROR_TITLE": "خطا",
  "PHP_SERVER_MEMORY_LIMIT_INVALID": "محدودیت حافظه ای که ارائه داده اید نامعتبر است. برای تنظیم مقدار صحیح، تنظیمات PHP را مرور کنید.",
  "DESCRIPTION_PHP_TOOLING_CONFIGURATION": "تنظیمات پیکربندی پیش فرض PHP Tooling",
  "OPEN_PREFERENNCES": "تنظیمات باز",
  "LANGUAGE_TOOLS_PREFERENCES": "تنظیمات برای ابزارهای زبان",
  "FIND_ALL_REFERENCES": "یافتن همه منابع",
  ...
  "REMOTE_DEBUGGING_ENABLED": "اشکال زدایی از راه دور فعال در localhost",
  "REMOTE_DEBUGGING_PORT_INVALID": "امکان فعال کردن دیباگ از راه دور روی پورت {0} وجود ندارد. شماره‌های درگاه باید بین {۱} و {۲} باشد.",
  "DESCRIPTION_EXTERNAL_APPLICATION_ASSOCIATE": "نقشه برای پسوند فایل به برنامه های خارجی. Syntax: \"<file_type>«: «<Default|ApplicationName|ApplicationPath>»، از «پیش فرض» برای باز کردن فایل ها در برنامه پیش فرض سیستم برای نوع فایل استفاده کنید.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "فایل های گرافیکی را در ویراستاران خارجی باز کنید.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "پوشه فعلی شما دارای انواع فایل های گرافیکی است که توسط {APP_NAME} پشتیبانی نمی شوند. <br/>شماهم اکنون می توانید انواع فایل های خاص را با ویراستاران خارجی مرتبط کنید. پس از ارتباط، شما می توانید فایل های گرافیکی مانند xd، .psd، .jpg، .png، .ai، .svg را در برنامه های پیش فرض خود با دوبار کلیک کردن بر روی فایل های موجود در File Tree باز کنید. <br/><br/>لطفابر روی دکمه «Ok» کلیک کنید تا انواع فایل های گرافیکی را با برنامه های پیش فرض مربوطه مرتبط کنید.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "انواع فایل های زیر با موفقیت با برنامه های پیش فرض مرتبط شده اند. <br/>{0} شما باید گزینه ای برای تغییر اولویت خود را در مورد اینکه آیا شما حذف/اضافه کردن انجمن نوع فایل جدید در brackets.json با رفتن به «اشکال زدایی->باز کردن فایل تنظیمات» منو.",
  "UNSUPPORTED_BROWSER": "مرورگر پشتیبانی نمی شود",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "مرورگر پوشه باز را پشتیبانی نمی کند",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "لطفاً از یکی از مرورگرهای پشتیبانی شده در زیر استفاده کنید.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " ما سخت کار می کنیم تا ققنوس را در مرورگرهای بیشتری در دسترس قرار دهیم. شما ممکن است این گفتگو را ببندید، اما برخی از ویژگی های Phoenix در این مرورگر کار نمی کنند.",
  "CANNOT_PUBLISH_LARGE_PROJECT": "نمی تواند پروژه بزرگ را منتشر کند",
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "ققنوس هنوز در آلفای آزمایشی است. ما هنوز همگام سازی پروژه های با بیش از 500 فایل را فعال نکرده ایم.",
  "SHARE_WEBSITE": "انتشار و به اشتراک گذاری وب سایت؟",
  "PUBLISH": "انتشار",
  "PUBLISH_CONSENT_MESSAGE": "به سرعت پیش نمایش تغییرات و به اشتراک گذاری وب سایت خود را با دیگران. فینیکس می‌تواند این وب‌گاه را با شماره {۰} برای شما منتشر کند. پیوندهای منتشر شده برای مدت 7 روز معتبر خواهند بود. </br>آیامی خواهید وب سایت خود را منتشر و به اشتراک بگذارید؟",
  "PUBLISH_SYNC_IN_PROGRESS": "همگام سازی در حال انجام برای پیش نمایش...",
  "PUBLISH_PAGE": "برای انتشار و به اشتراک گذاری این سایت کلیک کنید",
  "PUBLISH_VIEW_PAGE": "برای مشاهده صفحه منتشر شده کلیک کنید",
  "MISSING_FIELDS": "زمینه های گم شده",
  "PLEASE_FILL_ALL_REQUIRED": "لطفا تمام فیلدهای مورد نیاز را با رنگ قرمز پر کنید",
  "CODE_EDITOR": "ویرایشگر کد",
  "BUILD_THE_WEB": "ساخت وب",
  "IMPORT_PROJECT": "پروژه واردات",
  "GITHUB_PROJECT": "پروژه گیتهاب",
  "NEW_PROJECT_FROM_GITHUB": "پروژه جدید از گیتهاب",
  "GITHUB_REPO_URL": "آدرس مخزن گیتهاب:",
  "CREATE_PROJECT": "ایجاد پروژه",
  "SETTING_UP_PROJECT": "راه اندازی پروژه",
  "LOCATION": "محل سکونت:",
  "DOWNLOADING": "در حال بارگیری...",
  "DOWNLOAD_FAILED_MESSAGE": "اطمینان حاصل کنید که URL بارگیری معتبر است. </br>NB: همانطور که ققنوس در آلفا است، آدرس های خصوصی Repos و Github بزرگتر از 25 مگابایت مجاز نیست.",
  "PLEASE_SELECT_A_FOLDER": "لطفا یک پوشه را انتخاب کنید...",
  "UNZIP_IN_PROGRESS": "باز کردن فایل ها...",
  "UNZIP_FAILED": "خطا: باز کردن زیپ شکست خورد.",
  "CONFIRM_REPLACE_TITLE": "تأیید جایگزینی",
  ...
  "VIEW_MORE": "مشاهده موارد بیشتر...",
  "NEW_PROJECT_NOTIFICATION": "برای<br/>ایجاد یک پروژه جدید روی این آیکون کلیک کنید. </br> <a href='#' style='float:right;'>باشه</a>",
  "DEFAULT_PROJECT_NOTIFICATION": "برای باز کردن<b>پروژه <br/>پیش فرض</b> در ققنوس اینجا را کلیک کنید. </br> <a href='#' style='float:right;'>باشه</a>",
  "DIRECTORY_REPLACE_MESSAGE": "پوشه انتخاب شده <span class='dialog-filename'>{0}</span> خالی نیست. آیا مطمئن هستید که می خواهید محتویات پوشه را با پروژه جایگزین کنید؟",
  "BUILD_WEBSITE_SECTION": "ساخت وب سایت",
  "LEARN_SECTION": "با مثالها یاد بگیرید",
  "WEBPAGE_HOME_PAGE": "صفحه اصلی پوسته",
  "WEBPAGE_BLOG": "وبلاگ صفحه",
