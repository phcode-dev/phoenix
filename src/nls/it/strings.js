...
define({
  ...
  "CMD_HOMEPAGE": "Pagina iniziale - Scarica app",
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME} <strong>non raccoglie né elabora alcuna informazione di identificazione personale</strong> , ma <strong>raccoglie statistiche di utilizzo anonime</strong> per proteggere la tua privacy. I dati anonimi sono esenti dai requisiti di notifica GDPR/CCPA, ma riteniamo che tu debba avere la possibilità di scegliere di disattivare la raccolta di dati anonimi.<br> Queste statistiche <strong>anonime</strong> sull&#39;utilizzo delle app e le segnalazioni di errori ti aiutano a dare priorità alle funzionalità, a trovare bug e a individuare problemi di usabilità per la tua esperienza con {APP_NAME}.</p><p> Di seguito è riportata un&#39;anteprima dei dati che verranno inviati nel prossimo Rapporto sanitario <em>se</em> è abilitato. (Vedi anche la console per sviluppatori per i log degli errori contrassegnati con &quot;Errore critico rilevato&quot;.)</p>",
  ...
  "NEW_PROJECT_NOTIFICATION": "Fare clic su questa icona per creare un nuovo progetto.</br><img src=\"styles/images/new_project.png\"><br/> <a href='#' style='float:right;'>OK</a>",
