...
define({
  ...
  "UPDATE_READY_RESTART_MESSAGE": "Chiudi tutte le finestre di {APP_NAME} e riavvia l'app per avviare la versione aggiornata.",
  "UPDATE_FAILED_TITLE": "Aggiornamento non riuscito",
  "UPDATE_FAILED_MESSAGE": "Chiudi tutte le finestre di {APP_NAME} e riapri l'applicazione per tentare nuovamente l'aggiornamento.",
