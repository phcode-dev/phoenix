...
define({
  ...
  "INCLUDE_FILE_FILTER": "Includi {0}",
  "EXCLUDE_FILE_FILTER_DROPDOWN": "Escludere",
  "INCLUDE_FILE_FILTER_DROPDOWN": "Includere",
  "EDIT_FILE_FILTER": "Modifica…",
  "FILE_FILTER_DIALOG": "Modifica filtro di esclusione",
  "FILE_FILTER_INSTRUCTIONS": "Escludi file e cartelle che corrispondono a uno qualsiasi dei seguenti <a href='{0}' title=\"{0}\">caratteri jolly da ignorare</a> . Inserisci ogni stringa su una nuova riga. Per esempio<ul><li> <code>*.js</code> corrisponderà <code>a/b/x.js</code> , <code>xyx.js</code> , ecc..</li><li> <code>./*.css</code> corrisponderà solo <code>x.css</code> nella radice del progetto, ma non <code>y/x.css</code> nella sottocartella.</li></ul>",
  "FILE_FILTER_INSTRUCTIONS_INCLUDE": "Include solo i file e le cartelle che corrispondono a uno qualsiasi dei seguenti <a href='{0}' title=\"{0}\">caratteri jolly da ignorare</a> . Inserisci ogni stringa su una nuova riga. Per esempio<ul><li> <code>*.js</code> corrisponderà <code>a/b/x.js</code> , <code>xyx.js</code> , ecc..</li><li> <code>./*.css</code> corrisponderà solo <code>x.css</code> nella radice del progetto, ma non <code>y/x.css</code> nella sottocartella.</li></ul>",
  ...
  "UPDATE_UP_TO_DATE": "La tua versione di {APP_NAME} è la più recente e la migliore!",
  ...
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>Safari cancella automaticamente i dati del sito web se un sito non viene rivisitato entro 7 giorni. {APP_NAME} si affida allo spazio di archiviazione del browser per salvare i tuoi progetti, che potrebbero essere rimossi a causa di questa norma.<br/><br/> <strong>Per evitare la perdita di dati</strong> , <strong>scarica</strong> i tuoi progetti prima di chiudere la scheda o resta sintonizzato per le nostre <strong>prossime app Web e native per Mac/iOS</strong> .</span>",
