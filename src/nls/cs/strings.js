...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "V aktuálním projektu nebyl zjištěn soubor <code>package.json</code> . Je aktuální projekt platným rozšířením {APP_NAME}?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "soubor <code>package.json</code> je neplatný JSON.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "V <code>package.json</code> chybí povinná pole: [{0}]",
