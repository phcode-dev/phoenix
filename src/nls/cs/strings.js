...
define({
  ...
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>Safari automaticky odstraní data webových stránek, pokud web znovu nenavštívíte do 7 dnů. Aplikace {APP_NAME} při ukládání vašich projektů spoléhá na úložiště prohlížeče, které může být kvůli této zásadě odstraněno.<br/><br/> <strong>Chcete-li zabránit ztrátě dat</strong> , <strong>stáhněte si</strong> své projekty před zavřením karty nebo zůstaňte naladěni na naše <strong>připravované webové a nativní aplikace pro Mac/iOS</strong> .</span>",
