...
define({
  ...
  "ERROR_PREFS_RESET_TITLE": "Nastavení Resetovat - Je vyžadován restart",
  ...
  "ERROR_PREFS_CORRUPT_RESET": "Vaše nastavení aplikace {APP_NAME} byla poškozena a byla resetována. Restartujte prosím {APP_NAME}, aby se změny projevily.",
  ...
  "UNSUPPORTED_DOM_APIS_CONFIRM": "Rozhraní API `window.confirm` a `window.prompt` nejsou ve vloženém živém náhledu aplikace {APP_NAME} k dispozici. Chcete-li používat tato rozhraní API v prohlížeči, vysuňte živý náhled.",
  ...
  "LIVE_DEV_SETTINGS_BANNER": "Nastavte vlastní server pro živý náhled ` <b>{0}</b> ` a další soubory vykreslované serverem (PHP, JSP atd.)",
  "LIVE_DEV_SETTINGS_TITLE": "Nastavení živého náhledu",
  "LIVE_DEV_SETTINGS_STARTUP": "Zobrazit panel živého náhledu při spuštění",
  "LIVE_DEV_SETTINGS_SERVER_PREFERENCE": "true pro umožnění vlastního vývojového serveru",
  "LIVE_DEV_SETTINGS_STARTUP_PREFERENCE": "true pro zobrazení panelu živého náhledu při spuštění",
  "LIVE_DEV_SETTINGS_HOT_RELOAD_PREFERENCE": "true, pokud server podporuje opětovné načtení za běhu a zakázat opětovné načtení živého náhledu při uložení",
  "LIVE_DEV_SETTINGS_USE_SERVER": "Pro tento projekt použít Custom Development Server",
  "LIVE_DEV_SETTINGS_SERVE_PREFERENCE": "URL vašeho vývojového serveru pro projekt, např. http://localhost:8000/php",
  "LIVE_DEV_SETTINGS_SERVER_INBUILT": "Např. http://localhost:8000/php – V současné době se používá vestavěný server.",
  "LIVE_DEV_SETTINGS_SERVER_ROOT": "Obslužná složka v projektu",
  "LIVE_DEV_SETTINGS_SERVER_ROOT_HELP": "Např. www/ (výchozí je /)",
  "LIVE_DEV_SETTINGS_SERVER_ROOT_PREF": "Cesta v rámci projektu obsluhovaná vývojovým serverem Např. www/ (výchozí je /)",
  "LIVE_DEV_SETTINGS_RELOAD": "Server podporuje horké znovu načtení",
  "LIVE_DEV_SETTINGS_RELOAD_HELP": "Některé servery podporují opětovné načtení za chodu, kde jsou změny kódu přeneseny na stránku bez úplného opětovného načtení stránky.\nPovolte tuto funkci, pokud nechcete, aby aplikace {APP_NAME} znovu načítala stránku při každém uložení.",
  "LIVE_DEV_SETTINGS_FRAMEWORK": "Server Framework",
  "LIVE_DEV_SETTINGS_FRAMEWORK_CUSTOM": "Zvyk",
  "LIVE_DEV_SETTINGS_FRAMEWORK_PREFERENCES": "Server Framework, aktuálně podporuje pouze docusaurus",
  ...
  "FIND_IN_FILES_PROJECT_SCOPE": "Najít v projektu",
  "FIND_IN_FILES_PROJECT_SCOPE_FILTER": "Najít v {0}",
  ...
  "COPY_ERROR": "Problém s kopírováním",
  "FIX": "Opravit",
  ...
  "CMD_REOPEN_CLOSED": "Znovu otevřete uzavřený soubor",
  ...
  "CMD_OPEN_IN_DEFAULT_APP": "Výchozí aplikace systému",
  ...
  "HELP_MENU": "Nápověda",
  "CMD_CHECK_FOR_UPDATE": "Kontrola aktualizací…",
  ...
  "UPDATE_READY_RESTART_INSTALL_MESSAGE": "Aplikace {APP_NAME} se automaticky aktualizuje, když zavřete všechna otevřená okna.",
  ...
  "UPDATE_FAILED_MESSAGE": "Zavřete všechna okna aplikace {APP_NAME} a znovu aplikaci otevřete, abyste se mohli pokusit o aktualizaci znovu.<br/> Aktualizaci můžete také nainstalovat stažením instalačního programu z <a href='https://phcode.io'>phcode.io</a>",
  ...
  "GET_IT_NOW": "Stáhnout!",
  "UPDATE_ON_EXIT": "Aktualizace při ukončení",
  ...
  "CMD_BUILD_TESTS": "Testy editoru sestavení",
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "Aplikace {APP_NAME} <strong>neshromažďuje ani nezpracovává žádné osobní údaje</strong> , ale <strong>shromažďuje anonymní statistiky používání</strong> , aby chránila vaše soukromí. Anonymní údaje jsou vyňaty z požadavků na oznamování GDPR/CCPA, ale věříme, že musíte mít také možnost odhlásit se z anonymního shromažďování údajů.<br><br> Svá data můžete zobrazit nebo <strong>se rozhodnout nesdílet žádná anonymní data</strong> výběrem položky <strong>Nápověda &gt; Zpráva o stavu</strong> . Tyto <strong>anonymní</strong> statistiky používání aplikací a hlášení o chybách pomáhají upřednostňovat funkce, odhalovat chyby a odhalovat problémy s použitelností za účelem zlepšení vašeho prostředí s aplikací {APP_NAME}. Bez těchto dat bychom nevěděli, jaké funkce pro vás stojí za to budovat!<br><br>",
  "HEALTH_DATA_PREVIEW": "Hlášení o zdraví {APP_NAME}",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Aplikace {APP_NAME} <strong>neshromažďuje ani nezpracovává žádné osobní údaje</strong> , ale <strong>shromažďuje anonymní statistiky používání,</strong> aby chránila vaše soukromí. Tyto <strong>anonymní</strong> statistiky používání aplikací a hlášení o chybách pomáhají upřednostňovat funkce, odhalovat chyby a odhalovat problémy s použitelností za účelem zlepšení vašeho prostředí s aplikací {APP_NAME}.</p><p> Níže je uveden náhled dat, která budou odeslána ve vaší další zdravotní zprávě, <em>pokud</em> je povolena. (Prohlédněte si také vývojářskou konzoli, kde najdete protokoly chyb označené jako „Zachycena kritická chyba“.)</p>",
  ...
  "CSS_LINT_NAME": "{0}",
  "HTML_LINT_NAME": "HTML",
  "HTML_LINT_CONFIG_JSON_ERROR": "Chyba: Konfigurační soubor HTML Validator „{0}“ není platný JSON",
  ...
  "DESCRIPTION_JSHINT_DISABLE": "true pro deaktivaci JSHints linter v panelu problémů",
  "DESCRIPTION_ESLINT_DISABLE": "true pro deaktivaci ESLint linter v panelu problémů",
  "DESCRIPTION_HTML_LINT_DISABLE": "true pro zakázání HTML linter v panelu problémů",
  "DESCRIPTION_ESLINT_FAILED": "ESLint se nezdařil ({0}). Ujistěte se, že projekt obsahuje platné <a href='https://eslint.org/docs/latest/use/configure/configuration-files'>konfigurační soubory</a>",
  "DESCRIPTION_ESLINT_USE_NATIVE_APP": "ESLint je k dispozici pouze v aplikaci Desktop. Stáhněte si jej z <a href='https://phcode.io'>phcode.io</a>",
  "DESCRIPTION_ESLINT_LOAD_FAILED": "Nepodařilo se načíst ESLint pro tento projekt. {APP_NAME} podporuje pouze verze ESLint vyšší než 7.",
  "DESCRIPTION_ESLINT_DO_NPM_INSTALL": "Pro aktivaci ESLint spusťte na svém projektu `npm install`",
  ...
  "DESCRIPTION_RULERS_COLUMNS": "Pole čísel sloupců pro kreslení svislých pravítek v editoru. Např.: [80, 100]",
  "DESCRIPTION_RULERS_COLORS": "Pole barev pravítek odpovídající možnosti pravítek v editoru. Např.: [\"#3d3d3d\", \"červená\"]",
  ...
  "DESCRIPTION_EDITOR_LINE_HEIGHT": "Upravte svislé mezery mezi řádky kódu v editoru. Vyberte hodnotu mezi 1 a 3, výchozí je 1,5",
  ...
  "DESCRIPTION_AUTO_UPDATE": "Povolit/zakázat automatickou aktualizaci aplikace {APP_NAME}",
  ...
  "PUBLISH": "Publikovat",
  "PUBLISH_CONSENT_MESSAGE": "Rychlý náhled změn a sdílení vašeho webu s ostatními. Aplikace {APP_NAME} vám může publikovat tento web na adrese {0}. Zveřejněné odkazy budou platné po dobu 3 dnů. </br>Přejete si zveřejnit a sdílet svůj web?",
  ...
  "GIT_PROJECT": "Získejte z Git",
  "NEW_PROJECT_FROM_GIT": "Nový projekt od Git",
  "GIT_REPO_URL": "Adresa URL úložiště Git:",
  "GIT_CLONE_URL": "Adresa URL klonování Git:",
  "START_PROJECT": "Zahájit projekt…",
  "DOWNLOAD_DESKTOP_APP": "Stáhněte si aplikaci pro stolní počítače",
  "GET_DESKTOP_APP": "Získejte desktopovou aplikaci",
  "CREATE_PROJECT": "Vytvořit projekt",
  "SETTING_UP_PROJECT": "Nastavení projektu",
  "LOCATION": "umístění:",
  "ERROR_ONLY_GITHUB": "Verze prohlížeče {APP_NAME} podporuje pouze adresy URL GitHub. Chcete-li pracovat s jinými adresami URL Git, použijte aplikaci pro počítače.",
  "ERROR_GIT_URL_INVALID": "Zadejte prosím platnou adresu URL klonu Git.",
  "ERROR_GIT_FOLDER_NOT_EMPTY": "Složku Selected nelze použít pro klon Git, protože není prázdná nebo je nečitelná.",
  "ERROR_GIT_FOLDER_NOT_EXIST": "Složku Selected nelze použít pro klon Git, protože neexistuje.",
  "ERROR_CLONING_TITLE": "Klon Git se nezdařil",
  ...
  "DOWNLOAD_FAILED_MESSAGE": "Ujistěte se, že adresa URL ke stažení je platná. </br>Poznámka: Jelikož je Phoenix zdarma, soukromé repozitáře a adresy URL GitHub větší než 25 MB nejsou povoleny.",
  ...
  "NEW_PROJECT_NOTIFICATION": "Klepnutím na tuto ikonu znovu otevřete okno „Nový projekt“.</br> Viz Nedávné projekty, Otevřít složku nebo spustit projekty ze šablon.</br><img src=\"styles/images/new_project.png\"><br/> <a href='#' style='float:right;'>OK</a>",
  ...
  "GITHUB_STARS_POPUP": "<div>Vaše podpora pomáhá našemu malému týmu motivovanému k tomu, aby byl <b style='color: darkblue'>phcode.dev</b> ještě lepší.<br/> Označte nás hvězdičkou nebo zvažte sponzorování na GitHubu:",
  ...
  "ADD_ENDLINE_TO_THE_END_OF_FILE": "Přidejte koncovou čáru na konec souboru",
  "ADD_TO_GITIGNORE": "Přidat do .gitignore",
  "AMEND_COMMIT": "Upravit poslední potvrzení",
  "SKIP_COMMIT_CHECKS": "Přeskočit kontroly před potvrzením (--no-verify)",
  "AMEND_COMMIT_FORBIDDEN": "Nelze upravit odevzdání, pokud neexistují žádné neodložené odevzdání",
  "_ANOTHER_BRANCH": "další větev",
  "AUTHOR": "Autor",
  "AUTHORS_OF": "Autoři",
  ...
  "CHECKOUT_COMMIT": "Pokladna",
  "CHECKOUT_COMMIT_DETAIL": "<b>Potvrdit zprávu:</b> {0}<br> <b>Potvrdit hash:</b> {1}",
  "GIT_CLONE": "Klonovat",
  "BUTTON_CLOSE": "Zavřít",
  "BUTTON_COMMIT": "Spáchat",
  "BUTTON_DEFAULTS": "Obnovit výchozí",
  "BUTTON_FIND_CONFLICTS": "Najít konflikty…",
  "GIT_INIT": "Teplo",
  "BUTTON_MERGE_ABORT": "Přerušit sloučení",
  "BUTTON_OK": "OK",
  "BUTTON_REBASE_ABORT": "Potratit",
  "BUTTON_REBASE_CONTINUE": "Pokračujte v přestavbě",
  "BUTTON_REBASE_SKIP": "Přeskočit",
  "MENU_RESET_HARD": "Po tomto zahodit změny a potvrzení (hard reset)",
  "MENU_RESET_MIXED": "Poté zahoďte odevzdání, ale ponechte změny nepřipravené (smíšený reset)",
  "MENU_RESET_SOFT": "Poté zrušte odevzdání, ale ponechte změny připravené (soft reset)",
  "MENU_TAG_COMMIT": "Označit závazek",
  "RESET_HARD_TITLE": "Potvrďte tvrdý reset",
  "RESET_MIXED_TITLE": "Potvrďte smíšený reset",
  "RESET_SOFT_TITLE": "Potvrďte měkký reset",
  "RESET_DETAIL": "<b>Závazky po následujícím budou vyřazeny:</b><br> <b>Potvrdit zprávu:</b> {0}<br> <b>Příkaz Git:</b> {1}",
  "RESET_HARD_MESSAGE": "Tato akce zruší všechny změny a potvrzení po vybraném potvrzení. <b>Tuto operaci nelze snadno vrátit zpět.</b> Opravdu chcete pokračovat?<br><br> ⚠️ Varování: Toto přepíše historii a nemělo by se používat u revizí, které byly odeslány do sdílené větve.",
  "RESET_MIXED_MESSAGE": "Tato akce zruší všechny odevzdání po vybraném odevzdání, ale všechny změny zůstanou nepřipravené. <b>Tuto operaci nelze snadno vrátit zpět.</b> Opravdu chcete pokračovat?<br><br> ⚠️ Varování: Toto přepíše historii a nemělo by se používat u revizí, které byly odeslány do sdílené větve.",
  "RESET_SOFT_MESSAGE": "Tato akce zruší všechna potvrzení po vybraném potvrzení, ale ponechá všechny změny připravené pro nové potvrzení. <b>Tuto operaci nelze snadno vrátit zpět.</b> Opravdu chcete pokračovat?<br><br> ⚠️ Varování: Toto přepíše historii a nemělo by se používat u revizí, které byly odeslány do sdílené větve.",
  "BUTTON_SAVE": "Uložit",
  "RESET": "Resetovat",
  "CHANGE_USER_EMAIL_TITLE": "Změňte git email",
  "CHANGE_USER_EMAIL": "Změnit git email…",
  "CHANGE_USER_EMAIL_MENU": "Změnit e-mail git ({0})…",
  "CHANGE_USER_NAME_TITLE": "Změňte uživatelské jméno git",
  "CHANGE_USER_NAME": "Změnit uživatelské jméno git…",
  "CHANGE_USER_NAME_MENU": "Změnit uživatelské jméno git ({0})…",
  "REQUIRES_APP_RESTART_SETTING": "Změna tohoto nastavení se projeví až po restartování aplikace",
  "CLEAN_FILE_END": "Soubor vyčištěn",
  "CLEAN_FILE_START": "Čisticí soubor",
  "CLEANING_WHITESPACE_PROGRESS": "Čištění mezer v souborech…",
  "CLEAR_WHITESPACE_ON_FILE_SAVE": "Vymazat mezery při uložení souboru",
  "CLONE_REPOSITORY": "Klonovací úložiště",
  "CODE_INSPECTION_PROBLEMS": "Problémy s kontrolou kódu",
  "CODE_INSPECTION_IN_PROGRESS": "Probíhá kontrola kódu…",
  "CODE_INSPECTION_PROBLEMS_NONE": "Nebyly zjištěny žádné problémy",
  "CODE_INSPECTION_DONE_FILES": "Dokončeno {0} z {1} souborů…",
  "PLEASE_WAIT": "Čekejte prosím…",
  "COMMIT": "Spáchat",
  "COMMIT_ALL_SHORTCUT": "Potvrdit všechny soubory…",
  "COMMIT_CURRENT_SHORTCUT": "Potvrdit aktuální soubor…",
  "COMMIT_MESSAGE_PLACEHOLDER": "Zde zadejte zprávu o potvrzení…",
  "CREATE_NEW_BRANCH": "Vytvořit novou pobočku…",
  "CREATE_NEW_BRANCH_TITLE": "Vytvořte novou větev",
  "CREATE_NEW_GITFTP_SCOPE": "Vytvořit nový vzdálený Git-FTP…",
  "CREATE_NEW_REMOTE": "Vytvořit nový dálkový ovladač…",
  "CURRENT_TRACKING_BRANCH": "Aktuální sledovací větev",
  "_CURRENT_TRACKING_BRANCH": "aktuální sledovací větev",
  "DEFAULT_GIT_TIMEOUT": "Výchozí časový limit operace Git (v sekundách)",
  "DELETE_FILE_BTN": "Smazat soubor…",
  "DELETE_LOCAL_BRANCH": "Smazat místní pobočku",
  "DELETE_LOCAL_BRANCH_NAME": "Opravdu si přejete smazat místní pobočku „{0}“?",
  "DELETE_REMOTE": "Smazat dálkové ovládání",
  "DELETE_REMOTE_NAME": "Opravdu si přejete smazat vzdálené „{0}“?",
  "DELETE_SCOPE": "Smazat rozsah Git-FTP",
  "DELETE_SCOPE_NAME": "Opravdu si přejete smazat rozsah Git-FTP „{0}“?",
  "DIALOG_CHECKOUT": "Při odhlašování odevzdání přejde repo do stavu DETACHED HEAD. Nemůžete provádět žádné odevzdání, pokud na tomto základě nevytvoříte větev.",
  "DIALOG_PULL_TITLE": "Vytáhněte z dálkového ovladače",
  "DIALOG_PUSH_TITLE": "Zatlačte na dálkové ovládání",
  "SKIP_PRE_PUSH_CHECKS": "Přeskočit kontroly před odesláním (--no-verify)",
  "DIFF": "Dif",
  "DIFFTOOL": "Diff s difftool",
  "DIFF_FAILED_SEE_FILES": "Git diff nedokázal poskytnout výsledky diff. Toto je seznam připravených souborů, které mají být odevzdány:",
  "DIFF_TOO_LONG": "Rozdíl je příliš dlouhý na zobrazení",
  "ENABLE_GERRIT_PUSH_REF": "Použijte Gerrit kompatibilní push ref",
  "ENTER_NEW_USER_EMAIL": "Zadejte email",
  "ENTER_NEW_USER_NAME": "Zadejte uživatelské jméno",
  "ENTER_PASSWORD": "Zadejte heslo:",
  "ENTER_REMOTE_GIT_URL": "Zadejte Git URL úložiště, které chcete klonovat:",
  "ENTER_REMOTE_NAME": "Zadejte název nového dálkového ovládání:",
  "ENTER_REMOTE_URL": "Zadejte adresu URL nového dálkového ovládání:",
  "ENTER_USERNAME": "Zadejte uživatelské jméno:",
  "ERROR_NOTHING_SELECTED": "Nic není vybráno!",
  "ERROR_SAVE_FIRST": "Nejprve uložte dokument!",
  "ERROR_TERMINAL_NOT_FOUND": "Terminál nebyl pro váš OS nalezen, v nastavení můžete definovat vlastní příkaz Terminál",
  "EXTENDED_COMMIT_MESSAGE": "ROZŠÍŘENÉ",
  "GETTING_STAGED_DIFF_PROGRESS": "Získávání rozdílu fázovaných souborů…",
  "GIT_COMMIT": "Git commit…",
  "GIT_COMMIT_IN_PROGRESS": "Git Commit probíhá",
  "GIT_DIFF": "Git diff &mdash;",
  "GIT_PULL_RESPONSE": "Odezva Git Pull",
  "GIT_PUSH_RESPONSE": "Odpověď Git Push",
  "GIT_REMOTES": "Dálkové ovladače Git",
  "GIT_SETTINGS": "Nastavení Git…",
  "GIT_SETTINGS_TITLE": "Nastavení Git",
  "GOTO_NEXT_GIT_CHANGE": "Přejděte na další změnu Git",
  "GOTO_PREVIOUS_GIT_CHANGE": "Přejít na předchozí změnu Git",
  "GUTTER_CLICK_DETAILS": "Kliknutím zobrazíte další podrobnosti",
  "HIDE_UNTRACKED": "Skrýt nesledované soubory v panelu",
  "HISTORY": "Dějiny",
  "HISTORY_COMMIT_BY": "podle",
  "LINES": "Čáry",
  "_LINES": "linky",
  "MARK_MODIFIED_FILES_IN_TREE": "Označte upravené soubory ve stromu souborů",
  "MERGE_BRANCH": "Sloučit větev",
  "MERGE_MESSAGE": "Sloučit zprávu",
  "MERGE_RESULT": "Výsledek sloučení",
  "NORMALIZE_LINE_ENDINGS": "Normalizovat konce řádků (na \\n)",
  "NOTHING_TO_COMMIT": "Není co zavazovat, pracovní adresář čistý.",
  "OPERATION_IN_PROGRESS_TITLE": "Probíhá operace Git…",
  "ORIGIN_BRANCH": "Pobočka původu",
  "ON_BRANCH": "'{0}' - Aktuální větev Git",
  "PANEL_COMMAND": "Zobrazit panel Git",
  "PASSWORD": "Heslo",
  "PASSWORDS": "Hesla",
  "PATH_TO_GIT_EXECUTABLE": "Cesta ke spustitelnému souboru Git",
  "PULL_AVOID_MERGING": "Vyhněte se ručnímu slučování",
  "PULL_DEFAULT": "Výchozí sloučení",
  "PULL_FROM": "Vytáhnout z",
  "PULL_MERGE_NOCOMMIT": "Sloučit bez závazku",
  "PULL_REBASE": "Použijte lišku",
  "PULL_RESET": "Použijte měkký reset",
  "PULL_SHORTCUT": "Vytáhněte z dálkového…",
  "PULL_SHORTCUT_BEHIND": "Zatáhněte z dálkového ovladače ({0} za)…",
  "PULL_BEHAVIOR": "Tahové chování",
  "FETCH_SHORTCUT": "Vyzvedněte na dálku",
  "PUSH_DEFAULT": "Výchozí push",
  "PUSH_DELETE_BRANCH": "Smazat vzdálenou pobočku",
  "PUSH_SEND_TAGS": "Odeslat značky",
  "PUSH_FORCED": "Nucený tlak",
  "PUSH_SHORTCUT": "Zatlačte na dálkové…",
  "PUSH_SHORTCUT_AHEAD": "Push to remote ({0} dopředu)…",
  "PUSH_TO": "Zatlačte na",
  "PUSH_BEHAVIOR": "Push chování",
  "Q_UNDO_CHANGES": "Obnovit změny v souboru <span class='dialog-filename'>{0}</span> ?",
  "REBASE_RESULT": "Foxův výsledek",
  "REFRESH_GIT": "Obnovte Git",
  "REMOVE_BOM": "Odebrat kusovník ze souborů",
  "REMOVE_FROM_GITIGNORE": "Odebrat z .gitignore",
  "RESET_LOCAL_REPO": "Zahodit všechny změny od posledního potvrzení…",
  "DISCARD_CHANGES": "Zahodit změny",
  "RESET_LOCAL_REPO_CONFIRM": "Přejete si zrušit všechny změny provedené od posledního potvrzení? Tuto akci nelze vrátit zpět.",
  "UNDO_LOCAL_COMMIT_CONFIRM": "Jste si jisti, že chcete vrátit zpět poslední neodeslané potvrzení?",
  "MORE_OPTIONS": "Další možnosti",
  "CREDENTIALS": "Pověření",
  "SAVE_CREDENTIALS_HELP": "Pokud jsou vaše přihlašovací údaje spravovány jinde, nemusíte vyplňovat uživatelské jméno/heslo. Toto použijte pouze v případě, že vaše operace neustále vyprší.",
  "SAVE_CREDENTIALS_IN_URL": "Uložit přihlašovací údaje na vzdálenou adresu URL (ve formátu prostého textu)",
  "SET_THIS_BRANCH_AS_TRACKING": "Nastavte tuto větev jako novou sledovací větev",
  "STRIP_WHITESPACE_FROM_COMMITS": "Odstraňte koncové mezery z potvrzení",
  "TARGET_BRANCH": "Cílová větev",
  "TITLE_CHECKOUT": "Zavázat se k pokladně?",
  "TOOLTIP_CLONE": "Klonujte existující úložiště",
  "TOOLTIP_COMMIT": "Potvrdit vybrané soubory",
  "TOOLTIP_FETCH": "Získejte všechna dálková ovládání a počítadla obnovy",
  "TOOLTIP_FIND_CONFLICTS": "Spustí v projektu hledání konfliktů sloučení/rebase Git",
  "TOOLTIP_HIDE_FILE_HISTORY": "Skrýt historii souborů",
  "TOOLTIP_HIDE_HISTORY": "Skrýt historii",
  "TOOLTIP_INIT": "Inicializujte úložiště",
  "TOOLTIP_MERGE_ABORT": "Přerušte operaci sloučení a resetujte HEAD na poslední místní potvrzení",
  "TOOLTIP_PICK_REMOTE": "Vyberte preferovaný dálkový ovladač",
  "TOOLTIP_PULL": "Git Pull",
  "TOOLTIP_PUSH": "Git Push",
  "TOOLTIP_REBASE_ABORT": "Přerušte operaci rebase a resetujte HEAD na původní větev",
  "TOOLTIP_REBASE_CONTINUE": "Po vyřešení konfliktu sloučení restartujte proces rebasingu",
  "TOOLTIP_REBASE_SKIP": "Restartujte proces rebasingu přeskočením aktuální opravy",
  "TOOLTIP_REFRESH_PANEL": "Obnovit panel",
  "TOOLTIP_SHOW_FILE_HISTORY": "Zobrazit historii souborů",
  "TOOLTIP_SHOW_HISTORY": "Zobrazit historii",
  "UNDO_CHANGES": "Zahodit změny",
  "UNDO_CHANGES_BTN": "Zahodit změny…",
  "UNDO_LAST_LOCAL_COMMIT": "Vrátit zpět poslední místní (neposunuté) potvrzení…",
  "UNDO_COMMIT": "Zrušit závazek",
  "URL": "URL",
  "USERNAME": "Uživatelské jméno",
  "USER_ABORTED": "Uživatel přerušen!",
  "USE_GIT_GUTTER": "Použijte Git gutter marks",
  "USE_NOFF": "Vytvořte potvrzení sloučení, i když se sloučení vyřeší jako rychlý posun vpřed (--no-ff)",
  "USE_REBASE": "Použijte FOX",
  "USE_VERBOSE_DIFF": "Zobrazit podrobný výstup v rozdílech",
  "USE_DIFFTOOL": "Pro diffy použijte nástroj difftool",
  ...
  "TAG_NAME_PLACEHOLDER": "Zde zadejte název značky…",
  "TAG_NAME": "Štítek",
  "CMD_CLOSE_UNMODIFIED": "Zavřete neupravené soubory",
  ...
  "FILE_STAGED": "Inscenováno",
  "FILE_UNMERGED": "Nesloučeno",
  "FILE_UNMODIFIED": "Neupravené",
  "FILE_UNTRACKED": "Nesledováno",
  "GIT_PUSH_SUCCESS_MSG": "Úspěšně posunuto rychle vpřed",
  "GIT_PUSH_FORCE_UPDATED_MSG": "Úspěšná vynucená aktualizace",
  "GIT_PUSH_DELETED_MSG": "Úspěšně smazán ref",
  "GIT_PUSH_NEW_REF_MSG": "Úspěšně vloženo nové čj",
  "GIT_PUSH_REJECTED_MSG": "Ref byla odmítnuta nebo se nepodařilo vložit",
  "GIT_PUSH_UP_TO_DATE_MSG": "Ref byl aktuální a nepotřeboval tlačit",
  "GIT_PULL_SUCCESS": "Úspěšně dokončeno git pull",
  "GIT_MERGE_SUCCESS": "Úspěšně dokončeno git merge",
  "GIT_REBASE_SUCCESS": "Rebase git byla úspěšně dokončena",
  "GIT_BRANCH_DELETE_SUCCESS": "Větev git byla úspěšně smazána",
  "INIT_NEW_REPO_FAILED": "Nepodařilo se inicializovat nové úložiště",
  "GIT_CLONE_REMOTE_FAILED": "Klonování vzdáleného úložiště se nezdařilo!",
  "GIT_CLONE_ERROR_EXPLAIN": "Vybraný adresář „{0}“.\n není prázdný. Klon Git vyžaduje čistý, prázdný adresář.\nPokud se zdá, že je prázdný, zkontrolujte skryté soubory.",
  "FOLDER_NOT_WRITABLE": "Vybraný adresář „{0}“.\n není zapisovatelný.",
  "GIT_NOT_FOUND_MESSAGE": "Git není nainstalován nebo jej nelze ve vašem systému nalézt. Nainstalujte si prosím Git nebo zadejte správnou cestu ke spustitelnému souboru Git do textového pole níže.",
  "ERROR_GETTING_BRANCH_LIST": "Získání seznamu poboček se nezdařilo",
  "ERROR_READING_GIT_HEAD": "Čtení souboru .git/HEAD se nezdařilo",
  "ERROR_PARSING_BRANCH_NAME": "Analýza názvu větve z {0} se nezdařila",
  "ERROR_READING_GIT_STATE": "Čtení stavu .git se nezdařilo",
  "ERROR_GETTING_DELETED_FILES": "Získání seznamu smazaných souborů se nezdařilo",
  "ERROR_SWITCHING_BRANCHES": "Přepínání větví se nezdařilo",
  "ERROR_GETTING_CURRENT_BRANCH": "Získání aktuálního názvu pobočky se nezdařilo",
  "ERROR_REBASE_FAILED": "Rebase se nezdařila",
  "ERROR_MERGE_FAILED": "Sloučení se nezdařilo",
  "ERROR_BRANCH_DELETE_FORCED": "Vynucené smazání větve se nezdařilo",
  "ERROR_FETCH_REMOTE_INFO": "Načítání vzdálených informací se nezdařilo",
  "ERROR_CREATE_BRANCH": "Vytvoření nové větve se nezdařilo",
  "ERROR_REFRESH_GUTTER": "Obnovení okapu se nezdařilo!",
  "ERROR_GET_HISTORY": "Historii se nepodařilo získat",
  "ERROR_GET_MORE_HISTORY": "Nepodařilo se načíst další řádky historie",
  "ERROR_GET_CURRENT_BRANCH": "Nepodařilo se získat aktuální název pobočky",
  "ERROR_GET_DIFF_FILE_COMMIT": "Nepodařilo se získat rozdíl",
  "ERROR_GET_DIFF_FILES": "Nepodařilo se načíst seznam souborů rozdílů",
  "ERROR_MODIFY_GITIGNORE": "Úprava .gitignore se nezdařila",
  "ERROR_UNDO_LAST_COMMIT_FAILED": "Nelze zrušit poslední potvrzení",
  "ERROR_MODIFY_FILE_STATUS_FAILED": "Nepodařilo se upravit stav souboru",
  ...
  "ERROR_RESET_LOCAL_REPO_FAILED": "Resetování místního úložiště se nezdařilo",
  "ERROR_CREATE_TAG": "Vytvoření značky se nezdařilo",
  "ERROR_CODE_INSPECTION_FAILED": "Pro soubor se nepodařilo spustit CodeInspection.inspectFile",
  "ERROR_CANT_GET_STAGED_DIFF": "Nelze získat rozdíl pro inscenované soubory",
  "ERROR_GIT_COMMIT_FAILED": "Git Commit se nezdařil",
  "ERROR_GIT_BLAME_FAILED": "Git Blame selhal",
  "ERROR_GIT_DIFF_FAILED": "Git Diff se nezdařil",
  "ERROR_DISCARD_CHANGES_FAILED": "Zahození změn v souboru se nezdařilo",
  "ERROR_COULD_NOT_RESOLVE_FILE": "Soubor nelze vyřešit",
  "ERROR_MERGE_ABORT_FAILED": "Zrušení sloučení se nezdařilo",
  "ERROR_MODIFIED_DIALOG_FILES": "Soubory, které se chystali odevzdat, byly změněny, když bylo zobrazeno dialogové okno odevzdání. Přerušení odevzdání jako výsledek by se lišilo od toho, co bylo zobrazeno v dialogu.",
  "ERROR_GETTING_REMOTES": "Získání dálkových ovladačů se nezdařilo!",
  "ERROR_REMOTE_CREATION": "Vzdálené vytvoření se nezdařilo",
  "ERROR_PUSHING_REMOTE": "Odeslání na dálkové ovládání se nezdařilo",
  "ERROR_PULLING_REMOTE": "Vytažení z dálkového ovladače se nezdařilo",
  "ERROR_PULLING_OPERATION": "Operace vytažení se nezdařila",
  "ERROR_PUSHING_OPERATION": "Operace tlačení se nezdařila",
  "ERROR_NO_REMOTE_SELECTED": "Pro {0} nebylo vybráno žádné dálkové ovládání!",
  "ERROR_BRANCH_LIST": "Získání seznamu poboček se nezdařilo",
  "ERROR_FETCH_REMOTE": "Načítání vzdálených informací se nezdařilo"
});