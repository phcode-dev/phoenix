...
define({
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Aplikace {APP_NAME} <strong>neshromažďuje ani nezpracovává žádné osobní údaje</strong> , ale <strong>shromažďuje anonymní statistiky používání</strong> , aby chránila vaše soukromí. Anonymní údaje jsou vyňaty z požadavků na oznamování GDPR/CCPA, ale věříme, že musíte mít možnost dobře se odhlásit od anonymního shromažďování údajů.<br> Tyto <strong>anonymní</strong> statistiky používání aplikací a hlášení o chybách pomáhají upřednostňovat funkce, nacházet chyby a odhalovat problémy s použitelností pro vaše prostředí s aplikací {APP_NAME}.</p><p> Níže je uveden náhled dat, která budou odeslána ve vaší další zdravotní zprávě <em>, pokud</em> je povolena. (Prohlédněte si také vývojářskou konzoli, kde najdete protokoly chyb označené jako „Zachycena kritická chyba“.)</p>",
