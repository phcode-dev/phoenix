...
define({
  ...
  "ENCODE_FILE_FAILED_ERR": "{APP_NAME} nebyl schopen zakódovat obsah souboru.",
  "DECODE_FILE_FAILED_ERR": "{APP_NAME} nebyl schopen dekódovat obsah souboru.",
  "UNSUPPORTED_UTF16_ENCODING_ERR": "{APP_NAME} momentálně nepodporuje textové soubory kódované UTF-16.",
  ...
  "ERROR_RENAMING_NOT_IN_PROJECT": "Soubor nebo adresář není součástí aktuálně otevřeného projektu. Bohužel, pouze soubory projektu lze přejmenovat v tomto bodě.",
  "ERROR_MOVING_FILE_TITLE": "Chyba při pohybu {0}",
  "ERROR_MOVING_FILE": "Při pokusu o přesunutí {2} <span class='dialog-filename'>{0}</span>došlo k chybě. {1}",
  "ERROR_MOVING_NOT_IN_PROJECT": "Soubor nebo složku nelze přesunout, protože nejsou součástí aktuálního projektu.",
  ...
  "ERR_TYPE_PASTE_FAILED": "Při vkládání <span class='dialog-filename'>{0} do <span class='dialog-filename'>{1}</span> </span> došlo k chybě",
  ...
  "LIVE_DEV_CLICK_POPOUT": "Popout Live Preview do nového okna",
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "Připnout na stránku náhledu Unpin",
  ...
  "WINDOW_UNLOAD_WARNING": "Opravdu chcete přejít na jinou adresu URL a nechat závorky?",
  "WINDOW_UNLOAD_WARNING_WITH_UNSAVED_CHANGES": "Máte neuložené změny! Opravdu chcete přejít na jinou adresu URL a nechat závorky?",
  "DONE": "Hotovo",
  "OK": "OK",
  "CANCEL": "Zrušit",
  "DONT_SAVE": "Neukládat",
  ...
  "FIND_HISTORY_MAX_COUNT": "Maximální počet položek vyhledávání v historii vyhledávání",
  ...
  "FILTER_NAME_REMAINING": "{0} zbývajících znaků",
  ...
  "CMD_NAVIGATE_BACKWARD": "Navigace dozadu",
  "CMD_NAVIGATE_FORWARD": "Navigace vpřed",
  ...
  "CMD_SWITCH_PANE_FOCUS": "Zaměření panelu přepínače",
  ...
  "CMD_HOMEPAGE": "{APP_NAME} Úvodní stránka",
  ...
  "ABOUT": "O aplikaci",
  "CLOSE": "Zavřít",
  "ABOUT_TEXT_LINE1": "Uvolněte {VERSION_MAJOR}. {VERSION_MINOR} {BUILD_TYPE} {VERZE}",
  "ABOUT_TEXT_BUILD_TIMESTAMP": "sestavení časového razítka: ",
  "ABOUT_TEXT_LINE3": "Knihovny třetích stran, které používáme - <a href='https://github.com/phcode-dev/phoenix/tree/main/src/thirdparty/licences'> licence a atribuce</a> . ",
  "ABOUT_TEXT_LINE4": "Dokumentace a zdroj na adrese <a href='https://github.com/phcode-dev/phoenix/'>https://github.com/phcode-dev/phoenix/</a>",
  "ABOUT_TEXT_LINE5": "Vyrobeno pomocí ❤ a JavaScriptu:",
  ...
  "SORT_EXTENSION_METHOD": "Řazení rozšíření pomocí programu DownloadCount nebo PublishedDate",
  "INVALID_ZIP_FILE": "Stažený soubor není platný zip soubor.",
  "MISSING_PACKAGE_JSON": "Balíček nemá soubor package.json.",
  ...
  "EXTENSIONS_DOWNLOADS": "Soubory ke stažení",
  ...
  "ERROR_EXTRACTTO_FUNCTION_NOT_VALID": "Vybraný blok by měl představovat množiny příkazů nebo výrazů",
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "Extrahovat do proměnné nefunguje v multicursors",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "Extrahovat do funkce nefunguje v multicursors",
  "EXTRACTTO_FUNCTION_SELECT_SCOPE": "Zvolte rozsah cíle",
  ...
  "CMD_REFACTORING_CONDITION": "Zabalit ve stavu",
  "CMD_REFACTORING_GETTERS_SETTERS": "Vytvořit Getters/Settery",
  "CMD_REFACTORING_ARROW_FUNCTION": "Převést na funkci šipky",
  "DESCRIPTION_CODE_REFACTORING": "Povolení/zakázání refaktoringu kódu JavaScriptu",
  ...
  "ERROR_ARROW_FUNCTION": "Umístěte kurzor do funkčního výrazu",
  "ERROR_GETTERS_SETTERS": "Umístění kurzoru na člen výrazu objektu",
  "ERROR_RENAME_MULTICURSOR": "Nelze přejmenovat při použití více kurzorů",
  "ERROR_RENAME_QUICKEDIT": "Nelze přejmenovat tento identifikátor, protože je odkazován jinde mimo tuto funkci",
  ...
  "RECENT_FILES_DLG_CLEAR_BUTTON_TITLE": "Vymazat soubory, které nejsou v pracovní sadě",
  ...
  "DESCRIPTION_LINEWISE_COPY_CUT": "Kopírování a vyjmutí, když není výběr, zkopíruje nebo vyřízne celé řádky, které mají v sobě kurzory",
  "DESCRIPTION_INPUT_STYLE": "Vybere způsob, jakým CodeMirror zpracovává vstup a zaostření. Může to být textarea, což je výchozí nebo contenteditable, což je lepší pro čtečky obrazovky (nestabilní)",
  ...
  "DESCRIPTION_SEARCH_AUTOHIDE": "Uzavřete vyhledávání, jakmile je editor zaměřen",
  ...
  "DESCRIPTION_INDENT_LINE_COMMENT": "true pro povolení odsazení řádkových komentářů",
  "DESCRIPTION_RECENT_FILES_NAV": "Povolení/zakázání navigace v posledních souborech",
  "DESCRIPTION_LIVEDEV_WEBSOCKET_PORT": "Port, na kterém běží WebSocket Server pro Live Preview",
  "DESCRIPTION_LIVE_DEV_HIGHLIGHT_SETTINGS": "Nastavení zvýraznění živého náhledu",
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "false zakázat zpětnou kontrolu živého náhledu",
  "DOWNLOAD_FAILED": "Stahování se nezdařilo.",
  "DOWNLOAD_COMPLETE": "Stahování dokončeno!",
  "UPDATE_SUCCESSFUL": "Aktualizace byla úspěšná!",
  "UPDATE_FAILED": "Aktualizace se nezdařila!",
  "VALIDATION_FAILED": "Ověření se nezdařilo!",
  "INITIALISATION_FAILED": "Inicializace selhala!",
  "CLEANUP_FAILED": "Vyčištění selhalo!",
  "WARNING_TYPE": "Varování!",
  "CLICK_RESTART_TO_UPDATE": "Klepnutím na tlačítko Restartovat aktualizujte závorky.",
  "UPDATE_ON_NEXT_LAUNCH": "Aktualizace bude použita při opětovném spuštění.",
  "GO_TO_SITE": "Přejít na <a href = \"http://brackets.io/ „> brackets.io </a> opakovat.",
  "INTERNET_UNAVAILABLE": "Není k dispozici připojení k internetu.",
  "UPDATEDIR_READ_FAILED": "Aktualizační adresář nelze přečíst.",
  "UPDATEDIR_CLEAN_FAILED": "Aktualizační adresář nelze vyčistit.",
  "INITIAL_DOWNLOAD": "Stahuji aktualizaci...",
  "RETRY_DOWNLOAD": "Stahování se nezdařilo. Opakování... Pokus ",
  ...
  "DESCRIPTION_AUTO_UPDATE": "Zapnout/zakázat závorky Automatická aktualizace",
  ...
  "PHP_VERSION_INVALID": "Chyba při analýze PHP verze. Zkontrolujte prosím výstup příkazu „php —version“.",
  "PHP_UNSUPPORTED_VERSION": "Nainstalujte runtime PHP7 pro povolení nástrojů souvisejících s PHP, jako jsou tipy na kód, rady parametrů, Přejít na definici a další. Nalezena verze: {0}",
  "PHP_EXECUTABLE_NOT_FOUND": "PHP runtime nebyl nalezen. Nainstalujte PHP7 runtime a aktualizujte „ExecutablePath“ v předvolbách PHP vhodně. To umožňuje nástroje související s PHP, jako jsou tipy na kód, rady parametrů, Přejít na definici a další.",
  "PHP_PROCESS_SPAWN_ERROR": "Při spuštění procesu PHP došlo k chybě {0}.",
  "PHP_SERVER_ERROR_TITLE": "Chyba",
  "PHP_SERVER_MEMORY_LIMIT_INVALID": "Limit paměti, který jste zadali, je neplatný. Zkontrolujte předvolby PHP a nastavte správnou hodnotu.",
  "DESCRIPTION_PHP_TOOLING_CONFIGURATION": "Výchozí nastavení konfigurace PHP Tooling",
  "OPEN_PREFERENNCES": "Otevření předvoleb",
  "LANGUAGE_TOOLS_PREFERENCES": "Předvolby jazykových nástrojů",
  "FIND_ALL_REFERENCES": "Najít všechny reference",
  "REFERENCES_IN_FILES": "odkazy",
  "REFERENCE_IN_FILES": "odkaz",
  "REFERENCES_NO_RESULTS": "Pro aktuální pozici kurzoru nejsou k dispozici žádné reference",
  "CMD_FIND_DOCUMENT_SYMBOLS": "Najít symboly dokumentu",
  "CMD_FIND_PROJECT_SYMBOLS": "Najít symboly projektu",
  ...
  "DESCRIPTION_EXTERNAL_APPLICATION_ASSOCIATE": "Mapování pro příponu souboru na externí aplikace. Syntaxe: \"<file_type>„: „<default|ApplicationName|ApplicationPath>“, Použít „default“ pro otevření souborů v systémové výchozí aplikaci pro daný typ souboru.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "Otevřete grafické soubory v externích editorech.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "Vaše aktuální složka obsahuje grafické typy souborů, které nejsou podporovány {APP_NAME}. <br/>Nynímůžete přiřadit konkrétní typy souborů s externími editory. Jakmile je přidružen, můžete ve svých výchozích aplikacích otevřít grafické soubory jako .xd, .psd, .jpg, .png, .ai, .svg dvojitým kliknutím na soubory ve stromu souborů. <br/><br/>Kliknutímna tlačítko „Ok“ přidružíte typy grafických souborů s příslušnými výchozími aplikacemi.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Následující typy souborů byly úspěšně asociovány s výchozími aplikacemi. <br/>{0} Máte možnost změnit své preference ohledně toho, zda odstraníte/přidáte nová přidružení typů souborů v brackets.json tak, že přejdete do nabídky „Debug->Otevřít soubor předvoleb“.",
  "UNSUPPORTED_BROWSER": "Prohlížeč není podporován",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Prohlížeč nepodporuje Otevřít složku",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Použijte prosím některý z níže uvedených podporovaných prohlížečů.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Usilovně pracujeme na tom, aby byl Phoenix dostupný ve více prohlížečích. Tento dialog můžete zavřít, ale některé funkce ve Phoenixu nebudou v tomto prohlížeči fungovat.",
  "CANNOT_PUBLISH_LARGE_PROJECT": "Nelze publikovat velký projekt",
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "Phoenix je stále v experimentální alfa. Dosud jsme nepovolili synchronizaci projektů s více než 500 soubory.",
  "SHARE_WEBSITE": "Publikovat a sdílet web?",
  "PUBLISH": "Publikovat",
  "PUBLISH_CONSENT_MESSAGE": "Rychle zobrazte náhled změn a sdílejte své webové stránky s ostatními. Phoenix vám může tuto webovou stránku zveřejnit na adrese {0}. Zveřejněné odkazy budou platné po dobu 7 dnů. </br>Přejetesi publikovat a sdílet své webové stránky?",
  ...
  "CONFIRM_REPLACE_TITLE": "Potvrdit Nahradit",
  "KEEP_BOTH": "Ponechat obojí",
  "EXPLORE": "Html Hry",
  "BLOG": "Blog",
  ...
  "WEBPAGE_HOME_PAGE": "Rozvržení domovské stránky",
  "WEBPAGE_BLOG": "Stránka blogu",
  "WEBPAGE_DASHBOARD": "Řídicí panel HTML",
  ...
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Nemohl jsem zkrášlit. Text editoru se po zkrášlení změnil.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Zkrášlující soubor {0}",
  "BEAUTIFY_ERROR_SELECTION": "Nemohl jsem zkrášlit. </br>Neúplnýblok kódu vybraný nebo neplatná syntaxe.",
  "BEAUTIFY_OPTIONS": "Možnosti, které řídí, jak funguje Beautify Code",
  "BEAUTIFY_OPTION_PRINT_WIDTH": "Určete délku čáry, na kterou se zkrášlovač zabalí",
  "BEAUTIFY_OPTION_SEMICOLON": "Přidejte středník na konec každého příkazu",
  "BEAUTIFY_OPTION_SINGLE_QUOTE": "Použijte jednoduché uvozovky místo dvojitých uvozovek",
  "BEAUTIFY_OPTION_QUOTE_PROPS": "Změna při citování vlastností objektů",
  "BEAUTIFY_OPTION_BRACKET_SAME_LINE": "Umístěte > víceřádkového HTML (HTML, JSX, Vue, Angular) prvek na konec posledního řádku místo toho, aby byl sám na dalším řádku (nevztahuje se na samouzavírací prvky)",
  "BEAUTIFY_OPTION_SINGLE_ATTRIBUTE_PER_LINE": "Vynutit jeden atribut na řádek v HTML, Vue a JSX",
  "BEAUTIFY_OPTION_PROSE_WRAP": "Obtékání prózy, pokud přesahuje šířku tisku v souborech markdown",
  "BEAUTIFY_OPTION_PRINT_TRAILING_COMMAS": "Tisk koncových čárek všude tam, kde je to možné, ve víceřádkových syntaktických strukturách oddělených čárkami"
});