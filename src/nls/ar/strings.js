...
define({
  ...
  "AI_DISABLE_CONFIRM_MESSAGE": "يقوم هذا بإيقاف تشغيل جميع ميزات الذكاء الاصطناعي. ستتم إزالة لوحة الذكاء الاصطناعي وسيتوقف {APP_NAME} عن الاتصال بخدمات الذكاء الاصطناعي.<br><br>أعد تشغيل {APP_NAME} حتى يسري هذا التغيير.",
  "AI_DISABLE_CONFIRM_BTN": "تعطيل الذكاء الاصطناعي",
  "AI_ENABLE_CONFIRM_TITLE": "تمكين الذكاء الاصطناعي؟",
  "AI_ENABLE_CONFIRM_MESSAGE": "يقوم هذا بإعادة تشغيل ميزات الذكاء الاصطناعي واستعادة لوحة الذكاء الاصطناعي.<br><br>أعد تشغيل {APP_NAME} حتى يسري هذا التغيير.",
  "AI_ENABLE_CONFIRM_BTN": "تفعيل الذكاء الاصطناعي",
  ...
  "AI_SETTINGS_ENABLE_AI_NOTE": "يقوم بتشغيل أو إيقاف كل ميزات الذكاء الاصطناعي في {APP_NAME}. يسري مفعول هذا الإعداد بعد إعادة التشغيل — يمكنك تفعيلها مرة أخرى في أي وقت من <span class='ai-settings-menu-path'>قائمة عرض &gt; تفعيل الذكاء الاصطناعي</span>."
});