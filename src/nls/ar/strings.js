...
define({
  ...
  "BOTTOM_PANEL_HIDE": "إخفاء اللوحة",
  ...
  "AI_CHAT_UPSELL_MESSAGE": "ميزات الذكاء الاصطناعي متاحة مع Phoenix Pro.",
  "AI_CHAT_UPSELL_BTN": "احصل على Phoenix Pro",
  "AI_CHAT_ADMIN_DISABLED_TITLE": "الذكاء الاصطناعي معطّل",
  "AI_CHAT_ADMIN_DISABLED_MESSAGE": "تم تعطيل ميزات الذكاء الاصطناعي من قبل مسؤول النظام الخاص بك.",
  ...
  "AI_CHAT_HISTORY_MINS_AGO": "قبل {0} د",
  "AI_CHAT_HISTORY_HOURS_AGO": "قبل {0} س",
  "AI_CHAT_HISTORY_DAYS_AGO": "قبل {0} ي",
  "AI_CHAT_HISTORY_CLEAR_ALL": "مسح الكل",
  "AI_CHAT_HISTORY_DELETE_CONFIRM": "هل تريد حذف هذه الجلسة؟",
  "AI_CHAT_SWITCH_PROJECT_TITLE": "الذكاء الاصطناعي قيد العمل"
});