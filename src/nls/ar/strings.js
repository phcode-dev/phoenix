...
define({
  ...
  "BOTTOM_PANEL_DEFAULT_HEADING": "فتح لوحة",
  "BOTTOM_PANEL_OPEN_PANEL": "فتح لوحة",
  ...
  "DEVICE_SIZE_LIMIT_MESSAGE": "شاهد كيف تبدو صفحتك على الهواتف والأجهزة اللوحية وأجهزة سطح المكتب ونقاط توقف CSS الخاصة بك. قم بالترقية إلى Phoenix Pro.",
  "DEVICE_SIZE_NOT_ENOUGH_SPACE": "لا توجد مساحة كافية لحجم الشاشة هذا - حاول التصغير",
  "DEVICE_SIZE_CYCLE_TOOLTIP": "التبديل بين الجوال والجهاز اللوحي وسطح المكتب",
  "DEVICE_SIZE_DROPDOWN_TOOLTIP": "كل أحجام الأجهزة",
  "DEVICE_SIZE_FIT_TO_PANEL": "ملاءمة مع اللوحة",
  "BOTTOM_PANEL_DEFAULT_TITLE": "وصول سريع - أدوات"
});