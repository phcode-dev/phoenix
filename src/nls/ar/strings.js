...
define({
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "{APP_NAME} <strong>لا تجمع أو تعالج أي معلومات تعريف شخصية</strong>، ولكنها <strong>تجمع إحصائيات استخدام مجهولة المصدر</strong> لحماية خصوصيتك. البيانات المجهولة المصدر مُستثناة من متطلبات إشعارات اللائحة العامة لحماية البيانات/قانون خصوصية المستهلك في كاليفورنيا، لكننا نعتقد أنك بحاجة إلى خيار إلغاء الاشتراك في جمع البيانات المجهولة المصدر أيضًا.<br><br> يمكنك الاطلاع على بياناتك أو <strong>اختيار عدم مشاركة أي بيانات مجهولة المصدر</strong> عن طريق تحديد <strong>مساعدة > تقرير الحالة</strong>. تساعد إحصائيات استخدام التطبيق وتقارير الأخطاء <strong>المجهولة المصدر</strong> هذه على تحديد أولويات الميزات، والعثور على الأخطاء، واكتشاف مشكلات سهولة الاستخدام لتحسين تجربتك مع {APP_NAME}. بدون هذه البيانات، لن نعرف الميزات التي تستحق تطويرها من أجلِك! <br><br>",
  ...
  "NEW_PROJECT_NOTIFICATION": "انقر على هذا الرمز لفتح نافذة `مشروع جديد` مرة أخرى.</br> راجع المشاريع الأخيرة، أو افتح مجلداً، أو ابدأ مشاريع من قوالب.</br> <img src=\"styles/images/new_project.png\">  <br/> <a href='#' style='float:right;'>موافق</a>",
  "BEAUTIFY_CODE_NOTIFICATION": "انقر هنا أو اضغط <b>`{0}`</b> لتحسين تنسيق الكود. </br> <img src=\"styles/images/beautify.gif\">  <br/> <a href='#' style='float:right;'>موافق</a>",
  "DEFAULT_PROJECT_NOTIFICATION": "انقر هنا لفتح <br/><b>المشروع الافتراضي</b> في فونيكس. </br> <a href='#' style='float:right;'>موافق</a>",
  ...
  "MENU_RESET_HARD": "تجاهل التغييرات والالتزامات بعد هذا (إعادة تعيين صعبة)",
  "MENU_RESET_MIXED": "تجاهل الالتزامات بعد هذا ولكن احتفظ بالتغييرات غير مرحلة (إعادة تعيين مختلطة)",
  "MENU_RESET_SOFT": "تجاهل الالتزامات بعد هذا ولكن احتفظ بالتغييرات مرحلة (إعادة تعيين ناعمة)",
  ...
  "RESET_HARD_MESSAGE": "سيؤدي هذا الإجراء إلى تجاهل جميع التغييرات والالتزامات التي تمت بعد الالتزام المحدد. <b>لا يمكن التراجع عن هذه العملية بسهولة.</b> هل أنت متأكد أنك تريد المتابعة؟<br><br>⚠️ تحذير: هذا الإجراء يعيد كتابة التاريخ ولا يجب استخدامه على الالتزامات التي تم دفعها إلى فرع مشترك.",
  "RESET_MIXED_MESSAGE": "سيؤدي هذا الإجراء إلى تجاهل جميع الالتزامات التي تمت بعد الالتزام المحدد ولكن الاحتفاظ بجميع التغييرات غير المُرحّلة. <b>لا يمكن التراجع عن هذه العملية بسهولة.</b> هل أنت متأكد أنك تريد المتابعة؟<br><br>⚠️ تحذير: هذا الإجراء يعيد كتابة التاريخ ولا يجب استخدامه على الالتزامات التي تم دفعها إلى فرع مشترك.",
  "RESET_SOFT_MESSAGE": "سيؤدي هذا الإجراء إلى تجاهل جميع الالتزامات التي تمت بعد الالتزام المحدد ولكن الاحتفاظ بجميع التغييرات المُرحّلة لالتزام جديد. <b>لا يمكن التراجع عن هذه العملية بسهولة.</b> هل أنت متأكد أنك تريد المتابعة؟<br><br>⚠️ تحذير: هذا الإجراء يعيد كتابة التاريخ ولا يجب استخدامه على الالتزامات التي تم دفعها إلى فرع مشترك.",
  "BUTTON_SAVE": "حفظ",
  "RESET": "إعادة ضبط",
  ...
  "REQUIRES_APP_RESTART_SETTING": "يتطلب تغيير هذا الإعداد إعادة تشغيل التطبيق لكي يسري مفعوله",
  "CLEAN_FILE_END": "تم تنظيف الملف",
  "CLEAN_FILE_START": "جارٍ تنظيف الملف",
  ...
  "CODE_INSPECTION_IN_PROGRESS": "فحص الكود جارٍ…",
  "CODE_INSPECTION_PROBLEMS_NONE": "لم يتم الكشف عن أي مشاكل",
  "CODE_INSPECTION_DONE_FILES": "{0} من {1} ملف تم الانتهاء منها…",
  ...
  "CREATE_NEW_GITFTP_SCOPE": "إنشاء اتصال Git-FTP جديد…",
  "CREATE_NEW_REMOTE": "إنشاء اتصال جديد…",
  ...
  "DIALOG_CHECKOUT": "عند استخراج نسخة من تعهد، سيصبح المستودع في حالة DETACHED HEAD. لن يمكنك إجراء أي تعهدات إلا إذا أنشأت فرعًا بناءً على هذا.",
  ...
  "DIFF_FAILED_SEE_FILES": "فشل أمر Git diff في توفير نتائج المقارنة. هذه قائمة بالملفات المُدرجة للتأكيد:",
  ...
  "ENTER_REMOTE_NAME": "أدخل اسم المصدر البعيد الجديد:",
  "ENTER_REMOTE_URL": "أدخل عنوان URL للمصدر البعيد الجديد:",
  ...
  "GIT_COMMIT": "إيداع Git…",
  "GIT_COMMIT_IN_PROGRESS": "عملية إيداع Git جارية",
  "GIT_DIFF": "اختلافات Git &mdash;",
  "GIT_PULL_RESPONSE": "استجابة سحب Git",
  "GIT_PUSH_RESPONSE": "استجابة إرسال Git",
  "GIT_REMOTES": "مستودعات Git البعيدة",
  ...
  "NOTHING_TO_COMMIT": "لا يوجد ما يمكن الالتزام به، دليل العمل نظيف.",
  ...
  "PATH_TO_GIT_EXECUTABLE": "مسار ملف Git التنفيذي",
  "PULL_AVOID_MERGING": "تجنب الدمج اليدوي",
  "PULL_DEFAULT": "دمج افتراضي",
  "PULL_FROM": "سحب من",
  "PULL_MERGE_NOCOMMIT": "دمج بدون التزام",
  "PULL_REBASE": "استخدام إعادة التأسيس (rebase)",
  "PULL_RESET": "استخدام إعادة تعيين بسيطة",
  "PULL_SHORTCUT": "سحب من المستودع البعيد…",
  "PULL_SHORTCUT_BEHIND": "سحب من المستودع البعيد ({0} خلف)…",
  ...
  "RESET_LOCAL_REPO_CONFIRM": "هل تريد تجاهل جميع التغييرات التي أجريتها منذ آخر عملية ارتكاب؟ لا يمكن التراجع عن هذا الإجراء.",
  ...
  "SAVE_CREDENTIALS_HELP": "لا تحتاج إلى ملء اسم المستخدم / كلمة المرور إذا تمت إدارة بيانات اعتمادك في مكان آخر. استخدم هذا فقط عندما يستمر انتهاء مهلة العملية.",
  ...
  "TOOLTIP_REBASE_ABORT": "إحباط عملية إعادة التأسيس وإعادة ضبط HEAD إلى الفرع الأصلي",
  ...
  "UNDO_COMMIT": "تراجع عن الالتزام",
  "URL": "عنوان الموقع الإلكتروني",
  "USERNAME": "اسم المستخدم",
  "USER_ABORTED": "ألغى المستخدم العملية!",
  "USE_GIT_GUTTER": "استخدام علامات Git في الهامش",
  "USE_NOFF": "إنشاء التزام دمج حتى عندما يتم حل الدمج كـ \"تقديم سريع\" (--no-ff)",
  "USE_REBASE": "استخدام إعادة التأسيس (REBASE)",
  "USE_VERBOSE_DIFF": "إظهار مُخرجات مُفصلة في الفروقات",
  "USE_DIFFTOOL": "استخدام أداة فرق (difftool) للفروقات",
  "VIEW_AUTHORS_FILE": "عرض مُؤلفي الملف…",
  "VIEW_AUTHORS_SELECTION": "عرض مؤلفي التحديد…",
  "VIEW_THIS_FILE": "عرض هذا الملف",
  "TAG_NAME_PLACEHOLDER": "أدخل اسم الوسم هنا…",
  "TAG_NAME": "وسم",
  ...
  "FILE_RENAMED": "تم تغيير الاسم",
  "FILE_STAGED": "مُجهّز",
  "FILE_UNMERGED": "غير مدمج",
  "FILE_UNMODIFIED": "غير معدل",
  "FILE_UNTRACKED": "غير مُتابع",
  "GIT_PUSH_SUCCESS_MSG": "تم الدفع بنجاح (تقديم سريع)",
  ...
  "ERROR_GIT_COMMIT_FAILED": "فشل تنفيذ أمر Git Commit",
  "ERROR_GIT_BLAME_FAILED": "فشل تنفيذ أمر Git Blame",
  "ERROR_GIT_DIFF_FAILED": "فشل مُقارنة Git",
  "ERROR_DISCARD_CHANGES_FAILED": "فشل تجاهل التغييرات في الملف",
  ...
  "ERROR_GETTING_REMOTES": "فشل الحصول على أجهزة التحكم عن بُعد!",
  "ERROR_REMOTE_CREATION": "فشل إنشاء جهاز التحكم عن بُعد",
  "ERROR_PUSHING_REMOTE": "فشل الدفع إلى جهاز التحكم عن بُعد",
  "ERROR_PULLING_REMOTE": "فشل السحب من جهاز التحكم عن بُعد",
  "ERROR_PULLING_OPERATION": "فشل عملية السحب",
  "ERROR_PUSHING_OPERATION": "فشل إجراء الدفع",
