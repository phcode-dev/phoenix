...
define({
  ...
  "PHP_INSTALL_DIALOG_TEXT": "إكمالات متقدمة، وتدقيق للأخطاء، ووثائق والمزيد للغة PHP.",
  "PHP_INSTALL_DIALOG_SIZE": "تنزيل بحجم 9 ميجابايت",
  "PHP_INSTALL_LATER_INFO": "يمكنك التثبيت لاحقًا دائمًا — سيظهر شريط التثبيت عند فتح أي ملف PHP.",
  ...
  "PYTHON_POWERED_BY_PYREFLY": "مدعوم بواسطة Pyrefly",
  ...
  "PYTHON_BENEFIT_DOCS_SUB": "مساعدة حول الدالة مباشرة في المحرر",
  "PYTHON_BENEFIT_ERRORS": "التحقق من الأخطاء",
  "PYTHON_BENEFIT_ERRORS_SUB": "تمييز الأخطاء أثناء كتابة الكود",
  ...
  "PYTHON_PANEL_TEXT": "ميزة الذكاء البرمجي للغة Python متوقفة. قم بتثبيت خادم اللغة Pyrefly ومنسق Ruff (مجاني، تنزيل بحجم 25 ميجابايت تقريبًا) للحصول على الإكمالات، وتدقيق الأخطاء، والوثائق، والتنسيق، وميزة الانتقال إلى التعريف.",
  "PYTHON_INSTALLING": "جارٍ إعداد دعم Python — جارٍ تنزيل أدوات اللغة...",
  "PYTHON_INSTALL_DONE": "ميزة الذكاء البرمجي للغة Python جاهزة.",
  "PYTHON_INSTALL_FAILED": "تعذر إعداد دعم Python: {0}. سيحاول {APP_NAME} مرة أخرى عند فتح ملف Python مجددًا.",
  "DESCRIPTION_PYTHON_CODE_INTELLIGENCE": "false لتعطيل ميزة الذكاء البرمجي للغة Python (Pyrefly). إعادة تعيينها إلى true يعرض تنزيل خادم اللغة مرة أخرى."
});