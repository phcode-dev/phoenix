...
define({
  ...
  "LIVE_DEV_ELEMENT_PROPS_NO_CLASSES": "لا توجد فئات",
  "LIVE_DEV_ELEMENT_PROPS_NO_ATTRIBUTES": "لا توجد سمات",
  ...
  "PHOENIX_TOUR_EDIT_MODE": "وضع التحرير يتيح لك تعديل صفحتك مباشرة في المعاينة المباشرة — انقر على العناصر لفحصها وتحريرها مباشرةً.",
  "PROMO_CARD_2": "ذكاء اصطناعي يرى ما تراه",
  "PROMO_CARD_2_MESSAGE": "استكشف أفكار واجهة المستخدم، وابنِ التطبيقات، وأصلح المشكلات باستخدام الذكاء الاصطناعي — فهو يرى صفحتك بنفس الطريقة التي تراها بها، وليس مجرد كود برمجي.",
  "PROMO_CARD_3": "شاهد صفحتك على أي جهاز",
  "PROMO_CARD_3_MESSAGE": "بدّل فورًا بين عروض الهاتف والجهاز اللوحي وسطح المكتب لاكتشاف مشكلات الاستجابة مبكرًا.",
  "PROMO_CARD_4": "الماركدون الخاص بك، في صورة مستند حقيقي",
  "PROMO_CARD_4_MESSAGE": "حرّر الجداول والصور والتنسيقات بشكل مرئي — طريقة أسهل للتعامل مع الماركدون.",
  ...
  "AI_CHAT_SETUP_NEED_HELP": "هل تحتاج إلى مساعدة؟",
  ...
  "AI_CHAT_PLACEHOLDER_TITLE": "صمّم، وابنِ، وأصلِح بشكل أسرع مع الذكاء الاصطناعي",
  ...
  "AI_CHAT_PLACEHOLDER_CARD_BUGS_TITLE": "إصلاح الأخطاء",
  ...
  "AI_CHAT_LOGIN_TITLE": "سجّل الدخول للبدء باستخدام الذكاء الاصطناعي",
