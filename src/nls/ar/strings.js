...
define({
  ...
  "AI_CHAT_CLI_INSTALL_MSG": "يجب تثبيت Claude Code CLI على نظامك لاستخدام ميزات الذكاء الاصطناعي في {APP_NAME}. <a class='ai-learn-more-link' href='#'>اعرف المزيد</a>",
  ...
  "AI_CHAT_CLAUDE_LOGIN_MSG": "تم تثبيت Claude Code ولكنه يحتاج إلى التهيئة. <a class='ai-learn-more-link' href='#'>اعرف المزيد</a>",
  "AI_CHAT_CLAUDE_LOGIN_BTN": "إعداد Claude Code",
  "AI_CHAT_ADD_PROVIDER_BTN": "إضافة مزود مخصص",
  "AI_CHAT_RETRY": "إعادة المحاولة",
  "AI_CHAT_DESKTOP_ONLY": "ميزات الذكاء الاصطناعي تتطلب تطبيق Phoenix لسطح المكتب. قم بتنزيله للبدء.",
  "AI_CHAT_DOWNLOAD_BTN": "تنزيل تطبيق سطح المكتب",
  "AI_CHAT_LOGIN_TITLE": "سجّل الدخول لاستخدام الذكاء الاصطناعي",
  ...
  "AI_CHAT_INTRO_CONFIGURE_DESC": "شاهد هذا الفيديو القصير حول كيفية إعداد الذكاء الاصطناعي",
  ...
  "PROMO_CARD_2": "الذكاء الاصطناعي في محررك",
  "PROMO_CARD_2_MESSAGE": "اطلب من الذكاء الاصطناعي كتابة الكود، أو إصلاح الأخطاء، أو إعادة هيكلة مشروعك. إنه يقوم بالعمل نيابةً عنك.",
  "PROMO_CARD_3": "معاينة على أي جهاز",
  "PROMO_CARD_3_MESSAGE": "غيّر حجم المعاينة المباشرة لتناسب أي هاتف أو جهاز لوحي أو منفذ عرض مخصص - واكتشف مشاكل التصميم المتجاوب قبل نشرها.",
  "PROMO_CARD_4": "ماركداون غني، مباشر",
  "PROMO_CARD_4_MESSAGE": "معاينة ماركداون مصقولة جنبًا إلى جنب مع الرسوم البيانية والجداول وكتل الكود - يتم عرضها أثناء الكتابة."
});