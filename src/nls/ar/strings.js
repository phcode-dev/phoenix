...
define({
  ...
  "LIVE_DEV_SETTINGS_STYLES_BAR_POSITION_PREFERENCE": "الموضع المحفوظ لشريط أنماط المعاينة المباشرة، يُعيَّن تلقائيًا عند سحب الشريط. يؤدي تركه فارغًا إلى وضع الشريط في موضعه الافتراضي.",
  ...
  "LIVE_DEV_STYLER_SPACING": "الهامش والحشو",
  ...
  "PHP_INSTALL_MESSAGE": "هل تريد تثبيت ذكاء شيفرة PHP المتقدم؟",
  "PHP_INSTALL_ENABLE": "تثبيت",
  "PHP_INSTALL_NOT_NOW": "ليس الآن",
  "PHP_POWERED_BY_INTELEPHENSE": "مدعوم بواسطة Intelephense",
  "PHP_BENEFIT_COMPLETIONS": "الإكمالات",
  "PHP_BENEFIT_COMPLETIONS_SUB": "اقتراحات ذكية أثناء الكتابة",
  "PHP_BENEFIT_DOCS": "التوثيق عند التمرير",
  "PHP_BENEFIT_DOCS_SUB": "مساعدة الدالة مباشرة في المحرر",
  "PHP_BENEFIT_ERRORS": "التحقق من الأخطاء",
  "PHP_BENEFIT_ERRORS_SUB": "تمييز الأخطاء أثناء كتابة الشيفرة",
  "PHP_BENEFIT_NAV": "التنقل",
  "PHP_BENEFIT_NAV_SUB": "الانتقال إلى التعريف والبحث عن الاستخدامات",
  "PHP_PANEL_TEXT": "ميزة التحليل الذكي لشيفرة PHP متوقفة. قم بتثبيت خادم لغة Intelephense (مجاني، تنزيل بحجم 9 ميجابايت تقريبًا) للحصول على ميزات الإكمال التلقائي، وتدقيق الأخطاء، والتوثيق، والانتقال إلى التعريف.",
  "PHP_INSTALLING": "إعداد دعم PHP — جارٍ تنزيل خادم اللغة...",
  ...
  "DESCRIPTION_PHP_CODE_INTELLIGENCE": "القيمة false لتعطيل ميزة التحليل الذكي لشيفرة PHP (Intelephense). إعادة تعيينها إلى true تعرض خيار تنزيل خادم اللغة مرة أخرى.",
  ...
  "PHP_INSTALL_DIALOG_TITLE": "تثبيت ذكاء الشيفرة لـ PHP",
  "PHP_INSTALL_DIALOG_TEXT": "إكمالات متقدمة، وتدقيق الأخطاء، ووثائق والمزيد لـ PHP.",
  "PHP_INSTALL_DIALOG_SIZE": "تنزيل بحجم 9 ميجابايت",
  "PHP_INSTALL_LATER_INFO": "يمكنك دائمًا التثبيت لاحقًا — يظهر شريط التثبيت كلما تم فتح ملف PHP.",
  "LSP_INSTALL_POWERED_BY": "بدعم من",
  "PYTHON_INSTALL_TITLE": "ذكاء الشيفرة لـ Python",
  "PYTHON_INSTALL_DIALOG_TITLE": "تثبيت ذكاء الشيفرة لـ Python",
  "PYTHON_INSTALL_MESSAGE": "هل تريد تثبيت ذكاء الشيفرة المتقدم لـ Python؟",
  "PYTHON_INSTALL_ENABLE": "تثبيت",
  "PYTHON_INSTALL_NOT_NOW": "ليس الآن",
  "PYTHON_POWERED_BY_PYREFLY": "مدعوم من Pyrefly",
  "PYTHON_BENEFIT_COMPLETIONS": "الإكمالات",
  "PYTHON_BENEFIT_COMPLETIONS_SUB": "اقتراحات ذكية أثناء الكتابة",
  "PYTHON_BENEFIT_DOCS": "التوثيق عند التمرير",
  "PYTHON_BENEFIT_DOCS_SUB": "مساعدة حول الدوال مباشرة في المحرر",
  "PYTHON_BENEFIT_ERRORS": "التحقق من الأخطاء",
  "PYTHON_BENEFIT_ERRORS_SUB": "تمييز الأخطاء أثناء كتابة التعليمات البرمجية",
  "PYTHON_BENEFIT_NAV": "التنقل",
  "PYTHON_BENEFIT_NAV_SUB": "الانتقال إلى التعريف والعثور على الاستخدامات",
  "PYTHON_BENEFIT_FORMAT": "التنسيق",
  "PYTHON_BENEFIT_FORMAT_SUB": "تنظيف الكود بأمر واحد باستخدام Ruff",
  "PYTHON_INSTALL_DIALOG_TEXT": "إكمالات متقدمة، وتدقيق للأخطاء، ووثائق، وتنسيق للغة Python.",
  "PYTHON_INSTALL_DIALOG_SIZE": "تنزيل بحجم 25 ميجابايت",
  "PYTHON_INSTALL_LATER_INFO": "يمكنك التثبيت لاحقًا دائمًا — يظهر شريط التثبيت كلما تم فتح ملف Python.",
  "PYTHON_PANEL_TEXT": "ميزات الذكاء الاصطناعي لكود Python متوقفة. قم بتثبيت خادم اللغة Pyrefly ومنسق Ruff (مجانًا، تنزيل بحجم 25 ميجابايت تقريبًا) للحصول على الإكمالات، وتدقيق الأخطاء، والوثائق، والتنسيق، والانتقال إلى التعريف.",
  "PYTHON_INSTALLING": "جارٍ إعداد دعم Python — يتم الآن تنزيل أدوات اللغة...",
  ...
  "DESCRIPTION_PYTHON_CODE_INTELLIGENCE": "اضبط القيمة على false لتعطيل ميزات الذكاء الاصطناعي لكود Python (Pyrefly). إعادة ضبطها على true يعرض تنزيل خادم اللغة مرة أخرى."
});