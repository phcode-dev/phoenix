...
define({
  ...
  "AI_CHAT_CLI_NOT_FOUND_TITLE": "لم يتم العثور على {0}",
  "AI_CHAT_CLI_NOT_FOUND_MSG": "تعذر العثور على {0} على هذا النظام. قم بتثبيته، أو أدخل المسار الكامل لملفه التنفيذي أدناه.",
  "AI_CHAT_CLI_NOT_FOUND_BAD_PATH_MSG": "تعذر استخدام المسار المحدد لـ {0}: {1}. أدخل مسارًا مختلفًا، أو امسح المربع لاكتشافه تلقائيًا.",
  "AI_CHAT_CLI_NOT_FOUND_INSTALL_BTN": "تثبيت {0}",
  "AI_CHAT_CLI_NOT_FOUND_SAVE_BTN": "حفظ وإعادة المحاولة",
  "AI_CHAT_CLI_NOT_FOUND_LEARN_MORE": "تعليمات التثبيت",
  ...
  "AI_CHAT_PLACEHOLDER_SUBTITLE": "ذكاء اصطناعي يعمل مع معاينتك",
  "AI_CHAT_PLACEHOLDER_CARD_LAYOUT_TITLE": "إنشاء تخطيط",
  "AI_CHAT_PLACEHOLDER_CARD_LAYOUT_DESC": "صِف قسمًا",
  "AI_CHAT_PLACEHOLDER_CARD_BUGS_TITLE": "إصلاح الأخطاء البرمجية",
  "AI_CHAT_PLACEHOLDER_CARD_BUGS_DESC": "ابحث عن المشاكل",
  "AI_CHAT_PLACEHOLDER_CARD_IMPROVE_TITLE": "اقتراح تحسينات",
  "AI_CHAT_PLACEHOLDER_CARD_IMPROVE_DESC": "نصائح حول تجربة المستخدم والأداء",
  "AI_CHAT_LOGIN_TITLE": "سجّل الدخول للبدء في استخدام الذكاء الاصطناعي",
  "AI_CHAT_LOGIN_MESSAGE": "سجّل الدخول إلى حسابك في {APP_NAME} للوصول إلى ميزات الذكاء الاصطناعي.",
  ...
  "AI_CHAT_ONBOARDING_REVIEW_PROMPT": "جاهز للبناء",
  "AI_CHAT_ONBOARDING_SEND": "إرسال",
  ...
  "LIVE_PREVIEW_LAYERS_SHOW_MORE_FILES": "إظهار {0} المزيد",
  "LIVE_PREVIEW_LAYERS_SHOW_FEWER_FILES": "إظهار عدد أقل",
