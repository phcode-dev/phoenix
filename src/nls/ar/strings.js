...
define({
  ...
  "LIVE_DEV_STYLES_PANEL_HEADER": "محرر الأنماط",
  "LIVE_DEV_STYLES_EDIT_TOOLTIP": "تحرير الأنماط",
  "LIVE_DEV_STYLES_PANEL_ADD": "+ إضافة",
  "LIVE_DEV_STYLES_PANEL_NO_RULES": "لم يتم العثور على قواعد CSS",
  "LIVE_DEV_STYLES_PANEL_MATCHING_RULES": "القواعد المطابقة ({0})",
  "LIVE_DEV_STYLES_PANEL_LOADING": "جارٍ تحميل الأنماط...",
  "LIVE_DEV_STYLES_PANEL_NO_STYLES": "لم يتم العثور على أنماط",
  "LIVE_DEV_STYLES_PANEL_PROPERTY_PLACEHOLDER": "خاصية",
  "LIVE_DEV_STYLES_PANEL_VALUE_PLACEHOLDER": "قيمة",
  ...
  "AI_CHAT_PLACEHOLDER": "اسأل Claude...",
  "AI_CHAT_SEND_TITLE": "إرسال رسالة",
  "AI_CHAT_STOP_TITLE": "إيقاف الإنشاء (Esc)",
  "AI_CHAT_CLI_NOT_FOUND": "لم يتم العثور على Claude CLI",
  "AI_CHAT_CLI_INSTALL_MSG": "ثبّت Claude CLI لاستخدام ميزات الذكاء الاصطناعي:<br><code>npm install -g @anthropic-ai/claude-code</code><br><br>ثم قم بتشغيل <code>claude login</code> للمصادقة.",
  "AI_CHAT_RETRY": "إعادة المحاولة",
  "AI_CHAT_DESKTOP_ONLY": "ميزات الذكاء الاصطناعي تتطلب تطبيق Phoenix لسطح المكتب.",
  "AI_CHAT_TOOL_SEARCH_FILES": "بحث في الملفات",
  "AI_CHAT_TOOL_SEARCH_CODE": "بحث في الكود",
  "AI_CHAT_TOOL_READ": "قراءة",
  "AI_CHAT_TOOL_EDIT": "تعديل",
  "AI_CHAT_TOOL_WRITE": "كتابة",
  "AI_CHAT_TOOL_RUN_CMD": "تشغيل أمر",
  "AI_CHAT_TOOL_SKILL": "مهارة",
  "AI_CHAT_TOOL_SEARCHED": "تم البحث عن: {0}",
  "AI_CHAT_TOOL_GREP": "Grep: {0}",
  "AI_CHAT_TOOL_READ_FILE": "قراءة {0}",
  "AI_CHAT_TOOL_EDIT_FILE": "تعديل {0}",
  "AI_CHAT_TOOL_WRITE_FILE": "كتابة {0}",
  "AI_CHAT_TOOL_RAN_CMD": "تم تنفيذ الأمر",
  "AI_CHAT_TOOL_SKILL_NAME": "المهارة: {0}",
  "AI_CHAT_TOOL_IN_PATH": "في {0}",
  "AI_CHAT_TOOL_INCLUDE": "تضمين {0}",
  "AI_CHAT_RECEIVING_BYTES": "جارٍ استلام {0} بايت...",
  "AI_CHAT_FILES_CHANGED": "تم تغيير {0} {1}",
  "AI_CHAT_FILE_SINGULAR": "ملف",
  "AI_CHAT_FILE_PLURAL": "ملفات",
  "AI_CHAT_RESTORE_POINT": "استعادة إلى هذه النقطة",
  "AI_CHAT_UNDO": "تراجع",
  ...
  "AI_CHAT_LABEL_CLAUDE": "كلود",
  "AI_CHAT_SEND_ERROR": "فشل إرسال الرسالة: {0}",
  "AI_CHAT_EDIT_NOT_FOUND": "لم يتم العثور على النص في الملف — ربما تم تغييره",
  "AI_CHAT_WORKING": "جارٍ العمل...",
  "AI_CHAT_WRITING": "جارٍ الكتابة...",
  "AI_CHAT_PROCESSING": "جارٍ المعالجة...",
  ...
  "AI_CHAT_TOOL_EDITOR_STATE": "حالة المحرر",
  ...
  "AI_CHAT_TOOL_SCREENSHOT_FULL_PAGE": "صفحة كاملة",
  "AI_CHAT_TOOL_LIVE_PREVIEW_JS": "معاينة مباشرة JS",
  "AI_CHAT_TOOL_CONTROL_EDITOR": "المحرر",
  "AI_CHAT_TOOL_TASKS": "المهام",
  "AI_CHAT_TOOL_TASKS_SUMMARY": "تم إنجاز {0} من {1} من المهام",
  "AI_CHAT_CONTEXT_SELECTION": "تحديد س{0}-س{1}",
  "AI_CHAT_CONTEXT_CURSOR": "سطر {0}",
  "AI_CHAT_CONTEXT_LIVE_PREVIEW": "معاينة مباشرة"
});