...
define({
  ...
  "MIGRATE_SUNSET_COUNTDOWN": "تبقى لديك <strong>{0} أيام</strong> قبل أن يتوقف {1} عن العمل.",
  "MIGRATE_SUNSET_COUNTDOWN_ONE": "تبقى لديك <strong>{0} يوم</strong> قبل أن يتوقف {1} عن العمل.",
  ...
  "MIGRATE_MANUAL_DOWNLOAD_NOTE": "النقل التلقائي غير متاح في هذا المتصفح. إذا كانت لديك مشاريع محفوظة هنا، فيرجى تنزيلها قبل التاريخ المذكور أعلاه حتى تتمكن من فتحها مرة أخرى على الموقع الجديد.",
  "MIGRATE_TWA_UPDATE_NOTE": "يرجى تحديث التطبيق عندما تتمكن من ذلك. لن يتوقف أي شيء عن العمل اليوم، ويمكنك الاستمرار في استخدام هذا الإصدار في هذه الأثناء.",
  "MIGRATE_TWA_BROWSER_LINK": "إذا لم تتمكن من التحديث الآن، فيمكنك أيضًا <a href='{0}'>المتابعة في متصفح على {1}</a>.",
