...
define({
  ...
  "PROMO_CARD_2_MESSAGE": "استكشف أفكار واجهة المستخدم، وابنِ التطبيقات، وأصلح المشكلات باستخدام الذكاء الاصطناعي — فهو يرى صفحتك بنفس الطريقة التي تراها بها، وليس مجرد الكود البرمجي.",
