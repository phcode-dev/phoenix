...
define({
  ...
  "IMAGE_SEARCH_MONTHLY_LIMIT_MESSAGE": "لقد استخدمت كل عمليات البحث عن الصور البالغ عددها {0} لهذا الشهر.<br>اشترك في خطة Phoenix Pro مدفوعة لإزالة قيود الفترة التجريبية ومواصلة البحث."
});