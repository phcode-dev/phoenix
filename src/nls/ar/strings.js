...
define({
  ...
  "AI_CHAT_FULL_AUTO_WARNING_TITLE": "التبديل إلى وضع التشغيل التلقائي الكامل؟",
  "AI_CHAT_FULL_AUTO_WARNING_BODY": "يسمح وضع التشغيل التلقائي الكامل للذكاء الاصطناعي بتشغيل أي أداة — أوامر Bash، وتعديلات الملفات، وحذف الملفات، وجلب البيانات من الويب — دون أن يطلب منك الإذن أولاً.<br><br>هذا مناسب للمشاريع التجريبية الموثوقة، ولكنه قد يكون محفوفًا بالمخاطر: فقد تؤدي خطوة خاطئة إلى الكتابة فوق الملفات أو حذفها، أو تشغيل أمر طرفية تدميري، أو دفع تغييرات غير مقصودة. استخدم نظام التحكم في الإصدارات (Git) حتى تتمكن من الاسترداد إذا حدث خطأ ما.<br><br>قم بتمكين وضع التشغيل التلقائي الكامل فقط في المشاريع التي تثق بها. يمكنك العودة إلى وضع التحرير في أي وقت باستخدام <kbd>Shift+Tab</kbd> أو بالنقر على شريط الوضع.",
  "AI_CHAT_FULL_AUTO_WARNING_PROCEED": "تمكين التشغيل التلقائي الكامل",
