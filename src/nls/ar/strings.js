...
define({
  ...
  "DESCRIPTION_LIVEDEV_MAIN_HEADING": "عفوًا! متصفحك الحالي لا يدعم المعاينة المباشرة.",
  "DESCRIPTION_LIVEDEV_MAIN_SPAN": "احصل على أفضل تجربة للمعاينة المباشرة بتنزيل تطبيقاتنا الأصلية لأنظمة ويندوز، وماك، ولينكس من {0}.",
  "AI_CHAT_TOOL_READ_FILE_RANGE": "قراءة الملف {0}: الأسطر {1}-{2}",
  "AI_CHAT_TOOL_READ_FILE_FROM": "قراءة الملف {0} من السطر {1}",
  ...
  "AI_CHAT_FILE_NOT_FOUND_TITLE": "الملف غير موجود",
  "AI_CHAT_FILE_NOT_FOUND_MSG": "تعذر فتح <span class=\"dialog-filename\">{0}</span>. ربما تم نقل الملف أو حذفه.",
  "AI_CHAT_DIFF_MORE_TITLE": "خيارات الفرق",
  "AI_CHAT_DIFF_EXPAND_ALL": "توسيع الكل",
  "AI_CHAT_DIFF_COLLAPSE_ALL": "طي الكل",
  "AI_CHAT_DIFF_ALWAYS_SHOW": "الإظهار دائمًا",
  "AI_CHAT_PLAN_WRITE_CONFIRM_TITLE": "التبديل إلى وضع التعديل؟",
  "AI_CHAT_PLAN_WRITE_CONFIRM_BODY": "يريد Claude تعديل {0}. أنت حاليًا في وضع التخطيط.",
  "AI_CHAT_PLAN_WRITE_ALLOW": "السماح والتبديل إلى وضع التعديل",
  "AI_CHAT_PLAN_WRITE_STAY": "البقاء في وضع التخطيط",
  "AI_CHAT_PLAN_WRITE_ALLOWED": "تم التبديل إلى وضع التعديل",
