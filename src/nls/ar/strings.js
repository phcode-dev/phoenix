...
define({
  ...
  "LIVE_DEV_SETTINGS_SHOW_STYLES_BAR_PREFERENCE": "إظهار شريط الأنماط عند تحديد العناصر في المعاينة المباشرة. القيمة الافتراضية هي 'true'",
  "LIVE_DEV_SETTINGS_SHOW_STARTER_BAR_PREFERENCE": "إظهار شريط البدء عندما تكون صفحة المعاينة المباشرة فارغة. القيمة الافتراضية هي 'true'",
  "LIVE_DEV_SETTINGS_STYLES_BAR_POSITION_PREFERENCE": "الحافة التي يرسو إليها شريط أنماط المعاينة المباشرة، 'top' أو 'bottom'. القيمة الافتراضية هي 'bottom'",
  "LIVE_DEV_TOOLBOX_SELECT_PARENT": "تحديد الأصل",
  "LIVE_DEV_SCRIPT_GENERATED_TOOLTIP": "أُضيف بواسطة سكربت، لذا فهو غير موجود في مصدر HTML. لا يزال من الممكن تعديل قواعد CSS الخاصة به.",
  "LIVE_DEV_STYLER_SCRIPT_ELEMENT_NOTICE": "عنصر مُنشأ بواسطة سكربت: يتم حفظ التعديلات في قواعد CSS الخاصة به",
  "LIVE_DEV_TOOLBOX_EDIT_TEXT": "تحرير النص",
  "LIVE_DEV_TOOLBOX_DOUBLE_CLICK_HINT": "النقر المزدوج",
  "LIVE_DEV_TOOLBOX_EDIT_ELEMENT_PROPS": "تحرير خصائص العنصر",
  ...
  "LIVE_DEV_STYLER_DOCK_BOTTOM": "إرساء في الأسفل",
  "LIVE_DEV_STYLER_RESET": "إعادة تعيين التغييرات",
  "LIVE_DEV_STYLER_NOTHING_TO_RESET": "لا توجد تغييرات لإعادة تعيينها",
  "LIVE_DEV_STYLER_OVERRIDDEN": "يتم تجاوز هذا التغيير بواسطة قاعدة أكثر تحديدًا",
  "LIVE_DEV_STYLER_APPLY_INLINE": "تطبيق على أي حال",
  "LIVE_DEV_STYLER_CLOSE_SAVED": "تم",
  "LIVE_DEV_STYLER_MIXED": "مختلط",
  "LIVE_DEV_STYLER_SIDES_MIXED": "الجوانب مختلفة — حرّر كل جانب على حدة",
  ...
  "LIVE_DEV_STYLER_LOAD_MORE": "تحميل المزيد",
  ...
  "LIVE_DEV_STYLER_WEIGHT_THIN": "رفيع",
  "LIVE_DEV_STYLER_WEIGHT_EXTRA_LIGHT": "خفيف جدًا",
  "LIVE_DEV_STYLER_WEIGHT_LIGHT": "خفيف",
  "LIVE_DEV_STYLER_WEIGHT_REGULAR": "عادي",
  "LIVE_DEV_STYLER_WEIGHT_MEDIUM": "متوسط",
  "LIVE_DEV_STYLER_WEIGHT_SEMI_BOLD": "شبه عريض",
  "LIVE_DEV_STYLER_WEIGHT_BOLD": "عريض",
  "LIVE_DEV_STYLER_WEIGHT_EXTRA_BOLD": "عريض جدًا",
  "LIVE_DEV_STYLER_WEIGHT_BLACK": "أسود",
  "LIVE_DEV_STYLER_LINE_HEIGHT": "ارتفاع السطر",
  "LIVE_DEV_STYLER_LETTER_SPACING": "تباعد الأحرف",
  "LIVE_DEV_STYLER_WORD_SPACING": "تباعد الكلمات",
  "LIVE_DEV_STYLER_TEXT_INDENT": "مسافة بادئة للنص",
  "LIVE_DEV_STYLER_FORMAT_TAB": "تنسيق",
  "LIVE_DEV_STYLER_SPACING_TAB": "تباعد",
  "LIVE_DEV_STYLER_CASE": "حالة الأحرف",
  "LIVE_DEV_STYLER_ITALIC": "مائل",
  "LIVE_DEV_STYLER_UNDERLINE": "تسطير",
  "LIVE_DEV_STYLER_OVERLINE": "خط علوي",
  "LIVE_DEV_STYLER_STRIKETHROUGH": "يتوسطه خط",
  "LIVE_DEV_STYLER_NONE": "بلا",
  "LIVE_DEV_STYLER_UPPERCASE": "أحرف كبيرة",
  "LIVE_DEV_STYLER_LOWERCASE": "أحرف صغيرة",
  "LIVE_DEV_STYLER_CAPITALIZE": "تكبير الحرف الأول",
  "LIVE_DEV_STYLER_ALIGN_LEFT": "محاذاة إلى اليسار",
  "LIVE_DEV_STYLER_ALIGN_CENTER": "توسيط",
  "LIVE_DEV_STYLER_ALIGN_RIGHT": "محاذاة إلى اليمين",
  "LIVE_DEV_STYLER_ALIGN_JUSTIFY": "ضبط",
  "LIVE_DEV_STYLER_CURSOR": "مؤشر",
  "LIVE_DEV_STYLER_CURSOR_AUTO": "تلقائي",
  "LIVE_DEV_STYLER_CURSOR_DEFAULT": "افتراضي",
  "LIVE_DEV_STYLER_CURSOR_POINTER": "يد",
  "LIVE_DEV_STYLER_CURSOR_TEXT": "نص",
  "LIVE_DEV_STYLER_CURSOR_MOVE": "تحريك",
  "LIVE_DEV_STYLER_CURSOR_GRAB": "إمساك",
  "LIVE_DEV_STYLER_CURSOR_GRABBING": "قيد الإمساك",
  "LIVE_DEV_STYLER_CURSOR_NOT_ALLOWED": "غير مسموح",
  "LIVE_DEV_STYLER_CURSOR_HELP": "مساعدة",
  "LIVE_DEV_STYLER_CURSOR_WAIT": "انتظار",
  "LIVE_DEV_STYLER_CURSOR_PROGRESS": "تقدم",
  "LIVE_DEV_STYLER_CURSOR_CROSSHAIR": "تقاطع",
  "LIVE_DEV_STYLER_CURSOR_ZOOM_IN": "تكبير",
  "LIVE_DEV_STYLER_CURSOR_ZOOM_OUT": "تصغير",
  "LIVE_DEV_STYLER_REMOVE_BACKGROUND": "إزالة لون الخلفية",
  "LIVE_DEV_STYLER_REMOVE_PROPERTY": "إزالة {0}",
  "LIVE_DEV_STYLER_RESET_DEFAULT": "إعادة التعيين إلى القيمة الافتراضية للمتصفح",
  "LIVE_DEV_STYLER_CTX_NOT_SET": "غير مُعيّن على هذا العنصر",
  "LIVE_DEV_STYLER_CTX_SHORTHAND_BLOCKED": "تم التعيين بواسطة خاصية مختصرة، استخدم إعادة التعيين بدلاً من ذلك",
  "LIVE_DEV_STYLER_AFFECTS_TITLE": "يؤثر {0} على {1} من العناصر في هذه الصفحة",
  "LIVE_DEV_STYLER_CTX_AFFECTS": "يؤثر على {0} من العناصر",
  "LIVE_DEV_STYLER_CTX_AFFECTS_ONE": "يؤثر على هذا العنصر فقط",
  "LIVE_DEV_STYLER_CTX_FROM_RULE": "من {0}",
  "LIVE_DEV_STYLER_CTX_INLINE_STYLE": "النمط المضمن لهذا العنصر",
  "LIVE_DEV_STYLER_CTX_ADDS_REVERT": "إضافة {0} إلى هذا العنصر",
  "LIVE_DEV_STYLER_CLEAR_IN_RULE": "تم تعيين {0} بواسطة {1}",
  "LIVE_DEV_STYLER_CLEAR_IN_INLINE": "تم تعيين {0} في {1}",
  "LIVE_DEV_STYLER_CLEAR_IN_SHORTHAND": "تم تعيين {0} بواسطة الخاصية المختصرة {1}",
  "LIVE_DEV_STYLER_CLEAR_REMOVE_BTN": "إزالة",
  "LIVE_DEV_STYLER_CLEAR_RESET_BTN": "إعادة تعيين",
  "LIVE_DEV_STYLER_LEARN_MORE": "تعلم المزيد...",
  ...
  "LIVE_DEV_STYLER_FROM_GOOGLE": "من خطوط جوجل",
  "LIVE_DEV_STYLER_COMMON_COLORS": "شائعة",
  "LIVE_DEV_STYLER_COLOR_WHITE": "أبيض",
  "LIVE_DEV_STYLER_COLOR_SILVER": "فضي",
  "LIVE_DEV_STYLER_COLOR_GRAY": "رمادي",
  "LIVE_DEV_STYLER_COLOR_BLACK": "أسود",
  "LIVE_DEV_STYLER_COLOR_RED": "أحمر",
  "LIVE_DEV_STYLER_COLOR_MAROON": "كستنائي",
  "LIVE_DEV_STYLER_COLOR_ORANGE": "برتقالي",
  "LIVE_DEV_STYLER_COLOR_GOLD": "ذهبي",
  "LIVE_DEV_STYLER_COLOR_YELLOW": "أصفر",
  "LIVE_DEV_STYLER_COLOR_OLIVE": "زيتوني",
  "LIVE_DEV_STYLER_COLOR_LIME": "ليموني",
  "LIVE_DEV_STYLER_COLOR_GREEN": "أخضر",
  "LIVE_DEV_STYLER_COLOR_TEAL": "أزرق مخضر",
  "LIVE_DEV_STYLER_COLOR_CYAN": "سماوي",
  "LIVE_DEV_STYLER_COLOR_BLUE": "أزرق",
  "LIVE_DEV_STYLER_COLOR_NAVY": "كحلي",
  "LIVE_DEV_STYLER_COLOR_INDIGO": "نيلي",
  "LIVE_DEV_STYLER_COLOR_PURPLE": "بنفسجي",
  "LIVE_DEV_STYLER_COLOR_MAGENTA": "أرجواني",
  "LIVE_DEV_STYLER_COLOR_VIOLET": "بنفسجي",
  "LIVE_DEV_STYLER_COLOR_PINK": "وردي",
  "LIVE_DEV_STYLER_STYLE": "النمط",
  "LIVE_DEV_STYLER_SOLID": "متصل",
  "LIVE_DEV_STYLER_DASHED": "متقطع",
  "LIVE_DEV_STYLER_DOTTED": "منقط",
  "LIVE_DEV_STYLER_DOUBLE": "مزدوج",
  "LIVE_DEV_STYLER_OUTLINE": "إطار خارجي",
  "LIVE_DEV_STYLER_OFFSET": "إزاحة",
  "LIVE_DEV_STYLER_BORDER_AND_OUTLINE": "الحدود والمخطط التفصيلي",
  "LIVE_DEV_STYLER_BORDER_COLOR": "لون الحد",
  "LIVE_DEV_STYLER_OUTLINE_COLOR": "لون المخطط التفصيلي",
  "LIVE_DEV_STYLER_SIDE": "جانب",
  "LIVE_DEV_STYLER_PADDING": "حشوة",
  "LIVE_DEV_STYLER_MARGIN": "هامش",
  "LIVE_DEV_STYLER_SIDES_LINKED": "تعديل جميع الجوانب معًا",
  "LIVE_DEV_STYLER_SIDES_INDEPENDENT": "تعديل الجوانب بشكل مستقل",
  "LIVE_DEV_STYLER_LINK_NONE": "جوانب مستقلة - لكل جانب قيمته الخاصة",
  "LIVE_DEV_STYLER_LINK_PAIRED": "مقترن - يرتبط العلوي والسفلي، واليسار واليمين",
  "LIVE_DEV_STYLER_LINK_ALL": "كل الجوانب مرتبطة - قيمة واحدة لكل جانب",
  "LIVE_DEV_STYLER_LINK_NONE_SHORT": "مستقل",
  "LIVE_DEV_STYLER_LINK_PAIRED_SHORT": "مقترن",
  "LIVE_DEV_STYLER_LINK_ALL_SHORT": "الكل مرتبط",
  "LIVE_DEV_STYLER_LINK_CYCLE_HINT": "انقر لتغيير كيفية ربط الجوانب",
  "LIVE_DEV_STYLER_ALL_SIDES": "الكل",
  "LIVE_DEV_STYLER_TOP": "أعلى",
  "LIVE_DEV_STYLER_RIGHT": "يمين",
  "LIVE_DEV_STYLER_BOTTOM": "أسفل",
  "LIVE_DEV_STYLER_LEFT": "يسار",
  "LIVE_DEV_STYLER_DISPLAY": "العرض",
  "LIVE_DEV_STYLER_DIRECTION": "الاتجاه",
  "LIVE_DEV_STYLER_JUSTIFY": "ضبط",
  "LIVE_DEV_STYLER_ALIGN_ITEMS": "محاذاة العناصر",
  "LIVE_DEV_STYLER_WRAP": "التفاف",
  "LIVE_DEV_STYLER_GAP": "فجوة",
  "LIVE_DEV_STYLER_COLUMNS": "أعمدة",
  "LIVE_DEV_STYLER_ROWS": "صفوف",
  "LIVE_DEV_STYLER_POSITION": "الموضع",
  "LIVE_DEV_STYLER_Z_INDEX": "مؤشر Z",
  "LIVE_DEV_STYLER_BLOCK": "كتلة",
  "LIVE_DEV_STYLER_INLINE": "مضمن",
  "LIVE_DEV_STYLER_INLINE_BLOCK": "كتلة مضمنة",
  "LIVE_DEV_STYLER_FLEX": "مرن",
  "LIVE_DEV_STYLER_INLINE_FLEX": "فلكس مضمن",
  "LIVE_DEV_STYLER_GRID": "شبكة",
  "LIVE_DEV_STYLER_HIDDEN": "مخفي",
  "LIVE_DEV_STYLER_ROW": "صف",
  "LIVE_DEV_STYLER_COLUMN": "عمود",
  "LIVE_DEV_STYLER_ROW_REVERSE": "صف معكوس",
  "LIVE_DEV_STYLER_COLUMN_REVERSE": "عمود معكوس",
  "LIVE_DEV_STYLER_START": "بداية",
  "LIVE_DEV_STYLER_CENTER": "وسط",
  "LIVE_DEV_STYLER_END": "نهاية",
  "LIVE_DEV_STYLER_SPACE_BETWEEN": "مسافة بينية",
  "LIVE_DEV_STYLER_SPACE_AROUND": "مسافة حول",
  "LIVE_DEV_STYLER_SPACE_EVENLY": "مسافة متساوية",
  "LIVE_DEV_STYLER_STRETCH": "تمدد",
  "LIVE_DEV_STYLER_BASELINE": "خط الأساس",
  "LIVE_DEV_STYLER_NO_WRAP": "بدون التفاف",
  "LIVE_DEV_STYLER_WRAP_REVERSE": "التفاف عكسي",
  "LIVE_DEV_STYLER_STATIC": "ثابت",
  "LIVE_DEV_STYLER_RELATIVE": "نسبي",
  "LIVE_DEV_STYLER_ABSOLUTE": "مطلق",
  "LIVE_DEV_STYLER_STICKY": "لاصق",
  "LIVE_DEV_STYLER_FIXED": "ثابت",
  "LIVE_DEV_STYLER_PLACEMENT": "الموضع",
  "LIVE_DEV_STYLER_DISTRIBUTE": "توزيع",
  "LIVE_DEV_STYLER_PACKED": "مرصوص",
  "LIVE_DEV_STYLER_APPLIES_TO": "حفظ التغييرات في",
  "LIVE_DEV_STYLER_INLINE_STYLE": "مضمن",
  ...
  "LIVE_DEV_STYLER_STATE_EXIT_NAMED": "الخروج من {0}",
  "LIVE_DEV_STYLER_STATE_NO_BASE": "لا يمكن تطبيق الحالات على الأنماط المضمنة",
  ...
  "LIVE_DEV_STYLER_STATE_CHECKED": "مُحدَّد",
  "LIVE_DEV_STYLER_STATE_DISABLED": "مُعطَّل",
  "LIVE_DEV_STYLER_STATE_ENABLED": "مُمكَّن",
  "LIVE_DEV_STYLER_STATE_PLACEHOLDER_SHOWN": "العنصر النائب معروض",
  "LIVE_DEV_STYLER_HEIGHT": "الارتفاع",
  "LIVE_DEV_STYLER_SIZE_TAB": "الحجم",
  "LIVE_DEV_STYLER_MIN_WIDTH": "العرض الأدنى",
  "LIVE_DEV_STYLER_MAX_WIDTH": "العرض الأقصى",
  "LIVE_DEV_STYLER_MIN_HEIGHT": "الارتفاع الأدنى",
  "LIVE_DEV_STYLER_MAX_HEIGHT": "الارتفاع الأقصى",
  "LIVE_DEV_STYLER_MIN": "أدنى",
  "LIVE_DEV_STYLER_MAX": "أقصى",
  "LIVE_DEV_STYLER_LIMITS": "الحد الأدنى / الأقصى",
  "LIVE_DEV_STYLER_LIMITS_SHOW": "إظهار حدود الحجم الأدنى / الأقصى",
  "LIVE_DEV_STYLER_LIMITS_HIDE": "إخفاء حدود الحجم الأدنى / الأقصى",
  "LIVE_DEV_STYLER_OPACITY": "الشفافية",
  "LIVE_DEV_STYLER_CHANGE_UNIT": "تغيير الوحدة - للتبديل بين {0}",
  "LIVE_DEV_STYLER_INCREASE_VALUE": "زيادة {0}",
  "LIVE_DEV_STYLER_DECREASE_VALUE": "إنقاص {0}",
  "LIVE_DEV_STYLER_INCREASE": "زيادة القيمة",
  "LIVE_DEV_STYLER_DECREASE": "إنقاص القيمة",
  "LIVE_DEV_STYLER_STEP_HINT": "شيفت + نقر: ×10",
  "LIVE_DEV_STYLER_EYEDROPPER": "التقاط لون من الصفحة",
  "LIVE_DEV_MORE_OPTIONS_CUT": "قص",
  "LIVE_DEV_MORE_OPTIONS_COPY": "نسخ",
  "LIVE_DEV_MORE_OPTIONS_PASTE": "لصق",
  "LIVE_DEV_INSERT_ELEMENT": "إدراج عنصر",
  "LIVE_DEV_INSERT_BEFORE": "قبل",
  "LIVE_DEV_INSERT_AFTER": "بعد",
  "LIVE_DEV_INSERT_INSIDE": "بالداخل",
  "LIVE_DEV_INSERT_WRAP": "تغليف",
  ...
  "LIVE_DEV_INSERT_SHOW_MORE": "إظهار المزيد",
  "LIVE_DEV_INSERT_SHOW_LESS": "عرض أقل",
  "LIVE_DEV_INSERT_CREATE": "إنشاء {0}",
  "LIVE_DEV_INSERT_NAME_ACCORDION": "أكورديون",
  "LIVE_DEV_INSERT_NAME_PASSWORD": "كلمة المرور",
  "LIVE_DEV_INSERT_NAME_MAIN_CONTENT": "المحتوى الرئيسي",
  "LIVE_DEV_INSERT_NAME_CODE_BLOCK": "كتلة برمجية",
  "LIVE_DEV_INSERT_NAME_DEF_LIST": "قائمة تعريفات",
  "LIVE_DEV_INSERT_NAME_FILE_UPLOAD": "رفع ملف",
  "LIVE_DEV_INSERT_NAME_DATE_PICKER": "منتقي التاريخ",
  "LIVE_DEV_INSERT_NAME_IFRAME": "iFrame",
  "LIVE_DEV_STARTER_BAR_LABEL": "صفحتك فارغة — أضف عنصرًا",
  ...
  "LIVE_DEV_ELEMENT_PROPS_VOID_ERROR": "<{0}> هو وسم ذاتي الإغلاق ولا يمكن أن يحتوي على محتوى",
  "LIVE_DEV_ELEMENT_PROPS_SIZE": "الحجم",
  "LIVE_DEV_ELEMENT_PROPS_CLASS": "فئة",
  "LIVE_DEV_ELEMENT_PROPS_ID": "معرّف",
  "LIVE_DEV_ELEMENT_PROPS_HREF": "رابط",
  "LIVE_DEV_ELEMENT_PROPS_ADD_CLASS": "+ إضافة فئة",
  "LIVE_DEV_ELEMENT_PROPS_CLASS_PLACEHOLDER": "أضف فئة...",
  "LIVE_DEV_ELEMENT_PROPS_ID_PLACEHOLDER": "أضف معرّفًا...",
  "LIVE_DEV_ELEMENT_PROPS_SEARCH_TAGS": "اقتراحات الوسوم",
  "LIVE_DEV_ELEMENT_PROPS_COMPUTED": "محسوب:",
  "LIVE_DEV_ELEMENT_PROPS_USE_CUSTOM": "استخدام “{0}”",
  "LIVE_DEV_ELEMENT_PROPS_ATTRIBUTES": "السمات",
  "LIVE_DEV_ELEMENT_PROPS_ADD_ATTR": "+ إضافة سمة",
  "LIVE_DEV_ELEMENT_PROPS_ATTR_NAME": "الاسم",
  "LIVE_DEV_ELEMENT_PROPS_ATTR_VALUE": "القيمة",
  "LIVE_DEV_ELEMENT_PROPS_LOADING": "جارٍ التحميل",
  "LIVE_DEV_ELEMENT_PROPS_NO_CLASSES": "لا توجد فئات بعد",
  "LIVE_DEV_ELEMENT_PROPS_NO_ATTRIBUTES": "لا توجد سمات بعد",
  "LIVE_DEV_ELEMENT_PROPS_RESETTING": "جارٍ إعادة التعيين",
  "LIVE_DEV_CB_EXCEEDED_CLASSES": "+{0} أخرى",
  "LIVE_DEV_CB_TIP_TEXT_COLOR": "لون النص",
  "LIVE_DEV_CB_TIP_BG_COLOR": "لون الخلفية",
  "LIVE_DEV_CB_TIP_FONT": "الخط",
  "LIVE_DEV_CB_TIP_TEXT_SPACING": "تباعد النص",
  "LIVE_DEV_CB_TIP_APPEARANCE": "الحدود والشفافية",
  "LIVE_DEV_CB_TIP_LAYOUT": "التخطيط",
  "LIVE_DEV_CB_TIP_POSITION": "الموضع",
  "LIVE_DEV_CB_TIP_OBJECT_FIT": "ملاءمة الكائن",
  "LIVE_DEV_CB_TIP_IMAGE": "صورة",
  "LIVE_DEV_CB_CHANGE_IMAGE": "تغيير الصورة",
  "LIVE_DEV_CB_TIP_LIST_STYLE": "نمط القائمة",
  "LIVE_DEV_CB_TIP_ALL_STYLES": "كل الأنماط",
  "LIVE_DEV_CB_LABEL_FAMILY": "العائلة",
  "LIVE_DEV_CB_LABEL_SIZE": "الحجم",
  "LIVE_DEV_CB_LABEL_WEIGHT": "الوزن",
  "LIVE_DEV_CB_LABEL_STYLE": "النمط",
  "LIVE_DEV_CB_LABEL_ALIGN": "محاذاة النص",
  "LIVE_DEV_CB_LABEL_TRANSFORM": "تحويل",
  "LIVE_DEV_CB_LABEL_LETTER_SPACING": "تباعد الأحرف",
  "LIVE_DEV_CB_LABEL_WORD_SPACING": "تباعد الكلمات",
  "LIVE_DEV_CB_LABEL_LINE_HEIGHT": "ارتفاع السطر",
  "LIVE_DEV_CB_LABEL_TEXT_INDENT": "المسافة البادئة للنص",
  "LIVE_DEV_CB_LABEL_WIDTH": "العرض",
  "LIVE_DEV_CB_LABEL_RADIUS": "نصف القطر",
  "LIVE_DEV_CB_LABEL_COLOR": "اللون",
  "LIVE_DEV_CB_LABEL_OPACITY": "التعتيم",
  "LIVE_DEV_CB_LABEL_DISPLAY": "عرض",
  "LIVE_DEV_CB_LABEL_DIRECTION": "اتجاه",
  "LIVE_DEV_CB_LABEL_WRAP": "التفاف",
  "LIVE_DEV_CB_LABEL_JUSTIFY": "محاذاة",
  "LIVE_DEV_CB_LABEL_GAP": "فجوة",
  "LIVE_DEV_CB_LABEL_OVERFLOW": "تجاوز",
  "LIVE_DEV_CB_LABEL_POSITION": "موضع",
  "LIVE_DEV_CB_LABEL_TOP": "أعلى",
  "LIVE_DEV_CB_LABEL_RIGHT": "يمين",
  "LIVE_DEV_CB_LABEL_BOTTOM": "أسفل",
  "LIVE_DEV_CB_LABEL_LEFT": "يسار",
  "LIVE_DEV_CB_LABEL_Z_INDEX": "مؤشر Z",
  "LIVE_DEV_CB_LABEL_FIT": "ملاءمة",
  "LIVE_DEV_CB_LABEL_TYPE": "النوع",
  "LIVE_DEV_CB_WEIGHT_THIN": "رفيع",
  "LIVE_DEV_CB_WEIGHT_REGULAR": "عادي",
  "LIVE_DEV_CB_WEIGHT_BOLD": "غامق",
  "LIVE_DEV_CB_WEIGHT_BLACK": "أسود",
  "LIVE_DEV_CB_STYLE_ITALIC": "مائل",
  "LIVE_DEV_CB_STYLE_UNDERLINE": "تسطير",
  "LIVE_DEV_CB_STYLE_STRIKETHROUGH": "يتوسطه خط",
  "LIVE_DEV_CB_STYLE_OVERLINE": "خط علوي",
  "LIVE_DEV_CB_ALIGN_LEFT": "يسار",
  "LIVE_DEV_CB_ALIGN_CENTER": "توسيط",
  "LIVE_DEV_CB_ALIGN_RIGHT": "يمين",
  "LIVE_DEV_CB_ALIGN_JUSTIFY": "ضبط",
  "LIVE_DEV_CB_TRANSFORM_NONE": "بلا",
  "LIVE_DEV_CB_TRANSFORM_CAPITALIZE": "أحرف استهلالية كبيرة",
  "LIVE_DEV_CB_TRANSFORM_UPPERCASE": "أحرف كبيرة",
  "LIVE_DEV_CB_TRANSFORM_LOWERCASE": "أحرف صغيرة",
  "LIVE_DEV_CB_SEARCH_FONTS": "بحث عن الخطوط...",
  "LIVE_DEV_CB_BACK": "رجوع",
  "LIVE_DEV_CB_BACK_ESC": "رجوع (Esc)",
  "LIVE_DEV_CB_RESET": "إعادة تعيين",
  "LIVE_DEV_CB_APPLIES_TO": "ينطبق على:",
  "LIVE_DEV_CB_INLINE": "سطري",
  "LIVE_DEV_CB_LIST_DISC": "قرص",
  "LIVE_DEV_CB_LIST_CIRCLE": "دائرة",
  "LIVE_DEV_CB_LIST_SQUARE": "مربع",
  "LIVE_DEV_CB_LIST_NONE": "بلا",
  "LIVE_DEV_CB_LIST_DECIMAL": "عشري",
  "LIVE_DEV_CB_LIST_LOWER_ALPHA": "أبجدي صغير",
  "LIVE_DEV_CB_LIST_UPPER_ALPHA": "أبجدي كبير",
  "LIVE_DEV_CB_LIST_LOWER_ROMAN": "روماني صغير",
  "LIVE_DEV_CB_LIST_UPPER_ROMAN": "روماني كبير",
  "LIVE_DEV_CB_LIST_OUTSIDE": "خارجي",
  "LIVE_DEV_CB_LIST_INSIDE": "داخلي",
  "LIVE_DEV_CB_TIP_SPACING": "الهامش والحشوة",
  "LIVE_DEV_CB_LABEL_MARGIN": "الهامش",
  "LIVE_DEV_CB_LABEL_PADDING": "الحشوة",
  "LIVE_DEV_CB_LABEL_CONTENT": "محتوى",
  "LIVE_DEV_CB_SPACING_LINK_INDEPENDENT": "منفصل",
  "LIVE_DEV_CB_SPACING_LINK_AXIS": "أزواج",
  "LIVE_DEV_CB_SPACING_LINK_ALL": "الكل متساوٍ",
  "LIVE_DEV_CB_LABEL_BORDER_TOP": "أعلى",
  "LIVE_DEV_CB_LABEL_BORDER_RIGHT": "يمين",
  "LIVE_DEV_CB_LABEL_BORDER_BOTTOM": "أسفل",
  "LIVE_DEV_CB_LABEL_BORDER_LEFT": "يسار",
  "LIVE_DEV_CB_LABEL_BORDER_TL": "ع. يسار",
  "LIVE_DEV_CB_LABEL_BORDER_TR": "ع. يمين",
  "LIVE_DEV_CB_LABEL_BORDER_BR": "س ي",
  "LIVE_DEV_CB_LABEL_BORDER_BL": "س ش",
  "LIVE_DEV_CB_PER_SIDE": "لكل جانب",
  "LIVE_DEV_CB_PER_CORNER": "لكل زاوية",
  "LIVE_DEV_CB_COLOR_RECENT": "الأخيرة",
  "LIVE_DEV_CB_COLOR_FROM_PAGE": "من الصفحة",
  "LIVE_DEV_CB_COLOR_SUGGESTED": "مقترحة",
  "LIVE_DEV_CB_LABEL_COLUMNS": "أعمدة",
  "LIVE_DEV_CB_LABEL_ROWS": "صفوف",
  "LIVE_DEV_CB_LABEL_JUSTIFY_ITEMS": "ضبط",
  "LIVE_DEV_CB_LABEL_ALIGN_ITEMS": "محاذاة",
  "LIVE_DEV_CB_LABEL_ROW_GAP": "فجوة الصف",
  "LIVE_DEV_CB_LABEL_COL_GAP": "فجوة العمود",
  "LIVE_DEV_CB_WEIGHT_EXTRA_LIGHT": "خفيف جدًا",
  "LIVE_DEV_CB_WEIGHT_LIGHT": "خفيف",
  "LIVE_DEV_CB_WEIGHT_MEDIUM": "متوسط",
  "LIVE_DEV_CB_WEIGHT_SEMI_BOLD": "شبه عريض",
  "LIVE_DEV_CB_WEIGHT_EXTRA_BOLD": "عريض جدًا",
  "LIVE_DEV_CB_GO_TO_SOURCE": "الانتقال إلى المصدر",
  "LIVE_DEV_CB_TIP_AI_STYLE": "تنسيق باستخدام الذكاء الاصطناعي",
  "LIVE_DEV_CB_AI_PLACEHOLDER": "صِف النمط الذي تريده...",
  "LIVE_DEV_CB_AI_SEND": "إرسال",
  "LIVE_DEV_CB_AI_THINKING": "جارٍ تطبيق الأنماط...",
  "LIVE_DEV_CB_MORE_OPTIONS": "المزيد من الخيارات",
  "LIVE_DEV_CB_DIM_W": "ع",
  "LIVE_DEV_CB_DIM_H": "ا",
  "LIVE_DEV_CB_MINMAX_TOOLTIP": "قيود الحد الأدنى/الأقصى",
  "LIVE_DEV_CB_MINMAX_MIN": "الحد الأدنى",
  "LIVE_DEV_CB_MINMAX_MAX": "الحد الأقصى",
  "LIVE_DEV_CB_ID_PLACEHOLDER": "لا شيء",
  "LIVE_DEV_CB_ALL_WEIGHTS": "جميع الأوزان",
  "LIVE_DEV_CB_ALL_STYLES": "جميع الأنماط",
  "LIVE_DEV_HB_PARAGRAPH": "فقرة",
  "LIVE_DEV_HB_HEADING_1": "عنوان 1",
  "LIVE_DEV_HB_HEADING_2": "عنوان 2",
  "LIVE_DEV_HB_HEADING_3": "عنوان 3",
  "LIVE_DEV_HB_HEADING_4": "عنوان 4",
  "LIVE_DEV_HB_HEADING_5": "عنوان 5",
  "LIVE_DEV_HB_HEADING_6": "عنوان 6",
  "LIVE_DEV_HB_SPAN": "امتداد",
  "LIVE_DEV_HB_BLOCKQUOTE": "اقتباس",
  "LIVE_DEV_HB_PREFORMATTED": "منسق مسبقًا",
  "LIVE_DEV_HB_CODE": "كود",
  "LIVE_DEV_HB_EMPHASIS": "توكيد",
  "LIVE_DEV_HB_STRONG": "بارز",
  "LIVE_DEV_HB_BOLD": "غامق",
  "LIVE_DEV_HB_ITALIC": "مائل",
  "LIVE_DEV_HB_UNDERLINE": "تسطير",
  "LIVE_DEV_HB_STRIKETHROUGH": "يتوسطه خط",
  "LIVE_DEV_HB_SMALL": "صغير",
  "LIVE_DEV_HB_SUBSCRIPT": "منخفض",
  "LIVE_DEV_HB_SUPERSCRIPT": "مرتفع",
  "LIVE_DEV_HB_MARK": "تمييز",
  "LIVE_DEV_HB_ABBREVIATION": "اختصار",
  "LIVE_DEV_HB_CITATION": "اقتباس",
  "LIVE_DEV_HB_INLINE_QUOTE": "اقتباس مضمّن",
  "LIVE_DEV_HB_TIME": "وقت",
  "LIVE_DEV_HB_KEYBOARD": "لوحة المفاتيح",
  "LIVE_DEV_HB_SAMPLE_OUTPUT": "نموذج مخرجات",
  "LIVE_DEV_HB_VARIABLE": "متغير",
  "LIVE_DEV_HB_CONTAINER": "حاوية",
  "LIVE_DEV_HB_SECTION": "قسم",
  "LIVE_DEV_HB_ARTICLE": "مقالة",
  "LIVE_DEV_HB_HEADER": "ترويسة",
  "LIVE_DEV_HB_FOOTER": "تذييل",
  "LIVE_DEV_HB_NAVIGATION": "التنقل",
  "LIVE_DEV_HB_SIDEBAR": "جانبي",
  "LIVE_DEV_HB_MAIN": "رئيسي",
  "LIVE_DEV_HB_ADDRESS": "عنوان",
  "LIVE_DEV_HB_IMAGE": "صورة",
  "LIVE_DEV_HB_VIDEO": "فيديو",
  "LIVE_DEV_HB_AUDIO": "صوتي",
  "LIVE_DEV_HB_PICTURE": "صورة",
  "LIVE_DEV_HB_CANVAS": "لوحة",
  "LIVE_DEV_HB_SVG": "SVG",
  "LIVE_DEV_HB_FIGURE": "شكل",
  "LIVE_DEV_HB_FIGCAPTION": "تسمية توضيحية",
  "LIVE_DEV_HB_LINK": "رابط",
  "LIVE_DEV_HB_BUTTON": "زر",
  "LIVE_DEV_HB_DETAILS": "تفاصيل",
  "LIVE_DEV_HB_SUMMARY": "ملخص",
  "LIVE_DEV_HB_DIALOG": "حوار",
  "LIVE_DEV_HB_UNORDERED_LIST": "قائمة غير مرتبة",
  "LIVE_DEV_HB_ORDERED_LIST": "قائمة مرتبة",
  "LIVE_DEV_HB_LIST_ITEM": "عنصر قائمة",
  "LIVE_DEV_HB_DEF_LIST": "قائمة تعريفات",
  "LIVE_DEV_HB_DEF_TERM": "مصطلح التعريف",
  "LIVE_DEV_HB_DEF_DESC": "تعريف",
  "LIVE_DEV_HB_FORM": "نموذج",
  "LIVE_DEV_HB_TEXT_INPUT": "إدخال نص",
  "LIVE_DEV_HB_TEXT_AREA": "منطقة نص",
  "LIVE_DEV_HB_DROPDOWN": "قائمة منسدلة",
  "LIVE_DEV_HB_OPTION": "خيار",
  "LIVE_DEV_HB_OPTION_GROUP": "مجموعة خيارات",
  "LIVE_DEV_HB_FIELDSET": "مجموعة حقول",
  "LIVE_DEV_HB_LEGEND": "تسمية توضيحية",
  "LIVE_DEV_HB_LABEL": "تسمية",
  "LIVE_DEV_HB_OUTPUT": "مُخرجات",
  "LIVE_DEV_HB_METER": "مقياس",
  "LIVE_DEV_HB_PROGRESS": "تقدم",
  "LIVE_DEV_HB_EMAIL_INPUT": "إدخال البريد الإلكتروني",
  "LIVE_DEV_HB_PASSWORD_INPUT": "إدخال كلمة المرور",
  "LIVE_DEV_HB_FILE_INPUT": "إدخال ملف",
  "LIVE_DEV_HB_CHECKBOX": "مربع اختيار",
  "LIVE_DEV_HB_RADIO": "زر اختيار",
  "LIVE_DEV_HB_NUMBER_INPUT": "إدخال رقم",
  "LIVE_DEV_HB_RANGE_INPUT": "منزلقة النطاق",
  "LIVE_DEV_HB_DATE_INPUT": "إدخال التاريخ",
  "LIVE_DEV_HB_COLOR_INPUT": "منتقي الألوان",
  "LIVE_DEV_HB_SEARCH_INPUT": "إدخال البحث",
  "LIVE_DEV_HB_URL_INPUT": "إدخال عنوان URL",
  "LIVE_DEV_HB_TEL_INPUT": "إدخال رقم الهاتف",
  "LIVE_DEV_HB_SUBMIT_BUTTON": "زر الإرسال",
  "LIVE_DEV_HB_RESET_BUTTON": "زر إعادة التعيين",
  "LIVE_DEV_HB_HIDDEN_INPUT": "إدخال مخفي",
  "LIVE_DEV_HB_TABLE": "جدول",
  "LIVE_DEV_HB_TABLE_HEAD": "رأس الجدول",
  "LIVE_DEV_HB_TABLE_BODY": "جسم الجدول",
  "LIVE_DEV_HB_TABLE_FOOT": "تذييل الجدول",
  "LIVE_DEV_HB_TABLE_ROW": "صف جدول",
  "LIVE_DEV_HB_TABLE_HEADER": "ترويسة جدول",
  "LIVE_DEV_HB_TABLE_CELL": "خلية جدول",
  "LIVE_DEV_HB_TABLE_CAPTION": "تسمية توضيحية للجدول",
  "LIVE_DEV_HB_COL_GROUP": "مجموعة أعمدة",
  "LIVE_DEV_HB_COLUMN": "عمود",
  "LIVE_DEV_HB_IFRAME": "إطار مضمن",
  "LIVE_DEV_HB_EMBED": "تضمين",
  "LIVE_DEV_HB_OBJECT": "كائن",
  "LIVE_DEV_HB_DIVIDER": "فاصل",
  "LIVE_DEV_HB_LINE_BREAK": "فاصل أسطر",
  "LIVE_DEV_HB_SOURCE": "مصدر",
  "LIVE_DEV_HB_TEMPLATE": "قالب",
  "LIVE_DEV_HB_SLOT": "موضع",
  "LIVE_DEV_HB_NOSCRIPT": "بدون برمجة نصية",
  "LIVE_DEV_HB_SCRIPT": "برمجة نصية",
  "LIVE_DEV_HB_STYLE": "نمط",
  ...
  "LIVE_DEV_TOAST_HIDDEN_BY_STYLE": "العنصر مخفي - لديه {0}",
  "LIVE_DEV_TOAST_HIDDEN_BY_PARENT_STYLE": "العنصر مخفي - {0} لديه {1}",
  "LIVE_DEV_TOAST_HIDDEN_IN_CLOSED": "العنصر مخفي - {0} مغلق",
  "LIVE_DEV_TOAST_HIDDEN_NO_SIZE": "العنصر غير مرئي - ليس له حجم",
  "LIVE_DEV_TOAST_HIDDEN_CUT_OFF": "العنصر غير مرئي - تم قصه بواسطة {0}",
  "LIVE_DEV_TOAST_HIDDEN_OUTSIDE": "العنصر غير مرئي - إنه خارج المنطقة المرئية",
  "LIVE_DEV_TOAST_HIDDEN": "العنصر غير مرئي على الصفحة",
  ...
  "AVAILABLE_IN_PRO_TITLE": "متوفر في Phoenix Pro",
  "DEVICE_SIZE_LIMIT_MESSAGE": "للتبديل بين عروض الهاتف والجهاز اللوحي وسطح المكتب، قم بالترقية إلى Phoenix Pro.",
  "LAYERS_PANEL_LIMIT_MESSAGE": "لرؤية بنية صفحتك وتحديد أو تحرير أي عنصر فيها، قم بالترقية إلى Phoenix Pro.",
  "DEVICE_SIZE_NOT_ENOUGH_SPACE": "هذه الشاشة لا تتسع في حجم النافذة الحالي — حاول توسيع النافذة",
  "DEVICE_SIZE_CYCLE_NO_FIT": "الشاشة صغيرة جدًا للتبديل إلى حجم جهاز آخر — قم بزيادة حجم النافذة",
  "DEVICE_SIZE_CYCLE_TOOLTIP": "التبديل بين الجوال والجهاز اللوحي وسطح المكتب",
  "DEVICE_SIZE_DROPDOWN_TOOLTIP": "كل أحجام الأجهزة",
  "DEVICE_SIZE_FIT_TO_SCREEN": "ملاءمة للشاشة",
  "MD_EDIT_UPSELL_MESSAGE": "اكتب بلغة ماركداون كمستند. يتولى {APP_NAME} التنسيق لتبقى مركزًا على الكتابة.",
  "IMAGE_UPLOADING": "جاري الرفع",
  "IMAGE_UPLOAD_FAILED": "فشل رفع الصورة",
  "IMAGE_UPLOAD_LOGIN_REQUIRED_TITLE": "سجل الدخول لتضمين الصورة",
  "IMAGE_UPLOAD_LOGIN_REQUIRED_MSG": "سجل الدخول لرفع وتضمين الصور في مستندك.",
  "IMAGE_UPLOAD_LOGIN_BTN": "تسجيل الدخول",
  "IMAGE_UPLOAD_CONFIRM_TITLE": "تضمين الصورة",
  "IMAGE_UPLOAD_CONFIRM_MSG": "ارفع هذه الصورة ليتم تضمينها مباشرة في ملفك. ستعمل على أي جهاز كمبيوتر — لن تظهر صور معطوبة عند مشاركة ملفات markdown أو نقلها.",
  "IMAGE_UPLOAD_HOSTED_ON": "تتم استضافة الصور على user-cdn.phcode.site",
  "IMAGE_UPLOAD_BTN": "تحميل وتضمين",
  "IMAGE_UPLOAD_DONT_SHOW_AGAIN": "التضمين دائمًا دون سؤال",
  "IMAGE_UPLOAD_UNSUPPORTED_TYPE": "نوع الصورة غير مدعوم: {0}",
  "IMAGE_UPLOAD_LIMIT_TITLE": "حمّل المزيد من الصور مع Phoenix Pro",
  ...
  "LIVE_PREVIEW_SHOW_STYLES_BAR": "إظهار شريط الأنماط",
  ...
  "LIVE_PREVIEW_LAYERS_TAB": "طبقات",
  "LIVE_PREVIEW_LAYERS_NEEDS_PREVIEW": "تتطلب لوحة الطبقات معاينة حية.",
  "LIVE_PREVIEW_LAYERS_OPEN_PREVIEW": "فتح المعاينة الحية",
  "LIVE_PREVIEW_LAYERS_OPEN_IN_BROWSER": "فتح في المتصفح",
  "LIVE_PREVIEW_LAYERS_NEEDS_HTML": "افتح ملف HTML لرؤية طبقاته.",
  "LIVE_PREVIEW_LAYERS_CHOOSE_PAGE": "اختر صفحة",
  "LIVE_PREVIEW_LAYERS_PICK_HTML": "اختر ملف HTML لرؤية طبقاته.",
  "LIVE_PREVIEW_LAYERS_SEARCH_FILES": "بحث في {0} ملفات",
  "LIVE_PREVIEW_LAYERS_NO_FILE_MATCHES": "لا توجد ملفات مطابقة",
  "LIVE_PREVIEW_LAYERS_FILES_TRUNCATED": "عرض أول {0} ملف",
  "LIVE_PREVIEW_LAYERS_NEEDS_EDIT_MODE": "تتطلب لوحة الطبقات وضع التحرير.",
  "LIVE_PREVIEW_LAYERS_ENABLE_EDIT_MODE": "تشغيل وضع التحرير",
  "LIVE_PREVIEW_LAYERS_LOAD_FAILED": "تعذر تحميل لوحة الطبقات. أعد تشغيل {APP_NAME} للمحاولة مرة أخرى.",
  "LIVE_PREVIEW_LAYERS_ELEMENTS": "عناصر",
  "LIVE_PREVIEW_LAYERS_SEARCH": "بحث عن عناصر",
  "LIVE_PREVIEW_LAYERS_NO_MATCHES": "لا توجد عناصر متطابقة",
  "LIVE_PREVIEW_LAYERS_TRUNCATED": "عرض أول {0} عناصر",
  "LIVE_PREVIEW_LAYERS_COLLAPSE_ALL": "طي الكل",
  "LIVE_PREVIEW_LAYERS_EXPAND_LEVEL": "توسيع إلى المستوى",
  "LIVE_PREVIEW_LAYERS_LEVEL": "المستوى {0}",
  "LIVE_PREVIEW_LAYERS_LEVEL_ALL": "كل المستويات",
  "LIVE_PREVIEW_LAYERS_SETTINGS": "إعدادات",
  "LIVE_PREVIEW_LAYERS_SHOW_TEXT_NODES": "إظهار العُقد النصية",
  "LIVE_PREVIEW_LAYERS_SCROLL_ON_HOVER": "تمرير المعاينة عند التحويم",
  "LIVE_PREVIEW_LAYERS_AUTO_COLLAPSE": "طي العناصر تلقائيًا",
  "LIVE_PREVIEW_LAYERS_MOVE_UP": "نقل لأعلى",
  "LIVE_PREVIEW_LAYERS_MOVE_DOWN": "نقل لأسفل",
  "LIVE_PREVIEW_LAYERS_CUT_DONE": "قص",
  "LIVE_PREVIEW_LAYERS_ADD_ATTRIBUTE": "إضافة سمة",
  "LIVE_PREVIEW_LAYERS_REMOVE_ATTRIBUTE": "إزالة سمة",
  "LIVE_PREVIEW_LAYERS_PROPERTIES": "خصائص",
  "LIVE_PREVIEW_LAYERS_STYLES": "أنماط",
  "LIVE_PREVIEW_LAYERS_MAXIMIZE_SECTION": "توسيع القسم",
  "LIVE_PREVIEW_LAYERS_RESTORE_SECTIONS": "استعادة الأقسام",
  "LIVE_PREVIEW_LAYERS_NO_SELECTION_PROPERTIES": "حدد عنصرًا لرؤية خصائصه",
  "LIVE_PREVIEW_LAYERS_NO_SELECTION_STYLES": "حدد عنصرًا لرؤية أنماطه",
  ...
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_IMPORTANT": "تم تجاوزها بواسطة {0} في {1} ({2})",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_IN_RULE": "تم تجاوزها بواسطة تعريف {0} اللاحق في هذه القاعدة",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_INLINE": "تم تجاوزها بواسطة النمط المضمن للعنصر ({0})",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_SPECIFIC": "تم تجاوزها بواسطة القاعدة الأكثر تحديدًا {0} ({1})",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_LATER": "تم تجاوزه بواسطة {0} ({1})، الذي له نفس التحديد ولكنه يأتي لاحقًا",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_JUMP": "انقر للانتقال إلى الإعلان الفائز",
  "LIVE_PREVIEW_LAYERS_EDIT_STYLE": "تحرير في شريط الأنماط",
  "LIVE_PREVIEW_LAYERS_STYLES_BAR_POPPED_OUT": "تم فتح شريط الأنماط في معاينة المتصفح",
  "LIVE_PREVIEW_LAYERS_ADD_DECLARATION": "إضافة تصريح",
  "LIVE_PREVIEW_LAYERS_REMOVE_DECLARATION": "إزالة تصريح",
  "LIVE_PREVIEW_LAYERS_EDIT_DECLARATION": "تعديل تصريح",
  "LIVE_PREVIEW_LAYERS_SHOW_SCRIPT_NODES": "إظهار العناصر المنشأة بواسطة سكربت",
  "LIVE_PREVIEW_LAYERS_SCRIPT_GENERATED": "مُنشأ بواسطة سكربت، غير موجود في الملف المصدري",
  "LIVE_PREVIEW_LAYERS_HOVER_HIDDEN": "{0} (مخفي)",
  "LIVE_PREVIEW_LAYERS_INSERT_ELEMENT": "إدراج عنصر",
  "LIVE_PREVIEW_LAYERS_CHANGE_COLOR": "تغيير اللون: {0}",
  ...
  "LIVE_PREVIEW_LAYERS_INSERT_POSITION": "الموضع",
  "LIVE_PREVIEW_LAYERS_INSERT_INTO_PAGE": "إضافة إلى الصفحة",
  "LIVE_PREVIEW_LAYERS_INSERT_LOADING": "جارٍ تحميل العناصر...",
  "LIVE_PREVIEW_LAYERS_INSERT_UNAVAILABLE": "لم تستجب المعاينة المباشرة. حاول مرة أخرى بعد لحظة.",
  "LIVE_PREVIEW_LAYERS_LOADING": "جارٍ تحميل العناصر...",
  "LIVE_PREVIEW_LAYERS_UNAVAILABLE": "لم تستجب المعاينة المباشرة.",
  "LIVE_PREVIEW_LAYERS_RETRY": "إعادة المحاولة",
  "LIVE_PREVIEW_LAYERS_NOT_RESPONDING": "المعاينة المباشرة لا تستجيب.",
  "LIVE_PREVIEW_LAYERS_RELOAD_PREVIEW": "إعادة تحميل المعاينة",
  "LIVE_PREVIEW_LAYERS_EMPTY_PAGE": "لا توجد عناصر في هذه الصفحة بعد.",
  "LIVE_PREVIEW_LAYERS_ADD_ELEMENT": "إضافة عنصر",
  ...
  "LIVE_PREVIEW_LAYERS_SCRUB_HINT": "اسحب للتعديل. مرّر أو استخدم مفاتيح الأسهم أثناء التحرير. Shift: خطوات أكبر، Alt: خطوات أصغر",
  ...
  "ERRORS_PANEL_TITLE_INFO_SUFFIX": "{0} ({1} معلومة)",
  ...
  "DOC_COMMENT_ADD_JSDOC": "إضافة تعليق JSDoc",
  "DOC_COMMENT_ADD_PHPDOC": "إضافة تعليق PHPDoc",
  "DOC_COMMENT_ADD_JAVADOC": "إضافة تعليق Javadoc",
  "DOC_COMMENT_ADD_DOXYGEN": "إضافة تعليق Doxygen",
  "DOC_COMMENT_ADD_DOCSTRING": "إضافة docstring",
  "DOC_COMMENT_SUMMARY": "الوصف",
  "DOC_COMMENT_DESC": "وصف",
  ...
  "CMD_VIEW_TERMINAL": "طرفية",
  "CMD_VIEW_ENABLE_AI": "تمكين الذكاء الاصطناعي",
  ...
  "CMD_OPEN_IN_INTEGRATED_TERMINAL": "طرفية متكاملة",
  ...
  "DESCRIPTION_SHOW_CODE_HINT_DOCS": "`false` لإخفاء النافذة المنبثقة للتوثيق التي تظهر بجانب تلميحات الكود",
  "DESCRIPTION_SHOW_PARAMETER_HINTS": "`false` لتعطيل النافذة المنبثقة لتلميحات المعلمات التي تظهر عند الكتابة داخل استدعاء دالة",
  ...
  "DESCRIPTION_LIVEDEV_MAIN_HEADING": "عفوًا!",
  "DESCRIPTION_LIVEDEV_MAIN_SPAN": "احصل على أفضل تجربة للمعاينة المباشرة عبر تنزيل تطبيقاتنا الأصلية لأنظمة التشغيل Windows و Mac و Linux من {0}.",
  ...
  "FIND_ALL_REFERENCES": "إيجاد الاستخدامات",
  "CODE_INTEL_JS": "جافا سكريبت",
  "CODE_INTEL_TS": "تايب سكريبت",
  "CODE_INTEL_ENABLED_TITLE": "تم تفعيل ذكاء الكود لـ {0}",
  "CODE_INTEL_ENABLED_MESSAGE": "أصبحت ميزات «العثور على الاستخدامات» و«إعادة التسمية» و«الانتقال إلى التعريف» تعمل الآن عبر جميع ملفات المشروع.",
  "CODE_INTEL_SEE_CONFIG": "عرض التكوين",
  "CODE_INTEL_ENABLE_TS": "تفعيل تايب سكريبت",
  "CODE_INTEL_LEARN_MORE": "لمعرفة المزيد",
  "CODE_INTEL_PANEL_TEXT": "ذكاء الكود على مستوى المشروع مُعطَّل. قم بتفعيله لتشغيل ميزات «العثور على الاستخدامات» و«إعادة التسمية» و«الانتقال إلى التعريف» عبر جميع الملفات — سيؤدي هذا إلى إضافة ملف jsconfig.json إلى المجلد الجذر للمشروع.",
  "CODE_INTEL_PANEL_ENABLE": "تفعيل",
  "CODE_INTEL_PANEL_DISMISS": "تجاهل",
  "PHP_INSTALL_TITLE": "ذكاء شيفرة PHP",
  "PHP_INSTALLING": "جاري إعداد دعم PHP — تنزيل خادم اللغة (9 ميجابايت)…",
  "PHP_INSTALL_DONE": "ميزة التحليل الذكي لشيفرة PHP جاهزة.",
  "PHP_INSTALL_FAILED": "تعذر إعداد دعم PHP: {0}. سيحاول {APP_NAME} مرة أخرى عند فتح ملف PHP مجددًا.",
  "PHP_INSTALL_STOP": "إيقاف إعداد دعم PHP (سيحاول {APP_NAME} مرة أخرى عند التشغيل التالي)",
  "PHP_INSTALL_WAITING_NETWORK": "في انتظار الاتصال بالإنترنت لإعداد دعم PHP…",
  "DESCRIPTION_PHP_CODE_INTELLIGENCE": "`false` لتعطيل الذكاء البرمجي للغة PHP (Intelephense). إعادة تعيينها إلى `true` يؤدي إلى تنزيل خادم اللغة مرة أخرى تلقائيًا.",
  "DESCRIPTION_PHP_LICENSE_KEY": "مفتاح ترخيص Intelephense premium (أو مسار مطلق لملف المفتاح) لتفعيل الميزات المتميزة مثل إعادة التسمية وإجراءات الشيفرة. لا حاجة له إذا كان ترخيصك موجودًا بالفعل في ملف ترخيص intelephense العام القياسي.",
  "PYTHON_INSTALL_TITLE": "ذكاء الشيفرة لـ Python",
  "PYTHON_INSTALLING": "جاري إعداد دعم Python — تنزيل أدوات اللغة (25 ميجابايت)…",
  "PYTHON_INSTALL_DONE": "ميزات الذكاء الاصطناعي لكود Python جاهزة.",
  "PYTHON_INSTALL_FAILED": "تعذر إعداد دعم Python: {0}. سيحاول {APP_NAME} مرة أخرى عند فتح ملف Python مجددًا.",
  "PYTHON_INSTALL_STOP": "إيقاف إعداد دعم Python (سيحاول {APP_NAME} مرة أخرى عند التشغيل التالي)",
  "PYTHON_INSTALL_WAITING_NETWORK": "في انتظار الاتصال بالإنترنت لإعداد دعم Python…",
  "DESCRIPTION_PYTHON_CODE_INTELLIGENCE": "`false` لتعطيل الذكاء البرمجي للغة Python (Pyrefly). إعادة تعيينها إلى `true` يؤدي إلى تنزيل خادم اللغة مرة أخرى تلقائيًا.",
  "DESCRIPTION_TYPESCRIPT_CODE_INTELLIGENCE": "`false` لتعطيل ذكاء الكود لـ JavaScript/TypeScript (الإكمال، ومستندات التمرير، والانتقال إلى التعريف، والتشخيصات)",
  "DESCRIPTION_JSON_CODE_INTELLIGENCE": "`false` لتعطيل ذكاء الكود لـ JSON (الإكمال المستند إلى المخطط، ومستندات التمرير، والتحقق من الصحة)",
  "DESCRIPTION_LSP_CODE_INTELLIGENCE": "`false` لتعطيل خادم اللغة {0}",
  "NPM_VULN_PROVIDER_NAME": "إرشادات npm الأمنية",
  "NPM_VULN_MESSAGE": "الحزمة {0}@{1} بها ثغرة أمنية: {2} (خطورة {3})",
  "NPM_SEVERITY_CRITICAL": "حرجة",
  "NPM_SEVERITY_HIGH": "عالية",
  "NPM_SEVERITY_MODERATE": "متوسطة",
  "NPM_SEVERITY_LOW": "منخفضة",
  "NPM_HINT_LATEST_MINOR": "الأحدث، التحديثات الثانوية مسموحة",
  "NPM_HINT_LATEST_PATCH": "الأحدث، تحديثات التصحيح فقط",
  "NPM_HOVER_HOMEPAGE": "فتح الصفحة الرئيسية",
  "NPM_HOVER_VIEW_DOCS": "عرض المستندات",
  "CODE_INTEL_CFG_TITLE": "ذكاء الكود",
  "CODE_INTEL_CFG_ALL_OPTIONS": "جميع الخيارات…",
  "CODE_INTEL_CFG_CHECK_JS": "فحص أنواع JavaScript",
  "CODE_INTEL_CFG_CHECK_JS_SUB": "يكتشف أخطاء الأنواع في ملفات JS",
  "CODE_INTEL_CFG_CHECK_JS_INFO": "يكتشف الأخطاء الإملائية وأخطاء الأنواع في شيفرة JavaScript الخاصة بك ويعرضها في لوحة المشاكل. تحذيرات فقط — تعمل شيفرتك دون تغيير.",
  "CODE_INTEL_CFG_CHECK_JS_EG_CODE": "console.lgo(\"hi\")",
  "CODE_INTEL_CFG_CHECK_JS_EG_TEXT": "يتم الإبلاغ عنه: هل تقصد 'log'؟",
  "CODE_INTEL_CFG_AUTO_TYPES": "تنزيل الأنواع تلقائيًا",
  "CODE_INTEL_CFG_AUTO_TYPES_SUB": "يجلب تعريفات الأنواع عبر npm",
  "CODE_INTEL_CFG_AUTO_TYPES_INFO": "تبدأ تلميحات الأكواد لحزم npm في العمل حتى قبل تشغيل `npm install`. يتطلب npm والاتصال بالإنترنت؛ يتم تخزين التنزيلات مؤقتًا خارج مشروعك.",
  "CODE_INTEL_CFG_AUTO_MANAGE": "تتم إدارته بواسطة {APP_NAME}",
  "CODE_INTEL_CFG_AUTO_MANAGE_SUB": "يحافظ على تحديث هذا الملف تلقائيًا",
  "CODE_INTEL_CFG_AUTO_MANAGE_INFO": "يقوم {APP_NAME} بضبط هذا الملف حتى تعمل ميزات ذكاء الأكواد بشكل صحيح. قم بإيقاف تشغيله لتخصيص الملف بنفسك — وعندها لن يقوم {APP_NAME} بتعديله أبدًا.",
  "CODE_INTEL_CFG_TARGET": "الهدف",
  "CODE_INTEL_CFG_TARGET_SUB": "إصدار JS الذي يستخدمه الكود الخاص بك",
  "CODE_INTEL_CFG_TARGET_ES5": "المتصفحات القديمة (حقبة IE11)",
  "CODE_INTEL_CFG_TARGET_ES2015": "الفئات، الدوال السهمية، let/const",
  "CODE_INTEL_CFG_TARGET_ES2017": "async/await",
  "CODE_INTEL_CFG_TARGET_ES2020": "التسلسل الاختياري a?.b، الدمج الفارغ ??",
  "CODE_INTEL_CFG_TARGET_ES2022": "حقول الفئة، await على المستوى الأعلى",
  "CODE_INTEL_CFG_TARGET_ESNEXT": "كل شيء حالي",
  "CODE_INTEL_CFG_TARGET_FOOT": "الأهداف الأقدم تعتبر الصيغ الأحدث أخطاءً — اختر الأحدث ما لم يكن يجب تشغيل الكود الخاص بك على محركات قديمة.",
  "CODE_INTEL_CFG_MODULE": "الوحدة",
  "CODE_INTEL_CFG_MODULE_SUB": "كيفية تحليل import و require()",
  "CODE_INTEL_CFG_MODULE_PRESERVE": "يفهم كلاً من import و require()، لا توجد قواعد لامتدادات الملفات — الأفضل للتحرير",
  "CODE_INTEL_CFG_MODULE_ESNEXT": "دلالات import/export الحديثة",
  "CODE_INTEL_CFG_MODULE_NODENEXT": "قواعد ESM الصارمة الخاصة بـ Node — امتدادات ملفات إلزامية، يحترم خاصية \"type\" في package.json",
  "CODE_INTEL_CFG_MODULE_COMMONJS": "مشاريع require()/module.exports الكلاسيكية",
  "CODE_INTEL_CFG_JSX": "JSX",
  "CODE_INTEL_CFG_JSX_SUB": "كيفية التعامل مع JSX في ملفات .jsx و .tsx",
  "CODE_INTEL_CFG_JSX_REACT_JSX": "وقت تشغيل حديث (+React 17) — لا حاجة لاستيراد React",
  "CODE_INTEL_CFG_JSX_REACT": "يُصرّف إلى React.createElement — يتطلب استيراد React",
  "CODE_INTEL_CFG_JSX_PRESERVE": "يترك JSX دون تغيير لأداة أخرى، مثل أداة التجميع (bundler)",
  "CODE_INTEL_CFG_JSX_OFF_INFO": "لا توجد معالجة لـ JSX",
  "CODE_INTEL_CFG_JSX_OFF": "إيقاف",
  "CODE_INTEL_CFG_CURRENT_VALUE": "(الحالي: {0})",
  "CODE_INTEL_CFG_ORIGIN_NOTE": "أنشأ {APP_NAME} هذا الملف لتفعيل ذكاء الشيفرة على مستوى المشروع. حذفه يعطل هذه الميزة — يمكنك إعادة تفعيلها في أي وقت من {0}.",
  "CODE_INTEL_CFG_PROBLEMS_PANEL": "لوحة المشاكل",
  "CODE_INTEL_CFG_AUTO_CREATE": "إنشاء ملف إعدادات تلقائيًا في المشاريع الجديدة",
  "CODE_INTEL_CFG_READ_ONLY": "يحتوي هذا الملف على تنسيق مخصص أو تعليقات — قم بتحرير ملف JSON مباشرةً.",
  "REFERENCES_IN_FILES": "مراجع",
  "REFERENCE_IN_FILES": "مرجع",
  "REFERENCES_NO_RESULTS": "لا توجد مراجع متاحة لموقع المؤشر الحالي",
  "REFERENCES_PANEL_TITLE": "المراجع",
  "SEARCH_RESULTS_PANEL_TITLE": "نتائج البحث",
  "BOTTOM_PANEL_MINIMIZE": "تصغير اللوحة",
  "BOTTOM_PANEL_SHOW": "إظهار اللوحة السفلية",
  "BOTTOM_PANEL_HIDE_TOGGLE": "إخفاء اللوحة السفلية",
  "BOTTOM_PANEL_DEFAULT_TITLE": "أدوات",
  "BOTTOM_PANEL_DEFAULT_HEADING": "أدوات",
  "BOTTOM_PANEL_MAXIMIZE": "تكبير اللوحة",
  "BOTTOM_PANEL_RESTORE": "استعادة حجم اللوحة",
  ...
  "PHOENIX_TOUR_DESIGN_MODE": "انقر هنا للدخول إلى وضع التصميم. انتقل إلى وضع ملء الشاشة وعدّل صفحتك بصريًا.",
  "PHOENIX_TOUR_AI_PANEL": "صمّم التخطيطات، وأصلح الأخطاء البرمجية، وابنِ بشكل أسرع باستخدام الذكاء الاصطناعي. انقر هنا لفتح لوحة الذكاء الاصطناعي.",
  "PHOENIX_TOUR_NEW_PROJECT": "افتح أو أنشئ مشروعًا جديدًا من هنا.",
  "PHOENIX_TOUR_EDIT_MODE": "يتيح لك وضع التحرير تعديل صفحتك مباشرة في المعاينة المباشرة — انقر على العناصر لفحصها وتحريرها في مكانها.",
  "PHOENIX_TOUR_STEP_OF": "{0} من {1}",
  "PHOENIX_TOUR_NEXT_BTN": "التالي",
  "PHOENIX_TOUR_DISMISS_BTN": "تجاهل",
  ...
  "DESCRIPTION_ENABLE_AI": "'true' لتمكين ميزات الذكاء الاصطناعي، 'false' لتعطيل الذكاء الاصطناعي بالكامل.",
  ...
  "TERMINAL_CLOSE_SINGLE_MSG": "يوجد عملية نشطة في هذه الطرفية. سيؤدي إغلاقها إلى إيقاف العملية.<br>هل تريد المتابعة؟",
  "TERMINAL_CLOSE_SINGLE_BTN": "إغلاق الطرفية",
  "TERMINAL_CLOSE_ALL_TITLE": "إغلاق كل الطرفيات؟",
  "TERMINAL_CLOSE_ALL_MSG": "سيتم إغلاق جميع الطرفيات.<br>لا توجد عمليات نشطة قيد التشغيل.<br><br>متابعة؟",
  "TERMINAL_CLOSE_ALL_BTN": "إغلاق الكل",
  "TERMINAL_CLOSE_ALL_MSG_PROCESS_ONE": "سيتم إغلاق جميع الطرفيات.<br>سيتم إيقاف عملية نشطة واحدة.<br><br>متابعة؟",
  "TERMINAL_CLOSE_ALL_MSG_PROCESS_MANY": "سيتم إغلاق جميع الوحدات الطرفية.<br>سيتم إيقاف {0} من العمليات النشطة.<br><br>هل تريد المتابعة؟",
  ...
  "PROMO_CARD_4_MESSAGE": "حرّر الجداول والصور والتنسيقات بشكل مرئي — طريقة أسهل للعمل مع الماركداون.",
  "PROMO_CARD_5": "نسّق صفحتك بصريًا",
  "PROMO_CARD_5_MESSAGE": "غيّر الخطوط والألوان والحدود والتباعد والتخطيط مباشرةً في المعاينة المباشرة، ويتم تحديث CSS الخاص بك في الوقت الفعلي.",
  ...
  "OFF_HOURS_ENDING_TITLE": "{0} سينتهي قريبًا",
  "OFF_HOURS_ENDING_MSG": "جلستك المجانية لـ {0} ستنتهي قريبًا. <a href=\"{1}\">احصل على {2}</a> للاحتفاظ بميزات Pro طوال اليوم.",
  "OFF_HOURS_ENDED_TITLE": "{0} قد انتهى",
  "OFF_HOURS_ENDED_MSG": "لقد انتهت جلستك المجانية لـ {0}. <a href=\"{1}\">احصل على {2}</a> لإبقاء ميزات Pro مفعلة.",
  "OFF_HOURS_LOGIN_TITLE": "{0} مجاني الآن",
  "OFF_HOURS_LOGIN_MSG": "{0}: {1} مجاني كل يوم خلال {2}. سجل الدخول لاستخدامه.",
  "OFF_HOURS_LOGIN_BTN": "تسجيل الدخول",
  "OFF_HOURS_DONT_SHOW_AGAIN": "لا تظهر هذا مرة أخرى",
  "OFF_HOURS_NAV_TOOLTIP": "{0} — Phoenix Pro مجاني لك خلال أوقاتك الشخصية ({1})",
  "OFF_HOURS_TIME_LEFT_HOURS": "{0} س متبقية",
  "OFF_HOURS_TIME_LEFT_MINUTES": "{0} د متبقية",
  "OFF_HOURS_DURATION_HOURS": "{0} س",
  "OFF_HOURS_DURATION_MINUTES": "{0} د",
  "OFF_HOURS_POPUP_ACTIVE": "{0}: متبقٍ {1}",
  "OFF_HOURS_POPUP_LOGIN_ACTIVE": "سجّل الدخول للحصول على {0}: متبقٍ {1}",
  "OFF_HOURS_POPUP_UPCOMING": "{0} يبدأ خلال {1}",
  "OFF_HOURS_EXPLAIN_TITLE": "ما هو {0}؟",
  "OFF_HOURS_EXPLAIN_MSG": "{0} متاح للجميع مجانًا خلال الأوقات الشخصية خارج العمل — <b>{1}</b>، بتوقيتك المحلي. ما عليك سوى استخدام المحرر خلال هذه الساعات، ولا يلزم الاشتراك.",
  "OFF_HOURS_EXPLAIN_ACTIVE": "إنه مجاني الآن — تبقى {0}!",
  "OFF_HOURS_EXPLAIN_LOGIN_ACTIVE": "إنه مجاني الآن — تبقى {0}. سجّل الدخول لاستخدامه!",
  "OFF_HOURS_EXPLAIN_UPCOMING": "تبدأ جلستك المجانية التالية خلال {0}.",
  "OFF_HOURS_WAIT_BTN": "سأنتظر",
  "OFF_HOURS_KEEP_CODING_BTN": "متابعة البرمجة",
  "MANAGE_LICENSE_DIALOG_TITLE": "إدارة التراخيص",
  "LICENSE_ACCOUNT_HEADING": "ترخيص الحساب",
  "LICENSE_DEVICE_HEADING": "ترخيص الجهاز",
  "LICENSE_SIGN_IN": "تسجيل الدخول",
  "LICENSE_PLAN_UNKNOWN": "غير معروف",
  "LICENSE_GET_PRO": "الحصول على Phoenix Pro",
  "LICENSE_MANAGE_ACCOUNT": "إدارة الحساب",
  "LICENSE_KEY": "مفتاح الترخيص",
  "LICENSE_KEY_PROMPT": "هل لديك مفتاح ترخيص للجهاز؟",
  "LICENSE_KEY_PLACEHOLDER": "أدخل مفتاح ترخيصك…",
  "LICENSE_KEY_ACTIVATE": "تفعيل",
  ...
  "LICENSE_REACTIVATE": "إعادة تفعيل الترخيص",
  "LICENSE_DEACTIVATE": "إلغاء التفعيل",
  "LICENSE_DEACTIVATING": "جارٍ إلغاء التفعيل...",
  "LICENSE_DEACTIVATE_SUCCESS": "تم إلغاء تفعيل الترخيص على هذا الجهاز. يرجى إعادة تشغيل {APP_NAME} لتطبيق التغييرات.",
  "LICENSE_DEACTIVATE_FAIL": "فشل إلغاء تفعيل الترخيص على هذا الجهاز",
  "LICENSE_NOT_ACTIVATED_HERE": "هذا الترخيص غير مُفعّل على هذا الجهاز — لن يتم تمكين ميزات Phoenix Pro حتى تضغط على إعادة تفعيل الترخيص.",
  "LICENSE_STATUS_NOT_ACTIVATED_HERE": "متوفر، ولكن غير مُفعّل",
  ...
  "AI_DISABLE_CONFIRM_TITLE": "تعطيل الذكاء الاصطناعي؟",
  "AI_DISABLE_CONFIRM_MESSAGE": "سيؤدي هذا إلى إيقاف تشغيل جميع ميزات الذكاء الاصطناعي. ستتم إزالة لوحة الذكاء الاصطناعي وسيتوقف {APP_NAME} عن الاتصال بخدمات الذكاء الاصطناعي.<br><br>سيُعاد تشغيل {APP_NAME} الآن لتطبيق هذا التغيير. سيُطلب منك حفظ أي ملفات غير محفوظة.",
  "AI_DISABLE_CONFIRM_BTN": "تعطيل الذكاء الاصطناعي وإعادة التشغيل",
  "AI_ENABLE_CONFIRM_TITLE": "تمكين الذكاء الاصطناعي؟",
  "AI_ENABLE_CONFIRM_MESSAGE": "سيؤدي هذا إلى إعادة تشغيل ميزات الذكاء الاصطناعي واستعادة لوحة الذكاء الاصطناعي.<br><br>سيُعاد تشغيل {APP_NAME} الآن لتطبيق هذا التغيير. سيُطلب منك حفظ أي ملفات غير محفوظة.",
  "AI_ENABLE_CONFIRM_BTN": "تمكين الذكاء الاصطناعي وإعادة التشغيل",
  "AI_CHAT_TITLE": "Claude Code",
  "AI_CHAT_MODE_CHAT": "Claude Code",
  "AI_CHAT_MODE_CLI": "Claude Code CLI",
  "AI_CHAT_MODE_CODEX_CLI": "سطر أوامر Codex",
  "AI_CHAT_START_TYPE_HINT": "اكتب هنا للبدء",
  "AI_CHAT_START_GREETING": "مرحباً {0}،",
  "AI_CHAT_START_TITLE": "ماذا سنبني اليوم؟",
  "AI_CHAT_START_SURPRISE_TITLE": "فاجئني",
  "AI_CHAT_START_SURPRISE_DESC": "أرني عرضاً توضيحياً لما يمكنك فعله",
  "AI_CHAT_START_SURPRISE_CHOICE_DESC": "شاهد عرضاً توضيحياً آخر، أو دعني أبني شيئاً بشكل مباشر",
  "AI_CHAT_START_MAKE_NEW": "إنشاء شيء جديد",
  "AI_CHAT_START_ANOTHER_DEMO": "أظهر عرضاً توضيحياً آخر",
  "AI_CHAT_START_MAKE_NEW_NOTE": "إنشاء محتوى جديد يستهلك من أرصدة الذكاء الاصطناعي لديك. اختر عرضًا تجريبيًا لتجنب استهلاكها.",
  "AI_CHAT_START_DEMO_LINK": "هل تريد عرضًا تجريبيًا؟ {0}.",
  "AI_CHAT_START_DEMO_LINK_LABEL": "فاجئني",
  "AI_CHAT_SEE_DEMO_DESC": "شاهد عرضًا تجريبيًا",
  "AI_CHAT_DEMO_NOTICE_OFFLINE": "أنت غير متصل بالإنترنت، لذا فهذا عرض تجريبي مسجل.",
  "AI_CHAT_DEMO_BAR_TEXT": "سجّل الدخول لإنشاء محتواك الخاص باستخدام الذكاء الاصطناعي.",
  "AI_CHAT_DEMO_BACK_BTN": "رجوع",
  "AI_CHAT_DEMO_BUILT_WITH": "تم الإنشاء بواسطة {0}",
  "AI_CHAT_DEMO_ANOTHER_BTN": "شاهد عرضًا تجريبيًا آخر",
  "AI_CHAT_DEMO_REVEAL_PROMPT": "إظهار الموجه",
  "AI_CHAT_DEMO_HIDE_PROMPT": "إخفاء الموجه",
  "AI_CHAT_DEMO_PROMPT_LABEL": "الموجه الذي أنشأ هذا",
  "AI_CHAT_DEMO_COPY_PROMPT": "نسخ",
  "AI_CHAT_DEMO_PROMPT_COPIED": "تم النسخ",
  "AI_CHAT_DEMO_SPEED_TITLE": "سرعة التشغيل (انقر للتغيير)",
  "AI_CHAT_START_WORK_WITH": "العمل مع",
  "AI_CHAT_START_SETUP": "إعداد",
  "AI_CHAT_START_CUSTOM_PROVIDER": "نقطة نهاية مخصصة أو مزود خدمة مثل {0}؟ راجع {1}.",
  ...
  "AI_CHAT_WAITING_FOR_MODEL": "في انتظار النموذج...",
  "AI_CHAT_SCROLL_TO_BOTTOM": "التمرير إلى الأسفل",
  "AI_CHAT_PLACEHOLDER": "اسأل Claude...",
  "AI_CHAT_PLACEHOLDER_MODEL": "اسأل {0}...",
  "AI_CHAT_SEND_TITLE": "إرسال رسالة",
  "AI_CHAT_STOP_TITLE": "إيقاف الإنشاء (Esc)",
  "AI_CHAT_CLI_NOT_FOUND": "Claude Code غير مثبت",
  "AI_CHAT_CLI_INSTALL_MSG": "يجب تثبيت Claude Code CLI على نظامك لاستخدام ميزات الذكاء الاصطناعي في {APP_NAME}.",
  "AI_CHAT_CLI_INSTALL_BTN": "تثبيت Claude Code",
  "AI_CHAT_CLI_INSTALLING": "جارٍ التثبيت...",
  "AI_CHAT_CLI_INSTALLING_NAMED_MSG": "جاري تثبيت {0}، يرجى الانتظار. قد يستغرق هذا بعض الوقت...",
  "AI_CHAT_CLI_RESTART_NOTE": "أعد تشغيل {APP_NAME} بعد اكتمال التثبيت.",
  "AI_CHAT_CLI_NOT_FOUND_INSTALL_BTN": "تثبيت {0}",
  "AI_CHAT_CLI_SETUP_TITLE": "إعداد {0}",
  "AI_CHAT_CLI_SETUP_MISSING": "{0} غير مثبت بعد.",
  "AI_CHAT_CLI_SETUP_BAD_PATH": "تعذر بدء {0} من المسار المحفوظ.",
  "AI_CHAT_CLI_SETUP_INSTALL_TITLE": "ثبّته لي",
  "AI_CHAT_CLI_SETUP_RECOMMENDED": "موصى به",
  "AI_CHAT_CLI_SETUP_INSTALL_DESC": "يشغل المثبت الرسمي لـ {0} في الطرفية. اختر {1} مرة أخرى عند الانتهاء.",
  "AI_CHAT_CLI_SETUP_NO_DOWNLOADER": "يتطلب {0} أو {1}. قم بتثبيت أحدهما أولاً.",
  "AI_CHAT_CLI_SETUP_PATH_TITLE": "لدي بالفعل",
  "AI_CHAT_CLI_SETUP_PATH_DESC": "ألصق المسار الكامل لـ {0}.",
  "AI_CHAT_CLI_SETUP_USE_PATH_BTN": "استخدم هذا المسار",
  "AI_CHAT_CLI_SETUP_AUTO_DETECT": "الكشف تلقائيًا بدلاً من ذلك",
  "AI_CHAT_CLI_SETUP_AUTO_DETECT_FAILED": "تعذر العثور على {0} تلقائيًا.",
  "AI_CHAT_CLI_SETUP_WHAT_IS": "ما هو {0}؟",
  "AI_CHAT_CLI_ERR_OVERRIDE_MISSING": "لا يوجد ملف في ذلك المسار.",
  "AI_CHAT_CLI_ERR_OVERRIDE_NOT_EXECUTABLE": "هذا الملف غير قابل للتنفيذ.",
  "AI_CHAT_CLI_ERR_OVERRIDE_INVALID": "لم يتم تشغيل هذا الملف كـ {0}.",
  "AI_CHAT_CLI_ERR_OVERRIDE_TIMEOUT": "لم يستجب ذلك الملف في الوقت المحدد.",
  "AI_CHAT_CLI_ERR_OVERRIDE_REJECTED": "يحتوي ذلك المسار على أحرف لا يمكن استخدامها.",
  "AI_CHAT_SETUP_NEED_HELP": "تحتاج مساعدة؟",
  "AI_CHAT_SETUP_LEARN_MORE": "اعرف المزيد",
  "AI_CHAT_RETRY": "إعادة المحاولة",
  "AI_CHAT_DESKTOP_ONLY": "تتطلب ميزات الذكاء الاصطناعي تطبيق سطح المكتب {APP_NAME}. قم بتنزيله للبدء.",
  "AI_CHAT_DOWNLOAD_BTN": "تنزيل تطبيق سطح المكتب",
  "AI_CHAT_PLACEHOLDER_TITLE": "صمّم، وابنِ، وأصلِح بشكل أسرع باستخدام الذكاء الاصطناعي",
  "AI_CHAT_PLACEHOLDER_SUBTITLE": "حوّل الأفكار إلى صفحات عاملة في {APP_NAME}.",
  "AI_CHAT_WELCOME_LABEL": "الذكاء الاصطناعي في {APP_NAME}",
  "AI_CHAT_WELCOME_CLI_TITLE": "أنشئ باستخدام وكيل CLI المفضل لديك",
  "AI_CHAT_WELCOME_CLI_SUBTITLE": "زوّد وكلاء CLI لديك بالأدوات لرؤية صفحتك وفحصها وتصحيح أخطائها أثناء قيامهم بالبناء.",
  "AI_CHAT_WELCOME_LAYOUT_PROMPT": "أنشئ قسمًا للأسعار",
  "AI_CHAT_WELCOME_BUG_PROMPT": "إصلاح التنقل على الجوال",
  "AI_CHAT_WELCOME_EDITING": "جارٍ تحرير {0}…",
  "AI_CHAT_WELCOME_REVIEWING": "جارٍ مراجعة {0}…",
  "AI_CHAT_WELCOME_NAV_LABEL": "استعراض معاينات الذكاء الاصطناعي",
  "AI_CHAT_WELCOME_PREVIOUS": "المعاينة السابقة",
  "AI_CHAT_WELCOME_NEXT": "المعاينة التالية",
  "AI_CHAT_WELCOME_SHOW_DEMO": "عرض العرض التوضيحي للذكاء الاصطناعي",
  "AI_CHAT_WELCOME_SHOW_CLI": "عرض وكلاء CLI",
  "AI_CHAT_WELCOME_PLAY_DEMO": "تشغيل العرض التوضيحي للذكاء الاصطناعي",
  "AI_CHAT_LOGIN_TITLE": "سجّل الدخول للبدء في استخدام الذكاء الاصطناعي",
  "AI_CHAT_LOGIN_MESSAGE": "سجّل الدخول إلى حسابك في {APP_NAME} لإعداد الذكاء الاصطناعي.",
  "AI_CHAT_LOGIN_BTN": "تسجيل الدخول",
  "AI_CHAT_INTRO_GUEST_TITLE": "صمّم التخطيطات، وأصلح الأخطاء، وابنِ أسرع مع الذكاء الاصطناعي",
  "AI_CHAT_INTRO_CONFIGURE_TITLE": "بدء استخدام Claude Code",
  "AI_CHAT_INTRO_CONFIGURE_DESC": "شاهد هذا الفيديو القصير لإعداد الذكاء الاصطناعي في {APP_NAME}",
  "AI_CHAT_UPSELL_TITLE": "Phoenix Pro + الذكاء الاصطناعي",
  "AI_CHAT_UPSELL_MESSAGE": "ميزات الذكاء الاصطناعي متوفرة مع Phoenix Pro.",
  ...
  "AI_LIVE_PREVIEW_BANNER_DISMISS_TOOLTIP": "اضغط للتجاهل",
  "AI_CHAT_TOOL_CONTROL_EDITOR": "المحرر",
  "AI_CHAT_TOOL_TASKS": "المهام",
  "AI_CHAT_TOOL_TASKS_SUMMARY": "تم إنجاز {0} من {1} من المهام",
  "AI_CHAT_TOOL_WEB_FETCH": "جلب صفحة ويب",
  "AI_CHAT_TOOL_WEB_SEARCH": "بحث في الويب",
  "AI_CHAT_TOOL_SEARCHED": "تم البحث عن: {0}",
  "AI_CHAT_TOOL_GREP": "Grep: {0}",
  "AI_CHAT_TOOL_READ_FILE": "قراءة {0}",
  "AI_CHAT_TOOL_READ_FILE_RANGE": "قراءة الأسطر {1}-{2} من {0}",
  "AI_CHAT_TOOL_READ_FILE_FROM": "قراءة {0} من السطر {1}",
  ...
  "AI_CHAT_TOOL_APPLIED_DIRECTLY": "تم التطبيق مباشرة على القرص · الفرق غير متاح",
  "AI_CHAT_TOOL_REJECTED": "تم رفض التعديل — لم يتم تعديل الملف",
  "AI_CHAT_TOOL_REJECTED_REASON": "السبب: {0}",
  "AI_CHAT_FILE_NOT_FOUND_TITLE": "لم يتم العثور على الملف",
  "AI_CHAT_FILE_NOT_FOUND_MSG": "تعذّر فتح <span class=\"dialog-filename\">{0}</span>. ربما تم نقل الملف أو حذفه.",
  ...
  "AI_CHAT_FULL_AUTO_WARNING_TITLE": "التبديل إلى وضع السماح بكل شيء؟",
  "AI_CHAT_FULL_AUTO_WARNING_BODY": "يسمح وضع \"السماح بكل شيء\" للذكاء الاصطناعي بتشغيل أي أداة — أوامر Bash، تعديلات الملفات، حذف الملفات، جلب البيانات من الويب — دون أن يطلب إذنك أولاً.<br><br>هذا مناسب للمشاريع التجريبية الموثوقة، ولكنه قد يكون محفوفًا بالمخاطر: فخطوة خاطئة في التقدير قد تؤدي إلى الكتابة فوق الملفات أو حذفها، أو تشغيل أمر طرفية تدميري، أو دفع تغييرات غير مقصودة. استخدم نظام التحكم في الإصدارات (Git) حتى تتمكن من استعادة ملفاتك إذا حدث خطأ ما.<br><br>لا تقم بتمكين وضع \"السماح بكل شيء\" إلا في المشاريع التي تثق بها. يمكنك العودة إلى \"وضع التعديل\" في أي وقت باستخدام <kbd>Shift+Tab</kbd> أو بالنقر على شريط الوضع.",
  "AI_CHAT_FULL_AUTO_WARNING_PROCEED": "تمكين \"السماح بكل شيء\"",
  "AI_CHAT_SHOW_DIFF": "عرض الفروقات",
  "AI_CHAT_HIDE_DIFF": "إخفاء الفروقات",
  "AI_CHAT_DIFF_MORE_TITLE": "خيارات الفرق",
  "AI_CHAT_DIFF_EXPAND_ALL": "توسيع الكل",
  "AI_CHAT_DIFF_COLLAPSE_ALL": "طي الكل",
  "AI_CHAT_DIFF_ALWAYS_SHOW": "إظهار دائمًا",
  ...
  "AI_CHAT_TOOL_PLANNING": "التخطيط",
  "AI_CHAT_TOOL_TOOL_SEARCH": "جارٍ تحميل الأدوات",
  "AI_CHAT_TOOL_SEND_MESSAGE": "مراسلة الوكيل الفرعي",
  "AI_CHAT_TOOL_TASK_OUTPUT": "قراءة مُخرجات الوكيل الفرعي",
  "AI_CHAT_TOOL_TASK_STOP": "إيقاف الوكيل الفرعي",
  "AI_CHAT_PLAN_TITLE": "الخطة المقترحة",
  "AI_CHAT_PLAN_MAXIMIZE": "فتح الخطة في وضع ملء الشاشة",
  "AI_CHAT_PLAN_CLOSE_FULLSCREEN": "تصغير للعودة إلى المحادثة (Esc)",
  "AI_CHAT_PLAN_APPROVE": "موافقة",
  "AI_CHAT_PLAN_REVISE": "مراجعة",
  "AI_CHAT_PLAN_FEEDBACK_PLACEHOLDER": "ما الذي تود تغييره؟",
  "AI_CHAT_PLAN_STOP": "إيقاف",
  "AI_CHAT_PLAN_STOP_TITLE": "مقاطعة Claude وتجاهل هذه الخطة",
  "AI_CHAT_PLAN_REVISE_DEFAULT": "يرجى مراجعة الخطة.",
  ...
  "AI_CHAT_MODE_SELECT_TITLE": "التبديل بين محادثة Claude Code وطرفية CLI مدمجة",
  ...
  "AI_CHAT_BASH_ALLOWED": "تم السماح بالأمر",
  "AI_CHAT_BASH_DENIED": "تم رفض الأمر",
  "AI_CHAT_TOOL_CONFIRM_TITLE": "هل تسمح بهذا الإجراء؟",
  "AI_CHAT_TOOL_ALLOWED": "تم السماح بالإجراء",
  "AI_CHAT_TOOL_DENIED": "تم رفض الإجراء",
  "AI_CHAT_PLAN_WRITE_CONFIRM_TITLE": "التبديل إلى تلقائي؟",
  "AI_CHAT_PLAN_WRITE_CONFIRM_BODY": "يريد Claude تحرير {0}. أنت حاليًا في وضع التخطيط.",
  "AI_CHAT_PLAN_WRITE_ALLOW": "السماح والتبديل إلى تلقائي",
  "AI_CHAT_PLAN_WRITE_STAY": "البقاء في وضع التخطيط",
  "AI_CHAT_PLAN_WRITE_ALLOWED": "تم التبديل إلى تلقائي",
  "AI_CHAT_PLAN_WRITE_STAYED": "تم البقاء في وضع التخطيط",
  "AI_CHAT_CODE_DEFAULT_LANG": "نص",
  "AI_CHAT_CODE_COLLAPSE": "طي",
  "AI_CHAT_CODE_EXPAND": "توسيع",
  "AI_CHAT_CODE_EXPAND_LINES": "انقر للتوسيع - {0} أسطر",
  "AI_CHAT_CODE_COLLAPSE_FOOTER": "انقر للطي",
  "AI_CHAT_PREVIEW_OPEN": "معاينة",
  "AI_CHAT_PREVIEW_VIEWING": "جارٍ المعاينة",
  "AI_CHAT_QUESTION_OTHER": "اكتب إجابة مخصصة...",
  "AI_CHAT_QUESTION_SUBMIT": "إرسال",
  "AI_CHAT_IMAGE_LIMIT": "يُسمح بـ {0} صور كحد أقصى",
  "AI_CHAT_IMAGE_REMOVE": "إزالة الصورة",
  "AI_CHAT_IMAGE_SEARCH": "جاري البحث عن الصور",
  "AI_CHAT_IMAGE_USE": "جاري تحديد الصورة",
  "AI_CHAT_IMAGE_SELECTED": "الصورة المحددة",
  "AI_CHAT_IMAGE_SELECTED_GROUP": "الصور المحددة",
  "AI_CHAT_IMAGE_PREVIEW": "معاينة الصورة",
  "AI_CHAT_IMAGE_PREVIEW_INVALID": "يرجى توفير من واحد إلى تسعة عناوين URL لصور من نوع HTTP أو HTTPS أو ملف.",
  "AI_CHAT_IMAGE_PREVIEW_COUNT": "{0} صور",
  "AI_CHAT_IMAGE_PREVIEW_SINGLE": "صورة واحدة",
  "AI_CHAT_IMAGE_CLOSE": "إغلاق معاينة الصورة (Esc)",
  "AI_CHAT_IMAGE_PREVIOUS": "الصورة السابقة",
  "AI_CHAT_IMAGE_NEXT": "الصورة التالية",
  "AI_CHAT_IMAGE_POSITION": "صورة {0} من {1}",
  "AI_CHAT_IMAGE_PHOTO_BY": "صورة بواسطة",
  "AI_CHAT_IMAGE_REPLY": "الرد بهذه الصورة",
  "AI_CHAT_IMAGE_QUOTE": "اقتباس الصورة في المحادثة",
  "AI_CHAT_IMAGE_VIEW_COLLAGE": "عرض الصورة المجمعة",
  "AI_CHAT_IMAGE_SHOW_ALL": "إظهار الكل",
  "AI_CHAT_IMAGE_BACK_TO_ALL": "العودة إلى كل الصور",
  "AI_CHAT_IMAGE_RESULTS_COUNT": "{0} صورة · Unsplash",
  "AI_CHAT_IMAGE_RESULTS_SINGLE": "صورة واحدة · Unsplash",
  "AI_CHAT_IMAGE_NO_RESULTS": "لم يتم العثور على صور. جرب بحثًا مختلفًا.",
  "AI_CHAT_IMAGE_LOAD_FAILED": "تعذر تحميل هذه الصورة.",
  "AI_CHAT_IMAGE_COLLAGE_FAILED": "تعذر إنشاء مجموعة الصور.",
  "AI_CHAT_IMAGE_INVALID_QUERY": "أدخل استعلام بحث يصل إلى 200 حرف ورقم صفحة صالح.",
  "AI_CHAT_IMAGE_INVALID_REFERENCE": "مرجع الصورة هذا غير صالح. استخدم نتيجة من بحث الصور.",
  "AI_CHAT_IMAGE_HOURLY_LIMIT": "تم الوصول إلى حد 120 عملية بحث عن الصور في الساعة. انتظر قبل البحث مرة أخرى.",
  "AI_CHAT_IMAGE_GUEST_LIMIT": "لقد استنفدت حصتك من عمليات البحث عن الصور. سجل الدخول لمواصلة البحث.",
  "AI_CHAT_IMAGE_SERVER_LIMIT": "تم تقييد معدل البحث عن الصور مؤقتًا. انتظر قبل البحث مرة أخرى.",
  "AI_CHAT_IMAGE_TIMEOUT": "انتهت مهلة البحث عن الصور. حاول مرة أخرى لاحقًا.",
  "AI_CHAT_IMAGE_REQUEST_FAILED": "أعادت خدمة الصور خطأ ({0}).",
  "AI_CHAT_ATTACH_FILE": "إرفاق ملفات",
  "AI_CHAT_ATTACH_TITLE": "إرفاق ملف أو مجلد",
  "AI_CHAT_ATTACH_FILE_OPTION": "إرفاق ملف",
  "AI_CHAT_ATTACH_FOLDER": "إضافة مجلد كسياق",
  "AI_CHAT_ATTACH_FOLDER_PICK_TITLE": "اختر مجلدًا لإضافته كسياق",
  "AI_CHAT_SCREENSHOT_TITLE": "التقاط لقطة شاشة",
  ...
  "AI_CHAT_HISTORY_TITLE": "سجل الجلسات",
  "AI_CHAT_HISTORY_EMPTY": "لا توجد جلسات سابقة",
  "AI_CHAT_SESSION_RESUMED": "تم استئناف الجلسة",
  "AI_CHAT_HISTORY_JUST_NOW": "الآن",
  "AI_CHAT_HISTORY_MINS_AGO": "قبل {0} دقائق",
  "AI_CHAT_HISTORY_HOURS_AGO": "قبل {0} ساعات",
  "AI_CHAT_HISTORY_DAYS_AGO": "قبل {0} أيام",
  "AI_CHAT_HISTORY_CLEAR_ALL": "مسح الكل",
  "AI_CHAT_HISTORY_DELETE_CONFIRM": "هل تريد حذف هذه الجلسة؟",
  "AI_CHAT_SWITCH_PROJECT_TITLE": "الذكاء الاصطناعي يعمل",
  "AI_CHAT_SWITCH_PROJECT_MSG": "الذكاء الاصطناعي يعمل حاليًا على مهمة. سيؤدي تبديل المشاريع إلى إيقافه. هل تريد المتابعة؟",
  ...
  "AI_SETTINGS_API_TIMEOUT": "مهلة API (مللي ثانية)",
  "AI_SETTINGS_API_KEY_PLACEHOLDER": "أدخل مفتاح API الخاص بـ Anthropic",
  "AI_SETTINGS_BASE_URL_PLACEHOLDER": "اتركه فارغًا للاستخدام الافتراضي",
  "AI_SETTINGS_API_TIMEOUT_PLACEHOLDER": "اتركه فارغًا للاستخدام الافتراضي",
  "AI_SETTINGS_SAVE": "حفظ",
  "AI_SETTINGS_RESET": "إعادة تعيين",
  "AI_SETTINGS_CUSTOM_ENDPOINT_NOTICE": "يتم استخدام نقطة نهاية API مخصصة: {0}",
  "AI_SETTINGS_ACTIVE_PROVIDER": "الموفر النشط",
  "AI_SETTINGS_DEFAULT_PROVIDER": "افتراضي (كود Claude المحلي)",
  "AI_SETTINGS_DEFAULT_PROVIDER_FOR": "افتراضي (محلي {0})",
  "AI_SETTINGS_PROVIDERS": "الموفرون",
  "AI_SETTINGS_ADD_PROVIDER": "+ إضافة موفر",
  "AI_SETTINGS_EDIT": "تعديل",
  "AI_SETTINGS_DELETE": "حذف",
  "AI_SETTINGS_PROVIDER_NAME": "الاسم",
  "AI_SETTINGS_PROVIDER_NAME_PLACEHOLDER": "مثال: موفر واجهة برمجة التطبيقات الخاص بي",
  "AI_SETTINGS_SAVE_PROVIDER": "حفظ الموفر",
  "AI_SETTINGS_DELETE_PROVIDER": "حذف الموفر",
  "AI_SETTINGS_DELETE_ACTIVE_CONFIRM": "\"{0}\" هو المزوّد النشط. سيؤدي حذفه إلى العودة إلى الإعداد الافتراضي. هل تريد المتابعة؟",
  ...
  "MIGRATE_MOVING_TITLE": "{0} قيد الانتقال",
  "MIGRATE_MOVING_MESSAGE": "تطبيق {APP_NAME} على {0} ينتقل إلى موقع جديد على <strong>{1}</strong>. كل شيء يعمل بنفس الطريقة، العنوان فقط هو الذي يتغير.",
  "MIGRATE_DATA_SAFE_NOTE": "سيتم نسخ مشاريعك وإعداداتك وإضافاتك تلقائيًا في المرة الأولى التي تفتح فيها {0}. لن يتم حذف أي شيء من هذا الموقع.",
  "MIGRATE_MANUAL_DOWNLOAD_NOTE": "النقل التلقائي غير متوفر في هذا المتصفح. إذا كانت لديك مشاريع محفوظة هنا، فيُرجى تنزيلها حتى تتمكن من فتحها مرة أخرى على الموقع الجديد.",
  "MIGRATE_GO_TO_NEW_SITE": "الانتقال إلى الموقع الجديد",
  "MIGRATE_STAY_HERE": "البقاء هنا",
  "MIGRATE_PROGRESS_TITLE": "جارٍ نقل بياناتك",
  "MIGRATE_PROGRESS_STATUS": "تم نسخ {0} من {1} ملف",
  "MIGRATE_DONE_TITLE": "اكتمل الترحيل",
  "MIGRATE_DONE_FROM": "تم جلبه من {0}:",
  "MIGRATE_DONE_PROJECTS": "{0} من المشاريع",
  "MIGRATE_DONE_EXTENSIONS": "{0} من الإضافات والسمات",
  "MIGRATE_DONE_SETTINGS": "إعداداتك، بما في ذلك سمة المحرر",
  "MIGRATE_DONE_TOTAL": "إجمالي {0} ملف. أعد تحميل {APP_NAME} لبدء استخدامها.",
  "MIGRATE_PARTIAL_TITLE": "لم يكتمل الترحيل",
  "MIGRATE_PARTIAL_COUNT": "تعذر نسخ {0} من أصل {1} ملف، وهي لا تزال في الموقع القديم.",
  ...
  "MIGRATE_INTERRUPTED_TITLE": "لم يكتمل الترحيل",
  "MIGRATE_INTERRUPTED_PROGRESS": "تم نسخ {0} من أصل {1} ملف من {2} قبل انقطاع الاتصال. لقد تم حفظ هذه الملفات، لذا لم يُفقد أي شيء.",
  "MIGRATE_INTERRUPTED_RETRY": "سيحاول {APP_NAME} معالجة البقية في المرة القادمة التي تفتحه فيها.",
  "MIGRATE_INTERRUPTED_FINAL": "لنسخ البقية، اختر {0}.",
  ...
  "TERMINAL_PROJECT_CHANGED": "تم تبديل المشروع إلى {0}",
  "TERMINAL_PROJECT_RESTART_PATH": "إعادة تشغيل جميع الطرفيات في {0}",
  "TERMINAL_PROJECT_DISMISS": "تجاهل — إبقاء الطرفيات قيد التشغيل",
  "TERMINAL_PROJECT_RESTART": "إعادة تشغيل جميع الطرفيات",
  "AI_CHAT_START_CHAT_NAME": "{0} · الذكاء الاصطناعي البصري",
  "AI_CHAT_START_CHAT_DESC": "دردشة مدمجة لمسارات العمل المرئية",
  "AI_CHAT_START_BY_PROVIDER": "بواسطة {0}",
  "AI_CHAT_START_CLI_SEPARATOR": "أدوات سطر الأوامر · يتصل بـ {APP_NAME}",
  "AI_CHAT_START_CHAT_RUNNING": "قيد التنفيذ",
  "AI_CHAT_START_CLI_RUNNING": "قيد التشغيل",
  "AI_CHAT_START_CLI_FOLDED": "استخدم سطر الأوامر بدلاً من ذلك: {0}",
  "AI_CHAT_BACK_BTN": "رجوع",
  "AI_CHAT_BACK_TITLE": "العودة إلى البداية",
  "AI_CHAT_SETUP_PLACEHOLDER": "قم بإعداد Claude Code لبدء الدردشة"
});