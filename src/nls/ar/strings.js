...
define({
  ...
  "SIGNED_OUT_MESSAGE": "تم تسجيل خروجك من حساب {APP_NAME}. يُرجى تسجيل الدخول مرة أخرى للمتابعة.",
  "SIGNED_OUT_MESSAGE_FRIENDLY": "شكرًا لاستخدامك {APP_NAME}. نراك قريبًا!",
  ...
  "VALIDATION_CODE_MESSAGE": "الرجاء استخدام رمز التحقق هذا لتسجيل الدخول إلى حسابك في {APP_NAME}:",
