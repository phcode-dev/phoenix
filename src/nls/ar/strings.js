...
define({
  ...
  "MIGRATE_INTERRUPTED_MESSAGE": "انقطع الاتصال بـ {0} أثناء العملية. تم الاحتفاظ بكل ما نُسخ بالفعل. يمكنك الاستئناف من حيث توقفت في أي وقت من قائمة \"المساعدة\".",
  "MIGRATE_INTERRUPTED_FINAL": "انقطع الاتصال بـ {0} مرة أخرى. تم الاحتفاظ بكل ما نُسخ بالفعل. لإكمال ما تبقى، اختر {1}."
});