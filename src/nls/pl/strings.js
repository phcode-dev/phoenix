...
define({
  ...
  "UNSUPPORTED_BROWSER_MOBILE": "Urządzenia mobilne i tablety nie są obecnie w pełni obsługiwane. Możesz zamknąć to okno dialogowe, ale niektóre funkcje oprogramowania Phoenix nie będą działać w tej przeglądarce.",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Przeglądarka nie obsługuje otwartego folderu. Użyj przeglądarki Chrome, Edge lub Opera, aby otworzyć foldery lokalne.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Użyj jednej z obsługiwanych przeglądarek poniżej.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Ciężko pracujemy, aby Phoenix był dostępny w większej liczbie przeglądarek. Możesz zamknąć to okno dialogowe, ale niektóre funkcje oprogramowania Phoenix nie będą działać w tej przeglądarce.",
