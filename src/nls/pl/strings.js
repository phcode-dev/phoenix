...
define({
  ...
  "INCLUDE_FILE_FILTER": "Uwzględnij {0}",
  "EXCLUDE_FILE_FILTER_DROPDOWN": "Wykluczać",
  "INCLUDE_FILE_FILTER_DROPDOWN": "Włączać",
  "EDIT_FILE_FILTER": "Edytuj…",
  "FILE_FILTER_DIALOG": "Edytuj filtr wykluczeń",
  "FILE_FILTER_INSTRUCTIONS": "Wyklucz pliki i foldery pasujące do dowolnego z poniższych kryteriów: <a href='{0}' title=\"{0}\">ignoruj symbole wieloznaczne</a> . Wprowadź każdy ciąg w nowej linii. Np<ul><li> <code>*.js</code> będzie pasować do <code>a/b/x.js</code> , <code>xyx.js</code> itp.</li><li> <code>./*.css</code> będzie pasować tylko <code>x.css</code> w katalogu głównym projektu, ale nie do <code>y/x.css</code> w podfolderze.</li></ul>",
  "FILE_FILTER_INSTRUCTIONS_INCLUDE": "Uwzględnij tylko pliki i foldery pasujące do któregokolwiek z poniższych <a href='{0}' title=\"{0}\">ignorowanych symboli wieloznacznych</a> . Wprowadź każdy ciąg w nowej linii. Np<ul><li> <code>*.js</code> będzie pasować do <code>a/b/x.js</code> , <code>xyx.js</code> itp.</li><li> <code>./*.css</code> będzie pasować tylko <code>x.css</code> w katalogu głównym projektu, ale nie do <code>y/x.css</code> w podfolderze.</li></ul>",
  ...
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>Safari automatycznie usuwa dane witryny, jeśli witryna nie zostanie ponownie odwiedzona w ciągu 7 dni. Aplikacja {APP_NAME} wykorzystuje pamięć przeglądarki do zapisywania Twoich projektów, które mogą zostać usunięte ze względu na te zasady.<br/><br/> <strong>Aby zapobiec utracie danych</strong> , <strong>pobierz</strong> swoje projekty przed zamknięciem karty lub bądź na bieżąco z naszymi <strong>nadchodzącymi aplikacjami internetowymi i natywnymi aplikacjami Mac/iOS</strong> .</span>",
