...
define({
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME} <strong>nie zbiera ani nie przetwarza żadnych danych osobowych</strong> , ale <strong>zbiera anonimowe statystyki użytkowania</strong> , aby chronić Twoją prywatność. Dane anonimowe są zwolnione z wymogów dotyczących powiadomień RODO/CCPA, ale uważamy, że musisz mieć wybór, aby dobrze zrezygnować z gromadzenia anonimowych danych.<br> Te <strong>anonimowe</strong> statystyki użytkowania aplikacji i raporty o błędach pomagają ustalać priorytety funkcji, znajdować błędy i wykrywać problemy z użytecznością aplikacji {APP_NAME}.</p><p> Poniżej znajduje się podgląd danych, które zostaną przesłane w następnym Raporcie stanu <em>, jeśli</em> jest on włączony. (Zobacz także konsolę programisty, aby zapoznać się z dziennikami błędów oznaczonymi jako „Wychwycony błąd krytyczny”).</p>",
