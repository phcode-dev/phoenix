...
define({
  ...
  "DECODE_FILE_FAILED_ERR": "{APP_NAME} nie był w stanie zdekodować zawartości pliku.",
  ...
  "ERROR_MOVING_FILE_TITLE": "Błąd w ruchu {0}",
  ...
  "LIVE_DEV_CLICK_TO_RELOAD_PAGE": "Przeładuj stronę",
  "LIVE_DEV_CLICK_POPOUT": "Popout Live Preview do nowego okna",
  ...
  "FIND_IN_FILES_INDEXING_PROGRESS": "Indeksowanie {0} plików {1} do natychmiastowego wyszukiwania...",
  ...
  "CMD_NAVIGATE_BACKWARD": "Nawigacja wstecz",
  "CMD_NAVIGATE_FORWARD": "Nawigacja do",
  ...
  "CMD_HOMEPAGE": "{APP_NAME} Strona główna",
  ...
  "PRERELEASE_BUILD": "wstępna kompilacja",
  ...
  "ABOUT": "O programie",
  "CLOSE": "Zamknij",
  "ABOUT_TEXT_LINE1": "Wydanie {VERSION_MAJOR}. {VERSION_MINOR} {BUILD_TYPE} {WERSJA}",
  "ABOUT_TEXT_BUILD_TIMESTAMP": "kompilacja znacznika czasu: ",
  "ABOUT_TEXT_LINE3": "Biblioteki stron trzecich, z których korzystamy - <a href='https://github.com/phcode-dev/phoenix/tree/main/src/thirdparty/licences'> Licencje i Uznanie autorstwa</a> . ",
  "ABOUT_TEXT_LINE4": "Dokumentacja i źródło pod adresem <a href='https://github.com/phcode-dev/phoenix/'>https://github.com/phcode-dev/phoenix/</a>",
  "ABOUT_TEXT_LINE5": "Wykonane z ❤ i JavaScript przez:",
  "ABOUT_TEXT_LINE6": "Wiele osób (ale mamy problem z załadowaniem tych danych w tej chwili).",
  ...
  "ERROR_EXTRACTTO_FUNCTION_NOT_VALID": "Wybrany blok powinien reprezentować zestaw instrukcji lub wyrażenie",
  ...
  "CMD_REFACTORING_TRY_CATCH": "Zawiń w Try Catch",
  "CMD_REFACTORING_CONDITION": "Owiń w stanie",
  "CMD_REFACTORING_GETTERS_SETTERS": "Tworzenie Getters/Setters",
  "CMD_REFACTORING_ARROW_FUNCTION": "Konwertuj na funkcję strzałki",
  "DESCRIPTION_CODE_REFACTORING": "Włącz/wyłącz refaktoring kodu JavaScript",
  "ERROR_TRY_CATCH": "Wybierz poprawny kod do zawinięcia w blok Try-catch",
  "ERROR_WRAP_IN_CONDITION": "Wybierz prawidłowy kod do zawinięcia w bloku Warunek",
  "ERROR_ARROW_FUNCTION": "Umieść kursor wewnątrz wyrażenia funkcyjnego",
  "ERROR_GETTERS_SETTERS": "Umieszczanie kursora na składniku wyrażenia obiektu",
  "ERROR_RENAME_MULTICURSOR": "Nie można zmienić nazwy podczas korzystania z wielu kursorów",
  "ERROR_RENAME_QUICKEDIT": "Nie można zmienić nazwy tego identyfikatora, ponieważ jest on wymieniony gdzie indziej poza tą funkcją",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "Obiekt z domyślnymi opcjami JSHint. Proszę zobaczyć następujący adres URL dla wszystkich dostępnych opcji JSHint: https://jshint.com/docs/options/",
  ...
  "DESCRIPTION_LIVE_DEV_HIGHLIGHT_SETTINGS": "Podgląd na żywo Ustawienia wyróżnienia",
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "false, aby wyłączyć podgląd na żywo wstecznej inspekcji",
  "DOWNLOAD_FAILED": "Pobieranie nie powiodło się",
  "DOWNLOAD_COMPLETE": "Pobierz kompletne!",
  "UPDATE_SUCCESSFUL": "Aktualizacja zakończona sukcesem!",
  "UPDATE_FAILED": "Aktualizacja nie powiodła się",
  "VALIDATION_FAILED": "Weryfikacja nie powiodła się!",
  "INITIALISATION_FAILED": "Inicjalizacja zawiodła!",
  "CLEANUP_FAILED": "Czyszczenie nie powiodło się",
  "WARNING_TYPE": "Ostrzeżenie!",
  "CLICK_RESTART_TO_UPDATE": "Kliknij przycisk Uruchom ponownie, aby zaktualizować nawiasy.",
  ...
  "RETRY_DOWNLOAD": "Pobieranie nie powiodło się Ponowienie próby... Próba ",
  "VALIDATING_INSTALLER": "Pobierz kompletne! Sprawdzanie poprawności instalatora...",
  "CHECKSUM_DID_NOT_MATCH": "Suma kontrolna nie pasowała.",
  "INSTALLER_NOT_FOUND": "Instalator nie został znaleziony.",
  "DOWNLOAD_ERROR": "Wystąpił błąd podczas pobierania.",
  "NETWORK_SLOW_OR_DISCONNECTED": "Sieć jest odłączona lub zbyt wolna.",
  "RESTART_BUTTON": "Uruchom ponownie",
  "LATER_BUTTON": "Później",
  "DESCRIPTION_AUTO_UPDATE": "Włącz/wyłącz nawiasy Automatyczna aktualizacja",
  ...
  "PHP_VERSION_INVALID": "Błąd podczas analizowania wersji PHP. Proszę sprawdzić wyjście polecenia „php —version”.",
  "PHP_UNSUPPORTED_VERSION": "Zainstaluj środowisko wykonawcze PHP7, aby włączać narzędzia związane z PHP, takie jak wskazówki do kodu, wskazówki do parametrów, przeskocz do definicji i inne. Znaleziono wersję: {0}",
  "PHP_EXECUTABLE_NOT_FOUND": "Nie znaleziono środowiska wykonawczego PHP. Zainstaluj środowisko wykonawcze PHP7 i zaktualizuj „ExecutablePath” w Preferencjach PHP odpowiednio. Umożliwia to oprzyrządowanie związane z PHP, takie jak wskazówki do kodu, wskazówki do parametrów, przeskocz do definicji i inne.",
  "PHP_PROCESS_SPAWN_ERROR": "Podczas uruchamiania procesu PHP napotkany kod błędu {0}.",
  "PHP_SERVER_ERROR_TITLE": "Błąd",
  "PHP_SERVER_MEMORY_LIMIT_INVALID": "Podany limit pamięci jest nieprawidłowy. Przejrzyj preferencje PHP, aby ustawić prawidłową wartość.",
  "DESCRIPTION_PHP_TOOLING_CONFIGURATION": "Domyślne ustawienia konfiguracji PHP Tooling",
  "OPEN_PREFERENNCES": "Otwórz Preferencje",
  "LANGUAGE_TOOLS_PREFERENCES": "Preferencje dotyczące narzędzi językowych",
  "FIND_ALL_REFERENCES": "Znajdź wszystkie referencje",
  "REFERENCES_IN_FILES": "odniesienia",
  "REFERENCE_IN_FILES": "źródło",
  "REFERENCES_NO_RESULTS": "Brak dostępnych odniesień dla bieżącej pozycji kursora",
  "CMD_FIND_DOCUMENT_SYMBOLS": "Znajdź symbole dokumentu",
  "CMD_FIND_PROJECT_SYMBOLS": "Znajdź symbole projektu",
  "REMOTE_DEBUGGING_ENABLED": "Zdalne debugowanie włączone na localhost:",
  "REMOTE_DEBUGGING_PORT_INVALID": "Nie można włączyć zdalnego debugowania na porcie {0}. Numery portów powinny mieścić się między {1} a {2}.",
  "DESCRIPTION_EXTERNAL_APPLICATION_ASSOCIATE": "Mapowania dla rozszerzenia pliku do aplikacji zewnętrznych. Składnia: \"<file_type>„: „<Default|ApplicationName|ApplicationPath>”, Użyj „default”, aby otworzyć pliki w domyślnej aplikacji systemu dla danego typu pliku.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "Otwórz pliki graficzne w zewnętrznych edytorach.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "Twój bieżący folder zawiera typy plików graficznych, które nie są obsługiwane przez {APP_NAME}. <br/>Możeszteraz kojarzyć określone typy plików z zewnętrznymi edytorami. Po skojarzeniu możesz otwierać pliki graficzne, takie jak .xd, .psd, .jpg, .png, .ai, .svg w ich domyślnych aplikacjach, klikając dwukrotnie pliki w drzewie plików. <br/><br/>Kliknijprzycisk „Ok”, aby skojarzyć typy plików graficznych z odpowiednimi domyślnymi aplikacjami.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Następujące typy plików zostały pomyślnie skojarzone z domyślnymi aplikacjami. <br/>{0} Masz możliwość zmiany preferencji dotyczących tego, czy usuwasz lub dodajesz nowe skojarzenia typów plików w brackets.json, przechodząc do menu „Debug->Otwórz plik preferencji”.",
  "UNSUPPORTED_BROWSER": "Przeglądarka nie jest obsługiwana",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Przeglądarka nie obsługuje folderu Open",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Użyj jednej z obsługiwanych przeglądarek poniżej.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Ciężko pracujemy, aby Phoenix był dostępny w większej liczbie przeglądarek. Możesz zamknąć ten dialog, ale niektóre funkcje w Phoenix nie będą działać w tej przeglądarce.",
  "CANNOT_PUBLISH_LARGE_PROJECT": "Nie można opublikować dużego projektu",
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "Phoenix wciąż jest w eksperymentalnej alfie. Nie włączyliśmy jeszcze synchronizacji projektów z ponad 500 plikami.",
  "SHARE_WEBSITE": "Publikowanie i udostępnianie witryny?",
  "PUBLISH": "Publikuj",
  "PUBLISH_CONSENT_MESSAGE": "Szybko wyświetlaj podgląd zmian i udostępniaj swoją witrynę innym osobom. Phoenix może opublikować dla Ciebie tę stronę pod adresem {0}. Opublikowane linki będą ważne przez okres 7 dni. </br>Czychcesz opublikować i udostępnić swoją stronę internetową?",
  "PUBLISH_SYNC_IN_PROGRESS": "Synchronizacja w toku dla podglądu...",
  "PUBLISH_PAGE": "Kliknij, aby opublikować i udostępnić tę stronę",
  ...
  "UNZIP_FAILED": "Błąd: Rozpakowanie nie powiodło się.",
  "CONFIRM_REPLACE_TITLE": "Potwierdź zastąpić",
  ...
  "WEBPAGE_HOME_PAGE": "Strona główna podzial",
  "WEBPAGE_BLOG": "Blog Page",
  "WEBPAGE_DASHBOARD": "Pulpit nawigacyjny HTML",
  ...
  "BEAUTIFY_ERROR": "Nie można upiększyć kodu. Sprawdź składnię.",
  ...
  "BEAUTIFY_ERROR_SELECTION": "Nie udało się upiększyć. </br>Niekompletnyblok kodu wybrany lub nieprawidłowa składnia.",
