...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "Nie wykryto pliku <code>package.json</code> w bieżącym projekcie. Czy bieżący projekt jest prawidłowym rozszerzeniem aplikacji {APP_NAME}?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "plik <code>package.json</code> ma nieprawidłowy format JSON.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "Brak wymaganych pól w <code>package.json</code> : [{0}]",
