...
define({
  ...
  "DEVICE_SIZE_LIMIT_MESSAGE": "O Phoenix Pro permite que você visualize sua página nos tamanhos de tela definidos no seu CSS.",
  "AI_CHAT_TITLE": "Claude Code",
  "AI_CHAT_CLI_NOT_FOUND": "Claude Code Não Instalado",
  "AI_CHAT_CLI_INSTALL_MSG": "O Claude Code CLI precisa estar instalado no seu sistema para usar os recursos de IA no {APP_NAME}. <a class='ai-learn-more-link' href='#'>Saiba mais</a>",
  "AI_CHAT_CLI_INSTALL_BTN": "Instalar Claude Code",
  "AI_CHAT_CLI_INSTALLING": "Instalando…",
  "AI_CHAT_CLI_INSTALLING_MSG": "Instalando o Claude Code, aguarde. Isso pode demorar um pouco...",
  ...
  "AI_CHAT_PLAN_FEEDBACK_PLACEHOLDER": "O que você gostaria de alterar?"
});