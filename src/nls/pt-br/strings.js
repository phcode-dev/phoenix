...
define({
  ...
  "AI_CHAT_CLI_NOT_FOUND": "CLI do Claude não encontrado",
  "AI_CHAT_CLI_INSTALL_MSG": "Instale o CLI do Claude para usar os recursos de IA:<br><code>npm install -g @anthropic-ai/claude-code</code><br><br>Em seguida, execute <code>claude login</code> para se autenticar.",
