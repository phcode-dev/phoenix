...
define({
  ...
  "AI_CHAT_DESKTOP_ONLY": "Os recursos de IA requerem o aplicativo Phoenix para desktop. Faça o download para começar.",
  ...
  "AI_CHAT_ADMIN_DISABLED_MESSAGE": "Os recursos de IA foram desativados pelo administrador do sistema.",
  ...
  "AI_CHAT_HISTORY_MINS_AGO": "{0}m atrás",
  "AI_CHAT_HISTORY_HOURS_AGO": "{0}h atrás",
  "AI_CHAT_HISTORY_DAYS_AGO": "{0}d atrás",
  ...
  "AI_CHAT_SWITCH_PROJECT_MSG": "A IA está trabalhando em uma tarefa. Mudar de projeto irá interrompê-la. Deseja continuar?"
});