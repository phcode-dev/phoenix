...
define({
  ...
  "LIVE_DEV_SETTINGS_ELEMENT_HIGHLIGHT_PREFERENCE": "mostrar destaques do elemento na pré-visualização ao vivo ao 'passar o mouse' ou 'clicar'. O padrão é 'passar o mouse'",
  ...
  "DESCRIPTION_LIVE_DEV_HIGHLIGHT_SETTINGS": "Configurações de destaque da Visualização em Tempo Real.",
  ...
  "ENJOYING_APP": "Gostando do {APP_NAME}?",
  "GITHUB_STARS_POPUP": "<div>Seu apoio ajuda nossa pequena equipe a se manter motivada para tornar o <b style='color: darkblue'>phcode.dev</b> ainda melhor.<br/>Por favor, nos dê uma estrela ou considere nos patrocinar no GitHub:",
