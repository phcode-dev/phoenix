...
define({
  ...
  "UNSUPPORTED_UTF16_ENCODING_ERR": "{APP_NAME} atualmente não é compatível com arquivos de texto codificados UTF-16.",
  ...
  "ERROR_RENAMING_NOT_IN_PROJECT": "O arquivo ou diretório não faz parte do projeto aberto no momento. Infelizmente, somente arquivos de projeto podem ser renomeados neste momento.",
  ...
  "CANNOT_DUPLICATE_TITLE": "Impossível duplicar",
  ...
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "Fixar na página de visualização de desafixar",
  ...
  "WINDOW_UNLOAD_WARNING": "Tem certeza de que deseja navegar para um URL diferente e sair de colchetes?",
  "WINDOW_UNLOAD_WARNING_WITH_UNSAVED_CHANGES": "Você tem alterações não salvas! Tem certeza de que deseja navegar para um URL diferente e sair de colchetes?",
  "DONE": "Concluído",
  "OK": "OK",
  "CANCEL": "Cancelar",
  ...
  "CMD_GOTO_DEFINITION_PROJECT": "Definição de localização rápida no projeto",
  ...
  "CMD_OPEN_VFS": "Sistema de arquivos virtual aberto",
  "CMD_OPEN_VIRTUAL_SERVER": "Servidor virtual aberto",
  "HELP_MENU": "Ajuda",
  ...
  "ABOUT": "Sobre",
  "CLOSE": "Fechar",
  "ABOUT_TEXT_LINE1": "Lançamento {VERSION_MAJOR}. {VERSION_MINOR} {BUILD_TYPE} {VERSÃO}",
  "ABOUT_TEXT_BUILD_TIMESTAMP": "carimbo de data/hora da construção: ",
  ...
  "ABOUT_TEXT_LINE6": "Muitas pessoas (mas estamos tendo problemas para carregar esses dados no momento).",
  ...
  "EXTRACTTO_FUNCTION_SELECT_SCOPE": "Escolha o escopo do destino",
  ...
  "CMD_REFACTORING_CONDITION": "Condição de embrulho",
  "CMD_REFACTORING_GETTERS_SETTERS": "Criar Getters/Setters",
  "CMD_REFACTORING_ARROW_FUNCTION": "Função Converter para seta",
  "DESCRIPTION_CODE_REFACTORING": "Ativar/desativar a refatoração de código JavaScript",
  "ERROR_TRY_CATCH": "Selecione um código válido para empacotar em um bloco Try-catch",
  "ERROR_WRAP_IN_CONDITION": "Selecione um código válido para empacotar em um bloco Condition",
  "ERROR_ARROW_FUNCTION": "Coloque o cursor dentro de uma expressão de função",
  "ERROR_GETTERS_SETTERS": "Colocar o cursor em um membro de uma expressão de objeto",
  "ERROR_RENAME_MULTICURSOR": "Não é possível renomear ao usar vários cursores",
  "ERROR_RENAME_QUICKEDIT": "Não é possível renomear esse identificador, pois ele é referenciado em outro lugar fora desta função",
  ...
  "DESCRIPTION_CODE_FOLDING_MAKE_SELECTIONS_FOLDABLE": "true para ativar o dobramento de código no texto selecionado no editor",
  ...
  "DESCRIPTION_LINEWISE_COPY_CUT": "Copiar e recortar quando não houver seleção copiará ou cortará as linhas inteiras que têm cursores nelas",
  "DESCRIPTION_INPUT_STYLE": "Seleciona a maneira como o CodeMirror lida com a entrada e o foco. Pode ser textarea, que é o padrão, ou contenteditable, o que é melhor para leitores de tela (instável)",
  ...
  "DESCRIPTION_MERGE_PANES_WHEN_LAST_FILE_CLOSED": "true para recolher painéis depois que o último arquivo do painel for fechado por meio do botão fechar do cabeçalho do painel",
  "DESCRIPTION_SHOW_PANE_HEADER_BUTTONS": "Alterne quando mostrar os botões fechar e virar visualização no cabeçalho.",
  ...
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "false para desativar a inspeção reversa de visualização ao vivo",
  ...
  "INITIALISATION_FAILED": "Falha na inicialização!",
  ...
  "INITIAL_DOWNLOAD": "Fazendo download da atualização...",
  ...
  "CHECKSUM_DID_NOT_MATCH": "A soma de verificação não correspondeu.",
  "INSTALLER_NOT_FOUND": "Instalador não encontrado.",
  "DOWNLOAD_ERROR": "Ocorreu um erro durante o download.",
  "NETWORK_SLOW_OR_DISCONNECTED": "A rede está desconectada ou está muito lenta.",
  ...
  "PHP_EXECUTABLE_NOT_FOUND": "Tempo de execução do PHP não encontrado. Instale o tempo de execução do PHP7 e atualize “ExecutablePath” nas Preferências do PHP adequadamente. Isso permite ferramentas relacionadas ao PHP, como dicas de código, dicas de parâmetro, salto para definição e muito mais.",
  ...
  "OPEN_PREFERENNCES": "Preferências abertas",
  "LANGUAGE_TOOLS_PREFERENCES": "Preferências para ferramentas de linguagem",
  "FIND_ALL_REFERENCES": "Localizar todas as referências",
  "REFERENCES_IN_FILES": "referencia",
  ...
  "REMOTE_DEBUGGING_ENABLED": "Depuração remota ativada no localhost:",
  ...
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "Sua pasta atual tem tipos de arquivos gráficos que não são suportados pelo {APP_NAME}. <br/>Agora você pode associar tipos de arquivos específicos a editores externos. Uma vez associado, você pode abrir arquivos gráficos como .xd, .psd, .jpg, .png, .ai, .svg em seus aplicativos padrão clicando duas vezes nos arquivos na Árvore de Arquivos. <br/><br/>Clique no botão 'Ok' para associar os tipos de arquivo gráfico com seus respectivos aplicativos padrão.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Os seguintes tipos de arquivo foram associados com sucesso aos aplicativos padrão. <br/>{0} Você tem a opção de alterar sua preferência sobre se você excluir/adicionar novas associações de tipo de arquivo em colchets.json acessando o menu “Depurar->Abrir arquivo de preferências”.",
  "UNSUPPORTED_BROWSER": "O navegador não é suportado",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "O navegador não suporta a pasta Abrir",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Use um dos navegadores compatíveis abaixo.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Estamos trabalhando muito para disponibilizar o Phoenix em mais navegadores. Você pode fechar essa caixa de diálogo, mas alguns recursos do Phoenix não funcionarão neste navegador.",
  ...
  "PUBLISH": "Publicar",
  "PUBLISH_CONSENT_MESSAGE": "Visualize rapidamente as alterações e compartilhe seu site com outras pessoas. A Phoenix pode publicar este site para você em {0}. Os links publicados serão válidos por um período de 7 dias. </br>Você deseja publicar e compartilhar seu site?",
