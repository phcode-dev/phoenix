...
define({
  ...
  "DESCRIPTION_LIVEDEV_SECURITY": "Предупреждение за сигурност от phcode.dev<br><br> Тази визуализация на живо се опита да получи достъп до файл, който не е проект. Достъпът е отказан за вашата безопасност. Моля, бъдете внимателни, когато работите върху ненадеждни проекти.",
  ...
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Следните типове файлове са успешно свързани с приложения по подразбиране.<br/> {0} Имате възможност да промените предпочитанията си дали да изтриете/добавите нови асоциации на файлови типове в brackets.json, като отидете в менюто „Debug-&gt;Open Preferences File“.",
  ...
  "NEW_PROJECT_NOTIFICATION": "Щракнете върху тази икона, за да създадете нов проект.</br><img src=\"extensions/default/Phoenix/images/new_project.png\"><br/> <a href='#' style='float:right;'>Добре</a>",
  "BEAUTIFY_CODE_NOTIFICATION": "Щракнете тук или натиснете <b>„{0}“,</b> за да разкрасите кода.</br><img src=\"extensions/default/Phoenix/images/beautify.gif\"><br/> <a href='#' style='float:right;'>Добре</a>",
