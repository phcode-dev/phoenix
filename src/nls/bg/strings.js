...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "файлът <code>package.json</code> не е открит в текущия проект. Текущият проект валидно разширение {APP_NAME} ли е?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "файлът <code>package.json</code> е невалиден JSON.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "Липсват задължителни полета в <code>package.json</code> : [{0}]",
  ...
  "PUBLISH": "Публикувай",
  "PUBLISH_CONSENT_MESSAGE": "Бързо прегледайте промените и споделете уебсайта си с други. Phoenix може да публикува този уебсайт вместо вас на адрес {0}. Публикуваните връзки ще бъдат валидни за период от 7 дни. </br>Искате ли да публикувате и споделите уебсайта си?",
