...
define({
  ...
  "UPDATE_READY_RESTART_INSTALL_MESSAGE": "Актуализацията е изтеглена успешно: Моля, затворете всички прозорци на приложението {APP_NAME}, за да приложите най-новите актуализации.",
