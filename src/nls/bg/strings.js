...
define({
  ...
  "ZOOM_WITH_SHORTCUTS_DETAILS": "Моля, използвайте клавишни комбинации <code><i>{0}</i></code> за увеличаване и <code><i>{1}</i></code> за намаляване.",
  ...
  "ERROR_PREFS_RESET_TITLE": "Нулиране на настройките - Изисква се рестартиране",
  "ERROR_PREFS_PROJECT_LINT": "Предпочитания за проекта",
  "ERROR_PREFS_PROJECT_LINT_MESSAGE": "Грешка: Проектът съдържа файлове `.brackets.json` и `.phcode.json`, което води до конфликт. Моля, изтрийте или `.brackets.json`, или `.phcode.json` и след това презаредете проекта.",
  ...
  "ERROR_PREFS_CORRUPT_RESET": "Настройките ви за {APP_NAME} бяха повредени и нулирани. Моля, рестартирайте {APP_NAME}, за да влязат в сила промените.",
  ...
  "UNSUPPORTED_DOM_APIS_CONFIRM": "Приложните програмни интерфейси `window.confirm` и `window.prompt` не са налични във вградения преглед на живо на {APP_NAME}. Моля, изскачане на Live Preview, за да използвате тези API в браузъра.",
  ...
  "LIVE_DEV_STATUS_TIP_CONNECTED": "Активен сървър за предварителен преглед на живо",
  "LIVE_DEV_STATUS_TIP_OUT_OF_SYNC": "Преглед на живо",
  "LIVE_DEV_TOOLTIP_SHOW_IN_EDITOR": "{0} – Показване в редактора…",
  ...
  "LIVE_DEV_OPEN_CHROME": "Отворете в Chrome...",
  "LIVE_DEV_OPEN_SAFARI": "Отворете в Safari...",
  "LIVE_DEV_OPEN_EDGE": "Отваряне в Edge...",
  "LIVE_DEV_OPEN_FIREFOX": "Отворете във Firefox...",
  "LIVE_DEV_OPEN_ERROR_TITLE": "Грешка при отваряне на визуализация на живо в {0}",
  "LIVE_DEV_OPEN_ERROR_MESSAGE": "Уверете се, че браузърът {0} е инсталиран и опитайте отново.",
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "Фиксиране или откачане на страница за визуализация",
  "LIVE_DEV_STATUS_TIP_SYNC_ERROR": "Преглед на живо (без обновяване, поради синтактична грешка)",
  "LIVE_DEV_SETTINGS": "Настройки за преглед на живо...",
  "LIVE_DEV_SETTINGS_BANNER": "Настройте персонализиран сървър за визуализация на живо „ <b>{0}</b> “ и други изобразени от сървъра файлове (PHP, JSP и др.)",
  "LIVE_DEV_SETTINGS_TITLE": "Настройки за преглед на живо",
  "LIVE_DEV_SETTINGS_STARTUP": "Показване на панела за преглед на живо при стартиране",
  "LIVE_DEV_SETTINGS_SERVER_PREFERENCE": "true за активиране на персонализиран сървър за разработка",
  "LIVE_DEV_SETTINGS_STARTUP_PREFERENCE": "true за показване на панела за преглед на живо при стартиране",
  "LIVE_DEV_SETTINGS_HOT_RELOAD_PREFERENCE": "вярно, ако сървърът поддържа горещо презареждане и деактивира презареждането на Live Preview при запазване",
  "LIVE_DEV_SETTINGS_USE_SERVER": "Използвайте персонализиран сървър за разработка за този проект",
  "LIVE_DEV_SETTINGS_SERVE_PREFERENCE": "Вашият URL адрес на сървър за разработка за проекта, напр. http://localhost:8000/php",
  "LIVE_DEV_SETTINGS_SERVER_INBUILT": "напр. http://localhost:8000/php - В момента се използва вграден сървър.",
  "LIVE_DEV_SETTINGS_SERVER_ROOT": "Обслужваща папка в проекта",
  ...
  "LIVE_DEV_SETTINGS_RELOAD_HELP": "Някои сървъри поддържат горещо презареждане, при което промените в кода се изпращат към страницата без пълно презареждане на страницата.\nАктивирайте тази функция, ако не искате {APP_NAME} да презарежда страницата при всяко запазване.",
  "LIVE_DEV_SETTINGS_FRAMEWORK": "Сървърна рамка",
  "LIVE_DEV_SETTINGS_FRAMEWORK_CUSTOM": "Персонализиран",
  "LIVE_DEV_SETTINGS_FRAMEWORK_PREFERENCES": "Сървърна рамка, в момента поддържа само docusaurus",
  "LIVE_PREVIEW_CUSTOM_SERVER_BANNER": "Получаване на визуализация от вашия персонализиран сървър {0}",
  ...
  "EXT_ALWAYS_MODIFIED_BUTTON_TOOLTIP": "Винаги презаписвайте файлове до превключване или рестартиране на проекта",
  ...
  "ALWAYS_OVERWRITE": "Винаги презаписвайте",
  "DELETE": "Изтриване",
  "BUTTON_YES": "Да",
  "BUTTON_NO": "Не",
  ...
  "FIND_IN_FILES_PROJECT_SCOPE": "Намерете в проекта",
  "FIND_IN_FILES_PROJECT_SCOPE_FILTER": "Намерете в {0}",
  ...
  "FIND_IN_FILES_SEARCHING": "Търсене на файлове...",
  ...
  "EXCLUDE_FILE_FILTER": "Изключване на файлове",
  "INCLUDE_FILE_FILTER": "Търсене във файлове",
  "FILTER_PLACEHOLDER": "напр. индекс,.css,*.js,src/**/*.css",
  "FILTER_HISTORY_TOOLTIP": "Натиснете `Ctrl-Space`, за да видите История.",
  "FILTER_HISTORY_TOOLTIP_MAC": "Натиснете `Cmd-Space`, за да видите История.",
  "FIND_HISTORY_TOOLTIP": "Натиснете `Ctrl-Space`, за да видите История.",
  "FIND_HISTORY_TOOLTIP_MAC": "Натиснете `Cmd-Space`, за да видите История.",
  ...
  "KEYBOARD_SHORTCUT_CHANGE_TITLE": "Промяна на клавишната комбинация...",
  "KEYBOARD_SHORTCUT_CHANGE_DIALOG_TITLE": "Промяна на клавишната комбинация",
  "KEYBOARD_SHORTCUT_CHANGE_DIALOG_TEXT": "Натиснете новата клавишна комбинация за <b>„{0}“</b> (Текущо: <b>{1}</b> )",
  "KEYBOARD_SHORTCUT_CHANGE_DIALOG_DUPLICATE": "Предупреждение: Клавишната комбинация <b>{0}</b> вече е присвоена на <b>&#39;{1}&#39;</b> . Превъзлагане на <b>„{2}“</b> ?",
  "KEYBOARD_SHORTCUT_ASSIGN": "Присвояване",
  "KEYBOARD_SHORTCUT_NONE": "Нито един",
  "KEYBOARD_SHORTCUT_MENU_SHOW_SHORTCUTS": "Комбинация от клавиши…",
  "KEYBOARD_SHORTCUT_MENU_SHOW_SHORTCUTS_BUTTON": "Показване на всички преки пътища...",
  "KEYBOARD_SHORTCUT_TABLE_BASE_KEY": "Базов ключ",
  "KEYBOARD_SHORTCUT_TABLE_KEY_BINDING": "Пряк път",
  "KEYBOARD_SHORTCUT_TABLE_COMMAND_ID": "ID на командата",
  "KEYBOARD_SHORTCUT_TABLE_COMMAND_NAME": "командване",
  "KEYBOARD_SHORTCUT_TABLE_DOUBLE_CLICK": "Щракнете двукратно, за да промените прекия път",
  ...
  "KEYBOARD_SHORTCUT_PANEL_FILTER": "Филтър&hellip;",
  ...
  "STATUSBAR_TASKS_HIDE_SPINNER": "Скриване на въртящата се икона",
  "STATUSBAR_TASKS_UNKNOWN_EXTENSION_TASK": "Неизвестна задача за разширение…",
  "STATUSBAR_TASKS_PLAY": "Старт или Възобновяване",
  ...
  "COPY_ERROR": "Проблем с копирането",
  "FIX": "Поправете",
  "CANNOT_FIX_TITLE": "Неуспешно прилагане на корекция",
  "CANNOT_FIX_SOME_TITLE": "Неуспешно прилагане на някои корекции",
  ...
  "CLICK_VIEW_PROBLEM": "Кликнете, за да видите проблема в панела",
  "FILE_MENU": "Файл",
  "CMD_FILE_NEW_UNTITLED": "Нов",
  "CMD_FILE_NEW": "Нов файл",
  "CMD_FILE_DUPLICATE": "Копие на реда",
  "CMD_FILE_DUPLICATE_FILE": "Дублиращ се файл",
  ...
  "CMD_PROJECT_NEW": "Започнете проект...",
  ...
  "CMD_REOPEN_CLOSED": "Отворете отново затворения файл",
  ...
  "CMD_LIVE_FILE_PREVIEW_SETTINGS": "Настройки за преглед на живо",
  ...
  "CMD_AUTO_RENAME_TAGS": "Автоматично преименуване на HTML етикети",
  "FIND_MENU": "Търсене",
  "CMD_FIND": "Търсене",
  "CMD_FIND_NEXT": "Търсене на следващото",
  "CMD_FIND_PREVIOUS": "Търсене на предишното",
  "CMD_FIND_ALL_AND_SELECT": "Изберете Всички срещания",
  "CMD_ADD_NEXT_MATCH": "Добавяне на следващо появяване",
  "CMD_SKIP_CURRENT_MATCH": "Пропускане и добавяне на следващо срещане",
  ...
  "CMD_TOGGLE_INDENT_GUIDES": "Отстъп на водещи линии",
  "CMD_KEYBOARD_NAV_OVERLAY": "Палета за визуални команди",
  ...
  "CMD_GOTO_NEXT_PROBLEM": "Отидете на следващия проблем",
  "CMD_GOTO_PREV_PROBLEM": "Отидете на предишен проблем",
  ...
  "CMD_QUICK_EDIT_NEXT_MATCH": "Следващ елемент за бързо редактиране",
  ...
  "CMD_OPEN_IN_CMD": "Команден ред",
  "CMD_OPEN_IN_POWER_SHELL": "PowerShell",
  "CMD_OPEN_IN_DEFAULT_APP": "Системно приложение по подразбиране",
  "CMD_SWITCH_PANE_FOCUS": "Превключване на фокуса на екрана",
  "CMD_OPEN_VFS": "Отворете виртуална файлова система",
  "CMD_DIAGNOSTIC_TOOLS": "Инструменти за диагностика на {APP_NAME}",
  ...
  "HELP_MENU": "Помощ",
  "CMD_CHECK_FOR_UPDATE": "Провери за актуализации…",
  "CMD_AUTO_UPDATE": "Автоматична актуализация",
  ...
  "CMD_OPEN_KEYMAP": "Отворете файла с карта на потребителските ключове",
  ...
  "UPDATE_FAILED_TITLE": "Неуспешна актуализация",
  "UPDATE_INSTALLING": "Актуализацията се инсталира...",
  ...
  "UPDATE_FAILED_MESSAGE": "Моля, затворете всички прозорци на приложението {APP_NAME} и отворете отново приложението, за да опитате отново актуализацията.<br/> Можете също да инсталирате актуализацията, като изтеглите инсталатора от <a href='https://phcode.io'>phcode.io</a>",
  ...
  "UPDATE_ON_EXIT": "Актуализиране при излизане",
  ...
  "UPDATE_DOWNLOAD_PROGRESS": "Изтегля се - {0} от {1} MB",
  "UPDATING_APP": "{APP_NAME} се актуализира",
  "UPDATING_APP_MESSAGE": "Това може да отнеме известно време",
  "UPDATING_APP_DIALOG_MESSAGE": "В ход е актуализация. Можете да продължите да използвате {APP_NAME}, докато надграждаме.",
  ...
  "EXTENSION_DEFAULT_FEATURE_PRESENT": "Може да не се нуждаете от това разширение. {APP_NAME} вече разполага с тази функция.",
  ...
  "EXTENSION_MANAGER_THEMES_INFO": "За да <a class=\"theme_settings\">изберете теми по подразбиране</a> или да промените други настройки на теми, <a class=\"theme_settings\">щракнете тук</a> .",
  "EXTENSION_MANAGER_THEMES_UNDO": "Връщане към предишната тема",
  ...
  "ERRORS": "Грешки",
  "CMD_SHOW_DEV_TOOLS": "Инструменти за разработчици на {APP_NAME}",
  "CMD_REFRESH_WINDOW": "Презареждане с разширения",
  "CMD_LOAD_CURRENT_EXTENSION": "Зареждане на проекта като разширение",
  "CMD_RELOAD_CURRENT_EXTENSION": "Презаредете проекта като разширение",
  "CMD_UNLOAD_CURRENT_EXTENSION": "Разтоварване на проекта като разширение",
  ...
  "HEALTH_FIRST_POPUP_TITLE": "Съобщение за поверителност",
  "HEALTH_DATA_DO_TRACK": "Споделете анонимна информация за това как използвам {APP_NAME}",
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "{APP_NAME} <strong>не събира и не обработва никаква лична информация</strong> , но <strong>събира анонимни статистически данни за употреба,</strong> за да защити поверителността ви. Анонимните данни са освободени от изискванията за уведомяване на GDPR/CCPA, но ние вярваме, че трябва да имате избор да се откажете и от събирането на анонимни данни.<br><br> Можете да видите вашите данни или <strong>да изберете да не споделяте никакви анонимни данни,</strong> като изберете <strong>Помощ &gt; Здравен отчет</strong> . Тези <strong>анонимни</strong> статистически данни за използването на приложението и отчети за грешки помагат за приоритизиране на функциите, намиране на грешки и откриване на проблеми с използваемостта за подобряване на изживяването ви с {APP_NAME}. Без тези данни не бихме знаели какви функции си струва да изградим за вас!<br><br>",
  "HEALTH_DATA_PREVIEW": "Здравен доклад на {APP_NAME}",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME} <strong>не събира и не обработва никаква лична информация</strong> , но <strong>събира анонимни статистически данни за употреба,</strong> за да защити поверителността ви. Тези <strong>анонимни</strong> статистически данни за използването на приложението и отчети за грешки помагат за приоритизиране на функциите, намиране на грешки и откриване на проблеми с използваемостта за подобряване на изживяването ви с {APP_NAME}.</p><p> По-долу е преглед на данните, които ще бъдат изпратени в следващия ви здравен отчет <em>, ако</em> е активиран. (Също така вижте конзолата за разработчици за регистрационни файлове за грешки, отбелязани с „Уловена критична грешка“.)</p>",
  ...
  "DETECTED_EXCLUSION_INFO": "{APP_NAME} възникна проблем при обработката на <span class='dialog-filename'>{0}</span> .<br><br> Този файл повече няма да се обработва за съвети за код, Преминаване към дефиниция или Бързо редактиране. За да активирате отново този файл, отворете <code>.phcode.json</code> във вашия проект и редактирайте <code>jscodehints.detectedExclusions</code> .<br><br> Това вероятно е грешка в {APP_NAME}. Ако можете да предоставите копие на този файл, моля, <a href='https://github.com/adobe/brackets/wiki/How-to-Report-an-Issue'>подайте сигнал за грешка</a> с връзка към файла, посочен тук.",
  "CMD_REFACTOR": "Рефактор",
  "CMD_EXTRACTTO_VARIABLE": "Извличане към променлива",
  "CMD_EXTRACTTO_FUNCTION": "Извличане във функция",
  "ERROR_TERN_FAILED": "Не могат да се получат данни от Tern",
  "ERROR_EXTRACTTO_VARIABLE_NOT_VALID": "Изборът не формира израз",
  "ERROR_EXTRACTTO_FUNCTION_NOT_VALID": "Избраният блок трябва да представлява набор от изрази или израз",
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "Извличането към променлива не работи в мултикурсори",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "Извличане към функция не работи в мултикурсори",
  ...
  "CMD_REFACTORING_TRY_CATCH": "Увийте в Try Catch",
  "CMD_REFACTORING_CONDITION": "Увийте в състояние",
  "CMD_REFACTORING_GETTERS_SETTERS": "Създайте Getters/Setters",
  "CMD_REFACTORING_ARROW_FUNCTION": "Преобразуване във функция стрелка",
  "DESCRIPTION_CODE_REFACTORING": "Активиране/деактивиране на рефакторинг на JavaScript код",
  "ERROR_TRY_CATCH": "Изберете валиден код, който да обвиете в блок Try-catch",
  "ERROR_WRAP_IN_CONDITION": "Изберете валиден код, който да обвиете в блок Condition",
  "ERROR_ARROW_FUNCTION": "Поставете курсора вътре във функционален израз",
  "ERROR_GETTERS_SETTERS": "Поставете курсора върху член на обектен израз",
  "ERROR_RENAME_MULTICURSOR": "Не може да се преименува при използване на мулти-курсори",
  ...
  "DOCS_MORE_LINK_MDN_TITLE": "Кликнете, за да прочетете документацията",
  ...
  "DISCARD_UNSAVED_FILES_RESTORE": "Изхвърлете",
  ...
  "DESCRIPTION_ESLINT_DO_NPM_INSTALL": "Моля, стартирайте `npm install` на вашия проект, за да активирате ESLint",
  ...
  "DESCRIPTION_LINEWISE_COPY_CUT": "Извършването на копиране и изрязване, когато няма селекция, ще копира или изреже целите редове, в които има курсори",
  ...
  "DESCRIPTION_RULERS_COLUMNS": "Масив от номера на колони за изчертаване на вертикални линийки в редактора. Напр.: [80, 100]",
  "DESCRIPTION_RULERS_COLORS": "Масив от цветове на линийка, съответстващи на опцията за линийки в редактора. Напр.: [\"#3d3d3d\", \"червено\"]",
  ...
  "DESCRIPTION_SELECTION_VIEW_ENABLED": "true, за да активирате изгледа за избор",
  "DESCRIPTION_EXTENSION_LESS_IMAGE_PREVIEW": "Задайте true за показване на изображения за адресите с лепсващи разширения",
  "DESCRIPTION_NUMBER_QUICK_VIEW": "true за показване на бърз изглед при задържане на курсора на мишката върху числа в редактора",
  ...
  "DESCRIPTION_EDITOR_LINE_HEIGHT": "Регулирайте вертикалното разстояние между редовете на кода в редактора. Изберете стойност между 1 и 3, по подразбиране е 1,5",
  ...
  "DESCRIPTION_DESKTOP_ZOOM_SCALE": "Изберете коефициент на мащабиране в диапазона от 0,1 (за по-компактен изглед) до 2 (за по-голям, по-увеличен изглед). Предлага се само в настолни приложения",
  ...
  "DESCRIPTION_LIVEDEV_MAIN_HEADING": "Ъъъ О!<br> Текущият ви браузър не поддържа визуализация на живо.",
  "DESCRIPTION_LIVEDEV_MAIN_SPAN": "Получете най-доброто изживяване за визуализация на живо, като изтеглите нашите собствени приложения за Windows, Mac и Linux от <a href=\"https://phcode.io\" style=\"color: white\">phcode.io</a> .<br>",
  "DESCRIPTION_LIVEDEV_SECURITY_POPOUT_MESSAGE": "На път сте да отворите файл за преглед на живо. Моля, продължете само ако имате доверие на източника на този проект. Кликнете върху „Доверете се на проекта“, за да продължите, или затворете този прозорец, ако нямате доверие на източника.",
  "DESCRIPTION_LIVEDEV_SECURITY_TRUST_MESSAGE": "На път сте да отворите файл за преглед на живо. Моля, продължете, като щракнете върху „Доверете се на проекта“, само ако имате доверие на източника на този проект!",
  "CONFIRM_EXTERNAL_BROWSER_TITLE": "Изскачащите прозорци са блокирани",
  "CONFIRM_EXTERNAL_BROWSER_MESSAGE": "Искате ли да разрешите на страницата за визуализация на живо да отваря този URL адрес: {0}?",
  "TRUST_PROJECT": "Доверете се и изпълнете предварителен преглед – {0}",
  "TRUST_AUTHORS": "Имате ли доверие на авторите на този проект?",
  ...
  "VALIDATION_FAILED": "Проверката е неуспешна!",
  "INITIALISATION_FAILED": "Неуспешна инициализация!",
  "CLEANUP_FAILED": "Почистването не бе успешно!",
  "WARNING_TYPE": "Внимание!",
  "CLICK_RESTART_TO_UPDATE": "Щракнете върху Рестартиране, за да актуализирате скоби.",
  "UPDATE_ON_NEXT_LAUNCH": "Актуализацията ще бъде приложена при повторно стартиране.",
  ...
  "UPDATEDIR_READ_FAILED": "Актуализационната директория не може да бъде прочетена.",
  "UPDATEDIR_CLEAN_FAILED": "Актуализационната директория не можа да бъде почистена.",
  "INITIAL_DOWNLOAD": "Актуализацията се изтегля...",
  "RETRY_DOWNLOAD": "Изтеглянето се провали. Повторен опит... Опит",
  ...
  "RESTART_BUTTON": "Рестартирам",
  "LATER_BUTTON": "По късно",
  "DESCRIPTION_AUTO_UPDATE": "Активирайте/деактивирайте автоматичното актуализиране на {APP_NAME}",
  "AUTOUPDATE_ERROR": "грешка!",
  "AUTOUPDATE_IN_PROGRESS": "Актуализацията вече е в ход.",
  "NUMBER_WITH_PERCENTAGE": "{0}%",
  "CMD_FIND_RELATED_FILES": "Намерете свързани файлове",
  "PHP_VERSION_INVALID": "Грешка при анализа на PHP версията. Моля, проверете резултата от командата “php –version”.",
  "PHP_UNSUPPORTED_VERSION": "Инсталирайте среда за изпълнение на PHP7 за активиране на инструменти, свързани с PHP, като съвети за код, съвети за параметри, прескачане към дефиниция и други. Намерена версия: {0}",
  "PHP_EXECUTABLE_NOT_FOUND": "PHP среда за изпълнение не е намерена. Инсталирайте PHP7 runtime и актуализирайте „executablePath“ в PHP Preferences по подходящ начин. Това позволява инструменти, свързани с PHP, като съвети за код, съвети за параметри, прескачане към дефиниция и други.",
  "PHP_PROCESS_SPAWN_ERROR": "Открит е код на грешка {0} при стартиране на PHP процеса.",
  "PHP_SERVER_ERROR_TITLE": "Грешка",
  "PHP_SERVER_MEMORY_LIMIT_INVALID": "Предоставеното от вас ограничение на паметта е невалидно. Прегледайте PHP предпочитанията, за да зададете правилната стойност.",
  "DESCRIPTION_PHP_TOOLING_CONFIGURATION": "Настройки за конфигурация по подразбиране на PHP Tooling",
  "OPEN_PREFERENNCES": "Отворете Предпочитания",
  "LANGUAGE_TOOLS_PREFERENCES": "Предпочитания за езикови инструменти",
  "FIND_ALL_REFERENCES": "Намерете всички препратки",
  "REFERENCES_IN_FILES": "препратки",
  "REFERENCE_IN_FILES": "справка",
  "REFERENCES_NO_RESULTS": "Няма налични препратки за текущата позиция на курсора",
  "CMD_FIND_DOCUMENT_SYMBOLS": "Намерете символи на документи",
  "CMD_FIND_PROJECT_SYMBOLS": "Намерете символи на проекта",
  "REMOTE_DEBUGGING_ENABLED": "Отдалеченото отстраняване на грешки е активирано на localhost:",
  "REMOTE_DEBUGGING_PORT_INVALID": "Не може да се активира отдалечено отстраняване на грешки на порт {0}. Номерата на портовете трябва да са между {1} и {2}.",
  "DESCRIPTION_EXTERNAL_APPLICATION_ASSOCIATE": "Съпоставяне за файлово разширение към външни приложения. Синтаксис: \"<file_type>\": \"<default|applicationName|ApplicationPath>\", Използвайте \"default\", за да отваряте файлове в системно приложение по подразбиране за типа файл.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "Отваряне на графични файлове във външни редактори.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "Текущата ви папка съдържа типове графични файлове, които не се поддържат от {APP_NAME}.<br/> Вече можете да свързвате конкретни типове файлове с външни редактори. Веднъж свързани, можете да отваряте графични файлове като .xd, .psd, .jpg, .png, .ai, .svg в техните приложения по подразбиране, като щракнете двукратно върху файловете в дървото на файловете.<br/><br/> Моля, щракнете върху бутона „ОК“, за да свържете типовете графични файлове със съответните им приложения по подразбиране.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Следните типове файлове са успешно свързани с приложения по подразбиране.<br/> {0} Имате опцията да промените предпочитанията си дали да изтриете/добавите нови асоциации на типове файлове в phcode.json, като отидете в менюто „Debug-&gt;Open Preferences File“.",
  "UNSUPPORTED_BROWSER_TITLE": "Браузърът не се поддържа",
  "UNSUPPORTED_BROWSER_MESSAGE": "Моля, използвайте модерен браузър (пускан през последните 3 години).",
  "UNSUPPORTED_BROWSER_MOBILE_TITLE": "Мобилните браузъри не се поддържат",
  "UNSUPPORTED_BROWSER_MOBILE": "Понастоящем браузърите за мобилни устройства и таблети не се поддържат напълно. Можете да затворите този диалог, но някои функции във Phoenix няма да работят в този браузър.<br/><br/> Работим върху разработването на собствени приложения за iOS и Android. <a href=\"https://github.com/phcode-dev/phoenix/discussions/1046\" target=\"_blank\">Включете се в дискусията тук!</a>",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER_TITLE": "Достъпът до локална папка не се поддържа от браузъра",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "За съжаление изглежда, че текущият ви браузър не поддържа отваряне на локални папки. За тази функция препоръчваме да използвате Chrome, Edge или Opera.<br/><br/> Като алтернатива работим върху разработването на собствени приложения за Windows, Mac, Linux, iOS и Android, за да осигурим пълна поддръжка. <a href=\"https://github.com/phcode-dev/phoenix/discussions/1047\" target=\"_blank\">Очаквайте актуализации!</a>",
  "ATTENTION_SAFARI_USERS": "На вниманието на потребителите на Safari",
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>Safari автоматично изтрива данните за уебсайта, ако сайтът не бъде посетен повторно в рамките на 7 дни. {APP_NAME} разчита на хранилище на браузъра, за да запази вашите проекти, които може да бъдат премахнати поради това правило.<br/><br/> Препоръчително е да <strong>изтеглите настолното приложение за macOS</strong> от <a href='https://phcode.io' target='_blank' style='color: white'>https://phcode.io</a></span>",
  ...
  "SHARE_WEBSITE": "Публикуване и споделяне на уебсайт?",
  "PUBLISH": "Публикувай",
  "PUBLISH_CONSENT_MESSAGE": "Бързо прегледайте промените и споделете уебсайта си с други. {APP_NAME} може да публикува този уебсайт вместо вас на адрес {0}. Публикуваните линкове ще бъдат валидни за период от 3 дни. </br>Искате ли да публикувате и споделите уебсайта си?",
  "PUBLISH_SYNC_IN_PROGRESS": "Извършва се синхронизиране за визуализация...",
  ...
  "PLEASE_FILL_ALL_REQUIRED": "Моля, попълнете всички задължителни полета, подчертани в червено",
  "CODE_EDITOR": "Редактор на кодове",
  "BUILD_THE_WEB": "Изградете мрежата",
  "IMPORT_PROJECT": "Импортиране на проект",
  "GIT_PROJECT": "Вземете от Git",
  "NEW_PROJECT_FROM_GIT": "Нов проект от Git",
  "GIT_REPO_URL": "Git Repo URL:",
  "GIT_CLONE_URL": "Git URL адрес на клониране:",
  "START_PROJECT": "Започнете проект...",
  "DOWNLOAD_DESKTOP_APP": "Изтеглете приложението за настолен компютър",
  "GET_DESKTOP_APP": "Изтеглете приложението за настолен компютър",
  "CREATE_PROJECT": "Създаване на проект",
  "SETTING_UP_PROJECT": "Настройка на проекта",
  "LOCATION": "местоположение:",
  "ERROR_ONLY_GITHUB": "Версията на браузъра на {APP_NAME} поддържа само URL адреси на GitHub. За да работите с други Git URL адреси, моля, използвайте настолното приложение.",
  "ERROR_GIT_URL_INVALID": "Моля, въведете валиден URL адрес на Git клонинг.",
  "ERROR_GIT_FOLDER_NOT_EMPTY": "Избраната папка не може да се използва за Git клонинг, тъй като не е празна или е нечетима.",
  "ERROR_GIT_FOLDER_NOT_EXIST": "Избраната папка не може да се използва за Git клонинг, тъй като не съществува.",
  "ERROR_CLONING_TITLE": "Неуспешно клониране на Git",
  "DOWNLOADING": "Изтегля се...",
  "DOWNLOADING_FILE": "Изтегля се {0}...",
  "EXTRACTING_FILES_PROGRESS": "Извлича се {0} от {1} файла.",
  "COMPRESS_FILES_PROGRESS": "Компресиране на {0} от {1} файла.",
  "DOWNLOAD_FAILED_MESSAGE": "Уверете се, че URL адресът за изтегляне е валиден. </br>NB: Тъй като Phoenix е безплатен, не се допускат URL адреси на Private Repos и GitHub, по-големи от 25 MB.",
  "PLEASE_SELECT_A_FOLDER": "Моля, изберете папка...",
  "UNZIP_IN_PROGRESS": "Файловете се разархивират...",
  "UNZIP_FAILED": "Грешка: Неуспешно разархивиране.",
  ...
  "LICENSE": "Лиценз и кредити:",
  "PREVIEW": "Преглед",
  "BUILD_WEBSITE": "Изградете уебсайт",
  "VIEW_MORE": "Виж повече...",
  "NEW_PROJECT_NOTIFICATION": "Щракнете върху тази икона, за да отворите отново прозореца `Нов проект`.</br> Вижте Последни проекти, Отваряне на папка или стартирайте проекти от шаблони.</br><img src=\"styles/images/new_project.png\"><br/> <a href='#' style='float:right;'>Добре</a>",
  ...
  "WEBPAGE_BLOG": "Страница в блога",
  "WEBPAGE_DASHBOARD": "HTML табло за управление",
  ...
  "GITHUB_STARS_POPUP": "<div>Вашата подкрепа помага на нашия малък екип, мотивиран да направи <b style='color: darkblue'>phcode.dev</b> още по-добър.<br/> Моля, означете ни със звезда или обмислете да ни спонсорирате в GitHub:",
  "GITHUB_STARS_POPUP_TWITTER": "Дайте обратна връзка или разпространете думата в Twitter:",
  "TEST_TRANSLATE": "използвайте това, за да тествате преводи",
  "BEAUTIFY_ERROR": "Кодът не можа да бъде разкрасен. Проверете синтаксиса.",
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Не може да се разкраси. Текстът на редактора е променен след разкрасяване.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Разкрасяващ файл {0}",
  "BEAUTIFY_ERROR_SELECTION": "Не може да се разкраси.</br>Избран е непълен кодов блок или невалиден синтаксис.",
  "BEAUTIFY_OPTIONS": "Опции, които контролират как работи Beautify Code",
  "BEAUTIFY_OPTION_PRINT_WIDTH": "Посочете дължината на линията, върху която ще се обвие разкрасителят",
  "BEAUTIFY_OPTION_SEMICOLON": "Добавете точка и запетая в края на всеки израз",
  "BEAUTIFY_OPTION_SINGLE_QUOTE": "Използвайте единични кавички вместо двойни кавички",
  "BEAUTIFY_OPTION_QUOTE_PROPS": "Промяна, когато свойствата в обектите са цитирани",
  "BEAUTIFY_OPTION_BRACKET_SAME_LINE": "Поставете > на многоредов HTML (HTML, JSX, Vue, Angular) елемент в края на последния ред, вместо да бъде сам на следващия ред (не се отнася за самозатварящи се елементи)",
  "BEAUTIFY_OPTION_SINGLE_ATTRIBUTE_PER_LINE": "Прилагане на един атрибут на ред в HTML, Vue и JSX",
  ...
  "ENABLE_GIT": "Активирайте Git",
  "ACTION": "Действие",
  "STATUSBAR_SHOW_GIT": "Git панел",
  "ADD_ENDLINE_TO_THE_END_OF_FILE": "Добавете краен ред в края на файла",
  "ADD_TO_GITIGNORE": "Добавяне към .gitignore",
  "AMEND_COMMIT": "Промяна на последния ангажимент",
  "SKIP_COMMIT_CHECKS": "Пропуснете проверките преди ангажиране (--no-verify)",
  "AMEND_COMMIT_FORBIDDEN": "Не може да се промени ангажимент, когато няма неизбутани ангажименти",
  "_ANOTHER_BRANCH": "друг клон",
  "AUTHOR": "Автор",
  "AUTHORS_OF": "Автори на",
  "SYSTEM_CONFIGURATION": "Системна конфигурация",
  "BRACKETS_GIT_ERROR": "Git откри грешка...",
  "BRANCH_NAME": "Име на клон",
  "BUTTON_CANCEL": "Отказ",
  "CHECKOUT_COMMIT": "Плащане",
  "CHECKOUT_COMMIT_DETAIL": "<b>Съобщение за ангажиране:</b> {0}<br> <b>Задаване на хеш:</b> {1}",
  "GIT_CLONE": "Клонинг",
  "BUTTON_CLOSE": "Затваряне",
  "BUTTON_COMMIT": "Ангажирайте се",
  "BUTTON_DEFAULTS": "Възстановяване на настройките по подразбиране",
  "BUTTON_FIND_CONFLICTS": "Открийте конфликти...",
  "GIT_INIT": "Топлина",
  "BUTTON_MERGE_ABORT": "Прекъсване на сливането",
  "BUTTON_OK": "Добре",
  "BUTTON_REBASE_ABORT": "Прекъсване",
  "BUTTON_REBASE_CONTINUE": "Продължете с пребазирането",
  "BUTTON_REBASE_SKIP": "Пропускане",
  "MENU_RESET_HARD": "Отхвърляне на промените и ангажиментите след това (хардуерно нулиране)",
  "MENU_RESET_MIXED": "Отхвърляне на ангажименти след това, но запазване на промените без етап (смесено нулиране)",
  "MENU_RESET_SOFT": "Отхвърлете ангажиментите след това, но запазете промените поетапно (плавно нулиране)",
  "MENU_TAG_COMMIT": "Ангажиране на етикети",
  "RESET_HARD_TITLE": "Потвърдете Hard Reset",
  "RESET_MIXED_TITLE": "Потвърдете смесеното нулиране",
  "RESET_SOFT_TITLE": "Потвърдете Soft Reset",
  "RESET_DETAIL": "<b>Ангажиментите след следното ще бъдат отхвърлени:</b><br> <b>Съобщение за ангажиране:</b> {0}<br> <b>Git команда:</b> {1}",
  "RESET_HARD_MESSAGE": "Това действие ще отхвърли всички промени и ангажименти след избрания комит. <b>Тази операция не може да бъде отменена лесно.</b> Сигурни ли сте, че искате да продължите?<br><br> ⚠️ Предупреждение: Това пренаписва историята и не трябва да се използва при ангажименти, които са били насочени към споделен клон.",
  "RESET_MIXED_MESSAGE": "Това действие ще отхвърли всички ангажименти след избрания комит, но ще запази всички промени неинтегрирани. <b>Тази операция не може да бъде отменена лесно.</b> Сигурни ли сте, че искате да продължите?<br><br> ⚠️ Предупреждение: Това пренаписва историята и не трябва да се използва при ангажименти, които са били насочени към споделен клон.",
  "RESET_SOFT_MESSAGE": "Това действие ще отхвърли всички ангажименти след избрания комит, но ще запази всички промени, подготвени за нов комит. <b>Тази операция не може да бъде отменена лесно.</b> Сигурни ли сте, че искате да продължите?<br><br> ⚠️ Предупреждение: Това пренаписва историята и не трябва да се използва при ангажименти, които са били насочени към споделен клон.",
  ...
  "CHANGE_USER_NAME_TITLE": "Променете git потребителското име",
  "CHANGE_USER_NAME": "Промяна на git потребителско име...",
  "CHANGE_USER_NAME_MENU": "Променете git потребителското име ({0})…",
  ...
  "CLEAN_FILE_START": "Файл за почистване",
  "CLEANING_WHITESPACE_PROGRESS": "Почистване на празно пространство от файлове...",
  "CLEAR_WHITESPACE_ON_FILE_SAVE": "Изчистване на празното пространство при запис на файл",
  "CLONE_REPOSITORY": "Хранилище за клонинги",
  "CODE_INSPECTION_PROBLEMS": "Проблеми с проверката на кода",
  "CODE_INSPECTION_IN_PROGRESS": "Извършва се проверка на кода...",
  "CODE_INSPECTION_PROBLEMS_NONE": "Няма открити проблеми",
  "CODE_INSPECTION_DONE_FILES": "{0} от {1} файла са готови…",
  "PLEASE_WAIT": "моля изчакайте...",
  "COMMIT": "Ангажирайте се",
  "COMMIT_ALL_SHORTCUT": "Ангажирайте всички файлове...",
  "COMMIT_CURRENT_SHORTCUT": "Фиксиране на текущия файл...",
  "COMMIT_MESSAGE_PLACEHOLDER": "Въведете съобщение за ангажиране тук...",
  "CREATE_NEW_BRANCH": "Създаване на нов клон...",
  "CREATE_NEW_BRANCH_TITLE": "Създайте нов клон",
  "CREATE_NEW_GITFTP_SCOPE": "Създайте ново Git-FTP дистанционно...",
  "CREATE_NEW_REMOTE": "Създаване на ново дистанционно...",
  "CURRENT_TRACKING_BRANCH": "Текущ клон за проследяване",
  "_CURRENT_TRACKING_BRANCH": "текущ клон за проследяване",
  "DEFAULT_GIT_TIMEOUT": "Време за изчакване на Git операция по подразбиране (в секунди)",
  "DELETE_FILE_BTN": "Изтриване на файл...",
  "DELETE_LOCAL_BRANCH": "Изтрийте местния клон",
  "DELETE_LOCAL_BRANCH_NAME": "Наистина ли искате да изтриете местния клон „{0}“?",
  "DELETE_REMOTE": "Изтриване на дистанционно",
  "DELETE_REMOTE_NAME": "Наистина ли искате да изтриете отдалечения „{0}“?",
  "DELETE_SCOPE": "Изтриване на Git-FTP обхват",
  "DELETE_SCOPE_NAME": "Наистина ли искате да изтриете обхвата на Git-FTP „{0}“?",
  "DIALOG_CHECKOUT": "При проверка на ангажимент, репото ще премине в състояние DETACHED HEAD. Не можете да правите никакви ангажименти, освен ако не създадете клон въз основа на това.",
  "DIALOG_PULL_TITLE": "Издърпайте от дистанционно",
  "DIALOG_PUSH_TITLE": "Натиснете към дистанционно",
  "SKIP_PRE_PUSH_CHECKS": "Пропускане на предварителни проверки (--no-verify)",
  "DIFF": "разл",
  "DIFFTOOL": "Разлика с difftool",
  "DIFF_FAILED_SEE_FILES": "Git diff не успя да предостави резултати за diff. Това е списъкът на етапните файлове, които трябва да бъдат ангажирани:",
  "DIFF_TOO_LONG": "Разликата е твърде дълга за показване",
  "ENABLE_GERRIT_PUSH_REF": "Използвайте Gerrit-съвместим push ref",
  "ENTER_NEW_USER_EMAIL": "Въведете имейл",
  "ENTER_NEW_USER_NAME": "Въведете потребителско име",
  "ENTER_PASSWORD": "Въведете парола:",
  "ENTER_REMOTE_GIT_URL": "Въведете Git URL на хранилището, което искате да клонирате:",
  "ENTER_REMOTE_NAME": "Въведете името на новото дистанционно:",
  "ENTER_REMOTE_URL": "Въведете URL на новото дистанционно:",
  "ENTER_USERNAME": "Въведете потребителско име:",
  "ERROR_NOTHING_SELECTED": "Нищо не е избрано!",
  "ERROR_SAVE_FIRST": "Първо запазете документа!",
  "ERROR_TERMINAL_NOT_FOUND": "Терминалът не е намерен за вашата операционна система, можете да дефинирате персонализирана команда за терминал в настройките",
  "EXTENDED_COMMIT_MESSAGE": "РАЗШИРЕН",
  "GETTING_STAGED_DIFF_PROGRESS": "Получаване на разлика на етапни файлове...",
  "GIT_COMMIT": "Git ангажимент...",
  "GIT_COMMIT_IN_PROGRESS": "Git Commit се извършва",
  "GIT_DIFF": "Git diff &mdash;",
  "GIT_PULL_RESPONSE": "Git Pull отговор",
  "GIT_PUSH_RESPONSE": "Git Push отговор",
  "GIT_REMOTES": "Git дистанционни",
  "GIT_SETTINGS": "Git настройки...",
  "GIT_SETTINGS_TITLE": "Настройки на Git",
  "GOTO_NEXT_GIT_CHANGE": "Отидете на следващата промяна на Git",
  "GOTO_PREVIOUS_GIT_CHANGE": "Отидете до предишната промяна на Git",
  ...
  "LINES": "линии",
  "_LINES": "линии",
  "MARK_MODIFIED_FILES_IN_TREE": "Маркирайте променени файлове във файловото дърво",
  "MERGE_BRANCH": "Сливане на клон",
  "MERGE_MESSAGE": "Обединяване на съобщение",
  "MERGE_RESULT": "Резултат от сливане",
  "NORMALIZE_LINE_ENDINGS": "Нормализиране на краищата на редове (до \\n)",
  "NOTHING_TO_COMMIT": "Няма нищо за ангажиране, работещата директория е чиста.",
  "OPERATION_IN_PROGRESS_TITLE": "Извършва се Git операция...",
  "ORIGIN_BRANCH": "Произходен клон",
  "ON_BRANCH": "„{0}“ – Текущ клон на Git",
  "PANEL_COMMAND": "Показване на Git панел",
  "PASSWORD": "Парола",
  "PASSWORDS": "Пароли",
  "PATH_TO_GIT_EXECUTABLE": "Път до изпълнимия файл на Git",
  "PULL_AVOID_MERGING": "Избягвайте ръчно обединяване",
  "PULL_DEFAULT": "Обединяване по подразбиране",
  "PULL_FROM": "Издърпайте от",
  "PULL_MERGE_NOCOMMIT": "Обединяване без ангажиране",
  "PULL_REBASE": "Използвайте лисицата",
  "PULL_RESET": "Използвайте меко нулиране",
  "PULL_SHORTCUT": "Издърпайте от дистанционно...",
  "PULL_SHORTCUT_BEHIND": "Издърпайте от дистанционно ({0} отзад)…",
  "PULL_BEHAVIOR": "Поведение при издърпване",
  "FETCH_SHORTCUT": "Извличане от дистанционно",
  "PUSH_DEFAULT": "Натискане по подразбиране",
  "PUSH_DELETE_BRANCH": "Изтриване на отдалечен клон",
  "PUSH_SEND_TAGS": "Изпращане на етикети",
  "PUSH_FORCED": "Принудителен тласък",
  "PUSH_SHORTCUT": "Натискане към дистанционно...",
  "PUSH_SHORTCUT_AHEAD": "Натискане към дистанционно ({0} напред)…",
  "PUSH_TO": "Натиснете до",
  "PUSH_BEHAVIOR": "Поведение при натискане",
  "Q_UNDO_CHANGES": "Нулиране на промените във файл <span class='dialog-filename'>{0}</span> ?",
  "REBASE_RESULT": "Резултат на Фокс",
  "REFRESH_GIT": "Опресняване на Git",
  "REMOVE_BOM": "Премахване на BOM от файлове",
  "REMOVE_FROM_GITIGNORE": "Премахване от .gitignore",
  "RESET_LOCAL_REPO": "Отхвърляне на всички промени от последното ангажиране...",
  "DISCARD_CHANGES": "Отхвърляне на промените",
  "RESET_LOCAL_REPO_CONFIRM": "Искате ли да отхвърлите всички промени, направени от последното ангажиране? Това действие не може да бъде отменено.",
  "UNDO_LOCAL_COMMIT_CONFIRM": "Сигурни ли сте, че искате да отмените последния ненатиснат ангажимент?",
  "MORE_OPTIONS": "Още опции",
  "CREDENTIALS": "пълномощията",
  "SAVE_CREDENTIALS_HELP": "Не е необходимо да попълвате потребителско име/парола, ако вашите идентификационни данни се управляват другаде. Използвайте това само когато операцията продължава да изтича.",
  "SAVE_CREDENTIALS_IN_URL": "Запазете идентификационните данни на отдалечен URL адрес (в обикновен текст)",
  "SET_THIS_BRANCH_AS_TRACKING": "Задайте този клон като нов клон за проследяване",
  "STRIP_WHITESPACE_FROM_COMMITS": "Премахване на крайния интервал от ангажименти",
  "TARGET_BRANCH": "Целеви клон",
  "TITLE_CHECKOUT": "Checkout Commit?",
  "TOOLTIP_CLONE": "Клониране на съществуващо хранилище",
  "TOOLTIP_COMMIT": "Комитирайте избраните файлове",
  "TOOLTIP_FETCH": "Извлечете всички дистанционни управления и броячи за опресняване",
  "TOOLTIP_FIND_CONFLICTS": "Започва търсене на Git merge/rebase конфликти в проекта",
  "TOOLTIP_HIDE_FILE_HISTORY": "Скриване на хронологията на файловете",
  "TOOLTIP_HIDE_HISTORY": "Скриване на историята",
  "TOOLTIP_INIT": "Инициализиране на хранилището",
  "TOOLTIP_MERGE_ABORT": "Прекратете операцията по сливане и нулирайте HEAD до последния локален комит",
  "TOOLTIP_PICK_REMOTE": "Изберете предпочитано дистанционно",
  "TOOLTIP_PULL": "Git Pull",
  "TOOLTIP_PUSH": "Git Push",
  "TOOLTIP_REBASE_ABORT": "Прекратете операцията за повторно базиране и нулирайте HEAD към оригиналния клон",
  "TOOLTIP_REBASE_CONTINUE": "Рестартирайте процеса на пребазиране, след като разрешите конфликт на сливане",
  "TOOLTIP_REBASE_SKIP": "Рестартирайте процеса на пребазиране, като пропуснете текущата корекция",
  "TOOLTIP_REFRESH_PANEL": "Опресняване на панела",
  "TOOLTIP_SHOW_FILE_HISTORY": "Показване на хронология на файла",
  "TOOLTIP_SHOW_HISTORY": "Показване на историята",
  "UNDO_CHANGES": "Отхвърляне на промените",
  "UNDO_CHANGES_BTN": "Отхвърляне на промените...",
  "UNDO_LAST_LOCAL_COMMIT": "Отмяна на последния локален (ненасочен) ангажимент...",
  "UNDO_COMMIT": "Отмяна на ангажимента",
  "URL": "URL адрес",
  "USERNAME": "Потребителско име",
  "USER_ABORTED": "Потребителят е прекратен!",
  "USE_GIT_GUTTER": "Използвайте Git gutter marks",
  "USE_NOFF": "Създайте ангажимент за сливане дори когато сливането се разрешава като превъртане напред (--no-ff)",
  "USE_REBASE": "Използвайте FOX",
  "USE_VERBOSE_DIFF": "Показване на подробен изход в разл",
  "USE_DIFFTOOL": "Използвайте difftool за разл",
  "VIEW_AUTHORS_FILE": "Вижте авторите на файла...",
  "VIEW_AUTHORS_SELECTION": "Вижте авторите на селекцията...",
  "VIEW_THIS_FILE": "Вижте този файл",
  "TAG_NAME_PLACEHOLDER": "Въведете името на етикета тук...",
  "TAG_NAME": "Етикет",
  "CMD_CLOSE_UNMODIFIED": "Затворете непроменени файлове",
  "FILE_ADDED": "Нов файл",
  "FILE_COPIED": "Копирано",
  "FILE_DELETED": "Изтрито",
  "FILE_IGNORED": "Игнорирани",
  "FILE_MODIFIED": "Променен",
  "FILE_RENAMED": "Преименуван",
  "FILE_STAGED": "Постановка",
  "FILE_UNMERGED": "Необединени",
  "FILE_UNMODIFIED": "Непроменен",
  "FILE_UNTRACKED": "Непроследено",
  "GIT_PUSH_SUCCESS_MSG": "Успешно избутано превъртане напред",
  "GIT_PUSH_FORCE_UPDATED_MSG": "Успешна принудителна актуализация",
  "GIT_PUSH_DELETED_MSG": "Успешно изтрит реф",
  "GIT_PUSH_NEW_REF_MSG": "Успешно насочен нов реф",
  "GIT_PUSH_REJECTED_MSG": "Референтът беше отхвърлен или неуспешен",
  "GIT_PUSH_UP_TO_DATE_MSG": "Рефът беше актуален и нямаше нужда от натискане",
  "GIT_PULL_SUCCESS": "Успешно завършено git pull",
  "GIT_MERGE_SUCCESS": "Успешно завършено git сливане",
  "GIT_REBASE_SUCCESS": "Успешно завършена git rebase",
  "GIT_BRANCH_DELETE_SUCCESS": "Успешно изтрит git клон",
  "INIT_NEW_REPO_FAILED": "Неуспешно инициализиране на ново хранилище",
  "GIT_CLONE_REMOTE_FAILED": "Клонирането на отдалечено хранилище не бе успешно!",
  "GIT_CLONE_ERROR_EXPLAIN": "Избраната директория „{0}“.\n не е празен. Git клонингът изисква чиста, празна директория.\nАко изглежда празен, проверете за скрити файлове.",
  "FOLDER_NOT_WRITABLE": "Избраната директория „{0}“.\n не може да се пише.",
  "GIT_NOT_FOUND_MESSAGE": "Git не е инсталиран или не може да бъде намерен във вашата система. Моля, инсталирайте Git или предоставете правилния път до изпълнимия файл на Git в текстовото поле по-долу.",
  "ERROR_GETTING_BRANCH_LIST": "Неуспешно получаване на списък с клонове",
  "ERROR_READING_GIT_HEAD": "Неуспешно четене на .git/HEAD файл",
  "ERROR_PARSING_BRANCH_NAME": "Неуспешно анализиране на име на клон от {0}",
  "ERROR_READING_GIT_STATE": "Неуспешно четене на състояние .git",
  "ERROR_GETTING_DELETED_FILES": "Получаването на списък с изтрити файлове не бе успешно",
  "ERROR_SWITCHING_BRANCHES": "Превключването на клонове не бе успешно",
  "ERROR_GETTING_CURRENT_BRANCH": "Получаването на текущото име на клона не бе успешно",
  "ERROR_REBASE_FAILED": "Неуспешно повторно базиране",
  "ERROR_MERGE_FAILED": "Обединяването не бе успешно",
  "ERROR_BRANCH_DELETE_FORCED": "Принудителното изтриване на клон не бе успешно",
  "ERROR_FETCH_REMOTE_INFO": "Неуспешно извличане на отдалечена информация",
  "ERROR_CREATE_BRANCH": "Създаването на нов клон не бе успешно",
  "ERROR_REFRESH_GUTTER": "Опресняването на улука не бе успешно!",
  "ERROR_GET_HISTORY": "Неуспешно получаване на хронология",
  "ERROR_GET_MORE_HISTORY": "Неуспешно зареждане на още редове с хронология",
  "ERROR_GET_CURRENT_BRANCH": "Неуспешно получаване на текущото име на клон",
  "ERROR_GET_DIFF_FILE_COMMIT": "Неуспешно получаване на разл",
  "ERROR_GET_DIFF_FILES": "Неуспешно зареждане на списък с разл. файлове",
  "ERROR_MODIFY_GITIGNORE": "Неуспешно модифициране на .gitignore",
  "ERROR_UNDO_LAST_COMMIT_FAILED": "Невъзможно отмяна на последния ангажимент",
  "ERROR_MODIFY_FILE_STATUS_FAILED": "Неуспешна промяна на състоянието на файла",
  "ERROR_CHANGE_USERNAME_FAILED": "Невъзможна промяна на потребителското име",
  "ERROR_CHANGE_EMAIL_FAILED": "Невъзможна промяна на потребителския имейл",
  "ERROR_TOGGLE_GERRIT_PUSH_REF_FAILED": "Невъзможно превключване на gerrit push ref",
  "ERROR_RESET_LOCAL_REPO_FAILED": "Неуспешно нулиране на локалното хранилище",
  "ERROR_CREATE_TAG": "Създаването на маркер не бе успешно",
  "ERROR_CODE_INSPECTION_FAILED": "CodeInspection.inspectFile не успя да се изпълни за файл",
  "ERROR_CANT_GET_STAGED_DIFF": "Не може да се получи разлика за етапни файлове",
  "ERROR_GIT_COMMIT_FAILED": "Git Commit не бе успешен",
  "ERROR_GIT_BLAME_FAILED": "Git Blame се провали",
  "ERROR_GIT_DIFF_FAILED": "Git Diff се провали",
  "ERROR_DISCARD_CHANGES_FAILED": "Отхвърлянето на промените във файл не бе успешно",
  "ERROR_COULD_NOT_RESOLVE_FILE": "Файлът не можа да бъде разрешен",
  "ERROR_MERGE_ABORT_FAILED": "Прекъсването на сливането не бе успешно",
  "ERROR_MODIFIED_DIALOG_FILES": "Файловете, които щяхте да ангажирате, бяха променени, докато беше показан диалоговият прозорец за ангажиране. Прекъсването на ангажимента, тъй като резултатът би бил различен от това, което беше показано в диалоговия прозорец.",
  "ERROR_GETTING_REMOTES": "Получаването на дистанционни не бе успешно!",
  "ERROR_REMOTE_CREATION": "Неуспешно отдалечено създаване",
  "ERROR_PUSHING_REMOTE": "Натискането към дистанционно неуспешно",
  "ERROR_PULLING_REMOTE": "Изтеглянето от дистанционното не бе успешно",
  "ERROR_PULLING_OPERATION": "Операцията по изтегляне е неуспешна",
  "ERROR_PUSHING_OPERATION": "Операцията по натискане е неуспешна",
  "ERROR_NO_REMOTE_SELECTED": "Не е избрано дистанционно за {0}!",
  "ERROR_BRANCH_LIST": "Получаването на списък с клонове не бе успешно",
  "ERROR_FETCH_REMOTE": "Неуспешно извличане на отдалечена информация"
});