...
define({
  ...
  "UNSUPPORTED_BROWSER_MOBILE": "Понастоящем мобилните и таблетните устройства не се поддържат напълно. Можете да затворите този диалог, но някои функции във Phoenix няма да работят в този браузър.",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Браузърът не поддържа отворена папка. Моля, използвайте Chrome, Edge или Opera, за да отворите локални папки.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Моля, използвайте един от поддържаните браузъри по-долу.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Работим усилено, за да направим Phoenix достъпен в повече браузъри. Можете да затворите този диалог, но някои функции във Phoenix няма да работят в този браузър.",
