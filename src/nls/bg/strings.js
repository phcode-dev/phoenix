...
define({
  ...
  "UPDATE_CLOSE_TO_UPDATE_TITLE": "Не може да се актуализира",
  "UPDATE_CLOSE_TO_UPDATE": "Отворени са няколко прозореца на редактора. Моля, уверете се, че всички други прозорци на {APP_NAME} Editor са затворени, преди да опитате да актуализирате. Затворете всички допълнителни прозорци на {APP_NAME} и опитайте да актуализирате отново.",
