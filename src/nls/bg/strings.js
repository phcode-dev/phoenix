...
define({
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME} <strong>не събира и не обработва никаква лична информация</strong> , но <strong>събира анонимни статистически данни за употреба,</strong> за да защити поверителността ви. Анонимните данни са освободени от изискванията за уведомяване на GDPR/CCPA, но ние вярваме, че трябва да имате избор да се откажете от събирането на анонимни данни.<br> Тези <strong>анонимни</strong> статистически данни за използването на приложението и отчети за грешки помагат за приоритизиране на функциите, намиране на грешки и откриване на проблеми с използваемостта за вашия опит с {APP_NAME}.</p><p> По-долу е преглед на данните, които ще бъдат изпратени в следващия ви здравен отчет <em>, ако</em> е активиран. (Също така вижте конзолата за разработчици за регистрационни файлове за грешки, отбелязани с „Уловена критична грешка“.)</p>",
  ...
  "NEW_PROJECT_NOTIFICATION": "Щракнете върху тази икона, за да създадете нов проект.</br><img src=\"styles/images/new_project.png\"><br/> <a href='#' style='float:right;'>Добре</a>",
  ...
  "POWER_USER_POPUP_TITLE": "Как можем да направим {APP_NAME} по-добро за вас?",
  "POWER_USER_POPUP_TEXT": "<div>Ще се радваме да получим вашите отзиви. Вашата обратна връзка ни помага да решим кои функции да изградим и какви подобрения трябва да бъдат направени в нашата платформа.<br/> <a>Моля, попълнете тази кратка анкета.</a></div>",
