...
define({
  ...
  "IMAGE_SEARCH_MONTHLY_LIMIT_MESSAGE": "Използвали сте всички {0} търсения на изображения за този месец.<br>Стартирайте платен план на Phoenix Pro, за да премахнете ограниченията на пробния период и да продължите да търсите."
});