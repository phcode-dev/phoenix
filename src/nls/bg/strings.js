...
define({
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "За да подобрим {APP_NAME}, ние периодично изпращаме ограничени, <strong>псевдонимни</strong> статистически данни и доклади за грешки до phcode.dev за това как използвате {APP_NAME}. Тази информация помага за приоритизиране на функциите, намиране на грешки и откриване на проблеми с използваемостта, като същевременно защитава поверителността ви.<br><br> Можете да видите вашите данни или да изберете да не споделяте данни, като изберете <strong>Помощ &gt; Здравен отчет</strong> .<br><br>",
  "HEALTH_DATA_PREVIEW": "Здравен доклад на {APP_NAME}",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>За да подобрим {APP_NAME}, ние периодично изпращаме ограничени, <strong>псевдонимни</strong> статистически данни и доклади за грешки до phcode.dev за това как използвате {APP_NAME}. Тази информация помага за приоритизиране на функциите, намиране на грешки и откриване на проблеми с използваемостта.</p><p> По-долу е преглед на данните, които ще бъдат изпратени в следващия ви здравен отчет, <em>ако</em> е активиран. (Също така вижте конзолата за разработчици за регистрационни файлове за грешки, отбелязани с „Уловена критична грешка“.)</p>",
