...
define({
  ...
  "LIVE_DEV_SETTINGS_FRAMEWORK_UNKNOWN": "Неизвестен",
  ...
  "DEFAULT_PROJECT_HTML_CLICK_HERE": "Щракнете тук, за да отворите този HTML файл в редактора. Курсорът ще бъде насочен към код, съответстващ на този &ltspan&gt",
