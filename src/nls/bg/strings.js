...
define({
  ...
  "UPDATE_READY_RESTART_MESSAGE": "Затворете всички прозорци на {APP_NAME} и рестартирайте приложението, за да стартирате актуализираната версия.",
  "UPDATE_FAILED_TITLE": "Неуспешна актуализация",
  "UPDATE_FAILED_MESSAGE": "Моля, затворете всички прозорци на {APP_NAME} и отворете отново приложението, за да опитате отново актуализацията.",
  ...
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>Safari автоматично изтрива данните за уебсайта, ако сайтът не бъде посетен повторно в рамките на 7 дни. {APP_NAME} разчита на хранилище на браузъра, за да запази вашите проекти, които може да бъдат премахнати поради това правило.<br/><br/> <strong>За да предотвратите загуба на данни</strong> , моля, <strong>изтеглете</strong> проектите си, преди да затворите раздела, или следете за <strong>предстоящите ни уеб приложения и приложения за Mac/iOS</strong> .</span>",
