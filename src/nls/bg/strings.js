...
define({
  ...
  "WEBPAGE_HOME_PAGE": "Оформления на началната страница",
  "WEBPAGE_BLOG": "Страница в блога",
  "WEBPAGE_DASHBOARD": "HTML табло за управление",
  "WEBPAGE_BOOTSTRAP_EXAMPLES": "Примери за стартиране",
  "GUIDED_FILES_SIDEBAR": "Изберете HTML файл</br> <a href='#' style='float:right;'>Добре</a>",
  "GUIDED_LIVE_PREVIEW": "Направете някои промени в кода и запазете файла, за да видите визуализация.</br> <a href='#' style='float:right;'>Добре</a>",
