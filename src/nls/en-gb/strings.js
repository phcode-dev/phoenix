...
define({
  ...
  "LIVE_DEV_STYLER_CAPITALIZE": "Capitalise",
  "LIVE_DEV_STYLER_ALIGN_LEFT": "Align left",
  "LIVE_DEV_STYLER_ALIGN_CENTER": "Align centre",
  ...
  "LIVE_DEV_STYLER_REMOVE_BACKGROUND": "Remove background colour",
  ...
  "LIVE_DEV_STYLER_COLOR_GRAY": "Grey",
  ...
  "LIVE_DEV_STYLER_BORDER_COLOR": "Border colour",
  "LIVE_DEV_STYLER_OUTLINE_COLOR": "Outline colour",
  ...
  "LIVE_DEV_STYLER_EYEDROPPER": "Pick colour from page",
  ...
  "LIVE_DEV_STYLES_FILTER_COLOR": "Colour",
  ...
  "LIVE_DEV_CB_TIP_TEXT_COLOR": "Text Colour",
  "LIVE_DEV_CB_TIP_BG_COLOR": "Background Colour",
  ...
  "LIVE_DEV_CB_LABEL_COLOR": "Colour",
  ...
  "LIVE_DEV_HB_COLOR_INPUT": "Colour Picker",
  ...
  "DESCRIPTION_SHOW_CODE_HINT_DOCS": "false to hide the documentation pop-up shown beside code hints",
  "DESCRIPTION_SHOW_PARAMETER_HINTS": "false to disable the parameter hint pop-up shown when typing inside a function call",
  ...
  "DESCRIPTION_LIVEDEV_MAIN_HEADING": "Oh dear! Your current browser doesn't support live preview.",
  ...
  "CODE_INTEL_CFG_AUTO_TYPES_INFO": "Code hints for npm packages start working even before you run npm install. Requires npm and an internet connection; downloads are cached outside your project.",
  "CODE_INTEL_CFG_AUTO_MANAGE": "Managed by {APP_NAME}",
  "CODE_INTEL_CFG_AUTO_MANAGE_SUB": "Keeps this file updated automatically",
  "CODE_INTEL_CFG_AUTO_MANAGE_INFO": "{APP_NAME} keeps this file tuned so code intelligence just works. Turn off to customise the file yourself — {APP_NAME} will then never modify it.",
  ...
  "CODE_INTEL_CFG_MODULE_NODENEXT": "Node's strict ESM rules — required file extensions, honours package.json \"type\"",
  ...
  "BOTTOM_PANEL_MINIMIZE": "Minimise Panel",
  ...
  "BOTTOM_PANEL_MAXIMIZE": "Maximise Panel",
  ...
  "PROMO_PRO_WHATS_NEW_MESSAGE": "Thank you for supporting {0}. Here’s what’s new in this update:",
  ...
  "PROMO_CARD_5_MESSAGE": "Change fonts, colours, borders, spacing, and layout right in the Live Preview, and your CSS updates in real time.",
  ...
  "MANAGE_LICENSE_DIALOG_TITLE": "Manage Licences",
  "LICENSE_ACCOUNT_HEADING": "Account Licence",
  "LICENSE_DEVICE_HEADING": "Device Licence",
  ...
  "LICENSE_KEY_PROMPT": "Have a device licence key?",
  ...
  "LICENSE_REACTIVATE": "Reactivate Licence",
  "LICENSE_DEACTIVATE": "Deactivate",
  "LICENSE_DEACTIVATING": "Deactivating…",
  "LICENSE_DEACTIVATE_SUCCESS": "Licence deactivated on this device. Please restart {APP_NAME} for the changes to take effect.",
  "LICENSE_DEACTIVATE_FAIL": "Failed to deactivate licence on this device",
  "LICENSE_NOT_ACTIVATED_HERE": "This licence isn't activated on this device — Phoenix Pro features won't be enabled until you click Reactivate Licence.",
  ...
  "AI_DISABLE_CONFIRM_MESSAGE": "This switches off all AI features. The AI panel will be removed and {APP_NAME} will stop connecting to AI services.<br><br>{APP_NAME} will restart now to apply this change. You will be asked to save any unsaved files.",
  "AI_DISABLE_CONFIRM_BTN": "Disable AI and Restart",
  "AI_ENABLE_CONFIRM_TITLE": "Enable AI?",
  "AI_ENABLE_CONFIRM_MESSAGE": "This switches the AI features back on and restores the AI panel.<br><br>{APP_NAME} will restart now to apply this change. You will be asked to save any unsaved files.",
  ...
  "AI_CHAT_CLAUDE_LOGIN_TITLE": "Set up Claude Code",
  "AI_CHAT_CLAUDE_LOGIN_MSG": "Claude Code is installed but needs to be configured.",
  "AI_CHAT_CLAUDE_LOGIN_BTN": "Set up Claude Code",
  ...
  "AI_CHAT_QUOTA_DAILY_EXHAUSTED": "You've used all {0} of your daily chats. This resets tomorrow.",
  "AI_CHAT_QUOTA_MONTHLY_EXHAUSTED": "You've used all {0} of your monthly chats.",
  ...
  "AI_SETTINGS_ENABLE_AI_NOTE": "Switches all AI features in {APP_NAME} on or off. Changing this restarts {APP_NAME} to apply it — you can enable it again any time from <span class='ai-settings-menu-path'>View menu &gt; Enable AI</span>.",
  ...
  "DEMO_CARD_SELECT_PARENT_TIP": "Click the <img src=\"images/arrowUp.svg\" alt=\"Up\" class=\"inline-icon\">&nbsp;icon in the toolbar above to select the parent card.",
  ...
  "DEMO_SECTION4_HINT_STEP2_DUPLICATE": "Use the <img src=\"images/duplicate.svg\" alt=\"Duplicate\" class=\"inline-icon\"> button or press <strong><span id=\"duplicate-shortcut\"></span></strong> to duplicate cards until you have 3 in total",
  ...
  "MIGRATE_INTERRUPTED_TITLE": "Migration interrupted",
  "MIGRATE_INTERRUPTED_MESSAGE": "The connection to {0} was lost part-way through. Anything already copied has been kept. You can resume the migration at any time from the Help menu.",
  "MIGRATE_INTERRUPTED_FINAL": "The connection to {0} was lost again. Anything already copied has been kept. To complete the migration, choose {1}."
});