...
define({
  ...
  "LIVE_DEV_SETTINGS_ELEMENT_HIGHLIGHT_PREFERENCE": "Show live preview element highlighting on 'hover' or 'click'. Defaults to 'hover'.",
  ...
  "LIVE_DEV_IMAGE_FOLDER_DIALOG_HELP": "💡 Type a folder path or leave empty to download to the project root",
