...
define({
  ...
  "AI_CHAT_CLI_INSTALL_MSG": "{APP_NAME}에서 AI 기능을 사용하려면 시스템에 Claude Code CLI가 설치되어 있어야 합니다. <a class='ai-learn-more-link' href='#'>자세히 알아보기</a>",
  ...
  "AI_CHAT_CLAUDE_LOGIN_MSG": "Claude Code가 설치되었지만 구성이 필요합니다. <a class='ai-learn-more-link' href='#'>더 알아보기</a>",
  "AI_CHAT_CLAUDE_LOGIN_BTN": "Claude Code 설정",
  "AI_CHAT_ADD_PROVIDER_BTN": "사용자 지정 공급자 추가",
  "AI_CHAT_TOOL_PLANNING": "계획",
  "AI_CHAT_PLAN_TITLE": "제안된 계획",
  "AI_CHAT_PLAN_APPROVE": "승인",
  "AI_CHAT_PLAN_REVISE": "수정",
  "AI_CHAT_PLAN_FEEDBACK_PLACEHOLDER": "어떤 점을 변경하시겠어요?"
});