...
define({
  ...
  "AI_CHAT_PLAN_CLOSE_FULLSCREEN": "닫기 (Esc)",
  ...
  "AI_CHAT_PLAN_WRITE_CONFIRM_TITLE": "편집 모드로 전환하시겠습니까?",
  "AI_CHAT_PLAN_WRITE_CONFIRM_BODY": "클로드가 {0}을(를) 편집하려고 합니다. 현재 계획 모드입니다.",
  "AI_CHAT_PLAN_WRITE_ALLOW": "허용 및 편집 모드로 전환",
  "AI_CHAT_PLAN_WRITE_STAY": "계획 모드 유지",
  "AI_CHAT_PLAN_WRITE_ALLOWED": "편집 모드로 전환되었습니다",
