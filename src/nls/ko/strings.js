...
define({
  ...
  "ENCODE_FILE_FAILED_ERR": "{APP_NAME} 이 (가) 파일의 내용을 인코딩할 수 없습니다.",
  "DECODE_FILE_FAILED_ERR": "{APP_NAME} 이 (가) 파일의 내용을 디코딩할 수 없습니다.",
  "UNSUPPORTED_UTF16_ENCODING_ERR": "{APP_NAME} 은 (는) 현재 UTF-16 인코딩 텍스트 파일을 지원하지 않습니다.",
  ...
  "ERROR_RENAMING_NOT_IN_PROJECT": "파일 또는 디렉토리가 현재 열려 있는 프로젝트의 일부가 아닙니다.아쉽게도 지금은 프로젝트 파일만 이름을 바꿀 수 있습니다.",
  "ERROR_MOVING_FILE_TITLE": "{0} 이동 중 오류",
  ...
  "LIVE_DEV_SELECT_FILE_TO_PREVIEW": "[실시간 미리 보기] 를 선택합니다",
  "LIVE_DEV_CLICK_TO_RELOAD_PAGE": "페이지 다시 로드",
  "LIVE_DEV_CLICK_POPOUT": "새 창으로 실시간 미리보기 팝아웃",
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "고정 해제 미리보기 페이지에 고정",
  ...
  "WINDOW_UNLOAD_WARNING": "다른 URL로 이동하여 대괄호를 남기시겠습니까?",
  "WINDOW_UNLOAD_WARNING_WITH_UNSAVED_CHANGES": "변경 사항을 저장하지 않았습니다!다른 URL로 이동하여 대괄호를 남기시겠습니까?",
  "DONE": "완료",
  "OK": "확인",
  "CANCEL": "취소",
  "DONT_SAVE": "저장하지 않음",
  ...
  "STATUSBAR_ENCODING_TOOLTIP": "인코딩을 선택합니다.",
  ...
  "CMD_SWITCH_PANE_FOCUS": "스위치 창 포커스",
  "CMD_OPEN_VFS": "오픈 가상 파일 시스템",
  "CMD_OPEN_VIRTUAL_SERVER": "오픈 가상 서버",
  "HELP_MENU": "도움말",
  ...
  "ABOUT": "이 소프트웨어에 대하여",
  "CLOSE": "닫기",
  "ABOUT_TEXT_LINE1": "릴리스 {버전_메이저}.{버전_마이너} {빌드_타입} {버전}",
  "ABOUT_TEXT_BUILD_TIMESTAMP": "빌드 타임스탬프: ",
  "ABOUT_TEXT_LINE3": "당사가 사용하는 제3자 라이브러리 - <a href='https://github.com/phcode-dev/phoenix/tree/main/src/thirdparty/licences'>라이선스 및 저작자 표시</a>. ",
  "ABOUT_TEXT_LINE4": "<a href='https://github.com/phcode-dev/phoenix/'>https://github.com/phcode-dev/phoenix/ 의 문서 및 출처</a>",
  "ABOUT_TEXT_LINE5": "❤ 및 자바스크립트로 만든 작성자:",
  "ABOUT_TEXT_LINE6": "많은 사람들 (하지만 지금은 해당 데이터를 로드하는 데 문제가 있습니다).",
  ...
  "SORT_EXTENSION_METHOD": "다운로드 횟수 또는 게시된 날짜를 사용하여 확장 프로그램 정렬",
  "INVALID_ZIP_FILE": "다운로드 한 콘텐츠가 유효한 zip 파일이 아닙니다.",
  "MISSING_PACKAGE_JSON": "패키지에 패키지.json 파일이 없습니다.",
  ...
  "EXTENSIONS_LAST_UPDATED": "최종 업데이트",
  ...
  "ERROR_EXTRACTTO_VARIABLE_NOT_VALID": "선택이 표현식을 형성하지 않음",
  "ERROR_EXTRACTTO_FUNCTION_NOT_VALID": "선택한 블록은 명령문 집합 또는 표현식을 나타내야 합니다.",
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "다중 커서에서 변수로 추출이 작동하지 않음",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "다중 커서에서 함수로 추출이 작동하지 않음",
  "EXTRACTTO_FUNCTION_SELECT_SCOPE": "대상 범위 선택",
  "EXTRACTTO_VARIABLE_SELECT_EXPRESSION": "표현식을 선택합니다.",
  "CMD_REFACTORING_RENAME": "파일명 변경",
  "CMD_REFACTORING_TRY_CATCH": "랩 인 트라이 캐치",
  "CMD_REFACTORING_CONDITION": "랩 인 조건",
  "CMD_REFACTORING_GETTERS_SETTERS": "게터/세터 생성",
  "CMD_REFACTORING_ARROW_FUNCTION": "화살표 함수로 변환",
  "DESCRIPTION_CODE_REFACTORING": "자바스크립트 코드 리팩토링 활성화/비활성화",
  "ERROR_TRY_CATCH": "try-catch 블록에서 래핑할 유효한 코드 선택",
  "ERROR_WRAP_IN_CONDITION": "조건 블록에서 래핑할 유효한 코드 선택",
  "ERROR_ARROW_FUNCTION": "함수 표현식 안에 커서를 놓습니다.",
  "ERROR_GETTERS_SETTERS": "객체 표현식의 멤버에 커서를 놓습니다.",
  "ERROR_RENAME_MULTICURSOR": "다중 커서를 사용할 때 이름을 바꿀 수 없음",
  "ERROR_RENAME_QUICKEDIT": "이 식별자는 이 함수 외부의 다른 곳에서 참조되므로 이름을 바꿀 수 없습니다.",
  "ERROR_RENAME_GENERAL": "선택한 텍스트의 이름을 바꿀 수 없음",
  "JSHINT_NAME": "신트",
  ...
  "RECENT_FILES_DLG_CLEAR_BUTTON_LABEL": "클리어",
  ...
  "DESCRIPTION_DISABLED_DEFAULT_EXTENSIONS": "사용하지 않도록 설정된 기본 확장",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "JSHint에 대한 기본 옵션이 있는 객체입니다.사용 가능한 모든 JSHint 옵션은 다음 URL을 참조하십시오. https://jshint.com/docs/options/",
  ...
  "DESCRIPTION_LINEWISE_COPY_CUT": "선택 영역이 없을 때 복사 및 잘라내기를 수행하면 커서가 있는 전체 줄이 복사되거나 잘립니다.",
  "DESCRIPTION_INPUT_STYLE": "CodeMirror가 입력과 포커스를 처리하는 방식을 선택합니다.기본값인 텍스트 영역이거나 화면 판독기에 더 적합한 콘텐츠 편집 가능 (불안정) 일 수 있습니다.",
  ...
  "DESCRIPTION_SEARCH_AUTOHIDE": "편집기에 포커스가 맞춰지면 바로 검색을 닫습니다.",
  ...
  "DESCRIPTION_SELECTION_VIEW_ENABLED": "true - 선택 보기를 활성화합니다.",
  ...
  "DESCRIPTION_INDENT_LINE_COMMENT": "true - 줄 주석 들여쓰기를 활성화합니다.",
  "DESCRIPTION_RECENT_FILES_NAV": "최근 파일에서 탐색 활성화/비활성화",
  "DESCRIPTION_LIVEDEV_WEBSOCKET_PORT": "실시간 미리 보기용으로 웹소켓 서버가 실행되는 포트",
  "DESCRIPTION_LIVE_DEV_HIGHLIGHT_SETTINGS": "실시간 미리 보기 하이라이트 설정",
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "실시간 미리 보기 역방향 검사를 비활성화하려면 false",
  "DOWNLOAD_FAILED": "다운로드에 실패했습니다.",
  "DOWNLOAD_COMPLETE": "다운로드 완료!",
  "UPDATE_SUCCESSFUL": "업데이트에 성공했습니다!",
  "UPDATE_FAILED": "업데이트 실패!",
  "VALIDATION_FAILED": "유효성 검사에 실패했습니다!",
  "INITIALISATION_FAILED": "초기화에 실패했습니다!",
  "CLEANUP_FAILED": "정리에 실패했습니다!",
  "WARNING_TYPE": "경고!",
  "CLICK_RESTART_TO_UPDATE": "다시 시작을 클릭하여 대괄호를 업데이트합니다.",
  "UPDATE_ON_NEXT_LAUNCH": "업데이트는 다시 시작할 때 적용됩니다.",
  "GO_TO_SITE": "<a href = \"http://brackets.io/ “> 브래킷.io로 이동하여</a> 다시 시도하십시오.",
  ...
  "RETRY_DOWNLOAD": "다운로드에 실패했습니다.재시도 중... 시도 ",
  "VALIDATING_INSTALLER": "다운로드 완료!설치 프로그램을 검증하는 중...",
  "CHECKSUM_DID_NOT_MATCH": "체크섬이 일치하지 않았습니다.",
  "INSTALLER_NOT_FOUND": "설치 프로그램을 찾을 수 없습니다.",
  "DOWNLOAD_ERROR": "다운로드 중 오류가 발생했습니다.",
  "NETWORK_SLOW_OR_DISCONNECTED": "네트워크 연결이 끊기거나 너무 느립니다.",
  "RESTART_BUTTON": "재시작",
  "LATER_BUTTON": "나중에",
  "DESCRIPTION_AUTO_UPDATE": "브래킷 사용/사용 안 함 자동 업데이트",
  "AUTOUPDATE_ERROR": "오류!",
  "AUTOUPDATE_IN_PROGRESS": "업데이트가 이미 진행 중입니다.",
  "NUMBER_WITH_PERCENTAGE": "{0}%",
  "CMD_FIND_RELATED_FILES": "관련 파일 찾기",
  "PHP_VERSION_INVALID": "PHP 버전을 구문 분석하는 중 오류가 발생했습니다.“php —version” 명령의 출력을 확인하십시오.",
  "PHP_UNSUPPORTED_VERSION": "코드 힌트, 매개 변수 힌트, 정의로 이동 등과 같은 PHP 관련 도구를 활성화하기 위해 PHP7 런타임을 설치하십시오.찾은 버전: {0}",
  "PHP_EXECUTABLE_NOT_FOUND": "PHP 런타임을 찾을 수 없습니다.PHP7 런타임을 설치하고 PHP 환경 설정에서 “실행 가능한 경로”를 적절하게 업데이트하십시오.이를 통해 코드 힌트, 파라미터 힌트, 정의로 이동 등과 같은 PHP 관련 도구를 사용할 수 있습니다.",
  "PHP_PROCESS_SPAWN_ERROR": "PHP 프로세스를 시작하는 동안 오류 코드 {0} 이 (가) 발생했습니다.",
  "PHP_SERVER_ERROR_TITLE": "에러",
  "PHP_SERVER_MEMORY_LIMIT_INVALID": "입력한 메모리 제한이 잘못되었습니다.PHP 기본 설정을 검토하여 올바른 값을 설정합니다.",
  "DESCRIPTION_PHP_TOOLING_CONFIGURATION": "PHP 툴링 기본 구성 설정",
  "OPEN_PREFERENNCES": "환경설정 열기",
  "LANGUAGE_TOOLS_PREFERENCES": "언어 도구 기본 설정",
  "FIND_ALL_REFERENCES": "모든 참조 찾기",
  "REFERENCES_IN_FILES": "참조",
  "REFERENCE_IN_FILES": "참고",
  "REFERENCES_NO_RESULTS": "현재 커서 위치에 사용할 수 있는 참조 없음",
  "CMD_FIND_DOCUMENT_SYMBOLS": "문서 기호 찾기",
  "CMD_FIND_PROJECT_SYMBOLS": "프로젝트 심볼 찾기",
  "REMOTE_DEBUGGING_ENABLED": "로컬 호스트에서 원격 디버깅이 활성화됨:",
  "REMOTE_DEBUGGING_PORT_INVALID": "{0} 포트에서 원격 디버깅을 설정할 수 없습니다.포트 번호는 {1} 에서 {2} 사이여야 합니다.",
  "DESCRIPTION_EXTERNAL_APPLICATION_ASSOCIATE": "파일 확장자를 외부 응용 프로그램에 매핑합니다.Syntax: \"<file_type>“: “<기본|응용 프로그램 이름|응용 프로그램 경로>”, 파일 형식에 대한 시스템 기본 응용 프로그램에서 파일을 열려면 “기본값”을 사용합니다.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "외부 편집기에서 그래픽 파일을 엽니다.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "현재 폴더에 {APP_NAME} 에서 지원하지 않는 그래픽 파일 유형이 있습니다.<br/>이제 특정 파일 유형을 외부 편집기와 연결할 수 있습니다.연결되면 파일 트리의 파일을 두 번 클릭하여 기본 응용 프로그램에서.xd, .psd, .jpg, .png, .ai, .svg와 같은 그래픽 파일을 열 수 있습니다.<br/><br/>그래픽 파일 형식을 해당 기본 응용 프로그램과 연결하려면 '확인'버튼을 클릭하십시오.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "다음 파일 유형이 기본 응용 프로그램과 성공적으로 연결되었습니다.<br/>{0} “디버그->기본 설정 파일 열기” 메뉴로 이동하여 brackets.json에서 새 파일 형식 연결을 삭제/추가할지 여부에 대한 기본 설정을 변경할 수 있습니다.",
  "UNSUPPORTED_BROWSER": "브라우저가 지원되지 않음",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "브라우저가 폴더 열기를 지원하지 않습니다.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "아래 지원되는 브라우저 중 하나를 사용하십시오.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " 우리는 더 많은 브라우저에서 Phoenix를 사용할 수 있도록 열심히 노력하고 있습니다.이 대화 상자를 닫을 수 있지만 Phoenix의 일부 기능은 이 브라우저에서 작동하지 않습니다.",
  "CANNOT_PUBLISH_LARGE_PROJECT": "대형 프로젝트를 게시할 수 없음",
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "피닉스는 아직 실험적인 알파입니다.파일이 500개 이상인 프로젝트의 동기화를 아직 활성화하지 않았습니다.",
  "SHARE_WEBSITE": "웹 사이트 게시 및 공유",
  "PUBLISH": "게시",
  "PUBLISH_CONSENT_MESSAGE": "변경 사항을 빠르게 미리보고 다른 사람들과 웹 사이트를 공유할 수 있습니다.Phoenix는 {0} 에 이 웹 사이트를 게시할 수 있습니다.게시된 링크는 7일 동안 유효합니다.</br>웹사이트를 게시하고 공유하고 싶으세요?",
  "PUBLISH_SYNC_IN_PROGRESS": "미리 보기를 위해 동기화 진행 중...",
  "PUBLISH_PAGE": "이 사이트를 게시하고 공유하려면 클릭하십시오.",
  "PUBLISH_VIEW_PAGE": "게시된 페이지를 보려면 클릭하십시오.",
  "MISSING_FIELDS": "누락된 필드",
  "PLEASE_FILL_ALL_REQUIRED": "빨간색으로 강조 표시된 모든 필수 필드를 입력하십시오.",
  "CODE_EDITOR": "코드 에디터",
  "BUILD_THE_WEB": "웹 빌드",
  ...
  "BEAUTIFY_ERROR": "코드를 아름답게 꾸밀 수 없습니다.구문을 확인합니다.",
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "아름답게 할 수 없었습니다.미화 후 편집자 텍스트가 변경되었습니다.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "뷰티파잉 파일 {0}",
  "BEAUTIFY_ERROR_SELECTION": "아름답게 할 수 없었습니다.</br>불완전한 코드 블록을 선택했거나 구문이 잘못되었습니다.",
  "BEAUTIFY_OPTIONS": "코드 아름답게 하기 작동 방식을 제어하는 옵션",
  "BEAUTIFY_OPTION_PRINT_WIDTH": "뷰파이어가 줄 바꿈할 선 길이를 지정합니다.",
  "BEAUTIFY_OPTION_SEMICOLON": "모든 문장 끝에 세미콜론을 추가합니다.",
  "BEAUTIFY_OPTION_SINGLE_QUOTE": "큰따옴표 대신 작은 따옴표 사용",
  "BEAUTIFY_OPTION_QUOTE_PROPS": "개체의 속성을 인용할 때 변경",
  "BEAUTIFY_OPTION_BRACKET_SAME_LINE": "여러 줄 HTML (HTML, JSX, Vue, Angular) 요소의 >를 다음 줄에 단독으로 놓지 않고 마지막 줄의 끝에 놓습니다 (자체 닫는 요소에는 적용되지 않음).",
  "BEAUTIFY_OPTION_SINGLE_ATTRIBUTE_PER_LINE": "HTML, Vue 및 JSX에서 한 줄당 단일 속성 적용",
  "BEAUTIFY_OPTION_PROSE_WRAP": "마크다운 파일의 인쇄 너비를 초과하는 경우 산문 줄 바꿈",
  "BEAUTIFY_OPTION_PRINT_TRAILING_COMMAS": "가능한 한 여러 줄의 쉼표로 구분된 구문 구조로 후행 쉼표를 인쇄합니다."
});