...
define({
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "{APP_NAME}은 <strong>개인 식별 정보를 수집하거나 처리하지 않지만</strong>, 사용자의 개인정보를 보호하기 위해 <strong>익명 사용 통계를 수집합니다</strong>. 익명 데이터는 GDPR/CCPA 알림 요구사항에서 제외되지만, 익명 데이터 수집을 거부할 수 있는 선택권도 제공해야 한다고 생각합니다.<br><br> <strong>도움말 > 상태 보고서</strong>를 선택하여 데이터를 확인하거나 <strong>익명 데이터를 공유하지 않도록 선택</strong>할 수 있습니다. 이러한 <strong>익명</strong> 앱 사용 통계 및 오류 보고서는 {APP_NAME} 사용 환경 개선을 위해 기능 우선순위 지정, 버그 찾기 및 사용성 문제 파악에 도움이 됩니다. 이 데이터가 없으면 어떤 기능을 개발해야 할지 알 수 없습니다! <br><br>",
  ...
  "NEW_PROJECT_FROM_GIT": "깃에서 새 프로젝트 생성",
  "GIT_REPO_URL": "깃 저장소 URL :",
  "GIT_CLONE_URL": "깃 클론 URL :",
  ...
  "ERROR_GIT_URL_INVALID": "유효한 깃 클론 URL을 입력하세요.",
  "ERROR_GIT_FOLDER_NOT_EMPTY": "선택한 폴더가 비어 있지 않거나 읽을 수 없어서 깃 클론에 사용할 수 없습니다.",
  "ERROR_GIT_FOLDER_NOT_EXIST": "선택한 폴더가 존재하지 않아서 깃 클론에 사용할 수 없습니다.",
  "ERROR_CLONING_TITLE": "깃 클론 실패",
  "DOWNLOADING": "다운로드 중...",
  ...
  "VIEW_MORE": "더 보기...",
  "NEW_PROJECT_NOTIFICATION": "`새 프로젝트` 창을 다시 열려면 이 아이콘을 클릭하세요.</br> 최근 프로젝트 보기, 폴더 열기 또는 템플릿에서 프로젝트 시작하기.</br> <img src=\"styles/images/new_project.png\">  <br/> <a href='#' style='float:right;'>확인</a>",
  "BEAUTIFY_CODE_NOTIFICATION": "코드를 정리하려면 여기를 클릭하거나 <b>`{0}`</b>를 누르세요. </br> <img src=\"styles/images/beautify.gif\">  <br/> <a href='#' style='float:right;'>확인</a>",
  "DEFAULT_PROJECT_NOTIFICATION": "피닉스에서 <br/><b>기본 프로젝트</b>를 열려면 여기를 클릭하세요. </br> <a href='#' style='float:right;'>확인</a>",
  ...
  "ENJOYING_APP": "{APP_NAME}이(가) 마음에 드시나요?",
  "GITHUB_STARS_POPUP": "<div>여러분의 지원은 저희 소규모 팀이 <b style='color: darkblue'>phcode.dev</b>를 더욱 발전시키는 데 큰 도움이 됩니다.<br/>GitHub에서 저희에게 별점을 주시거나 후원을 고려해 주세요:",
  "GITHUB_STARS_POPUP_TWITTER": "트위터에서 피드백을 제공하거나 소식을 공유해 주세요:",
  ...
  "RESET_HARD_MESSAGE": "선택한 커밋 이후의 모든 변경 사항과 커밋이 삭제됩니다. <b>이 작업은 쉽게 되돌릴 수 없습니다.</b> 계속하시겠습니까?<br><br>⚠️ 경고: 이 작업은 히스토리를 다시 작성하므로 공유 브랜치에 푸시된 커밋에는 사용하지 않아야 합니다.",
  "RESET_MIXED_MESSAGE": "선택한 커밋 이후의 모든 커밋이 삭제되지만, 모든 변경 사항은 스테이징되지 않은 상태로 유지됩니다. <b>이 작업은 쉽게 되돌릴 수 없습니다.</b> 계속하시겠습니까?<br><br>⚠️ 경고: 이 작업은 히스토리를 다시 작성하므로 공유 브랜치에 푸시된 커밋에는 사용하지 않아야 합니다.",
  "RESET_SOFT_MESSAGE": "선택한 커밋 이후의 모든 커밋이 삭제되지만, 모든 변경 사항은 새 커밋을 위해 스테이징된 상태로 유지됩니다. <b>이 작업은 쉽게 되돌릴 수 없습니다.</b> 계속하시겠습니까?<br><br>⚠️ 경고: 이 작업은 히스토리를 다시 작성하므로 공유 브랜치에 푸시된 커밋에는 사용하지 않아야 합니다.",
  "BUTTON_SAVE": "저장",
  "RESET": "초기화",
  ...
  "COMMIT_MESSAGE_PLACEHOLDER": "커밋 메시지를 여기에 입력하세요…",
  ...
  "DIALOG_CHECKOUT": "커밋을 체크아웃하면 저장소는 DETACHED HEAD 상태가 됩니다. 이 상태에서는 브랜치를 생성하지 않으면 커밋할 수 없습니다.",
  "DIALOG_PULL_TITLE": "원격에서 가져오기",
  "DIALOG_PUSH_TITLE": "원격으로 푸시",
  "SKIP_PRE_PUSH_CHECKS": "사전 푸시 검사 건너뛰기 (--no-verify)",
  "DIFF": "비교",
  "DIFFTOOL": "비교 도구로 비교",
  "DIFF_FAILED_SEE_FILES": "Git 비교에서 결과를 제공하지 못했습니다. 커밋될 스테이징된 파일 목록은 다음과 같습니다.",
  "DIFF_TOO_LONG": "비교 결과가 너무 길어서 표시할 수 없습니다.",
  ...
  "PULL_SHORTCUT": "원격에서 풀…",
  "PULL_SHORTCUT_BEHIND": "원격에서 풀 ({0} 뒤쳐짐)…",
  "PULL_BEHAVIOR": "풀 동작",
  ...
  "REFRESH_GIT": "Git 새로고침",
  "REMOVE_BOM": "파일에서 BOM 제거",
  "REMOVE_FROM_GITIGNORE": ".gitignore에서 제거",
  "RESET_LOCAL_REPO": "마지막 커밋 이후 변경 사항 모두 취소…",
  "DISCARD_CHANGES": "변경 사항 취소",
  "RESET_LOCAL_REPO_CONFIRM": "마지막 커밋 이후의 모든 변경 사항을 취소하시겠습니까? 이 작업은 되돌릴 수 없습니다.",
  "UNDO_LOCAL_COMMIT_CONFIRM": "푸시하지 않은 마지막 커밋을 취소하시겠습니까?",
  "MORE_OPTIONS": "추가 옵션",
  "CREDENTIALS": "자격 증명",
  "SAVE_CREDENTIALS_HELP": "자격 증명이 다른 곳에서 관리되는 경우 사용자 이름/암호를 입력할 필요가 없습니다. 작업 시간이 계속 초과되는 경우에만 사용하세요.",
  ...
  "UNDO_LAST_LOCAL_COMMIT": "마지막 로컬 (푸시되지 않은) 커밋 취소…",
  "UNDO_COMMIT": "커밋 취소",
  "URL": "URL",
  "USERNAME": "사용자명",
  ...
  "GIT_PUSH_UP_TO_DATE_MSG": "참조가 최신 상태이므로 푸시할 필요가 없습니다.",
  ...
  "ERROR_GET_CURRENT_BRANCH": "현재 브랜치 이름을 가져오지 못했습니다.",
  "ERROR_GET_DIFF_FILE_COMMIT": "diff를 가져오지 못했습니다.",
  "ERROR_GET_DIFF_FILES": "diff 파일 목록을 불러오지 못했습니다.",
  "ERROR_MODIFY_GITIGNORE": ".gitignore 수정에 실패했습니다.",
  "ERROR_UNDO_LAST_COMMIT_FAILED": "마지막 커밋을 취소할 수 없습니다.",
  "ERROR_MODIFY_FILE_STATUS_FAILED": "파일 상태 수정에 실패했습니다.",
  "ERROR_CHANGE_USERNAME_FAILED": "사용자 이름을 변경할 수 없습니다.",
  "ERROR_CHANGE_EMAIL_FAILED": "사용자 이메일을 변경할 수 없습니다.",
  "ERROR_TOGGLE_GERRIT_PUSH_REF_FAILED": "Gerrit 푸시 참조를 전환할 수 없습니다.",
  "ERROR_RESET_LOCAL_REPO_FAILED": "로컬 저장소 초기화에 실패했습니다.",
  ...
  "ERROR_MODIFIED_DIALOG_FILES": "커밋 대화 상자가 표시되는 동안 커밋하려는 파일이 수정되었습니다. 대화 상자에 표시된 내용과 결과가 다르므로 커밋을 중단합니다.",
  "ERROR_GETTING_REMOTES": "리모트 가져오기 실패!",
  "ERROR_REMOTE_CREATION": "리모트 생성 실패",
  "ERROR_PUSHING_REMOTE": "리모트에 푸시하는 데 실패했습니다.",
  "ERROR_PULLING_REMOTE": "리모트에서 가져오기 실패",
  "ERROR_PULLING_OPERATION": "가져오기 작업 실패",
