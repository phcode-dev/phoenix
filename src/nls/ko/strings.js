...
define({
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME} <strong>은 개인 식별 정보를 수집하거나 처리하지 않지만</strong> 개인정보 보호를 위해 <strong>익명의 사용 통계를 수집합니다</strong> . 익명 데이터는 GDPR/CCPA 통지 요구 사항에서 제외되지만 익명 데이터 수집을 거부할 수 있는 선택권이 있어야 한다고 생각합니다.<br> 이러한 <strong>익명의</strong> 앱 사용 통계 및 오류 보고서는 기능 우선순위를 지정하고, 버그를 찾고, {APP_NAME} 사용 경험에 대한 사용성 문제를 파악하는 데 도움이 됩니다.</p><p> 다음은 활성화된 <em>경우</em> 다음 건강 보고서에서 전송될 데이터의 미리보기입니다. (&#39;Caught Critical error&#39;라고 표시된 오류 로그는 개발자 콘솔을 참조하세요.)</p>",
  ...
  "VIEW_MORE": "더보기...",
  "NEW_PROJECT_NOTIFICATION": "새 프로젝트를 생성하려면 이 아이콘을 클릭하세요.</br><img src=\"styles/images/new_project.png\"><br/> <a href='#' style='float:right;'>좋아요</a>",
  ...
  "POWER_USER_POPUP_TITLE": "{APP_NAME}을(를) 어떻게 개선할 수 있을까요?",
  "POWER_USER_POPUP_TEXT": "<div>우리는 귀하의 피드백을 받고 싶습니다. 귀하의 피드백은 어떤 기능을 구축하고 플랫폼에 어떤 개선이 필요한지 결정하는 데 도움이 됩니다.<br/> <a>이 짧은 설문 조사를 작성해 주십시오.</a></div>",
