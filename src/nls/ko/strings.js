...
define({
  ...
  "PHP_INSTALL_DIALOG_TEXT": "PHP를 위한 고급 자동 완성, 오류 검사, 문서 등",
  ...
  "PYTHON_BENEFIT_COMPLETIONS_SUB": "타이핑하는 대로 스마트 제안",
  "PYTHON_BENEFIT_DOCS": "호버 시 문서",
  "PYTHON_BENEFIT_DOCS_SUB": "에디터에서 바로 확인하는 함수 도움말",
  "PYTHON_BENEFIT_ERRORS": "오류 검사",
  "PYTHON_BENEFIT_ERRORS_SUB": "코딩하는 대로 오류 표시",
  "PYTHON_BENEFIT_NAV": "내비게이션",
  "PYTHON_BENEFIT_NAV_SUB": "정의로 이동 및 사용처 찾기",
  "PYTHON_BENEFIT_FORMAT": "포맷팅",
  "PYTHON_BENEFIT_FORMAT_SUB": "Ruff로 명령어 하나로 코드 정리",
  "PYTHON_INSTALL_DIALOG_TEXT": "파이썬을 위한 고급 자동 완성, 오류 검사, 문서 및 서식 지정.",
  "PYTHON_INSTALL_DIALOG_SIZE": "25메가바이트 다운로드",
  "PYTHON_INSTALL_LATER_INFO": "언제든지 나중에 설치할 수 있습니다 — 파이썬 파일이 열릴 때마다 설치 바가 나타납니다.",
  "PYTHON_PANEL_TEXT": "파이썬 코드 인텔리전스가 꺼져 있습니다. 자동 완성, 오류 검사, 문서, 서식 지정 및 정의로 이동 기능을 사용하려면 Pyrefly 언어 서버와 Ruff 포매터(무료, 약 25메가바이트 다운로드)를 설치하세요.",
  "PYTHON_INSTALLING": "파이썬 지원 설정 중 — 언어 도구 다운로드 중…",
  "PYTHON_INSTALL_DONE": "파이썬 코드 인텔리전스가 준비되었습니다.",
  "PYTHON_INSTALL_FAILED": "파이썬 지원을 설정할 수 없습니다: {0}. 파이썬 파일을 다시 열면 {APP_NAME}에서 재시도합니다.",
  "DESCRIPTION_PYTHON_CODE_INTELLIGENCE": "거짓으로 설정하면 파이썬 코드 인텔리전스(Pyrefly)가 비활성화됩니다. 다시 참으로 설정하면 언어 서버 다운로드가 다시 제공됩니다."
});