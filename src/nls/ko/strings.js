...
define({
  ...
  "PROMO_CARD_2_MESSAGE": "섹션을 시각적으로 재배치하세요. 코딩에 몇 분씩 걸리는 대신, 단 몇 초 만에 더 많은 레이아웃 아이디어를 시도해 보세요.",
  "PROMO_CARD_3": "스톡 이미지 라이브러리",
  "PROMO_CARD_3_MESSAGE": "로열티 프리 이미지를 둘러보세요. 마우스를 올리면 즉시 미리 볼 수 있고, 클릭하면 적용됩니다. 더 많은 옵션을 더 빠르게 시도해 보세요.",
