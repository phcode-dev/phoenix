...
define({
  ...
  "LIVE_DEV_SETTINGS_STYLES_BAR_DOCK_PREFERENCE": "라이브 미리보기 스타일 바를 도킹할 위치('top', 'bottom', 'left' 또는 'right')입니다. 기본값은 'bottom'입니다.",
  ...
  "LIVE_DEV_STYLER_WEIGHT_CYCLE_HINT": "클릭하여 보통 / 굵게 / 아주 굵게 순환 · 시프트-클릭하여 모든 굵기 보기",
  ...
  "LIVE_DEV_STYLER_DOCK": "도킹 위치",
  "LIVE_DEV_STYLER_DOCK_TOP": "상단으로 이동",
  "LIVE_DEV_STYLER_DOCK_BOTTOM": "하단으로 이동",
  "LIVE_DEV_STYLER_DOCK_LEFT": "바를 왼쪽으로 이동",
  "LIVE_DEV_STYLER_DOCK_RIGHT": "바를 오른쪽으로 이동",
  ...
  "LIVE_DEV_STYLER_FONTS_CUSTOM": "사용자 지정",
  "LIVE_DEV_STYLER_FONT_USE_CUSTOM": "\"{0}\" 사용",
