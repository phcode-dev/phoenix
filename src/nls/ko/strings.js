...
define({
  ...
  "LIVE_DEV_STYLES_PANEL_NO_RULES": "CSS 규칙 없음",
  "LIVE_DEV_STYLES_PANEL_MATCHING_RULES": "일치하는 규칙 ({0})",
  "LIVE_DEV_STYLES_PANEL_LOADING": "스타일 로딩 중…",
  "LIVE_DEV_STYLES_PANEL_NO_STYLES": "스타일 없음",
  "LIVE_DEV_STYLES_PANEL_PROPERTY_PLACEHOLDER": "속성",
  "LIVE_DEV_STYLES_PANEL_VALUE_PLACEHOLDER": "값",
  "LIVE_DEV_STYLES_TAB_ADVANCED": "스타일",
  "LIVE_DEV_STYLES_TAB_COMPUTED": "계산됨",
  "LIVE_DEV_STYLES_FILTER_ALL": "모두",
  "LIVE_DEV_STYLES_FILTER_LAYOUT": "레이아웃",
  "LIVE_DEV_STYLES_FILTER_TYPOGRAPHY": "타이포그래피",
  "LIVE_DEV_STYLES_FILTER_COLOR": "색상",
  "LIVE_DEV_STYLES_FILTER_EFFECTS": "효과",
  "LIVE_DEV_STYLES_FILTER_BOX_MODEL": "박스 모델",
  "LIVE_DEV_STYLES_COMPUTED_SEARCH": "속성 필터…",
  "LIVE_DEV_STYLES_COMPUTED_NO_RESULTS": "검색 결과 없음",
  "LIVE_DEV_STYLES_COMPUTED_USER_AGENT": "사용자 에이전트",
  ...
  "AI_CHAT_SETTINGS_TITLE": "클로드 코드 설정",
