...
define({
  ...
  "AI_CHAT_CLI_NOT_FOUND": "Claude CLI를 찾을 수 없음",
  "AI_CHAT_CLI_INSTALL_MSG": "AI 기능을 사용하려면 Claude CLI를 설치하세요:<br><code>npm install -g @anthropic-ai/claude-code</code><br><br>그런 다음 <code>claude login</code>을 실행하여 인증하세요.",
  "AI_CHAT_RETRY": "다시 시도",
