...
define({
  ...
  "PHOENIX_TOUR_DESIGN_MODE": "여기를 클릭하여 디자인 모드로 들어가세요. 전체 화면에서 페이지를 시각적으로 편집할 수 있습니다.",
  "PHOENIX_TOUR_AI_PANEL": "여기를 클릭하여 AI 패널을 여세요",
  "PHOENIX_TOUR_NEW_PROJECT": "여기에서 새 프로젝트를 열거나 생성하세요",
