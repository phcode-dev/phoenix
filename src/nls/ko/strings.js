...
define({
  ...
  "LIVE_DEV_ELEMENT_PROPS_NO_CLASSES": "클래스 없음",
  "LIVE_DEV_ELEMENT_PROPS_NO_ATTRIBUTES": "속성 없음",
  ...
  "PHOENIX_TOUR_EDIT_MODE": "편집 모드를 사용하면 실시간 미리보기에서 직접 페이지를 수정할 수 있습니다. 요소를 클릭하여 인라인으로 검사하고 편집하세요.",
  "PROMO_CARD_2": "당신이 보는 것을 똑같이 보는 AI",
  "PROMO_CARD_2_MESSAGE": "AI와 함께 UI 아이디어를 탐색하고, 앱을 만들고, 문제를 해결해 보세요. AI는 코드가 아닌, 당신이 보는 것과 똑같은 방식으로 페이지를 봅니다.",
  "PROMO_CARD_3": "어떤 기기에서든 페이지를 확인하세요",
  "PROMO_CARD_3_MESSAGE": "휴대폰, 태블릿, 데스크톱 보기 간에 즉시 전환하여 반응형 문제를 조기에 발견하세요.",
  "PROMO_CARD_4": "당신의 마크다운을 실제 문서처럼",
  "PROMO_CARD_4_MESSAGE": "표, 이미지, 서식을 시각적으로 편집하여 마크다운을 더 쉽게 다뤄보세요.",
  "AI_CHAT_SURPRISE_ME_USER_MSG": "아무거나 제안해 줘",
  "AI_CHAT_CLI_INSTALL_MSG": "{APP_NAME}에서 AI 기능을 사용하려면 시스템에 Claude Code CLI가 설치되어 있어야 합니다.",
  ...
  "AI_CHAT_PLACEHOLDER_CARD_LAYOUT_DESC": "섹션을 설명하세요",
  "AI_CHAT_PLACEHOLDER_CARD_BUGS_TITLE": "버그 수정",
  "AI_CHAT_PLACEHOLDER_CARD_BUGS_DESC": "문제를 검사하세요",
