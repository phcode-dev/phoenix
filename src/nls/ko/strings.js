...
define({
  ...
  "LIVE_DEV_SETTINGS_ELEMENT_HIGHLIGHT_PREFERENCE": "'호버' 또는 '클릭' 시 실시간 미리보기 요소 하이라이트를 표시합니다. 기본값은 '호버'입니다.",
  ...
  "LIVE_DEV_MORE_OPTIONS_EDIT_HYPERLINK": "하이퍼링크 편집",
  ...
  "LIVE_DEV_MORE_OPTIONS_MORE": "추가 옵션",
  ...
  "IMAGE_SEARCH_MONTHLY_LIMIT_MESSAGE": "이번 달 이미지 검색 {0}회를 모두 사용하셨습니다.<br>체험판 제한을 없애고 계속 검색하려면 Phoenix Pro 유료 플랜을 시작하세요."
});