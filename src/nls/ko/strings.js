...
define({
  ...
  "DESCRIPTION_LIVEDEV_SECURITY": "phcode.dev의 보안 경고<br><br> 이 실시간 미리보기는 프로젝트가 아닌 파일에 액세스하려고 시도했습니다. 안전을 위해 액세스가 거부되었습니다. 신뢰할 수 없는 프로젝트에서 작업할 때는 주의하십시오.",
  ...
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "다음 파일 형식이 기본 응용 프로그램과 성공적으로 연결되었습니다.<br/> {0} &#39;디버그-&gt;기본 설정 파일 열기&#39; 메뉴로 이동하여 brackets.json에서 새 파일 유형 연결을 삭제/추가할지 여부에 대한 기본 설정을 변경할 수 있는 옵션이 있습니다.",
  ...
  "VIEW_MORE": "더보기...",
  "NEW_PROJECT_NOTIFICATION": "새 프로젝트를 생성하려면 이 아이콘을 클릭하세요.</br><img src=\"extensions/default/Phoenix/images/new_project.png\"><br/> <a href='#' style='float:right;'>좋아요</a>",
  "BEAUTIFY_CODE_NOTIFICATION": "코드를 아름답게 하려면 여기를 클릭하거나 <b>`{0}`</b> 을 누르십시오.</br><img src=\"extensions/default/Phoenix/images/beautify.gif\"><br/> <a href='#' style='float:right;'>좋아요</a>",
