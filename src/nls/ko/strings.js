...
define({
  ...
  "WEBPAGE_HOME_PAGE": "홈페이지 레이아웃",
  "WEBPAGE_BLOG": "블로그 페이지",
  "WEBPAGE_DASHBOARD": "HTML 대시보드",
  "WEBPAGE_BOOTSTRAP_EXAMPLES": "부트스트랩 예제",
  "GUIDED_FILES_SIDEBAR": "HTML 파일 선택</br> <a href='#' style='float:right;'>좋아요</a>",
  "GUIDED_LIVE_PREVIEW": "일부 코드를 변경하고 파일을 저장하여 미리보기를 확인하세요.</br> <a href='#' style='float:right;'>좋아요</a>",
