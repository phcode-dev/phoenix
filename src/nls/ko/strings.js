...
define({
  ...
  "INCLUDE_FILE_FILTER": "{0} 포함",
  "EXCLUDE_FILE_FILTER_DROPDOWN": "들어오지 못하게 하다",
  "INCLUDE_FILE_FILTER_DROPDOWN": "포함하다",
  "EDIT_FILE_FILTER": "수정…",
  "FILE_FILTER_DIALOG": "제외 필터 편집",
  "FILE_FILTER_INSTRUCTIONS": "다음 중 하나와 일치하는 파일 및 폴더를 제외합니다. <a href='{0}' title=\"{0}\">와일드카드는 무시됩니다</a> . 새 줄에 각 문자열을 입력합니다. 예:<ul><li> <code>*.js</code> <code>a/b/x.js</code> , <code>xyx.js</code> 등과 일치합니다.</li><li> <code>./*.css</code> 프로젝트 루트의 <code>x.css</code> 와만 일치하지만 하위 폴더의 <code>y/x.css</code> 는 일치하지 않습니다.</li></ul>",
  "FILE_FILTER_INSTRUCTIONS_INCLUDE": "다음 중 하나와 일치하는 파일 및 폴더만 포함합니다. <a href='{0}' title=\"{0}\">와일드카드는 무시합니다</a> . 새 줄에 각 문자열을 입력합니다. 예:<ul><li> <code>*.js</code> <code>a/b/x.js</code> , <code>xyx.js</code> 등과 일치합니다.</li><li> <code>./*.css</code> 프로젝트 루트의 <code>x.css</code> 와만 일치하지만 하위 폴더의 <code>y/x.css</code> 는 일치하지 않습니다.</li></ul>",
  "FILTER_NAME_PLACEHOLDER": "이 제외 규칙의 이름 (생략가능)",
  "FILTER_NAME_REMAINING": "{0}자 남음",
  ...
  "CMD_KEYBOARD_NAV_OVERLAY": "UI 탐색 모드",
  "NAVIGATE_MENU": "탐색",
  ...
  "UPDATE_UP_TO_DATE": "귀하의 {APP_NAME} 버전은 최신이자 최고의 버전입니다.",
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "{APP_NAME}을(를) 개선하기 위해 Google에서는 귀하의 {APP_NAME} 사용 방법에 대한 제한된 <strong>가명</strong> 통계 및 오류 보고서를 phcode.dev에 정기적으로 보냅니다. 이 정보는 개인 정보를 보호하면서 기능의 우선 순위를 지정하고, 버그를 찾고, 유용성 문제를 발견하는 데 도움이 됩니다.<br><br> <strong>도움말 &gt; 상태 보고서</strong> 를 선택하여 데이터를 보거나 데이터를 공유하지 않도록 선택할 수 있습니다.<br><br>",
  "HEALTH_DATA_PREVIEW": "{APP_NAME} 상태 보고서",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME}을(를) 개선하기 위해 Google에서는 귀하의 {APP_NAME} 사용 방법에 대한 제한된 <strong>가명</strong> 통계 및 오류 보고서를 phcode.dev에 정기적으로 보냅니다. 이 정보는 기능의 우선 순위를 지정하고 버그를 찾고 사용성 문제를 찾는 데 도움이 됩니다.</p><p> 다음은 활성화된 <em>경우</em> 다음 건강 보고서에 전송될 데이터의 미리보기입니다. (또한 &#39;Caught Critical error&#39;라고 표시된 오류 로그는 개발자 콘솔을 참조하세요.)</p>",
  ...
  "RESTART_BUTTON": "재시작",
  "LATER_BUTTON": "나중",
  "DESCRIPTION_AUTO_UPDATE": "대괄호 자동 업데이트 활성화/비활성화",
  "AUTOUPDATE_ERROR": "오류!",
