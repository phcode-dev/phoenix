...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "현재 프로젝트에서 <code>package.json</code> 파일이 감지되지 않습니다. 현재 프로젝트가 유효한 {APP_NAME} 확장 프로그램인가요?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "<code>package.json</code> 파일이 유효하지 않은 JSON입니다.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "<code>package.json</code> 에 누락된 필수 필드: [{0}]",
  ...
  "UNSUPPORTED_BROWSER": "브라우저가 지원되지 않음",
  "UNSUPPORTED_BROWSER_MOBILE": "모바일 및 태블릿 장치는 현재 완전히 지원되지 않습니다. 이 대화 상자를 닫을 수 있지만 Phoenix의 일부 기능은 이 브라우저에서 작동하지 않습니다.",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "브라우저는 폴더 열기를 지원하지 않습니다. 로컬 폴더를 열려면 Chrome, Edge 또는 Opera를 사용하세요.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "아래 지원되는 브라우저 중 하나를 사용하십시오.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " 더 많은 브라우저에서 Phoenix를 사용할 수 있도록 열심히 노력하고 있습니다. 이 대화 상자를 닫을 수 있지만 Phoenix의 일부 기능은 이 브라우저에서 작동하지 않습니다.",
  ...
  "PUBLISH": "게시",
  "PUBLISH_CONSENT_MESSAGE": "변경 사항을 빠르게 미리 보고 웹사이트를 다른 사람들과 공유하십시오. Phoenix는 이 웹사이트를 {0}에 게시할 수 있습니다. 게시된 링크는 7일 동안 유효합니다. </br>웹사이트를 게시하고 공유하시겠습니까?",
