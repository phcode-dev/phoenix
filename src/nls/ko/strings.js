...
define({
  ...
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>Safari는 7일 이내에 사이트를 다시 방문하지 않으면 웹사이트 데이터를 자동으로 삭제합니다. {APP_NAME}은(는) 이 정책으로 인해 삭제될 수 있는 프로젝트를 저장하기 위해 브라우저 저장소에 의존합니다.<br/><br/> <strong>데이터 손실을 방지하려면</strong> 탭을 닫기 전에 프로젝트를 <strong>다운로드하거나</strong> 곧 <strong>출시될 웹 및 기본 Mac/iOS 앱을</strong> 계속 지켜봐 주시기 바랍니다.</span>",
