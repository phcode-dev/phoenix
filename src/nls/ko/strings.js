...
define({
  ...
  "DEVICE_SIZE_LIMIT_TITLE": "Phoenix Pro에서 사용 가능",
  ...
  "LIVE_PREVIEW_SYNC_SOURCE_AND_PREVIEW": "코드 및 미리보기 동기화",
  "LIVE_DEV_SETTINGS_SYNC_SOURCE_AND_PREVIEW_PREFERENCE": "소스 코드 커서와 라이브 미리보기 요소 하이라이트를 동기화합니다. 활성화 시, 편집기에서 커서를 움직이면 라이브 미리보기의 해당 요소가 강조 표시되고, 라이브 미리보기에서 요소를 클릭하면 해당 소스 코드로 커서가 이동합니다. 기본값은 'true'입니다.",
