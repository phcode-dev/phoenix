...
define({
  ...
  "UPDATE_NOT_AVAILABLE_TITLE": "사용 가능한 업데이트가 없습니다.",
  "UPDATE_AVAILABLE_TITLE": "사용 가능한 업데이트가 있습니다",
  "UPDATE_READY_RESTART_TITLE": "업데이트 준비됨: 다시 시작해야 함",
  "UPDATE_READY_RESTART_MESSAGE": "업데이트된 버전을 실행하려면 모든 {APP_NAME} 창을 닫고 앱을 다시 시작하세요.",
  "UPDATE_FAILED_TITLE": "업데이트가 실패",
  "UPDATE_FAILED_MESSAGE": "업데이트를 다시 시도하려면 {APP_NAME} 창을 모두 닫고 애플리케이션을 다시 열어보세요.",
  ...
  "UPDATE_DONE": "{APP_NAME}이 업데이트되었습니다.",
