...
define({
  ...
  "MIGRATE_TWA_UPDATE_NOTE": "가능할 때 앱을 업데이트해 주세요. 오늘 바로 작동이 중지되는 것은 아니며, 그동안 이 버전을 계속 사용할 수 있습니다.",
  "MIGRATE_TWA_BROWSER_LINK": "지금 바로 업데이트할 수 없는 경우, <a href='{0}'>{1}에서 브라우저로 계속 사용</a>할 수도 있습니다.",
