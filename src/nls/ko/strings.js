...
define({
  ...
  "DEVICE_SIZE_LIMIT_MESSAGE": "휴대폰, 태블릿, 데스크톱 및 CSS 중단점에서 페이지가 어떻게 보이는지 확인하세요. Phoenix Pro로 업그레이드하세요.",
  "DEVICE_SIZE_NOT_ENOUGH_SPACE": "이 화면 크기를 표시할 공간이 부족합니다. 축소해 보세요.",
  "DEVICE_SIZE_CYCLE_TOOLTIP": "모바일, 태블릿, 데스크톱 간 전환",
  "DEVICE_SIZE_DROPDOWN_TOOLTIP": "모든 기기 크기",
  "DEVICE_SIZE_FIT_TO_PANEL": "패널에 맞추기",
  "BOTTOM_PANEL_DEFAULT_TITLE": "빠른 접근 - 도구"
});