...
define({
  ...
  "AI_CHAT_CLAUDE_LOGIN_TITLE": "Claude Code 설정",
  "AI_CHAT_CLAUDE_LOGIN_MSG": "Claude Code가 설치되었지만 구성이 필요합니다.",
  "AI_CHAT_CLAUDE_LOGIN_BTN": "Claude Code 설정",
  "AI_CHAT_CLAUDE_LOGIN_RESTART_NOTE": "설정이 완료되면 {APP_NAME}을(를) 다시 시작하세요.",
  "AI_CHAT_ADD_PROVIDER_BTN": "사용자 지정 공급자 추가",
  ...
  "AI_CHAT_MODE_SWITCH_HINT": "여기에서 언제든지 다시 전환할 수 있습니다",
  ...
  "AI_CHAT_START_CHAT_DESC": "시각적 편집 기능이 있는 내장 채팅",
  "AI_CHAT_START_CLI_SEPARATOR": "CLI · {APP_NAME}와(과) 연결",
