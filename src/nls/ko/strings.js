...
define({
  ...
  "LIVE_DEV_SETTINGS_STYLES_BAR_POSITION_PREFERENCE": "실시간 미리보기 스타일 막대의 저장된 위치로, 막대를 드래그할 때 자동으로 설정됩니다. 비워두면 막대가 기본 위치에 배치됩니다.",
  ...
  "LIVE_DEV_STYLER_SPACING": "마진 및 패딩",
  ...
  "LIVE_DEV_STYLER_NEW_STYLE": "새 스타일…",
  "LIVE_DEV_STYLER_NEW_STYLE_TITLE": "새 스타일",
  ...
  "LIVE_DEV_EMPTY_CANVAS_LABEL": "페이지가 비어 있습니다 — 요소를 추가하세요",
  "LIVE_DEV_EMPTY_CANVAS_ADD": "첫 요소 추가",
  "LIVE_DEV_EMPTY_CANVAS_COLLAPSE": "접기",
  ...
  "PHP_INSTALL_MESSAGE": "고급 PHP 코드 인텔리전스를 설치하시겠습니까?",
  "PHP_INSTALL_ENABLE": "설치",
  "PHP_INSTALL_NOT_NOW": "나중에",
  "PHP_POWERED_BY_INTELEPHENSE": "Intelephense 제공",
  "PHP_BENEFIT_COMPLETIONS": "자동 완성",
  "PHP_BENEFIT_COMPLETIONS_SUB": "입력과 동시에 스마트한 코드 제안",
  "PHP_BENEFIT_DOCS": "호버 시 문서 표시",
  "PHP_BENEFIT_DOCS_SUB": "에디터에서 바로 함수 도움말 확인",
  "PHP_BENEFIT_ERRORS": "오류 검사",
  "PHP_BENEFIT_ERRORS_SUB": "코드 작성 중 실수 표시",
  "PHP_BENEFIT_NAV": "탐색",
  "PHP_BENEFIT_NAV_SUB": "정의로 이동 및 사용 위치 찾기",
  "PHP_PANEL_TEXT": "PHP 코드 인텔리전스가 꺼져 있습니다. 인텔리펜스 언어 서버(무료, 약 9MB 다운로드)를 설치하여 자동 완성, 오류 검사, 문서 및 정의로 이동 기능을 사용하세요.",
  "PHP_INSTALLING": "PHP 지원 설정 중 — 언어 서버 다운로드 중…",
  "PHP_INSTALL_DONE": "PHP 코드 인텔리전스가 준비되었습니다.",
  "PHP_INSTALL_FAILED": "PHP 지원을 설정할 수 없습니다: {0}. 다음에 PHP 파일을 열 때 {APP_NAME}에서 다시 시도합니다.",
  "DESCRIPTION_PHP_CODE_INTELLIGENCE": "PHP 코드 인텔리전스(인텔리펜스)를 비활성화하려면 거짓(false)으로 설정하세요. 다시 참(true)으로 설정하면 언어 서버를 다시 다운로드할 수 있습니다.",
  ...
  "PHP_INSTALL_DIALOG_TITLE": "PHP 코드 인텔리전스 설치",
  "PHP_INSTALL_DIALOG_TEXT": "PHP를 위한 고급 자동 완성, 오류 검사, 문서 등 다양한 기능",
  "PHP_INSTALL_DIALOG_SIZE": "9 MB 다운로드",
  "PHP_INSTALL_LATER_INFO": "나중에 언제든지 설치할 수 있습니다 — PHP 파일을 열 때마다 설치 바가 나타납니다.",
  "LSP_INSTALL_POWERED_BY": "제공:",
  "PYTHON_INSTALL_TITLE": "파이썬 코드 인텔리전스",
  "PYTHON_INSTALL_DIALOG_TITLE": "파이썬 코드 인텔리전스 설치",
  "PYTHON_INSTALL_MESSAGE": "고급 파이썬 코드 인텔리전스를 설치하시겠습니까?",
  "PYTHON_INSTALL_NOT_NOW": "나중에",
  "PYTHON_POWERED_BY_PYREFLY": "Pyrefly 제공",
  "PYTHON_BENEFIT_COMPLETIONS": "자동 완성",
  "PYTHON_BENEFIT_COMPLETIONS_SUB": "입력하는 대로 스마트하게 제안",
  "PYTHON_BENEFIT_DOCS": "마우스 오버 시 문서 보기",
  "PYTHON_BENEFIT_DOCS_SUB": "에디터에서 바로 함수 도움말 확인",
  "PYTHON_BENEFIT_ERRORS": "오류 검사",
  "PYTHON_BENEFIT_ERRORS_SUB": "코딩 중 실시간으로 오류 표시",
  "PYTHON_BENEFIT_NAV": "탐색",
  "PYTHON_BENEFIT_NAV_SUB": "정의로 이동 및 사용된 곳 찾기",
  "PYTHON_BENEFIT_FORMAT": "서식 지정",
  "PYTHON_BENEFIT_FORMAT_SUB": "Ruff를 사용하여 명령 한 번으로 코드 정리",
  "PYTHON_INSTALL_DIALOG_TEXT": "파이썬을 위한 고급 자동 완성, 오류 검사, 문서 및 서식 지정",
  "PYTHON_INSTALL_DIALOG_SIZE": "25 MB 다운로드",
  "PYTHON_INSTALL_LATER_INFO": "언제든지 나중에 설치할 수 있습니다 — 파이썬 파일이 열릴 때마다 설치 바가 나타납니다.",
  "PYTHON_PANEL_TEXT": "파이썬 코드 인텔리전스가 꺼져 있습니다. 자동 완성, 오류 검사, 문서, 서식 지정 및 정의로 이동 기능을 사용하려면 Pyrefly 언어 서버와 Ruff 포맷터(무료, 약 25MB 다운로드)를 설치하세요.",
  "PYTHON_INSTALLING": "파이썬 지원 설정 중 — 언어 도구 다운로드 중…",
  "PYTHON_INSTALL_DONE": "파이썬 코드 인텔리전스가 준비되었습니다.",
  "PYTHON_INSTALL_FAILED": "파이썬 지원을 설정하지 못했습니다: {0}. 다음에 파이썬 파일을 열 때 {APP_NAME}에서 다시 시도합니다.",
  "DESCRIPTION_PYTHON_CODE_INTELLIGENCE": "`false`로 설정하면 파이썬 코드 인텔리전스(Pyrefly)가 비활성화됩니다. 다시 `true`로 설정하면 언어 서버 다운로드를 다시 제안합니다."
});