...
define({
  ...
  "AI_DISABLE_CONFIRM_MESSAGE": "모든 AI 기능이 꺼집니다. AI 패널이 제거되고 {APP_NAME}은 AI 서비스 연결을 중단합니다.<br><br>이 변경 사항을 적용하려면 {APP_NAME}을 다시 시작하세요.",
  "AI_DISABLE_CONFIRM_BTN": "AI 비활성화",
  "AI_ENABLE_CONFIRM_TITLE": "AI를 활성화하시겠습니까?",
  "AI_ENABLE_CONFIRM_MESSAGE": "AI 기능이 다시 켜지고 AI 패널이 복원됩니다.<br><br>이 변경 사항을 적용하려면 {APP_NAME}을 다시 시작하세요.",
  "AI_ENABLE_CONFIRM_BTN": "AI 활성화",
  ...
  "AI_SETTINGS_ENABLE_AI_NOTE": "{APP_NAME}의 모든 AI 기능을 켜거나 끕니다. 다시 시작한 후에 적용됩니다 — 언제든지 <span class='ai-settings-menu-path'>보기 메뉴 &gt; AI 활성화</span>에서 다시 활성화할 수 있습니다."
});