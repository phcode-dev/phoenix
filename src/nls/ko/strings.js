...
define({
  ...
  "DESCRIPTION_LIVEDEV_MAIN_HEADING": "이런!",
  "DESCRIPTION_LIVEDEV_MAIN_SPAN": "{0}에서 윈도우, 맥, 리눅스용 네이티브 앱을 다운로드하여 최고의 실시간 미리보기 환경을 경험해 보세요.",
  "AI_CHAT_TOOL_READ_FILE_RANGE": "{0}줄({1}-{2}행) 읽음",
  "AI_CHAT_TOOL_READ_FILE_FROM": "{1}행부터 {0} 읽음",
  "AI_CHAT_TOOL_APPLIED_DIRECTLY": "디스크에 바로 적용됨 · 디프 없음",
  "AI_CHAT_TOOL_REJECTED": "편집 거부 — 파일이 수정되지 않음",
  ...
  "AI_CHAT_PLAN_WRITE_CONFIRM_BODY": "Claude가 {0}을(를) 편집하려고 합니다. 현재 계획 모드에 있습니다.",
  "AI_CHAT_PLAN_WRITE_ALLOW": "허용하고 편집 모드로 전환",
  "AI_CHAT_PLAN_WRITE_STAY": "계획 모드 유지",
  "AI_CHAT_PLAN_WRITE_ALLOWED": "편집 모드로 전환됨",
  "AI_CHAT_PLAN_WRITE_STAYED": "계획 모드 유지됨"
});