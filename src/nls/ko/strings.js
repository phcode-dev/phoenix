...
define({
  ...
  "LIVE_DEV_SETTINGS_ELEMENT_HIGHLIGHT_PREFERENCE": "라이브 미리보기에서 '가리키기' 또는 '클릭' 시 요소를 검사합니다. 기본값은 '가리키기'입니다.",
  "LIVE_DEV_SETTINGS_SHOW_RULER_LINES_PREFERENCE": "실시간 미리보기에서 요소를 선택하면 측정값을 표시합니다. 기본값은 '펄스'입니다.",
  "LIVE_DEV_SETTINGS_SHOW_STYLES_BAR_PREFERENCE": "라이브 미리보기에서 요소를 선택하면 스타일 바를 표시합니다. 기본값은 'true'입니다.",
  "LIVE_DEV_SETTINGS_SHOW_STARTER_BAR_PREFERENCE": "라이브 미리보기 페이지가 비어 있을 때 시작 표시줄을 표시합니다. 기본값은 'true'입니다.",
  "LIVE_DEV_SETTINGS_STYLES_BAR_POSITION_PREFERENCE": "라이브 미리보기 스타일 표시줄이 고정될 가장자리('top' 또는 'bottom')를 지정합니다. 기본값은 'bottom'입니다.",
  "LIVE_DEV_TOOLBOX_SELECT_PARENT": "부모 선택",
  "LIVE_DEV_SCRIPT_GENERATED_TOOLTIP": "스크립트로 추가되어 HTML 소스에는 없지만 CSS 규칙은 편집할 수 있습니다.",
  "LIVE_DEV_STYLER_SCRIPT_ELEMENT_NOTICE": "스크립트로 생성된 요소: 편집 내용은 CSS 규칙에 저장됩니다.",
  "LIVE_DEV_TOOLBOX_EDIT_TEXT": "텍스트 편집",
  "LIVE_DEV_TOOLBOX_DOUBLE_CLICK_HINT": "더블 클릭",
  "LIVE_DEV_TOOLBOX_EDIT_ELEMENT_PROPS": "요소 속성 편집",
  ...
  "LIVE_DEV_TOOLBOX_IMAGE_GALLERY": "이미지 갤러리",
  "LIVE_DEV_TOOLBOX_MORE_OPTIONS": "추가 옵션",
  "LIVE_DEV_STYLER_BACKGROUND": "배경색",
  "LIVE_DEV_STYLER_TEXT_COLOR": "텍스트 색상",
  "LIVE_DEV_STYLER_FONT": "글꼴",
  "LIVE_DEV_STYLER_FONT_DEFAULT": "기본",
  "LIVE_DEV_STYLER_SIZE": "글꼴 크기",
  ...
  "LIVE_DEV_STYLER_DOCK_BOTTOM": "아래쪽에 도킹",
  "LIVE_DEV_STYLER_RESET": "변경 사항 초기화",
  "LIVE_DEV_STYLER_NOTHING_TO_RESET": "초기화할 변경 사항이 없습니다",
  "LIVE_DEV_STYLER_OVERRIDDEN": "이 변경 사항은 더 구체적인 규칙에 의해 재정의되었습니다",
  "LIVE_DEV_STYLER_APPLY_INLINE": "그래도 적용",
  "LIVE_DEV_STYLER_CLOSE_SAVED": "완료",
  "LIVE_DEV_STYLER_MIXED": "혼합",
  "LIVE_DEV_STYLER_SIDES_MIXED": "측면 값이 다릅니다 — 각 측면을 개별적으로 편집하세요",
  "LIVE_DEV_STYLER_SEARCH_FONTS": "글꼴 검색…",
  "LIVE_DEV_STYLER_FONTS_GOOGLE": "구글",
  "LIVE_DEV_STYLER_FONTS_SYSTEM": "시스템",
  "LIVE_DEV_STYLER_NO_FONTS_FOUND": "글꼴을 찾을 수 없습니다",
  "LIVE_DEV_STYLER_LOAD_MORE": "더 불러오기",
  "LIVE_DEV_STYLER_FONTS_MANUAL": "수동",
  "LIVE_DEV_STYLER_FONT_MANUAL_PLACEHOLDER": "예: Helvetica Neue",
  "LIVE_DEV_STYLER_FONT_MANUAL_APPLY": "적용",
  "LIVE_DEV_STYLER_FONT_MANUAL_HINT": "글꼴 이름을 입력하세요. 구글 글꼴은 자동으로 추가되며, 다른 글꼴은 이미 사용 가능해야 합니다.",
  "LIVE_DEV_STYLER_FONT_UPLOAD": "글꼴 파일 업로드",
  "LIVE_DEV_STYLER_FONT_UPLOAD_HINT": ".ttf .otf .woff .woff2",
  "LIVE_DEV_STYLER_FONT_UPLOAD_FAILED": "해당 글꼴 파일을 추가할 수 없습니다",
  "LIVE_DEV_STYLER_WEIGHT_THIN": "얇은",
  "LIVE_DEV_STYLER_WEIGHT_EXTRA_LIGHT": "아주 얇은",
  "LIVE_DEV_STYLER_WEIGHT_LIGHT": "가는",
  "LIVE_DEV_STYLER_WEIGHT_REGULAR": "보통",
  "LIVE_DEV_STYLER_WEIGHT_MEDIUM": "중간",
  "LIVE_DEV_STYLER_WEIGHT_SEMI_BOLD": "준굵은",
  "LIVE_DEV_STYLER_WEIGHT_BOLD": "굵게",
  "LIVE_DEV_STYLER_WEIGHT_EXTRA_BOLD": "아주 굵게",
  "LIVE_DEV_STYLER_WEIGHT_BLACK": "블랙",
  "LIVE_DEV_STYLER_LINE_HEIGHT": "줄 간격",
  "LIVE_DEV_STYLER_LETTER_SPACING": "글자 간격",
  "LIVE_DEV_STYLER_WORD_SPACING": "단어 간격",
  "LIVE_DEV_STYLER_TEXT_INDENT": "텍스트 들여쓰기",
  "LIVE_DEV_STYLER_FORMAT_TAB": "서식",
  "LIVE_DEV_STYLER_SPACING_TAB": "간격",
  "LIVE_DEV_STYLER_CASE": "대소문자",
  "LIVE_DEV_STYLER_ITALIC": "기울임꼴",
  "LIVE_DEV_STYLER_UNDERLINE": "밑줄",
  "LIVE_DEV_STYLER_OVERLINE": "윗줄",
  "LIVE_DEV_STYLER_STRIKETHROUGH": "취소선",
  "LIVE_DEV_STYLER_NONE": "없음",
  "LIVE_DEV_STYLER_UPPERCASE": "대문자",
  "LIVE_DEV_STYLER_LOWERCASE": "소문자",
  "LIVE_DEV_STYLER_CAPITALIZE": "첫 글자 대문자",
  "LIVE_DEV_STYLER_ALIGN_LEFT": "왼쪽 정렬",
  "LIVE_DEV_STYLER_ALIGN_CENTER": "가운데 정렬",
  "LIVE_DEV_STYLER_ALIGN_RIGHT": "오른쪽 정렬",
  "LIVE_DEV_STYLER_ALIGN_JUSTIFY": "양쪽 정렬",
  "LIVE_DEV_STYLER_CURSOR": "커서",
  "LIVE_DEV_STYLER_CURSOR_AUTO": "자동",
  "LIVE_DEV_STYLER_CURSOR_DEFAULT": "기본",
  "LIVE_DEV_STYLER_CURSOR_POINTER": "포인터",
  "LIVE_DEV_STYLER_CURSOR_TEXT": "텍스트",
  "LIVE_DEV_STYLER_CURSOR_MOVE": "이동",
  "LIVE_DEV_STYLER_CURSOR_GRAB": "잡기",
  "LIVE_DEV_STYLER_CURSOR_GRABBING": "잡는 중",
  "LIVE_DEV_STYLER_CURSOR_NOT_ALLOWED": "허용 안 됨",
  "LIVE_DEV_STYLER_CURSOR_HELP": "도움말",
  "LIVE_DEV_STYLER_CURSOR_WAIT": "대기",
  "LIVE_DEV_STYLER_CURSOR_PROGRESS": "진행",
  "LIVE_DEV_STYLER_CURSOR_CROSSHAIR": "십자선",
  "LIVE_DEV_STYLER_CURSOR_ZOOM_IN": "확대",
  "LIVE_DEV_STYLER_CURSOR_ZOOM_OUT": "축소",
  "LIVE_DEV_STYLER_REMOVE_BACKGROUND": "배경색 제거",
  "LIVE_DEV_STYLER_REMOVE_PROPERTY": "{0} 제거",
  "LIVE_DEV_STYLER_RESET_DEFAULT": "브라우저 기본값으로 재설정",
  "LIVE_DEV_STYLER_CTX_NOT_SET": "이 요소에 설정되지 않음",
  "LIVE_DEV_STYLER_CTX_SHORTHAND_BLOCKED": "단축 속성으로 설정됨, 대신 재설정을 사용하세요",
  "LIVE_DEV_STYLER_AFFECTS_TITLE": "이 페이지의 {1}개 요소가 {0}의 영향을 받습니다",
  "LIVE_DEV_STYLER_CTX_AFFECTS": "{0}개 요소에 영향",
  "LIVE_DEV_STYLER_CTX_AFFECTS_ONE": "이 요소에만 영향",
  "LIVE_DEV_STYLER_CTX_FROM_RULE": "{0}로부터",
  "LIVE_DEV_STYLER_CTX_INLINE_STYLE": "이 요소의 인라인 스타일",
  "LIVE_DEV_STYLER_CTX_ADDS_REVERT": "이 요소에 {0} 추가",
  "LIVE_DEV_STYLER_CLEAR_IN_RULE": "{0}은(는) {1}에 의해 설정되었습니다",
  "LIVE_DEV_STYLER_CLEAR_IN_INLINE": "{0}은(는) {1}에 설정되었습니다",
  "LIVE_DEV_STYLER_CLEAR_IN_SHORTHAND": "{0}은(는) {1} 약식 속성에 의해 설정되었습니다",
  "LIVE_DEV_STYLER_CLEAR_REMOVE_BTN": "삭제",
  "LIVE_DEV_STYLER_CLEAR_RESET_BTN": "재설정",
  "LIVE_DEV_STYLER_LEARN_MORE": "자세히 알아보기…",
  "LIVE_DEV_STYLER_RADIUS": "반경",
  "LIVE_DEV_STYLER_WIDTH": "너비",
  "LIVE_DEV_STYLER_COLOR": "색상",
  "LIVE_DEV_STYLER_ON_THIS_PAGE": "이 페이지에서",
  "LIVE_DEV_STYLER_FROM_GOOGLE": "구글 폰트에서",
  "LIVE_DEV_STYLER_COMMON_COLORS": "공통",
  "LIVE_DEV_STYLER_COLOR_WHITE": "흰색",
  "LIVE_DEV_STYLER_COLOR_SILVER": "은색",
  "LIVE_DEV_STYLER_COLOR_GRAY": "회색",
  "LIVE_DEV_STYLER_COLOR_BLACK": "검정",
  "LIVE_DEV_STYLER_COLOR_RED": "빨강",
  "LIVE_DEV_STYLER_COLOR_MAROON": "마룬",
  "LIVE_DEV_STYLER_COLOR_ORANGE": "주황",
  "LIVE_DEV_STYLER_COLOR_GOLD": "금색",
  "LIVE_DEV_STYLER_COLOR_YELLOW": "노랑",
  "LIVE_DEV_STYLER_COLOR_OLIVE": "올리브",
  "LIVE_DEV_STYLER_COLOR_LIME": "라임",
  "LIVE_DEV_STYLER_COLOR_GREEN": "초록",
  "LIVE_DEV_STYLER_COLOR_TEAL": "틸",
  "LIVE_DEV_STYLER_COLOR_CYAN": "시안",
  "LIVE_DEV_STYLER_COLOR_BLUE": "파란색",
  "LIVE_DEV_STYLER_COLOR_NAVY": "남색",
  "LIVE_DEV_STYLER_COLOR_INDIGO": "인디고",
  "LIVE_DEV_STYLER_COLOR_PURPLE": "보라색",
  "LIVE_DEV_STYLER_COLOR_MAGENTA": "마젠타",
  "LIVE_DEV_STYLER_COLOR_VIOLET": "바이올렛",
  "LIVE_DEV_STYLER_COLOR_PINK": "분홍색",
  "LIVE_DEV_STYLER_STYLE": "스타일",
  "LIVE_DEV_STYLER_SOLID": "실선",
  "LIVE_DEV_STYLER_DASHED": "파선",
  "LIVE_DEV_STYLER_DOTTED": "점선",
  "LIVE_DEV_STYLER_DOUBLE": "이중선",
  "LIVE_DEV_STYLER_OUTLINE": "외곽선",
  "LIVE_DEV_STYLER_OFFSET": "오프셋",
  "LIVE_DEV_STYLER_BORDER_AND_OUTLINE": "테두리 및 윤곽선",
  "LIVE_DEV_STYLER_BORDER_COLOR": "테두리 색상",
  "LIVE_DEV_STYLER_OUTLINE_COLOR": "윤곽선 색상",
  "LIVE_DEV_STYLER_SIDE": "면",
  "LIVE_DEV_STYLER_PADDING": "패딩",
  "LIVE_DEV_STYLER_MARGIN": "마진",
  "LIVE_DEV_STYLER_SIDES_LINKED": "모든 면 함께 편집",
  "LIVE_DEV_STYLER_SIDES_INDEPENDENT": "각 면 개별 편집",
  "LIVE_DEV_STYLER_LINK_NONE": "독립된 면 - 각 면이 고유한 값을 가짐",
  "LIVE_DEV_STYLER_LINK_PAIRED": "쌍으로 연결 - 상하 연결, 좌우 연결",
  "LIVE_DEV_STYLER_LINK_ALL": "모든 면 연결 - 모든 면에 하나의 값 적용",
  "LIVE_DEV_STYLER_LINK_NONE_SHORT": "독립",
  "LIVE_DEV_STYLER_LINK_PAIRED_SHORT": "쌍으로",
  "LIVE_DEV_STYLER_LINK_ALL_SHORT": "모두 연결",
  "LIVE_DEV_STYLER_LINK_CYCLE_HINT": "클릭하여 면 연결 방식 변경",
  "LIVE_DEV_STYLER_ALL_SIDES": "모두",
  "LIVE_DEV_STYLER_TOP": "위",
  "LIVE_DEV_STYLER_RIGHT": "오른쪽",
  "LIVE_DEV_STYLER_BOTTOM": "아래",
  "LIVE_DEV_STYLER_LEFT": "왼쪽",
  "LIVE_DEV_STYLER_DISPLAY": "디스플레이",
  "LIVE_DEV_STYLER_DIRECTION": "방향",
  "LIVE_DEV_STYLER_JUSTIFY": "정렬",
  "LIVE_DEV_STYLER_ALIGN_ITEMS": "항목 정렬",
  "LIVE_DEV_STYLER_WRAP": "줄 바꿈",
  "LIVE_DEV_STYLER_GAP": "간격",
  "LIVE_DEV_STYLER_COLUMNS": "열",
  "LIVE_DEV_STYLER_ROWS": "행",
  "LIVE_DEV_STYLER_POSITION": "위치",
  "LIVE_DEV_STYLER_Z_INDEX": "제트 인덱스",
  "LIVE_DEV_STYLER_BLOCK": "블록",
  "LIVE_DEV_STYLER_INLINE": "인라인",
  "LIVE_DEV_STYLER_INLINE_BLOCK": "인라인 블록",
  "LIVE_DEV_STYLER_FLEX": "플렉스",
  "LIVE_DEV_STYLER_INLINE_FLEX": "인라인 플렉스",
  "LIVE_DEV_STYLER_GRID": "그리드",
  "LIVE_DEV_STYLER_HIDDEN": "숨김",
  "LIVE_DEV_STYLER_ROW": "로우",
  "LIVE_DEV_STYLER_COLUMN": "컬럼",
  "LIVE_DEV_STYLER_ROW_REVERSE": "행 역순",
  "LIVE_DEV_STYLER_COLUMN_REVERSE": "열 역순",
  "LIVE_DEV_STYLER_START": "시작",
  "LIVE_DEV_STYLER_CENTER": "중앙",
  "LIVE_DEV_STYLER_END": "End",
  "LIVE_DEV_STYLER_SPACE_BETWEEN": "사이 간격",
  "LIVE_DEV_STYLER_SPACE_AROUND": "주위 간격",
  "LIVE_DEV_STYLER_SPACE_EVENLY": "균등 간격",
  "LIVE_DEV_STYLER_STRETCH": "늘리기",
  "LIVE_DEV_STYLER_BASELINE": "기준선",
  "LIVE_DEV_STYLER_NO_WRAP": "줄 바꿈 안 함",
  "LIVE_DEV_STYLER_WRAP_REVERSE": "역방향 줄 바꿈",
  "LIVE_DEV_STYLER_STATIC": "정적",
  "LIVE_DEV_STYLER_RELATIVE": "상대",
  "LIVE_DEV_STYLER_ABSOLUTE": "절대",
  "LIVE_DEV_STYLER_STICKY": "스티키",
  "LIVE_DEV_STYLER_FIXED": "고정",
  "LIVE_DEV_STYLER_PLACEMENT": "배치",
  "LIVE_DEV_STYLER_DISTRIBUTE": "분배",
  "LIVE_DEV_STYLER_PACKED": "팩",
  "LIVE_DEV_STYLER_APPLIES_TO": "적용 대상",
  "LIVE_DEV_STYLER_INLINE_STYLE": "인라인",
  "LIVE_DEV_STYLER_TARGET_INLINE_HINT": "요소에 직접",
  "LIVE_DEV_STYLER_TARGET_COUNT": "페이지의 {0}에 적용됨",
  "LIVE_DEV_STYLER_TARGET_CREATE": "{0}에 새 규칙",
  "LIVE_DEV_STYLER_NEW_RULE": "새 규칙 만들기…",
  "LIVE_DEV_STYLER_NEW_RULE_TITLE": "새 규칙 만들기",
  "LIVE_DEV_STYLER_NEW_ADDS_CLASS": "이 요소에 \"{0}\" 클래스를 추가하고 {1}에 스타일을 저장합니다",
  "LIVE_DEV_STYLER_NEW_ADDS_ID": "이 요소에 \"{0}\" 아이디를 지정하고 {1}에 스타일을 저장합니다",
  "LIVE_DEV_STYLER_NEW_SAVES_ONE": "{0}에 스타일을 저장합니다 - 이 요소에만 스타일을 적용합니다",
  "LIVE_DEV_STYLER_NEW_SAVES_MANY": "{0}에 스타일을 저장합니다 - 페이지의 {1}개 요소에 스타일을 적용합니다",
  "LIVE_DEV_STYLER_NEW_ERR_ID_TAKEN": "다른 요소에 이미 해당 아이디가 있습니다 - 대신 클래스를 사용해 보세요",
  "LIVE_DEV_STYLER_NEW_ERR_NO_MATCH": "이것은 선택된 요소와 일치하지 않으므로 편집해도 변경되지 않습니다",
  "LIVE_DEV_STYLER_NEW_ERR_PSEUDO_ELEMENT": "'::before'와 같은 의사 요소는 여기에서 스타일을 지정할 수 없습니다",
  "LIVE_DEV_STYLER_NEW_ERR_STATE_BASE": ".button:hover와 같이 상태 앞에 클래스 또는 아이디를 추가하세요",
  "LIVE_DEV_STYLER_NEW_STATE_SAVES": "'{0}' 생성 - 편집 내용은 {1} 상태에 적용됩니다",
  "LIVE_DEV_STYLER_NEW_STATE_ADDS_CLASS": "이 요소에 '{0}' 클래스를 추가하고 {1} 상태의 스타일을 지정합니다",
  "LIVE_DEV_STYLER_NEW_STATE_ADDS_ID": "이 요소에 아이디 \"{0}\"을(를) 부여하고 {1} 상태를 스타일링합니다",
  "LIVE_DEV_STYLER_NEW_ERR_INVALID": "유효한 스타일 이름이 아닌 것 같습니다 - .card와 같은 클래스나 #hero와 같은 아이디를 사용해 보세요",
  "LIVE_DEV_STYLER_CREATE": "만들기",
  "LIVE_DEV_STYLER_SELECTOR_PLACEHOLDER": "예: .card 또는 #hero",
  "LIVE_DEV_STYLER_STATE": "상태",
  "LIVE_DEV_STYLER_STATE_PICK": "상태(hover, focus, …) 편집",
  "LIVE_DEV_STYLER_STATE_NORMAL": "일반",
  "LIVE_DEV_STYLER_STATE_BANNER": "{0} 상태 편집 중 — 변경 사항은 {0}에만 적용됩니다",
  "LIVE_DEV_STYLER_STATE_EXIT": "종료",
  "LIVE_DEV_STYLER_STATE_EXIT_NAMED": "{0} 종료",
  "LIVE_DEV_STYLER_STATE_NO_BASE": "상태는 인라인 스타일에 적용할 수 없습니다",
  "LIVE_DEV_STYLER_STATE_HOVER": "호버",
  "LIVE_DEV_STYLER_STATE_FOCUS": "포커스",
  "LIVE_DEV_STYLER_STATE_ACTIVE": "액티브",
  "LIVE_DEV_STYLER_STATE_FOCUS_WITHIN": "포커스 위드인",
  "LIVE_DEV_STYLER_STATE_FOCUS_VISIBLE": "포커스 표시",
  "LIVE_DEV_STYLER_STATE_VISITED": "방문함",
  "LIVE_DEV_STYLER_STATE_TARGET": "대상",
  "LIVE_DEV_STYLER_STATE_CHECKED": "선택됨",
  "LIVE_DEV_STYLER_STATE_DISABLED": "비활성화됨",
  "LIVE_DEV_STYLER_STATE_ENABLED": "활성화됨",
  "LIVE_DEV_STYLER_STATE_PLACEHOLDER_SHOWN": "플레이스홀더 표시됨",
  "LIVE_DEV_STYLER_HEIGHT": "높이",
  "LIVE_DEV_STYLER_SIZE_TAB": "크기",
  "LIVE_DEV_STYLER_MIN_WIDTH": "최소 너비",
  "LIVE_DEV_STYLER_MAX_WIDTH": "최대 너비",
  "LIVE_DEV_STYLER_MIN_HEIGHT": "최소 높이",
  "LIVE_DEV_STYLER_MAX_HEIGHT": "최대 높이",
  "LIVE_DEV_STYLER_MIN": "최소",
  "LIVE_DEV_STYLER_MAX": "최대",
  "LIVE_DEV_STYLER_LIMITS": "최소 / 최대",
  "LIVE_DEV_STYLER_LIMITS_SHOW": "최소/최대 크기 제한 표시",
  "LIVE_DEV_STYLER_LIMITS_HIDE": "최소/최대 크기 제한 숨기기",
  "LIVE_DEV_STYLER_OPACITY": "불투명도",
  "LIVE_DEV_STYLER_CHANGE_UNIT": "단위 변경 - {0} 간에 전환",
  "LIVE_DEV_STYLER_INCREASE_VALUE": "{0} 증가",
  "LIVE_DEV_STYLER_DECREASE_VALUE": "{0} 감소",
  "LIVE_DEV_STYLER_INCREASE": "값 증가",
  "LIVE_DEV_STYLER_DECREASE": "값 감소",
  "LIVE_DEV_STYLER_STEP_HINT": "Shift + 클릭: x10",
  "LIVE_DEV_STYLER_EYEDROPPER": "페이지에서 색상 선택",
  "LIVE_DEV_MORE_OPTIONS_CUT": "오려두기",
  "LIVE_DEV_MORE_OPTIONS_COPY": "복사하기",
  "LIVE_DEV_MORE_OPTIONS_PASTE": "붙여넣기",
  "LIVE_DEV_INSERT_ELEMENT": "요소 삽입",
  "LIVE_DEV_INSERT_BEFORE": "앞에",
  "LIVE_DEV_INSERT_AFTER": "뒤에",
  "LIVE_DEV_INSERT_INSIDE": "안에",
  "LIVE_DEV_INSERT_WRAP": "감싸기",
  "LIVE_DEV_INSERT_SEARCH_PLACEHOLDER": "요소 검색…",
  "LIVE_DEV_INSERT_COMMON": "일반",
  "LIVE_DEV_INSERT_NO_RESULTS": "일치하는 요소 없음",
  "LIVE_DEV_INSERT_SHOW_MORE": "더 보기",
  "LIVE_DEV_INSERT_SHOW_LESS": "간략히 보기",
  "LIVE_DEV_INSERT_CREATE": "{0} 생성",
  "LIVE_DEV_INSERT_NAME_ACCORDION": "아코디언",
  "LIVE_DEV_INSERT_NAME_PASSWORD": "비밀번호",
  "LIVE_DEV_INSERT_NAME_MAIN_CONTENT": "메인 콘텐츠",
  "LIVE_DEV_INSERT_NAME_CODE_BLOCK": "코드 블록",
  "LIVE_DEV_INSERT_NAME_DEF_LIST": "정의 목록",
  "LIVE_DEV_INSERT_NAME_FILE_UPLOAD": "파일 업로드",
  "LIVE_DEV_INSERT_NAME_DATE_PICKER": "날짜 선택기",
  "LIVE_DEV_INSERT_NAME_IFRAME": "아이프레임",
  "LIVE_DEV_STARTER_BAR_LABEL": "페이지가 비어 있습니다 — 요소를 추가하세요",
  ...
  "LIVE_DEV_IMAGE_GALLERY_DIALOG_OVERLAY_MESSAGE": "계속하려면 편집기에서 이미지 다운로드 위치를 선택하세요.",
  "LIVE_DEV_IMAGE_GALLERY_OFFLINE_BANNER": "연결 없음 - 오프라인 모드에서 작업 중",
  ...
  "LIVE_DEV_IMAGE_GALLERY_SIZE_THUMBNAIL": "썸네일",
  "LIVE_DEV_IMAGE_GALLERY_SIZE_XS": "아바타",
  "LIVE_DEV_IMAGE_GALLERY_SIZE_SM": "카드",
  "LIVE_DEV_IMAGE_GALLERY_SIZE_MD": "콘텐츠",
  "LIVE_DEV_IMAGE_GALLERY_SIZE_REGULAR": "표준",
  "LIVE_DEV_IMAGE_GALLERY_SIZE_LG": "히어로",
  "LIVE_DEV_IMAGE_GALLERY_SIZE_XL": "배너",
  "LIVE_DEV_IMAGE_GALLERY_SIZE_RETINA": "레티나",
  ...
  "LIVE_DEV_FORMAT_BOLD": "굵게",
  "LIVE_DEV_FORMAT_ITALIC": "기울임꼴",
  "LIVE_DEV_FORMAT_UNDERLINE": "밑줄",
  "LIVE_DEV_FORMAT_STRIKETHROUGH": "취소선",
  "LIVE_DEV_FORMAT_SUBSCRIPT": "아래 첨자",
  "LIVE_DEV_FORMAT_SUPERSCRIPT": "위 첨자",
  "LIVE_DEV_FORMAT_HIGHLIGHT": "하이라이트",
  "LIVE_DEV_FORMAT_CODE": "코드",
  "LIVE_DEV_FORMAT_SMALL": "작게",
  "LIVE_DEV_FORMAT_MORE": "서식 더 보기",
  "LIVE_DEV_ELEMENT_PROPS_TITLE": "요소 속성",
  "LIVE_DEV_ELEMENT_PROPS_TAG": "태그",
  "LIVE_DEV_ELEMENT_PROPS_VOID_ERROR": "<{0}>는 자체 닫힘 태그이므로 콘텐츠를 가질 수 없습니다",
  "LIVE_DEV_ELEMENT_PROPS_SIZE": "크기",
  "LIVE_DEV_ELEMENT_PROPS_CLASS": "클래스",
  "LIVE_DEV_ELEMENT_PROPS_ID": "아이디",
  "LIVE_DEV_ELEMENT_PROPS_HREF": "링크",
  "LIVE_DEV_ELEMENT_PROPS_ADD_CLASS": "+ 클래스 추가",
  "LIVE_DEV_ELEMENT_PROPS_CLASS_PLACEHOLDER": "클래스 추가…",
  "LIVE_DEV_ELEMENT_PROPS_ID_PLACEHOLDER": "아이디 추가…",
  "LIVE_DEV_ELEMENT_PROPS_SEARCH_TAGS": "태그 제안",
  "LIVE_DEV_ELEMENT_PROPS_COMPUTED": "계산됨:",
  "LIVE_DEV_ELEMENT_PROPS_USE_CUSTOM": "“{0}” 사용",
  "LIVE_DEV_ELEMENT_PROPS_ATTRIBUTES": "속성",
  "LIVE_DEV_ELEMENT_PROPS_ADD_ATTR": "+ 속성 추가",
  "LIVE_DEV_ELEMENT_PROPS_ATTR_NAME": "이름",
  "LIVE_DEV_ELEMENT_PROPS_ATTR_VALUE": "값",
  "LIVE_DEV_ELEMENT_PROPS_LOADING": "로딩 중",
  "LIVE_DEV_ELEMENT_PROPS_NO_CLASSES": "아직 클래스가 없습니다",
  "LIVE_DEV_ELEMENT_PROPS_NO_ATTRIBUTES": "아직 속성이 없습니다",
  "LIVE_DEV_ELEMENT_PROPS_RESETTING": "재설정 중",
  "LIVE_DEV_CB_EXCEEDED_CLASSES": "+{0}개 더 보기",
  "LIVE_DEV_CB_TIP_TEXT_COLOR": "텍스트 색상",
  "LIVE_DEV_CB_TIP_BG_COLOR": "배경색",
  "LIVE_DEV_CB_TIP_FONT": "글꼴",
  "LIVE_DEV_CB_TIP_TEXT_SPACING": "텍스트 간격",
  "LIVE_DEV_CB_TIP_APPEARANCE": "테두리 및 불투명도",
  "LIVE_DEV_CB_TIP_LAYOUT": "레이아웃",
  "LIVE_DEV_CB_TIP_POSITION": "위치",
  "LIVE_DEV_CB_TIP_OBJECT_FIT": "개체 맞춤",
  "LIVE_DEV_CB_TIP_IMAGE": "이미지",
  "LIVE_DEV_CB_CHANGE_IMAGE": "이미지 변경",
  "LIVE_DEV_CB_TIP_LIST_STYLE": "목록 스타일",
  "LIVE_DEV_CB_TIP_ALL_STYLES": "모든 스타일",
  "LIVE_DEV_CB_LABEL_FAMILY": "서체",
  "LIVE_DEV_CB_LABEL_SIZE": "크기",
  "LIVE_DEV_CB_LABEL_WEIGHT": "굵기",
  "LIVE_DEV_CB_LABEL_STYLE": "스타일",
  "LIVE_DEV_CB_LABEL_ALIGN": "텍스트 정렬",
  "LIVE_DEV_CB_LABEL_TRANSFORM": "변형",
  "LIVE_DEV_CB_LABEL_LETTER_SPACING": "글자 간격",
  "LIVE_DEV_CB_LABEL_WORD_SPACING": "단어 간격",
  "LIVE_DEV_CB_LABEL_LINE_HEIGHT": "줄 간격",
  "LIVE_DEV_CB_LABEL_TEXT_INDENT": "텍스트 들여쓰기",
  "LIVE_DEV_CB_LABEL_WIDTH": "너비",
  "LIVE_DEV_CB_LABEL_RADIUS": "반경",
  "LIVE_DEV_CB_LABEL_COLOR": "색상",
  "LIVE_DEV_CB_LABEL_OPACITY": "불투명도",
  "LIVE_DEV_CB_LABEL_DISPLAY": "디스플레이",
  "LIVE_DEV_CB_LABEL_DIRECTION": "방향",
  "LIVE_DEV_CB_LABEL_WRAP": "줄 바꿈",
  "LIVE_DEV_CB_LABEL_JUSTIFY": "정렬",
  "LIVE_DEV_CB_LABEL_GAP": "간격",
  "LIVE_DEV_CB_LABEL_OVERFLOW": "오버플로",
  "LIVE_DEV_CB_LABEL_POSITION": "위치",
  "LIVE_DEV_CB_LABEL_TOP": "위",
  "LIVE_DEV_CB_LABEL_RIGHT": "오른쪽",
  "LIVE_DEV_CB_LABEL_BOTTOM": "아래",
  "LIVE_DEV_CB_LABEL_LEFT": "왼쪽",
  "LIVE_DEV_CB_LABEL_Z_INDEX": "Z-인덱스",
  "LIVE_DEV_CB_LABEL_FIT": "맞춤",
  "LIVE_DEV_CB_LABEL_TYPE": "유형",
  "LIVE_DEV_CB_WEIGHT_THIN": "가는",
  "LIVE_DEV_CB_WEIGHT_REGULAR": "보통",
  "LIVE_DEV_CB_WEIGHT_BOLD": "굵게",
  "LIVE_DEV_CB_WEIGHT_BLACK": "블랙",
  "LIVE_DEV_CB_STYLE_ITALIC": "기울임꼴",
  "LIVE_DEV_CB_STYLE_UNDERLINE": "밑줄",
  "LIVE_DEV_CB_STYLE_STRIKETHROUGH": "취소선",
  "LIVE_DEV_CB_STYLE_OVERLINE": "윗줄",
  "LIVE_DEV_CB_ALIGN_LEFT": "왼쪽",
  "LIVE_DEV_CB_ALIGN_CENTER": "가운데 정렬",
  "LIVE_DEV_CB_ALIGN_RIGHT": "오른쪽",
  "LIVE_DEV_CB_ALIGN_JUSTIFY": "양쪽 정렬",
  "LIVE_DEV_CB_TRANSFORM_NONE": "없음",
  "LIVE_DEV_CB_TRANSFORM_CAPITALIZE": "첫 글자 대문자",
  "LIVE_DEV_CB_TRANSFORM_UPPERCASE": "대문자",
  "LIVE_DEV_CB_TRANSFORM_LOWERCASE": "소문자",
  "LIVE_DEV_CB_SEARCH_FONTS": "글꼴 검색…",
  "LIVE_DEV_CB_BACK": "뒤로",
  "LIVE_DEV_CB_BACK_ESC": "뒤로 (Esc)",
  "LIVE_DEV_CB_RESET": "재설정",
  "LIVE_DEV_CB_APPLIES_TO": "적용 대상:",
  "LIVE_DEV_CB_INLINE": "인라인",
  "LIVE_DEV_CB_LIST_DISC": "디스크",
  "LIVE_DEV_CB_LIST_CIRCLE": "원",
  "LIVE_DEV_CB_LIST_SQUARE": "사각형",
  "LIVE_DEV_CB_LIST_NONE": "없음",
  "LIVE_DEV_CB_LIST_DECIMAL": "십진수",
  "LIVE_DEV_CB_LIST_LOWER_ALPHA": "소문자 알파벳",
  "LIVE_DEV_CB_LIST_UPPER_ALPHA": "대문자 알파벳",
  "LIVE_DEV_CB_LIST_LOWER_ROMAN": "소문자 로마 숫자",
  "LIVE_DEV_CB_LIST_UPPER_ROMAN": "대문자 로마 숫자",
  "LIVE_DEV_CB_LIST_OUTSIDE": "바깥쪽",
  "LIVE_DEV_CB_LIST_INSIDE": "내부",
  "LIVE_DEV_CB_TIP_SPACING": "마진 및 패딩",
  "LIVE_DEV_CB_LABEL_MARGIN": "마진",
  "LIVE_DEV_CB_LABEL_PADDING": "패딩",
  "LIVE_DEV_CB_LABEL_CONTENT": "콘텐츠",
  "LIVE_DEV_CB_SPACING_LINK_INDEPENDENT": "개별",
  "LIVE_DEV_CB_SPACING_LINK_AXIS": "쌍",
  "LIVE_DEV_CB_SPACING_LINK_ALL": "모두 동일",
  "LIVE_DEV_CB_LABEL_BORDER_TOP": "위",
  "LIVE_DEV_CB_LABEL_BORDER_RIGHT": "오른쪽",
  "LIVE_DEV_CB_LABEL_BORDER_BOTTOM": "아래",
  "LIVE_DEV_CB_LABEL_BORDER_LEFT": "왼쪽",
  "LIVE_DEV_CB_LABEL_BORDER_TL": "좌상",
  "LIVE_DEV_CB_LABEL_BORDER_TR": "우상",
  "LIVE_DEV_CB_LABEL_BORDER_BR": "우하",
  "LIVE_DEV_CB_LABEL_BORDER_BL": "좌하",
  "LIVE_DEV_CB_PER_SIDE": "면별",
  "LIVE_DEV_CB_PER_CORNER": "모서리별",
  "LIVE_DEV_CB_COLOR_RECENT": "최근",
  "LIVE_DEV_CB_COLOR_FROM_PAGE": "페이지에서",
  "LIVE_DEV_CB_COLOR_SUGGESTED": "추천",
  "LIVE_DEV_CB_LABEL_COLUMNS": "열",
  "LIVE_DEV_CB_LABEL_ROWS": "행",
  "LIVE_DEV_CB_LABEL_JUSTIFY_ITEMS": "정렬",
  "LIVE_DEV_CB_LABEL_ALIGN_ITEMS": "정렬",
  "LIVE_DEV_CB_LABEL_ROW_GAP": "행 간격",
  "LIVE_DEV_CB_LABEL_COL_GAP": "열 간격",
  "LIVE_DEV_CB_WEIGHT_EXTRA_LIGHT": "엑스트라 라이트",
  "LIVE_DEV_CB_WEIGHT_LIGHT": "라이트",
  "LIVE_DEV_CB_WEIGHT_MEDIUM": "미디엄",
  "LIVE_DEV_CB_WEIGHT_SEMI_BOLD": "세미 볼드",
  "LIVE_DEV_CB_WEIGHT_EXTRA_BOLD": "엑스트라 볼드",
  "LIVE_DEV_CB_GO_TO_SOURCE": "소스로 이동",
  "LIVE_DEV_CB_TIP_AI_STYLE": "AI로 스타일 지정",
  "LIVE_DEV_CB_AI_PLACEHOLDER": "원하는 스타일을 설명하세요…",
  "LIVE_DEV_CB_AI_SEND": "보내기",
  "LIVE_DEV_CB_AI_THINKING": "스타일을 적용하는 중…",
  "LIVE_DEV_CB_MORE_OPTIONS": "추가 옵션",
  "LIVE_DEV_CB_DIM_W": "너",
  "LIVE_DEV_CB_DIM_H": "높",
  "LIVE_DEV_CB_MINMAX_TOOLTIP": "최소/최대 제약 조건",
  "LIVE_DEV_CB_MINMAX_MIN": "최소",
  "LIVE_DEV_CB_MINMAX_MAX": "최대",
  "LIVE_DEV_CB_ID_PLACEHOLDER": "없음",
  "LIVE_DEV_CB_ALL_WEIGHTS": "모든 굵기",
  "LIVE_DEV_CB_ALL_STYLES": "모든 스타일",
  "LIVE_DEV_HB_PARAGRAPH": "단락",
  "LIVE_DEV_HB_HEADING_1": "제목 1",
  "LIVE_DEV_HB_HEADING_2": "제목 2",
  "LIVE_DEV_HB_HEADING_3": "제목 3",
  "LIVE_DEV_HB_HEADING_4": "제목 4",
  "LIVE_DEV_HB_HEADING_5": "제목 5",
  "LIVE_DEV_HB_HEADING_6": "제목 6",
  "LIVE_DEV_HB_SPAN": "스팬",
  "LIVE_DEV_HB_BLOCKQUOTE": "인용문",
  "LIVE_DEV_HB_PREFORMATTED": "서식이 지정된",
  "LIVE_DEV_HB_CODE": "코드",
  "LIVE_DEV_HB_EMPHASIS": "강조",
  "LIVE_DEV_HB_STRONG": "강한 강조",
  "LIVE_DEV_HB_BOLD": "굵게",
  "LIVE_DEV_HB_ITALIC": "기울임꼴",
  "LIVE_DEV_HB_UNDERLINE": "밑줄",
  "LIVE_DEV_HB_STRIKETHROUGH": "취소선",
  "LIVE_DEV_HB_SMALL": "작게",
  "LIVE_DEV_HB_SUBSCRIPT": "아래 첨자",
  "LIVE_DEV_HB_SUPERSCRIPT": "위 첨자",
  "LIVE_DEV_HB_MARK": "강조 표시",
  "LIVE_DEV_HB_ABBREVIATION": "약어",
  "LIVE_DEV_HB_CITATION": "인용",
  "LIVE_DEV_HB_INLINE_QUOTE": "인라인 인용",
  "LIVE_DEV_HB_TIME": "시간",
  "LIVE_DEV_HB_KEYBOARD": "키보드",
  "LIVE_DEV_HB_SAMPLE_OUTPUT": "샘플 출력",
  "LIVE_DEV_HB_VARIABLE": "변수",
  "LIVE_DEV_HB_CONTAINER": "디브",
  "LIVE_DEV_HB_SECTION": "섹션",
  "LIVE_DEV_HB_ARTICLE": "아티클",
  "LIVE_DEV_HB_HEADER": "헤더",
  "LIVE_DEV_HB_FOOTER": "푸터",
  "LIVE_DEV_HB_NAVIGATION": "내비게이션",
  "LIVE_DEV_HB_SIDEBAR": "사이드바",
  "LIVE_DEV_HB_MAIN": "메인",
  "LIVE_DEV_HB_ADDRESS": "주소",
  "LIVE_DEV_HB_IMAGE": "이미지",
  "LIVE_DEV_HB_VIDEO": "비디오",
  "LIVE_DEV_HB_AUDIO": "오디오",
  "LIVE_DEV_HB_PICTURE": "사진",
  "LIVE_DEV_HB_CANVAS": "캔버스",
  "LIVE_DEV_HB_SVG": "에스브이지",
  "LIVE_DEV_HB_FIGURE": "피규어",
  "LIVE_DEV_HB_FIGCAPTION": "캡션",
  "LIVE_DEV_HB_LINK": "링크",
  "LIVE_DEV_HB_BUTTON": "버튼",
  "LIVE_DEV_HB_DETAILS": "세부 정보",
  "LIVE_DEV_HB_SUMMARY": "요약",
  "LIVE_DEV_HB_DIALOG": "대화 상자",
  "LIVE_DEV_HB_UNORDERED_LIST": "순서 없는 목록",
  "LIVE_DEV_HB_ORDERED_LIST": "순서 있는 목록",
  "LIVE_DEV_HB_LIST_ITEM": "목록 항목",
  "LIVE_DEV_HB_DEF_LIST": "정의 목록",
  "LIVE_DEV_HB_DEF_TERM": "정의 용어",
  "LIVE_DEV_HB_DEF_DESC": "정의",
  "LIVE_DEV_HB_FORM": "폼",
  "LIVE_DEV_HB_TEXT_INPUT": "텍스트 입력",
  "LIVE_DEV_HB_TEXT_AREA": "텍스트 영역",
  "LIVE_DEV_HB_DROPDOWN": "드롭다운",
  "LIVE_DEV_HB_OPTION": "옵션",
  "LIVE_DEV_HB_OPTION_GROUP": "옵션 그룹",
  "LIVE_DEV_HB_FIELDSET": "필드셋",
  "LIVE_DEV_HB_LEGEND": "범례",
  "LIVE_DEV_HB_LABEL": "레이블",
  "LIVE_DEV_HB_OUTPUT": "출력",
  "LIVE_DEV_HB_METER": "미터",
  "LIVE_DEV_HB_PROGRESS": "진행률",
  "LIVE_DEV_HB_EMAIL_INPUT": "이메일 입력",
  "LIVE_DEV_HB_PASSWORD_INPUT": "비밀번호 입력",
  "LIVE_DEV_HB_FILE_INPUT": "파일 입력",
  "LIVE_DEV_HB_CHECKBOX": "체크박스",
  "LIVE_DEV_HB_RADIO": "라디오 버튼",
  "LIVE_DEV_HB_NUMBER_INPUT": "숫자 입력",
  "LIVE_DEV_HB_RANGE_INPUT": "범위 슬라이더",
  "LIVE_DEV_HB_DATE_INPUT": "날짜 입력",
  "LIVE_DEV_HB_COLOR_INPUT": "색상 선택기",
  "LIVE_DEV_HB_SEARCH_INPUT": "검색 입력",
  "LIVE_DEV_HB_URL_INPUT": "URL 입력",
  "LIVE_DEV_HB_TEL_INPUT": "전화번호 입력",
  "LIVE_DEV_HB_SUBMIT_BUTTON": "제출 버튼",
  "LIVE_DEV_HB_RESET_BUTTON": "초기화 버튼",
  "LIVE_DEV_HB_HIDDEN_INPUT": "숨겨진 입력",
  "LIVE_DEV_HB_TABLE": "표",
  "LIVE_DEV_HB_TABLE_HEAD": "표 머리글",
  "LIVE_DEV_HB_TABLE_BODY": "테이블 본문",
  "LIVE_DEV_HB_TABLE_FOOT": "테이블 바닥글",
  "LIVE_DEV_HB_TABLE_ROW": "테이블 행",
  "LIVE_DEV_HB_TABLE_HEADER": "테이블 머리글",
  "LIVE_DEV_HB_TABLE_CELL": "테이블 셀",
  "LIVE_DEV_HB_TABLE_CAPTION": "테이블 캡션",
  "LIVE_DEV_HB_COL_GROUP": "열 그룹",
  "LIVE_DEV_HB_COLUMN": "열",
  "LIVE_DEV_HB_IFRAME": "아이프레임",
  "LIVE_DEV_HB_EMBED": "임베드",
  "LIVE_DEV_HB_OBJECT": "객체",
  "LIVE_DEV_HB_DIVIDER": "구분선",
  "LIVE_DEV_HB_LINE_BREAK": "줄 바꿈",
  "LIVE_DEV_HB_SOURCE": "소스",
  "LIVE_DEV_HB_TEMPLATE": "템플릿",
  "LIVE_DEV_HB_SLOT": "슬롯",
  "LIVE_DEV_HB_NOSCRIPT": "노스크립트",
  "LIVE_DEV_HB_SCRIPT": "스크립트",
  "LIVE_DEV_HB_STYLE": "스타일",
  "LIVE_DEV_TOAST_NOT_EDITABLE": "스크립트로 생성된 요소는 편집할 수 없습니다.",
  "LIVE_DEV_COPY_TOAST_MESSAGE": "요소가 복사되었습니다. '붙여넣기'로 선택한 요소 뒤에 추가하세요.",
  "LIVE_DEV_TOAST_FIXED_ELEMENT_DISMISSED": "요소가 페이지에 고정되어 있어 편집 상자가 숨겨집니다.",
  "LIVE_DEV_TOAST_HIDDEN_BY_STYLE": "요소가 숨겨져 있습니다 - {0} 속성 때문입니다",
  "LIVE_DEV_TOAST_HIDDEN_BY_PARENT_STYLE": "요소가 숨겨져 있습니다 - {0}에 {1} 속성이 있습니다",
  "LIVE_DEV_TOAST_HIDDEN_IN_CLOSED": "요소가 숨겨져 있습니다 - {0}이(가) 닫혀 있습니다",
  "LIVE_DEV_TOAST_HIDDEN_NO_SIZE": "요소가 보이지 않습니다 - 크기가 없습니다",
  "LIVE_DEV_TOAST_HIDDEN_CUT_OFF": "요소가 보이지 않습니다 - {0}에 의해 잘렸습니다",
  "LIVE_DEV_TOAST_HIDDEN_OUTSIDE": "요소가 보이지 않습니다 - 표시 영역 밖에 있습니다",
  "LIVE_DEV_TOAST_HIDDEN": "페이지에 요소가 보이지 않습니다",
  ...
  "DEVICE_SIZE_LIMIT_MESSAGE": "모바일, 태블릿, 데스크톱 뷰 간에 전환하려면 Phoenix Pro로 업그레이드하세요.",
  "LAYERS_PANEL_LIMIT_MESSAGE": "페이지 구조를 보고 그 안의 요소를 선택하거나 편집하려면 Phoenix Pro로 업그레이드하세요.",
  "DEVICE_SIZE_NOT_ENOUGH_SPACE": "이 화면은 현재 창 크기에 맞지 않습니다 — 창을 확장해 보세요.",
  "DEVICE_SIZE_CYCLE_NO_FIT": "화면이 너무 작아 다른 기기 크기로 전환할 수 없습니다 — 창 크기를 늘려 주세요.",
  "DEVICE_SIZE_CYCLE_TOOLTIP": "모바일, 태블릿, 데스크톱 간 전환",
  "DEVICE_SIZE_DROPDOWN_TOOLTIP": "모든 기기 크기",
  "DEVICE_SIZE_FIT_TO_SCREEN": "화면에 맞추기",
  ...
  "IMAGE_UPLOAD_LOGIN_REQUIRED_MSG": "문서에 이미지를 업로드하고 삽입하려면 로그인하세요.",
  "IMAGE_UPLOAD_LOGIN_BTN": "로그인",
  "IMAGE_UPLOAD_CONFIRM_TITLE": "이미지 삽입",
  "IMAGE_UPLOAD_CONFIRM_MSG": "이 이미지를 업로드하여 파일에 직접 포함하세요. 그러면 어떤 컴퓨터에서든 작동하며, 마크다운 파일을 공유하거나 옮겨도 이미지가 깨지지 않습니다.",
  "IMAGE_UPLOAD_HOSTED_ON": "이미지는 user-cdn.phcode.site에 호스팅됩니다.",
  "IMAGE_UPLOAD_BTN": "업로드 및 삽입",
  "IMAGE_UPLOAD_DONT_SHOW_AGAIN": "항상 확인 없이 삽입",
  "IMAGE_UPLOAD_UNSUPPORTED_TYPE": "지원되지 않는 이미지 유형: {0}",
  "IMAGE_UPLOAD_LIMIT_TITLE": "Phoenix Pro로 더 많은 이미지 업로드",
  ...
  "LIVE_PREVIEW_SHOW_STYLES_BAR": "스타일 바 표시",
  ...
  "LIVE_PREVIEW_LAYERS_TAB": "레이어",
  "LIVE_PREVIEW_LAYERS_NEEDS_PREVIEW": "레이어 패널에는 라이브 프리뷰가 필요합니다.",
  "LIVE_PREVIEW_LAYERS_OPEN_PREVIEW": "라이브 프리뷰 열기",
  "LIVE_PREVIEW_LAYERS_OPEN_IN_BROWSER": "브라우저에서 열기",
  "LIVE_PREVIEW_LAYERS_NEEDS_HTML": "레이어를 보려면 HTML 파일을 여세요.",
  "LIVE_PREVIEW_LAYERS_CHOOSE_PAGE": "페이지 선택",
  "LIVE_PREVIEW_LAYERS_PICK_HTML": "레이어를 보려면 HTML 파일을 선택하세요.",
  "LIVE_PREVIEW_LAYERS_SEARCH_FILES": "{0}개 파일 검색",
  "LIVE_PREVIEW_LAYERS_NO_FILE_MATCHES": "일치하는 파일이 없습니다.",
  "LIVE_PREVIEW_LAYERS_FILES_TRUNCATED": "처음 {0}개의 파일을 표시합니다.",
  "LIVE_PREVIEW_LAYERS_NEEDS_EDIT_MODE": "레이어 패널에는 편집 모드가 필요합니다.",
  "LIVE_PREVIEW_LAYERS_ENABLE_EDIT_MODE": "편집 모드 켜기",
  "LIVE_PREVIEW_LAYERS_LOAD_FAILED": "레이어 패널을 로드할 수 없습니다. {APP_NAME}을(를) 다시 시작하여 다시 시도하세요.",
  "LIVE_PREVIEW_LAYERS_ELEMENTS": "요소",
  "LIVE_PREVIEW_LAYERS_SEARCH": "요소 검색",
  "LIVE_PREVIEW_LAYERS_NO_MATCHES": "일치하는 요소 없음",
  "LIVE_PREVIEW_LAYERS_TRUNCATED": "상위 {0}개 요소 표시",
  "LIVE_PREVIEW_LAYERS_COLLAPSE_ALL": "모두 접기",
  "LIVE_PREVIEW_LAYERS_EXPAND_LEVEL": "레벨까지 펼치기",
  "LIVE_PREVIEW_LAYERS_LEVEL": "레벨 {0}",
  "LIVE_PREVIEW_LAYERS_LEVEL_ALL": "모든 레벨",
  "LIVE_PREVIEW_LAYERS_SETTINGS": "설정",
  "LIVE_PREVIEW_LAYERS_SHOW_TEXT_NODES": "텍스트 노드 표시",
  "LIVE_PREVIEW_LAYERS_SCROLL_ON_HOVER": "마우스오버 시 미리보기 스크롤",
  "LIVE_PREVIEW_LAYERS_AUTO_COLLAPSE": "요소 자동 축소",
  "LIVE_PREVIEW_LAYERS_MOVE_UP": "위로 이동",
  "LIVE_PREVIEW_LAYERS_MOVE_DOWN": "아래로 이동",
  "LIVE_PREVIEW_LAYERS_CUT_DONE": "오려두기",
  "LIVE_PREVIEW_LAYERS_ADD_ATTRIBUTE": "속성 추가",
  "LIVE_PREVIEW_LAYERS_REMOVE_ATTRIBUTE": "속성 제거",
  "LIVE_PREVIEW_LAYERS_PROPERTIES": "속성",
  "LIVE_PREVIEW_LAYERS_STYLES": "스타일",
  "LIVE_PREVIEW_LAYERS_MAXIMIZE_SECTION": "섹션 확장",
  "LIVE_PREVIEW_LAYERS_RESTORE_SECTIONS": "섹션 복원",
  "LIVE_PREVIEW_LAYERS_NO_SELECTION_PROPERTIES": "요소를 선택하여 속성을 확인하세요",
  "LIVE_PREVIEW_LAYERS_NO_SELECTION_STYLES": "요소를 선택하여 스타일을 확인하세요",
  "LIVE_PREVIEW_LAYERS_NOT_IN_SOURCE": "이 요소는 소스 파일에 없습니다",
  "LIVE_PREVIEW_LAYERS_NO_STYLES": "적용된 스타일 없음",
  "LIVE_PREVIEW_LAYERS_OPEN_SOURCE": "에디터에서 열기",
  "LIVE_PREVIEW_LAYERS_RULE_INACTIVE": "현재 상태에서 비활성",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_IMPORTANT": "{1}({2})의 {0}에 의해 재정의됨",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_IN_RULE": "이 규칙의 이후 {0} 선언에 의해 재정의됨",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_INLINE": "요소의 인라인 스타일({0})에 의해 재정의됨",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_SPECIFIC": "더 구체적인 규칙 {0}({1})에 의해 재정의됨",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_LATER": "구체성은 동일하지만 나중에 선언된 {0}({1})에 의해 재정의됨",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_JUMP": "클릭하여 우선 적용된 선언으로 이동",
  "LIVE_PREVIEW_LAYERS_EDIT_STYLE": "스타일 바에서 편집",
  "LIVE_PREVIEW_LAYERS_STYLES_BAR_POPPED_OUT": "스타일 바가 브라우저 미리보기에서 열렸습니다",
  "LIVE_PREVIEW_LAYERS_ADD_DECLARATION": "선언 추가",
  "LIVE_PREVIEW_LAYERS_REMOVE_DECLARATION": "선언 제거",
  "LIVE_PREVIEW_LAYERS_EDIT_DECLARATION": "선언 편집",
  "LIVE_PREVIEW_LAYERS_SHOW_SCRIPT_NODES": "스크립트로 생성된 요소 표시",
  "LIVE_PREVIEW_LAYERS_SCRIPT_GENERATED": "스크립트로 생성되어 소스 파일에 없음",
  "LIVE_PREVIEW_LAYERS_HOVER_HIDDEN": "{0} (숨김)",
  "LIVE_PREVIEW_LAYERS_INSERT_ELEMENT": "요소 삽입",
  "LIVE_PREVIEW_LAYERS_CHANGE_COLOR": "색상 변경: {0}",
  "LIVE_PREVIEW_LAYERS_COPY_DECLARATION": "속성 복사",
  "LIVE_PREVIEW_LAYERS_COPY_RULE": "규칙 복사",
  "LIVE_PREVIEW_LAYERS_PASTE_PROPERTIES": "속성 붙여넣기",
  "LIVE_PREVIEW_LAYERS_PASTE": "붙여넣기",
  "LIVE_PREVIEW_LAYERS_STYLES_MENU_HINT": "마우스 오른쪽 버튼을 클릭하여 스타일을 복사하거나 붙여넣으세요",
  "LIVE_PREVIEW_LAYERS_PASTE_INVALID": "CSS 속성 또는 한 번에 하나의 전체 선택자를 붙여넣으세요.",
  "LIVE_PREVIEW_LAYERS_PASTE_FAILED": "이 속성을 붙여넣을 수 없습니다. 다시 시도하세요.",
  "LIVE_PREVIEW_LAYERS_PASTED": "{0}에 속성을 붙여넣었습니다",
  "LIVE_PREVIEW_LAYERS_COPY_FAILED": "이 스타일을 복사할 수 없습니다. 다시 시도하세요.",
  "LIVE_PREVIEW_LAYERS_INSERT_POSITION": "배치",
  "LIVE_PREVIEW_LAYERS_INSERT_INTO_PAGE": "페이지에 추가",
  "LIVE_PREVIEW_LAYERS_INSERT_LOADING": "요소를 불러오는 중…",
  "LIVE_PREVIEW_LAYERS_INSERT_UNAVAILABLE": "실시간 미리 보기가 응답하지 않았습니다. 잠시 후 다시 시도하세요.",
  "LIVE_PREVIEW_LAYERS_LOADING": "요소 로드 중…",
  "LIVE_PREVIEW_LAYERS_UNAVAILABLE": "라이브 미리보기가 응답하지 않았습니다",
  "LIVE_PREVIEW_LAYERS_RETRY": "다시 시도",
  "LIVE_PREVIEW_LAYERS_NOT_RESPONDING": "실시간 미리 보기가 응답하지 않습니다.",
  "LIVE_PREVIEW_LAYERS_RELOAD_PREVIEW": "미리 보기 새로 고침",
  "LIVE_PREVIEW_LAYERS_EMPTY_PAGE": "이 페이지에는 아직 요소가 없습니다.",
  "LIVE_PREVIEW_LAYERS_ADD_ELEMENT": "요소 추가",
  "LIVE_PREVIEW_LAYERS_EMPTY_PAGE_PROPERTIES": "페이지가 비어 있습니다. 요소를 추가하여 속성을 확인하세요.",
  "LIVE_PREVIEW_LAYERS_EMPTY_PAGE_STYLES": "페이지가 비어 있습니다. 요소를 추가하여 스타일을 확인하세요.",
  "LIVE_PREVIEW_LAYERS_SHOW_SELECTED": "선택한 요소 표시",
  "LIVE_PREVIEW_LAYERS_SCRUB_HINT": "드래그하여 조정하세요. 편집 중에는 스크롤하거나 화살표 키를 사용하세요. Shift: 더 큰 단위, Alt: 더 작은 단위",
  "LIVE_PREVIEW_LAYERS_PROPERTY_PLACEHOLDER": "속성",
  "LIVE_PREVIEW_LAYERS_VALUE_PLACEHOLDER": "값",
  ...
  "ERRORS_PANEL_TITLE_INFO_SUFFIX": "{0} ({1} 정보)",
  ...
  "CMD_RELOAD_LIVE_PREVIEW": "실시간 미리보기 새로 고침",
  ...
  "DOC_COMMENT_ADD_JSDOC": "제이에스독 주석 추가",
  "DOC_COMMENT_ADD_PHPDOC": "피에이치피독 주석 추가",
  "DOC_COMMENT_ADD_JAVADOC": "자바독 주석 추가",
  "DOC_COMMENT_ADD_DOXYGEN": "독시젠 주석 추가",
  "DOC_COMMENT_ADD_DOCSTRING": "독스트링 추가",
  "DOC_COMMENT_SUMMARY": "설명",
  "DOC_COMMENT_DESC": "설명",
  ...
  "CMD_TOGGLE_LP_FULL_SCREEN": "라이브 프리뷰 전체 화면 전환",
  "LIVE_PREVIEW_FULL_SCREEN": "라이브 프리뷰 전체 화면으로 확장",
  "LIVE_PREVIEW_EXIT_FULL_SCREEN": "전체 화면 종료",
  ...
  "CMD_VIEW_TERMINAL": "터미널",
  "CMD_VIEW_ENABLE_AI": "AI 활성화",
  ...
  "CMD_OPEN_IN_INTEGRATED_TERMINAL": "통합 터미널",
  ...
  "ABOUT_TEXT_PRO_BUILD": "Phoenix Pro 빌드:",
  ...
  "UPDATE_FAILED_MESSAGE": "모든 {APP_NAME} 앱 창을 닫고 애플리케이션을 다시 시작하여 업데이트를 재시도하세요. <br/> 또는 <a href='https://phcode.dev'>phcode.dev</a>에서 설치 프로그램을 다운로드하여 업데이트를 설치할 수도 있습니다.",
  ...
  "CMD_PHOENIX_BUILDER_CONNECT": "Phoenix 빌더 MCP…",
  ...
  "JUMPTO_DEFINITION_SELECT_TARGET": "정의를 선택하세요",
  "JUMPTO_DEFINITION_LINE_LABEL": "줄 {0}",
  "JUMPTO_DEFINITION_IMPLEMENTATION_BADGE": "구현",
  "CMD_SHOW_PARAMETER_HINT": "파라메터 정보를 표시",
  "NO_ARGUMENTS": "<매개변수가 없습니다>",
  "CODE_HINT_IMPORT_FROM_N": "{0}개의 가져오기…",
  "CODE_HINT_IMPORT_CHOOSE": "<code>{1}</code>을(를) 가져올 모듈을 {0}개 중에서 선택하세요.",
  ...
  "DESCRIPTION_CODE_INTEL_AUTO_CREATE": "`false`로 설정하면 프로젝트를 열 때 {APP_NAME}이 코드 인텔리전스를 위해 `jsconfig.json/tsconfig.json` 파일을 생성하는 것을 중지합니다. 생성된 설정 파일을 삭제한 경우, 문제 패널에서 코드 인텔리전스를 다시 활성화할 수 있습니다.",
  ...
  "DESCRIPTION_ESLINT_USE_NATIVE_APP": "ESLint는 데스크톱 앱에서만 사용할 수 있습니다. <a href='https://phcode.dev'>phcode.dev</a>에서 다운로드하세요.",
  ...
  "DESCRIPTION_SHOW_CODE_HINT_DOCS": "코드 힌트 옆에 표시되는 문서 팝업을 숨기려면 false로 설정하세요",
  "DESCRIPTION_SHOW_PARAMETER_HINTS": "함수 호출 내에서 입력할 때 표시되는 매개변수 힌트 팝업을 비활성화하려면 false로 설정하세요",
  ...
  "DESCRIPTION_LIVEDEV_MAIN_HEADING": "이런!<br>현재 브라우저에서는 실시간 미리보기를 지원하지 않습니다.",
  "DESCRIPTION_LIVEDEV_MAIN_SPAN": "{0}에서 Windows, Mac, Linux용 네이티브 앱을 다운로드하여 최고의 실시간 미리보기 환경을 경험해 보세요.",
  ...
  "FIND_ALL_REFERENCES": "사용 위치 찾기",
  "CODE_INTEL_JS": "자바스크립트",
  "CODE_INTEL_TS": "타입스크립트",
  "CODE_INTEL_ENABLED_TITLE": "{0} 코드 인텔리전스 활성화됨",
  "CODE_INTEL_ENABLED_MESSAGE": "이제 이 프로젝트의 모든 파일에서 사용 위치 찾기, 이름 바꾸기, 정의로 이동 기능이 작동합니다.",
  "CODE_INTEL_SEE_CONFIG": "구성 보기",
  "CODE_INTEL_ENABLE_TS": "타입스크립트 활성화",
  "CODE_INTEL_LEARN_MORE": "더 알아보기",
  "CODE_INTEL_PANEL_TEXT": "프로젝트 전체에 대한 코드 인텔리전스 기능이 꺼져 있습니다. 이 기능을 활성화하면 모든 파일에서 사용 위치 찾기, 이름 바꾸기, 정의로 이동을 사용할 수 있으며, 프로젝트 루트에 jsconfig.json 파일이 추가됩니다.",
  "CODE_INTEL_PANEL_ENABLE": "활성",
  "CODE_INTEL_PANEL_DISMISS": "닫기",
  "PHP_INSTALL_TITLE": "PHP 코드 인텔리전스",
  "PHP_INSTALLING": "PHP 지원 설정 중 — 언어 서버 다운로드 중 (9 MB)…",
  "PHP_INSTALL_DONE": "PHP 코드 인텔리전스가 준비되었습니다.",
  "PHP_INSTALL_FAILED": "PHP 지원을 설정할 수 없습니다: {0}. 다음에 PHP 파일을 열 때 {APP_NAME}에서 다시 시도합니다.",
  "PHP_INSTALL_STOP": "PHP 지원 설정 중단 ({APP_NAME}이(가) 다음 실행 시 다시 시도합니다)",
  "PHP_INSTALL_WAITING_NETWORK": "PHP 지원 설정을 위한 인터넷 연결 대기 중…",
  "DESCRIPTION_PHP_CODE_INTELLIGENCE": "false로 설정 시 PHP 코드 인텔리전스(Intelephense)가 비활성화됩니다. 다시 true로 설정하면 언어 서버가 자동으로 다시 다운로드됩니다.",
  "DESCRIPTION_PHP_LICENSE_KEY": "이름 바꾸기, 코드 작업과 같은 프리미엄 기능을 활성화하는 인텔리펜스 프리미엄 라이선스 키(또는 키 파일의 절대 경로)입니다. 라이선스가 표준 전역 인텔리펜스 라이선스 파일에 이미 있다면 필요하지 않습니다.",
  "PYTHON_INSTALL_TITLE": "파이썬 코드 인텔리전스",
  "PYTHON_INSTALLING": "Python 지원 설정 중 — 언어 도구 다운로드 중 (25 MB)…",
  "PYTHON_INSTALL_DONE": "파이썬 코드 인텔리전스가 준비되었습니다.",
  "PYTHON_INSTALL_FAILED": "파이썬 지원을 설정하지 못했습니다: {0}. 다음에 파이썬 파일을 열 때 {APP_NAME}에서 다시 시도합니다.",
  "PYTHON_INSTALL_STOP": "Python 지원 설정 중단 ({APP_NAME}이(가) 다음 실행 시 다시 시도합니다)",
  "PYTHON_INSTALL_WAITING_NETWORK": "Python 지원 설정을 위한 인터넷 연결 대기 중…",
  "DESCRIPTION_PYTHON_CODE_INTELLIGENCE": "false로 설정 시 Python 코드 인텔리전스(Pyrefly)가 비활성화됩니다. 다시 true로 설정하면 언어 서버가 자동으로 다시 다운로드됩니다.",
  "DESCRIPTION_TYPESCRIPT_CODE_INTELLIGENCE": "자바스크립트/타입스크립트 코드 인텔리전스(완성, 호버 문서, 정의로 이동, 진단)를 비활성화하려면 false로 설정하세요",
  "DESCRIPTION_JSON_CODE_INTELLIGENCE": "JSON 코드 인텔리전스(스키마 기반 완성, 호버 문서 및 유효성 검사)를 비활성화하려면 false로 설정하세요",
  "DESCRIPTION_LSP_CODE_INTELLIGENCE": "{0} 언어 서버를 비활성화하려면 false로 설정하세요",
  "NPM_VULN_PROVIDER_NAME": "npm 보안 권고",
  "NPM_VULN_MESSAGE": "{0}@{1}에 취약점이 있습니다: {2} ({3} 심각도)",
  "NPM_SEVERITY_CRITICAL": "치명적",
  "NPM_SEVERITY_HIGH": "높음",
  "NPM_SEVERITY_MODERATE": "보통",
  "NPM_SEVERITY_LOW": "낮음",
  "NPM_HINT_LATEST_MINOR": "최신, 마이너 업데이트 허용",
  "NPM_HINT_LATEST_PATCH": "최신, 패치 업데이트만 허용",
  "NPM_HOVER_HOMEPAGE": "홈페이지 열기",
  "NPM_HOVER_VIEW_DOCS": "문서 보기",
  "CODE_INTEL_CFG_TITLE": "코드 인텔리전스",
  "CODE_INTEL_CFG_ALL_OPTIONS": "모든 옵션…",
  "CODE_INTEL_CFG_CHECK_JS": "자바스크립트 타입 검사",
  "CODE_INTEL_CFG_CHECK_JS_SUB": "JS 파일에서 타입 오류 찾기",
  "CODE_INTEL_CFG_CHECK_JS_INFO": "자바스크립트의 오타 및 타입 실수를 찾아 문제 패널에 표시합니다. 경고만 표시되며 코드는 변경 없이 실행됩니다.",
  "CODE_INTEL_CFG_CHECK_JS_EG_CODE": "console.lgo(\"hi\")",
  "CODE_INTEL_CFG_CHECK_JS_EG_TEXT": "플래그 지정됨: 'log'를 의미했나요?",
  "CODE_INTEL_CFG_AUTO_TYPES": "타입 자동 다운로드",
  "CODE_INTEL_CFG_AUTO_TYPES_SUB": "npm을 통해 타이핑 가져오기",
  "CODE_INTEL_CFG_AUTO_TYPES_INFO": "npm 패키지에 대한 코드 힌트는 npm install을 실행하기 전에도 작동합니다. npm과 인터넷이 필요하며, 다운로드된 파일은 프로젝트 외부에 캐시됩니다.",
  "CODE_INTEL_CFG_AUTO_MANAGE": "{APP_NAME}에서 관리",
  "CODE_INTEL_CFG_AUTO_MANAGE_SUB": "이 파일을 자동으로 최신 상태로 유지합니다.",
  "CODE_INTEL_CFG_AUTO_MANAGE_INFO": "{APP_NAME}이(가) 코드 인텔리전스가 바로 작동하도록 이 파일을 최적화된 상태로 유지합니다. 이 기능을 끄면 파일을 직접 사용자 지정할 수 있으며, 그러면 {APP_NAME}은(는) 이 파일을 절대 수정하지 않습니다.",
  "CODE_INTEL_CFG_TARGET": "대상",
  "CODE_INTEL_CFG_TARGET_SUB": "코드가 사용하는 JS 버전",
  "CODE_INTEL_CFG_TARGET_ES5": "레거시 브라우저 (IE11 시대)",
  "CODE_INTEL_CFG_TARGET_ES2015": "클래스, 화살표 함수, let/const",
  "CODE_INTEL_CFG_TARGET_ES2017": "async/await",
  "CODE_INTEL_CFG_TARGET_ES2020": "옵셔널 체이닝 a?.b, 널 병합 ??",
  "CODE_INTEL_CFG_TARGET_ES2022": "클래스 필드, 최상위 await",
  "CODE_INTEL_CFG_TARGET_ESNEXT": "모든 최신 기능",
  "CODE_INTEL_CFG_TARGET_FOOT": "이전 타겟은 최신 문법을 오류로 표시합니다. 코드를 구형 엔진에서 실행해야 하는 경우가 아니라면 가장 최신 타겟을 선택하세요.",
  "CODE_INTEL_CFG_MODULE": "모듈",
  "CODE_INTEL_CFG_MODULE_SUB": "import 및 require() 해석 방식",
  "CODE_INTEL_CFG_MODULE_PRESERVE": "import 및 require() 모두 이해, 파일 확장자 규칙 없음 — 편집에 최적",
  "CODE_INTEL_CFG_MODULE_ESNEXT": "최신 import/export 시맨틱",
  "CODE_INTEL_CFG_MODULE_NODENEXT": "Node의 엄격한 ESM 규칙 — 파일 확장자 필수, package.json \"type\" 준수",
  "CODE_INTEL_CFG_MODULE_COMMONJS": "기존 require()/module.exports 프로젝트",
  "CODE_INTEL_CFG_JSX": "JSX",
  "CODE_INTEL_CFG_JSX_SUB": ".jsx 및 .tsx 파일의 JSX 처리 방식",
  "CODE_INTEL_CFG_JSX_REACT_JSX": "최신 런타임(React 17 이상) — React 가져오기 필요 없음",
  "CODE_INTEL_CFG_JSX_REACT": "React.createElement로 컴파일 — React 가져오기 필요",
  "CODE_INTEL_CFG_JSX_PRESERVE": "다른 도구(예: 번들러)를 위해 JSX를 그대로 둠",
  "CODE_INTEL_CFG_JSX_OFF_INFO": "JSX 처리 없음",
  "CODE_INTEL_CFG_JSX_OFF": "끄기",
  "CODE_INTEL_CFG_CURRENT_VALUE": "(현재: {0})",
  "CODE_INTEL_CFG_ORIGIN_NOTE": "{APP_NAME}에서 프로젝트 전반의 코드 인텔리전스를 지원하기 위해 이 파일을 생성했습니다. 이 파일을 삭제하면 해당 기능이 꺼지며, 언제든지 {0}에서 다시 활성화할 수 있습니다.",
  "CODE_INTEL_CFG_PROBLEMS_PANEL": "문제 패널",
  "CODE_INTEL_CFG_AUTO_CREATE": "새 프로젝트에서 자동으로 구성 파일 생성",
  "CODE_INTEL_CFG_READ_ONLY": "이 파일에는 사용자 지정 서식 또는 주석이 있으니 JSON을 직접 편집하세요.",
  ...
  "BOTTOM_PANEL_MINIMIZE": "패널 최소화",
  "BOTTOM_PANEL_SHOW": "하단 패널 표시",
  "BOTTOM_PANEL_HIDE_TOGGLE": "하단 패널 숨기기",
  "BOTTOM_PANEL_DEFAULT_TITLE": "도구",
  "BOTTOM_PANEL_DEFAULT_HEADING": "도구",
  ...
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>사파리는 7일 동안 재방문하지 않은 웹사이트의 데이터를 자동으로 삭제합니다. {APP_NAME}는 브라우저 저장소를 사용하여 프로젝트를 저장하므로 이 정책에 따라 프로젝트가 삭제될 수 있습니다. <br/> <br/><strong>macOS 데스크톱 앱을 다운로드</strong>하시려면 <a href='https://phcode.dev' target='_blank' style='color: white'>https://phcode.dev</a>를 방문하세요.</span>",
  ...
  "PHOENIX_TOUR_DESIGN_MODE": "여기를 클릭하여 디자인 모드로 들어가세요. 전체 화면으로 페이지를 시각적으로 편집할 수 있습니다.",
  "PHOENIX_TOUR_AI_PANEL": "AI로 레이아웃을 디자인하고, 버그를 수정하며, 더 빠르게 빌드하세요. 여기를 클릭하여 AI 패널을 여세요.",
  "PHOENIX_TOUR_NEW_PROJECT": "여기에서 프로젝트를 열거나 새로 생성하세요.",
  "PHOENIX_TOUR_EDIT_MODE": "편집 모드를 사용하면 실시간 미리보기에서 페이지를 직접 수정할 수 있습니다. 요소를 클릭하여 검사하고 인라인으로 편집하세요.",
  "PHOENIX_TOUR_STEP_OF": "{1}개 중 {0}번째",
  "PHOENIX_TOUR_NEXT_BTN": "다음",
  "PHOENIX_TOUR_DISMISS_BTN": "닫기",
  ...
  "DESCRIPTION_ENABLE_AI": "AI 기능을 활성화하려면 true, 완전히 비활성화하려면 false로 설정합니다.",
  ...
  "TERMINAL_CLOSE_SINGLE_MSG": "이 터미널에 활성 프로세스가 있습니다. 터미널을 닫으면 프로세스가 중지됩니다.<br>계속하시겠습니까?",
  "TERMINAL_CLOSE_SINGLE_BTN": "터미널 닫기",
  "TERMINAL_CLOSE_ALL_TITLE": "모든 터미널을 닫으시겠습니까?",
  "TERMINAL_CLOSE_ALL_MSG": "모든 터미널이 닫힙니다.<br>실행 중인 활성 프로세스가 없습니다.<br><br>계속하시겠습니까?",
  "TERMINAL_CLOSE_ALL_BTN": "모두 닫기",
  "TERMINAL_CLOSE_ALL_MSG_PROCESS_ONE": "모든 터미널이 닫힙니다.<br>1개의 활성 프로세스가 중지됩니다.<br><br>계속하시겠습니까?",
  "TERMINAL_CLOSE_ALL_MSG_PROCESS_MANY": "모든 터미널이 닫힙니다.<br>{0}개의 활성 프로세스가 중지됩니다.<br><br>계속하시겠습니까?",
  ...
  "PROMO_CARD_2_MESSAGE": "코드를 넘어 당신이 보는 것을 그대로 보는 AI입니다. 레이아웃 생성과 까다로운 UI 문제 해결을 도우며, 당신이 창의적인 작업에 집중할 수 있도록 합니다.",
  "PROMO_CARD_3": "모든 기기에서 페이지 보기",
  "PROMO_CARD_3_MESSAGE": "휴대폰, 태블릿, 데스크톱 보기 간에 즉시 전환하여 반응형 문제를 조기에 발견하세요.",
  "PROMO_CARD_4": "마크다운을 실제 문서처럼",
  "PROMO_CARD_4_MESSAGE": "표, 이미지, 서식을 시각적으로 편집하세요. 마크다운으로 작업하는 더 쉬운 방법입니다.",
  "PROMO_CARD_5": "페이지를 시각적으로 스타일링하세요",
  "PROMO_CARD_5_MESSAGE": "실시간 미리보기에서 글꼴, 색상, 테두리, 간격, 레이아웃을 바로 변경하면 CSS가 실시간으로 업데이트됩니다.",
  ...
  "PROMO_PRO_CONTINUE_ON_FREE": "무료로 계속 사용",
  ...
  "PRO_TRIAL_ENDING_TITLE": "회원님의 {0} 업그레이드가 {1}일 후에 종료됩니다",
  "PRO_TRIAL_ENDING_TITLE_TOMORROW": "회원님의 {0} 업그레이드가 내일 종료됩니다",
  "PRO_TRIAL_ENDING_MESSAGE": "{0}일 후에 자동으로 <b>무료 커뮤니티 에디션으로 전환됩니다</b>. <br>지금 업그레이드하여 다음 Pro 기능을 계속 사용하세요:",
  "PRO_TRIAL_ENDING_MESSAGE_TOMORROW": "내일 자동으로 <b>무료 커뮤니티 에디션으로 전환됩니다</b>. <br>지금 업그레이드하여 다음 Pro 기능을 계속 사용하세요:",
  "GET_PRO_NOT_NOW": "나중에",
  "GET_PHOENIX_PRO": "Phoenix Pro 받기",
  "OFF_HOURS_ENDING_TITLE": "{0}가 곧 종료됩니다",
  "OFF_HOURS_ENDING_MSG": "무료 {0} 세션이 곧 종료됩니다. 하루 종일 Pro 기능을 계속 사용하려면 <a href=\"{1}\">{2}를 구매</a>하세요.",
  "OFF_HOURS_ENDED_TITLE": "{0}가 종료되었습니다",
  "OFF_HOURS_ENDED_MSG": "무료 {0} 세션이 종료되었습니다. Pro 기능을 계속 사용하려면 <a href=\"{1}\">{2}를 구매</a>하세요.",
  "OFF_HOURS_LOGIN_TITLE": "이제 {0}가 무료입니다",
  "OFF_HOURS_LOGIN_MSG": "{0}: {1}는 매일 {2} 동안 무료입니다. 로그인하여 사용하세요.",
  "OFF_HOURS_LOGIN_BTN": "로그인",
  "OFF_HOURS_DONT_SHOW_AGAIN": "다시 표시 안 함",
  "OFF_HOURS_NAV_TOOLTIP": "{0} — 개인 시간({1})에는 Phoenix Pro를 무료로 사용할 수 있습니다.",
  "OFF_HOURS_TIME_LEFT_HOURS": "{0}시간 남음",
  "OFF_HOURS_TIME_LEFT_MINUTES": "{0}분 남음",
  "OFF_HOURS_DURATION_HOURS": "{0}시간",
  "OFF_HOURS_DURATION_MINUTES": "{0}분",
  "OFF_HOURS_POPUP_ACTIVE": "{0}: {1} 남음",
  "OFF_HOURS_POPUP_LOGIN_ACTIVE": "로그인하여 {0} 이용하기: {1} 남음",
  "OFF_HOURS_POPUP_UPCOMING": "{0}가 {1} 후에 시작됩니다.",
  "OFF_HOURS_EXPLAIN_TITLE": "{0}란 무엇인가요?",
  "OFF_HOURS_EXPLAIN_MSG": "{0}는 사용자 현지 시각 기준 <b>{1}</b>인 개인 업무 외 시간 동안 모두에게 무료입니다. 이 시간 동안에는 구독 없이 에디터를 사용하기만 하면 됩니다.",
  "OFF_HOURS_EXPLAIN_ACTIVE": "지금은 무료입니다 — {0} 남았습니다!",
  "OFF_HOURS_EXPLAIN_LOGIN_ACTIVE": "지금은 무료입니다 — {0} 남았습니다. 로그인하여 사용하세요!",
  "OFF_HOURS_EXPLAIN_UPCOMING": "다음 무료 세션은 {0} 후에 시작됩니다.",
  "OFF_HOURS_WAIT_BTN": "기다리기",
  "OFF_HOURS_KEEP_CODING_BTN": "계속 코딩하기",
  "MANAGE_LICENSE_DIALOG_TITLE": "라이선스 관리",
  "LICENSE_ACCOUNT_HEADING": "계정 라이선스",
  "LICENSE_DEVICE_HEADING": "디바이스 라이선스",
  "LICENSE_SIGN_IN": "로그인",
  "LICENSE_PLAN_UNKNOWN": "알 수 없음",
  "LICENSE_GET_PRO": "Phoenix Pro 시작하기",
  "LICENSE_MANAGE_ACCOUNT": "계정 관리",
  "LICENSE_KEY": "라이선스 키",
  "LICENSE_KEY_PROMPT": "디바이스 라이선스 키가 있으신가요?",
  "LICENSE_KEY_PLACEHOLDER": "라이선스 키를 입력하세요…",
  "LICENSE_KEY_ACTIVATE": "활성화",
  ...
  "LICENSE_ACTIVATE_FAIL_APPLY": "디바이스에 라이선스를 적용하지 못했습니다.",
  "LICENSE_ENTER_KEY": "라이선스 키를 입력해 주세요",
  "LICENSE_REACTIVATE": "라이선스 재활성화",
  "LICENSE_DEACTIVATE": "비활성화",
  "LICENSE_DEACTIVATING": "비활성화 중…",
  "LICENSE_DEACTIVATE_SUCCESS": "이 기기에서 라이선스가 비활성화되었습니다. 변경 사항을 적용하려면 {APP_NAME}을(를) 다시 시작하세요.",
  "LICENSE_DEACTIVATE_FAIL": "이 기기에서 라이선스 비활성화에 실패했습니다.",
  "LICENSE_NOT_ACTIVATED_HERE": "이 라이선스는 현재 기기에서 비활성화 상태입니다. '라이선스 재활성화'를 클릭해야 Phoenix Pro 기능을 사용할 수 있습니다.",
  "LICENSE_STATUS_NOT_ACTIVATED_HERE": "사용 가능, 활성화되지 않음",
  ...
  "AI_DISABLE_CONFIRM_TITLE": "AI를 비활성화하시겠습니까?",
  "AI_DISABLE_CONFIRM_MESSAGE": "모든 인공지능 기능을 끕니다. 인공지능 패널이 제거되고 {APP_NAME}의 인공지능 서비스 연결이 중단됩니다.<br><br>이 변경 사항을 적용하기 위해 지금 {APP_NAME}을(를) 다시 시작합니다. 저장하지 않은 파일이 있으면 저장하라는 메시지가 표시됩니다.",
  "AI_DISABLE_CONFIRM_BTN": "인공지능 비활성화 및 다시 시작",
  "AI_ENABLE_CONFIRM_TITLE": "AI를 활성화하시겠습니까?",
  "AI_ENABLE_CONFIRM_MESSAGE": "인공지능 기능을 다시 켜고 인공지능 패널을 복원합니다.<br><br>이 변경 사항을 적용하기 위해 지금 {APP_NAME}을(를) 다시 시작합니다. 저장하지 않은 파일이 있으면 저장하라는 메시지가 표시됩니다.",
  "AI_ENABLE_CONFIRM_BTN": "인공지능 활성화 및 다시 시작",
  "AI_CHAT_TITLE": "Claude Code",
  "AI_CHAT_MODE_CHAT": "Claude Code",
  "AI_CHAT_MODE_CLI": "Claude Code CLI",
  "AI_CHAT_MODE_CODEX_CLI": "코덱스 CLI",
  "AI_CHAT_START_TYPE_HINT": "시작하려면 여기에 입력하세요",
  "AI_CHAT_START_GREETING": "{0}님, 안녕하세요,",
  "AI_CHAT_START_TITLE": "오늘은 무엇을 만들어 볼까요?",
  "AI_CHAT_START_SURPRISE_TITLE": "깜짝 제안",
  "AI_CHAT_START_SURPRISE_DESC": "무엇을 할 수 있는지 데모를 보여주세요",
  "AI_CHAT_START_SURPRISE_CHOICE_DESC": "다른 데모를 보거나, 실시간으로 무언가를 만들어 달라고 요청하세요",
  "AI_CHAT_START_MAKE_NEW": "새로 만들기",
  "AI_CHAT_START_ANOTHER_DEMO": "다른 데모 보기",
  "AI_CHAT_START_MAKE_NEW_NOTE": "새로운 것을 만들면 AI 크레딧이 사용됩니다. 크레딧을 사용하지 않으려면 데모를 선택하세요.",
  "AI_CHAT_START_DEMO_LINK": "데모를 원하시나요? {0}.",
  "AI_CHAT_START_DEMO_LINK_LABEL": "아무거나 보여주세요",
  "AI_CHAT_SEE_DEMO_DESC": "데모 보기",
  "AI_CHAT_DEMO_NOTICE_OFFLINE": "오프라인 상태이므로 녹화된 데모가 재생됩니다.",
  "AI_CHAT_DEMO_BAR_TEXT": "로그인하여 AI로 직접 만들어 보세요.",
  "AI_CHAT_DEMO_BACK_BTN": "뒤로",
  "AI_CHAT_DEMO_BUILT_WITH": "{0}으로 제작",
  "AI_CHAT_DEMO_ANOTHER_BTN": "다른 데모 보기",
  "AI_CHAT_DEMO_REVEAL_PROMPT": "프롬프트 보기",
  "AI_CHAT_DEMO_HIDE_PROMPT": "프롬프트 숨기기",
  "AI_CHAT_DEMO_PROMPT_LABEL": "이것을 만든 프롬프트",
  "AI_CHAT_DEMO_COPY_PROMPT": "복사하기",
  "AI_CHAT_DEMO_PROMPT_COPIED": "복사됨",
  "AI_CHAT_DEMO_SPEED_TITLE": "재생 속도 (클릭하여 변경)",
  "AI_CHAT_START_WORK_WITH": "함께 작업",
  "AI_CHAT_START_SETUP": "설정",
  "AI_CHAT_START_CUSTOM_PROVIDER": "사용자 지정 엔드포인트 또는 {0} 같은 공급자는 {1}을(를) 참조하세요.",
  ...
  "AI_CHAT_WAITING_FOR_MODEL": "모델을 기다리는 중...",
  "AI_CHAT_SCROLL_TO_BOTTOM": "맨 아래로 스크롤",
  "AI_CHAT_PLACEHOLDER": "Claude에게 질문하기...",
  "AI_CHAT_PLACEHOLDER_MODEL": "{0}에게 질문하기...",
  "AI_CHAT_SEND_TITLE": "메시지 보내기",
  "AI_CHAT_STOP_TITLE": "생성 중단 (Esc)",
  "AI_CHAT_CLI_NOT_FOUND": "Claude Code가 설치되지 않았습니다",
  "AI_CHAT_CLI_INSTALL_MSG": "{APP_NAME}에서 인공지능 기능을 사용하려면 시스템에 Claude Code CLI가 설치되어 있어야 합니다.",
  "AI_CHAT_CLI_INSTALL_BTN": "Claude Code 설치",
  "AI_CHAT_CLI_INSTALLING": "설치 중…",
  "AI_CHAT_CLI_INSTALLING_NAMED_MSG": "{0}을(를) 설치하는 중입니다. 잠시만 기다려 주세요. 이 작업은 시간이 걸릴 수 있습니다...",
  "AI_CHAT_CLI_RESTART_NOTE": "설치가 완료되면 {APP_NAME}을(를) 다시 시작하세요.",
  "AI_CHAT_CLI_NOT_FOUND_INSTALL_BTN": "{0} 설치",
  "AI_CHAT_CLI_SETUP_TITLE": "{0} 설정",
  "AI_CHAT_CLI_SETUP_MISSING": "{0}이(가) 아직 설치되지 않았습니다.",
  "AI_CHAT_CLI_SETUP_BAD_PATH": "저장된 경로에서 {0}을(를) 시작할 수 없습니다.",
  "AI_CHAT_CLI_SETUP_INSTALL_TITLE": "자동 설치",
  "AI_CHAT_CLI_SETUP_RECOMMENDED": "권장",
  "AI_CHAT_CLI_SETUP_INSTALL_DESC": "터미널에서 {0} 공식 설치 프로그램을 실행합니다. 완료되면 {1}을(를) 다시 선택하세요.",
  "AI_CHAT_CLI_SETUP_NO_DOWNLOADER": "{0} 또는 {1}이(가) 필요합니다. 둘 중 하나를 먼저 설치하세요.",
  "AI_CHAT_CLI_SETUP_PATH_TITLE": "직접 경로 지정",
  "AI_CHAT_CLI_SETUP_PATH_DESC": "{0}의 전체 경로를 붙여넣으세요.",
  "AI_CHAT_CLI_SETUP_USE_PATH_BTN": "이 경로 사용",
  "AI_CHAT_CLI_SETUP_AUTO_DETECT": "대신 자동으로 감지",
  "AI_CHAT_CLI_SETUP_AUTO_DETECT_FAILED": "{0}을(를) 자동으로 찾을 수 없습니다.",
  "AI_CHAT_CLI_SETUP_WHAT_IS": "{0}이란 무엇인가요?",
  "AI_CHAT_CLI_ERR_OVERRIDE_MISSING": "해당 경로에 파일이 존재하지 않습니다.",
  "AI_CHAT_CLI_ERR_OVERRIDE_NOT_EXECUTABLE": "해당 파일은 실행 파일이 아닙니다.",
  "AI_CHAT_CLI_ERR_OVERRIDE_INVALID": "해당 파일이 {0}(으)로 실행되지 않았습니다.",
  "AI_CHAT_CLI_ERR_OVERRIDE_TIMEOUT": "해당 파일이 시간 내에 응답하지 않았습니다.",
  "AI_CHAT_CLI_ERR_OVERRIDE_REJECTED": "해당 경로에 사용할 수 없는 문자가 포함되어 있습니다.",
  "AI_CHAT_SETUP_NEED_HELP": "도움이 필요하신가요?",
  "AI_CHAT_SETUP_LEARN_MORE": "더 알아보기",
  "AI_CHAT_RETRY": "다시 시도",
  "AI_CHAT_DESKTOP_ONLY": "AI 기능은 {APP_NAME} 데스크톱 앱이 필요합니다. 다운로드하여 시작하세요.",
  "AI_CHAT_DOWNLOAD_BTN": "데스크톱 앱 다운로드",
  "AI_CHAT_PLACEHOLDER_TITLE": "AI로 디자인, 빌드, 수정을 더 빠르게",
  "AI_CHAT_PLACEHOLDER_SUBTITLE": "{APP_NAME}에서 아이디어를 실제 작동하는 페이지로 만들어 보세요.",
  "AI_CHAT_WELCOME_LABEL": "{APP_NAME}의 AI",
  "AI_CHAT_WELCOME_CLI_TITLE": "자주 사용하는 CLI 에이전트로 빌드하세요",
  "AI_CHAT_WELCOME_CLI_SUBTITLE": "CLI 에이전트에게 빌드 과정에서 페이지를 보고, 검사하고, 디버그할 수 있는 도구를 제공하세요.",
  "AI_CHAT_WELCOME_LAYOUT_PROMPT": "가격 책정 섹션 빌드하기",
  "AI_CHAT_WELCOME_BUG_PROMPT": "모바일 내비게이션 수정하기",
  "AI_CHAT_WELCOME_EDITING": "{0} 편집 중…",
  "AI_CHAT_WELCOME_REVIEWING": "{0} 검토 중…",
  "AI_CHAT_WELCOME_NAV_LABEL": "AI 미리보기 탐색",
  "AI_CHAT_WELCOME_PREVIOUS": "이전 미리보기",
  "AI_CHAT_WELCOME_NEXT": "다음 미리보기",
  "AI_CHAT_WELCOME_SHOW_DEMO": "AI 데모 보기",
  "AI_CHAT_WELCOME_SHOW_CLI": "CLI 에이전트 보기",
  "AI_CHAT_WELCOME_PLAY_DEMO": "AI 데모 재생",
  "AI_CHAT_LOGIN_TITLE": "AI를 시작하려면 로그인하세요",
  "AI_CHAT_LOGIN_MESSAGE": "AI를 설정하려면 {APP_NAME} 계정에 로그인하세요.",
  "AI_CHAT_LOGIN_BTN": "로그인",
  "AI_CHAT_INTRO_GUEST_TITLE": "AI로 레이아웃을 디자인하고, 버그를 수정하며, 더 빠르게 빌드하세요",
  "AI_CHAT_INTRO_CONFIGURE_TITLE": "Claude Code 시작하기",
  "AI_CHAT_INTRO_CONFIGURE_DESC": "{APP_NAME}에서 AI를 설정하려면 이 짧은 동영상을 시청하세요",
  "AI_CHAT_UPSELL_TITLE": "Phoenix Pro + AI",
  "AI_CHAT_UPSELL_MESSAGE": "AI 기능은 Phoenix Pro에서 사용할 수 있습니다.",
  ...
  "AI_CHAT_TOOL_EDIT": "편집",
  "AI_CHAT_TOOL_WRITE": "쓰기",
  "AI_CHAT_TOOL_RUN_CMD": "명령 실행",
  "AI_CHAT_TOOL_SKILL": "스킬",
  "AI_CHAT_TOOL_EDITOR_STATE": "에디터 상태",
  "AI_CHAT_TOOL_SCREENSHOT": "스크린샷",
  "AI_CHAT_TOOL_SCREENSHOT_OF": "{0}의 스크린샷",
  ...
  "AI_CHAT_TOOL_READ_FILE_RANGE": "{0} 파일 {1}-{2}번째 줄 읽음",
  "AI_CHAT_TOOL_READ_FILE_FROM": "{0} 파일 {1}번째 줄부터 읽음",
  "AI_CHAT_TOOL_EDIT_FILE": "{0} 수정",
  "AI_CHAT_TOOL_WRITE_FILE": "{0} 작성",
  "AI_CHAT_TOOL_RAN_CMD": "명령 실행",
  ...
  "AI_CHAT_TOOL_SKILL_NAME": "스킬: {0}",
  "AI_CHAT_TOOL_IN_PATH": "{0}에서",
  "AI_CHAT_TOOL_INCLUDE": "{0} 포함",
  "AI_CHAT_RECEIVING_BYTES": "{0}바이트 수신 중...",
  "AI_CHAT_FILES_CHANGED": "{0} {1} 변경됨",
  "AI_CHAT_FILE_SINGULAR": "파일",
  "AI_CHAT_FILE_PLURAL": "파일",
  "AI_CHAT_RESTORE_POINT": "이 시점으로 복원",
  "AI_CHAT_UNDO": "비활성화 취소",
  "AI_CHAT_UNDO_TITLE": "이 응답의 변경 사항 실행 취소",
  "AI_CHAT_RESTORE_TITLE": "파일을 이 시점으로 복원",
  "AI_CHAT_RESTORED": "복원됨",
  "AI_CHAT_TOOL_APPLIED_DIRECTLY": "디스크에 직접 적용됨 · 디프 사용 불가",
  "AI_CHAT_TOOL_REJECTED": "편집 거부됨 — 파일이 수정되지 않음",
  "AI_CHAT_TOOL_REJECTED_REASON": "사유: {0}",
  "AI_CHAT_FILE_NOT_FOUND_TITLE": "파일을 찾을 수 없음",
  "AI_CHAT_FILE_NOT_FOUND_MSG": "<span class=\"dialog-filename\">{0}</span> 파일을 열 수 없습니다. 파일이 이동되었거나 삭제되었을 수 있습니다.",
  ...
  "AI_CHAT_FULL_AUTO_WARNING_TITLE": "모든 것 허용 모드로 전환하시겠습니까?",
  "AI_CHAT_FULL_AUTO_WARNING_BODY": "모든 것 허용 모드에서는 AI가 사용자에게 먼저 묻지 않고 Bash 명령어, 파일 수정, 파일 삭제, 웹 가져오기 등 모든 도구를 실행할 수 있습니다.<br><br>이 모드는 신뢰할 수 있는 스크래치 프로젝트에서는 편리하지만, 잘못된 판단으로 파일을 덮어쓰거나 삭제하고, 파괴적인 셸 명령어를 실행하거나, 의도하지 않은 변경 사항을 푸시하는 등 위험을 초래할 수 있습니다. 문제가 발생했을 때 복구할 수 있도록 버전 관리(Git)를 사용하세요.<br><br>신뢰하는 프로젝트에서만 모든 것 허용 모드를 활성화하세요. <kbd>Shift+Tab</kbd>을 누르거나 모드 바를 클릭하여 언제든지 편집 모드로 다시 전환할 수 있습니다.",
  "AI_CHAT_FULL_AUTO_WARNING_PROCEED": "모든 것 허용 활성화",
  "AI_CHAT_SHOW_DIFF": "diff 보기",
  "AI_CHAT_HIDE_DIFF": "diff 숨기기",
  "AI_CHAT_DIFF_MORE_TITLE": "디프 옵션",
  "AI_CHAT_DIFF_EXPAND_ALL": "모두 펼치기",
  "AI_CHAT_DIFF_COLLAPSE_ALL": "모두 접기",
  "AI_CHAT_DIFF_ALWAYS_SHOW": "항상 표시",
  "AI_CHAT_LABEL_YOU": "나",
  "AI_CHAT_LABEL_CLAUDE": "클로드",
  "AI_CHAT_SEND_ERROR": "메시지 전송 실패: {0}",
  "AI_CHAT_EDIT_NOT_FOUND": "파일에서 텍스트를 찾을 수 없습니다 — 변경되었을 수 있습니다",
  "AI_CHAT_WORKING": "작업 중...",
  "AI_CHAT_WRITING": "작성 중...",
  "AI_CHAT_PROCESSING": "처리 중...",
  ...
  "AI_CHAT_TOOL_QUESTION": "질문",
  "AI_CHAT_TOOL_TASK": "하위 에이전트",
  "AI_CHAT_TOOL_TASK_NAME": "하위 에이전트: {0}",
  "AI_CHAT_TOOL_PLANNING": "계획 중",
  "AI_CHAT_TOOL_TOOL_SEARCH": "도구 로드 중",
  "AI_CHAT_TOOL_SEND_MESSAGE": "서브 에이전트에 메시지 전송 중",
  "AI_CHAT_TOOL_TASK_OUTPUT": "서브 에이전트 출력 읽는 중",
  "AI_CHAT_TOOL_TASK_STOP": "서브 에이전트 중지 중",
  "AI_CHAT_PLAN_TITLE": "제안된 계획",
  "AI_CHAT_PLAN_MAXIMIZE": "계획을 전체 화면으로 열기",
  "AI_CHAT_PLAN_CLOSE_FULLSCREEN": "채팅으로 돌아가기 (Esc)",
  "AI_CHAT_PLAN_APPROVE": "승인",
  "AI_CHAT_PLAN_REVISE": "수정",
  "AI_CHAT_PLAN_FEEDBACK_PLACEHOLDER": "무엇을 변경하고 싶으신가요?",
  "AI_CHAT_PLAN_STOP": "중지",
  "AI_CHAT_PLAN_STOP_TITLE": "클로드를 중단하고 이 계획을 폐기합니다",
  "AI_CHAT_PLAN_REVISE_DEFAULT": "계획을 수정해 주세요.",
  ...
  "AI_CHAT_MODEL_DEFAULT": "기본",
  "AI_CHAT_MODEL_DEFAULT_DESC_CURRENT": "현재 {0}",
  ...
  "AI_CHAT_MODEL_SELECT_TITLE": "이 채팅에 사용할 AI 모델 선택",
  "AI_CHAT_MODE_SELECT_TITLE": "Claude Code 채팅과 내장 CLI 터미널 간 전환",
  "AI_CHAT_MODEL_SWITCHED_NOTICE": "{0}으로 전환되었습니다. 다음 메시지부터 적용되며, 캐시가 재구성되는 동안 첫 번째 응답이 조금 더 오래 걸릴 수 있습니다.",
  "AI_CHAT_INPUT_HINT": "{0}를 눌러 전송 · {1}로 줄 바꿈",
  "AI_CHAT_BASH_CONFIRM_TITLE": "명령을 허용하시겠습니까?",
  "AI_CHAT_BASH_ALLOW": "허용",
  "AI_CHAT_BASH_DENY": "거부",
  "AI_CHAT_BASH_ALLOWED": "명령이 허용되었습니다",
  "AI_CHAT_BASH_DENIED": "명령이 거부되었습니다",
  "AI_CHAT_TOOL_CONFIRM_TITLE": "이 작업을 허용하시겠습니까?",
  "AI_CHAT_TOOL_ALLOWED": "작업 허용됨",
  "AI_CHAT_TOOL_DENIED": "작업 거부됨",
  "AI_CHAT_PLAN_WRITE_CONFIRM_TITLE": "자동으로 전환할까요?",
  "AI_CHAT_PLAN_WRITE_CONFIRM_BODY": "클로드가 {0}을(를) 편집하려고 합니다. 현재 계획 모드입니다.",
  "AI_CHAT_PLAN_WRITE_ALLOW": "허용 및 자동 전환",
  "AI_CHAT_PLAN_WRITE_STAY": "계획 모드 유지",
  "AI_CHAT_PLAN_WRITE_ALLOWED": "자동으로 전환됨",
  "AI_CHAT_PLAN_WRITE_STAYED": "계획 모드가 유지되었습니다",
  "AI_CHAT_CODE_DEFAULT_LANG": "텍스트",
  "AI_CHAT_CODE_COLLAPSE": "접기",
  "AI_CHAT_CODE_EXPAND": "펼치기",
  "AI_CHAT_CODE_EXPAND_LINES": "클릭하여 펼치기 - {0}줄",
  "AI_CHAT_CODE_COLLAPSE_FOOTER": "클릭하여 접기",
  "AI_CHAT_PREVIEW_OPEN": "미리 보기",
  "AI_CHAT_PREVIEW_VIEWING": "미리 보는 중",
  "AI_CHAT_QUESTION_OTHER": "사용자 지정 답변 입력…",
  "AI_CHAT_QUESTION_SUBMIT": "제출",
  "AI_CHAT_IMAGE_LIMIT": "최대 {0}개의 이미지만 허용됩니다",
  "AI_CHAT_IMAGE_REMOVE": "이미지 제거",
  "AI_CHAT_IMAGE_SEARCH": "이미지 검색 중",
  "AI_CHAT_IMAGE_USE": "이미지 선택 중",
  "AI_CHAT_IMAGE_SELECTED": "선택된 이미지",
  "AI_CHAT_IMAGE_SELECTED_GROUP": "선택된 이미지",
  "AI_CHAT_IMAGE_PREVIEW": "이미지 미리 보기",
  "AI_CHAT_IMAGE_PREVIEW_INVALID": "하나에서 아홉 개의 HTTP, HTTPS 또는 파일 이미지 URL을 입력하세요.",
  "AI_CHAT_IMAGE_PREVIEW_COUNT": "이미지 {0}개",
  "AI_CHAT_IMAGE_PREVIEW_SINGLE": "이미지 1개",
  "AI_CHAT_IMAGE_CLOSE": "이미지 미리 보기 닫기 (Esc)",
  "AI_CHAT_IMAGE_PREVIOUS": "이전 이미지",
  "AI_CHAT_IMAGE_NEXT": "다음 이미지",
  "AI_CHAT_IMAGE_POSITION": "{1}개 중 {0}번째 이미지",
  "AI_CHAT_IMAGE_PHOTO_BY": "촬영:",
  "AI_CHAT_IMAGE_REPLY": "이 이미지로 답장",
  "AI_CHAT_IMAGE_QUOTE": "채팅에서 이미지 인용",
  "AI_CHAT_IMAGE_VIEW_COLLAGE": "콜라주 보기",
  "AI_CHAT_IMAGE_SHOW_ALL": "모두 보기",
  "AI_CHAT_IMAGE_BACK_TO_ALL": "모든 이미지로 돌아가기",
  "AI_CHAT_IMAGE_RESULTS_COUNT": "사진 {0}장 · Unsplash",
  "AI_CHAT_IMAGE_RESULTS_SINGLE": "사진 1장 · Unsplash",
  "AI_CHAT_IMAGE_NO_RESULTS": "이미지를 찾을 수 없습니다. 다른 검색어로 시도해 보세요.",
  "AI_CHAT_IMAGE_LOAD_FAILED": "이미지를 불러올 수 없습니다.",
  "AI_CHAT_IMAGE_COLLAGE_FAILED": "이미지 콜라주를 만들 수 없습니다.",
  "AI_CHAT_IMAGE_INVALID_QUERY": "최대 200자의 검색어와 유효한 페이지 번호를 입력하세요.",
  "AI_CHAT_IMAGE_INVALID_REFERENCE": "이 이미지 참조는 유효하지 않습니다. 이미지 검색 결과를 사용하세요.",
  "AI_CHAT_IMAGE_HOURLY_LIMIT": "시간당 이미지 검색 한도인 120회를 초과했습니다. 잠시 후 다시 검색하세요.",
  "AI_CHAT_IMAGE_GUEST_LIMIT": "이미지 검색 허용량을 모두 사용했습니다. 계속 검색하려면 로그인하세요.",
  "AI_CHAT_IMAGE_SERVER_LIMIT": "이미지 검색이 일시적으로 제한되었습니다. 잠시 후 다시 검색하세요.",
  "AI_CHAT_IMAGE_TIMEOUT": "이미지 검색 시간이 초과되었습니다. 나중에 다시 시도하세요.",
  "AI_CHAT_IMAGE_REQUEST_FAILED": "이미지 서비스에서 오류({0})를 반환했습니다.",
  "AI_CHAT_ATTACH_FILE": "파일 첨부",
  "AI_CHAT_ATTACH_TITLE": "파일 또는 폴더 첨부",
  "AI_CHAT_ATTACH_FILE_OPTION": "파일 첨부",
  "AI_CHAT_ATTACH_FOLDER": "컨텍스트로 폴더 추가",
  "AI_CHAT_ATTACH_FOLDER_PICK_TITLE": "컨텍스트로 추가할 폴더 선택",
  "AI_CHAT_SCREENSHOT_TITLE": "스크린샷 찍기",
  ...
  "AI_CHAT_QUEUED": "대기 중",
  "AI_CHAT_QUEUED_EDIT": "편집",
  "AI_CHAT_TOOL_CLARIFICATION": "후속 질문 읽는 중",
  "AI_CHAT_HISTORY_TITLE": "세션 기록",
  "AI_CHAT_HISTORY_EMPTY": "이전 세션이 없습니다",
  "AI_CHAT_SESSION_RESUMED": "재개된 세션",
  "AI_CHAT_HISTORY_JUST_NOW": "방금 전",
  "AI_CHAT_HISTORY_MINS_AGO": "{0}분 전",
  "AI_CHAT_HISTORY_HOURS_AGO": "{0}시간 전",
  "AI_CHAT_HISTORY_DAYS_AGO": "{0}일 전",
  "AI_CHAT_HISTORY_CLEAR_ALL": "모두 지우기",
  "AI_CHAT_HISTORY_DELETE_CONFIRM": "이 세션을 삭제하시겠습니까?",
  "AI_CHAT_SWITCH_PROJECT_TITLE": "AI가 작업 중입니다",
  "AI_CHAT_SWITCH_PROJECT_MSG": "AI가 현재 작업을 수행 중입니다. 프로젝트를 전환하면 작업이 중단됩니다. 계속하시겠습니까?",
  ...
  "AI_SETTINGS_API_TIMEOUT": "API 타임아웃 (밀리초)",
  "AI_SETTINGS_API_KEY_PLACEHOLDER": "앤스로픽 API 키를 입력하세요",
  "AI_SETTINGS_BASE_URL_PLACEHOLDER": "기본값을 사용하려면 비워두세요",
  "AI_SETTINGS_API_TIMEOUT_PLACEHOLDER": "기본값을 사용하려면 비워두세요",
  "AI_SETTINGS_SAVE": "저장",
  "AI_SETTINGS_RESET": "재설정",
  "AI_SETTINGS_CUSTOM_ENDPOINT_NOTICE": "사용자 지정 API 엔드포인트 사용 중: {0}",
  "AI_SETTINGS_ACTIVE_PROVIDER": "활성 공급자",
  "AI_SETTINGS_DEFAULT_PROVIDER": "기본값 (로컬 클로드 코드)",
  "AI_SETTINGS_DEFAULT_PROVIDER_FOR": "기본값 (로컬 {0})",
  "AI_SETTINGS_PROVIDERS": "공급자",
  "AI_SETTINGS_ADD_PROVIDER": "+ 공급자 추가",
  "AI_SETTINGS_EDIT": "편집",
  "AI_SETTINGS_DELETE": "삭제",
  "AI_SETTINGS_PROVIDER_NAME": "이름",
  "AI_SETTINGS_PROVIDER_NAME_PLACEHOLDER": "예: 내 API 공급자",
  "AI_SETTINGS_SAVE_PROVIDER": "공급자 저장",
  "AI_SETTINGS_DELETE_PROVIDER": "공급자 삭제",
  "AI_SETTINGS_DELETE_ACTIVE_CONFIRM": "\"{0}\"은(는) 활성 공급자입니다. 삭제하면 기본값으로 되돌아갑니다. 계속하시겠습니까?",
  "AI_SETTINGS_NAME_REQUIRED": "공급자 이름은 필수입니다.",
  "AI_SETTINGS_NAME_DUPLICATE": "같은 이름의 공급자가 이미 존재합니다.",
  "AI_SETTINGS_DONE": "완료",
  "AI_SETTINGS_PROVIDER_TYPE_NOTE": "이 제공자들은 {0}을 구성합니다. API 키는 {1}로 전달됩니다.",
  "AI_SETTINGS_CLI_PATHS_NOTE": "자동으로 감지하려면 비워 두세요.",
  "AI_SETTINGS_CLI_PATH_LABEL": "{0} 실행 파일 경로",
  "AI_SETTINGS_ENABLE_AI": "AI 기능 활성화",
  "AI_SETTINGS_ENABLE_AI_NOTE": "{APP_NAME}의 모든 인공지능 기능을 켜거나 끕니다. 이 설정을 변경하면 적용을 위해 {APP_NAME}이(가) 다시 시작되며, 언제든지 <span class='ai-settings-menu-path'>보기 메뉴 &gt; 인공지능 활성화</span>에서 다시 켤 수 있습니다.",
  "DEMO_SECTION1_TITLE": "라이브 프리뷰로 편집",
  "DEMO_SECTION1_SUBTITLE": "페이지를 시각적으로 편집하세요 -&nbsp; <b>HTML이 즉시 업데이트됩니다</b>",
  "DEMO_GET_STARTED_BUTTON": "시작하기",
  "DEMO_SECTION2_TITLE": "텍스트 편집",
  "DEMO_SECTION2_SUBTITLE": "아래 텍스트를 더블 클릭하여 이름을 추가하세요",
  "DEMO_EDITABLE_PLACEHOLDER_HELLO": "안녕하세요 ___",
  "DEMO_SECTION2_SUCCESS_MESSAGE": "편집 내용이 코드에 업데이트되었습니다 — <span id=\"undo-shortcut\"></span>로 실행 취소, <span id=\"redo-shortcut\"></span>로 다시 실행할 수 있습니다.",
  "DEMO_HINT_COMPLETE_TASK_LABEL": "이 작업을 완료하려면:",
  "DEMO_SECTION2_HINT_STEP1": "\"안녕하세요 ___\" 텍스트를 더블 클릭하세요",
  "DEMO_SECTION2_HINT_STEP2": "밑줄을 이름으로 교체하세요",
  "DEMO_SECTION2_HINT_STEP3": "엔터 키를 누르거나 바깥쪽을 클릭하여 변경 사항을 적용하세요",
  "DEMO_SECTION3_TITLE": "실시간 이미지 변경",
  ...
  "DEMO_SECTION4_SUBTITLE": "아래 카드를 복제<img src=\"images/duplicate.svg\" alt=\"Duplicate\" class=\"inline-icon\">하여 총 <strong>카드 3개</strong>로 만든 다음, <strong>카드 1개를 삭제<img src=\"images/trash.svg\" alt=\"Delete\" class=\"inline-icon\"></strong>하세요.",
  "DEMO_SECTION4_UNDO_WARNING": "앗! 모든 카드가 삭제되었습니다. <strong><span id=\"undo-shortcut-section4\"></span></strong> 키를 눌러 실행 취소하세요.",
  "DEMO_CARD_TITLE": "카드",
  "DEMO_CARD_SELECT_PARENT_TIP": "위 도구 모음의 <img src=\"images/arrowUp.svg\" alt=\"Up\" class=\"inline-icon\">&nbsp;아이콘을 클릭하여 상위 카드를 선택하세요.",
  "DEMO_SECTION4_SUCCESS_MESSAGE": "완벽해요! 요소 복제 및 삭제를 마스터하셨습니다.",
  "DEMO_SECTION4_HINT_STEP1": "카드를 클릭하여 선택하세요.",
  "DEMO_SECTION4_HINT_STEP2_DUPLICATE": "<img src=\"images/duplicate.svg\" alt=\"Duplicate\" class=\"inline-icon\"> 버튼을 사용하거나 <strong><span id=\"duplicate-shortcut\"></span></strong> 키를 눌러 총 3개가 될 때까지 카드를 복제하세요.",
  "DEMO_SECTION4_HINT_STEP3_DELETE": "아무 카드나 선택하고 <img src=\"images/trash.svg\" alt=\"Delete\" class=\"inline-icon\"> 버튼을 사용하거나 <strong>Delete</strong> 키를 눌러 삭제하세요.",
  "DEMO_SECTION4_HINT_TIP_UNDO_REDO": "팁: <strong><span id=\"undo-shortcut-hint\"></span></strong> 키로 실행을 취소하고 <strong><span id=\"redo-shortcut-hint\"></span></strong> 키로 다시 실행할 수 있습니다.",
  "DEMO_DELETE_KEY": "삭제",
  "DEMO_SECTION5_TITLE": "드래그하여 요소 순서 변경",
  "DEMO_SECTION5_SUBTITLE": "아무 노트나 드래그하여 순서를 변경하세요.",
  "DEMO_STICKY_NOTE_FIRST_PLACE": "1위",
  "DEMO_STICKY_NOTE_SECOND_PLACE": "2위",
  "DEMO_STICKY_NOTE_THIRD_PLACE": "3위",
  "DEMO_SECTION5_SUCCESS_MESSAGE": "페이지 내 어디로든 요소를 드래그하여 재배치할 수 있습니다.",
  "DEMO_SECTION5_HINT_STEP1": "노트를 길게 클릭하여 드래그를 시작하세요",
  "DEMO_SECTION5_HINT_STEP2": "위 또는 아래로 이동하여 순서를 변경하세요",
  "DEMO_SECTION5_HINT_STEP3": "새 위치에서 놓아 배치하세요",
  "DEMO_SECTION6_TITLE": "링크 편집 및 페이지 미리 보기",
  "DEMO_SECTION6_SUBTITLE": "도구 모음에서 <img src=\"images/link.svg\" alt=\"Link\" class=\"inline-icon\"> 아이콘을 선택하여 이 링크가 가리키는 위치를 변경하세요.",
  "DEMO_LINK_EDIT_LINK": "링크 편집",
  "DEMO_SECTION6_SUCCESS_MESSAGE": "링크를 수정했습니다.",
  "DEMO_MODE_EXPLANATION_TITLE": "편집 모드 대 미리보기 모드",
  "DEMO_EDIT_MODE_LABEL": "편집 모드",
  ...
  "DEMO_SECTION6_TIP3_PREVIEW": "미리보기 모드(<strong>F8</strong>)로 전환하여 링크와 상호작용을 테스트하세요",
  "DEMO_COMPLETION_TITLE": "이제 빌드할 준비가 되었습니다!",
  "DEMO_COMPLETION_BODY": "라이브 프리뷰로 편집하는 방법을 배웠습니다.<br>HTML 파일이 있는 폴더를 열어 편집을 시작하세요.",
  "DEMO_COMPLETION_HELP_PROMPT": "도움이 더 필요하신가요?",
  "DEMO_RESOURCE_YOUTUBE": "유튜브",
  "DEMO_RESOURCE_DOCUMENTATION": "문서",
  "DEMO_BONUS_BADGE": "한 가지 더",
  "DEMO_SECTION8_TITLE": "측정값으로 레이아웃 확인하기",
  "DEMO_SECTION8_SUBTITLE": "툴바의 <img src=\"images/verticalEllipsis.svg\" alt=\"menu\" class=\"inline-icon\">를 클릭하고 <strong>측정값 표시</strong>를 선택하여 어떤 상자가 잘못 정렬되었는지 확인하세요.",
  "DEMO_BOX_CLICK_MENU": "<img src=\"images/verticalEllipsis.svg\" alt=\"menu\" class=\"inline-icon\">를 클릭하세요",
  "DEMO_BOX_LABEL": "박스",
  "DEMO_SECTION8_TIP1": "도구 모음에서 <img src=\"images/verticalEllipsis.svg\" alt=\"More options\" class=\"inline-icon\"> 아이콘을 클릭하거나 마우스 오른쪽 버튼을 클릭하여 메뉴를 여세요",
  "DEMO_SECTION8_TIP2_MEASUREMENTS": "<strong>측정값 표시</strong>를 활성화하여 간격 및 정렬 안내선을 확인하세요",
  "DEMO_SECTION8_TIP3": "측정값은 정렬 문제를 빠르게 찾는 데 도움이 됩니다",
  "DEMO_ALT_EDIT_TEXT": "텍스트 편집",
  "DEMO_ALT_IMAGE_LIBRARY": "이미지 라이브러리",
  "DEMO_ALT_DRAG_AND_DROP": "드래그 앤 드롭",
  "DEMO_ALT_LAYOUT_RULERS": "레이아웃 눈금자",
  "DEMO_ALT_REPLACEABLE_IMAGE": "교체 가능한 이미지",
  "DEMO_ALT_DOWNLOAD_ICON": "다운로드",
  "DEMO_ALT_DUPLICATE_ICON": "행 복사",
  "DEMO_ALT_DELETE_ICON": "삭제",
  "DEMO_ALT_UP_ICON": "위로",
  "DEMO_ALT_LINK_ICON": "링크",
  "DEMO_ALT_PLAY_ICON": "재생",
  "DEMO_ALT_MENU_ICON": "메뉴",
  "DEMO_ALT_MORE_OPTIONS_ICON": "더 많은 옵션",
  "DEMO_ALT_CARD_IMAGE": "카드 이미지",
  "DEMO_ALT_ROCKET": "로켓",
  "DEMO_ALT_ARROW": "화살표",
  "DEMO_CLICK_TO_REPLACE_IMAGE": "클릭하여 교체",
  "DEMO_JS_BUTTON_BACK": "뒤로",
  "DEMO_JS_BUTTON_PREVIOUS": "이전",
  "DEMO_JS_BUTTON_NEXT": "다음",
  "DEMO_JS_BUTTON_TIP": "팁",
  "DEMO_JS_BUTTON_FINISH": "마침",
  ...
  "MIGRATE_DONE_TITLE": "마이그레이션 완료",
  "MIGRATE_DONE_FROM": "{0}에서 가져온 항목:",
  "MIGRATE_DONE_PROJECTS": "프로젝트 {0}개",
  "MIGRATE_DONE_EXTENSIONS": "확장 프로그램 및 테마 {0}개",
  "MIGRATE_DONE_SETTINGS": "에디터 테마를 포함한 사용자 설정",
  "MIGRATE_DONE_TOTAL": "총 {0}개의 파일. {APP_NAME}을 다시 로드하여 사용하세요.",
  "MIGRATE_PARTIAL_TITLE": "마이그레이션이 완료되지 않았습니다",
  "MIGRATE_PARTIAL_COUNT": "{1}개 파일 중 {0}개를 복사할 수 없었으며 이전 사이트에 남아 있습니다.",
  ...
  "MIGRATE_INTERRUPTED_TITLE": "마이그레이션이 완료되지 않았습니다",
  "MIGRATE_INTERRUPTED_PROGRESS": "연결이 끊어지기 전에 {2}에서 {1}개 파일 중 {0}개를 복사했습니다. 해당 파일은 보존되었으므로 손실된 데이터는 없습니다.",
  "MIGRATE_INTERRUPTED_RETRY": "{APP_NAME}은(는) 다음에 열 때 나머지 항목의 마이그레이션을 시도합니다.",
  ...
  "TERMINAL_PROJECT_CHANGED": "프로젝트가 {0}으로 전환되었습니다",
  "TERMINAL_PROJECT_RESTART_PATH": "{0}의 모든 터미널 다시 시작",
  "TERMINAL_PROJECT_DISMISS": "닫기 — 터미널 계속 실행",
  "TERMINAL_PROJECT_RESTART": "모든 터미널 다시 시작",
  "AI_CHAT_START_CHAT_NAME": "{0} · 시각적 AI",
  "AI_CHAT_START_CHAT_DESC": "시각적 워크플로를 위한 내장 채팅",
  "AI_CHAT_START_BY_PROVIDER": "제공: {0}",
  "AI_CHAT_START_CLI_SEPARATOR": "명령줄 도구 · {APP_NAME}과 연결",
  "AI_CHAT_START_CHAT_RUNNING": "진행 중",
  "AI_CHAT_START_CLI_RUNNING": "실행 중",
  "AI_CHAT_START_CLI_FOLDED": "대신 CLI를 사용하세요: {0}",
  "AI_CHAT_BACK_BTN": "뒤로",
  "AI_CHAT_BACK_TITLE": "처음으로 돌아가기",
  "AI_CHAT_SETUP_PLACEHOLDER": "채팅을 시작하려면 Claude Code를 설정하세요"
});