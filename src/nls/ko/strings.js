...
define({
  ...
  "AI_CHAT_CLI_INSTALLING_MSG": "Claude Code를 설치하는 중입니다. 잠시만 기다려 주세요. 시간이 다소 걸릴 수 있습니다...",
  "AI_CHAT_CLI_RESTART_NOTE": "설치가 완료되면 {APP_NAME}을(를) 다시 시작하세요.",
  "AI_CHAT_CLI_NOT_FOUND_TITLE": "{0}을(를) 찾을 수 없음",
  "AI_CHAT_CLI_NOT_FOUND_MSG": "이 시스템에서 {0}을(를) 찾을 수 없습니다. 설치하거나 아래에 실행 파일의 전체 경로를 입력하세요.",
  "AI_CHAT_CLI_NOT_FOUND_BAD_PATH_MSG": "{0}에 대해 설정된 경로를 사용할 수 없습니다: {1} 다른 경로를 입력하거나, 자동으로 감지하도록 입력란을 비우세요.",
  "AI_CHAT_CLI_NOT_FOUND_INSTALL_BTN": "{0} 설치",
  "AI_CHAT_CLI_NOT_FOUND_SAVE_BTN": "저장 및 다시 시도",
  "AI_CHAT_CLI_NOT_FOUND_LEARN_MORE": "설치 안내",
  ...
  "AI_CHAT_PLACEHOLDER_SUBTITLE": "미리보기와 함께 작동하는 AI",
  "AI_CHAT_PLACEHOLDER_CARD_LAYOUT_TITLE": "레이아웃 생성",
  "AI_CHAT_PLACEHOLDER_CARD_LAYOUT_DESC": "섹션 설명하기",
  "AI_CHAT_PLACEHOLDER_CARD_BUGS_TITLE": "버그 수정",
  "AI_CHAT_PLACEHOLDER_CARD_BUGS_DESC": "문제 스캔하기",
  "AI_CHAT_PLACEHOLDER_CARD_IMPROVE_TITLE": "개선 사항 제안",
  "AI_CHAT_PLACEHOLDER_CARD_IMPROVE_DESC": "UX 및 성능 팁",
  "AI_CHAT_LOGIN_TITLE": "AI를 시작하려면 로그인하세요",
  "AI_CHAT_LOGIN_MESSAGE": "AI 기능에 액세스하려면 {APP_NAME} 계정에 로그인하세요.",
  ...
  "AI_CHAT_ONBOARDING_REVIEW_PROMPT": "빌드 준비 완료",
  "AI_CHAT_ONBOARDING_SEND": "전송",
  ...
  "LIVE_PREVIEW_LAYERS_SHOW_MORE_FILES": "{0}개 더 보기",
  "LIVE_PREVIEW_LAYERS_SHOW_FEWER_FILES": "접기",
