...
define({
  ...
  "AI_CHAT_CLI_INSTALL_MSG": "{APP_NAME}에서 AI 기능을 사용하려면 시스템에 Claude Code CLI가 설치되어 있어야 합니다. <a class='ai-learn-more-link' href='#'>더 알아보기</a>",
  ...
  "AI_CHAT_CLAUDE_LOGIN_MSG": "Claude Code가 설치되었지만 구성이 필요합니다. <a class='ai-learn-more-link' href='#'>자세히 알아보기</a>",
  "AI_CHAT_CLAUDE_LOGIN_BTN": "Claude Code 설정",
  "AI_CHAT_ADD_PROVIDER_BTN": "사용자 지정 공급자 추가",
  "AI_CHAT_RETRY": "다시 시도",
  "AI_CHAT_DESKTOP_ONLY": "AI 기능은 Phoenix 데스크톱 앱이 필요합니다. 시작하려면 다운로드하세요.",
  "AI_CHAT_DOWNLOAD_BTN": "데스크톱 앱 다운로드",
  "AI_CHAT_LOGIN_TITLE": "AI 사용을 위해 로그인",
  ...
  "AI_CHAT_INTRO_CONFIGURE_DESC": "AI 설정 방법에 대한 짧은 동영상을 확인하세요",
  ...
  "PROMO_CARD_2": "에디터 속 AI",
  "PROMO_CARD_2_MESSAGE": "AI에게 코드 작성, 버그 수정, 프로젝트 리팩터링을 요청하세요. AI가 대신 작업을 수행해 줍니다.",
  "PROMO_CARD_3": "모든 기기 미리보기",
  "PROMO_CARD_3_MESSAGE": "실시간 미리보기 크기를 스마트폰, 태블릿, 사용자 지정 뷰포트에 맞게 조절하여 배포 전에 반응형 문제를 찾아내세요.",
  "PROMO_CARD_4": "실시간 리치 마크다운",
  "PROMO_CARD_4_MESSAGE": "다이어그램, 표, 코드 블록을 포함한 깔끔한 좌우 분할 마크다운 미리보기가 입력과 동시에 렌더링됩니다."
});