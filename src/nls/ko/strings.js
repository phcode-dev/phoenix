...
define({
  ...
  "DROP_TO_OPEN_FILES": "드롭하여 파일 열기",
  "DROP_TO_OPEN_FILE": "파일을 열려면 드롭하세요.",
  "DROP_TO_OPEN_PROJECT": "`{0}` 폴더를 프로젝트로 열려면 드롭하세요.",
  ...
  "ERROR_PREFS_RESET_TITLE": "설정 재설정 - 재시작 필요",
  ...
  "ERROR_PREFS_CORRUPT_RESET": "{APP_NAME} 설정이 손상되어 재설정되었습니다. 변경 사항을 적용하려면 {APP_NAME}을 다시 시작하세요.",
  ...
  "UNSUPPORTED_DOM_APIS_CONFIRM": "`window.confirm` 및 `window.prompt` API는 {APP_NAME}의 내장된 라이브 미리보기에서 사용할 수 없습니다. 브라우저에서 이러한 API를 사용하려면 라이브 미리보기를 팝업하세요.",
  ...
  "LIVE_DEV_SETTINGS_BANNER": "` <b>{0}</b> ` 및 기타 서버 렌더링 파일(PHP, JSP 등)을 실시간으로 미리 볼 수 있도록 사용자 정의 서버를 설정하세요.",
  ...
  "LIVE_DEV_SETTINGS_FRAMEWORK_CUSTOM": "관습",
  "LIVE_DEV_SETTINGS_FRAMEWORK_PREFERENCES": "서버 프레임워크는 현재 docusaurus만 지원합니다.",
  "LIVE_PREVIEW_CUSTOM_SERVER_BANNER": "맞춤 서버에서 미리보기 가져오기 {0}",
  ...
  "CONFIRM_FILE_DELETE_TRASH": "<span class='dialog-filename'>{0}</span> 파일을 삭제하시겠습니까?<br> 이 파일을 휴지통에서 복원할 수 있습니다.",
  "CONFIRM_FOLDER_DELETE_TRASH": "<span class='dialog-filename'>{0}</span> 폴더를 삭제하시겠습니까?<br> 이 폴더를 휴지통에서 복원할 수 있습니다.",
  ...
  "KEYBOARD_SHORTCUT_PRESET_TOOLTIP": "VSCode, WebStorm 또는 Sublime Text와 같은 편집기의 키보드 단축키 사용",
  "KEYBOARD_SHORTCUT_PRESET_SELECT": "바로가기 사전 설정 선택",
  "KEYBOARD_SHORTCUT_PRESET_USING": "{0} 사용 중",
  "DEFAULT": "기본",
  ...
  "KEYBOARD_SHORTCUT_SRC_PRESET": "{0} 사전 설정",
  "STATUSBAR_CURSOR_POSITION": "행 {0}, 열 {1}",
  "STATUSBAR_CURSOR_POSITION_SHORT": "{0} : {1}",
  "STATUSBAR_CURSOR_GOTO": "다른 :Line으로 이동하려면 클릭하세요",
  ...
  "STATUSBAR_SELECTION_MULTIPLE": "— {0} 다중 커서 선택",
  ...
  "STATUSBAR_AUTO_INDENT": "<span title=\"고정된 들여쓰기로 전환하려면 클릭하세요. 현재 파일에 따라 들여쓰기를 자동으로 감지하고 적용하도록 설정되어 있습니다.\">자동차</span>",
  "STATUSBAR_FIXED_INDENT": "<span title=\"자동 들여쓰기 감지로 전환하려면 클릭하세요. 현재 고정 들여쓰기로 설정되어 있습니다.\">결정된</span>",
  ...
  "ERRORS_NO_FILE": "열린 파일 없음",
  "ERRORS_PANEL_TITLE_MULTIPLE": "{0} 문제 - {1}",
  "ERRORS_PANEL_TITLE_MULTIPLE_FIXABLE": "{0} 문제, {1} 해결 가능 - {2}",
  "SINGLE_ERROR": "1 {0} 문제 - {1}",
  "SINGLE_ERROR_FIXABLE": "1 {0} 문제, {1} 해결 가능 - {2}",
  "MULTIPLE_ERRORS": "{0} {1} 문제 - {2}",
  "MULTIPLE_ERRORS_FIXABLE": "{0} {1} 문제, {2} 해결 가능 - {3}",
  ...
  "CMD_TOGGLE_INDENT_GUIDES": "들여쓰기 가이드 라인",
  ...
  "CMD_SHOW_IN_FINDER": "macOS 파인더",
  "CMD_SHOW_IN_FILE_MANAGER": "파일 관리자",
  "CMD_OPEN_IN_CMD": "명령 프롬프트",
  "CMD_OPEN_IN_POWER_SHELL": "파워셸",
  ...
  "CMD_EXPERIMENTAL_FEATURES": "실험적 기능",
  "CMD_ENABLE_DRAG_AND_DROP": "파일 드래그 앤 드롭",
  ...
  "UPDATE_READY_RESTART_TITLE": "업데이트하려면 앱을 다시 시작하세요.",
  "UPDATE_READY_RESTART_INSTALL_MESSAGE": "열려 있는 창을 모두 닫으면 {APP_NAME}이 자동으로 업데이트됩니다.",
  ...
  "UPDATE_FAILED_MESSAGE": "업데이트를 다시 시도하려면 {APP_NAME} 앱 창을 모두 닫은 후 애플리케이션을 다시 열어보세요.<br/> <a href='https://phcode.io'>phcode.io</a> 에서 설치 프로그램을 다운로드하여 업데이트를 설치할 수도 있습니다.",
  ...
  "EXTENSIONS_REGISTRY_TASK_TITLE": "확장 목록 업데이트",
  ...
  "JSHINT_NAME": "JSHint",
  "JSHINT_CONFIG_ERROR": "JSHint 구성 파일을 읽는 중 오류 발생: {0}",
  "JSHINT_CONFIG_JSON_ERROR": "오류: JSHint 구성 파일 `{0}`이(가) 유효한 JSON이 아닙니다.",
  "ESLINT_NAME": "ESLint",
  "CSS_LINT_NAME": "{0}",
  "HTML_LINT_NAME": "HTML",
  "HTML_LINT_CONFIG_JSON_ERROR": "오류: HTML 검사기 구성 파일 `{0}`이 유효한 JSON이 아닙니다.",
  "HTML_LINT_CONFIG_UNSUPPORTED": "오류: 지원되지 않는 구성 형식 `{0}`. JSON 구성 `.htmlvalidate.json`을 사용하세요.",
  ...
  "DESCRIPTION_ESLINT_DISABLE": "문제 패널에서 ESLint 린터를 비활성화하려면 true입니다.",
  "DESCRIPTION_HTML_LINT_DISABLE": "문제 패널에서 HTML Linter를 비활성화하려면 true입니다.",
  "DESCRIPTION_ESLINT_FAILED": "ESLint가 실패했습니다({0}). 프로젝트에 유효한 <a href='https://eslint.org/docs/latest/use/configure/configuration-files'>구성 파일이</a> 포함되어 있는지 확인하십시오.",
  "DESCRIPTION_ESLINT_USE_NATIVE_APP": "ESLint는 데스크톱 앱에서만 사용할 수 있습니다. <a href='https://phcode.io'>phcode.io</a> 에서 다운로드하세요.",
  "DESCRIPTION_ESLINT_LOAD_FAILED": "이 프로젝트의 ESLint를 로드하지 못했습니다. {APP_NAME}은 7 이상의 ESLint 버전만 지원합니다.",
  ...
  "DESCRIPTION_AUTO_TAB_SPACE": "현재 파일에서 사용되는 탭과 공백을 자동으로 감지합니다.",
  ...
  "DESCRIPTION_EDITOR_LINE_HEIGHT": "편집기에서 코드 줄 사이의 수직 간격을 조정합니다. 1~3 사이의 값을 선택하세요. 기본값은 1.5입니다.",
  ...
  "PUBLISH": "게시",
  "PUBLISH_CONSENT_MESSAGE": "변경 사항을 빠르게 미리 보고 웹사이트를 다른 사람들과 공유하세요. {APP_NAME}이(가) 이 웹사이트를 {0}에 게시할 수 있습니다. 게시된 링크는 3일 동안 유효합니다. </br>웹사이트를 게시하고 공유하시겠습니까?",
  ...
  "GIT_PROJECT": "Git에서 가져오기",
  "NEW_PROJECT_FROM_GIT": "Git에서 새 프로젝트",
  "GIT_REPO_URL": "Git 저장소 URL :",
  "GIT_CLONE_URL": "Git 복제 URL :",
  ...
  "LOCATION": "위치 :",
  "ERROR_ONLY_GITHUB": "{APP_NAME}의 브라우저 버전은 GitHub URL만 지원합니다. 다른 Git URL을 사용하려면 데스크톱 앱을 사용하세요.",
  "ERROR_GIT_URL_INVALID": "유효한 Git 복제 URL을 입력하세요.",
  "ERROR_GIT_FOLDER_NOT_EMPTY": "선택한 폴더는 비어 있지 않고 읽을 수 없으므로 Git 복제에 사용할 수 없습니다.",
  "ERROR_GIT_FOLDER_NOT_EXIST": "선택한 폴더는 존재하지 않으므로 Git 복제에 사용할 수 없습니다.",
  "ERROR_CLONING_TITLE": "Git 복제 실패",
  "DOWNLOADING": "다운로드 중...",
  ...
  "DOWNLOAD_FAILED_MESSAGE": "다운로드 URL이 유효한지 확인하세요.</br>참고: Phoenix는 무료이므로 25MB가 넘는 개인 저장소 및 GitHub URL은 허용되지 않습니다.",
  ...
  "ADD_ENDLINE_TO_THE_END_OF_FILE": "파일 끝에 종료줄 추가",
  "ADD_TO_GITIGNORE": ".gitignore에 추가",
  "AMEND_COMMIT": "마지막 커밋 수정",
  "SKIP_COMMIT_CHECKS": "사전 커밋 검사 건너뛰기(--no-verify)",
  "AMEND_COMMIT_FORBIDDEN": "푸시되지 않은 커밋이 없을 경우 커밋을 수정할 수 없습니다.",
  "_ANOTHER_BRANCH": "또 다른 지점",
  "AUTHOR": "제작자",
  "AUTHORS_OF": "저자",
  "SYSTEM_CONFIGURATION": "시스템 구성",
  "BRACKETS_GIT_ERROR": "Git에 오류가 발생했습니다…",
  "BRANCH_NAME": "지점 이름",
  "BUTTON_CANCEL": "취소",
  "CHECKOUT_COMMIT": "점검",
  ...
  "BUTTON_FIND_CONFLICTS": "갈등을 찾으세요…",
  "GIT_INIT": "열",
  "BUTTON_MERGE_ABORT": "병합 중단",
  "BUTTON_OK": "확인",
  "BUTTON_REBASE_ABORT": "중단하다",
  "BUTTON_REBASE_CONTINUE": "리베이스 계속",
  "BUTTON_REBASE_SKIP": "건너뛰다",
  "MENU_RESET_HARD": "이후 변경 사항 및 커밋을 취소합니다(하드 리셋)",
  "MENU_RESET_MIXED": "이후 커밋은 삭제하지만 변경 사항은 스테이징되지 않은 상태로 유지(혼합 재설정)",
  "MENU_RESET_SOFT": "이후 커밋은 삭제하지만 변경 사항은 스테이징 상태로 유지(소프트 리셋)",
  "MENU_TAG_COMMIT": "태그 커밋",
  "RESET_HARD_TITLE": "하드 리셋 확인",
  "RESET_MIXED_TITLE": "혼합 재설정 확인",
  "RESET_SOFT_TITLE": "소프트 리셋 확인",
  "RESET_DETAIL": "<b>다음 이후에 커밋된 내용은 삭제됩니다.</b><br> <b>커밋 메시지:</b> {0}<br> <b>Git 명령:</b> {1}",
  "RESET_HARD_MESSAGE": "이 작업은 선택한 커밋 이후의 모든 변경 사항과 커밋을 삭제합니다. <b>이 작업은 쉽게 취소할 수 없습니다.</b> 계속하시겠습니까?<br><br> ⚠️ 경고: 이렇게 하면 기록이 다시 작성되므로 공유 브랜치에 푸시된 커밋에는 사용하면 안 됩니다.",
  "RESET_MIXED_MESSAGE": "이 작업은 선택한 커밋 이후의 모든 커밋을 삭제하지만 모든 변경 사항은 스테이징되지 않은 상태로 유지합니다. <b>이 작업은 쉽게 취소할 수 없습니다.</b> 계속하시겠습니까?<br><br> ⚠️ 경고: 이렇게 하면 기록이 다시 작성되므로 공유 브랜치에 푸시된 커밋에는 사용하면 안 됩니다.",
  "RESET_SOFT_MESSAGE": "이 작업은 선택한 커밋 이후의 모든 커밋을 삭제하지만 모든 변경 사항은 새 커밋을 위해 준비된 상태로 유지합니다. <b>이 작업은 쉽게 취소할 수 없습니다.</b> 계속하시겠습니까?<br><br> ⚠️ 경고: 이렇게 하면 기록이 다시 작성되므로 공유 브랜치에 푸시된 커밋에는 사용하면 안 됩니다.",
  "BUTTON_SAVE": "저장",
  "RESET": "다시 놓기",
  ...
  "CLEAN_FILE_END": "파일이 청소되었습니다",
  "CLEAN_FILE_START": "청소 파일",
  "CLEANING_WHITESPACE_PROGRESS": "파일에서 공백을 제거하는 중…",
  "CLEAR_WHITESPACE_ON_FILE_SAVE": "파일 저장 시 공백 지우기",
  "CLONE_REPOSITORY": "저장소 복제",
  "CODE_INSPECTION_PROBLEMS": "코드 검사 문제",
  "CODE_INSPECTION_IN_PROGRESS": "코드 검사 진행 중…",
  "CODE_INSPECTION_PROBLEMS_NONE": "문제가 감지되지 않았습니다",
  "CODE_INSPECTION_DONE_FILES": "{1}개 파일 중 {0}개 완료…",
  "PLEASE_WAIT": "기다리세요…",
  "COMMIT": "저지르다",
  "COMMIT_ALL_SHORTCUT": "모든 파일을 커밋합니다…",
  "COMMIT_CURRENT_SHORTCUT": "현재 파일 커밋…",
  "COMMIT_MESSAGE_PLACEHOLDER": "여기에 커밋 메시지를 입력하세요…",
  "CREATE_NEW_BRANCH": "새로운 지점을 만듭니다…",
  "CREATE_NEW_BRANCH_TITLE": "새로운 지점을 만듭니다",
  "CREATE_NEW_GITFTP_SCOPE": "새로운 Git-FTP 원격 생성…",
  "CREATE_NEW_REMOTE": "새로운 원격 생성…",
  "CURRENT_TRACKING_BRANCH": "현재 추적 지점",
  "_CURRENT_TRACKING_BRANCH": "현재 추적 지점",
  "DEFAULT_GIT_TIMEOUT": "기본 Git 작업 시간 초과(초)",
  "DELETE_FILE_BTN": "파일 삭제…",
  "DELETE_LOCAL_BRANCH": "로컬 브랜치 삭제",
  "DELETE_LOCAL_BRANCH_NAME": "로컬 브랜치 \"{0}\"을(를) 삭제하시겠습니까?",
  "DELETE_REMOTE": "원격 삭제",
  "DELETE_REMOTE_NAME": "원격 \"{0}\"을 삭제하시겠습니까?",
  "DELETE_SCOPE": "Git-FTP 범위 삭제",
  "DELETE_SCOPE_NAME": "Git-FTP 범위 \"{0}\"을(를) 삭제하시겠습니까?",
  "DIALOG_CHECKOUT": "커밋을 체크아웃할 때, repo는 DETACHED HEAD 상태로 전환됩니다. 이를 기반으로 브랜치를 생성하지 않는 한 커밋을 할 수 없습니다.",
  "DIALOG_PULL_TITLE": "원격에서 가져오기",
  "DIALOG_PUSH_TITLE": "원격으로 푸시",
  "SKIP_PRE_PUSH_CHECKS": "푸시 전 확인 건너뛰기(--no-verify)",
  "DIFF": "차이",
  "DIFFTOOL": "difftool로 diff하기",
  "DIFF_FAILED_SEE_FILES": "Git diff가 diff 결과를 제공하지 못했습니다. 이것은 커밋할 스테이징된 파일 목록입니다:",
  "DIFF_TOO_LONG": "diff가 너무 길어서 표시할 수 없습니다.",
  "ENABLE_GERRIT_PUSH_REF": "Gerrit 호환 푸시 참조 사용",
  "ENTER_NEW_USER_EMAIL": "이메일을 입력하세요",
  "ENTER_NEW_USER_NAME": "사용자 이름을 입력하세요",
  "ENTER_PASSWORD": "비밀번호를 입력하세요:",
  "ENTER_REMOTE_GIT_URL": "복제하려는 저장소의 Git URL을 입력하세요:",
  "ENTER_REMOTE_NAME": "새 리모컨의 이름을 입력하세요:",
  "ENTER_REMOTE_URL": "새로운 리모컨의 URL을 입력하세요:",
  "ENTER_USERNAME": "사용자 이름을 입력하세요:",
  "ERROR_NOTHING_SELECTED": "아무것도 선택되지 않았습니다!",
  "ERROR_SAVE_FIRST": "먼저 문서를 저장하세요!",
  "ERROR_TERMINAL_NOT_FOUND": "OS에 맞는 터미널을 찾을 수 없습니다. 설정에서 사용자 정의 터미널 명령을 정의할 수 있습니다.",
  "EXTENDED_COMMIT_MESSAGE": "펼친",
  "GETTING_STAGED_DIFF_PROGRESS": "스테이징된 파일의 차이점을 얻는 중…",
  "GIT_COMMIT": "Git 커밋…",
  "GIT_COMMIT_IN_PROGRESS": "Git 커밋 진행 중",
  "GIT_DIFF": "Git diff &mdash;",
  "GIT_PULL_RESPONSE": "Git Pull 응답",
  "GIT_PUSH_RESPONSE": "Git Push 응답",
  "GIT_REMOTES": "Git 리모트",
  "GIT_SETTINGS": "Git 설정…",
  ...
  "HIDE_UNTRACKED": "패널에서 추적되지 않는 파일 숨기기",
  "HISTORY": "역사",
  "HISTORY_COMMIT_BY": "~에 의해",
  "LINES": "윤곽",
  "_LINES": "윤곽",
  "MARK_MODIFIED_FILES_IN_TREE": "파일 트리에서 수정된 파일 표시",
  "MERGE_BRANCH": "지점 병합",
  "MERGE_MESSAGE": "메시지 병합",
  "MERGE_RESULT": "병합 결과",
  "NORMALIZE_LINE_ENDINGS": "줄 끝을 정규화(\\n으로)",
  "NOTHING_TO_COMMIT": "커밋할 것이 없고 작업 디렉토리가 깨끗합니다.",
  "OPERATION_IN_PROGRESS_TITLE": "Git 작업이 진행 중입니다…",
  "ORIGIN_BRANCH": "원점 지점",
  ...
  "PULL_AVOID_MERGING": "수동 병합을 피하세요",
  "PULL_DEFAULT": "기본 병합",
  "PULL_FROM": "에서 끌어오기",
  "PULL_MERGE_NOCOMMIT": "커밋 없이 병합",
  "PULL_REBASE": "여우를 이용하세요",
  "PULL_RESET": "소프트 리셋을 사용하세요",
  "PULL_SHORTCUT": "원격에서 가져오기…",
  "PULL_SHORTCUT_BEHIND": "원격에서 가져오기({0} 뒤)…",
  "PULL_BEHAVIOR": "풀 동작",
  ...
  "PUSH_SHORTCUT_AHEAD": "원격으로 푸시({0} 앞)…",
  "PUSH_TO": "푸시 투",
  "PUSH_BEHAVIOR": "푸시 동작",
  "Q_UNDO_CHANGES": "<span class='dialog-filename'>{0}</span> 파일의 변경 사항을 재설정하시겠습니까?",
  "REBASE_RESULT": "폭스 결과",
  "REFRESH_GIT": "Git 새로 고침",
  "REMOVE_BOM": "파일에서 BOM 제거",
  "REMOVE_FROM_GITIGNORE": ".gitignore에서 제거",
  "RESET_LOCAL_REPO": "마지막 커밋 이후의 모든 변경 사항을 취소합니다…",
  "DISCARD_CHANGES": "변경 사항 취소",
  "RESET_LOCAL_REPO_CONFIRM": "마지막 커밋 이후의 모든 변경 사항을 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.",
  "UNDO_LOCAL_COMMIT_CONFIRM": "마지막으로 푸시되지 않은 커밋을 취소하시겠습니까?",
  "MORE_OPTIONS": "더 많은 옵션",
  "CREDENTIALS": "신임장",
  "SAVE_CREDENTIALS_HELP": "자격 증명이 다른 곳에서 관리되는 경우 사용자 이름/암호를 입력할 필요가 없습니다. 작업이 계속 시간 초과될 때만 사용하세요.",
  "SAVE_CREDENTIALS_IN_URL": "원격 URL에 자격 증명 저장(일반 텍스트)",
  "SET_THIS_BRANCH_AS_TRACKING": "이 브랜치를 새로운 추적 브랜치로 설정",
  "STRIP_WHITESPACE_FROM_COMMITS": "커밋에서 끝 공백 제거",
  "TARGET_BRANCH": "타겟 지점",
  "TITLE_CHECKOUT": "체크아웃을 완료하시겠습니까?",
  "TOOLTIP_CLONE": "기존 저장소 복제",
  "TOOLTIP_COMMIT": "선택한 파일을 커밋합니다.",
  "TOOLTIP_FETCH": "모든 리모컨을 가져오고 카운터를 새로 고칩니다.",
  "TOOLTIP_FIND_CONFLICTS": "프로젝트에서 Git 병합/리베이스 충돌에 대한 검색을 시작합니다.",
  "TOOLTIP_HIDE_FILE_HISTORY": "파일 기록 숨기기",
  "TOOLTIP_HIDE_HISTORY": "기록 숨기기",
  "TOOLTIP_INIT": "저장소 초기화",
  "TOOLTIP_MERGE_ABORT": "병합 작업을 중단하고 HEAD를 마지막 로컬 커밋으로 재설정합니다.",
  "TOOLTIP_PICK_REMOTE": "선호하는 리모컨을 선택하세요",
  "TOOLTIP_PULL": "깃 풀",
  "TOOLTIP_PUSH": "깃 푸시",
  "TOOLTIP_REBASE_ABORT": "리베이스 작업을 중단하고 HEAD를 원래 브랜치로 재설정합니다.",
  "TOOLTIP_REBASE_CONTINUE": "병합 충돌을 해결한 후 리베이스 프로세스를 다시 시작합니다.",
  "TOOLTIP_REBASE_SKIP": "현재 패치를 건너뛰어 리베이스 프로세스를 다시 시작합니다.",
  "TOOLTIP_REFRESH_PANEL": "패널 새로 고침",
  "TOOLTIP_SHOW_FILE_HISTORY": "파일 기록 표시",
  "TOOLTIP_SHOW_HISTORY": "역사 보기",
  "UNDO_CHANGES": "변경 사항 취소",
  "UNDO_CHANGES_BTN": "변경 사항 취소…",
  "UNDO_LAST_LOCAL_COMMIT": "마지막 로컬(푸시되지 않은) 커밋을 취소합니다…",
  "UNDO_COMMIT": "커밋 취소",
  "URL": "웹 주소",
  "USERNAME": "사용자 이름",
  "USER_ABORTED": "사용자가 중단했습니다!",
  "USE_GIT_GUTTER": "Git 거터 마크 사용",
  "USE_NOFF": "병합이 빠른 전달로 해결되는 경우에도 병합 커밋을 만듭니다(--no-ff)",
  "USE_REBASE": "FOX 사용",
  "USE_VERBOSE_DIFF": "diff에서 자세한 출력을 표시합니다.",
  "USE_DIFFTOOL": "difftool을 사용하여 diff를 확인하세요",
  "VIEW_AUTHORS_FILE": "파일 작성자 보기…",
  "VIEW_AUTHORS_SELECTION": "선택한 작가 보기…",
  ...
  "FILE_IGNORED": "무시됨",
  "FILE_MODIFIED": "수정됨",
  "FILE_RENAMED": "이름이 변경됨",
  "FILE_STAGED": "일부러 꾸민",
  "FILE_UNMERGED": "병합되지 않음",
  "FILE_UNMODIFIED": "수정되지 않음",
  "FILE_UNTRACKED": "추적되지 않음",
  "GIT_PUSH_SUCCESS_MSG": "성공적으로 빨리 앞으로 밀었습니다",
  "GIT_PUSH_FORCE_UPDATED_MSG": "강제 업데이트 성공",
  "GIT_PUSH_DELETED_MSG": "참조를 성공적으로 삭제했습니다",
  "GIT_PUSH_NEW_REF_MSG": "새로운 참조를 성공적으로 푸시했습니다.",
  "GIT_PUSH_REJECTED_MSG": "Ref가 거부되었거나 푸시에 실패했습니다.",
  "GIT_PUSH_UP_TO_DATE_MSG": "Ref가 최신 상태였고 밀어낼 필요가 없었습니다.",
  "GIT_PULL_SUCCESS": "git pull을 성공적으로 완료했습니다.",
  "GIT_MERGE_SUCCESS": "git merge가 성공적으로 완료되었습니다.",
  "GIT_REBASE_SUCCESS": "git rebase를 성공적으로 완료했습니다.",
  "GIT_BRANCH_DELETE_SUCCESS": "git 브랜치를 성공적으로 삭제했습니다.",
  "INIT_NEW_REPO_FAILED": "새로운 저장소를 초기화하는 데 실패했습니다.",
  "GIT_CLONE_REMOTE_FAILED": "원격 저장소 복제에 실패했습니다!",
  "GIT_CLONE_ERROR_EXPLAIN": "선택한 디렉토리 `{0}`\n가 비어 있지 않습니다. Git 복제에는 깨끗하고 비어 있는 디렉토리가 필요합니다.\n비어 있는 것으로 보이면 숨겨진 파일을 확인하세요.",
  "FOLDER_NOT_WRITABLE": "선택한 디렉토리 `{0}`\n에 쓸 수 없습니다.",
  "GIT_NOT_FOUND_MESSAGE": "Git이 설치되지 않았거나 시스템에서 찾을 수 없습니다. Git을 설치하거나 아래 텍스트 필드에 Git 실행 파일의 올바른 경로를 제공하세요.",
  "ERROR_GETTING_BRANCH_LIST": "지점 목록을 가져오는 데 실패했습니다.",
  "ERROR_READING_GIT_HEAD": ".git/HEAD 파일 읽기에 실패했습니다.",
  "ERROR_PARSING_BRANCH_NAME": "{0}에서 브랜치 이름 구문 분석에 실패했습니다.",
  "ERROR_READING_GIT_STATE": ".git state 읽기에 실패했습니다.",
  "ERROR_GETTING_DELETED_FILES": "삭제된 파일 목록을 가져오는 데 실패했습니다.",
  "ERROR_SWITCHING_BRANCHES": "지점 전환에 실패했습니다",
  "ERROR_GETTING_CURRENT_BRANCH": "현재 지점 이름을 가져오는 데 실패했습니다.",
  "ERROR_REBASE_FAILED": "리베이스 실패",
  "ERROR_MERGE_FAILED": "병합 실패",
  "ERROR_BRANCH_DELETE_FORCED": "강제 브랜치 삭제에 실패했습니다.",
  "ERROR_FETCH_REMOTE_INFO": "원격 정보를 가져오는 데 실패했습니다.",
  "ERROR_CREATE_BRANCH": "새로운 브랜치를 만드는 데 실패했습니다.",
  "ERROR_REFRESH_GUTTER": "거터 새로 고침에 실패했습니다!",
  "ERROR_GET_HISTORY": "기록을 가져오는 데 실패했습니다",
  "ERROR_GET_MORE_HISTORY": "더 많은 기록 행을 로드하는 데 실패했습니다.",
  "ERROR_GET_CURRENT_BRANCH": "현재 지점 이름을 가져오지 못했습니다.",
  "ERROR_GET_DIFF_FILE_COMMIT": "diff를 얻는 데 실패했습니다",
  "ERROR_GET_DIFF_FILES": "diff 파일 목록을 로드하는 데 실패했습니다.",
  "ERROR_MODIFY_GITIGNORE": ".gitignore 수정에 실패했습니다.",
  "ERROR_UNDO_LAST_COMMIT_FAILED": "마지막 커밋을 취소할 수 없습니다",
  "ERROR_MODIFY_FILE_STATUS_FAILED": "파일 상태를 수정하지 못했습니다.",
  "ERROR_CHANGE_USERNAME_FAILED": "사용자 이름을 변경할 수 없습니다",
  "ERROR_CHANGE_EMAIL_FAILED": "사용자 이메일을 변경하는 것이 불가능합니다",
  "ERROR_TOGGLE_GERRIT_PUSH_REF_FAILED": "Gerrit Push 참조를 토글하는 것이 불가능합니다.",
  "ERROR_RESET_LOCAL_REPO_FAILED": "로컬 저장소 재설정에 실패했습니다.",
  "ERROR_CREATE_TAG": "태그 생성에 실패했습니다",
  "ERROR_CODE_INSPECTION_FAILED": "CodeInspection.inspectFile이 파일에 대해 실행되지 않았습니다.",
  "ERROR_CANT_GET_STAGED_DIFF": "스테이징된 파일에 대한 diff를 얻을 수 없습니다.",
  "ERROR_GIT_COMMIT_FAILED": "Git 커밋 실패",
  "ERROR_GIT_BLAME_FAILED": "Git Blame이 실패했습니다",
  "ERROR_GIT_DIFF_FAILED": "Git Diff가 실패했습니다",
  "ERROR_DISCARD_CHANGES_FAILED": "파일 변경 사항 취소에 실패했습니다.",
  "ERROR_COULD_NOT_RESOLVE_FILE": "파일을 확인할 수 없습니다",
  "ERROR_MERGE_ABORT_FAILED": "병합 중단에 실패했습니다",
  "ERROR_MODIFIED_DIALOG_FILES": "커밋하려고 했던 파일이 커밋 대화 상자가 표시되는 동안 수정되었습니다. 대화 상자에 표시된 것과 결과가 다르기 때문에 커밋을 중단했습니다.",
  "ERROR_GETTING_REMOTES": "리모컨 가져오기에 실패했습니다!",
  "ERROR_REMOTE_CREATION": "원격 생성에 실패했습니다",
  "ERROR_PUSHING_REMOTE": "원격으로 푸시하는 데 실패했습니다.",
  "ERROR_PULLING_REMOTE": "원격에서 가져오기 실패",
  "ERROR_PULLING_OPERATION": "당기기 작업이 실패했습니다.",
  "ERROR_PUSHING_OPERATION": "푸싱 작업이 실패했습니다",
  "ERROR_NO_REMOTE_SELECTED": "{0}에 대한 리모컨이 선택되지 않았습니다!",
  "ERROR_BRANCH_LIST": "지점 목록을 가져오는 데 실패했습니다.",
  "ERROR_FETCH_REMOTE": "원격 정보를 가져오는 데 실패했습니다."
});