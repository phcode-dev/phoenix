...
define({
  ...
  "AI_CHAT_FULL_AUTO_WARNING_TITLE": "전체 자동 모드로 전환하시겠습니까?",
  "AI_CHAT_FULL_AUTO_WARNING_BODY": "전체 자동 모드는 AI가 먼저 묻지 않고 Bash 명령어, 파일 수정, 파일 삭제, 웹 가져오기 등 모든 도구를 실행하도록 허용합니다.<br><br>이는 신뢰할 수 있는 스크래치 프로젝트에는 편리하지만 위험할 수 있습니다. 잘못된 판단으로 파일을 덮어쓰거나 삭제하고, 파괴적인 셸 명령어를 실행하거나, 의도하지 않은 변경 사항을 푸시할 수 있습니다. 문제가 발생할 경우 복구할 수 있도록 버전 관리(Git)를 사용하세요.<br><br>신뢰하는 프로젝트에서만 전체 자동 모드를 활성화하세요. 언제든지 <kbd>Shift+Tab</kbd>을 사용하거나 모드 표시줄을 클릭하여 편집 모드로 다시 전환할 수 있습니다.",
  "AI_CHAT_FULL_AUTO_WARNING_PROCEED": "전체 자동 모드 활성화",
