...
define({
  ...
  "MIGRATE_INTERRUPTED_MESSAGE": "{0}과의 연결이 도중에 끊어졌습니다. 이미 복사된 내용은 유지되었습니다. 도움말 메뉴에서 언제든지 중단된 부분부터 다시 시작할 수 있습니다.",
  "MIGRATE_INTERRUPTED_FINAL": "{0}과의 연결이 다시 끊어졌습니다. 이미 복사된 내용은 유지되었습니다. 나머지 부분을 완료하려면 {1}을(를) 선택하세요."
});