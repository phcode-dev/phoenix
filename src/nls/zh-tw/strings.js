...
define({
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME}<strong>不會收集或處理任何個人識別信息</strong>，但<strong>會收集匿名使用統計信息</strong>以保護您的隱私。匿名資料不受 GDPR/CCPA 通知要求的約束，但我們認為您需要有選擇退出匿名資料收集的權利。<br>這些<strong>匿名</strong>應用程式使用情況統計資料和錯誤報告有助於確定功能的優先順序、尋找錯誤並發現影響您使用「{APP_NAME}」體驗的可用性問題。</p><p>以下是<em>在啟用後將</em>在您的下一份健康報告中發送的資料的預覽。 （另請參閱開發人員控制台以取得標記為「捕獲嚴重錯誤」的錯誤日誌。）</p>",
  ...
  "BUILD_WEBSITE": "建立網站",
  "VIEW_MORE": "查看更多...",
  "NEW_PROJECT_NOTIFICATION": "點擊此圖示建立一個新項目。</br><img src=\"styles/images/new_project.png\"><br/><a href='#' style='float:right;'>好的</a>",
