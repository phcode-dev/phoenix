...
define({
  ...
  "WEBPAGE_HOME_PAGE": "主頁佈局",
  "WEBPAGE_BLOG": "博客頁面",
  "WEBPAGE_DASHBOARD": "HTML 儀表板",
  "WEBPAGE_BOOTSTRAP_EXAMPLES": "引導示例",
  "GUIDED_FILES_SIDEBAR": "選擇一個 HTML 文件</br><a href='#' style='float:right;'>好的</a>",
  "GUIDED_LIVE_PREVIEW": "進行一些代碼更改並保存文件以查看預覽。</br><a href='#' style='float:right;'>好的</a>",
