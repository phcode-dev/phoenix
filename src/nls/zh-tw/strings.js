...
define({
  ...
  "EDIT_FILE_FILTER": "編輯…",
  "FILE_FILTER_DIALOG": "編輯排除過濾器",
  "FILE_FILTER_INSTRUCTIONS": "排除與下列任何<a href='{0}' title=\"{0}\">忽略通配符</a>相符的檔案和資料夾。在新行中輸入每個字串。例如<ul><li><code>*.js</code>將符合<code>a/b/x.js</code> 、 <code>xyx.js</code>等。</li><li> <code>./*.css</code>只會符合專案根目錄中的<code>x.css</code> ，而不符合子資料夾中的<code>y/x.css</code> 。</li></ul>",
  "FILE_FILTER_INSTRUCTIONS_INCLUDE": "僅包含與下列任一<a href='{0}' title=\"{0}\">忽略通配符</a>相符的檔案和資料夾。在新行中輸入每個字串。例如<ul><li><code>*.js</code>將符合<code>a/b/x.js</code> 、 <code>xyx.js</code>等。</li><li> <code>./*.css</code>只會符合專案根目錄中的<code>x.css</code> ，而不符合子資料夾中的<code>y/x.css</code> 。</li></ul>",
  ...
  "CMD_KEYBOARD_NAV_OVERLAY": "使用者介面導航模式",
  "NAVIGATE_MENU": "瀏覽",
  "CMD_QUICK_OPEN": "快速開啟",
  "CMD_GOTO_LINE": "到指定行",
