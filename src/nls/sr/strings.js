...
define({
  ...
  "DESCRIPTION_LIVEDEV_SECURITY": "Безбедносно упозорење са пхцоде.дев<br><br> Овај преглед уживо је покушао да приступи датотеци која није пројект. Приступ је одбијен због ваше безбедности. Будите опрезни када радите на непоузданим пројектима.",
  ...
  "TRUST_PROJECT": "Поверите и извршите пројекат – {0}",
  ...
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Следећи типови датотека су успешно повезани са подразумеваним апликацијама.<br/> {0} Имате опцију да промените подешавања да ли бришете/додајете нове асоцијације типова датотека у брацкетс.јсон тако што ћете отићи на мени „Дебуг-&gt;Опен Преференцес Филе“.",
  ...
  "NEW_PROJECT_NOTIFICATION": "Кликните на ову икону да бисте креирали нови пројекат.</br><img src=\"extensions/default/Phoenix/images/new_project.png\"><br/> <a href='#' style='float:right;'>У реду</a>",
  "BEAUTIFY_CODE_NOTIFICATION": "Кликните овде или притисните <b>`{0}`</b> да бисте улепшали код.</br><img src=\"extensions/default/Phoenix/images/beautify.gif\"><br/> <a href='#' style='float:right;'>ок</a>",
