...
define({
  ...
  "WEBPAGE_HOME_PAGE": "Изгледи почетне странице",
  "WEBPAGE_BLOG": "Блог страница",
  "WEBPAGE_DASHBOARD": "ХТМЛ контролна табла",
  "WEBPAGE_BOOTSTRAP_EXAMPLES": "Боотстрап Примери",
  "GUIDED_FILES_SIDEBAR": "Изаберите ХТМЛ датотеку</br> <a href='#' style='float:right;'>У реду</a>",
  "GUIDED_LIVE_PREVIEW": "Направите неке измене кода и сачувајте датотеку да бисте видели преглед.</br> <a href='#' style='float:right;'>У реду</a>",
