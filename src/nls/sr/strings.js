...
define({
  ...
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Напорно радимо на томе да Пхоеник буде доступан у више претраживача. Можете да затворите овај дијалог, али неке функције у Пхоеник-у неће радити у овом претраживачу.",
