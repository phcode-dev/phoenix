...
define({
  ...
  "UPDATE_CLOSE_TO_UPDATE_TITLE": "Није могуће ажурирати",
  "UPDATE_CLOSE_TO_UPDATE": "Отворено је више прозора уређивача. Уверите се да су сви други прозори уређивача апликације {АПП_НАМЕ} затворени пре него што покушате да ажурирате. Затворите све додатне прозоре апликације {АПП_НАМЕ} и покушајте поново да ажурирате.",
