...
define({
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "Да бисмо побољшали {АПП_НАМЕ}, периодично шаљемо ограничену, <strong>псеудонимну</strong> статистику на цоре.аи о томе како користите {АПП_НАМЕ}. Ове информације помажу у одређивању приоритета функција, проналажењу грешака и уочавању проблема са употребљивошћу, истовремено чувајући вашу приватност.<br><br> Можете да видите своје податке или да изаберете да их не делите тако што ћете изабрати <strong>Помоћ &gt; Извештај о здрављу</strong> .<br><br>",
  "HEALTH_DATA_PREVIEW": "Извештај о здравственом стању апликације {АПП_НАМЕ}",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Да бисмо побољшали {АПП_НАМЕ}, периодично шаљемо ограничену, <strong>псеудонимну</strong> статистику на цоре.аи о томе како користите {АПП_НАМЕ}. Ове информације помажу у одређивању приоритета функција, проналажењу грешака и уочавању проблема употребљивости.</p><p> Испод је преглед података који ће бити послати у вашем следећем здравственом извештају <em>ако</em> је омогућен.</p>",
