...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "<code>package.json</code> датотека није откривена у тренутном пројекту. Да ли је тренутни пројекат важећи додатак за {АПП_НАМЕ}?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "<code>package.json</code> датотека је неважећи ЈСОН.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "Недостају обавезна поља у <code>package.json</code> : [{0}]",
  ...
  "PUBLISH": "Објавите",
  "PUBLISH_CONSENT_MESSAGE": "Брзо прегледајте промене и поделите своју веб локацију са другима. Пхоеник може да објави ову веб локацију за вас на {0}. Објављени линкови ће важити 7 дана. </бр>Да ли желите да објавите и делите своју веб локацију?",
