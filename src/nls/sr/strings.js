...
define({
  ...
  "PROJECT_BUSY": "Projektne operacije u toku",
  "DUPLICATING": "Dupliranje {0}",
  "MOVING": "Moving {0}",
  "COPYING": "Kopiranje {0}",
  "DELETING": "Brisanje {0}",
  ...
  "CANNOT_PASTE_TITLE": "Ne mogu da zalepim {0}",
  "ERR_TYPE_PASTE_FAILED": "Došlo je do greške prilikom lepljenja <span class='dialog-filename'>{0}</span> na <span class='dialog-filename'>{1}</span>",
  "CANNOT_DUPLICATE_TITLE": "Ne mogu se duplirati",
  "ERR_TYPE_DUPLICATE_FAILED": "Došlo je do greške prilikom dupliranja <span class='dialog-filename'>{0}</span>",
  ...
  "CMD_ENABLE_SELECTION_VIEW": "Pogled na izbor",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "Objekat sa podrazumevanim opcijama za JShint. Molimo pogledajte sledeću URL adresu za sve dostupne opcije JShint: https://jshint.com/docs/options/",
  ...
  "DESCRIPTION_SELECTION_VIEW_ENABLED": "tačno da biste omogućili prikaz selekcije",
  ...
  "EXTRACTING_FILES_PROGRESS": "Izdvajanje {0} od {1} fajlova.",
  ...
  "BEAUTIFY_ERROR": "Ne mogu ulepšati kod. Proverite sintaksu.",
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Ne mogu da ulepšaju. Tekst uređivača promenjen nakon ulepšavanja.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Ulepšavanje File {0}",
  "BEAUTIFY_ERROR_SELECTION": "Ne mogu da ulepšaju. </br>Nepotpunblok koda izabrana ili nevažeća sintaksa.",
  "BEAUTIFY_OPTIONS": "Opcije koje kontrolišu kako funkcioniše Beautifi Code",
  "BEAUTIFY_OPTION_PRINT_WIDTH": "Navedite dužinu linije na koju će ulepšivač završiti",
  "BEAUTIFY_OPTION_SEMICOLON": "Dodajte tačku sa zarezom na kraju svake izjave",
  "BEAUTIFY_OPTION_SINGLE_QUOTE": "Koristite pojedinačne citate umesto dvostrukih citata",
  "BEAUTIFY_OPTION_QUOTE_PROPS": "Promenite kada se citiraju svojstva u objektima",
  "BEAUTIFY_OPTION_BRACKET_SAME_LINE": "Staviti> od multi-line HTML (HTML, JSKS, Vue, Ugaona) element na kraju poslednje linije umesto da bude sam na sledećem redu (ne odnosi se na samo zatvaranje elemenata)",
  "BEAUTIFY_OPTION_SINGLE_ATTRIBUTE_PER_LINE": "Primenite jedan atribut po liniji u HTML, Vue i JSKS",
  "BEAUTIFY_OPTION_PROSE_WRAP": "Zamotajte prozu ako prelazi širinu štampe u datotekama za obeležavanje",
  "BEAUTIFY_OPTION_PRINT_TRAILING_COMMAS": "Štampajte zareze gde god je to moguće u sintaktičkim strukturama odvojenim zarezima sa više linija"
});