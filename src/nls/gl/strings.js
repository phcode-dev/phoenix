...
define({
  ...
  "NEW_PROJECT_FROM_GIT": "Novo proxecto desde Git",
  ...
  "AMEND_COMMIT": "Corrixir o último commit",
  "SKIP_COMMIT_CHECKS": "Saltar as comprobacións pre-commit (--no-verify)",
  "AMEND_COMMIT_FORBIDDEN": "Non se pode corrixir o commit cando non hai commits sen enviar",
  ...
  "RESET_DETAIL": "<b>Os seguintes commits descartaranse:</b><br><b>Mensaxe do commit:</b> {0}<br><b>Comando Git:</b> {1}",
  ...
  "CLEAN_FILE_START": "Limpando ficheiro",
  ...
  "CODE_INSPECTION_IN_PROGRESS": "Inspección de código en progreso…",
  ...
  "CREATE_NEW_BRANCH": "Crear nova rama…",
  "CREATE_NEW_BRANCH_TITLE": "Crear nova rama",
  "CREATE_NEW_GITFTP_SCOPE": "Crear novo remoto Git-FTP…",
  "CREATE_NEW_REMOTE": "Crear novo remoto…",
  ...
  "DELETE_LOCAL_BRANCH_NAME": "Desexa realmente eliminar a rama local \"{0}\"?",
  "DELETE_REMOTE": "Eliminar remoto",
  "DELETE_REMOTE_NAME": "Desexa realmente eliminar o remoto \"{0}\"?",
  "DELETE_SCOPE": "Eliminar ámbito Git-FTP",
  "DELETE_SCOPE_NAME": "Desexa realmente eliminar o ámbito Git-FTP \"{0}\"?",
  "DIALOG_CHECKOUT": "Ao extraer un commit, o repositorio entrará nun estado DETACHED HEAD. Non podes facer commits a menos que crees unha rama baseada neste.",
  ...
  "DIFF_FAILED_SEE_FILES": "Git diff non puido proporcionar resultados de diff. Esta é a lista de ficheiros preparados para ser enviados:",
  "DIFF_TOO_LONG": "Diff demasiado longo para mostrar",
  "ENABLE_GERRIT_PUSH_REF": "Usar a referencia de envío compatible con Gerrit",
  "ENTER_NEW_USER_EMAIL": "Introducir o correo electrónico",
  ...
  "ERROR_SAVE_FIRST": "Garde o documento primeiro!",
  ...
  "GUTTER_CLICK_DETAILS": "Prema para ver máis detalles",
  "HIDE_UNTRACKED": "Agochar os ficheiros sen rastrexar no panel",
  "HISTORY": "Historial",
  ...
  "OPERATION_IN_PROGRESS_TITLE": "Operación Git en progreso…",
  "ORIGIN_BRANCH": "Rama de orixe",
  "ON_BRANCH": "'{0}' - Rama Git actual",
  "PANEL_COMMAND": "Mostrar panel Git",
  ...
  "PULL_SHORTCUT": "Extraer do remoto…",
  "PULL_SHORTCUT_BEHIND": "Extraer do remoto ({0} atrás)…",
  "PULL_BEHAVIOR": "Comportamento da extracción",
  ...
  "UNDO_LOCAL_COMMIT_CONFIRM": "Seguro que queres desfacer o último commit non enviado?",
  ...
  "VIEW_AUTHORS_FILE": "Ver os autores do ficheiro…",
  "VIEW_AUTHORS_SELECTION": "Ver os autores da selección…",
  ...
  "FILE_UNTRACKED": "Sen rastrexar",
  "GIT_PUSH_SUCCESS_MSG": "Envío con avance rápido realizado correctamente",
  ...
  "ERROR_MODIFIED_DIALOG_FILES": "Os ficheiros que ía confirmar modificáronse mentres se mostraba o diálogo de confirmación. Anúlase a confirmación xa que o resultado sería diferente do que se mostraba no diálogo.",
