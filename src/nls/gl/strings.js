...
define({
  ...
  "DESCRIPTION_LIVEDEV_MAIN_HEADING": "Vaites! O seu navegador actual non admite a vista previa en vivo.",
  "DESCRIPTION_LIVEDEV_MAIN_SPAN": "Obteña a mellor experiencia de vista previa en vivo descargando as nosas aplicacións nativas para Windows, Mac e Linux desde {0}.",
  "AI_CHAT_TOOL_READ_FILE_RANGE": "Ler {0} liñas {1}-{2}",
  ...
  "AI_CHAT_TOOL_REJECTED": "Edición rexeitada — ficheiro non modificado",
