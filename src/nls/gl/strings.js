...
define({
  ...
  "DEVICE_SIZE_LIMIT_MESSAGE": "Phoenix Pro permítelle previsualizar a páxina nos tamaños de pantalla definidos no seu CSS.",
  "AI_CHAT_TITLE": "Claude Code",
  "AI_CHAT_CLI_NOT_FOUND": "Claude Code non instalado",
  "AI_CHAT_CLI_INSTALL_MSG": "A CLI de Claude Code debe estar instalada no seu sistema para usar as funcións de IA en {APP_NAME}. <a class='ai-learn-more-link' href='#'>Máis información</a>",
  "AI_CHAT_CLI_INSTALL_BTN": "Instalar Claude Code",
  "AI_CHAT_CLI_INSTALLING": "Instalando…",
  "AI_CHAT_CLI_INSTALLING_MSG": "Instalando Claude Code, agarde por favor. Isto pode levar un tempo...",
  "AI_CHAT_CLI_RESTART_NOTE": "Reinicie {APP_NAME} unha vez completada a instalación.",
