...
define({
  ...
  "AI_CHAT_CLI_INSTALLING_MSG": "Instalando Claude Code, agarda por favor. Isto pode levar un tempo...",
  "AI_CHAT_CLI_RESTART_NOTE": "Reinicia {APP_NAME} despois de que remate a instalación.",
  "AI_CHAT_CLI_NOT_FOUND_TITLE": "Non se atopou {0}",
  "AI_CHAT_CLI_NOT_FOUND_MSG": "Non se puido atopar {0} neste sistema. Instálao ou introduce a ruta completa ao seu executábel a continuación.",
  "AI_CHAT_CLI_NOT_FOUND_BAD_PATH_MSG": "Non se puido usar a ruta establecida para {0}: {1} Introduce unha ruta diferente ou baleira a caixa para detectala automaticamente.",
  "AI_CHAT_CLI_NOT_FOUND_INSTALL_BTN": "Instalar {0}",
  "AI_CHAT_CLI_NOT_FOUND_SAVE_BTN": "Gardar e tentar de novo",
  "AI_CHAT_CLI_NOT_FOUND_LEARN_MORE": "Instrucións de instalación",
  ...
  "AI_CHAT_PLACEHOLDER_SUBTITLE": "IA que funciona coa súa vista previa",
  "AI_CHAT_PLACEHOLDER_CARD_LAYOUT_TITLE": "Xerar maquetación",
  "AI_CHAT_PLACEHOLDER_CARD_LAYOUT_DESC": "Describa unha sección",
  "AI_CHAT_PLACEHOLDER_CARD_BUGS_TITLE": "Corrixir erros",
  "AI_CHAT_PLACEHOLDER_CARD_BUGS_DESC": "Buscar problemas",
  "AI_CHAT_PLACEHOLDER_CARD_IMPROVE_TITLE": "Suxerir melloras",
  "AI_CHAT_PLACEHOLDER_CARD_IMPROVE_DESC": "Consellos de UX e rendemento",
  "AI_CHAT_LOGIN_TITLE": "Inicia sesión para empezar coa IA",
  "AI_CHAT_LOGIN_MESSAGE": "Inicie sesión na súa conta de {APP_NAME} para acceder ás funcións de IA.",
  ...
  "LIVE_PREVIEW_LAYERS_SHOW_MORE_FILES": "Amosar {0} máis",
  "LIVE_PREVIEW_LAYERS_SHOW_FEWER_FILES": "Amosar menos",
