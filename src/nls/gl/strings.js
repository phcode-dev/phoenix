...
define({
  ...
  "IMAGE_SEARCH_MONTHLY_LIMIT_MESSAGE": "Esgotaches as {0} buscas de imaxes deste mes.<br>Inicia un plan de pago de Phoenix Pro para eliminar os límites da proba e continuar buscando."
});