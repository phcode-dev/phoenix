...
define({
  ...
  "LIVE_DEV_SETTINGS_SHOW_STYLES_BAR_PREFERENCE": "Amosar a barra de estilos cando se seleccionan elementos na vista previa en vivo. O valor predeterminado é 'true'",
  "LIVE_DEV_SETTINGS_SHOW_STARTER_BAR_PREFERENCE": "Amosar a barra de inicio cando a páxina de vista previa en directo estea baleira. O valor predeterminado é 'true'",
  "LIVE_DEV_SETTINGS_STYLES_BAR_POSITION_PREFERENCE": "Bordo no que se acopla a barra de estilos da vista previa en directo, 'superior' ou 'inferior'. O valor predeterminado é 'bottom'",
  "LIVE_DEV_TOOLBOX_SELECT_PARENT": "Seleccionar pai",
  "LIVE_DEV_SCRIPT_GENERATED_TOOLTIP": "Engadido por un script, polo que non está no código fonte HTML. As súas regras CSS aínda se poden editar.",
  "LIVE_DEV_STYLER_SCRIPT_ELEMENT_NOTICE": "Elemento xerado por script: as edicións gárdanse nas súas regras CSS.",
  "LIVE_DEV_TOOLBOX_EDIT_TEXT": "Editar texto",
  "LIVE_DEV_TOOLBOX_DOUBLE_CLICK_HINT": "Dobre clic",
  "LIVE_DEV_TOOLBOX_EDIT_ELEMENT_PROPS": "Editar as propiedades do elemento",
  ...
  "LIVE_DEV_STYLER_DOCK_BOTTOM": "Acoplar abaixo",
  "LIVE_DEV_STYLER_RESET": "Restablecer os cambios",
  "LIVE_DEV_STYLER_NOTHING_TO_RESET": "Non hai cambios que restablecer",
  "LIVE_DEV_STYLER_OVERRIDDEN": "Este cambio é sobrescrito por unha regra máis específica",
  "LIVE_DEV_STYLER_APPLY_INLINE": "Aplicar aínda así",
  "LIVE_DEV_STYLER_CLOSE_SAVED": "Aceptar",
  "LIVE_DEV_STYLER_MIXED": "Mixto",
  "LIVE_DEV_STYLER_SIDES_MIXED": "Os lados difiren — edite cada lado por separado",
  "LIVE_DEV_STYLER_SEARCH_FONTS": "Buscar fontes…",
  "LIVE_DEV_STYLER_FONTS_GOOGLE": "Google",
  "LIVE_DEV_STYLER_FONTS_SYSTEM": "Sistema",
  "LIVE_DEV_STYLER_NO_FONTS_FOUND": "Non se atoparon fontes",
  "LIVE_DEV_STYLER_LOAD_MORE": "Cargar máis",
  "LIVE_DEV_STYLER_FONTS_MANUAL": "Manual",
  "LIVE_DEV_STYLER_FONT_MANUAL_PLACEHOLDER": "p. ex. Helvetica Neue",
  "LIVE_DEV_STYLER_FONT_MANUAL_APPLY": "Aplicar",
  "LIVE_DEV_STYLER_FONT_MANUAL_HINT": "Escribe o nome de calquera fonte. As Google Fonts engádense automaticamente; as outras xa deben estar dispoñibles.",
  "LIVE_DEV_STYLER_FONT_UPLOAD": "Cargar un ficheiro de fonte",
  "LIVE_DEV_STYLER_FONT_UPLOAD_HINT": ".ttf .otf .woff .woff2",
  "LIVE_DEV_STYLER_FONT_UPLOAD_FAILED": "Non se puido engadir ese ficheiro de fonte",
  "LIVE_DEV_STYLER_WEIGHT_THIN": "Fina",
  "LIVE_DEV_STYLER_WEIGHT_EXTRA_LIGHT": "Extrafina",
  "LIVE_DEV_STYLER_WEIGHT_LIGHT": "Lixeira",
  "LIVE_DEV_STYLER_WEIGHT_REGULAR": "Regular",
  "LIVE_DEV_STYLER_WEIGHT_MEDIUM": "Media",
  "LIVE_DEV_STYLER_WEIGHT_SEMI_BOLD": "Semigrosa",
  "LIVE_DEV_STYLER_WEIGHT_BOLD": "Negriña",
  "LIVE_DEV_STYLER_WEIGHT_EXTRA_BOLD": "Extranegriña",
  "LIVE_DEV_STYLER_WEIGHT_BLACK": "Negra",
  "LIVE_DEV_STYLER_LINE_HEIGHT": "Interliñado",
  "LIVE_DEV_STYLER_LETTER_SPACING": "Espazado entre letras",
  "LIVE_DEV_STYLER_WORD_SPACING": "Espazado entre palabras",
  "LIVE_DEV_STYLER_TEXT_INDENT": "Sangría do texto",
  "LIVE_DEV_STYLER_FORMAT_TAB": "Formato",
  "LIVE_DEV_STYLER_SPACING_TAB": "Espazamento",
  "LIVE_DEV_STYLER_CASE": "Caixa",
  "LIVE_DEV_STYLER_ITALIC": "Cursiva",
  "LIVE_DEV_STYLER_UNDERLINE": "Subliñado",
  "LIVE_DEV_STYLER_OVERLINE": "Liña superior",
  "LIVE_DEV_STYLER_STRIKETHROUGH": "Riscado",
  "LIVE_DEV_STYLER_NONE": "Ningún",
  "LIVE_DEV_STYLER_UPPERCASE": "Maiúsculas",
  "LIVE_DEV_STYLER_LOWERCASE": "Minúsculas",
  "LIVE_DEV_STYLER_CAPITALIZE": "Capitalizar",
  "LIVE_DEV_STYLER_ALIGN_LEFT": "Aliñar á esquerda",
  "LIVE_DEV_STYLER_ALIGN_CENTER": "Aliñar ao centro",
  "LIVE_DEV_STYLER_ALIGN_RIGHT": "Aliñar á dereita",
  "LIVE_DEV_STYLER_ALIGN_JUSTIFY": "Xustificar",
  "LIVE_DEV_STYLER_CURSOR": "Cursor",
  "LIVE_DEV_STYLER_CURSOR_AUTO": "Automático",
  "LIVE_DEV_STYLER_CURSOR_DEFAULT": "Predeterminado",
  "LIVE_DEV_STYLER_CURSOR_POINTER": "Punteiro",
  "LIVE_DEV_STYLER_CURSOR_TEXT": "Texto",
  "LIVE_DEV_STYLER_CURSOR_MOVE": "Mover",
  "LIVE_DEV_STYLER_CURSOR_GRAB": "Agarrar",
  "LIVE_DEV_STYLER_CURSOR_GRABBING": "Agarrando",
  "LIVE_DEV_STYLER_CURSOR_NOT_ALLOWED": "Non permitido",
  "LIVE_DEV_STYLER_CURSOR_HELP": "Axuda",
  "LIVE_DEV_STYLER_CURSOR_WAIT": "Agardar",
  "LIVE_DEV_STYLER_CURSOR_PROGRESS": "Progreso",
  "LIVE_DEV_STYLER_CURSOR_CROSSHAIR": "Cruz",
  "LIVE_DEV_STYLER_CURSOR_ZOOM_IN": "Achegar",
  "LIVE_DEV_STYLER_CURSOR_ZOOM_OUT": "Afastar",
  "LIVE_DEV_STYLER_REMOVE_BACKGROUND": "Eliminar a cor de fondo",
  "LIVE_DEV_STYLER_REMOVE_PROPERTY": "Eliminar {0}",
  "LIVE_DEV_STYLER_RESET_DEFAULT": "Restablecer ao valor predeterminado do navegador",
  "LIVE_DEV_STYLER_CTX_NOT_SET": "Non establecido neste elemento",
  "LIVE_DEV_STYLER_CTX_SHORTHAND_BLOCKED": "Establecido por unha propiedade abreviada, use Restablecer no seu lugar",
  "LIVE_DEV_STYLER_AFFECTS_TITLE": "{0} afecta a {1} elementos nesta páxina",
  "LIVE_DEV_STYLER_CTX_AFFECTS": "afecta a {0} elementos",
  "LIVE_DEV_STYLER_CTX_AFFECTS_ONE": "afecta só a este elemento",
  "LIVE_DEV_STYLER_CTX_FROM_RULE": "De {0}",
  "LIVE_DEV_STYLER_CTX_INLINE_STYLE": "o estilo en liña deste elemento",
  "LIVE_DEV_STYLER_CTX_ADDS_REVERT": "Engade {0} a este elemento",
  "LIVE_DEV_STYLER_CLEAR_IN_RULE": "{0} está definido por {1}",
  "LIVE_DEV_STYLER_CLEAR_IN_INLINE": "{0} está definido en {1}",
  "LIVE_DEV_STYLER_CLEAR_IN_SHORTHAND": "{0} está definido polo atallo {1}",
  "LIVE_DEV_STYLER_CLEAR_REMOVE_BTN": "Eliminar",
  "LIVE_DEV_STYLER_CLEAR_RESET_BTN": "Restablecer",
  "LIVE_DEV_STYLER_LEARN_MORE": "Máis información…",
  "LIVE_DEV_STYLER_RADIUS": "Raio",
  "LIVE_DEV_STYLER_WIDTH": "Ancho",
  "LIVE_DEV_STYLER_COLOR": "Cor",
  "LIVE_DEV_STYLER_ON_THIS_PAGE": "Nesta páxina",
  "LIVE_DEV_STYLER_FROM_GOOGLE": "De Google Fonts",
  "LIVE_DEV_STYLER_COMMON_COLORS": "Comúns",
  "LIVE_DEV_STYLER_COLOR_WHITE": "Branco",
  "LIVE_DEV_STYLER_COLOR_SILVER": "Prata",
  "LIVE_DEV_STYLER_COLOR_GRAY": "Gris",
  "LIVE_DEV_STYLER_COLOR_BLACK": "Negro",
  "LIVE_DEV_STYLER_COLOR_RED": "Vermello",
  "LIVE_DEV_STYLER_COLOR_MAROON": "Granate",
  "LIVE_DEV_STYLER_COLOR_ORANGE": "Laranxa",
  "LIVE_DEV_STYLER_COLOR_GOLD": "Dourado",
  "LIVE_DEV_STYLER_COLOR_YELLOW": "Amarelo",
  "LIVE_DEV_STYLER_COLOR_OLIVE": "Oliva",
  "LIVE_DEV_STYLER_COLOR_LIME": "Lima",
  "LIVE_DEV_STYLER_COLOR_GREEN": "Verde",
  "LIVE_DEV_STYLER_COLOR_TEAL": "Cerceta",
  "LIVE_DEV_STYLER_COLOR_CYAN": "Cian",
  "LIVE_DEV_STYLER_COLOR_BLUE": "Azul",
  "LIVE_DEV_STYLER_COLOR_NAVY": "Azul mariño",
  "LIVE_DEV_STYLER_COLOR_INDIGO": "Índigo",
  "LIVE_DEV_STYLER_COLOR_PURPLE": "Púrpura",
  "LIVE_DEV_STYLER_COLOR_MAGENTA": "Maxenta",
  "LIVE_DEV_STYLER_COLOR_VIOLET": "Violeta",
  "LIVE_DEV_STYLER_COLOR_PINK": "Rosa",
  "LIVE_DEV_STYLER_STYLE": "Estilo",
  "LIVE_DEV_STYLER_SOLID": "Sólido",
  "LIVE_DEV_STYLER_DASHED": "A trazos",
  "LIVE_DEV_STYLER_DOTTED": "Punteado",
  "LIVE_DEV_STYLER_DOUBLE": "Dobre",
  "LIVE_DEV_STYLER_OUTLINE": "Contorno",
  "LIVE_DEV_STYLER_OFFSET": "Desprazamento",
  "LIVE_DEV_STYLER_BORDER_AND_OUTLINE": "Bordo e contorno",
  "LIVE_DEV_STYLER_BORDER_COLOR": "Cor do bordo",
  "LIVE_DEV_STYLER_OUTLINE_COLOR": "Cor do contorno",
  "LIVE_DEV_STYLER_SIDE": "Lado",
  "LIVE_DEV_STYLER_PADDING": "Recheo",
  "LIVE_DEV_STYLER_MARGIN": "Marxe",
  "LIVE_DEV_STYLER_SIDES_LINKED": "Editar todos os lados xuntos",
  "LIVE_DEV_STYLER_SIDES_INDEPENDENT": "Editar os lados de forma independente",
  "LIVE_DEV_STYLER_LINK_NONE": "Lados independentes: cada lado ten o seu propio valor",
  "LIVE_DEV_STYLER_LINK_PAIRED": "Emparellados: superior e inferior vinculados, esquerdo e dereito vinculados",
  "LIVE_DEV_STYLER_LINK_ALL": "Todos os lados vinculados: un valor para cada lado",
  "LIVE_DEV_STYLER_LINK_NONE_SHORT": "Independente",
  "LIVE_DEV_STYLER_LINK_PAIRED_SHORT": "Emparellado",
  "LIVE_DEV_STYLER_LINK_ALL_SHORT": "Todos ligados",
  "LIVE_DEV_STYLER_LINK_CYCLE_HINT": "Faga clic para cambiar como se vinculan os lados",
  "LIVE_DEV_STYLER_ALL_SIDES": "Todos",
  "LIVE_DEV_STYLER_TOP": "Arriba",
  "LIVE_DEV_STYLER_RIGHT": "Dereita",
  "LIVE_DEV_STYLER_BOTTOM": "Abaixo",
  "LIVE_DEV_STYLER_LEFT": "Esquerda",
  "LIVE_DEV_STYLER_DISPLAY": "Visualización",
  "LIVE_DEV_STYLER_DIRECTION": "Dirección",
  "LIVE_DEV_STYLER_JUSTIFY": "Xustificar",
  "LIVE_DEV_STYLER_ALIGN_ITEMS": "Aliñar elementos",
  "LIVE_DEV_STYLER_WRAP": "Axuste",
  "LIVE_DEV_STYLER_GAP": "Espazamento",
  "LIVE_DEV_STYLER_COLUMNS": "Columnas",
  "LIVE_DEV_STYLER_ROWS": "Filas",
  "LIVE_DEV_STYLER_POSITION": "Posición",
  "LIVE_DEV_STYLER_Z_INDEX": "Índice Z",
  "LIVE_DEV_STYLER_BLOCK": "Bloque",
  "LIVE_DEV_STYLER_INLINE": "En liña",
  "LIVE_DEV_STYLER_INLINE_BLOCK": "Bloque en liña",
  "LIVE_DEV_STYLER_FLEX": "Flex",
  "LIVE_DEV_STYLER_INLINE_FLEX": "Flex en liña",
  "LIVE_DEV_STYLER_GRID": "Grella",
  "LIVE_DEV_STYLER_HIDDEN": "Oculto",
  "LIVE_DEV_STYLER_ROW": "Fila",
  "LIVE_DEV_STYLER_COLUMN": "Columna",
  "LIVE_DEV_STYLER_ROW_REVERSE": "Fila inversa",
  "LIVE_DEV_STYLER_COLUMN_REVERSE": "Columna inversa",
  "LIVE_DEV_STYLER_START": "Inicio",
  "LIVE_DEV_STYLER_CENTER": "Centro",
  "LIVE_DEV_STYLER_END": "Final",
  "LIVE_DEV_STYLER_SPACE_BETWEEN": "Espazo entre",
  "LIVE_DEV_STYLER_SPACE_AROUND": "Espazo ao redor",
  "LIVE_DEV_STYLER_SPACE_EVENLY": "Espazo uniforme",
  "LIVE_DEV_STYLER_STRETCH": "Estirar",
  "LIVE_DEV_STYLER_BASELINE": "Liña de base",
  "LIVE_DEV_STYLER_NO_WRAP": "Sen axuste",
  "LIVE_DEV_STYLER_WRAP_REVERSE": "Axuste inverso",
  "LIVE_DEV_STYLER_STATIC": "Estático",
  "LIVE_DEV_STYLER_RELATIVE": "Relativo",
  "LIVE_DEV_STYLER_ABSOLUTE": "Absoluto",
  "LIVE_DEV_STYLER_STICKY": "Adherente",
  "LIVE_DEV_STYLER_FIXED": "Fixo",
  "LIVE_DEV_STYLER_PLACEMENT": "Colocación",
  "LIVE_DEV_STYLER_DISTRIBUTE": "Distribuír",
  "LIVE_DEV_STYLER_PACKED": "Empaquetado",
  "LIVE_DEV_STYLER_APPLIES_TO": "Gardar os cambios en",
  "LIVE_DEV_STYLER_INLINE_STYLE": "En liña",
  "LIVE_DEV_STYLER_TARGET_INLINE_HINT": "directamente no elemento",
  "LIVE_DEV_STYLER_TARGET_COUNT": "Afecta a {0} na páxina",
  "LIVE_DEV_STYLER_TARGET_CREATE": "Nova regra en {0}",
  "LIVE_DEV_STYLER_NEW_RULE": "Crear nova regra…",
  "LIVE_DEV_STYLER_NEW_RULE_TITLE": "Crear nova regra",
  "LIVE_DEV_STYLER_NEW_ADDS_CLASS": "Engade a clase \"{0}\" a este elemento e garda o estilo en {1}",
  "LIVE_DEV_STYLER_NEW_ADDS_ID": "Dálle a este elemento o ID \"{0}\" e garda o estilo en {1}",
  "LIVE_DEV_STYLER_NEW_SAVES_ONE": "Garda o estilo en {0}: aplica o estilo só a este elemento",
  "LIVE_DEV_STYLER_NEW_SAVES_MANY": "Garda o estilo en {0}: aplica o estilo a {1} elementos na páxina",
  "LIVE_DEV_STYLER_NEW_ERR_ID_TAKEN": "Outro elemento xa ten ese ID. Probe a usar unha clase no seu lugar.",
  "LIVE_DEV_STYLER_NEW_ERR_NO_MATCH": "Isto non coincide co elemento seleccionado, polo que as súas edicións non o modificarán.",
  "LIVE_DEV_STYLER_NEW_ERR_PSEUDO_ELEMENT": "Os pseudo-elementos como \"::before\" non se poden estilizar aquí",
  "LIVE_DEV_STYLER_NEW_ERR_STATE_BASE": "Engada unha clase ou un ID antes do estado, como .button:hover",
  "LIVE_DEV_STYLER_NEW_STATE_SAVES": "Crea \"{0}\" - as edicións aplícanse no estado {1}",
  "LIVE_DEV_STYLER_NEW_STATE_ADDS_CLASS": "Engade a clase \"{0}\" a este elemento e estiliza o seu estado {1}",
  "LIVE_DEV_STYLER_NEW_STATE_ADDS_ID": "Dálle a este elemento o ID \"{0}\" e aplica estilos ao seu estado {1}",
  "LIVE_DEV_STYLER_NEW_ERR_INVALID": "Non parece un nome de estilo válido. Proba cunha clase como .card ou un ID como #hero",
  "LIVE_DEV_STYLER_CREATE": "Crear",
  "LIVE_DEV_STYLER_SELECTOR_PLACEHOLDER": "P. ex. .card ou #hero",
  "LIVE_DEV_STYLER_STATE": "Estado",
  "LIVE_DEV_STYLER_STATE_PICK": "Editar un estado (ao pasar o rato, foco, …)",
  "LIVE_DEV_STYLER_STATE_NORMAL": "Normal",
  "LIVE_DEV_STYLER_STATE_BANNER": "Editando o estado {0} — os cambios só se aplican a {0}",
  "LIVE_DEV_STYLER_STATE_EXIT": "Saír",
  "LIVE_DEV_STYLER_STATE_EXIT_NAMED": "Saír de {0}",
  "LIVE_DEV_STYLER_STATE_NO_BASE": "Os estados non se poden aplicar a estilos en liña",
  "LIVE_DEV_STYLER_STATE_HOVER": "Ao pasar o rato",
  "LIVE_DEV_STYLER_STATE_FOCUS": "Foco",
  "LIVE_DEV_STYLER_STATE_ACTIVE": "Activo",
  "LIVE_DEV_STYLER_STATE_FOCUS_WITHIN": "Foco interno",
  "LIVE_DEV_STYLER_STATE_FOCUS_VISIBLE": "Foco visible",
  "LIVE_DEV_STYLER_STATE_VISITED": "Visitado",
  "LIVE_DEV_STYLER_STATE_TARGET": "Obxectivo",
  "LIVE_DEV_STYLER_STATE_CHECKED": "Marcado",
  "LIVE_DEV_STYLER_STATE_DISABLED": "Desactivado",
  "LIVE_DEV_STYLER_STATE_ENABLED": "Activado",
  "LIVE_DEV_STYLER_STATE_PLACEHOLDER_SHOWN": "Marcador de posición mostrado",
  "LIVE_DEV_STYLER_HEIGHT": "Altura",
  "LIVE_DEV_STYLER_SIZE_TAB": "Tamaño",
  "LIVE_DEV_STYLER_MIN_WIDTH": "Ancho mín.",
  "LIVE_DEV_STYLER_MAX_WIDTH": "Ancho máx.",
  "LIVE_DEV_STYLER_MIN_HEIGHT": "Altura mín.",
  "LIVE_DEV_STYLER_MAX_HEIGHT": "Altura máx.",
  "LIVE_DEV_STYLER_MIN": "Mín.",
  "LIVE_DEV_STYLER_MAX": "Máx.",
  "LIVE_DEV_STYLER_LIMITS": "Mín. / máx.",
  "LIVE_DEV_STYLER_LIMITS_SHOW": "Amosar límites de tamaño mín. / máx.",
  "LIVE_DEV_STYLER_LIMITS_HIDE": "Ocultar os límites de tamaño mínimo/máximo",
  "LIVE_DEV_STYLER_OPACITY": "Opacidade",
  "LIVE_DEV_STYLER_CHANGE_UNIT": "Cambiar unidade: alterna entre {0}",
  "LIVE_DEV_STYLER_INCREASE_VALUE": "Aumentar {0}",
  "LIVE_DEV_STYLER_DECREASE_VALUE": "Diminuír {0}",
  "LIVE_DEV_STYLER_INCREASE": "Aumentar o valor",
  "LIVE_DEV_STYLER_DECREASE": "Diminuír o valor",
  "LIVE_DEV_STYLER_STEP_HINT": "Maiús + Clic: x10",
  "LIVE_DEV_STYLER_EYEDROPPER": "Seleccionar cor da páxina",
  "LIVE_DEV_MORE_OPTIONS_CUT": "Cortar",
  "LIVE_DEV_MORE_OPTIONS_COPY": "Copiar",
  "LIVE_DEV_MORE_OPTIONS_PASTE": "Pegar",
  "LIVE_DEV_INSERT_ELEMENT": "Inserir elemento",
  "LIVE_DEV_INSERT_BEFORE": "Antes",
  "LIVE_DEV_INSERT_AFTER": "Despois",
  "LIVE_DEV_INSERT_INSIDE": "Dentro",
  "LIVE_DEV_INSERT_WRAP": "Envolver",
  ...
  "LIVE_DEV_INSERT_SHOW_MORE": "Amosar máis",
  "LIVE_DEV_INSERT_SHOW_LESS": "Amosar menos",
  "LIVE_DEV_INSERT_CREATE": "Crear {0}",
  "LIVE_DEV_INSERT_NAME_ACCORDION": "Acordeón",
  "LIVE_DEV_INSERT_NAME_PASSWORD": "Contrasinal",
  "LIVE_DEV_INSERT_NAME_MAIN_CONTENT": "Contido principal",
  "LIVE_DEV_INSERT_NAME_CODE_BLOCK": "Bloque de código",
  "LIVE_DEV_INSERT_NAME_DEF_LIST": "Lista de def.",
  "LIVE_DEV_INSERT_NAME_FILE_UPLOAD": "Carga de ficheiros",
  "LIVE_DEV_INSERT_NAME_DATE_PICKER": "Selector de data",
  "LIVE_DEV_INSERT_NAME_IFRAME": "iFrame",
  "LIVE_DEV_STARTER_BAR_LABEL": "A túa páxina está baleira — engade un elemento",
  ...
  "LIVE_DEV_FORMAT_BOLD": "Negra",
  "LIVE_DEV_FORMAT_ITALIC": "Cursiva",
  "LIVE_DEV_FORMAT_UNDERLINE": "Subliñado",
  "LIVE_DEV_FORMAT_STRIKETHROUGH": "Riscado",
  ...
  "LIVE_DEV_FORMAT_MORE": "Máis formatos",
  "LIVE_DEV_ELEMENT_PROPS_TITLE": "Propiedades do elemento",
  "LIVE_DEV_ELEMENT_PROPS_TAG": "Etiqueta",
  "LIVE_DEV_ELEMENT_PROPS_VOID_ERROR": "<{0}> é de peche automático e non pode ter contido",
  "LIVE_DEV_ELEMENT_PROPS_SIZE": "Tamaño",
  "LIVE_DEV_ELEMENT_PROPS_CLASS": "Clase",
  "LIVE_DEV_ELEMENT_PROPS_ID": "ID",
  "LIVE_DEV_ELEMENT_PROPS_HREF": "Ligazón",
  "LIVE_DEV_ELEMENT_PROPS_ADD_CLASS": "+ engadir clase",
  "LIVE_DEV_ELEMENT_PROPS_CLASS_PLACEHOLDER": "Engadir unha clase…",
  "LIVE_DEV_ELEMENT_PROPS_ID_PLACEHOLDER": "Engadir un ID…",
  "LIVE_DEV_ELEMENT_PROPS_SEARCH_TAGS": "Suxestións de etiquetas",
  "LIVE_DEV_ELEMENT_PROPS_COMPUTED": "Calculado:",
  "LIVE_DEV_ELEMENT_PROPS_USE_CUSTOM": "Usar “{0}”",
  "LIVE_DEV_ELEMENT_PROPS_ATTRIBUTES": "Atributos",
  "LIVE_DEV_ELEMENT_PROPS_ADD_ATTR": "+ engadir atributo",
  "LIVE_DEV_ELEMENT_PROPS_ATTR_NAME": "nome",
  "LIVE_DEV_ELEMENT_PROPS_ATTR_VALUE": "valor",
  "LIVE_DEV_ELEMENT_PROPS_LOADING": "Cargando",
  "LIVE_DEV_ELEMENT_PROPS_NO_CLASSES": "Aínda non hai clases",
  "LIVE_DEV_ELEMENT_PROPS_NO_ATTRIBUTES": "Aínda non hai atributos",
  "LIVE_DEV_ELEMENT_PROPS_RESETTING": "Restablecendo",
  "LIVE_DEV_CB_EXCEEDED_CLASSES": "+{0} máis",
  "LIVE_DEV_CB_TIP_TEXT_COLOR": "Cor do texto",
  "LIVE_DEV_CB_TIP_BG_COLOR": "Cor de fondo",
  "LIVE_DEV_CB_TIP_FONT": "Fonte",
  "LIVE_DEV_CB_TIP_TEXT_SPACING": "Espazado do texto",
  "LIVE_DEV_CB_TIP_APPEARANCE": "Bordo e opacidade",
  "LIVE_DEV_CB_TIP_LAYOUT": "Disposición",
  "LIVE_DEV_CB_TIP_POSITION": "Posición",
  "LIVE_DEV_CB_TIP_OBJECT_FIT": "Axuste de obxecto",
  "LIVE_DEV_CB_TIP_IMAGE": "Imaxe",
  "LIVE_DEV_CB_CHANGE_IMAGE": "Cambiar imaxe",
  "LIVE_DEV_CB_TIP_LIST_STYLE": "Estilo de lista",
  "LIVE_DEV_CB_TIP_ALL_STYLES": "Todos os estilos",
  "LIVE_DEV_CB_LABEL_FAMILY": "Familia",
  "LIVE_DEV_CB_LABEL_SIZE": "Tamaño",
  "LIVE_DEV_CB_LABEL_WEIGHT": "Grosor",
  "LIVE_DEV_CB_LABEL_STYLE": "Estilo",
  "LIVE_DEV_CB_LABEL_ALIGN": "Aliñamento do texto",
  "LIVE_DEV_CB_LABEL_TRANSFORM": "Transformación",
  "LIVE_DEV_CB_LABEL_LETTER_SPACING": "Espazado entre letras",
  "LIVE_DEV_CB_LABEL_WORD_SPACING": "Espazado entre palabras",
  "LIVE_DEV_CB_LABEL_LINE_HEIGHT": "Altura da liña",
  "LIVE_DEV_CB_LABEL_TEXT_INDENT": "Sangría do texto",
  "LIVE_DEV_CB_LABEL_WIDTH": "Ancho",
  "LIVE_DEV_CB_LABEL_RADIUS": "Raio",
  "LIVE_DEV_CB_LABEL_COLOR": "Cor",
  "LIVE_DEV_CB_LABEL_OPACITY": "Opacidade",
  "LIVE_DEV_CB_LABEL_DISPLAY": "Visualización",
  "LIVE_DEV_CB_LABEL_DIRECTION": "Dirección",
  "LIVE_DEV_CB_LABEL_WRAP": "Envoltura",
  "LIVE_DEV_CB_LABEL_JUSTIFY": "Xustificación",
  "LIVE_DEV_CB_LABEL_GAP": "Espazado",
  "LIVE_DEV_CB_LABEL_OVERFLOW": "Desbordamento",
  "LIVE_DEV_CB_LABEL_POSITION": "Posición",
  "LIVE_DEV_CB_LABEL_TOP": "Arriba",
  "LIVE_DEV_CB_LABEL_RIGHT": "Dereita",
  "LIVE_DEV_CB_LABEL_BOTTOM": "Abaixo",
  "LIVE_DEV_CB_LABEL_LEFT": "Esquerda",
  "LIVE_DEV_CB_LABEL_Z_INDEX": "Índice Z",
  "LIVE_DEV_CB_LABEL_FIT": "Axuste",
  "LIVE_DEV_CB_LABEL_TYPE": "Tipo",
  "LIVE_DEV_CB_WEIGHT_THIN": "Fino",
  "LIVE_DEV_CB_WEIGHT_REGULAR": "Regular",
  "LIVE_DEV_CB_WEIGHT_BOLD": "Negra",
  "LIVE_DEV_CB_WEIGHT_BLACK": "Extranegra",
  "LIVE_DEV_CB_STYLE_ITALIC": "Cursiva",
  "LIVE_DEV_CB_STYLE_UNDERLINE": "Subliñado",
  "LIVE_DEV_CB_STYLE_STRIKETHROUGH": "Riscado",
  "LIVE_DEV_CB_STYLE_OVERLINE": "Sobrerraia",
  "LIVE_DEV_CB_ALIGN_LEFT": "Esquerda",
  "LIVE_DEV_CB_ALIGN_CENTER": "Centrado",
  "LIVE_DEV_CB_ALIGN_RIGHT": "Dereita",
  "LIVE_DEV_CB_ALIGN_JUSTIFY": "Xustificado",
  "LIVE_DEV_CB_TRANSFORM_NONE": "Ningún",
  "LIVE_DEV_CB_TRANSFORM_CAPITALIZE": "Capitalizar",
  "LIVE_DEV_CB_TRANSFORM_UPPERCASE": "Maiúsculas",
  "LIVE_DEV_CB_TRANSFORM_LOWERCASE": "Minúsculas",
  "LIVE_DEV_CB_SEARCH_FONTS": "Buscar fontes…",
  "LIVE_DEV_CB_BACK": "Atrás",
  "LIVE_DEV_CB_BACK_ESC": "Atrás (Esc)",
  "LIVE_DEV_CB_RESET": "Restablecer",
  "LIVE_DEV_CB_APPLIES_TO": "Aplícase a:",
  "LIVE_DEV_CB_INLINE": "En liña",
  "LIVE_DEV_CB_LIST_DISC": "Disco",
  "LIVE_DEV_CB_LIST_CIRCLE": "Círculo",
  "LIVE_DEV_CB_LIST_SQUARE": "Cadrado",
  "LIVE_DEV_CB_LIST_NONE": "Ningún",
  "LIVE_DEV_CB_LIST_DECIMAL": "Decimal",
  "LIVE_DEV_CB_LIST_LOWER_ALPHA": "Alfabético en minúsculas",
  "LIVE_DEV_CB_LIST_UPPER_ALPHA": "Alfabético en maiúsculas",
  "LIVE_DEV_CB_LIST_LOWER_ROMAN": "Romano en minúsculas",
  "LIVE_DEV_CB_LIST_UPPER_ROMAN": "Romano en maiúsculas",
  "LIVE_DEV_CB_LIST_OUTSIDE": "Fóra",
  "LIVE_DEV_CB_LIST_INSIDE": "Dentro",
  "LIVE_DEV_CB_TIP_SPACING": "Marxe e Recheo",
  "LIVE_DEV_CB_LABEL_MARGIN": "Marxe",
  "LIVE_DEV_CB_LABEL_PADDING": "Recheo",
  "LIVE_DEV_CB_LABEL_CONTENT": "contido",
  "LIVE_DEV_CB_SPACING_LINK_INDEPENDENT": "Separado",
  "LIVE_DEV_CB_SPACING_LINK_AXIS": "Pares",
  "LIVE_DEV_CB_SPACING_LINK_ALL": "Todos iguais",
  "LIVE_DEV_CB_LABEL_BORDER_TOP": "Arriba",
  "LIVE_DEV_CB_LABEL_BORDER_RIGHT": "Dereita",
  "LIVE_DEV_CB_LABEL_BORDER_BOTTOM": "Abaixo",
  "LIVE_DEV_CB_LABEL_BORDER_LEFT": "Esquerda",
  "LIVE_DEV_CB_LABEL_BORDER_TL": "SE",
  "LIVE_DEV_CB_LABEL_BORDER_TR": "SD",
  "LIVE_DEV_CB_LABEL_BORDER_BR": "BR",
  "LIVE_DEV_CB_LABEL_BORDER_BL": "BL",
  "LIVE_DEV_CB_PER_SIDE": "Por lado",
  "LIVE_DEV_CB_PER_CORNER": "Por esquina",
  "LIVE_DEV_CB_COLOR_RECENT": "Recentes",
  "LIVE_DEV_CB_COLOR_FROM_PAGE": "Da páxina",
  "LIVE_DEV_CB_COLOR_SUGGESTED": "Suxeridas",
  "LIVE_DEV_CB_LABEL_COLUMNS": "Columnas",
  "LIVE_DEV_CB_LABEL_ROWS": "Filas",
  "LIVE_DEV_CB_LABEL_JUSTIFY_ITEMS": "Xustificar",
  "LIVE_DEV_CB_LABEL_ALIGN_ITEMS": "Aliñar",
  "LIVE_DEV_CB_LABEL_ROW_GAP": "Espazamento de fila",
  "LIVE_DEV_CB_LABEL_COL_GAP": "Espazamento de columna",
  "LIVE_DEV_CB_WEIGHT_EXTRA_LIGHT": "Extra lixeira",
  "LIVE_DEV_CB_WEIGHT_LIGHT": "Lixeira",
  "LIVE_DEV_CB_WEIGHT_MEDIUM": "Media",
  "LIVE_DEV_CB_WEIGHT_SEMI_BOLD": "Semigraxa",
  "LIVE_DEV_CB_WEIGHT_EXTRA_BOLD": "Extragraxa",
  "LIVE_DEV_CB_GO_TO_SOURCE": "Ir á orixe",
  "LIVE_DEV_CB_TIP_AI_STYLE": "Estilizar con IA",
  "LIVE_DEV_CB_AI_PLACEHOLDER": "Describe o estilo que queres…",
  "LIVE_DEV_CB_AI_SEND": "Enviar",
  "LIVE_DEV_CB_AI_THINKING": "Aplicando estilos…",
  "LIVE_DEV_CB_MORE_OPTIONS": "Máis opcións",
  "LIVE_DEV_CB_DIM_W": "W",
  "LIVE_DEV_CB_DIM_H": "H",
  "LIVE_DEV_CB_MINMAX_TOOLTIP": "Restricións de mín./máx.",
  "LIVE_DEV_CB_MINMAX_MIN": "Mín.",
  "LIVE_DEV_CB_MINMAX_MAX": "Máx.",
  "LIVE_DEV_CB_ID_PLACEHOLDER": "ningún",
  "LIVE_DEV_CB_ALL_WEIGHTS": "Todos os pesos",
  "LIVE_DEV_CB_ALL_STYLES": "Todos os estilos",
  "LIVE_DEV_HB_PARAGRAPH": "Parágrafo",
  "LIVE_DEV_HB_HEADING_1": "Encabezado 1",
  "LIVE_DEV_HB_HEADING_2": "Encabezado 2",
  "LIVE_DEV_HB_HEADING_3": "Título 3",
  "LIVE_DEV_HB_HEADING_4": "Título 4",
  "LIVE_DEV_HB_HEADING_5": "Título 5",
  "LIVE_DEV_HB_HEADING_6": "Título 6",
  "LIVE_DEV_HB_SPAN": "Span",
  "LIVE_DEV_HB_BLOCKQUOTE": "Cita en bloque",
  "LIVE_DEV_HB_PREFORMATTED": "Preformatado",
  "LIVE_DEV_HB_CODE": "Código",
  "LIVE_DEV_HB_EMPHASIS": "Énfase",
  "LIVE_DEV_HB_STRONG": "Importante",
  "LIVE_DEV_HB_BOLD": "Negriña",
  "LIVE_DEV_HB_ITALIC": "Cursiva",
  "LIVE_DEV_HB_UNDERLINE": "Subliñado",
  "LIVE_DEV_HB_STRIKETHROUGH": "Riscado",
  "LIVE_DEV_HB_SMALL": "Pequeno",
  "LIVE_DEV_HB_SUBSCRIPT": "Subíndice",
  "LIVE_DEV_HB_SUPERSCRIPT": "Superíndice",
  "LIVE_DEV_HB_MARK": "Resaltado",
  "LIVE_DEV_HB_ABBREVIATION": "Abreviatura",
  "LIVE_DEV_HB_CITATION": "Cita",
  "LIVE_DEV_HB_INLINE_QUOTE": "Cita en liña",
  "LIVE_DEV_HB_TIME": "Tempo",
  "LIVE_DEV_HB_KEYBOARD": "Teclado",
  "LIVE_DEV_HB_SAMPLE_OUTPUT": "Saída de exemplo",
  "LIVE_DEV_HB_VARIABLE": "Variable",
  "LIVE_DEV_HB_CONTAINER": "Div",
  "LIVE_DEV_HB_SECTION": "Sección",
  "LIVE_DEV_HB_ARTICLE": "Artigo",
  "LIVE_DEV_HB_HEADER": "Cabeceira",
  "LIVE_DEV_HB_FOOTER": "Pé de páxina",
  "LIVE_DEV_HB_NAVIGATION": "Navegación",
  "LIVE_DEV_HB_SIDEBAR": "Barra lateral",
  "LIVE_DEV_HB_MAIN": "Principal",
  "LIVE_DEV_HB_ADDRESS": "Enderezo",
  "LIVE_DEV_HB_IMAGE": "Imaxe",
  "LIVE_DEV_HB_VIDEO": "Vídeo",
  "LIVE_DEV_HB_AUDIO": "Audio",
  "LIVE_DEV_HB_PICTURE": "Imaxe",
  "LIVE_DEV_HB_CANVAS": "Lenzo",
  "LIVE_DEV_HB_SVG": "SVG",
  "LIVE_DEV_HB_FIGURE": "Figura",
  "LIVE_DEV_HB_FIGCAPTION": "Lenda",
  "LIVE_DEV_HB_LINK": "Ligazón",
  "LIVE_DEV_HB_BUTTON": "Botón",
  "LIVE_DEV_HB_DETAILS": "Detalles",
  "LIVE_DEV_HB_SUMMARY": "Resumo",
  "LIVE_DEV_HB_DIALOG": "Diálogo",
  "LIVE_DEV_HB_UNORDERED_LIST": "Lista non ordenada",
  "LIVE_DEV_HB_ORDERED_LIST": "Lista ordenada",
  "LIVE_DEV_HB_LIST_ITEM": "Elemento da lista",
  "LIVE_DEV_HB_DEF_LIST": "Lista de definicións",
  "LIVE_DEV_HB_DEF_TERM": "Termo de definición",
  "LIVE_DEV_HB_DEF_DESC": "Definición",
  "LIVE_DEV_HB_FORM": "Formulario",
  "LIVE_DEV_HB_TEXT_INPUT": "Entrada de texto",
  "LIVE_DEV_HB_TEXT_AREA": "Área de texto",
  "LIVE_DEV_HB_DROPDOWN": "Despregable",
  "LIVE_DEV_HB_OPTION": "Opción",
  "LIVE_DEV_HB_OPTION_GROUP": "Grupo de opcións",
  "LIVE_DEV_HB_FIELDSET": "Conxunto de campos",
  "LIVE_DEV_HB_LEGEND": "Lenda",
  "LIVE_DEV_HB_LABEL": "Etiqueta",
  "LIVE_DEV_HB_OUTPUT": "Saída",
  "LIVE_DEV_HB_METER": "Medidor",
  "LIVE_DEV_HB_PROGRESS": "Progreso",
  "LIVE_DEV_HB_EMAIL_INPUT": "Entrada de correo electrónico",
  "LIVE_DEV_HB_PASSWORD_INPUT": "Entrada de contrasinal",
  "LIVE_DEV_HB_FILE_INPUT": "Entrada de ficheiro",
  "LIVE_DEV_HB_CHECKBOX": "Caixa de verificación",
  "LIVE_DEV_HB_RADIO": "Botón de opción",
  "LIVE_DEV_HB_NUMBER_INPUT": "Entrada de número",
  "LIVE_DEV_HB_RANGE_INPUT": "Control desprazable de rango",
  "LIVE_DEV_HB_DATE_INPUT": "Entrada de data",
  "LIVE_DEV_HB_COLOR_INPUT": "Selector de cor",
  "LIVE_DEV_HB_SEARCH_INPUT": "Entrada de busca",
  "LIVE_DEV_HB_URL_INPUT": "Entrada de URL",
  "LIVE_DEV_HB_TEL_INPUT": "Entrada de teléfono",
  "LIVE_DEV_HB_SUBMIT_BUTTON": "Botón de envío",
  "LIVE_DEV_HB_RESET_BUTTON": "Botón de restablecemento",
  "LIVE_DEV_HB_HIDDEN_INPUT": "Entrada oculta",
  "LIVE_DEV_HB_TABLE": "Táboa",
  "LIVE_DEV_HB_TABLE_HEAD": "Cabeceira da táboa",
  "LIVE_DEV_HB_TABLE_BODY": "Corpo da táboa",
  "LIVE_DEV_HB_TABLE_FOOT": "Pé da táboa",
  "LIVE_DEV_HB_TABLE_ROW": "Fila da táboa",
  "LIVE_DEV_HB_TABLE_HEADER": "Cabeceira da táboa",
  "LIVE_DEV_HB_TABLE_CELL": "Cela da táboa",
  "LIVE_DEV_HB_TABLE_CAPTION": "Lenda da táboa",
  "LIVE_DEV_HB_COL_GROUP": "Grupo de columnas",
  "LIVE_DEV_HB_COLUMN": "Columna",
  "LIVE_DEV_HB_IFRAME": "Iframe",
  "LIVE_DEV_HB_EMBED": "Contido inserido",
  "LIVE_DEV_HB_OBJECT": "Obxecto",
  "LIVE_DEV_HB_DIVIDER": "Divisor",
  "LIVE_DEV_HB_LINE_BREAK": "Salto de liña",
  "LIVE_DEV_HB_SOURCE": "Fonte",
  "LIVE_DEV_HB_TEMPLATE": "Modelo",
  "LIVE_DEV_HB_SLOT": "Slot",
  "LIVE_DEV_HB_NOSCRIPT": "Noscript",
  "LIVE_DEV_HB_SCRIPT": "Script",
  "LIVE_DEV_HB_STYLE": "Estilo",
  ...
  "LIVE_DEV_TOAST_HIDDEN_BY_STYLE": "O elemento está oculto: ten {0}",
  "LIVE_DEV_TOAST_HIDDEN_BY_PARENT_STYLE": "O elemento está oculto: {0} ten {1}",
  "LIVE_DEV_TOAST_HIDDEN_IN_CLOSED": "O elemento está oculto: {0} está pechado",
  "LIVE_DEV_TOAST_HIDDEN_NO_SIZE": "O elemento non está visible: non ten tamaño",
  "LIVE_DEV_TOAST_HIDDEN_CUT_OFF": "O elemento non está visible: está cortado por {0}",
  "LIVE_DEV_TOAST_HIDDEN_OUTSIDE": "O elemento non está visible: está fóra da área visible",
  "LIVE_DEV_TOAST_HIDDEN": "O elemento non está visible na páxina",
  ...
  "DEVICE_SIZE_LIMIT_MESSAGE": "Para cambiar entre as vistas de móbil, tableta e escritorio, actualiza a Phoenix Pro.",
  "LAYERS_PANEL_LIMIT_MESSAGE": "Para ver a estrutura da túa páxina e seleccionar ou editar calquera elemento nela, actualiza a Phoenix Pro.",
  "DEVICE_SIZE_NOT_ENOUGH_SPACE": "Esta pantalla non cabe no tamaño da xanela actual; proba a expandir a xanela.",
  "DEVICE_SIZE_CYCLE_NO_FIT": "Pantalla demasiado pequena para cambiar a outro tamaño de dispositivo; aumenta o tamaño da xanela.",
  "DEVICE_SIZE_CYCLE_TOOLTIP": "Alternar entre móbil, tableta e escritorio.",
  "DEVICE_SIZE_DROPDOWN_TOOLTIP": "Todos os tamaños de dispositivo.",
  "DEVICE_SIZE_FIT_TO_SCREEN": "Axustar á pantalla",
  ...
  "IMAGE_UPLOAD_LOGIN_REQUIRED_MSG": "Inicia sesión para subir e inserir imaxes no teu documento.",
  "IMAGE_UPLOAD_LOGIN_BTN": "Iniciar sesión",
  "IMAGE_UPLOAD_CONFIRM_TITLE": "Inserir imaxe",
  "IMAGE_UPLOAD_CONFIRM_MSG": "Sube esta imaxe para que se inclúa directamente no teu ficheiro. Funcionará en calquera ordenador — non haberá imaxes rotas cando compartas ou movas os ficheiros de Markdown.",
  "IMAGE_UPLOAD_HOSTED_ON": "As imaxes alóxanse en user-cdn.phcode.site",
  "IMAGE_UPLOAD_BTN": "Cargar e incrustar",
  "IMAGE_UPLOAD_DONT_SHOW_AGAIN": "Incrustar sempre sen preguntar",
  "IMAGE_UPLOAD_UNSUPPORTED_TYPE": "Tipo de imaxe non admitido: {0}",
  "IMAGE_UPLOAD_LIMIT_TITLE": "Carga máis imaxes con Phoenix Pro",
  ...
  "LIVE_PREVIEW_SHOW_STYLES_BAR": "Amosar barra de estilos",
  ...
  "LIVE_PREVIEW_LAYERS_TAB": "Capas",
  "LIVE_PREVIEW_LAYERS_NEEDS_PREVIEW": "O panel de capas precisa unha vista previa en vivo.",
  "LIVE_PREVIEW_LAYERS_OPEN_PREVIEW": "Abrir a vista previa en vivo",
  "LIVE_PREVIEW_LAYERS_OPEN_IN_BROWSER": "Abrir no navegador",
  "LIVE_PREVIEW_LAYERS_NEEDS_HTML": "Abre un ficheiro HTML para ver as súas capas.",
  "LIVE_PREVIEW_LAYERS_CHOOSE_PAGE": "Escolla unha páxina",
  "LIVE_PREVIEW_LAYERS_PICK_HTML": "Escolla un ficheiro HTML para ver as súas capas.",
  "LIVE_PREVIEW_LAYERS_SEARCH_FILES": "Buscar en {0} ficheiros",
  "LIVE_PREVIEW_LAYERS_NO_FILE_MATCHES": "Non hai ficheiros coincidentes",
  "LIVE_PREVIEW_LAYERS_FILES_TRUNCATED": "Amosando os primeiros {0} ficheiros",
  "LIVE_PREVIEW_LAYERS_NEEDS_EDIT_MODE": "O panel de capas precisa o modo de edición.",
  "LIVE_PREVIEW_LAYERS_ENABLE_EDIT_MODE": "Activar o modo de edición",
  "LIVE_PREVIEW_LAYERS_LOAD_FAILED": "O panel de capas non se puido cargar. Reinicie {APP_NAME} para tentalo de novo.",
  "LIVE_PREVIEW_LAYERS_ELEMENTS": "Elementos",
  "LIVE_PREVIEW_LAYERS_SEARCH": "Buscar elementos",
  "LIVE_PREVIEW_LAYERS_NO_MATCHES": "Non hai elementos coincidentes",
  "LIVE_PREVIEW_LAYERS_TRUNCATED": "Amosando os primeiros {0} elementos",
  "LIVE_PREVIEW_LAYERS_COLLAPSE_ALL": "Contraer todo",
  "LIVE_PREVIEW_LAYERS_EXPAND_LEVEL": "Expandir ata o nivel",
  "LIVE_PREVIEW_LAYERS_LEVEL": "Nivel {0}",
  "LIVE_PREVIEW_LAYERS_LEVEL_ALL": "Todos os niveis",
  "LIVE_PREVIEW_LAYERS_SETTINGS": "Axustes",
  "LIVE_PREVIEW_LAYERS_SHOW_TEXT_NODES": "Amosar os nós de texto",
  "LIVE_PREVIEW_LAYERS_SCROLL_ON_HOVER": "Desprazar a vista previa ao pasar o rato por riba",
  "LIVE_PREVIEW_LAYERS_AUTO_COLLAPSE": "Contraer elementos automaticamente",
  "LIVE_PREVIEW_LAYERS_MOVE_UP": "Mover cara a arriba",
  "LIVE_PREVIEW_LAYERS_MOVE_DOWN": "Mover cara a abaixo",
  "LIVE_PREVIEW_LAYERS_CUT_DONE": "Cortar",
  "LIVE_PREVIEW_LAYERS_ADD_ATTRIBUTE": "Engadir atributo",
  "LIVE_PREVIEW_LAYERS_REMOVE_ATTRIBUTE": "Eliminar atributo",
  "LIVE_PREVIEW_LAYERS_PROPERTIES": "Propiedades",
  "LIVE_PREVIEW_LAYERS_STYLES": "Estilos",
  "LIVE_PREVIEW_LAYERS_MAXIMIZE_SECTION": "Expandir sección",
  "LIVE_PREVIEW_LAYERS_RESTORE_SECTIONS": "Restaurar seccións",
  "LIVE_PREVIEW_LAYERS_NO_SELECTION_PROPERTIES": "Selecciona un elemento para ver as súas propiedades",
  "LIVE_PREVIEW_LAYERS_NO_SELECTION_STYLES": "Selecciona un elemento para ver os seus estilos",
  "LIVE_PREVIEW_LAYERS_NOT_IN_SOURCE": "Este elemento non está no ficheiro de orixe",
  "LIVE_PREVIEW_LAYERS_NO_STYLES": "Non se aplicaron estilos",
  "LIVE_PREVIEW_LAYERS_OPEN_SOURCE": "Abrir no editor",
  "LIVE_PREVIEW_LAYERS_RULE_INACTIVE": "Non activo no estado actual",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_IMPORTANT": "Sobrescrito por {0} en {1} ({2})",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_IN_RULE": "Sobrescrito pola declaración {0} posterior nesta regra",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_INLINE": "Sobrescrito polo estilo en liña do elemento ({0})",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_SPECIFIC": "Sobrescrito pola regra máis específica {0} ({1})",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_LATER": "Sobrescrito por {0} ({1}), que ten a mesma especificidade pero vén despois",
  "LIVE_PREVIEW_LAYERS_OVERRIDDEN_JUMP": "Fai clic para ir á declaración gañadora",
  "LIVE_PREVIEW_LAYERS_EDIT_STYLE": "Editar na barra de estilos",
  "LIVE_PREVIEW_LAYERS_STYLES_BAR_POPPED_OUT": "A barra de estilos abriuse na vista previa do teu navegador",
  "LIVE_PREVIEW_LAYERS_ADD_DECLARATION": "Engadir declaración.",
  "LIVE_PREVIEW_LAYERS_REMOVE_DECLARATION": "Eliminar declaración.",
  "LIVE_PREVIEW_LAYERS_EDIT_DECLARATION": "Editar declaración.",
  "LIVE_PREVIEW_LAYERS_SHOW_SCRIPT_NODES": "Amosar elementos xerados por script.",
  "LIVE_PREVIEW_LAYERS_SCRIPT_GENERATED": "Xerado por script, non está no ficheiro de orixe.",
  "LIVE_PREVIEW_LAYERS_HOVER_HIDDEN": "{0} (oculto)",
  "LIVE_PREVIEW_LAYERS_INSERT_ELEMENT": "Inserir elemento",
  "LIVE_PREVIEW_LAYERS_CHANGE_COLOR": "Cambiar cor: {0}",
  "LIVE_PREVIEW_LAYERS_COPY_DECLARATION": "Copiar propiedade",
  "LIVE_PREVIEW_LAYERS_COPY_RULE": "Copiar regra",
  "LIVE_PREVIEW_LAYERS_PASTE_PROPERTIES": "Pegar propiedades",
  "LIVE_PREVIEW_LAYERS_PASTE": "Pegar",
  "LIVE_PREVIEW_LAYERS_STYLES_MENU_HINT": "Fai clic co botón dereito para copiar ou pegar estilos",
  "LIVE_PREVIEW_LAYERS_PASTE_INVALID": "Pega propiedades CSS ou un selector completo de cada vez.",
  "LIVE_PREVIEW_LAYERS_PASTE_FAILED": "Non se puideron pegar estas propiedades. Téntao de novo.",
  "LIVE_PREVIEW_LAYERS_PASTED": "Propiedades pegadas en {0}",
  "LIVE_PREVIEW_LAYERS_COPY_FAILED": "Non se puideron copiar estes estilos. Téntao de novo.",
  "LIVE_PREVIEW_LAYERS_INSERT_POSITION": "Colocación",
  "LIVE_PREVIEW_LAYERS_INSERT_INTO_PAGE": "Engadir á páxina",
  "LIVE_PREVIEW_LAYERS_INSERT_LOADING": "Cargando elementos…",
  "LIVE_PREVIEW_LAYERS_INSERT_UNAVAILABLE": "A vista previa en directo non respondeu. Téntao de novo nuns intres.",
  "LIVE_PREVIEW_LAYERS_LOADING": "Cargando elementos…",
  "LIVE_PREVIEW_LAYERS_UNAVAILABLE": "A vista previa en directo non respondeu.",
  "LIVE_PREVIEW_LAYERS_RETRY": "Tentar de novo",
  "LIVE_PREVIEW_LAYERS_NOT_RESPONDING": "A vista previa en vivo non responde.",
  "LIVE_PREVIEW_LAYERS_RELOAD_PREVIEW": "Recargar a vista previa",
  "LIVE_PREVIEW_LAYERS_EMPTY_PAGE": "Esta páxina aínda non ten elementos.",
  "LIVE_PREVIEW_LAYERS_ADD_ELEMENT": "Engadir un elemento",
  "LIVE_PREVIEW_LAYERS_EMPTY_PAGE_PROPERTIES": "A páxina está baleira. Engada un elemento para ver as súas propiedades.",
  "LIVE_PREVIEW_LAYERS_EMPTY_PAGE_STYLES": "A páxina está baleira. Engada un elemento para ver os seus estilos.",
  "LIVE_PREVIEW_LAYERS_SHOW_SELECTED": "Amosar o elemento seleccionado",
  "LIVE_PREVIEW_LAYERS_SCRUB_HINT": "Arrastre para axustar. Desprácese ou use as teclas de frecha mentres edita. Maiús: pasos máis grandes, Alt: pasos máis pequenos",
  "LIVE_PREVIEW_LAYERS_PROPERTY_PLACEHOLDER": "propiedade",
  "LIVE_PREVIEW_LAYERS_VALUE_PLACEHOLDER": "valor",
  ...
  "ERRORS_PANEL_TITLE_INFO_SUFFIX": "{0} ({1} información)",
  ...
  "DOC_COMMENT_ADD_JSDOC": "Engadir comentario JSDoc",
  "DOC_COMMENT_ADD_PHPDOC": "Engadir comentario PHPDoc",
  "DOC_COMMENT_ADD_JAVADOC": "Engadir comentario Javadoc",
  "DOC_COMMENT_ADD_DOXYGEN": "Engadir comentario Doxygen",
  "DOC_COMMENT_ADD_DOCSTRING": "Engadir docstring",
  "DOC_COMMENT_SUMMARY": "Descrición",
  "DOC_COMMENT_DESC": "descrición",
  ...
  "CMD_TOGGLE_DESIGN_MODE": "Alternar o modo de deseño",
  "CCB_SWITCH_TO_DESIGN_MODE": "Cambiar ao modo de deseño",
  "CCB_SWITCH_TO_CODE_EDITOR": "Cambiar ao editor de código",
  ...
  "CMD_VIEW_ENABLE_AI": "Activar a IA",
  ...
  "CMD_OPEN_IN_INTEGRATED_TERMINAL": "Terminal integrado",
  ...
  "UPDATE_FAILED_MESSAGE": "Peche todas as xanelas da aplicación {APP_NAME} e volva abrir a aplicación para tentar a actualización de novo. <br/> Tamén pode instalar a actualización descargando o instalador desde <a href='https://phcode.dev'>phcode.dev</a>",
  ...
  "CODE_HINT_IMPORT_CHOOSE": "Escolla de cal dos {0} módulos importar <code>{1}</code>.",
  ...
  "DESCRIPTION_CODE_INTEL_AUTO_CREATE": "falso para evitar que {APP_NAME} cree un ficheiro jsconfig.json/tsconfig.json para a intelixencia de código ao abrir proxectos. Se elimina unha configuración creada, pode volver activar a intelixencia de código desde o panel de Problemas.",
  ...
  "DESCRIPTION_ESLINT_USE_NATIVE_APP": "ESLint só está dispoñible na aplicación de escritorio. Descárguea desde <a href='https://phcode.dev'>phcode.dev</a>",
  ...
  "DESCRIPTION_SHOW_CODE_HINT_DOCS": "`false` para ocultar a ventá emerxente de documentación que se amosa a carón das suxestións de código",
  "DESCRIPTION_SHOW_PARAMETER_HINTS": "`false` para desactivar a ventá emerxente de suxestións de parámetros que se amosa ao escribir dentro dunha chamada a unha función",
  ...
  "DESCRIPTION_LIVEDEV_MAIN_HEADING": "Vaites! O teu navegador actual non admite a previsualización en vivo.",
  "DESCRIPTION_LIVEDEV_MAIN_SPAN": "Obtén a mellor experiencia de previsualización en vivo descargando as nosas aplicacións nativas para Windows, Mac e Linux dende {0}.",
  ...
  "FIND_ALL_REFERENCES": "Buscar usos",
  "CODE_INTEL_JS": "JavaScript",
  "CODE_INTEL_TS": "TypeScript",
  "CODE_INTEL_ENABLED_TITLE": "Intelixencia de código de {0} activada",
  "CODE_INTEL_ENABLED_MESSAGE": "Atopar usos, Renomear e Ir á definición agora funcionan en todos os ficheiros deste proxecto.",
  "CODE_INTEL_SEE_CONFIG": "Ver a configuración",
  "CODE_INTEL_ENABLE_TS": "Activar TypeScript",
  "CODE_INTEL_LEARN_MORE": "Máis información",
  "CODE_INTEL_PANEL_TEXT": "A intelixencia de código para todo o proxecto está desactivada. Actívea para Atopar usos, Renomear e Ir á definición en todos os ficheiros — engade un ficheiro jsconfig.json á raíz do proxecto.",
  "CODE_INTEL_PANEL_ENABLE": "Activar",
  "CODE_INTEL_PANEL_DISMISS": "Descartar",
  "PHP_INSTALL_TITLE": "Intelixencia de código PHP",
  "PHP_INSTALLING": "Configurando a compatibilidade con PHP — descargando o servidor da linguaxe (9 MB)…",
  "PHP_INSTALL_DONE": "A intelixencia de código PHP está lista.",
  "PHP_INSTALL_FAILED": "Non se puido configurar o soporte para PHP: {0}. {APP_NAME} volverá intentalo cando abra de novo un ficheiro PHP.",
  "PHP_INSTALL_STOP": "Deter a configuración da compatibilidade con PHP ({APP_NAME} volverá intentalo no seguinte inicio)",
  "PHP_INSTALL_WAITING_NETWORK": "Agardando por unha conexión a internet para configurar a compatibilidade con PHP…",
  "DESCRIPTION_PHP_CODE_INTELLIGENCE": "false para desactivar a intelixencia de código de PHP (Intelephense). Ao volvelo establecer en true descárgase o servidor da linguaxe de novo automaticamente.",
  "DESCRIPTION_PHP_LICENSE_KEY": "Chave de licenza prémium de Intelephense (ou a ruta absoluta a un ficheiro de chave) que activa funcións prémium como o cambio de nome e as accións de código. Non é necesaria se a súa licenza xa está no ficheiro de licenza global estándar de Intelephense.",
  "PYTHON_INSTALL_TITLE": "Intelixencia de código de Python",
  "PYTHON_INSTALLING": "Configurando a compatibilidade con Python — descargando as ferramentas da linguaxe (25 MB)…",
  "PYTHON_INSTALL_DONE": "A intelixencia de código de Python está lista.",
  "PYTHON_INSTALL_FAILED": "Non se puido configurar o soporte para Python: {0}. {APP_NAME} volverá intentalo cando volva abrir un ficheiro de Python.",
  "PYTHON_INSTALL_STOP": "Deter a configuración da compatibilidade con Python ({APP_NAME} volverá intentalo no seguinte inicio)",
  "PYTHON_INSTALL_WAITING_NETWORK": "Agardando por unha conexión a internet para configurar a compatibilidade con Python…",
  "DESCRIPTION_PYTHON_CODE_INTELLIGENCE": "false para desactivar a intelixencia de código de Python (Pyrefly). Ao volvelo establecer en true descárgase o servidor da linguaxe de novo automaticamente.",
  "DESCRIPTION_TYPESCRIPT_CODE_INTELLIGENCE": "`false` para desactivar a intelixencia de código de JavaScript/TypeScript (autocompletado, documentación ao pasar o rato, ir á definición, diagnósticos)",
  "DESCRIPTION_JSON_CODE_INTELLIGENCE": "`false` para desactivar a intelixencia de código de JSON (autocompletado baseado en esquemas, documentación ao pasar o rato e validación)",
  "DESCRIPTION_LSP_CODE_INTELLIGENCE": "`false` para desactivar o servidor de linguaxe {0}",
  "NPM_VULN_PROVIDER_NAME": "Avisos de seguranza de npm",
  "NPM_VULN_MESSAGE": "{0}@{1} é vulnerable: {2} (gravidade {3})",
  "NPM_SEVERITY_CRITICAL": "crítica",
  "NPM_SEVERITY_HIGH": "alta",
  "NPM_SEVERITY_MODERATE": "moderada",
  "NPM_SEVERITY_LOW": "baixa",
  "NPM_HINT_LATEST_MINOR": "última, admítense actualizacións menores",
  "NPM_HINT_LATEST_PATCH": "última, só actualizacións de parche",
  "NPM_HOVER_HOMEPAGE": "Abrir a páxina de inicio",
  "NPM_HOVER_VIEW_DOCS": "Ver a documentación",
  "CODE_INTEL_CFG_TITLE": "Intelixencia de código",
  "CODE_INTEL_CFG_ALL_OPTIONS": "Todas as opcións…",
  "CODE_INTEL_CFG_CHECK_JS": "Comprobar os tipos de JavaScript",
  "CODE_INTEL_CFG_CHECK_JS_SUB": "Atopa erros de tipo en ficheiros JS",
  "CODE_INTEL_CFG_CHECK_JS_INFO": "Atopa erros ortográficos e de tipo no teu JavaScript e amósaos no panel de problemas. Só avisos — o teu código execútase sen cambios.",
  "CODE_INTEL_CFG_CHECK_JS_EG_CODE": "console.lgo(\"hi\")",
  "CODE_INTEL_CFG_CHECK_JS_EG_TEXT": "sinalízase: Quería dicir 'log'?",
  "CODE_INTEL_CFG_AUTO_TYPES": "Descarga automática de tipos",
  "CODE_INTEL_CFG_AUTO_TYPES_SUB": "Obtén as definicións de tipo vía npm",
  "CODE_INTEL_CFG_AUTO_TYPES_INFO": "As suxestións de código para paquetes npm comezan a funcionar mesmo antes de executar npm install. Precisa npm e internet; as descargas gárdanse na caché fóra do seu proxecto.",
  "CODE_INTEL_CFG_AUTO_MANAGE": "Xestionado por {APP_NAME}",
  "CODE_INTEL_CFG_AUTO_MANAGE_SUB": "Mantén este ficheiro actualizado automaticamente",
  "CODE_INTEL_CFG_AUTO_MANAGE_INFO": "{APP_NAME} mantén este ficheiro axustado para que a intelixencia de código funcione. Desactíveo para personalizar o ficheiro vostede mesmo — {APP_NAME} non o modificará nunca máis.",
  "CODE_INTEL_CFG_TARGET": "Obxectivo",
  "CODE_INTEL_CFG_TARGET_SUB": "A versión de JS que usa o seu código",
  "CODE_INTEL_CFG_TARGET_ES5": "navegadores antigos (da era de IE11)",
  "CODE_INTEL_CFG_TARGET_ES2015": "clases, funcións de frecha, let/const",
  "CODE_INTEL_CFG_TARGET_ES2017": "async/await",
  "CODE_INTEL_CFG_TARGET_ES2020": "encadeamento opcional a?.b, coalescencia nula ??",
  "CODE_INTEL_CFG_TARGET_ES2022": "campos de clase, await de nivel superior",
  "CODE_INTEL_CFG_TARGET_ESNEXT": "todo o actual",
  "CODE_INTEL_CFG_TARGET_FOOT": "Os obxectivos máis antigos marcan a sintaxe máis nova como erros — escolla o máis novo a non ser que o seu código deba executarse en motores antigos.",
  "CODE_INTEL_CFG_MODULE": "Módulo",
  "CODE_INTEL_CFG_MODULE_SUB": "Como se resolven import e require()",
  "CODE_INTEL_CFG_MODULE_PRESERVE": "entende tanto import como require(), sen regras de extensión de ficheiro — o mellor para editar",
  "CODE_INTEL_CFG_MODULE_ESNEXT": "semántica moderna de import/export",
  "CODE_INTEL_CFG_MODULE_NODENEXT": "regras estritas de ESM de Node — extensións de ficheiro obrigatorias, respecta o \"type\" de package.json",
  "CODE_INTEL_CFG_MODULE_COMMONJS": "proxectos clásicos de require()/module.exports",
  "CODE_INTEL_CFG_JSX": "JSX",
  "CODE_INTEL_CFG_JSX_SUB": "Como se trata o JSX nos ficheiros .jsx e .tsx",
  "CODE_INTEL_CFG_JSX_REACT_JSX": "contorno de execución moderno (React 17+) — non se necesita importar React",
  "CODE_INTEL_CFG_JSX_REACT": "compila a React.createElement — require a importación de React",
  "CODE_INTEL_CFG_JSX_PRESERVE": "deixa o JSX intacto para outra ferramenta, p. ex. un empaquetador",
  "CODE_INTEL_CFG_JSX_OFF_INFO": "sen xestión de JSX",
  "CODE_INTEL_CFG_JSX_OFF": "Desactivado",
  "CODE_INTEL_CFG_CURRENT_VALUE": "(actual: {0})",
  "CODE_INTEL_CFG_ORIGIN_NOTE": "{APP_NAME} creou este ficheiro para potenciar a intelixencia de código en todo o proxecto. Eliminalo desactívao — pódese reactivar en calquera momento desde {0}.",
  "CODE_INTEL_CFG_PROBLEMS_PANEL": "Panel de problemas",
  "CODE_INTEL_CFG_AUTO_CREATE": "Crear unha configuración automaticamente nos proxectos novos",
  "CODE_INTEL_CFG_READ_ONLY": "Este ficheiro ten formato personalizado ou comentarios — edite o JSON directamente.",
  ...
  "REFERENCES_PANEL_TITLE": "Referencias",
  "SEARCH_RESULTS_PANEL_TITLE": "Resultados da busca",
  "BOTTOM_PANEL_MINIMIZE": "Minimizar panel",
  "BOTTOM_PANEL_SHOW": "Amosar o panel inferior",
  "BOTTOM_PANEL_HIDE_TOGGLE": "Ocultar o panel inferior",
  "BOTTOM_PANEL_DEFAULT_TITLE": "Ferramentas",
  "BOTTOM_PANEL_DEFAULT_HEADING": "Ferramentas",
  "BOTTOM_PANEL_MAXIMIZE": "Maximizar panel",
  "BOTTOM_PANEL_RESTORE": "Restaurar o tamaño do panel",
  ...
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>Safari elimina automaticamente os datos dos sitios web se un sitio non se volve visitar nun prazo de 7 días. {APP_NAME} depende do almacenamento do navegador para gardar os seus proxectos, que poderían ser eliminados por mor desta política. <br/> <br/>Recoméndase<strong> descargar a aplicación de escritorio para macOS</strong> desde <a href='https://phcode.dev' target='_blank' style='color: white'>https://phcode.dev</a></span>",
  ...
  "PHOENIX_TOUR_DESIGN_MODE": "Fai clic aquí para entrar no modo de deseño. Ponte a pantalla completa e edita a túa páxina visualmente.",
  "PHOENIX_TOUR_AI_PANEL": "Deseña maquetas, corrixe erros e desenvolve máis rápido coa IA. Fai clic aquí para abrir o panel de IA.",
  "PHOENIX_TOUR_NEW_PROJECT": "Abre ou crea un proxecto novo desde aquí.",
  "PHOENIX_TOUR_EDIT_MODE": "O Modo de edición permíteche axustar a túa páxina directamente na previsualización en tempo real — fai clic nos elementos para inspeccionalos e editalos directamente.",
  "PHOENIX_TOUR_STEP_OF": "{0} de {1}",
  "PHOENIX_TOUR_NEXT_BTN": "Seguinte",
  "PHOENIX_TOUR_DISMISS_BTN": "Descartar",
  ...
  "DESCRIPTION_ENABLE_AI": "`true` para activar as funcións de IA, `false` para desactivar a IA por completo.",
  ...
  "TERMINAL_CLOSE_SINGLE_MSG": "Este terminal ten un proceso activo. Ao pechalo, deterase o proceso.<br>Quere continuar?",
  "TERMINAL_CLOSE_SINGLE_BTN": "Pechar o terminal",
  "TERMINAL_CLOSE_ALL_TITLE": "Pechar todos os terminais?",
  "TERMINAL_CLOSE_ALL_MSG": "Pecharanse todos os terminais.<br>Non hai ningún proceso activo en execución.<br><br>Quere continuar?",
  "TERMINAL_CLOSE_ALL_BTN": "Pechar todo",
  "TERMINAL_CLOSE_ALL_MSG_PROCESS_ONE": "Pecharanse todos os terminais.<br>Deterase 1 proceso activo.<br><br>Quere continuar?",
  "TERMINAL_CLOSE_ALL_MSG_PROCESS_MANY": "Pecharanse todos os terminais.<br>Deteranse {0} procesos activos.<br><br>Quere continuar?",
  "TERMINAL_CLOSE_ALL_STOP_BTN": "Pechar todo e deter os procesos",
  "TERMINAL_FOCUS_HINT": "Prema {0} para cambiar entre o editor e o terminal",
  "TERMINAL_CLEAR": "Limpar o terminal",
  "TERMINAL_CLEAR_BUFFER_HINT": "💡 Preme {0} para limpar o búfer do terminal",
  ...
  "CUSTOM_SNIPPETS_ADD_BTN_LABEL": "Engadir",
  ...
  "CUSTOM_SNIPPETS_TEMPLATE_INPUT_TOOLTIP": "Texto: O código real que se inserirá. Use ${1}, ${2}, ${3}, etc. para as posicións do cursor. ${1} é a posición inicial, a tecla de tabulación móvese a ${2}, ${3}, etc. ${0} é a posición final. Engada texto predeterminado que se selecciona para sobrescribir con ${1:texto de marcador de posición}. Use @@INDENT@@ para a sangría dunha liña aniñada; correspóndese coa configuración de sangría real do ficheiro actual (espazos ou tabulacións) en lugar dun ancho fixo.",
  ...
  "PROMO_PRO_WHATS_NEW_TITLE": "Novidades en {0}",
  "PROMO_PRO_WHATS_NEW_MESSAGE": "Grazas por apoiar {0}. Velaquí as novidades desta actualización:",
  "PROMO_CARD_1": "Editar na vista previa en vivo",
  "PROMO_CARD_1_MESSAGE": "Edita o texto, actualiza as imaxes, cambia as ligazóns, arrastra elementos e moito máis. O teu código actualízase sobre a marcha.",
  "PROMO_CARD_2": "Proba ideas, crea páxinas e corrixe problemas coa IA",
  "PROMO_CARD_2_MESSAGE": "Unha IA que ve o que ti ves, non só o código. Axuda a crear deseños, corrixir problemas de IU complicados e mantense á marxe para que poidas centrarte no traballo creativo.",
  "PROMO_CARD_3": "Visualiza a túa páxina en calquera dispositivo",
  "PROMO_CARD_3_MESSAGE": "Cambia ao instante entre as vistas de teléfono, tableta e escritorio para detectar problemas de adaptabilidade con antelación.",
  "PROMO_CARD_4": "O teu Markdown, coma un documento real",
  "PROMO_CARD_4_MESSAGE": "Edita táboas, imaxes e formatos visualmente — un xeito máis doado de traballar con Markdown.",
  "PROMO_CARD_5": "Estiliza a túa páxina visualmente",
  "PROMO_CARD_5_MESSAGE": "Cambia os tipos de letra, as cores, os bordos, o espazado e a disposición directamente na Vista previa en vivo, e o teu CSS actualízase en tempo real.",
  ...
  "OFF_HOURS_ENDING_TITLE": "{0} está a piques de rematar",
  "OFF_HOURS_ENDING_MSG": "A túa sesión gratuíta de {0} está a piques de rematar. <a href=\"{1}\">Obtén {2}</a> para manter o Pro todo o día.",
  "OFF_HOURS_ENDED_TITLE": "{0} rematou",
  "OFF_HOURS_ENDED_MSG": "A túa sesión gratuíta de {0} rematou. <a href=\"{1}\">Obtén {2}</a> para manter activadas as funcións Pro.",
  "OFF_HOURS_LOGIN_TITLE": "{0} agora é gratuíto",
  "OFF_HOURS_LOGIN_MSG": "{0}: {1} é gratuíto todos os días durante {2}. Inicia sesión para usalo.",
  "OFF_HOURS_LOGIN_BTN": "Iniciar sesión",
  "OFF_HOURS_DONT_SHOW_AGAIN": "Non volver mostrar isto",
  "OFF_HOURS_NAV_TOOLTIP": "{0} — Phoenix Pro é gratuíto para ti durante o teu tempo persoal ({1})",
  "OFF_HOURS_TIME_LEFT_HOURS": "Quedan {0} h",
  "OFF_HOURS_TIME_LEFT_MINUTES": "Quedan {0} m",
  "OFF_HOURS_DURATION_HOURS": "{0} h",
  "OFF_HOURS_DURATION_MINUTES": "{0} m",
  "OFF_HOURS_POPUP_ACTIVE": "{0}: quedan {1}",
  "OFF_HOURS_POPUP_LOGIN_ACTIVE": "Inicia sesión para obter {0}: quedan {1}",
  "OFF_HOURS_POPUP_UPCOMING": "{0} comeza en {1}",
  "OFF_HOURS_EXPLAIN_TITLE": "Que é {0}?",
  "OFF_HOURS_EXPLAIN_MSG": "{0} é gratuíto para todo o mundo durante as horas persoais fóra do traballo — <b>{1}</b>, na túa hora local. Só tes que usar o editor durante estas horas, non se precisa subscrición.",
  "OFF_HOURS_EXPLAIN_ACTIVE": "Agora é gratis — queda {0}!",
  "OFF_HOURS_EXPLAIN_LOGIN_ACTIVE": "Agora é gratis — queda {0}. Inicia sesión para usalo!",
  "OFF_HOURS_EXPLAIN_UPCOMING": "A túa próxima sesión gratuíta comeza en {0}.",
  "OFF_HOURS_WAIT_BTN": "Agardarei",
  "OFF_HOURS_KEEP_CODING_BTN": "Seguir programando",
  "MANAGE_LICENSE_DIALOG_TITLE": "Xestionar licenzas",
  "LICENSE_ACCOUNT_HEADING": "Licenza da conta",
  "LICENSE_DEVICE_HEADING": "Licenza do dispositivo",
  "LICENSE_SIGN_IN": "Iniciar sesión",
  "LICENSE_PLAN_UNKNOWN": "Descoñecido",
  "LICENSE_GET_PRO": "Obter Phoenix Pro",
  "LICENSE_MANAGE_ACCOUNT": "Xestionar conta",
  "LICENSE_KEY": "Chave de licenza",
  "LICENSE_KEY_PROMPT": "Ten unha clave de licenza do dispositivo?",
  "LICENSE_KEY_PLACEHOLDER": "Introduza a súa clave de licenza…",
  "LICENSE_KEY_ACTIVATE": "Activar",
  ...
  "LICENSE_REACTIVATE": "Reactivar licenza",
  "LICENSE_DEACTIVATE": "Desactivar",
  "LICENSE_DEACTIVATING": "Desactivando…",
  "LICENSE_DEACTIVATE_SUCCESS": "Licenza desactivada neste dispositivo. Reinicie {APP_NAME} para que os cambios teñan efecto.",
  "LICENSE_DEACTIVATE_FAIL": "Non se puido desactivar a licenza neste dispositivo",
  "LICENSE_NOT_ACTIVATED_HERE": "Esta licenza non está activada neste dispositivo — as funcións de Phoenix Pro non se activarán ata que prema en Reactivar licenza.",
  "LICENSE_STATUS_NOT_ACTIVATED_HERE": "Dispoñible, pero non activada",
  ...
  "AI_DISABLE_CONFIRM_TITLE": "Desactivar a IA?",
  "AI_DISABLE_CONFIRM_MESSAGE": "Isto desactiva todas as funcións de IA. O panel de IA eliminarase e {APP_NAME} deixará de conectarse aos servizos de IA.<br><br>{APP_NAME} reiniciarase agora para aplicar este cambio. Pediráselle que garde os ficheiros non gardados.",
  "AI_DISABLE_CONFIRM_BTN": "Desactivar a IA e reiniciar",
  "AI_ENABLE_CONFIRM_TITLE": "Activar a IA?",
  "AI_ENABLE_CONFIRM_MESSAGE": "Isto volve activar as funcións de IA e restaura o panel de IA.<br><br>{APP_NAME} reiniciarase agora para aplicar este cambio. Pediráselle que garde os ficheiros non gardados.",
  "AI_ENABLE_CONFIRM_BTN": "Activar a IA e reiniciar",
  "AI_CHAT_TITLE": "Claude Code",
  "AI_CHAT_MODE_CHAT": "Claude Code",
  "AI_CHAT_MODE_CLI": "Claude Code CLI",
  "AI_CHAT_MODE_CODEX_CLI": "Codex CLI",
  "AI_CHAT_START_TYPE_HINT": "Escriba aquí para comezar",
  "AI_CHAT_START_GREETING": "Ola, {0},",
  "AI_CHAT_START_TITLE": "Que imos construír hoxe?",
  "AI_CHAT_START_SURPRISE_TITLE": "Sorpréndame",
  "AI_CHAT_START_SURPRISE_DESC": "Móstreme unha demo do que pode facer",
  "AI_CHAT_START_SURPRISE_CHOICE_DESC": "Vexa outra demo ou deixe que lle constrúa algo en directo",
  "AI_CHAT_START_MAKE_NEW": "Crear algo novo",
  "AI_CHAT_START_ANOTHER_DEMO": "Ver outra demo",
  "AI_CHAT_START_MAKE_NEW_NOTE": "Crear algo novo consume os teus créditos de IA. Elixe a demostración para non gastar ningún.",
  "AI_CHAT_START_DEMO_LINK": "Queres unha demostración? {0}.",
  "AI_CHAT_START_DEMO_LINK_LABEL": "Sorpréndeme",
  "AI_CHAT_SEE_DEMO_DESC": "Ver unha demostración",
  "AI_CHAT_DEMO_NOTICE_OFFLINE": "Estás sen conexión, así que esta é unha demostración gravada.",
  "AI_CHAT_DEMO_BAR_TEXT": "Inicia sesión para crear o teu propio coa IA.",
  "AI_CHAT_DEMO_BACK_BTN": "Volver",
  "AI_CHAT_DEMO_BUILT_WITH": "Creado con {0}",
  "AI_CHAT_DEMO_ANOTHER_BTN": "Ver outra demostración",
  "AI_CHAT_DEMO_REVEAL_PROMPT": "Mostrar a instrución",
  "AI_CHAT_DEMO_HIDE_PROMPT": "Agochar a indicación",
  "AI_CHAT_DEMO_PROMPT_LABEL": "A indicación que xerou isto",
  "AI_CHAT_DEMO_COPY_PROMPT": "Copiar",
  "AI_CHAT_DEMO_PROMPT_COPIED": "Copiado",
  "AI_CHAT_DEMO_SPEED_TITLE": "Velocidade de reprodución (prema para cambiar)",
  "AI_CHAT_START_WORK_WITH": "Traballar con",
  "AI_CHAT_START_SETUP": "Configurar",
  "AI_CHAT_START_CUSTOM_PROVIDER": "Punto final personalizado ou un provedor como {0}? Consulte {1}.",
  "AI_CHAT_SURPRISE_ME_USER_MSG": "Sorpréndeme!",
  "AI_CHAT_SURPRISE_ME_LP_HEADING_1": "Preparando o escenario…",
  "AI_CHAT_SURPRISE_ME_LP_HEADING_2": "Quentando o lenzo…",
  "AI_CHAT_SURPRISE_ME_LP_HEADING_3": "Xa case está…",
  "AI_CHAT_NEW_SESSION_TITLE": "Iniciar unha nova conversa",
  "AI_CHAT_NEW_BTN": "Novo",
  "AI_CHAT_THINKING": "Pensando...",
  "AI_CHAT_WAITING_FOR_MODEL": "Agardando polo modelo...",
  "AI_CHAT_SCROLL_TO_BOTTOM": "Ir ao final",
  "AI_CHAT_PLACEHOLDER": "Pregúntalle a Claude...",
  "AI_CHAT_PLACEHOLDER_MODEL": "Pregúntalle a {0}...",
  "AI_CHAT_SEND_TITLE": "Enviar mensaxe",
  "AI_CHAT_STOP_TITLE": "Deter a xeración (Esc)",
  "AI_CHAT_CLI_NOT_FOUND": "Claude Code non instalado",
  "AI_CHAT_CLI_INSTALL_MSG": "A CLI de Claude Code debe estar instalada no teu sistema para usar as funcións de IA en {APP_NAME}.",
  "AI_CHAT_CLI_INSTALL_BTN": "Instalar Claude Code",
  "AI_CHAT_CLI_INSTALLING": "Instalando…",
  "AI_CHAT_CLI_INSTALLING_NAMED_MSG": "Instalando {0}, agarde por favor. Isto pode levar un tempo...",
  "AI_CHAT_CLI_RESTART_NOTE": "Reinicia {APP_NAME} despois de que remate a instalación.",
  "AI_CHAT_CLI_NOT_FOUND_INSTALL_BTN": "Instalar {0}",
  "AI_CHAT_CLI_SETUP_TITLE": "Configurar {0}",
  "AI_CHAT_CLI_SETUP_MISSING": "{0} aínda non está instalado.",
  "AI_CHAT_CLI_SETUP_BAD_PATH": "Non se puido iniciar {0} desde a ruta gardada.",
  "AI_CHAT_CLI_SETUP_INSTALL_TITLE": "Instálemo",
  "AI_CHAT_CLI_SETUP_RECOMMENDED": "Recomendado",
  "AI_CHAT_CLI_SETUP_INSTALL_DESC": "Executa o instalador oficial de {0} no terminal. Escolla {1} de novo cando remate.",
  "AI_CHAT_CLI_SETUP_NO_DOWNLOADER": "Necesítase {0} ou {1}. Instale un deles primeiro.",
  "AI_CHAT_CLI_SETUP_PATH_TITLE": "Xa o teño",
  "AI_CHAT_CLI_SETUP_PATH_DESC": "Pegue a ruta completa a {0}.",
  "AI_CHAT_CLI_SETUP_USE_PATH_BTN": "Usar esta ruta",
  "AI_CHAT_CLI_SETUP_AUTO_DETECT": "Detectar automaticamente",
  "AI_CHAT_CLI_SETUP_AUTO_DETECT_FAILED": "Non se puido atopar {0} automaticamente.",
  "AI_CHAT_CLI_SETUP_WHAT_IS": "Que é {0}?",
  "AI_CHAT_CLI_ERR_OVERRIDE_MISSING": "Non existe ningún ficheiro nesa ruta.",
  "AI_CHAT_CLI_ERR_OVERRIDE_NOT_EXECUTABLE": "Ese ficheiro non é executábel.",
  "AI_CHAT_CLI_ERR_OVERRIDE_INVALID": "Ese ficheiro non se executou como {0}.",
  "AI_CHAT_CLI_ERR_OVERRIDE_TIMEOUT": "O ficheiro non respondeu a tempo.",
  "AI_CHAT_CLI_ERR_OVERRIDE_REJECTED": "A ruta contén caracteres que non se poden usar.",
  "AI_CHAT_SETUP_NEED_HELP": "Precisa axuda?",
  "AI_CHAT_SETUP_LEARN_MORE": "Máis información",
  "AI_CHAT_RETRY": "Reintentar",
  "AI_CHAT_DESKTOP_ONLY": "As funcións de IA requiren a aplicación de escritorio {APP_NAME}. Descárguea para comezar.",
  "AI_CHAT_DOWNLOAD_BTN": "Descargar a aplicación de escritorio",
  "AI_CHAT_PLACEHOLDER_TITLE": "Deseñe, constrúa e corrixa máis rápido coa IA",
  "AI_CHAT_PLACEHOLDER_SUBTITLE": "Converte ideas en páxinas funcionais en {APP_NAME}.",
  "AI_CHAT_WELCOME_LABEL": "IA en {APP_NAME}",
  "AI_CHAT_WELCOME_CLI_TITLE": "Constrúe co teu axente CLI favorito",
  "AI_CHAT_WELCOME_CLI_SUBTITLE": "Dálle aos teus axentes CLI as ferramentas para ver, inspeccionar e depurar a túa páxina mentres constrúen.",
  "AI_CHAT_WELCOME_LAYOUT_PROMPT": "Constrúe unha sección de prezos",
  "AI_CHAT_WELCOME_BUG_PROMPT": "Arranxa a navegación móbil",
  "AI_CHAT_WELCOME_EDITING": "Editando {0}…",
  "AI_CHAT_WELCOME_REVIEWING": "Revisando {0}…",
  "AI_CHAT_WELCOME_NAV_LABEL": "Explorar as previsualizacións da IA",
  "AI_CHAT_WELCOME_PREVIOUS": "Previsualización anterior",
  "AI_CHAT_WELCOME_NEXT": "Seguinte previsualización",
  "AI_CHAT_WELCOME_SHOW_DEMO": "Amosar a demo da IA",
  "AI_CHAT_WELCOME_SHOW_CLI": "Amosar os axentes da CLI",
  "AI_CHAT_WELCOME_PLAY_DEMO": "Reproducir a demo da IA",
  "AI_CHAT_LOGIN_TITLE": "Inicia sesión para empezar coa IA",
  "AI_CHAT_LOGIN_MESSAGE": "Inicia sesión na túa conta de {APP_NAME} para configurar a IA.",
  "AI_CHAT_LOGIN_BTN": "Iniciar sesión",
  "AI_CHAT_INTRO_GUEST_TITLE": "Deseña maquetas, corrixe erros e desenvolve máis rápido coa IA",
  "AI_CHAT_INTRO_CONFIGURE_TITLE": "Primeiros pasos con Claude Code",
  "AI_CHAT_INTRO_CONFIGURE_DESC": "Mira este vídeo curto para configurar a IA en {APP_NAME}",
  "AI_CHAT_UPSELL_TITLE": "Phoenix Pro + IA",
  "AI_CHAT_UPSELL_MESSAGE": "As funcións de IA están dispoñibles con Phoenix Pro.",
  ...
  "AI_CHAT_TOOL_EDIT": "Edición",
  "AI_CHAT_TOOL_WRITE": "Escribir",
  "AI_CHAT_TOOL_RUN_CMD": "Executar comando",
  "AI_CHAT_TOOL_SKILL": "Habilidade",
  "AI_CHAT_TOOL_EDITOR_STATE": "Estado do editor",
  "AI_CHAT_TOOL_SCREENSHOT": "Captura de pantalla",
  "AI_CHAT_TOOL_SCREENSHOT_OF": "Captura de pantalla de {0}",
  ...
  "AI_CHAT_TOOL_RESIZE_PREVIEW": "Redimensionar a vista previa",
  "AI_LIVE_PREVIEW_BANNER_TEXT": "A IA está a inspeccionar a vista previa en directo",
  "AI_LIVE_PREVIEW_BANNER_RESIZE": "A IA redimensionou a vista previa a {0}",
  "AI_LIVE_PREVIEW_BANNER_DISMISS_TOOLTIP": "Fai clic para descartar",
  "AI_CHAT_TOOL_CONTROL_EDITOR": "Editor",
  "AI_CHAT_TOOL_TASKS": "Tarefas",
  "AI_CHAT_TOOL_TASKS_SUMMARY": "{0} de {1} tarefas feitas",
  "AI_CHAT_TOOL_WEB_FETCH": "Obter páxina web",
  "AI_CHAT_TOOL_WEB_SEARCH": "Busca na web",
  "AI_CHAT_TOOL_SEARCHED": "Buscouse: {0}",
  "AI_CHAT_TOOL_GREP": "Grep: {0}",
  "AI_CHAT_TOOL_READ_FILE": "Ler {0}",
  "AI_CHAT_TOOL_READ_FILE_RANGE": "Ler as liñas {1}-{2} de {0}",
  "AI_CHAT_TOOL_READ_FILE_FROM": "Ler {0} desde a liña {1}",
  "AI_CHAT_TOOL_EDIT_FILE": "Editar {0}",
  "AI_CHAT_TOOL_WRITE_FILE": "Escribir {0}",
  "AI_CHAT_TOOL_RAN_CMD": "Executouse o comando",
  ...
  "AI_CHAT_TOOL_SKILL_NAME": "Habilidade: {0}",
  "AI_CHAT_TOOL_IN_PATH": "en {0}",
  "AI_CHAT_TOOL_INCLUDE": "incluír {0}",
  "AI_CHAT_RECEIVING_BYTES": "recibindo {0} bytes...",
  "AI_CHAT_FILES_CHANGED": "{0} {1} modificados",
  "AI_CHAT_FILE_SINGULAR": "arquivo",
  "AI_CHAT_FILE_PLURAL": "arquivos",
  "AI_CHAT_RESTORE_POINT": "Restaurar a este punto",
  "AI_CHAT_UNDO": "Desfacer",
  "AI_CHAT_UNDO_TITLE": "Desfacer os cambios desta resposta",
  "AI_CHAT_RESTORE_TITLE": "Restaurar os ficheiros a este punto",
  "AI_CHAT_RESTORED": "Restaurado",
  "AI_CHAT_TOOL_APPLIED_DIRECTLY": "Aplicado directamente no disco · diff non dispoñible",
  "AI_CHAT_TOOL_REJECTED": "Edición rexeitada — o ficheiro non foi modificado",
  "AI_CHAT_TOOL_REJECTED_REASON": "Motivo: {0}",
  "AI_CHAT_FILE_NOT_FOUND_TITLE": "Ficheiro non atopado",
  ...
  "AI_CHAT_HIDE_DIFF": "Ocultar diferenzas",
  "AI_CHAT_DIFF_MORE_TITLE": "Opcións do diff",
  "AI_CHAT_DIFF_EXPAND_ALL": "Expandir todo",
  "AI_CHAT_DIFF_COLLAPSE_ALL": "Contraer todo",
  "AI_CHAT_DIFF_ALWAYS_SHOW": "Amosar sempre",
  "AI_CHAT_LABEL_YOU": "Ti",
  "AI_CHAT_LABEL_CLAUDE": "Claude",
  "AI_CHAT_SEND_ERROR": "Erro ao enviar a mensaxe: {0}",
  "AI_CHAT_EDIT_NOT_FOUND": "Non se atopou o texto no ficheiro — pode que cambiase",
  "AI_CHAT_WORKING": "Traballando...",
  "AI_CHAT_WRITING": "Escribindo...",
  "AI_CHAT_PROCESSING": "Procesando...",
  "AI_CHAT_CONTEXT_SELECTION": "Selección L{0}-L{1}",
  "AI_CHAT_CONTEXT_CURSOR": "Liña {0}",
  "AI_CHAT_CONTEXT_LIVE_PREVIEW": "Vista Previa en Vivo",
  "AI_CHAT_TOOL_WAIT": "Agarde",
  "AI_CHAT_TOOL_WAITING": "Agardando {0}s",
  "AI_CHAT_TOOL_WAITED": "Espera de {0}s finalizada",
  "AI_CHAT_COPY_CODE": "Copiar",
  "AI_CHAT_COPIED_CODE": "Copiado",
  "AI_CHAT_TOOL_QUESTION": "Pregunta",
  "AI_CHAT_TOOL_TASK": "Subaxente",
  "AI_CHAT_TOOL_TASK_NAME": "Subaxente: {0}",
  "AI_CHAT_TOOL_PLANNING": "Planificando",
  "AI_CHAT_TOOL_TOOL_SEARCH": "Cargando ferramentas",
  "AI_CHAT_TOOL_SEND_MESSAGE": "Enviando mensaxe ao subaxente",
  "AI_CHAT_TOOL_TASK_OUTPUT": "Lendo a saída do subaxente",
  "AI_CHAT_TOOL_TASK_STOP": "Detendo o subaxente",
  "AI_CHAT_PLAN_TITLE": "Plan proposto",
  "AI_CHAT_PLAN_MAXIMIZE": "Abrir o plan en pantalla completa",
  "AI_CHAT_PLAN_CLOSE_FULLSCREEN": "Minimizar de volta ao chat (Esc)",
  "AI_CHAT_PLAN_APPROVE": "Aprobar",
  "AI_CHAT_PLAN_REVISE": "Revisar",
  "AI_CHAT_PLAN_FEEDBACK_PLACEHOLDER": "Que che gustaría cambiar?",
  "AI_CHAT_PLAN_STOP": "Deter",
  "AI_CHAT_PLAN_STOP_TITLE": "Interromper a Claude e desbotar este plan",
  ...
  "AI_CHAT_MODEL_DEFAULT": "Predeterminado",
  "AI_CHAT_MODEL_DEFAULT_DESC_CURRENT": "Actualmente {0}",
  ...
  "AI_CHAT_MODEL_SELECT_TITLE": "Escolla o modelo de IA para esta conversa",
  "AI_CHAT_MODE_SELECT_TITLE": "Cambiar entre o chat de Claude Code e un terminal da CLI integrado",
  "AI_CHAT_MODEL_SWITCHED_NOTICE": "Cambiouse a {0}. Aplícase a partir da súa seguinte mensaxe; a primeira resposta pode tardar un pouco máis mentres se reconstrúe a caché.",
  "AI_CHAT_INPUT_HINT": "Preme {0} para enviar · {1} para unha nova liña",
  ...
  "AI_CHAT_TOOL_CONFIRM_TITLE": "Permitir esta acción?",
  "AI_CHAT_TOOL_ALLOWED": "Acción permitida",
  "AI_CHAT_TOOL_DENIED": "Acción denegada",
  "AI_CHAT_PLAN_WRITE_CONFIRM_TITLE": "Cambiar a Auto?",
  "AI_CHAT_PLAN_WRITE_CONFIRM_BODY": "Claude quere editar {0}. Estás actualmente no modo de planificación.",
  "AI_CHAT_PLAN_WRITE_ALLOW": "Permitir e cambiar a Auto",
  "AI_CHAT_PLAN_WRITE_STAY": "Permanecer no modo de planificación",
  "AI_CHAT_PLAN_WRITE_ALLOWED": "Cambiouse a Auto",
  "AI_CHAT_PLAN_WRITE_STAYED": "Permaneceuse no modo de planificación",
  "AI_CHAT_CODE_DEFAULT_LANG": "Texto",
  "AI_CHAT_CODE_COLLAPSE": "Contraer",
  "AI_CHAT_CODE_EXPAND": "Expandir",
  "AI_CHAT_CODE_EXPAND_LINES": "Prema para expandir - {0} liñas",
  "AI_CHAT_CODE_COLLAPSE_FOOTER": "Prema para contraer",
  "AI_CHAT_PREVIEW_OPEN": "Vista previa",
  "AI_CHAT_PREVIEW_VIEWING": "Previsualizando",
  "AI_CHAT_QUESTION_OTHER": "Escriba unha resposta personalizada…",
  "AI_CHAT_QUESTION_SUBMIT": "Enviar",
  "AI_CHAT_IMAGE_LIMIT": "Permítese un máximo de {0} imaxes",
  "AI_CHAT_IMAGE_REMOVE": "Eliminar imaxe",
  "AI_CHAT_IMAGE_SEARCH": "Buscando imaxes",
  "AI_CHAT_IMAGE_USE": "Seleccionando imaxe",
  "AI_CHAT_IMAGE_SELECTED": "Imaxe seleccionada",
  "AI_CHAT_IMAGE_SELECTED_GROUP": "Imaxes seleccionadas",
  "AI_CHAT_IMAGE_PREVIEW": "Vista previa da imaxe",
  "AI_CHAT_IMAGE_PREVIEW_INVALID": "Proporcione de un a nove URL de imaxes HTTP, HTTPS ou de ficheiro.",
  "AI_CHAT_IMAGE_PREVIEW_COUNT": "{0} imaxes",
  "AI_CHAT_IMAGE_PREVIEW_SINGLE": "1 imaxe",
  "AI_CHAT_IMAGE_CLOSE": "Pechar a vista previa da imaxe (Esc)",
  "AI_CHAT_IMAGE_PREVIOUS": "Imaxe anterior",
  "AI_CHAT_IMAGE_NEXT": "Seguinte imaxe",
  "AI_CHAT_IMAGE_POSITION": "Imaxe {0} de {1}",
  "AI_CHAT_IMAGE_PHOTO_BY": "Fotografía de",
  "AI_CHAT_IMAGE_REPLY": "Responder con esta imaxe",
  "AI_CHAT_IMAGE_QUOTE": "Citar imaxe no chat",
  "AI_CHAT_IMAGE_VIEW_COLLAGE": "Ver a colaxe",
  "AI_CHAT_IMAGE_SHOW_ALL": "Amosar todas",
  "AI_CHAT_IMAGE_BACK_TO_ALL": "Volver a todas as imaxes",
  "AI_CHAT_IMAGE_RESULTS_COUNT": "{0} fotografías · Unsplash",
  "AI_CHAT_IMAGE_RESULTS_SINGLE": "1 fotografía · Unsplash",
  "AI_CHAT_IMAGE_NO_RESULTS": "Non se atoparon imaxes. Proba cunha busca diferente.",
  "AI_CHAT_IMAGE_LOAD_FAILED": "Non se puido cargar esta imaxe.",
  "AI_CHAT_IMAGE_COLLAGE_FAILED": "Non se puido crear a colaxe de imaxes.",
  "AI_CHAT_IMAGE_INVALID_QUERY": "Introduza unha consulta de busca de ata 200 caracteres e un número de páxina válido.",
  "AI_CHAT_IMAGE_INVALID_REFERENCE": "Esta referencia de imaxe non é válida. Use un resultado da busca de imaxes.",
  "AI_CHAT_IMAGE_HOURLY_LIMIT": "Alcanzouse o límite de 120 buscas de imaxes por hora. Agarde antes de volver buscar.",
  "AI_CHAT_IMAGE_GUEST_LIMIT": "Esgotouse a súa cota de busca de imaxes. Inicie sesión para continuar buscando.",
  "AI_CHAT_IMAGE_SERVER_LIMIT": "A busca de imaxes está limitada temporalmente. Agarde antes de volver buscar.",
  "AI_CHAT_IMAGE_TIMEOUT": "Esgotouse o tempo de espera da busca de imaxes. Ténteo de novo máis tarde.",
  "AI_CHAT_IMAGE_REQUEST_FAILED": "O servizo de imaxes devolveu un erro ({0}).",
  "AI_CHAT_ATTACH_FILE": "Adxuntar ficheiros",
  "AI_CHAT_ATTACH_TITLE": "Adxuntar ficheiro ou cartafol",
  "AI_CHAT_ATTACH_FILE_OPTION": "Adxuntar un ficheiro",
  "AI_CHAT_ATTACH_FOLDER": "Engadir cartafol como contexto",
  "AI_CHAT_ATTACH_FOLDER_PICK_TITLE": "Seleccionar cartafol para engadir como contexto",
  ...
  "AI_CHAT_SCREENSHOT_UPLOAD": "Cargar desde o dispositivo",
  ...
  "AI_CHAT_TOOL_CLARIFICATION": "Lendo o seu seguimento",
  "AI_CHAT_HISTORY_TITLE": "Historial de sesións",
  "AI_CHAT_HISTORY_EMPTY": "Non hai sesións anteriores",
  "AI_CHAT_SESSION_RESUMED": "Sesión reanudada",
  "AI_CHAT_HISTORY_JUST_NOW": "agora mesmo",
  "AI_CHAT_HISTORY_MINS_AGO": "hai {0} m",
  "AI_CHAT_HISTORY_HOURS_AGO": "hai {0} h",
  "AI_CHAT_HISTORY_DAYS_AGO": "hai {0} d",
  "AI_CHAT_HISTORY_CLEAR_ALL": "Limpar todo",
  "AI_CHAT_HISTORY_DELETE_CONFIRM": "Eliminar esta sesión?",
  "AI_CHAT_SWITCH_PROJECT_TITLE": "A IA está a traballar",
  "AI_CHAT_SWITCH_PROJECT_MSG": "A IA está a traballar actualmente nunha tarefa. Cambiar de proxecto deterá o proceso. Desexa continuar?",
  "AI_CHAT_NEW_WHILE_STREAMING_TITLE": "A IA está a traballar",
  ...
  "AI_CHAT_CLI_UPSELL_OPEN_TERMINAL_BTN": "Abrir no Terminal",
  "AI_CHAT_CLI_UPSELL_UPGRADE_BTN": "Actualizar a Pro",
  "AI_CHAT_CLI_STALE_PROJECT_MSG": "Esta sesión da CLI de Claude Code segue en execución en {0} — o proxecto aberto agora é {1}.",
  ...
  "AI_SETTINGS_API_TIMEOUT": "Tempo de espera da API (ms)",
  "AI_SETTINGS_API_KEY_PLACEHOLDER": "Introduza a súa chave de API de Anthropic",
  "AI_SETTINGS_BASE_URL_PLACEHOLDER": "Deixe en branco para o valor predeterminado",
  "AI_SETTINGS_API_TIMEOUT_PLACEHOLDER": "Deixe en branco para o valor predeterminado",
  "AI_SETTINGS_SAVE": "Gardar",
  "AI_SETTINGS_RESET": "Restablecer",
  "AI_SETTINGS_CUSTOM_ENDPOINT_NOTICE": "Usando o punto de conexión da API personalizado: {0}",
  "AI_SETTINGS_ACTIVE_PROVIDER": "Provedor activo",
  "AI_SETTINGS_DEFAULT_PROVIDER": "Predeterminado (código local de Claude)",
  "AI_SETTINGS_DEFAULT_PROVIDER_FOR": "Por defecto (Local {0})",
  "AI_SETTINGS_PROVIDERS": "Provedores",
  "AI_SETTINGS_ADD_PROVIDER": "+ Engadir provedor",
  "AI_SETTINGS_EDIT": "Edición",
  "AI_SETTINGS_DELETE": "Eliminar",
  "AI_SETTINGS_PROVIDER_NAME": "Nome",
  "AI_SETTINGS_PROVIDER_NAME_PLACEHOLDER": "p. ex., O meu provedor de API",
  "AI_SETTINGS_SAVE_PROVIDER": "Gardar provedor",
  "AI_SETTINGS_DELETE_PROVIDER": "Eliminar provedor",
  "AI_SETTINGS_DELETE_ACTIVE_CONFIRM": "\"{0}\" é o provedor activo. Se o elimina, volverase ao predeterminado. Quere continuar?",
  ...
  "AI_SETTINGS_PROVIDER_TYPE_NOTE": "Estes provedores configuran {0}. A clave da API pásaselle como {1}.",
  "AI_SETTINGS_CLI_PATHS_NOTE": "Deixe en branco para detectar automaticamente.",
  "AI_SETTINGS_CLI_PATH_LABEL": "Camiño do executábel {0}",
  "AI_SETTINGS_ENABLE_AI": "Activar as funcións de IA",
  "AI_SETTINGS_ENABLE_AI_NOTE": "Activa ou desactiva todas as funcións de IA en {APP_NAME}. Cambiar isto reinicia {APP_NAME} para aplicalo — pode activalo de novo en calquera momento desde <span class='ai-settings-menu-path'>Menú Ver &gt; Activar a IA</span>.",
  ...
  "MIGRATE_MOVING_TITLE": "{0} estase a trasladar",
  "MIGRATE_MOVING_MESSAGE": "{APP_NAME} en {0} estase a trasladar a un novo enderezo en <strong>{1}</strong>. Todo funciona igual, só cambia o enderezo.",
  "MIGRATE_DATA_SAFE_NOTE": "Os teus proxectos, axustes e extensións copiaranse a primeira vez que abras {0}. Non se eliminará nada deste sitio.",
  "MIGRATE_MANUAL_DOWNLOAD_NOTE": "A transferencia automática non está dispoñible neste navegador. Se tes proxectos gardados aquí, descárgaos para podelos abrir de novo no sitio novo.",
  "MIGRATE_GO_TO_NEW_SITE": "Lévame ao novo sitio",
  ...
  "MIGRATE_DONE_TITLE": "Migración completada",
  "MIGRATE_DONE_FROM": "Importado desde {0}:",
  "MIGRATE_DONE_PROJECTS": "{0} proxectos",
  "MIGRATE_DONE_EXTENSIONS": "{0} extensións e temas",
  "MIGRATE_DONE_SETTINGS": "A túa configuración, incluído o tema do editor",
  "MIGRATE_DONE_TOTAL": "{0} ficheiros en total. Recarga {APP_NAME} para comezar a usalos.",
  "MIGRATE_PARTIAL_TITLE": "A migración non rematou",
  "MIGRATE_PARTIAL_COUNT": "{0} de {1} ficheiros non se puideron copiar e aínda están no sitio antigo.",
  ...
  "MIGRATE_INTERRUPTED_TITLE": "A migración non rematou",
  "MIGRATE_INTERRUPTED_PROGRESS": "Copiáronse {0} de {1} ficheiros desde {2} antes de que se perdese a conexión. Eses ficheiros gardáronse, así que non se perdeu nada.",
  "MIGRATE_INTERRUPTED_RETRY": "{APP_NAME} tentará o resto a próxima vez que o abra.",
  ...
  "TERMINAL_PROJECT_CHANGED": "Proxecto cambiado a {0}",
  "TERMINAL_PROJECT_RESTART_PATH": "Reiniciar todos os terminais en {0}",
  "TERMINAL_PROJECT_DISMISS": "Descartar — manter os terminais en execución",
  "TERMINAL_PROJECT_RESTART": "Reiniciar todos os terminais",
  "AI_CHAT_START_CHAT_NAME": "{0} · IA visual",
  "AI_CHAT_START_CHAT_DESC": "Chat integrado para fluxos de traballo visuais",
  "AI_CHAT_START_BY_PROVIDER": "Por {0}",
  "AI_CHAT_START_CLI_SEPARATOR": "Ferramentas de liña de comandos · conéctase con {APP_NAME}",
  "AI_CHAT_START_CHAT_RUNNING": "En curso",
  "AI_CHAT_START_CLI_RUNNING": "En execución",
  "AI_CHAT_START_CLI_FOLDED": "Usa unha CLI no seu lugar: {0}",
  "AI_CHAT_BACK_BTN": "Atrás",
  "AI_CHAT_BACK_TITLE": "Volver ao inicio",
  "AI_CHAT_SETUP_PLACEHOLDER": "Configura Claude Code para comezar a chatear"
});