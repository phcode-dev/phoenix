...
define({
  ...
  "PHP_INSTALL_DIALOG_TEXT": "Autocompletado avanzado, comprobación de erros, documentación e máis para PHP.",
  "PHP_INSTALL_DIALOG_SIZE": "Descarga de 9 MB",
  "PHP_INSTALL_LATER_INFO": "Pode instalalo máis tarde — a barra de instalación aparece sempre que se abre un ficheiro PHP.",
  ...
  "PYTHON_BENEFIT_ERRORS_SUB": "erros sinalados mentres programas",
  "PYTHON_BENEFIT_NAV": "Navegación",
  "PYTHON_BENEFIT_NAV_SUB": "ir á definición e atopar usos",
  "PYTHON_BENEFIT_FORMAT": "Formato",
  "PYTHON_BENEFIT_FORMAT_SUB": "limpeza de código cun só comando con Ruff",
  "PYTHON_INSTALL_DIALOG_TEXT": "Completados avanzados, comprobación de erros, documentación e formato para Python.",
  ...
  "PYTHON_PANEL_TEXT": "A intelixencia de código de Python está desactivada. Instale o servidor de linguaxe Pyrefly e o formatador Ruff (de balde, ~25 MB de descarga) para obter completados, comprobación de erros, documentación, formato e ir á definición.",
  "PYTHON_INSTALLING": "Configurando o soporte para Python — a descargar as ferramentas da linguaxe…",
  ...
  "DESCRIPTION_PYTHON_CODE_INTELLIGENCE": "`false` para desactivar a intelixencia de código de Python (Pyrefly). Se o volve establecer en `true`, volverase ofrecer a descarga do servidor da linguaxe."
});