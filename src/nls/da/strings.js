...
define({
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "For at forbedre {APP_NAME} sender vi med jævne mellemrum begrænsede, <strong>pseudonyme</strong> statistikker til core.ai om, hvordan du bruger {APP_NAME}. Disse oplysninger hjælper med at prioritere funktioner, finde fejl og spotte brugervenlighedsproblemer, mens du beskytter dit privatliv.<br><br> Du kan se dine data eller vælge ikke at dele data ved at vælge <strong>Hjælp &gt; Sundhedsrapport</strong> .<br><br>",
  "HEALTH_DATA_PREVIEW": "Sundhedsrapport for {APP_NAME}",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>For at forbedre {APP_NAME} sender vi med jævne mellemrum begrænsede, <strong>pseudonyme</strong> statistikker til core.ai om, hvordan du bruger {APP_NAME}. Disse oplysninger hjælper med at prioritere funktioner, finde fejl og finde problemer med brugervenlighed.</p><p> Nedenfor er en forhåndsvisning af de data, der sendes i din næste sundhedsrapport, <em>hvis</em> den er aktiveret.</p>",
