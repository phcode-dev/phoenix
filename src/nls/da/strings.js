...
define({
  ...
  "CMD_ENABLE_SELECTION_VIEW": "Selection Se",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "Et objekt med standardindstillingerne for JSHint. Se venligst følgende URL for alle tilgængelige JSHint muligheder: https://jshint.com/docs/options/",
  ...
  "DESCRIPTION_SELECTION_VIEW_ENABLED": "true for at aktivere markeringsvisning",
  ...
  "EXTRACTING_FILES_PROGRESS": "Udpakning {0} af {1} filer.",
  ...
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Kunne ikke forskønne. Editor tekst ændret efter forskønnelse.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Forskønne fil {0}",
  "BEAUTIFY_ERROR_SELECTION": "Kunne ikke forskønne. </br>Ufuldstændigkodeblok valgt eller ugyldig syntaks.",
