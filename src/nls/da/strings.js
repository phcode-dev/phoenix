...
define({
  ...
  "ERROR_RENAMING_NOT_IN_PROJECT": "Filen eller mappen er ikke en del af det aktuelt åbnede projekt. Desværre kan kun projektfiler omdøbes på dette tidspunkt.",
  "ERROR_MOVING_FILE_TITLE": "Fejl ved flytning {0}",
  "ERROR_MOVING_FILE": "Der opstod en fejl under forsøg på at flytte {2} <span class='dialog-filename'>{0}</span>. {1}",
  "ERROR_MOVING_NOT_IN_PROJECT": "Filen/mappen kan ikke flyttes, da de ikke er en del af det aktuelle projekt.",
  ...
  "ERROR_RESTRICTED_COMMANDS": "Du kan ikke omfordele genveje til disse kommandoer: {0}",
  "ERROR_RESTRICTED_SHORTCUTS": "Du kan ikke omfordele disse genveje: {0}",
  "ERROR_MULTIPLE_SHORTCUTS": "Du omfordele flere genveje til disse kommandoer: {0}",
  ...
  "ERROR_PROJ_PREFS_CORRUPT": "Din projektindstillingsfil er ikke gyldig JSON. Filen åbnes, så du kan rette formatet. Du bliver nødt til at genindlæse projektet for at ændringerne kan træde i kraft.",
  ...
  "LIVE_DEV_SELECT_FILE_TO_PREVIEW": "Vælg fil til live forhåndsvisning",
  "LIVE_DEV_CLICK_TO_RELOAD_PAGE": "Genindlæs side",
  "LIVE_DEV_CLICK_POPOUT": "Popout Live-forhåndsvisning til nyt vindue",
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "Pin på Unpin Page Eksempel",
  ...
  "WINDOW_UNLOAD_WARNING": "Er du sikker på, at du vil navigere til en anden URL og forlade parentes?",
  "WINDOW_UNLOAD_WARNING_WITH_UNSAVED_CHANGES": "Du har ikke-gemte ændringer! Er du sikker på, at du vil navigere til en anden URL og forlade parentes?",
  "DONE": "Færdig",
  "OK": "OK",
  "CANCEL": "Annuller",
  "DONT_SAVE": "Gem ikke",
  ...
  "CMD_SPLITVIEW_VERTICAL": "Lodret Split",
  "CMD_SPLITVIEW_HORIZONTAL": "Vandret Split",
  ...
  "SPLITVIEW_MULTIPANE_WARNING": "Filen er allerede åben i en anden rude. {APP_NAME} vil snart understøtte åbning af den samme fil i mere end én rude. Indtil da vises filen i ruden, den allerede er åben i. <br /><br />( Du vil kun se denne meddelelse én gang.)",
  ...
  "STATUSBAR_INSOVR_TOOLTIP": "Klik for at skifte markøren mellem tilstanden Indsæt (INS) og Overskriv (OVR)",
  "STATUSBAR_LANG_TOOLTIP": "Klik for at ændre filtype",
  "STATUSBAR_CODE_INSPECTION_TOOLTIP": "{0}. Klik for at slå rapportpanelet fra.",
  "STATUSBAR_DEFAULT_LANG": "(standard)",
  "STATUSBAR_SET_DEFAULT_LANG": "Angiv som standard for. {0} Filer",
  ...
  "CMD_FILE_OPEN": "Åbn…",
  "CMD_RECENT_FILES_OPEN": "Åbn Seneste...",
  ...
  "CMD_TOGGLE_LIVE_PREVIEW_MB_MODE": "Aktivér eksperimentel Live Preview",
  "CMD_RELOAD_LIVE_PREVIEW": "Tving Reload Live Eksempel",
  ...
  "CMD_TOGGLE_PANELS": "Toggle paneler",
  ...
  "CMD_THEMES": "Temaer...",
  "CMD_TOGGLE_SEARCH_AUTOHIDE": "Luk automatisk søgning",
  "NAVIGATE_MENU": "Navigér",
  "CMD_QUICK_OPEN": "Lyn-åbn",
  "CMD_GOTO_LINE": "Gå til linje",
  "CMD_GOTO_DEFINITION": "Lyn-søg efter definition",
  "CMD_GOTO_DEFINITION_PROJECT": "Definition af hurtig søgning i projekt",
  ...
  "CMD_NAVIGATE_BACKWARD": "Naviger baglæns",
  "CMD_NAVIGATE_FORWARD": "Naviger fremad",
  ...
  "CMD_SWITCH_PANE_FOCUS": "Switch Rude Fokus",
  ...
  "ABOUT": "Om",
  "CLOSE": "Luk",
  "ABOUT_TEXT_LINE1": "Frigøre {VERSION_MAJOR}. {VERSION_MINOR} {BUILD_TYPE} {VERSION}",
  "ABOUT_TEXT_BUILD_TIMESTAMP": "build tidsstempel: ",
  "ABOUT_TEXT_LINE3": "Tredjepartsbiblioteker, som vi bruger - <a href='https://github.com/phcode-dev/phoenix/tree/main/src/thirdparty/licences'> Licenser og attributter</a> . ",
  ...
  "ABOUT_TEXT_LINE6": "Masser af mennesker (men vi har problemer med at indlæse disse data lige nu).",
  ...
  "EMPTY_VIEW_HEADER": "<em>Åbnen fil, mens denne rude har fokus</em>",
  "FLIPVIEW_BTN_TOOLTIP": "Vend denne visning til {0} rude",
  "CURRENT_THEME": "Aktuelt tema",
  "USE_THEME_SCROLLBARS": "Brug Theme Scrollbars",
  "FONT_SIZE": "Skriftstørrelse",
  "FONT_FAMILY": "Font Familie",
  "THEMES_SETTINGS": "Temaer Indstillinger",
  ...
  "VIEW_COMPLETE_DESCRIPTION": "Se hele beskrivelsen",
  "VIEW_TRUNCATED_DESCRIPTION": "Vis afkortet beskrivelse",
  "SORT_EXTENSION_METHOD": "Sorter udvidelser med DownloadCount eller PublishedDate",
  "INVALID_ZIP_FILE": "Det modtagede indhold er ikke en gyldig zip-fil.",
  "MISSING_PACKAGE_JSON": "Pakken har ingen pakke.json-fil.",
  ...
  "NPM_INSTALL_FAILED": "npm installationskommandoen mislykkedes: {0}",
  ...
  "INSTALL_EXTENSION_DROP": "Drop.zip for at installere",
  "INSTALL_EXTENSION_DROP_ERROR": "Installer/Opdater afbrudt på grund af følgende fejl:",
  ...
  "EXTENSION_TRANSLATED_USER_LANG": "Oversat til {0} sprog, herunder dit",
  ...
  "EXTENSION_MANAGER_DISABLE_ERROR": "Kunne ikke deaktivere en eller flere udvidelser: {0}. {APP_NAME} vil stadig genindlæse.",
  ...
  "EXTENSIONS_LAST_UPDATED": "Senest opdateret",
  "EXTENSIONS_DOWNLOADS": "Downloads",
  "INLINE_EDITOR_NO_MATCHES": "Ingen forekomster.",
  "INLINE_EDITOR_HIDDEN_MATCHES": "Alle kampe er kollapsede. Udvid de filer, der er anført til højre for at se kampe.",
  ...
  "CMD_LAUNCH_SCRIPT_MAC": "Genvej til Installer kommandolinje",
  ...
  "ERROR_CREATING_LAUNCH_SCRIPT": "Der opstod en fejl under installationen af kommandolinjegenvejen. Prøv <a href='https://github.com/adobe/brackets/wiki/Command-Line-Arguments#troubleshooting'>disse forslag til fejlfinding</a>. <br/><br/>Årsag: {0}",
  "ERROR_CLTOOLS_RMFAILED": "Kunne ikke fjerne eksisterende <code>/usr/local/bin/parentes</code> symlink.",
  "ERROR_CLTOOLS_MKDIRFAILED": "Kunne ikke oprette mappen <code>/usr/local/bin</code> .",
  "ERROR_CLTOOLS_LNFAILED": "Kunne ikke oprette <code>/usr/local/bin/parentes</code> symlink.",
  ...
  "LAUNCH_SCRIPT_CREATE_SUCCESS": "Succes! Nu kan du nemt starte {APP_NAME} fra kommandolinjen: <code>parentes myFile.txt</code> for at åbne en fil eller <code>parentes MyFolder</code> for at skifte projekter. <br/><br/><a href='https://github.com/adobe/brackets/wiki/Command-Line-Arguments'>Lær mere</a> om brug af {APP_NAME} fra kommandolinjen.",
  ...
  "HEALTH_FIRST_POPUP_TITLE": "{APP_NAME} Sundhedsrapport",
  "HEALTH_DATA_DO_TRACK": "Del pseudonyme oplysninger om, hvordan jeg bruger {APP_NAME}",
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "For at forbedre {APP_NAME} sender vi periodisk begrænsede, <strong>pseudonyme</strong> statistikker til core.ai om, hvordan du bruger {APP_NAME}. Disse oplysninger hjælper med at prioritere funktioner, finde fejl, og få øje på brugervenlighedsproblemer, mens du beskytter dit privatliv. <br><br>Dukan se dine data eller vælge ikke at dele data ved at vælge <strong>Hjælp > Sundhedsrapport</strong>. <br><br>",
  "HEALTH_DATA_PREVIEW": "{APP_NAME} Sundhedsrapport",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Forat forbedre {APP_NAME} sender vi periodisk begrænsede, <strong>pseudonyme</strong> statistikker til core.ai om, hvordan du bruger {APP_NAME}. Disse oplysninger hjælper med at prioritere funktioner, finde fejl, og få øje på problemer med brugervenlighed. </p><p>Nedenforer en forhåndsvisning af de data, der sendes i din næste sundhedsrapport, <em>hvis</em> de er aktiveret. </p>",
  ...
  "DETECTED_EXCLUSION_TITLE": "JavaScript fil inferens Problem",
  "DETECTED_EXCLUSION_INFO": "{APP_NAME} løb ind i problemer med at behandle <span class='dialog-filename'>{0}</span>. <br><br>Dennefil behandles ikke længere for kodetip, Gå til definition eller Hurtig redigering. Hvis du vil aktivere denne fil igen, skal du åbne <code>.brackets.json</code> i dit projekt og redigere <code>JScodeHints.detectedExclusions</code> . <br><br>Detteer sandsynligvis en {APP_NAME} fejl. Hvis du kan give en kopi af denne fil, bedes du <a href='https://github.com/adobe/brackets/wiki/How-to-Report-an-Issue'>indsende en fejl med et</a> link til den fil, der er navngivet her.",
  "CMD_REFACTOR": "Refaktor",
  "CMD_EXTRACTTO_VARIABLE": "Uddrag til variabel",
  "CMD_EXTRACTTO_FUNCTION": "Uddrag til funktion",
  "ERROR_TERN_FAILED": "Kan ikke hente data fra Tern",
  "ERROR_EXTRACTTO_VARIABLE_NOT_VALID": "Markering danner ikke et udtryk",
  "ERROR_EXTRACTTO_FUNCTION_NOT_VALID": "Den valgte blok skal repræsentere sæt af udsagn eller et udtryk",
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "Uddrag til variabel virker ikke i multicursors",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "Uddrag til funktion virker ikke i multicursorer",
  ...
  "CMD_REFACTORING_TRY_CATCH": "Indpakning i Prøv fangst",
  "CMD_REFACTORING_CONDITION": "Wrap i stand",
  ...
  "ERROR_TRY_CATCH": "Vælg gyldig kode, der skal pakkes ind i en Try-catch-blok",
  "ERROR_WRAP_IN_CONDITION": "Vælg gyldig kode for at ombryde i en Tilstandsblok",
  ...
  "ERROR_RENAME_MULTICURSOR": "Kan ikke omdøbe, når du bruger multi-markører",
  "ERROR_RENAME_QUICKEDIT": "Kan ikke omdøbe denne identifikator, da der refereres til andre steder uden for denne funktion",
  "ERROR_RENAME_GENERAL": "Kan ikke omdøbe markeret tekst",
  "JSLINT_NAME": "JSLint",
  ...
  "COLLAPSE_CURRENT": "Skjul strøm",
  "EXPAND_CURRENT": "Udvid nuværende",
  ...
  "DESCRIPTION_CLOSE_BRACKETS": "true til automatisk at lukke seler, parenteser og parenteser",
  "DESCRIPTION_CLOSE_OTHERS_ABOVE": "falsk at fjerne „Luk andre over“ fra Working Files kontekstmenu",
  "DESCRIPTION_CLOSE_OTHERS_BELOW": "falsk at fjerne „Luk andre nedenfor“ fra Working Files kontekstmenu",
  "DESCRIPTION_CLOSE_OTHERS": "falsk for at fjerne „Luk andre“ fra Working Files kontekstmenu",
  "DESCRIPTION_CLOSE_TAGS": "Indstiller indstillingerne for lukning af tag",
  "DESCRIPTION_CLOSE_TAGS_DONT_CLOSE_TAGS": "En række tags, der ikke bør lukkes automatisk",
  "DESCRIPTION_CLOSE_TAGS_WHEN_OPENING": "Luk, når > af åbningsmærket er indtastet",
  "DESCRIPTION_CLOSE_TAGS_WHEN_CLOSING": "Luk, når/af lukkemærket er indtastet",
  "DESCRIPTION_CLOSE_TAGS_INDENT_TAGS": "En række tags, der, når de åbnes, har en tom linje",
  "DESCRIPTION_CODE_FOLDING_ALWAY_USE_INDENT_FOLD": "true til altid generere sammenklappelige sektion markører, når indrykning niveau ændringer",
  "DESCRIPTION_CODE_FOLDING_ENABLED": "sandt at aktivere kode foldning",
  "DESCRIPTION_CODE_FOLDING_HIDE_UNTIL_MOUSEOVER": "sandt at gøre sektionskollapsende markører kun synlige, når du bevæger musen hen over rendestenen",
  "DESCRIPTION_CODE_FOLDING_MAX_FOLD_LEVEL": "Begrænser, hvor mange niveauer dyb Kollaps Alle gælder",
  "DESCRIPTION_CODE_FOLDING_MIN_FOLD_SIZE": "Minimum linjer før et sammenklappeligt sektionsikon vises",
  "DESCRIPTION_CODE_FOLDING_SAVE_FOLD_STATES": "true at huske kollapsede sektioner, hvis du lukker og genåbner en fil eller et projekt",
  "DESCRIPTION_CODE_FOLDING_MAKE_SELECTIONS_FOLDABLE": "sandt at aktivere kode foldning på valgt tekst i editoren",
  "DESCRIPTION_DISABLED_DEFAULT_EXTENSIONS": "Standardudvidelser, der er deaktiveret",
  "DESCRIPTION_ATTR_HINTS": "Aktiver/deaktiver HTML-attribut-tip",
  "DESCRIPTION_CSS_PROP_HINTS": "Aktiver/deaktiver CSS/MINDRE/SCSS ejendom hints",
  "DESCRIPTION_JS_HINTS": "Aktiver/deaktiver JavaScript kode tips",
  "DESCRIPTION_JS_HINTS_TYPE_DETAILS": "Aktiver/deaktiver datatype detaljer i JavaScript-kode hints",
  "DESCRIPTION_PREF_HINTS": "Aktiver/deaktiver Preferences kode hints",
  "DESCRIPTION_SPECIAL_CHAR_HINTS": "Aktiver/deaktiver HTML-objekttips",
  "DESCRIPTION_SVG_HINTS": "Aktiver/deaktiver SVG-kodetips",
  "DESCRIPTION_HTML_TAG_HINTS": "Aktiver/deaktiver HTML-tag hints",
  "DESCRIPTION_URL_CODE_HINTS": "Aktiver/deaktiver URL hints i HTML & CSS/LESS/SCSS",
  "DESCRIPTION_DRAG_DROP_TEXT": "Aktiver/deaktiver Træk & Drop-funktionalitet",
  "DESCRIPTION_HEALTH_DATA_TRACKING": "Aktivér sporing af sundhedsdata",
  "DESCRIPTION_HIGHLIGHT_MATCHES": "Aktiverer automatisk fremhævning af matchende strenge i hele dokumentet",
  "DESCRIPTION_HIGHLIGHT_MATCHES_SHOW_TOKEN": "Fremhæv alle strenge, der matcher det token, markøren er i øjeblikket (intet valg nødvendigt)",
  "DESCRIPTION_HIGHLIGHT_MATCHES_WORDS_ONLY": "Fremhæv kun, når markeringen er et komplet token",
  "DESCRIPTION_INSERT_HINT_ON_TAB": "true at indsætte den aktuelt valgte kode hint på fanebladet",
  "DESCRIPTION_NO_HINTS_ON_DOT": "sandt at ikke automatisk vise JS kode hints, når. er skrevet",
  "DESCRIPTION_JSLINT_OPTIONS": "Et objekt med standardindstillingerne for JSLint",
  "DESCRIPTION_JSLINT_OPTIONS_ASS": "sandt at tillade tildelingsudtryk",
  "DESCRIPTION_JSLINT_OPTIONS_BITWISE": "sandt at tillade bitvise operatører",
  "DESCRIPTION_JSLINT_OPTIONS_BROWSER": "sandt, hvis standard browser globals bør være foruddefineret",
  "DESCRIPTION_JSLINT_OPTIONS_CLOSURE": "sandt at tillade Google Closure idiomer",
  "DESCRIPTION_JSLINT_OPTIONS_CONTINUE": "sandt at tillade „fortsæt“ erklæring",
  "DESCRIPTION_JSLINT_OPTIONS_COUCH": "sandt, hvis CouchDB globals bør være foruddefineret",
  "DESCRIPTION_JSLINT_OPTIONS_DEBUG": "sandt at tillade debugger udsagn",
  "DESCRIPTION_JSLINT_OPTIONS_DEVEL": "sandt, hvis browser globals nyttige i udvikling bør være foruddefineret",
  "DESCRIPTION_JSLINT_OPTIONS_EQEQ": "sandt at tillade == og! =",
  "DESCRIPTION_JSLINT_OPTIONS_ES6": "sandt, hvis ES6 globals bør være foruddefineret",
  "DESCRIPTION_JSLINT_OPTIONS_EVIL": "sandt at tillade eval",
  "DESCRIPTION_JSLINT_OPTIONS_FORIN": "sandt at tillade ufiltreret „for... i“",
  "DESCRIPTION_JSLINT_OPTIONS_INDENT": "Indstil en bestemt tabulatorbredde",
  "DESCRIPTION_JSLINT_OPTIONS_MAXERR": "Det maksimale antal indberettede advarsler",
  "DESCRIPTION_JSLINT_OPTIONS_MAXLEN": "Det maksimale antal tegn på en linje",
  "DESCRIPTION_JSLINT_OPTIONS_NEWCAP": "sandt at tillade ukapitaliserede konstruktører",
  "DESCRIPTION_JSLINT_OPTIONS_NODE": "sandt, hvis Node.js globals bør være foruddefineret",
  "DESCRIPTION_JSLINT_OPTIONS_NOMEN": "true at tillade dinglende understregning i identifikatorer",
  "DESCRIPTION_JSLINT_OPTIONS_PASSFAIL": "sandt at stoppe ved første fejl",
  "DESCRIPTION_JSLINT_OPTIONS_PLUSPLUS": "sandt at tillade ++ og -",
  "DESCRIPTION_JSLINT_OPTIONS_REGEXP": "sandt at tillade. og [^...]. i RegExp",
  "DESCRIPTION_JSLINT_OPTIONS_RHINO": "sandt, hvis Rhino globals bør være foruddefineret",
  "DESCRIPTION_JSLINT_OPTIONS_SLOPPY": "sandt at tillade manglende `brug streng` pragma",
  "DESCRIPTION_JSLINT_OPTIONS_STUPID": "true, hvis der kan anvendes blokeringsmetoder (“... Sync „).",
  "DESCRIPTION_JSLINT_OPTIONS_SUB": "sandt at tillade ineffektiv abonnement",
  "DESCRIPTION_JSLINT_OPTIONS_TODO": "sandt at tillade TODO kommentarer",
  "DESCRIPTION_JSLINT_OPTIONS_UNPARAM": "sandt at tillade ubrugte parametre",
  "DESCRIPTION_JSLINT_OPTIONS_VARS": "sand til at tillade mere end 1 vars i en funktion",
  "DESCRIPTION_JSLINT_OPTIONS_WHITE": "sandt at ignorere regler for hvidt rum",
  ...
  "DESCRIPTION_LINEWISE_COPY_CUT": "Hvis du kopierer og klipper, når der ikke er noget valg, kopieres eller klippes de hele linjer, der har markører i dem",
  "DESCRIPTION_INPUT_STYLE": "Vælger den måde, CodeMirror håndterer input og fokus på. Det kan være textarea, som er standard, eller contenteditable, hvilket er bedre for skærmlæsere (ustabil)",
  "DESCRIPTION_LINTING_ENABLED": "sandt at muliggøre kodeinspektion",
  ...
  "DESCRIPTION_LIVE_DEV_MULTIBROWSER": "sandt at aktivere eksperimentel Live Preview",
  "DESCRIPTION_USE_PREFERED_ONLY": "sandt at køre udbydere, der er angivet i linting.prefer kun",
  "DESCRIPTION_MAX_CODE_HINTS": "Maksimal kode hints vises på én gang",
  "DESCRIPTION_PATH": "Sti specifikke indstillinger",
  "DESCRIPTION_PROXY": "URL'en til den proxyserver, der bruges til udvidelsesinstallation",
  "DESCRIPTION_SCROLL_PAST_END": "true for at gøre det muligt at rulle ud over slutningen af dokumentet",
  "DESCRIPTION_SHOW_CODE_HINTS": "false at deaktivere alle kode hints",
  "DESCRIPTION_SHOW_CURSOR_WHEN_SELECTING": "Holder den blinkende markør synlig, når du har en tekstmarkering",
  "DESCRIPTION_SHOW_LINE_NUMBERS": "sandt at vise linjenumre i en „tagrende“ til venstre for koden",
  "DESCRIPTION_SMART_INDENT": "Indryk automatisk, når du opretter en ny blok",
  "DESCRIPTION_SOFT_TABS": "false at deaktivere bløde faner adfærd",
  "DESCRIPTION_SORT_DIRECTORIES_FIRST": "sandt at sortere mapperne først i projekttræet",
  "DESCRIPTION_SPACE_UNITS": "Antal mellemrum, der skal bruges til rumbaseret indrykning",
  "DESCRIPTION_STATIC_SERVER_PORT": "Portnummer, som den indbyggede server skal bruge til Live Preview",
  "DESCRIPTION_STYLE_ACTIVE_LINE": "sandt at fremhæve baggrundsfarven på linjen markøren er på",
  "DESCRIPTION_TAB_SIZE": "Antal mellemrum, der skal vises for faner",
  "DESCRIPTION_USE_TAB_CHAR": "sandt at bruge faner i stedet for mellemrum",
  "DESCRIPTION_UPPERCASE_COLORS": "sandt at generere store bogstaver hex-farver i Inline Color Editor",
  "DESCRIPTION_WORD_WRAP": "Ombrydning af linjer, der overskrider vinduets bredde",
  "DESCRIPTION_SEARCH_AUTOHIDE": "Luk søgningen, så snart redaktøren er fokuseret",
  "DESCRIPTION_DETECTED_EXCLUSIONS": "En liste over filer, der er blevet opdaget at forårsage Tern at løbe tør for kontrol",
  "DESCRIPTION_INFERENCE_TIMEOUT": "Mængden af tid, hvorefter Tern vil timeout, når de forsøger at forstå filer",
  "DESCRIPTION_SHOW_ERRORS_IN_STATUS_BAR": "sandt at vise fejl i statuslinjen",
  "DESCRIPTION_QUICK_VIEW_ENABLED": "sandt at aktivere Quick View",
  "DESCRIPTION_EXTENSION_LESS_IMAGE_PREVIEW": "true til at vise billedeksempler for URL'er manglende udvidelser",
  "DESCRIPTION_THEME": "Vælg et {APP_NAME} tema",
  "DESCRIPTION_USE_THEME_SCROLLBARS": "sandt at tillade brugerdefinerede rullepaneler",
  "DESCRIPTION_LINTING_COLLAPSED": "sandt at kollapse fnug panel",
  "DESCRIPTION_FONT_FAMILY": "Skift skrifttypefamilie",
  "DESCRIPTION_FONT_SIZE": "Skift skriftstørrelse, f.eks. 13px",
  "DESCRIPTION_FIND_IN_FILES_NODE": "sandt at aktivere node baseret søgning",
  "DESCRIPTION_FIND_IN_FILES_INSTANT": "sandt at aktivere øjeblikkelig søgning",
  "DESCRIPTION_FONT_SMOOTHING": "Kun Mac: „subpixel-antialiased“ for at muliggøre antialiasing under pixel eller „antialiaseret“ til antialiasing i gråskala",
  "DESCRIPTION_OPEN_PREFS_IN_SPLIT_VIEW": "falsk at deaktivere åbning præferencer fil i split view",
  "DESCRIPTION_OPEN_USER_PREFS_IN_SECOND_PANE": "false at åbne brugerindstillinger fil i venstre/øverste rude",
  "DESCRIPTION_MERGE_PANES_WHEN_LAST_FILE_CLOSED": "sandt at kollapse ruder efter den sidste fil fra ruden er lukket via rude header luk knap",
  "DESCRIPTION_SHOW_PANE_HEADER_BUTTONS": "Slå til, hvornår knapperne Luk og flip-view skal vises på overskriften.",
  "DEFAULT_PREFERENCES_JSON_HEADER_COMMENT": "/*\n * Dette er en skrivebeskyttet fil med de understøttede præferencer\n * ved {APP_NAME}.\n * Brug denne fil som reference til at ændre dine præferencer\n * fil „brackets.json“ åbnet i den anden rude.\n * For mere information om, hvordan du bruger præferencer inde\n * {APP_NAME}, se websiden på https://github.com/adobe/brackets/wiki/How-to-Use-Brackets#preferences\n */",
  "DEFAULT_PREFERENCES_JSON_DEFAULT": "Standard",
  "DESCRIPTION_PURE_CODING_SURFACE": "sandt at aktivere kode kun tilstand og skjule alle andre UI elementer i {APP_NAME}",
  "DESCRIPTION_INDENT_LINE_COMMENT": "sandt at muliggøre indrykning af linje kommentarer",
  "DESCRIPTION_RECENT_FILES_NAV": "Aktiver/deaktiver navigation i seneste filer",
  "DESCRIPTION_LIVEDEV_WEBSOCKET_PORT": "Port, hvor WebSocket Server kører til Live Preview",
  "DESCRIPTION_LIVE_DEV_HIGHLIGHT_SETTINGS": "Live Preview Fremhæv indstillinger",
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "falsk at deaktivere levende forhåndsvisning omvendt inspicere",
  "DOWNLOAD_FAILED": "Download mislykkedes.",
  "DOWNLOAD_COMPLETE": "Download komplet!",
  ...
  "CLICK_RESTART_TO_UPDATE": "Klik på Genstart for at opdatere parentes.",
  ...
  "UPDATEDIR_CLEAN_FAILED": "Opdateringsmappen kunne ikke rengøres.",
  "INITIAL_DOWNLOAD": "Downloader opdatering...",
  "RETRY_DOWNLOAD": "Download mislykkedes. Forsøger igen... Forsøg ",
  "VALIDATING_INSTALLER": "Download komplet! Validerer installationsprogram...",
  "CHECKSUM_DID_NOT_MATCH": "Checksum matchede ikke.",
  ...
  "LATER_BUTTON": "Senere",
  "DESCRIPTION_AUTO_UPDATE": "Aktiver/deaktiver Beslag Auto-opdatering",
  ...
  "PHP_VERSION_INVALID": "Fejl ved parsing af PHP-version. Kontroller output fra kommandoen „php —version“.",
  "PHP_UNSUPPORTED_VERSION": "Installer PHP7 runtime for at aktivere PHP-relateret værktøj såsom kodetips, Parametertip, Gå til definition og mere. Version fundet: {0}",
  "PHP_EXECUTABLE_NOT_FOUND": "PHP runtime ikke fundet. Installer PHP7 runtime og opdater „ExecutablePath“ i PHP-præferencer korrekt. Dette muliggør PHP-relateret værktøj såsom kodetips, Parametertips, Jump To Definition og mere.",
  "PHP_PROCESS_SPAWN_ERROR": "Fejlkode {0} opstod under start af PHP-processen.",
  "PHP_SERVER_ERROR_TITLE": "Fejl",
  "PHP_SERVER_MEMORY_LIMIT_INVALID": "Den hukommelsesgrænse, du har angivet, er ugyldig. Gennemgå PHP-indstillingerne for at indstille den korrekte værdi.",
  ...
  "REFERENCES_NO_RESULTS": "Der er ingen referencer til rådighed for den aktuelle markørposition",
  ...
  "DESCRIPTION_EXTERNAL_APPLICATION_ASSOCIATE": "Kortlægninger til filtypenavn til eksterne applikationer. Syntaks: \"<file_type>„: „<Default|ApplicationName|ApplicationPath>“, Brug „default“ til at åbne filer i systemets standardprogram for filtypen.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "Åbn grafikfiler i eksterne redaktører.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "Din nuværende mappe har grafiske filtyper, som ikke understøttes af {APP_NAME}. <br/>Dukan nu knytte bestemte filtyper til eksterne redaktører. Når du er tilknyttet, kan du åbne grafiske filer som.xd, .psd, .jpg, .png, .ai, .svg i deres standardprogrammer ved at dobbeltklikke på filerne i File Tree. <br/><br/>Klikvenligst på 'Ok' knappen for at knytte de grafiske filtyper til deres respektive standardprogrammer.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Følgende filtyper er blevet forbundet med standardprogrammer. <br/>{0} Du har mulighed for at ændre dine præferencer for, om du sletter/tilføjer nye filtypeforeninger i brackets.json ved at gå til menuen „Fejlfind-> Åbn indstillingsfil“.",
  "UNSUPPORTED_BROWSER": "Browser understøttes ikke",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Browser understøtter ikke Åbn mappe",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Brug en af de understøttede browsere nedenfor.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Vi arbejder hårdt på at gøre Phoenix tilgængelig i flere browsere. Du kan lukke denne dialog, men nogle funktioner i Phoenix fungerer ikke i denne browser.",
  ...
  "PUBLISH": "Udgiv",
  "PUBLISH_CONSENT_MESSAGE": "Forhåndsvis hurtigt ændringer, og del dit websted med andre. Phoenix kan offentliggøre dette websted for dig på {0}. De offentliggjorte links er gyldige i en periode på 7 dage. </br>Ønskerdu at udgive og dele din hjemmeside?",
  "PUBLISH_SYNC_IN_PROGRESS": "Synkronisering i gang til forhåndsvisning...",
  "PUBLISH_PAGE": "Klik for at offentliggøre og dele dette websted",
  "PUBLISH_VIEW_PAGE": "Klik for at se publiceret side",
  "MISSING_FIELDS": "Manglende felter",
  "PLEASE_FILL_ALL_REQUIRED": "Udfyld alle obligatoriske felter fremhævet med rødt",
  "CODE_EDITOR": "Kode Editor",
  "BUILD_THE_WEB": "Byg internettet",
  "IMPORT_PROJECT": "Importér projekt",
  ...
  "DOWNLOAD_FAILED_MESSAGE": "Sørg for, at download-URL'en er gyldig. </br>NB: Da Phoenix er i alpha, Private Repos og Github URL'er større end 25 MB er ikke tilladt.",
  "PLEASE_SELECT_A_FOLDER": "Vælg en mappe...",
  "UNZIP_IN_PROGRESS": "Udpakning af filer...",
  "UNZIP_FAILED": "Fejl: Udpakning mislykkedes.",
  "CONFIRM_REPLACE_TITLE": "Bekræft Udskift",
  "KEEP_BOTH": "Behold begge",
  "EXPLORE": "HTML Spil",
  "BLOG": "Blog",
  "PHOENIX_DEFAULT_PROJECT": "Standard Projekt",
  ...
  "WEBPAGE_HOME_PAGE": "Hjem sidelayout",
  "WEBPAGE_BLOG": "Blog Side",
  "WEBPAGE_DASHBOARD": "HTML-instrumentbræt",
