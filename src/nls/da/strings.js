...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "<code>package.json</code> filen blev ikke fundet i det aktuelle projekt. Er det aktuelle projekt en gyldig {APP_NAME}-udvidelse?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "<code>package.json</code> filen er ugyldig JSON.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "Påkrævede felter mangler i <code>package.json</code> : [{0}]",
  ...
  "PUBLISH_CONSENT_MESSAGE": "Se hurtigt et eksempel på ændringer og del dit websted med andre. Phoenix kan udgive denne hjemmeside for dig på {0}. De offentliggjorte links vil være gyldige i en periode på 7 dage. </br>Ønsker du at udgive og dele dit websted?",
