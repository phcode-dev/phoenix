...
define({
  ...
  "WEBPAGE_HOME_PAGE": "Hjemmesidelayouts",
  "WEBPAGE_BLOG": "Blog side",
  "WEBPAGE_DASHBOARD": "HTML Dashboard",
  "WEBPAGE_BOOTSTRAP_EXAMPLES": "Eksempler på bootstrap",
  "GUIDED_FILES_SIDEBAR": "Vælg en HTML-fil</br> <a href='#' style='float:right;'>Okay</a>",
  "GUIDED_LIVE_PREVIEW": "Foretag nogle kodeændringer, og gem filen for at se forhåndsvisningen.</br> <a href='#' style='float:right;'>Okay</a>",
