...
define({
  ...
  "DETECTED_EXCLUSION_INFO": "{APP_NAME} løb ind i problemer med at behandle <span class='dialog-filename'>{0}</span> .<br><br> Denne fil vil ikke længere blive behandlet for kodetip, Jump to Definition eller Quick Edit. For at genaktivere denne fil skal du åbne <code>.brackets.json</code> i dit projekt og redigere <code>jscodehints.detectedExclusions</code> .<br><br> Dette er sandsynligvis en fejl i {APP_NAME}. Hvis du kan levere en kopi af denne fil, bedes du <a href='https://github.com/adobe/brackets/wiki/How-to-Report-an-Issue'>indsende en fejl</a> med et link til filen, der er navngivet her.",
  ...
  "DESCRIPTION_LIVEDEV_SECURITY": "Sikkerhedsadvarsel fra phcode.dev<br><br> Denne live forhåndsvisning forsøgte at få adgang til en ikke-projektfil. Adgang blev nægtet af hensyn til din sikkerhed. Vær forsigtig, når du arbejder på upålidelige projekter.",
  ...
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Følgende filtyper er blevet knyttet til standardapplikationer.<br/> {0} Du har mulighed for at ændre din præference for, om du sletter/tilføjer nye filtypetilknytninger i brackets.json ved at gå til menuen &quot;Fejlfinding-&gt;Åbn præferencefil&quot;.",
  ...
  "VIEW_MORE": "Se mere...",
  "NEW_PROJECT_NOTIFICATION": "Klik på dette ikon for at oprette et nyt projekt.</br><img src=\"extensions/default/Phoenix/images/new_project.png\"><br/> <a href='#' style='float:right;'>Okay</a>",
  "BEAUTIFY_CODE_NOTIFICATION": "Klik her eller tryk på <b>`{0}`</b> for at forskønne koden.</br><img src=\"extensions/default/Phoenix/images/beautify.gif\"><br/> <a href='#' style='float:right;'>Okay</a>",
