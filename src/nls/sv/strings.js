...
define({
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME} <strong>samlar inte in eller behandlar någon personligt identifierbar information,</strong> men <strong>samlar in anonym användningsstatistik</strong> för att skydda din integritet. Anonyma uppgifter är undantagna från GDPR/CCPA-aviseringskrav, men vi tror att du måste ha ett val att välja bort anonym datainsamling väl.<br> Dessa <strong>anonyma</strong> appanvändningsstatistik och felrapporter hjälper dig att prioritera funktioner, hitta buggar och upptäcka användbarhetsproblem för din upplevelse av {APP_NAME}.</p><p> Nedan finns en förhandsgranskning av data som kommer att skickas i din nästa hälsorapport <em>om</em> den är aktiverad. (Se även utvecklarkonsolen för felloggar märkta &quot;Fångat kritiskt fel&quot;.)</p>",
  ...
  "VIEW_MORE": "Visa mer...",
  "NEW_PROJECT_NOTIFICATION": "Klicka på den här ikonen för att skapa ett nytt projekt.</br><img src=\"styles/images/new_project.png\"><br/> <a href='#' style='float:right;'>ok</a>",
