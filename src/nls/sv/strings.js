...
define({
  ...
  "CMD_ENABLE_SELECTION_VIEW": "Vyn Urval",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "Ett objekt med standardalternativen för JShint. Se följande webbadress för alla tillgängliga JSHint-alternativ: https://jshint.com/docs/options/",
  ...
  "DESCRIPTION_SELECTION_VIEW_ENABLED": "true för att aktivera markeringsvy",
  ...
  "EXTRACTING_FILES_PROGRESS": "Extrahera {0} av {1} -filer.",
  ...
  "BEAUTIFY_ERROR": "Kunde inte försköna kod. Kontrollera syntax.",
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Kunde inte försköna. Redaktörens text ändrades efter försköning.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Försköna fil {0}",
  "BEAUTIFY_ERROR_SELECTION": "Kunde inte försköna. </br>Ofullständigkodblock vald eller ogiltig syntax.",
  "BEAUTIFY_OPTIONS": "Alternativ som styr hur Beautify Code fungerar",
  "BEAUTIFY_OPTION_PRINT_WIDTH": "Ange linjelängden som förskönaren ska slå på",
  "BEAUTIFY_OPTION_SEMICOLON": "Lägg till ett semikolon i slutet av varje programsats",
  "BEAUTIFY_OPTION_SINGLE_QUOTE": "Använd enkla citat istället för dubbla citattecken",
  "BEAUTIFY_OPTION_QUOTE_PROPS": "Ändra när egenskaper i objekt citeras",
  "BEAUTIFY_OPTION_BRACKET_SAME_LINE": "Sätt > av ett flerradigt HTML-element (HTML, JSX, Vue, Angular) i slutet av den sista raden istället för att vara ensam på nästa rad (gäller inte självstängande element)",
  "BEAUTIFY_OPTION_SINGLE_ATTRIBUTE_PER_LINE": "Tvinga enstaka attribut per rad i HTML, Vue och JSX",
  "BEAUTIFY_OPTION_PROSE_WRAP": "Wrap prosa om den överskrider utskriftsbredden i markdown-filer",
  "BEAUTIFY_OPTION_PRINT_TRAILING_COMMAS": "Skriv ut efterföljande kommatecken när det är möjligt i syntaktiska strukturer med flera rader med kommaavgränsade"
});