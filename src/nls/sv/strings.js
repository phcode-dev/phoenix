...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "<code>package.json</code> filen upptäcktes inte i det aktuella projektet. Är det aktuella projektet ett giltigt {APP_NAME}-tillägg?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "<code>package.json</code> filen är ogiltig JSON.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "Obligatoriska fält saknas i <code>package.json</code> : [{0}]",
