...
define({
  ...
  "UPDATE_CLOSE_TO_UPDATE_TITLE": "Kan inte uppdatera",
  "UPDATE_CLOSE_TO_UPDATE": "Flera redigeringsfönster är öppna. Se till att alla andra {APP_NAME} Editor-fönster är stängda innan du försöker uppdatera. Stäng eventuella ytterligare {APP_NAME}-fönster och försök uppdatera igen.",
