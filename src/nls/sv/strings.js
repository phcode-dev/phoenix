...
define({
  ...
  "UPDATE_READY_RESTART_MESSAGE": "Stäng alla {APP_NAME}-fönster och starta om appen för att starta den uppdaterade versionen.",
  "UPDATE_FAILED_TITLE": "Uppdateringen misslyckades",
  "UPDATE_FAILED_MESSAGE": "Stäng alla {APP_NAME}-fönster och öppna appen igen för att försöka uppdatera igen.",
