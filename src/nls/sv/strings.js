...
define({
  ...
  "INCLUDE_FILE_FILTER": "Inkludera {0}",
  "EXCLUDE_FILE_FILTER_DROPDOWN": "Utesluta",
  "INCLUDE_FILE_FILTER_DROPDOWN": "Omfatta",
  "EDIT_FILE_FILTER": "Redigera…",
  "FILE_FILTER_DIALOG": "Redigera uteslutningsfilter",
  "FILE_FILTER_INSTRUCTIONS": "Uteslut filer och mappar som matchar något av följande <a href='{0}' title=\"{0}\">ignorera jokertecken</a> . Ange varje sträng på en ny rad. T.ex<ul><li> <code>*.js</code> matchar <code>a/b/x.js</code> , <code>xyx.js</code> , etc..</li><li> <code>./*.css</code> matchar bara <code>x.css</code> i projektroten, men inte <code>y/x.css</code> i undermappen.</li></ul>",
  "FILE_FILTER_INSTRUCTIONS_INCLUDE": "Inkludera endast filer och mappar som matchar något av följande <a href='{0}' title=\"{0}\">ignorera jokertecken</a> . Ange varje sträng på en ny rad. T.ex<ul><li> <code>*.js</code> matchar <code>a/b/x.js</code> , <code>xyx.js</code> , etc..</li><li> <code>./*.css</code> matchar bara <code>x.css</code> i projektroten, men inte <code>y/x.css</code> i undermappen.</li></ul>",
  ...
  "UPDATE_UP_TO_DATE": "Din version av {APP_NAME} är den senaste och bästa!",
  ...
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>Safari tar automatiskt bort webbplatsdata om en webbplats inte besöks igen inom 7 dagar. {APP_NAME} förlitar sig på webbläsarlagring för att spara dina projekt, som kan tas bort på grund av denna policy.<br/><br/> <strong>För att förhindra dataförlust</strong> , <strong>ladda ner</strong> dina projekt innan du stänger fliken eller håll utkik efter våra <strong>kommande webb- och inbyggda Mac/iOS-appar.</strong></span>",
