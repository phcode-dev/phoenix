...
define({
  ...
  "ERROR_MOVING_FILE_TITLE": "Fel vid flyttning av {0}",
  "ERROR_MOVING_FILE": "Ett fel uppstod vid försök att flytta {2} <span class='dialog-filename'>{0}</span>. {1}",
  "ERROR_MOVING_NOT_IN_PROJECT": "Det går inte att flytta filen/mappen, eftersom de inte ingår i det aktuella projektet.",
  ...
  "ERR_TYPE_PASTE_FAILED": "Ett fel uppstod när du klistrade in <span class='dialog-filename'>{0}</span> till <span class='dialog-filename'>{1}</span>",
  ...
  "LIVE_DEV_SELECT_FILE_TO_PREVIEW": "Välj fil till direktförhandsvisning",
  "LIVE_DEV_CLICK_TO_RELOAD_PAGE": "Ladda om sida",
  ...
  "CMD_THEMES": "Teman…",
  "CMD_TOGGLE_SEARCH_AUTOHIDE": "Stäng sökningen automatiskt",
  "NAVIGATE_MENU": "Navigera",
  "CMD_QUICK_OPEN": "Snabböppna",
  "CMD_GOTO_LINE": "Gå till rad",
  "CMD_GOTO_DEFINITION": "Gå till definition",
  "CMD_GOTO_DEFINITION_PROJECT": "Snabbsökning Definition i Project",
  ...
  "PRERELEASE_BUILD": "prerelease bygga",
  ...
  "ABOUT_TEXT_BUILD_TIMESTAMP": "bygga tidsstämpel: ",
  "ABOUT_TEXT_LINE3": "Tredjepartsbibliotek som vi använder - <a href='https://github.com/phcode-dev/phoenix/tree/main/src/thirdparty/licences'> Licenser och attributioner</a> . ",
  ...
  "ABOUT_TEXT_LINE6": "Massor av människor (men vi har problem med att ladda den informationen just nu).",
  ...
  "CMD_EXTRACTTO_VARIABLE": "Utdrag till variabel",
  "CMD_EXTRACTTO_FUNCTION": "Extrahera till funktion",
  "ERROR_TERN_FAILED": "Det gick inte att hämta data från Tern",
  "ERROR_EXTRACTTO_VARIABLE_NOT_VALID": "Markering bildar inte ett uttryck",
  "ERROR_EXTRACTTO_FUNCTION_NOT_VALID": "Markerat block ska representera en uppsättning satser eller ett uttryck",
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "Extrahera till variabel fungerar inte i multikursorer",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "Extrahera till funktion fungerar inte i multikursorer",
  "EXTRACTTO_FUNCTION_SELECT_SCOPE": "Välj destination omfattning",
  "EXTRACTTO_VARIABLE_SELECT_EXPRESSION": "Markera ett uttryck",
  "CMD_REFACTORING_RENAME": "Byt namn",
  "CMD_REFACTORING_TRY_CATCH": "Wrap i Prova Catch",
  "CMD_REFACTORING_CONDITION": "Wrap i skick",
  "CMD_REFACTORING_GETTERS_SETTERS": "Skapa Getters/Setters",
  "CMD_REFACTORING_ARROW_FUNCTION": "Konvertera till pilfunktion",
  "DESCRIPTION_CODE_REFACTORING": "Aktivera/inaktivera JavaScript-kod Refactoring",
  "ERROR_TRY_CATCH": "Välj giltig kod som ska brytas in i ett Try-catch-block",
  "ERROR_WRAP_IN_CONDITION": "Välj giltig kod som ska brytas in i ett villkorsblock",
  "ERROR_ARROW_FUNCTION": "Placera markören i ett funktionsuttryck",
  "ERROR_GETTERS_SETTERS": "Placera markören vid en medlem av ett objektuttryck",
  "ERROR_RENAME_MULTICURSOR": "Kan inte byta namn när du använder flermarkörer",
  "ERROR_RENAME_QUICKEDIT": "Det går inte att byta namn på denna identifierare, eftersom den refereras någon annanstans utanför den här funktionen",
  ...
  "DESCRIPTION_CLOSE_OTHERS_ABOVE": "falskt att ta bort ”Stäng andra ovan” från arbetsfiler snabbmenyn",
  "DESCRIPTION_CLOSE_OTHERS_BELOW": "false att ta bort ”Stäng andra nedan” från arbetsfiler snabbmenyn",
  "DESCRIPTION_CLOSE_OTHERS": "false för att ta bort ”Stäng andra” från arbetsfiler snabbmenyn",
  "DESCRIPTION_CLOSE_TAGS": "Anger stängningsalternativ för taggen",
  "DESCRIPTION_CLOSE_TAGS_DONT_CLOSE_TAGS": "En array med taggar som inte ska stängas automatiskt",
  "DESCRIPTION_CLOSE_TAGS_WHEN_OPENING": "Stäng när > av öppningstaggen skrivs",
  "DESCRIPTION_CLOSE_TAGS_WHEN_CLOSING": "Stäng när/av avslutande tagg skrivs",
  "DESCRIPTION_CLOSE_TAGS_INDENT_TAGS": "En array med taggar som när den öppnas har en tom rad",
  "DESCRIPTION_CODE_FOLDING_ALWAY_USE_INDENT_FOLD": "sant att alltid generera hopfällbara sektionsmarkörer när strecksatsen nivå ändras",
  "DESCRIPTION_CODE_FOLDING_ENABLED": "sant för att möjliggöra kodvikning",
  "DESCRIPTION_CODE_FOLDING_HIDE_UNTIL_MOUSEOVER": "sant att göra sektionskollapsande markörer synliga endast när du flyttar musen över rännan",
  "DESCRIPTION_CODE_FOLDING_MAX_FOLD_LEVEL": "Begränsar hur många nivåer djupt Dölj alla gäller",
  ...
  "DESCRIPTION_CODE_FOLDING_MAKE_SELECTIONS_FOLDABLE": "sant för att aktivera kodvikning på markerad text i redigeraren",
  ...
  "DESCRIPTION_JS_HINTS_TYPE_DETAILS": "Aktivera/inaktivera uppgifter om datatyp i JavaScript-kodtips",
  "DESCRIPTION_PREF_HINTS": "Aktivera/inaktivera Inställningar kodtips",
  ...
  "DESCRIPTION_DRAG_DROP_TEXT": "Aktivera/inaktivera dra och släpp-funktionalitet",
  "DESCRIPTION_HEALTH_DATA_TRACKING": "Aktivera spårning av hälsodata",
  "DESCRIPTION_HIGHLIGHT_MATCHES": "Aktiverar automatisk markering av matchande strängar i hela dokumentet",
  "DESCRIPTION_HIGHLIGHT_MATCHES_SHOW_TOKEN": "Markera alla strängar som matchar den token som markören för närvarande befinner sig i (inget val behövs)",
  "DESCRIPTION_HIGHLIGHT_MATCHES_WORDS_ONLY": "Markera endast när markeringen är en komplett token",
  "DESCRIPTION_INSERT_HINT_ON_TAB": "true för att infoga det markerade kodtipset på fliken",
  "DESCRIPTION_NO_HINTS_ON_DOT": "sant att inte automatiskt visa JS-kodtips när. skrivs",
  "DESCRIPTION_JSLINT_OPTIONS": "Ett objekt med standardalternativen för JSlint",
  "DESCRIPTION_JSLINT_OPTIONS_ASS": "sant för att tillåta tilldelningsuttryck",
  "DESCRIPTION_JSLINT_OPTIONS_BITWISE": "true för att tillåta bitvisa operatorer",
  "DESCRIPTION_JSLINT_OPTIONS_BROWSER": "true om standard browser globals bör fördefinieras",
  "DESCRIPTION_JSLINT_OPTIONS_CLOSURE": "sant att tillåta Google Closure idiom",
  "DESCRIPTION_JSLINT_OPTIONS_CONTINUE": "sant att tillåta ”fortsätt” uttalande",
  "DESCRIPTION_JSLINT_OPTIONS_COUCH": "sant om CouchDB-globals bör fördefinieras",
  "DESCRIPTION_JSLINT_OPTIONS_DEBUG": "sant för att tillåta felsökningssatser",
  "DESCRIPTION_JSLINT_OPTIONS_DEVEL": "sant om webbläsare globals användbara i utvecklingen bör fördefinieras",
  "DESCRIPTION_JSLINT_OPTIONS_EQEQ": "sant att tillåta == och! =",
  "DESCRIPTION_JSLINT_OPTIONS_ES6": "sant om ES6 globals bör vara fördefinierade",
  "DESCRIPTION_JSLINT_OPTIONS_EVIL": "sant att tillåta eval",
  "DESCRIPTION_JSLINT_OPTIONS_FORIN": "sant att tillåta ofiltrerad ”för... in”",
  "DESCRIPTION_JSLINT_OPTIONS_INDENT": "Ange en specifik flikbredd",
  "DESCRIPTION_JSLINT_OPTIONS_MAXERR": "Maximalt antal rapporterade varningar",
  "DESCRIPTION_JSLINT_OPTIONS_MAXLEN": "Maximalt antal tecken på en rad",
  "DESCRIPTION_JSLINT_OPTIONS_NEWCAP": "sant att tillåta okapitaliserade konstruktörer",
  "DESCRIPTION_JSLINT_OPTIONS_NODE": "true om Node.js globals bör fördefinieras",
  "DESCRIPTION_JSLINT_OPTIONS_NOMEN": "sant att tillåta dinglande understreck i identifierare",
  "DESCRIPTION_JSLINT_OPTIONS_PASSFAIL": "sant att stoppa vid första felet",
  "DESCRIPTION_JSLINT_OPTIONS_PLUSPLUS": "sant att tillåta ++ och -",
  "DESCRIPTION_JSLINT_OPTIONS_REGEXP": "sant att tillåta. och [^...]. i RegExp",
  "DESCRIPTION_JSLINT_OPTIONS_RHINO": "sant om Rhino globals bör fördefinieras",
  "DESCRIPTION_JSLINT_OPTIONS_SLOPPY": "sant att tillåta saknad `använd strikt` pragma",
  "DESCRIPTION_JSLINT_OPTIONS_STUPID": "true om metoder för blockering (”... Sync”) kan användas.",
  "DESCRIPTION_JSLINT_OPTIONS_SUB": "sant för att tillåta ineffektiv prenumeration",
  "DESCRIPTION_JSLINT_OPTIONS_TODO": "sant att tillåta TODO kommentarer",
  "DESCRIPTION_JSLINT_OPTIONS_UNPARAM": "sant för att tillåta oanvända parametrar",
  "DESCRIPTION_JSLINT_OPTIONS_VARS": "sant att tillåta mer än 1 vars i en funktion",
  "DESCRIPTION_JSLINT_OPTIONS_WHITE": "sant att ignorera regler för blanktecken",
  ...
  "DESCRIPTION_LINEWISE_COPY_CUT": "Att kopiera och klippa ut när det inte finns något val kommer att kopiera eller klippa hela raderna som har markörer i sig",
  "DESCRIPTION_INPUT_STYLE": "Väljer hur CodeMirror hanterar indata och fokus. Det kan vara textarea, vilket är standard, eller innehållsredigerbart vilket är bättre för skärmläsare (instabil)",
  "DESCRIPTION_LINTING_ENABLED": "sant för att möjliggöra kodinspektion",
  ...
  "DESCRIPTION_LIVE_DEV_MULTIBROWSER": "sant för att möjliggöra experimentell Live Preview",
  "DESCRIPTION_USE_PREFERED_ONLY": "sant att köra leverantörer som anges i linting.prefer bara",
  "DESCRIPTION_MAX_CODE_HINTS": "Maximala kodtips visas på en gång",
  "DESCRIPTION_PATH": "Sökvägsspecifika inställningar",
  "DESCRIPTION_PROXY": "URL:en för proxyservern som används för tilläggsinstallation",
  "DESCRIPTION_SCROLL_PAST_END": "sant för att möjliggöra rullning efter slutet av dokumentet",
  ...
  "DESCRIPTION_SHOW_LINE_NUMBERS": "sant att visa radnummer i en ”ränna” till vänster om koden",
  "DESCRIPTION_SMART_INDENT": "Indrag automatiskt när du skapar ett nytt block",
  "DESCRIPTION_SOFT_TABS": "false för att stänga av mjuka flikar beteende",
  "DESCRIPTION_SORT_DIRECTORIES_FIRST": "sant att sortera katalogerna först i projektträdet",
  "DESCRIPTION_SPACE_UNITS": "Antal blanksteg som ska användas för utrymmesbaserad indrag",
  "DESCRIPTION_STATIC_SERVER_PORT": "Portnummer som den inbyggda servern ska använda för Live Preview",
  "DESCRIPTION_STYLE_ACTIVE_LINE": "sant för att markera bakgrundsfärgen på linjen markören är på",
  "DESCRIPTION_TAB_SIZE": "Antal mellanslag som ska visas för flikar",
  "DESCRIPTION_USE_TAB_CHAR": "sant att använda flikar istället för mellanslag",
  "DESCRIPTION_UPPERCASE_COLORS": "sant att generera versaler hexfärger i Inline Color Editor",
  "DESCRIPTION_WORD_WRAP": "Radbrytningslinjer som överskrider fönstrets bredd",
  "DESCRIPTION_SEARCH_AUTOHIDE": "Stäng sökningen så snart redaktören är fokuserad",
  "DESCRIPTION_DETECTED_EXCLUSIONS": "En lista över filer som har upptäckts för att få Tern att ta slut på kontroll",
  "DESCRIPTION_INFERENCE_TIMEOUT": "Mängden tid efter vilken Tern kommer att ta slut när du försöker förstå filer",
  "DESCRIPTION_SHOW_ERRORS_IN_STATUS_BAR": "sant att visa fel i statusfältet",
  "DESCRIPTION_QUICK_VIEW_ENABLED": "sant för att aktivera Quick View",
  "DESCRIPTION_EXTENSION_LESS_IMAGE_PREVIEW": "true för att visa förhandsgranskningar av bilder för webbadresser som saknas tillägg",
  "DESCRIPTION_THEME": "Välj ett {APP_NAME} -tema",
  "DESCRIPTION_USE_THEME_SCROLLBARS": "sant att tillåta anpassade rullningslister",
  "DESCRIPTION_LINTING_COLLAPSED": "sant att kollapsa linting panel",
  ...
  "DESCRIPTION_FONT_SMOOTHING": "Endast Mac: ”subpixel-kantutjämning” för att aktivera kantutjämning av underpixlar eller ”kantutjämning” för kantutjämning av gråskala",
  "DESCRIPTION_OPEN_PREFS_IN_SPLIT_VIEW": "false för att inaktivera öppna inställningsfilen i delad vy",
  "DESCRIPTION_OPEN_USER_PREFS_IN_SECOND_PANE": "false för att öppna användarinställningsfilen i vänster/övre rutan",
  "DESCRIPTION_MERGE_PANES_WHEN_LAST_FILE_CLOSED": "sant att komprimera rutor efter den sista filen från rutan stängs via rutan header stängningsknapp",
  "DESCRIPTION_SHOW_PANE_HEADER_BUTTONS": "Växla när stängnings- och flip-view-knapparna ska visas i rubriken.",
  "DEFAULT_PREFERENCES_JSON_HEADER_COMMENT": "/*\n * Detta är en skrivskyddad fil med inställningarna som stöds\n * av {APP_NAME}.\n * Använd den här filen som referens för att ändra dina inställningar\n * file ”brackets.json” öppnas i den andra rutan.\n * För mer information om hur du använder inställningar inuti\n * {APP_NAME}, se webbsidan på https://github.com/adobe/brackets/wiki/How-to-Use-Brackets#preferences\n */",
  "DEFAULT_PREFERENCES_JSON_DEFAULT": "Standard",
  "DESCRIPTION_PURE_CODING_SURFACE": "sant för att aktivera endast kodläge och dölja alla andra gränssnittselement i {APP_NAME}",
  "DESCRIPTION_INDENT_LINE_COMMENT": "sant för att möjliggöra indentering av radkommentarer",
  "DESCRIPTION_RECENT_FILES_NAV": "Aktivera/inaktivera navigering i senaste filer",
  "DESCRIPTION_LIVEDEV_WEBSOCKET_PORT": "Port som WebSocket Server körs för Live Preview",
  "DESCRIPTION_LIVE_DEV_HIGHLIGHT_SETTINGS": "Live Preview Markera inställningar",
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "falskt att inaktivera förhandsvisning omvänd inspektera",
  "DOWNLOAD_FAILED": "Nedladdning misslyckades.",
  "DOWNLOAD_COMPLETE": "Ladda ner komplett!",
  "UPDATE_SUCCESSFUL": "Uppdateringen lyckades!",
  "UPDATE_FAILED": "Uppdateringen misslyckades!",
  "VALIDATION_FAILED": "Valideringen misslyckades!",
  "INITIALISATION_FAILED": "Initialisering misslyckades!",
  "CLEANUP_FAILED": "Saneringen misslyckades!",
  ...
  "GO_TO_SITE": "Gå till <a href = \"http://brackets.io/ ”> parentess.io </a> för att försöka igen.",
  ...
  "VALIDATING_INSTALLER": "Ladda ner komplett! Validerar installationsprogrammet...",
  "CHECKSUM_DID_NOT_MATCH": "Checksumman matchade inte.",
  ...
  "LATER_BUTTON": "Senare",
  "DESCRIPTION_AUTO_UPDATE": "Aktivera/inaktivera parenteser Automatisk uppdatering",
  ...
  "PHP_VERSION_INVALID": "Fel vid tolkning av PHP-versionen. Kontrollera utmatningen från kommandot ”php —version”.",
  ...
  "PHP_EXECUTABLE_NOT_FOUND": "PHP-körtid hittades inte. Installera PHP7-körningen och uppdatera ”ExecutablePath” i PHP-inställningar på lämpligt sätt. Detta möjliggör PHP-relaterade verktyg som kodtips, parametertips, Hoppa till definition och mer.",
  "PHP_PROCESS_SPAWN_ERROR": "Felkod {0} påträffades vid start av PHP-processen.",
  ...
  "REMOTE_DEBUGGING_PORT_INVALID": "Det går inte att aktivera fjärrfelsökning på port {0}. Portnumren ska ligga mellan {1} och {2}.",
  ...
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "Öppna grafiska filer i externa redigerare.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "Din nuvarande mapp har grafiska filtyper som inte stöds av {APP_NAME}. <br/>Dukan nu koppla specifika filtyper med externa redigerare. När du är associerad kan du öppna grafiska filer som .xd, .psd, .jpg, .png, .ai, .svg i deras standardprogram genom att dubbelklicka på filerna i File Tree. <br/><br/>Klickapå ”Ok” -knappen för att associera de grafiska filtyperna med deras respektive standardapplikationer.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Följande filtyper har associerats med standardapplikationer. <br/>{0} Du har möjlighet att ändra dina inställningar för om du tar bort/lägger till nya filtypsförbindelser inom parentess.json genom att gå till ”Felsök->Öppna inställningsfil” -menyn.",
  "UNSUPPORTED_BROWSER": "Webbläsaren stöds inte",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Webbläsaren stöder inte Öppna mapp",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Använd en av de webbläsare som stöds nedan.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Vi arbetar hårt för att göra Phoenix tillgängligt i fler webbläsare. Du kan stänga den här dialogen, men vissa funktioner i Phoenix fungerar inte i den här webbläsaren.",
  "CANNOT_PUBLISH_LARGE_PROJECT": "Kan inte publicera stort projekt",
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "Phoenix är fortfarande i experimentell alfa. Vi har ännu inte aktiverat synkronisering av projekt med mer än 500 filer.",
  "SHARE_WEBSITE": "Publicera och dela webbplats?",
  "PUBLISH": "Publicera",
  "PUBLISH_CONSENT_MESSAGE": "Förhandsgranska ändringar snabbt och dela din webbplats med andra. Phoenix kan publicera denna webbplats åt dig på {0}. De publicerade länkarna är giltiga under en period av 7 dagar. </br>Villdu publicera och dela din webbplats?",
  "PUBLISH_SYNC_IN_PROGRESS": "Synkronisering pågår för förhandsgranskning...",
  "PUBLISH_PAGE": "Klicka för att publicera och dela den här webbplatsen",
  "PUBLISH_VIEW_PAGE": "Klicka för att visa publicerad sida",
  "MISSING_FIELDS": "Saknade fält",
  "PLEASE_FILL_ALL_REQUIRED": "Vänligen fyll i alla obligatoriska fält markerade med rött",
  "CODE_EDITOR": "kod Editor",
  "BUILD_THE_WEB": "Bygg webben",
  "IMPORT_PROJECT": "Importera projekt",
  "GITHUB_PROJECT": "Github-projektet",
  "NEW_PROJECT_FROM_GITHUB": "Nytt projekt från Github",
  "GITHUB_REPO_URL": "Github Repo URL:",
  "CREATE_PROJECT": "Skapa projekt",
  "SETTING_UP_PROJECT": "Ställa in projekt",
  "LOCATION": "Plats:",
  "DOWNLOADING": "Laddar ner...",
  "DOWNLOAD_FAILED_MESSAGE": "Se till att nedladdningsadressen är giltig. </br>OBS: Eftersom Phoenix är i alfa är privata repor och Github webbadresser större än 25 MB inte tillåtna.",
  "PLEASE_SELECT_A_FOLDER": "Välj en mapp...",
  "UNZIP_IN_PROGRESS": "Packa upp filer...",
  "UNZIP_FAILED": "Fel: Unzipping misslyckades.",
  "CONFIRM_REPLACE_TITLE": "Bekräfta ersätta",
  ...
  "WEBPAGE_HOME_PAGE": "Hem sidlayouter",
  "WEBPAGE_BLOG": "Blogg Sida",
  "WEBPAGE_DASHBOARD": "HTML-instrumentpanelen",
