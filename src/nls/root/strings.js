...
define({
    ...
    "AI_CHAT_CLI_NOT_FOUND_TITLE": "{0} not found",
    "AI_CHAT_CLI_NOT_FOUND_MSG": "{0} could not be found on this system. Install it, or enter the full path to its executable below.",
    "AI_CHAT_CLI_NOT_FOUND_BAD_PATH_MSG": "The path set for {0} could not be used: {1} Enter a different path, or clear the box to detect it automatically.",
    "AI_CHAT_CLI_NOT_FOUND_INSTALL_BTN": "Install {0}",
    "AI_CHAT_CLI_NOT_FOUND_SAVE_BTN": "Save & Retry",
    "AI_CHAT_CLI_NOT_FOUND_LEARN_MORE": "Installation instructions",
