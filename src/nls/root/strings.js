...
define({
    ...
    "LIVE_PREVIEW_LAYERS_COPIED_HINT": "Copied. Right-click a row and choose Paste to insert it above that row.",
    "LIVE_PREVIEW_LAYERS_CUT_HINT": "Cut. Right-click a row and choose Paste to insert it above that row.",
