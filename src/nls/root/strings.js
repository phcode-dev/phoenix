...
define({
    ...
    "LIVE_DEV_STYLER_WEIGHT_SEMI_BOLD": "Semibold",
    ...
    "LIVE_DEV_STYLER_LOWERCASE": "Lowercase",
    "LIVE_DEV_STYLER_CAPITALIZE": "Capitalize",
    "LIVE_DEV_STYLER_ALIGN_LEFT": "Align left",
    "LIVE_DEV_STYLER_ALIGN_CENTER": "Align center",
    "LIVE_DEV_STYLER_ALIGN_RIGHT": "Align right",
    "LIVE_DEV_STYLER_ALIGN_JUSTIFY": "Justify",
    ...
    "LIVE_DEV_STYLER_CURSOR_MOVE": "Move",
    "LIVE_DEV_STYLER_CURSOR_GRAB": "Grab",
    "LIVE_DEV_STYLER_CURSOR_GRABBING": "Grabbing",
    "LIVE_DEV_STYLER_CURSOR_NOT_ALLOWED": "Not allowed",
    "LIVE_DEV_STYLER_CURSOR_HELP": "Help",
    "LIVE_DEV_STYLER_CURSOR_WAIT": "Wait",
    "LIVE_DEV_STYLER_CURSOR_PROGRESS": "Progress",
    "LIVE_DEV_STYLER_CURSOR_CROSSHAIR": "Crosshair",
    ...
    "LIVE_DEV_STYLER_FROM_GOOGLE": "From Google Fonts",
    "LIVE_DEV_STYLER_COMMON_COLORS": "Common",
    "LIVE_DEV_STYLER_COLOR_WHITE": "White",
    "LIVE_DEV_STYLER_COLOR_SILVER": "Silver",
    "LIVE_DEV_STYLER_COLOR_GRAY": "Gray",
    "LIVE_DEV_STYLER_COLOR_BLACK": "Black",
    "LIVE_DEV_STYLER_COLOR_RED": "Red",
    "LIVE_DEV_STYLER_COLOR_MAROON": "Maroon",
    "LIVE_DEV_STYLER_COLOR_ORANGE": "Orange",
    "LIVE_DEV_STYLER_COLOR_GOLD": "Gold",
    "LIVE_DEV_STYLER_COLOR_YELLOW": "Yellow",
    "LIVE_DEV_STYLER_COLOR_OLIVE": "Olive",
    "LIVE_DEV_STYLER_COLOR_LIME": "Lime",
    "LIVE_DEV_STYLER_COLOR_GREEN": "Green",
    "LIVE_DEV_STYLER_COLOR_TEAL": "Teal",
    "LIVE_DEV_STYLER_COLOR_CYAN": "Cyan",
    "LIVE_DEV_STYLER_COLOR_BLUE": "Blue",
    "LIVE_DEV_STYLER_COLOR_NAVY": "Navy",
    "LIVE_DEV_STYLER_COLOR_INDIGO": "Indigo",
    "LIVE_DEV_STYLER_COLOR_PURPLE": "Purple",
    ...
    "LIVE_DEV_STYLER_DASHED": "Dashed",
    "LIVE_DEV_STYLER_DOTTED": "Dotted",
    "LIVE_DEV_STYLER_DOUBLE": "Double",
    "LIVE_DEV_STYLER_OUTLINE": "Outline",
    "LIVE_DEV_STYLER_OFFSET": "Offset",
    "LIVE_DEV_STYLER_BORDER_AND_OUTLINE": "Border & Outline",
    "LIVE_DEV_STYLER_BORDER_COLOR": "Border color",
    "LIVE_DEV_STYLER_OUTLINE_COLOR": "Outline color",
    ...
    "LIVE_DEV_STYLER_LINK_PAIRED_SHORT": "Paired",
    "LIVE_DEV_STYLER_LINK_ALL_SHORT": "All linked",
    ...
    "LIVE_DEV_STYLER_BOTTOM": "Bottom",
    "LIVE_DEV_STYLER_LEFT": "Left",
    "LIVE_DEV_STYLER_DISPLAY": "Display",
    "LIVE_DEV_STYLER_DIRECTION": "Direction",
    "LIVE_DEV_STYLER_JUSTIFY": "Justify",
    "LIVE_DEV_STYLER_ALIGN_ITEMS": "Align items",
    "LIVE_DEV_STYLER_WRAP": "Wrap",
    "LIVE_DEV_STYLER_GAP": "Gap",
    "LIVE_DEV_STYLER_COLUMNS": "Columns",
    "LIVE_DEV_STYLER_ROWS": "Rows",
    ...
    "LIVE_DEV_STYLER_HIDDEN": "Hidden",
    "LIVE_DEV_STYLER_ROW": "Row",
    "LIVE_DEV_STYLER_COLUMN": "Column",
    "LIVE_DEV_STYLER_ROW_REVERSE": "Row Reverse",
    "LIVE_DEV_STYLER_COLUMN_REVERSE": "Column Reverse",
    "LIVE_DEV_STYLER_START": "Start",
    "LIVE_DEV_STYLER_CENTER": "Center",
    "LIVE_DEV_STYLER_END": "End",
    "LIVE_DEV_STYLER_SPACE_BETWEEN": "Space Between",
    "LIVE_DEV_STYLER_SPACE_AROUND": "Space Around",
    ...
    "LIVE_DEV_STYLER_RELATIVE": "Relative",
    "LIVE_DEV_STYLER_ABSOLUTE": "Absolute",
    "LIVE_DEV_STYLER_STICKY": "Sticky",
    "LIVE_DEV_STYLER_FIXED": "Fixed",
    ...
    "LIVE_DEV_STYLER_DECREASE_VALUE": "Decrease {0}",
    "LIVE_DEV_STYLER_INCREASE": "Increase value",
    "LIVE_DEV_STYLER_DECREASE": "Decrease value",
    "LIVE_DEV_STYLER_STEP_HINT": "Shift + Click: x10\nAlt + Click: x0.1",
    "LIVE_DEV_STYLER_EYEDROPPER": "Pick color from page",
    ...
    "LIVE_DEV_INSERT_CREATE": "Create {0}",
    "LIVE_DEV_INSERT_NAME_ACCORDION": "Accordion",
    "LIVE_DEV_INSERT_NAME_PASSWORD": "Password",
    "LIVE_DEV_INSERT_NAME_MAIN_CONTENT": "Main Content",
    "LIVE_DEV_INSERT_NAME_CODE_BLOCK": "Code Block",
    "LIVE_DEV_INSERT_NAME_DEF_LIST": "Def. List",
    "LIVE_DEV_INSERT_NAME_FILE_UPLOAD": "File Upload",
    "LIVE_DEV_INSERT_NAME_DATE_PICKER": "Date Picker",
    ...
    "LIVE_DEV_ELEMENT_PROPS_CLASS_PLACEHOLDER": "Add a class…",
    "LIVE_DEV_ELEMENT_PROPS_ID_PLACEHOLDER": "Add an ID…",
    ...
    "LIVE_DEV_ELEMENT_PROPS_NO_CLASSES": "No classes yet",
    "LIVE_DEV_ELEMENT_PROPS_NO_ATTRIBUTES": "No attributes yet",
    ...
    "LIVE_DEV_TOAST_HIDDEN_BY_STYLE": "Element is hidden - it has {0}",
    "LIVE_DEV_TOAST_HIDDEN_BY_PARENT_STYLE": "Element is hidden - {0} has {1}",
    "LIVE_DEV_TOAST_HIDDEN_IN_CLOSED": "Element is hidden - {0} is closed",
    "LIVE_DEV_TOAST_HIDDEN_NO_SIZE": "Element is not visible - it has no size",
    "LIVE_DEV_TOAST_HIDDEN_CUT_OFF": "Element is not visible - it is cut off by {0}",
    "LIVE_DEV_TOAST_HIDDEN_OUTSIDE": "Element is not visible - it is outside the visible area",
    "LIVE_DEV_TOAST_HIDDEN": "Element is not visible on the page",
    ...
    "LIVE_PREVIEW_LAYERS_CHOOSE_PAGE": "Choose a page",
    "LIVE_PREVIEW_LAYERS_PICK_HTML": "Pick an HTML file to see its layers.",
    "LIVE_PREVIEW_LAYERS_SEARCH_FILES": "Search {0} files",
    "LIVE_PREVIEW_LAYERS_NO_FILE_MATCHES": "No matching files",
    ...
    "LIVE_PREVIEW_LAYERS_OVERRIDDEN_IMPORTANT": "Overridden by {0} in {1} ({2})",
    "LIVE_PREVIEW_LAYERS_OVERRIDDEN_IN_RULE": "Overridden by the later {0} declaration in this rule",
    "LIVE_PREVIEW_LAYERS_OVERRIDDEN_INLINE": "Overridden by the element's inline style ({0})",
    "LIVE_PREVIEW_LAYERS_OVERRIDDEN_SPECIFIC": "Overridden by the more specific rule {0} ({1})",
    "LIVE_PREVIEW_LAYERS_OVERRIDDEN_LATER": "Overridden by {0} ({1}), which has the same specificity but comes later",
    "LIVE_PREVIEW_LAYERS_OVERRIDDEN_JUMP": "Click to go to the winning declaration",
    ...
    "LIVE_PREVIEW_LAYERS_HOVER_HIDDEN": "{0} (hidden)",
    "LIVE_PREVIEW_LAYERS_INSERT_ELEMENT": "Insert Element",
    "LIVE_PREVIEW_LAYERS_CHANGE_COLOR": "Change color: {0}",
    ...
    "DOC_COMMENT_ADD_JSDOC": "Add JSDoc comment",
    "DOC_COMMENT_ADD_PHPDOC": "Add PHPDoc comment",
    "DOC_COMMENT_ADD_JAVADOC": "Add Javadoc comment",
    "DOC_COMMENT_ADD_DOXYGEN": "Add Doxygen comment",
    "DOC_COMMENT_ADD_DOCSTRING": "Add docstring",
    "DOC_COMMENT_SUMMARY": "Description",
    "DOC_COMMENT_DESC": "description",
    ...
    "EXTENSION_MANAGER_CREATE_EXTENSION": "+ Create Extension",
    "EXTENSION_MANAGER_CREATE_THEME": "+ Create Theme",
    ...
    "PHP_INSTALLING": "Setting up PHP support — downloading the language server (9 MB)…",
    ...
    "PHP_INSTALL_STOP": "Stop setting up PHP support ({APP_NAME} will try again on the next launch)",
    "PHP_INSTALL_WAITING_NETWORK": "Waiting for an internet connection to set up PHP support…",
    "DESCRIPTION_PHP_CODE_INTELLIGENCE": "false to disable PHP code intelligence (Intelephense). Setting it back to true downloads the language server again automatically.",
    ...
    // Python language support (PythonSupport)
    "PYTHON_INSTALL_TITLE": "Python Code Intelligence",
    "PYTHON_INSTALLING": "Setting up Python support — downloading the language tools (25 MB)…",
    ...
    "CODE_INTEL_CFG_CHECK_JS": "Type-check JavaScript",
    "CODE_INTEL_CFG_CHECK_JS_SUB": "Finds type errors in JS files",
    "CODE_INTEL_CFG_CHECK_JS_INFO": "Finds typos and type mistakes in your JavaScript and shows them in the Problems panel. Warnings only — your code runs unchanged.",
    "CODE_INTEL_CFG_CHECK_JS_EG_CODE": "console.lgo(\"hi\")",
    "CODE_INTEL_CFG_CHECK_JS_EG_TEXT": "gets flagged: Did you mean 'log'?",
    "CODE_INTEL_CFG_AUTO_TYPES": "Auto-download types",
    "CODE_INTEL_CFG_AUTO_TYPES_SUB": "Fetches typings via npm",
    "CODE_INTEL_CFG_AUTO_TYPES_INFO": "Code hints for npm packages start working even before you run npm install. Needs npm and internet; downloads are cached outside your project.",
    "CODE_INTEL_CFG_AUTO_MANAGE": "Managed by {APP_NAME}",
    "CODE_INTEL_CFG_AUTO_MANAGE_SUB": "Keeps this file updated automatically",
    "CODE_INTEL_CFG_AUTO_MANAGE_INFO": "{APP_NAME} keeps this file tuned so code intelligence just works. Turn off to customize the file yourself — {APP_NAME} will then never modify it.",
    "CODE_INTEL_CFG_TARGET": "Target",
    "CODE_INTEL_CFG_TARGET_SUB": "The JS version your code uses",
    "CODE_INTEL_CFG_TARGET_ES5": "legacy browsers (IE11-era)",
    ...
    "CODE_INTEL_CFG_TARGET_ES2022": "class fields, top-level await",
    "CODE_INTEL_CFG_TARGET_ESNEXT": "everything current",
    "CODE_INTEL_CFG_TARGET_FOOT": "Older targets flag newer syntax as errors — pick the newest unless your code must run on old engines.",
    "CODE_INTEL_CFG_MODULE": "Module",
    "CODE_INTEL_CFG_MODULE_SUB": "How import and require() resolve",
    "CODE_INTEL_CFG_MODULE_PRESERVE": "understands both import and require(), no file-extension rules — best for editing",
    "CODE_INTEL_CFG_MODULE_ESNEXT": "modern import/export semantics",
    "CODE_INTEL_CFG_MODULE_NODENEXT": "Node's strict ESM rules — required file extensions, honors package.json \"type\"",
    "CODE_INTEL_CFG_MODULE_COMMONJS": "classic require()/module.exports projects",
    "CODE_INTEL_CFG_JSX": "JSX",
    "CODE_INTEL_CFG_JSX_SUB": "How JSX in .jsx and .tsx files is treated",
    "CODE_INTEL_CFG_JSX_REACT_JSX": "modern runtime (React 17+) — no import React needed",
    "CODE_INTEL_CFG_JSX_REACT": "compiles to React.createElement — requires the React import",
    "CODE_INTEL_CFG_JSX_PRESERVE": "leaves JSX untouched for another tool, e.g. a bundler",
    "CODE_INTEL_CFG_JSX_OFF_INFO": "no JSX handling",
    "CODE_INTEL_CFG_JSX_OFF": "Off",
    "CODE_INTEL_CFG_CURRENT_VALUE": "(current: {0})",
    "CODE_INTEL_CFG_ORIGIN_NOTE": "{APP_NAME} created this file to power project-wide code intelligence. Deleting it turns that off — re-enable anytime from the {0}.",
    "CODE_INTEL_CFG_PROBLEMS_PANEL": "Problems panel",
    "CODE_INTEL_CFG_AUTO_CREATE": "Create a config automatically in new projects",
    "CODE_INTEL_CFG_READ_ONLY": "This file has custom formatting or comments — edit the JSON directly.",
    ...
    "PUBLISH": "Publish",
    "PUBLISH_CONSENT_MESSAGE": "Quickly preview changes and share your website with others. {APP_NAME} can publish this website for you at {0}. The published links will be valid for a period of 3 days. </br>Do you wish to publish and share your website?",
    ...
    "TERMINAL_PROJECT_CHANGED": "Project switched to {0}",
    "TERMINAL_PROJECT_RESTART_PATH": "Restart all terminals in {0}",
    ...
    "TERMINAL_PROJECT_DISMISS": "Dismiss — keep terminals running",
    "TERMINAL_PROJECT_RESTART": "Restart All Terminals",
    ...
    "PROMO_CARD_2_MESSAGE": "AI that sees what you see — not just code. It helps create layouts, fix tricky UI issues, and stays out of your way so you can focus on the creative work.",
    ...
    "AI_CHAT_MODE_SWITCH_HINT": "Switch back anytime from here",
    ...
    "AI_CHAT_START_ANOTHER_DEMO": "Show another demo",
    "AI_CHAT_START_MAKE_NEW_NOTE": "Making something new uses your AI credits. Pick demo to use none.",
    ...
    "AI_CHAT_DEMO_BUILT_WITH": "Built with {0}",
    "AI_CHAT_DEMO_ANOTHER_BTN": "See another demo",
    "AI_CHAT_DEMO_REVEAL_PROMPT": "Reveal the prompt",
    "AI_CHAT_DEMO_HIDE_PROMPT": "Hide the prompt",
    "AI_CHAT_DEMO_PROMPT_LABEL": "The prompt that built this",
    "AI_CHAT_DEMO_COPY_PROMPT": "Copy",
    ...
    "AI_CHAT_SETUP_PLACEHOLDER": "Set up Claude Code to start chatting",
    ...
    "AI_CHAT_CLI_INSTALLING_NAMED_MSG": "Installing {0}, please wait. This may take a while...",
    "AI_CHAT_CLI_RESTART_NOTE": "Restart {APP_NAME} after installation completes.",
    "AI_CHAT_CLI_NOT_FOUND_INSTALL_BTN": "Install {0}",
    "AI_CHAT_CLI_SETUP_TITLE": "Set up {0}",
    "AI_CHAT_CLI_SETUP_MISSING": "{0} isn't installed yet.",
    "AI_CHAT_CLI_SETUP_BAD_PATH": "{0} couldn't be started from the saved path.",
    "AI_CHAT_CLI_SETUP_INSTALL_TITLE": "Install it for me",
    "AI_CHAT_CLI_SETUP_RECOMMENDED": "Recommended",
    "AI_CHAT_CLI_SETUP_INSTALL_DESC": "Runs {0}'s official installer in the terminal. Pick {1} again when it's done.",
    "AI_CHAT_CLI_SETUP_NO_DOWNLOADER": "Needs {0} or {1}. Install one of them first.",
    "AI_CHAT_CLI_SETUP_PATH_TITLE": "I already have it",
    "AI_CHAT_CLI_SETUP_PATH_DESC": "Paste the full path to {0}.",
    "AI_CHAT_CLI_SETUP_USE_PATH_BTN": "Use This Path",
    "AI_CHAT_CLI_SETUP_AUTO_DETECT": "Detect automatically instead",
    "AI_CHAT_CLI_SETUP_AUTO_DETECT_FAILED": "Couldn't find {0} automatically.",
    "AI_CHAT_CLI_SETUP_WHAT_IS": "What is {0}?",
    "AI_CHAT_CLI_ERR_OVERRIDE_MISSING": "No file exists at that path.",
    "AI_CHAT_CLI_ERR_OVERRIDE_NOT_EXECUTABLE": "That file is not executable.",
    "AI_CHAT_CLI_ERR_OVERRIDE_INVALID": "That file did not run as {0}.",
    "AI_CHAT_CLI_ERR_OVERRIDE_TIMEOUT": "That file did not respond in time.",
    "AI_CHAT_CLI_ERR_OVERRIDE_REJECTED": "That path contains characters that cannot be used.",
    ...
    "AI_CHAT_QUOTA_DAILY_STATUS": "{0} / {1} daily chats used",
    "AI_CHAT_QUOTA_MONTHLY_STATUS": "{0} / {1} monthly chats used",
    "AI_CHAT_QUOTA_DAILY_EXHAUSTED": "You've used all {0} daily chats. Resets tomorrow.",
    "AI_CHAT_QUOTA_MONTHLY_EXHAUSTED": "You've used all {0} monthly chats.",
    "AI_CHAT_QUOTA_UPGRADE_BTN": "Get Phoenix Pro for unlimited chats",
    ...
    "AI_CHAT_TOOL_TOOL_SEARCH": "Loading tools",
    "AI_CHAT_TOOL_SEND_MESSAGE": "Messaging subagent",
    "AI_CHAT_TOOL_TASK_OUTPUT": "Reading subagent output",
    "AI_CHAT_TOOL_TASK_STOP": "Stopping subagent",
    ...
    "AI_CHAT_PLAN_STOP_TITLE": "Interrupt Claude and discard this plan",
    ...
    "AI_CHAT_TOOL_CONFIRM_TITLE": "Allow this action?",
    "AI_CHAT_TOOL_ALLOWED": "Action allowed",
    "AI_CHAT_TOOL_DENIED": "Action denied",
    "AI_CHAT_PLAN_WRITE_CONFIRM_TITLE": "Switch to Auto?",
    "AI_CHAT_PLAN_WRITE_CONFIRM_BODY": "Claude wants to edit {0}. You're currently in Plan Mode.",
    "AI_CHAT_PLAN_WRITE_ALLOW": "Allow & Switch to Auto",
    "AI_CHAT_PLAN_WRITE_STAY": "Stay in Plan Mode",
    "AI_CHAT_PLAN_WRITE_ALLOWED": "Switched to Auto",
    ...
    "AI_CHAT_IMAGE_SEARCH": "Searching images",
    "AI_CHAT_IMAGE_USE": "Selecting image",
    "AI_CHAT_IMAGE_SELECTED": "Selected image",
    "AI_CHAT_IMAGE_SELECTED_GROUP": "Selected images",
    "AI_CHAT_IMAGE_PREVIEW": "Image preview",
    "AI_CHAT_IMAGE_PREVIEW_INVALID": "Provide one to nine HTTP, HTTPS, or file image URLs.",
    "AI_CHAT_IMAGE_PREVIEW_COUNT": "{0} images",
    "AI_CHAT_IMAGE_PREVIEW_SINGLE": "1 image",
    "AI_CHAT_IMAGE_CLOSE": "Close image preview (Esc)",
    "AI_CHAT_IMAGE_PREVIOUS": "Previous image",
    "AI_CHAT_IMAGE_NEXT": "Next image",
    "AI_CHAT_IMAGE_POSITION": "Image {0} of {1}",
    "AI_CHAT_IMAGE_PHOTO_BY": "Photo by",
    "AI_CHAT_IMAGE_REPLY": "Reply with this image",
    "AI_CHAT_IMAGE_QUOTE": "Quote image in chat",
    "AI_CHAT_IMAGE_VIEW_COLLAGE": "View collage",
    "AI_CHAT_IMAGE_SHOW_ALL": "Show all",
    "AI_CHAT_IMAGE_BACK_TO_ALL": "Back to all images",
    "AI_CHAT_IMAGE_RESULTS_COUNT": "{0} photos · Unsplash",
    "AI_CHAT_IMAGE_RESULTS_SINGLE": "1 photo · Unsplash",
    "AI_CHAT_IMAGE_NO_RESULTS": "No images found. Try a different search.",
    "AI_CHAT_IMAGE_LOAD_FAILED": "This image could not be loaded.",
    "AI_CHAT_IMAGE_COLLAGE_FAILED": "The image collage could not be created.",
    "AI_CHAT_IMAGE_INVALID_QUERY": "Enter a search query of up to 200 characters and a valid page number.",
    "AI_CHAT_IMAGE_INVALID_REFERENCE": "This image reference is invalid. Use a result from image search.",
    "AI_CHAT_IMAGE_HOURLY_LIMIT": "The limit of 120 image searches in an hour has been reached. Wait before searching again.",
    "AI_CHAT_IMAGE_GUEST_LIMIT": "Your image search allowance has been used. Sign in to continue searching.",
    "AI_CHAT_IMAGE_SERVER_LIMIT": "Image search is temporarily rate limited. Wait before searching again.",
    "AI_CHAT_IMAGE_TIMEOUT": "Image search timed out. Try again later.",
    "AI_CHAT_IMAGE_REQUEST_FAILED": "The image service returned an error ({0}).",
    ...
    "AI_SETTINGS_DEFAULT_PROVIDER_FOR": "Default (Local {0})",
    ...
    "AI_SETTINGS_PROVIDER_TYPE_NOTE": "These providers configure {0}. The API key is passed to it as {1}.",
    "AI_SETTINGS_CLI_PATHS_NOTE": "Leave blank to detect automatically.",
    "AI_SETTINGS_CLI_PATH_LABEL": "Path to the {0} executable",
    ...
    "MIGRATE_DONE_TITLE": "Migration complete",
    "MIGRATE_DONE_FROM": "Brought over from {0}:",
    "MIGRATE_DONE_PROJECTS": "{0} project(s)",
    "MIGRATE_DONE_EXTENSIONS": "{0} extension(s) and theme(s)",
    "MIGRATE_DONE_SETTINGS": "Your settings, including the editor theme",
    "MIGRATE_DONE_TOTAL": "{0} files in total. Reload {APP_NAME} to start using them.",
    "MIGRATE_PARTIAL_TITLE": "Migration did not finish",
    "MIGRATE_PARTIAL_COUNT": "{0} of {1} files could not be copied and are still on the old site.",
    ...
    "MIGRATE_INTERRUPTED_PROGRESS": "{0} of {1} files were copied from {2} before the connection was lost. Those files have been kept, so nothing was lost.",
    "MIGRATE_INTERRUPTED_RETRY": "{APP_NAME} will try the rest the next time you open it.",
    "MIGRATE_INTERRUPTED_FINAL": "To copy the rest, choose {0}.",
