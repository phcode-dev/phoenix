...
define({
  ...
  "ERROR_MOVING_NOT_IN_PROJECT": "Tidak dapat memindahkan file/folder, karena mereka bukan bagian dari proyek saat ini.",
  ...
  "ERROR_PROJ_PREFS_CORRUPT": "File preferensi proyek Anda tidak valid JSON. File akan dibuka sehingga Anda dapat memperbaiki format. Anda perlu memuat ulang proyek agar perubahan diterapkan.",
  ...
  "LIVE_DEV_SELECT_FILE_TO_PREVIEW": "Pilih File Untuk Live Preview",
  "LIVE_DEV_CLICK_TO_RELOAD_PAGE": "Reload Halaman",
  "LIVE_DEV_CLICK_POPOUT": "Popout Live Preview Untuk Jendela Baru",
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "Pin pada Lepas Pin Halaman Pratinjau",
  ...
  "WINDOW_UNLOAD_WARNING": "Apakah Anda yakin ingin menavigasi ke URL yang berbeda dan meninggalkan Brackets?",
  "WINDOW_UNLOAD_WARNING_WITH_UNSAVED_CHANGES": "Anda memiliki perubahan yang belum diselamatkan! Apakah Anda yakin ingin menavigasi ke URL yang berbeda dan meninggalkan Brackets?",
  "DONE": "Selesai",
  "OK": "OK",
  "CANCEL": "Batal",
  ...
  "FIND_HISTORY_MAX_COUNT": "Jumlah Maksimum Item Pencarian di Riwayat Pencarian",
  ...
  "FILTER_NAME_REMAINING": "{0} karakter yang tersisa",
  ...
  "CMD_TOGGLE_SIDEBAR": "Beralih Sidebar",
  ...
  "CMD_GOTO_DEFINITION_PROJECT": "Cari Definisi Cepat dalam Proyek",
  ...
  "CMD_NAVIGATE_BACKWARD": "Arahkan Mundur",
  "CMD_NAVIGATE_FORWARD": "Arahkan Maju",
  ...
  "CMD_SWITCH_PANE_FOCUS": "Fokus Panel Beralih",
  ...
  "PRERELEASE_BUILD": "membangun prarilis",
  ...
  "ABOUT": "Tentang",
  "CLOSE": "Tutup",
  "ABOUT_TEXT_LINE1": "Rilis {VERSION_MAJOR}. {VERSION_MINOR} {BUILD_TYPE} {VERSI}",
  ...
  "ABOUT_TEXT_LINE6": "Banyak orang (tetapi kami mengalami kesulitan memuat data itu sekarang).",
  ...
  "FLIPVIEW_BTN_TOOLTIP": "Balikkan tampilan ini ke panel {0}",
  ...
  "SORT_EXTENSION_METHOD": "Urutkan Ekstensi menggunakan DownloadCount atau PublishedDate",
  ...
  "EXTENSION_MANAGER_DISABLE_ERROR": "Tidak dapat menonaktifkan satu atau beberapa ekstensi: {0}. {APP_NAME} masih akan reload.",
  ...
  "DISABLE_AND_RELOAD": "Nonaktifkan Ekstensi dan Reload",
  ...
  "CMD_ENABLE_LOGGING": "Aktifkan Log Detil",
  "CMD_OPEN_BRACKETS_SOURCE": "Buka Kode Sumber Brackets",
  "CREATING_LAUNCH_SCRIPT_TITLE": "{APP_NAME} Pintasan Baris Perintah",
  "ERROR_CREATING_LAUNCH_SCRIPT": "Terjadi galat saat menginstal pintasan baris perintah. Silakan coba <a href='https://github.com/adobe/brackets/wiki/Command-Line-Arguments#troubleshooting'>saran pemecahan masalah ini</a>. <br/><br/>Alasan: {0}",
  "ERROR_CLTOOLS_RMFAILED": "Tidak dapat menghapus symlink <code>/usr/local/bin/bracket</code> yang ada.",
  ...
  "LAUNCH_SCRIPT_CREATE_SUCCESS": "Sukses! Sekarang Anda dapat dengan mudah meluncurkan {APP_NAME} dari baris perintah: <code>kurung myFile.txt</code> untuk membuka file atau <code>kurung MyFolder</code> untuk beralih proyek. <br/><br/><a href='https://github.com/adobe/brackets/wiki/Command-Line-Arguments'>Pelajari lebih lanjut</a> tentang menggunakan {APP_NAME} dari baris perintah.",
  ...
  "HEALTH_FIRST_POPUP_TITLE": "{APP_NAME} Laporan Kesehatan",
  "HEALTH_DATA_DO_TRACK": "Bagikan informasi nama samaran tentang cara saya menggunakan {APP_NAME}",
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "Untuk meningkatkan {APP_NAME}, kami secara berkala mengirim statistik <strong>pseudonim</strong> terbatas ke core.ai tentang bagaimana Anda menggunakan {APP_NAME}. Informasi ini membantu memprioritaskan fitur, menemukan bug, dan menemukan masalah kegunaan sekaligus menjaga privasi Anda. <br><br>Andadapat melihat data atau memilih untuk tidak berbagi data dengan memilih <strong>Bantuan > Laporan Kesehatan</strong>. <br><br>",
  "HEALTH_DATA_PREVIEW": "{APP_NAME} Laporan Kesehatan",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Untukmeningkatkan {APP_NAME}, kami secara berkala mengirim statistik <strong>pseudonim</strong> terbatas ke core.ai tentang bagaimana Anda menggunakan {APP_NAME}. Informasi ini membantu memprioritaskan fitur, menemukan bug, dan menemukan masalah kegunaan. </p><p>Dibawah ini adalah pratinjau data yang akan dikirim dalam Laporan Kesehatan Anda berikutnya <em>jika</em> diaktifkan. </p>",
  ...
  "ERROR_TERN_FAILED": "Tidak dapat memperoleh data dari Tern",
  "ERROR_EXTRACTTO_VARIABLE_NOT_VALID": "Seleksi tidak membentuk ekspresi",
  "ERROR_EXTRACTTO_FUNCTION_NOT_VALID": "blok yang dipilih harus mewakili set pernyataan atau ekspresi",
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "Ekstrak ke Variabel tidak bekerja di multicursors",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "Ekstrak ke Fungsi tidak bekerja di multicursors",
  ...
  "CMD_REFACTORING_TRY_CATCH": "Bungkus di Coba Tangkap",
  "CMD_REFACTORING_CONDITION": "Bungkus dalam Kondisi",
  "CMD_REFACTORING_GETTERS_SETTERS": "Buat Pengambil/Setter",
  "CMD_REFACTORING_ARROW_FUNCTION": "Konversikan ke Fungsi Panah",
  "DESCRIPTION_CODE_REFACTORING": "Aktifkan/nonaktifkan JavaScript Kode Refactoring",
  "ERROR_TRY_CATCH": "Pilih kode yang valid untuk dibungkus dalam blok Try-catch",
  "ERROR_WRAP_IN_CONDITION": "Pilih kode yang valid untuk membungkus di blok Kondisi",
  ...
  "ERROR_RENAME_QUICKEDIT": "Tidak dapat mengubah nama pengenal ini, karena direferensikan di tempat lain di luar fungsi ini",
  "ERROR_RENAME_GENERAL": "Tidak dapat mengubah nama teks yang dipilih",
  "JSLINT_NAME": "JSLint",
  ...
  "COLLAPSE_CURRENT": "Runtuh Saat Ini",
  "EXPAND_CURRENT": "Perluas Saat Ini",
  "RECENT_FILES_DLG_HEADER": "File Terbaru",
  "RECENT_FILES_DLG_CLEAR_BUTTON_LABEL": "Jelas",
  "RECENT_FILES_DLG_CLEAR_BUTTON_TITLE": "Bersihkan berkas yang tidak ada di Set Kerja",
  "DESCRIPTION_CLOSE_BRACKETS": "true untuk secara otomatis menutup kawat gigi, kurung dan tanda kurung",
  "DESCRIPTION_CLOSE_OTHERS_ABOVE": "false untuk menghapus “Close Others Above” dari menu konteks Working Files",
  "DESCRIPTION_CLOSE_OTHERS_BELOW": "false untuk menghapus “Close Others Below” dari menu konteks Working Files",
  "DESCRIPTION_CLOSE_OTHERS": "false untuk menghapus “Tutup Lainnya” dari menu konteks File Kerja",
  "DESCRIPTION_CLOSE_TAGS": "Menetapkan opsi penutupan tag",
  "DESCRIPTION_CLOSE_TAGS_DONT_CLOSE_TAGS": "Array tag yang seharusnya tidak ditutup secara otomatis",
  "DESCRIPTION_CLOSE_TAGS_WHEN_OPENING": "Tutup saat > tag pembuka diketik",
  "DESCRIPTION_CLOSE_TAGS_WHEN_CLOSING": "Tutup saat/dari tag penutup diketik",
  "DESCRIPTION_CLOSE_TAGS_INDENT_TAGS": "Array tag yang ketika dibuka memiliki baris kosong",
  "DESCRIPTION_CODE_FOLDING_ALWAY_USE_INDENT_FOLD": "true untuk selalu menghasilkan penanda bagian yang dapat dilipat saat tingkat indent berubah",
  "DESCRIPTION_CODE_FOLDING_ENABLED": "true untuk mengaktifkan pelipatan kode",
  "DESCRIPTION_CODE_FOLDING_HIDE_UNTIL_MOUSEOVER": "benar untuk membuat penanda bagian-runtuh terlihat hanya ketika Anda memindahkan mouse di atas selokan",
  "DESCRIPTION_CODE_FOLDING_MAX_FOLD_LEVEL": "Membatasi berapa banyak level dalam Collapse Semua berlaku",
  "DESCRIPTION_CODE_FOLDING_MIN_FOLD_SIZE": "Baris minimum sebelum ikon bagian yang dapat dilipat muncul",
  "DESCRIPTION_CODE_FOLDING_SAVE_FOLD_STATES": "true untuk mengingat bagian yang diciutkan jika Anda menutup dan membuka kembali file atau proyek",
  "DESCRIPTION_CODE_FOLDING_MAKE_SELECTIONS_FOLDABLE": "true untuk mengaktifkan kode lipat pada teks yang dipilih di editor",
  "DESCRIPTION_DISABLED_DEFAULT_EXTENSIONS": "Ekstensi default yang dinonaktifkan",
  "DESCRIPTION_ATTR_HINTS": "Aktifkan/menonaktifkan HTML petunjuk atribut",
  "DESCRIPTION_CSS_PROP_HINTS": "Aktifkan/menonaktifkan CSS/KURANG/SCSS petunjuk properti",
  "DESCRIPTION_JS_HINTS": "Aktifkan/nonaktifkan petunjuk kode JavaScript",
  "DESCRIPTION_JS_HINTS_TYPE_DETAILS": "Aktifkan/menonaktifkan rincian tipe data dalam petunjuk kode JavaScript",
  "DESCRIPTION_PREF_HINTS": "Aktifkan/nonaktifkan petunjuk kode Preferensi",
  "DESCRIPTION_SPECIAL_CHAR_HINTS": "Aktifkan/menonaktifkan petunjuk entitas HTML",
  ...
  "DESCRIPTION_URL_CODE_HINTS": "Aktifkan/menonaktifkan petunjuk URL di HTML & CSS/KURANG/SCSS",
  "DESCRIPTION_DRAG_DROP_TEXT": "Mengaktifkan/menonaktifkan Drag & Drop fungsi",
  "DESCRIPTION_HEALTH_DATA_TRACKING": "Aktifkan Pelacakan Data Kesehatan",
  "DESCRIPTION_HIGHLIGHT_MATCHES": "Memungkinkan penyorotan otomatis string yang cocok di seluruh dokumen",
  "DESCRIPTION_HIGHLIGHT_MATCHES_SHOW_TOKEN": "Sorot semua string yang cocok dengan token kursor saat ini berada (tidak perlu seleksi)",
  "DESCRIPTION_HIGHLIGHT_MATCHES_WORDS_ONLY": "Sorot hanya jika seleksi adalah token lengkap",
  "DESCRIPTION_INSERT_HINT_ON_TAB": "true untuk menyisipkan petunjuk kode yang dipilih saat ini pada tab",
  "DESCRIPTION_NO_HINTS_ON_DOT": "true untuk tidak secara otomatis menampilkan petunjuk kode JS kapan. diketik",
  "DESCRIPTION_JSLINT_OPTIONS": "Objek dengan opsi default untuk JSLint",
  "DESCRIPTION_JSLINT_OPTIONS_ASS": "true untuk mengizinkan ekspresi tugas",
  "DESCRIPTION_JSLINT_OPTIONS_BITWISE": "true untuk mengizinkan operator bitwise",
  "DESCRIPTION_JSLINT_OPTIONS_BROWSER": "true jika global browser standar harus telah ditetapkan",
  "DESCRIPTION_JSLINT_OPTIONS_CLOSURE": "true untuk mengizinkan idiom Google Closure",
  "DESCRIPTION_JSLINT_OPTIONS_CONTINUE": "true untuk mengizinkan pernyataan “continue”",
  "DESCRIPTION_JSLINT_OPTIONS_COUCH": "true jika Globals CouchDB harus telah ditetapkan",
  "DESCRIPTION_JSLINT_OPTIONS_DEBUG": "true untuk mengizinkan pernyataan debugger",
  "DESCRIPTION_JSLINT_OPTIONS_DEVEL": "true jika global browser yang berguna dalam pengembangan harus telah ditetapkan",
  "DESCRIPTION_JSLINT_OPTIONS_EQEQ": "true untuk memungkinkan == dan! =",
  "DESCRIPTION_JSLINT_OPTIONS_ES6": "true jika global ES6 harus ditentukan sebelumnya",
  "DESCRIPTION_JSLINT_OPTIONS_EVIL": "benar untuk memungkinkan eval",
  "DESCRIPTION_JSLINT_OPTIONS_FORIN": "benar untuk memungkinkan tanpa filter “untuk... di”",
  "DESCRIPTION_JSLINT_OPTIONS_INDENT": "Mengatur lebar tab tertentu",
  "DESCRIPTION_JSLINT_OPTIONS_MAXERR": "Jumlah maksimum peringatan yang dilaporkan",
  "DESCRIPTION_JSLINT_OPTIONS_MAXLEN": "Jumlah maksimum karakter dalam satu baris",
  "DESCRIPTION_JSLINT_OPTIONS_NEWCAP": "true untuk mengizinkan konstruktor yang tidak dikapitalisasi",
  "DESCRIPTION_JSLINT_OPTIONS_NODE": "true jika Node.js globals harus telah ditetapkan",
  "DESCRIPTION_JSLINT_OPTIONS_NOMEN": "true untuk memungkinkan menggantungkan garis bawah dalam pengidentifikasi",
  "DESCRIPTION_JSLINT_OPTIONS_PASSFAIL": "true untuk berhenti pada kesalahan pertama",
  "DESCRIPTION_JSLINT_OPTIONS_PLUSPLUS": "benar untuk memungkinkan ++ dan -",
  "DESCRIPTION_JSLINT_OPTIONS_REGEXP": "benar untuk memungkinkan. dan [^...]. di RegExp",
  "DESCRIPTION_JSLINT_OPTIONS_RHINO": "true jika Rhino globals harus dipredefinisikan",
  "DESCRIPTION_JSLINT_OPTIONS_SLOPPY": "true untuk memungkinkan hilang `use strict` pragma",
  "DESCRIPTION_JSLINT_OPTIONS_STUPID": "true if blocking ('... Sync') metode dapat digunakan.",
  "DESCRIPTION_JSLINT_OPTIONS_SUB": "true untuk mengizinkan subscripting yang tidak efisien",
  "DESCRIPTION_JSLINT_OPTIONS_TODO": "benar untuk mengizinkan komentar TODO",
  "DESCRIPTION_JSLINT_OPTIONS_UNPARAM": "true untuk mengizinkan parameter yang tidak digunakan",
  "DESCRIPTION_JSLINT_OPTIONS_VARS": "true untuk mengizinkan lebih dari 1 vars dalam sebuah fungsi",
  "DESCRIPTION_JSLINT_OPTIONS_WHITE": "true untuk mengabaikan aturan ruang putih",
  ...
  "DESCRIPTION_LINEWISE_COPY_CUT": "Melakukan copy dan cut ketika tidak ada pilihan akan menyalin atau memotong seluruh baris yang memiliki kursor di dalamnya",
  "DESCRIPTION_INPUT_STYLE": "Memilih cara CodeMirror menangani input dan fokus. Hal ini dapat textarea, yang merupakan default, atau contenteditable yang lebih baik untuk pembaca layar (tidak stabil)",
  "DESCRIPTION_LINTING_ENABLED": "true untuk mengaktifkan Inspeksi Kode",
  "DESCRIPTION_ASYNC_TIMEOUT": "Waktu dalam milidetik setelah itu linter asinkron habis",
  "DESCRIPTION_LINTING_PREFER": "Array dari linters untuk menjalankan pertama",
  "DESCRIPTION_LIVE_DEV_MULTIBROWSER": "benar untuk mengaktifkan eksperimental Live Preview",
  ...
  "DESCRIPTION_SCROLL_PAST_END": "true untuk mengaktifkan pengguliran di luar akhir dokumen",
  "DESCRIPTION_SHOW_CODE_HINTS": "false untuk menonaktifkan semua petunjuk kode",
  "DESCRIPTION_SHOW_CURSOR_WHEN_SELECTING": "Menjaga kursor berkedip terlihat ketika Anda memiliki pilihan teks",
  "DESCRIPTION_SHOW_LINE_NUMBERS": "true untuk menunjukkan nomor baris dalam “selokan” di sebelah kiri kode",
  "DESCRIPTION_SMART_INDENT": "Secara otomatis indentasi saat membuat blok baru",
  "DESCRIPTION_SOFT_TABS": "false untuk mematikan perilaku tab lunak",
  "DESCRIPTION_SORT_DIRECTORIES_FIRST": "true untuk mengurutkan direktori terlebih dahulu di pohon proyek",
  "DESCRIPTION_SPACE_UNITS": "Jumlah spasi yang digunakan untuk lekukan berbasis ruang",
  "DESCRIPTION_STATIC_SERVER_PORT": "Nomor port yang harus digunakan server bawaan untuk Live Preview",
  "DESCRIPTION_STYLE_ACTIVE_LINE": "true untuk menyorot warna latar belakang garis kursor aktif",
  ...
  "DESCRIPTION_UPPERCASE_COLORS": "true untuk menghasilkan warna hex huruf besar di Inline Color Editor",
  ...
  "DESCRIPTION_DETECTED_EXCLUSIONS": "Daftar file yang telah terdeteksi menyebabkan Tern kehabisan kendali",
  "DESCRIPTION_INFERENCE_TIMEOUT": "Jumlah waktu setelah itu Tern akan waktu habis ketika mencoba untuk memahami file",
  "DESCRIPTION_SHOW_ERRORS_IN_STATUS_BAR": "true untuk menampilkan kesalahan di bilah status",
  "DESCRIPTION_QUICK_VIEW_ENABLED": "true untuk mengaktifkan Quick View",
  "DESCRIPTION_EXTENSION_LESS_IMAGE_PREVIEW": "true untuk menampilkan pratinjau gambar untuk URL ekstensi yang hilang",
  "DESCRIPTION_THEME": "Pilih tema {APP_NAME}",
  "DESCRIPTION_USE_THEME_SCROLLBARS": "benar untuk memungkinkan scroll bar kustom",
  "DESCRIPTION_LINTING_COLLAPSED": "true untuk menciutkan panel linting",
  ...
  "DESCRIPTION_FONT_SMOOTHING": "Mac-only: “subpixel-antialiased” untuk mengaktifkan sub-pixel antialiasing atau “antialias” untuk antialiasing skala abu-abu",
  "DESCRIPTION_OPEN_PREFS_IN_SPLIT_VIEW": "false untuk menonaktifkan membuka file preferensi dalam tampilan terpisah",
  "DESCRIPTION_OPEN_USER_PREFS_IN_SECOND_PANE": "false untuk membuka file preferensi pengguna di panel kiri/atas",
  "DESCRIPTION_MERGE_PANES_WHEN_LAST_FILE_CLOSED": "true untuk meruntuhkan panel setelah file terakhir dari panel ditutup melalui tombol tutup header panel",
  "DESCRIPTION_SHOW_PANE_HEADER_BUTTONS": "Beralih kapan menampilkan tombol tutup dan flip-view pada header.",
  "DEFAULT_PREFERENCES_JSON_HEADER_COMMENT": "/*\n * Ini adalah file hanya-baca dengan preferensi yang didukung\n * oleh {APP_NAME}.\n * Gunakan file ini sebagai referensi untuk mengubah preferensi Anda\n * file “brackets.json” dibuka di panel lainnya.\n * Untuk informasi lebih lanjut tentang cara menggunakan preferensi di dalam\n * {APP_NAME}, lihat halaman web di https://github.com/adobe/brackets/wiki/How-to-Use-Brackets#preferences\n */",
  "DEFAULT_PREFERENCES_JSON_DEFAULT": "Default",
  "DESCRIPTION_PURE_CODING_SURFACE": "true untuk mengaktifkan mode kode saja dan menyembunyikan semua elemen UI lainnya di {APP_NAME}",
  "DESCRIPTION_INDENT_LINE_COMMENT": "true untuk mengaktifkan indentasi komentar baris",
  "DESCRIPTION_RECENT_FILES_NAV": "Aktifkan/nonaktifkan navigasi dalam file terbaru",
  "DESCRIPTION_LIVEDEV_WEBSOCKET_PORT": "Port yang WebSocket Server berjalan untuk Live Preview",
  "DESCRIPTION_LIVE_DEV_HIGHLIGHT_SETTINGS": "Pengaturan Sorot Pratinjau Langsung",
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "false untuk menonaktifkan live preview reverse inspeksi",
  "DOWNLOAD_FAILED": "Unduhan gagal.",
  "DOWNLOAD_COMPLETE": "Unduh selesai!",
  "UPDATE_SUCCESSFUL": "Perbarui berhasil!",
  ...
  "CLICK_RESTART_TO_UPDATE": "Klik Restart untuk memperbarui Kurung.",
  "UPDATE_ON_NEXT_LAUNCH": "Pembaruan akan diterapkan pada peluncuran ulang.",
  "GO_TO_SITE": "Pergi ke <a href = \"http://brackets.io/ “> brackets.io </a> untuk mencoba lagi.",
  "INTERNET_UNAVAILABLE": "Tidak ada koneksi internet yang tersedia.",
  "UPDATEDIR_READ_FAILED": "Direktori pemutakhiran tidak dapat dibaca.",
  "UPDATEDIR_CLEAN_FAILED": "Direktori pemutakhiran tidak dapat dibersihkan.",
  "INITIAL_DOWNLOAD": "Mengunduh Pembaruan...",
  "RETRY_DOWNLOAD": "Unduhan gagal. Mencoba lagi... Mencoba ",
  "VALIDATING_INSTALLER": "Unduh selesai! Memvalidasi Installer...",
  "CHECKSUM_DID_NOT_MATCH": "Checksum tidak cocok.",
  "INSTALLER_NOT_FOUND": "Installer tidak ditemukan.",
  "DOWNLOAD_ERROR": "Terjadi kesalahan saat mengunduh.",
  "NETWORK_SLOW_OR_DISCONNECTED": "Jaringan terputus atau terlalu lambat.",
  "RESTART_BUTTON": "Restart",
  "LATER_BUTTON": "Nanti",
  "DESCRIPTION_AUTO_UPDATE": "Aktifkan/nonaktifkan Brackets Auto-update",
  "AUTOUPDATE_ERROR": "Kesalahan!",
  "AUTOUPDATE_IN_PROGRESS": "Pembaruan sudah berlangsung.",
  "NUMBER_WITH_PERCENTAGE": "{0}%",
  "CMD_FIND_RELATED_FILES": "Temukan File Terkait",
  "PHP_VERSION_INVALID": "Kesalahan parsing versi PHP. Silakan periksa output dari perintah “php —version”.",
  "PHP_UNSUPPORTED_VERSION": "Instal runtime PHP7 untuk mengaktifkan perkakas terkait PHP seperti Petunjuk Kode, Petunjuk Parameter, Langsung Ke Definisi, dan lainnya. Versi ditemukan: {0}",
  "PHP_EXECUTABLE_NOT_FOUND": "PHP runtime tidak ditemukan. Instal runtime PHP7 dan perbarui “executablePath” di Preferensi PHP dengan tepat. Ini memungkinkan perkakas terkait PHP seperti Petunjuk Kode, Petunjuk Parameter, Langsung Ke Definisi, dan banyak lagi.",
  "PHP_PROCESS_SPAWN_ERROR": "Kode kesalahan {0} ditemui saat memulai proses PHP.",
  ...
  "REFERENCES_IN_FILES": "rujukan",
  "REFERENCE_IN_FILES": "rujukan",
  ...
  "REMOTE_DEBUGGING_ENABLED": "Remote debugging diaktifkan pada localhost:",
  "REMOTE_DEBUGGING_PORT_INVALID": "Tidak dapat mengaktifkan debug jarak jauh pada port {0}. Nomor port harus antara {1} dan {2}.",
  "DESCRIPTION_EXTERNAL_APPLICATION_ASSOCIATE": "Pemetaan untuk ekstensi file ke aplikasi eksternal. Syntax: \"<file_type>“: “<Default|ApplicationName|ApplicationPath>”, Gunakan “default” untuk membuka berkas dalam aplikasi default sistem untuk jenis file.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "Buka File Grafik di Editor Eksternal.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "Folder Anda saat ini memiliki jenis file grafik yang tidak didukung oleh {APP_NAME}. <br/>Andasekarang dapat mengaitkan jenis file tertentu dengan editor eksternal. Setelah dikaitkan, Anda dapat membuka file grafik seperti.xd, .psd, .jpg, .png, .ai, .svg dalam aplikasi default mereka dengan mengklik dua kali pada file di File Tree. <br/><br/>Silakanklik tombol 'Ok' untuk mengaitkan jenis file grafik dengan aplikasi default masing-masing.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Berikut jenis file telah berhasil dikaitkan dengan aplikasi default. <br/>{0} Anda memiliki opsi untuk mengubah preferensi Anda pada apakah Anda menghapus/menambahkan asosiasi tipe file baru dalam tanda kurung.json dengan membuka menu “Debug->Open Preferences File”.",
  "UNSUPPORTED_BROWSER": "Browser Tidak Didukung",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Browser tidak mendukung Buka folder",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Silakan gunakan salah satu browser yang didukung di bawah ini.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Kami bekerja keras untuk membuat Phoenix tersedia di lebih banyak browser. Anda dapat menutup dialog ini, tetapi beberapa fitur di Phoenix tidak akan berfungsi di browser ini.",
  "CANNOT_PUBLISH_LARGE_PROJECT": "Tidak Dapat Mempublikasikan Proyek Besar",
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "Phoenix masih dalam alfa eksperimental. Kami belum mengaktifkan sinkronisasi proyek dengan lebih dari 500 file.",
  "SHARE_WEBSITE": "Publikasikan dan Bagikan Situs Web?",
  "PUBLISH": "Publikasikan",
  "PUBLISH_CONSENT_MESSAGE": "Pratinjau perubahan dengan cepat dan bagikan situs web Anda dengan orang lain. Phoenix dapat mempublikasikan situs web ini untuk Anda di {0}. Tautan yang dipublikasikan akan berlaku untuk jangka waktu 7 hari. </br>ApakahAnda ingin mempublikasikan dan membagikan situs web Anda?",
  "PUBLISH_SYNC_IN_PROGRESS": "Sinkronisasi dalam proses untuk pratinjau...",
  "PUBLISH_PAGE": "Klik untuk mempublikasikan dan berbagi situs ini",
  "PUBLISH_VIEW_PAGE": "Klik untuk melihat halaman yang dipublikasikan",
  "MISSING_FIELDS": "Bidang Hilang",
  "PLEASE_FILL_ALL_REQUIRED": "Harap isi semua kolom wajib yang disorot dengan warna merah",
  ...
  "DOWNLOAD_FAILED_MESSAGE": "Pastikan URL unduhan valid. </br>NB: Seperti Phoenix dalam alpha, Private Repos dan Github URL yang lebih besar dari 25 MB tidak diperbolehkan.",
  "PLEASE_SELECT_A_FOLDER": "Silakan pilih folder...",
  "UNZIP_IN_PROGRESS": "Membuka ritsleting file...",
  "UNZIP_FAILED": "Galat: Unzipping gagal.",
  "CONFIRM_REPLACE_TITLE": "Konfirmasi Ganti",
  "KEEP_BOTH": "Jauhkan Keduanya",
  "EXPLORE": "HTML Permainan",
  "BLOG": "Blog",
  ...
  "WEBPAGE_HOME_PAGE": "Halaman Layouts",
  "WEBPAGE_BLOG": "Blog Halaman",
