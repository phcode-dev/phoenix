...
define({
  ...
  "EXTRACTING_FILES_PROGRESS": "Mengekstrak {0} dari {1} file.",
  ...
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Tidak bisa mempercantik. Teks editor berubah setelah kecantikan.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Mempercantik File {0}",
  "BEAUTIFY_ERROR_SELECTION": "Tidak bisa mempercantik. </br>Blokkode yang tidak lengkap dipilih atau sintaks tidak valid.",
