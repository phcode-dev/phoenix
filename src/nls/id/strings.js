...
define({
  ...
  "HEALTH_FIRST_POPUP_TITLE": "Laporan Kesehatan {APP_NAME}",
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME} <strong>tidak mengumpulkan atau memproses informasi identitas pribadi apa pun</strong> , namun <strong>mengumpulkan statistik penggunaan anonim</strong> untuk menjaga privasi Anda. Data anonim dikecualikan dari persyaratan pemberitahuan GDPR/CCPA, namun kami yakin Anda harus memiliki pilihan untuk tidak ikut serta dalam pengumpulan data anonim.<br> Statistik penggunaan aplikasi <strong>anonim</strong> dan laporan kesalahan ini membantu memprioritaskan fitur, menemukan bug, dan menemukan masalah kegunaan untuk pengalaman Anda dengan {APP_NAME}.</p><p> Di bawah ini adalah pratinjau data yang akan dikirim ke Laporan Kesehatan Anda berikutnya <em>jika</em> diaktifkan. (Juga lihat konsol pengembang untuk log kesalahan bertanda &#39;Tertangkap Kesalahan Kritis&#39;.)</p>",
  ...
  "NEW_PROJECT_NOTIFICATION": "Klik ikon ini untuk membuat proyek baru.</br><img src=\"styles/images/new_project.png\"><br/> <a href='#' style='float:right;'>Oke</a>",
