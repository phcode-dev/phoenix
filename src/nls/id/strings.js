...
define({
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "Untuk meningkatkan {APP_NAME}, kami secara berkala mengirimkan statistik <strong>pseudonim</strong> terbatas ke core.ai tentang cara Anda menggunakan {APP_NAME}. Informasi ini membantu memprioritaskan fitur, menemukan bug, dan menemukan masalah kegunaan sambil menjaga privasi Anda.<br><br> Anda dapat melihat data Anda atau memilih untuk tidak membagikan data dengan memilih <strong>Bantuan &gt; Laporan Kesehatan</strong> .<br><br>",
  "HEALTH_DATA_PREVIEW": "Laporan Kesehatan {APP_NAME}",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Untuk meningkatkan {APP_NAME}, kami secara berkala mengirimkan statistik <strong>pseudonim</strong> terbatas ke core.ai tentang cara Anda menggunakan {APP_NAME}. Informasi ini membantu memprioritaskan fitur, menemukan bug, dan menemukan masalah kegunaan.</p><p> Di bawah ini adalah pratinjau data yang akan dikirim dalam Laporan Kesehatan Anda berikutnya <em>jika</em> diaktifkan.</p>",
