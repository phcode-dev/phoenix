...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "file <code>package.json</code> tidak terdeteksi dalam proyek saat ini. Apakah proyek saat ini merupakan Ekstensi {APP_NAME} yang valid?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "file <code>package.json</code> adalah JSON yang tidak valid.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "Kolom yang wajib diisi tidak ada di <code>package.json</code> : [{0}]",
  ...
  "UNSUPPORTED_BROWSER_MOBILE": "Perangkat Seluler dan Tablet saat ini tidak didukung sepenuhnya. Anda dapat menutup dialog ini, tetapi beberapa fitur di Phoenix tidak akan berfungsi di browser ini.",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Browser tidak mendukung Buka folder. Silakan gunakan Chrome, Edge atau Opera untuk membuka folder lokal.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Silakan gunakan salah satu browser yang didukung di bawah ini.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Kami bekerja keras agar Phoenix tersedia di lebih banyak browser. Anda dapat menutup dialog ini, tetapi beberapa fitur di Phoenix tidak akan berfungsi di browser ini.",
  ...
  "PUBLISH": "Menerbitkan",
  "PUBLISH_CONSENT_MESSAGE": "Pratinjau perubahan dengan cepat dan bagikan situs web Anda dengan orang lain. Phoenix dapat memublikasikan situs web ini untuk Anda di {0}. Tautan yang dipublikasikan akan berlaku untuk jangka waktu 7 hari. </br>Apakah Anda ingin memublikasikan dan membagikan situs web Anda?",
