...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "<code>package.json</code> -tiedostoa ei löydy nykyisestä projektista. Onko nykyinen projekti kelvollinen laajennus {APP_NAME}?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "<code>package.json</code> tiedosto on virheellinen JSON.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "Pakolliset kentät puuttuvat paketista <code>package.json</code> : [{0}]",
  ...
  "PUBLISH": "Julkaista",
  "PUBLISH_CONSENT_MESSAGE": "Esikatsele muutokset nopeasti ja jaa verkkosivustosi muiden kanssa. Phoenix voi julkaista tämän verkkosivuston puolestasi osoitteessa {0}. Julkaistut linkit ovat voimassa 7 päivää. </br>Haluatko julkaista ja jakaa verkkosivustosi?",
