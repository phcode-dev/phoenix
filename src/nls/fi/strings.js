...
define({
  ...
  "UPDATE_CLOSE_TO_UPDATE_TITLE": "Ei voi päivittää",
  "UPDATE_CLOSE_TO_UPDATE": "Useita muokkausikkunoita on auki. Varmista, että kaikki muut {APP_NAME} Editorin ikkunat on suljettu ennen kuin yrität päivittää. Sulje kaikki muut {APP_NAME}-ikkunat ja yritä päivittää uudelleen.",
