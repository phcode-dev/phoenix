...
define({
  ...
  "INCLUDE_FILE_FILTER": "Sisällytä {0}",
  "EXCLUDE_FILE_FILTER_DROPDOWN": "Sulje pois",
  "INCLUDE_FILE_FILTER_DROPDOWN": "Sisältää",
  "EDIT_FILE_FILTER": "Muokkaa…",
  "FILE_FILTER_DIALOG": "Muokkaa poissulkemissuodatinta",
  "FILE_FILTER_INSTRUCTIONS": "Sulje pois tiedostot ja kansiot, jotka vastaavat mitä tahansa seuraavista <a href='{0}' title=\"{0}\">ohita jokerimerkkejä</a> . Kirjoita jokainen merkkijono uudelle riville. Esim<ul><li> <code>*.js</code> vastaa <code>a/b/x.js</code> , <code>xyx.js</code> jne.</li><li> <code>./*.css</code> vastaa vain projektin juuren <code>x.css</code> tiedostoa, mutta ei alikansion <code>y/x.css</code> tiedostoa.</li></ul>",
  "FILE_FILTER_INSTRUCTIONS_INCLUDE": "Sisällytä vain tiedostot ja kansiot, jotka vastaavat jotakin seuraavista <a href='{0}' title=\"{0}\">ohitusmerkeistä</a> . Kirjoita jokainen merkkijono uudelle riville. Esim<ul><li> <code>*.js</code> vastaa <code>a/b/x.js</code> , <code>xyx.js</code> jne.</li><li> <code>./*.css</code> vastaa vain projektin juuren <code>x.css</code> tiedostoa, mutta ei alikansion <code>y/x.css</code> tiedostoa.</li></ul>",
  ...
  "UPDATE_UP_TO_DATE": "Sovelluksesi {APP_NAME} versio on uusin ja paras!",
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "Parantaaksemme sovellusta {APP_NAME} lähetämme ajoittain rajoitettuja, <strong>pseudonyymejä</strong> tilastoja ja virheraportteja osoitteeseen phcode.dev siitä, miten käytät {APP_NAME}. Nämä tiedot auttavat priorisoimaan ominaisuuksia, löytämään virheitä ja havaitsemaan käytettävyysongelmia samalla kun turvaat yksityisyyttäsi.<br><br> Voit nähdä tietosi tai päättää olla jakamatta tietoja valitsemalla <strong>Ohje &gt; Terveysraportti</strong> .<br><br>",
  "HEALTH_DATA_PREVIEW": "{APP_NAME}in terveydentilaraportti",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Parantaaksemme sovellusta {APP_NAME} lähetämme ajoittain rajoitettuja, <strong>pseudonyymejä</strong> tilastoja ja virheraportteja osoitteeseen phcode.dev siitä, miten käytät {APP_NAME}. Nämä tiedot auttavat priorisoimaan ominaisuuksia, löytämään virheitä ja havaitsemaan käytettävyysongelmia.</p><p> Alla on esikatselu tiedoista, jotka lähetetään seuraavassa terveysraportissasi, <em>jos</em> se on käytössä. (Katso myös kehittäjäkonsolista virhelokit, joissa on merkintä &quot;Caught Critical error&quot;.)</p>",
  ...
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>Safari poistaa verkkosivuston tiedot automaattisesti, jos sivustoa ei käytetä uudelleen 7 päivän kuluessa. {APP_NAME} käyttää selaimen tallennustilaa projektisi tallentamiseen, mikä saatetaan poistaa tämän käytännön vuoksi.<br/><br/> <strong>Estä tietojen häviäminen</strong> <strong>lataamalla</strong> projektisi ennen välilehden sulkemista tai seuraamalla <strong>tulevia verkko- ja alkuperäisiä Mac/iOS-sovelluksiamme</strong> .</span>",
