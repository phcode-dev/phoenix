...
define({
  ...
  "UPDATE_READY_RESTART_TITLE": "Päivitys valmis: Uudelleenkäynnistys vaaditaan",
  "UPDATE_READY_RESTART_MESSAGE": "Sulje kaikki {APP_NAME} -sovellusikkunat ja käynnistä sovellus uudelleen käynnistääksesi päivitetyn version.",
  "UPDATE_READY_RESTART_INSTALL_MESSAGE": "Päivitys ladattu onnistuneesti: Sulje kaikki sovelluksen {APP_NAME} sovellusikkunat ottaaksesi uusimmat päivitykset käyttöön.",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "Objekti, jolla on JSHint-oletusasetukset. Katso kaikki käytettävissä olevat JSHint-asetukset seuraavasta URL-osoitteesta: https://jshint.com/docs/options/",
