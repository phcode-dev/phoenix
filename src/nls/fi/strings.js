...
define({
  ...
  "DEVICE_SIZE_LIMIT_TITLE": "Saatavilla Phoenix Pro:ssa",
  "DEVICE_SIZE_LIMIT_MESSAGE": "Phoenix Pro:n avulla voit esikatsella sivuasi CSS:ssä määritellyillä näyttöko'oilla.",
  "AI_CHAT_TITLE": "Claude Code",
  "AI_CHAT_CLI_NOT_FOUND": "Claude Codea ei ole asennettu",
  "AI_CHAT_CLI_INSTALL_MSG": "Claude Code CLI on asennettava järjestelmääsi, jotta voit käyttää tekoälyominaisuuksia sovelluksessa {APP_NAME}. <a class='ai-learn-more-link' href='#'>Lue lisää</a>",
  ...
  "AI_CHAT_CLAUDE_LOGIN_TITLE": "Ota Claude Code käyttöön",
  ...
  "AI_CHAT_TOOL_PLANNING": "Suunnitellaan",
