...
define({
  ...
  "CMD_HOMEPAGE": "Kotisivu - Lataa sovelluksia",
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME} <strong>ei kerää tai käsittele henkilökohtaisia tunnistetietoja</strong> , mutta <strong>kerää anonyymejä käyttötilastoja</strong> suojatakseen yksityisyyttäsi. Nimettömät tiedot on vapautettu GDPR/CCPA-ilmoitusvaatimuksista, mutta uskomme, että sinun on valittava kieltäytyä anonyymista tiedonkeruusta.<br> Nämä <strong>anonyymit</strong> sovellusten käyttötilastot ja virheraportit auttavat priorisoimaan ominaisuuksia, löytämään virheitä ja havaitsemaan käytettävyysongelmia sovelluksen {APP_NAME} kanssa.</p><p> Alla on esikatselu tiedoista, jotka lähetetään seuraavassa terveysraportissasi <em>, jos</em> se on käytössä. (Katso myös kehittäjäkonsolista virhelokit, joissa on merkintä &quot;Caught Critical error&quot;.)</p>",
  ...
  "NEW_PROJECT_NOTIFICATION": "Napsauta tätä kuvaketta luodaksesi uuden projektin.</br><img src=\"styles/images/new_project.png\"><br/> <a href='#' style='float:right;'>okei</a>",
  ...
  "POWER_USER_POPUP_TITLE": "Miten voimme tehdä sovelluksesta APP_NAME} paremman?",
  "POWER_USER_POPUP_TEXT": "<div>Haluaisimme mielellämme palautettasi. Palautteesi auttaa meitä päättämään, mitä ominaisuuksia rakentaa ja mitä parannuksia alustaamme tulisi tehdä.<br/> <a>Ole hyvä ja täytä tämä lyhyt kysely.</a></div>",
