...
define({
  ...
  "DROP_TO_OPEN_FILES": "Avaa tiedostot pudottamalla",
  ...
  "ERROR_PREFS_RESET_TITLE": "Asetukset Reset - Uudelleenkäynnistys vaaditaan",
  ...
  "ERROR_PREFS_CORRUPT_RESET": "Sovelluksen {APP_NAME} asetuksesi ovat vaurioituneet ja ne on nollattu. Käynnistä {APP_NAME} uudelleen, jotta muutokset tulevat voimaan.",
  ...
  "UNSUPPORTED_DOM_APIS_CONFIRM": "Sovellusliittymät \"window.confirm\" ja \"window.prompt\" eivät ole käytettävissä sovelluksen {APP_NAME} upotetussa live-esikatselussa. Avaa Live Preview käyttääksesi näitä sovellusliittymiä selaimessa.",
  ...
  "LIVE_DEV_SETTINGS_BANNER": "Mukautetun palvelimen määrittäminen live-esikatseluun ` <b>{0}</b> ` ja muihin palvelimen luomiin tiedostoihin (PHP, JSP jne.)",
  ...
  "KEYBOARD_SHORTCUT_PRESET_TOOLTIP": "Käytä pikanäppäimiä muokkausohjelmista, kuten VSCode, WebStorm tai Sublime Text",
  "KEYBOARD_SHORTCUT_PRESET_SELECT": "Valitse Pikakuvakkeen esiasetukset",
  "KEYBOARD_SHORTCUT_PRESET_USING": "Käyttää {0}",
  "DEFAULT": "Oletus",
  ...
  "STATUSBAR_SELECTION_MULTIPLE": " — {0} Useita kohdistimen valintoja",
  ...
  "STATUSBAR_AUTO_INDENT": "<span title=\"Napsauta vaihtaaksesi kiinteisiin sisennyksiin. Tällä hetkellä asetettu tunnistamaan ja käyttämään sisennykset automaattisesti nykyisen tiedoston perusteella.\">Auto</span>",
  "STATUSBAR_FIXED_INDENT": "<span title=\"Napsauta siirtyäksesi automaattiseen sisennyksen tunnistukseen. Tällä hetkellä asetukseksi Kiinteä sisennys.\">Korjattu</span>",
  ...
  "CMD_AUTO_RENAME_TAGS": "Nimeä HTML-tunnisteet automaattisesti uudelleen",
  "FIND_MENU": "Etsi",
  "CMD_FIND": "Etsi",
  ...
  "CMD_VIEW_TOGGLE_PROBLEMS": "Ongelmia",
  ...
  "CMD_GOTO_NEXT_PROBLEM": "Siirry kohtaan Seuraava ongelma",
  "CMD_GOTO_PREV_PROBLEM": "Siirry kohtaan Edellinen ongelma",
  ...
  "CMD_OPEN_IN_CMD": "Komentorivi",
  "CMD_OPEN_IN_POWER_SHELL": "PowerShell",
  "CMD_OPEN_IN_DEFAULT_APP": "Järjestelmän oletussovellus",
  ...
  "FONT_LINE_HEIGHT": "Linjan korkeus",
  ...
  "EXTENSIONS_REGISTRY_TASK_TITLE": "Päivitetään laajennusluetteloa",
  ...
  "DESCRIPTION_AUTO_RENAME_TAGS": "true nimeää automaattisesti uudelleen HTML/XML-parin, muuten false",
  "DESCRIPTION_DRAG_AND_DROP_ENABLED": "true ottaaksesi käyttöön vedä ja pudota -toiminnon tiedostoille ja kansioille tiedostonhallinnasta tai Finderista",
  "DESCRIPTION_TRIPLE_CTRL_PALETTE": "true, jotta visuaalisen komennon peittokuva näytetään painettaessa Ctrl/Cmd-näppäintä kolme kertaa peräkkäin",
  ...
  "DESCRIPTION_AUTO_TAB_SPACE": "tosi tunnistaa automaattisesti nykyisessä tiedostossa käytetyt sarkaimet ja välilyönnit",
  ...
  "DESCRIPTION_EDITOR_LINE_HEIGHT": "Säädä koodirivien välistä pystyväliä editorissa. Valitse arvo väliltä 1–3, oletusarvo on 1,5",
  ...
  "PUBLISH": "Julkaista",
  "PUBLISH_CONSENT_MESSAGE": "Esikatsele muutokset nopeasti ja jaa verkkosivustosi muiden kanssa. {APP_NAME} voi julkaista tämän verkkosivuston puolestasi osoitteessa {0}. Julkaistut linkit ovat voimassa 3 päivää. </br>Haluatko julkaista ja jakaa verkkosivustosi?",
  ...
  "NEW_PROJECT_FROM_GIT": "Uusi projekti Gitiltä",
  "GIT_REPO_URL": "Git Repon URL-osoite:",
  "GIT_CLONE_URL": "Git Clonen URL-osoite:",
  ...
  "LOCATION": "Sijainti:",
  "ERROR_ONLY_GITHUB": "Sovelluksen {APP_NAME} selainversio tukee vain GitHub-URL-osoitteita. Käytä työpöytäsovellusta työskennelläksesi muiden Git-URL-osoitteiden kanssa.",
  "ERROR_GIT_URL_INVALID": "Anna kelvollinen Git-kloonin URL-osoite.",
  "ERROR_GIT_FOLDER_NOT_EMPTY": "Valittua kansiota ei voi käyttää Git-kloonille, koska se ei ole tyhjä tai sitä ei voi lukea.",
  "ERROR_GIT_FOLDER_NOT_EXIST": "Valittua kansiota ei voi käyttää Git-kloonille, koska sitä ei ole olemassa.",
  "ERROR_CLONING_TITLE": "Git-klooni epäonnistui",
  ...
  "DOWNLOAD_FAILED_MESSAGE": "Varmista, että lataus-URL-osoite on kelvollinen. </br>Huom. Koska Phoenix on ilmainen, yli 25 Mt:n yksityiset repot ja GitHub-URL-osoitteet eivät ole sallittuja.",
  ...
  "ADD_ENDLINE_TO_THE_END_OF_FILE": "Lisää loppurivi tiedoston loppuun",
  "ADD_TO_GITIGNORE": "Lisää .gitignoreen",
  "AMEND_COMMIT": "Muuta viimeistä sitoumusta",
  "SKIP_COMMIT_CHECKS": "Ohita sitoutumista edeltävät tarkistukset (--ei vahvista)",
  "AMEND_COMMIT_FORBIDDEN": "Ei voi muuttaa sitoumusta, jos ei ole työntämättömiä sitoumuksia",
  "_ANOTHER_BRANCH": "toinen haara",
  "AUTHOR": "Tekijä",
  "AUTHORS_OF": "Tekijät",
  "SYSTEM_CONFIGURATION": "Järjestelmän konfigurointi",
  "BRACKETS_GIT_ERROR": "Git havaitsi virheen…",
  "BRANCH_NAME": "Sivukonttorin nimi",
  "BUTTON_CANCEL": "Peruuta",
  "CHECKOUT_COMMIT": "Kassalle",
  "CHECKOUT_COMMIT_DETAIL": "<b>Vahvista viesti:</b> {0}<br> <b>Vahvista tiiviste:</b> {1}",
  "GIT_CLONE": "Klooni",
  "BUTTON_CLOSE": "Sulje",
  "BUTTON_COMMIT": "Sitoudu",
  "BUTTON_DEFAULTS": "Palauta oletusasetukset",
  "BUTTON_FIND_CONFLICTS": "Etsi ristiriitoja…",
  "GIT_INIT": "Lämpö",
  "BUTTON_MERGE_ABORT": "Peruuta yhdistäminen",
  "BUTTON_OK": "OK",
  "BUTTON_REBASE_ABORT": "Keskeyttää",
  "BUTTON_REBASE_CONTINUE": "Jatka rebasea",
  "BUTTON_REBASE_SKIP": "Ohita",
  "MENU_RESET_HARD": "Hylkää muutokset ja sitovat tämän jälkeen (hard reset)",
  "MENU_RESET_MIXED": "Hylkää sitoumukset tämän jälkeen, mutta pidä muutokset vaiheittamattomina (sekoitettu nollaus)",
  "MENU_RESET_SOFT": "Hylkää sitoumukset tämän jälkeen, mutta pidä muutokset vaiheittain (pehmeä nollaus)",
  ...
  "RESET_DETAIL": "<b>Sitoumukset seuraavien jälkeen hylätään:</b><br> <b>Vahvista viesti:</b> {0}<br> <b>Git-komento:</b> {1}",
  "RESET_HARD_MESSAGE": "Tämä toiminto hylkää kaikki muutokset ja sitoumukset valitun toimituksen jälkeen. <b>Tätä toimintoa ei voi helposti peruuttaa.</b> Haluatko varmasti jatkaa?<br><br> ⚠️ Varoitus: Tämä kirjoittaa historian uudelleen, eikä sitä tule käyttää sitoumuksissa, jotka on työnnetty jaettuun haaraan.",
  "RESET_MIXED_MESSAGE": "Tämä toiminto hylkää kaikki toimitukset valitun toimituksen jälkeen, mutta säilyttää kaikki muutokset vaiheittamattomina. <b>Tätä toimintoa ei voi helposti peruuttaa.</b> Haluatko varmasti jatkaa?<br><br> ⚠️ Varoitus: Tämä kirjoittaa historian uudelleen, eikä sitä tule käyttää sitoumuksissa, jotka on työnnetty jaettuun haaraan.",
  "RESET_SOFT_MESSAGE": "Tämä toiminto hylkää kaikki toimeksiannot valitun toimituksen jälkeen, mutta säilyttää kaikki muutokset tehtynä uutta toimitusta varten. <b>Tätä toimintoa ei voi helposti peruuttaa.</b> Haluatko varmasti jatkaa?<br><br> ⚠️ Varoitus: Tämä kirjoittaa historian uudelleen, eikä sitä tule käyttää sitoumuksissa, jotka on työnnetty jaettuun haaraan.",
  "BUTTON_SAVE": "Tallenna",
  "RESET": "Nollaa",
  "CHANGE_USER_EMAIL_TITLE": "Vaihda git-sähköposti",
  ...
  "REQUIRES_APP_RESTART_SETTING": "Tämän asetuksen muuttaminen vaatii sovelluksen uudelleenkäynnistyksen, jotta se tulee voimaan",
  "CLEAN_FILE_END": "Tiedosto puhdistettu",
  "CLEAN_FILE_START": "Tiedoston puhdistus",
  "CLEANING_WHITESPACE_PROGRESS": "Puhdistetaan välilyöntejä tiedostoista…",
  "CLEAR_WHITESPACE_ON_FILE_SAVE": "Tyhjennä välilyönnit tiedoston tallennuksen yhteydessä",
  "CLONE_REPOSITORY": "Klooni arkisto",
  "CODE_INSPECTION_PROBLEMS": "Koodin tarkastuksen ongelmat",
  "CODE_INSPECTION_IN_PROGRESS": "Koodin tarkastus käynnissä…",
  "CODE_INSPECTION_PROBLEMS_NONE": "Ei havaittuja ongelmia",
  "CODE_INSPECTION_DONE_FILES": "{0}/{1} tiedostoa valmis…",
  "PLEASE_WAIT": "Odota…",
  "COMMIT": "Sitoudu",
  "COMMIT_ALL_SHORTCUT": "Sitouta kaikki tiedostot…",
  "COMMIT_CURRENT_SHORTCUT": "Sitouta nykyinen tiedosto…",
  "COMMIT_MESSAGE_PLACEHOLDER": "Kirjoita vahvistusviesti tähän…",
  "CREATE_NEW_BRANCH": "Luo uusi haara…",
  "CREATE_NEW_BRANCH_TITLE": "Luo uusi haara",
  "CREATE_NEW_GITFTP_SCOPE": "Luo uusi Git-FTP-kaukosäädin…",
  "CREATE_NEW_REMOTE": "Luo uusi kaukosäädin…",
  "CURRENT_TRACKING_BRANCH": "Nykyinen seurantahaara",
  "_CURRENT_TRACKING_BRANCH": "nykyinen seurantahaara",
  "DEFAULT_GIT_TIMEOUT": "Git-toiminnan oletusaikakatkaisu (sekunteina)",
  "DELETE_FILE_BTN": "Poista tiedosto…",
  "DELETE_LOCAL_BRANCH": "Poista paikallinen haara",
  "DELETE_LOCAL_BRANCH_NAME": "Haluatko todella poistaa paikallisen sivukonttorin \"{0}\"?",
  "DELETE_REMOTE": "Poista kaukosäädin",
  "DELETE_REMOTE_NAME": "Haluatko todella poistaa kauko-ohjaimen \"{0}\"?",
  "DELETE_SCOPE": "Poista Git-FTP-alue",
  "DELETE_SCOPE_NAME": "Haluatko todella poistaa Git-FTP-alueen \"{0}\"?",
  "DIALOG_CHECKOUT": "Kun kirjataan ulos sitoumus, repo siirtyy DETACHED HEAD -tilaan. Et voi tehdä sitoumuksia, ellet luo haaraa tämän perusteella.",
  "DIALOG_PULL_TITLE": "Vedä kaukosäätimestä",
  "DIALOG_PUSH_TITLE": "Paina kaukosäätimeen",
  "SKIP_PRE_PUSH_CHECKS": "Ohita työntöä edeltävät tarkistukset (--no-verify)",
  "DIFF": "Diff",
  "DIFFTOOL": "Diff difftoolilla",
  "DIFF_FAILED_SEE_FILES": "Git-diff ei pystynyt tarjoamaan erotustuloksia. Tämä on luettelo vaiheittaisista sitovista tiedostoista:",
  "DIFF_TOO_LONG": "Ero liian pitkä näytettäväksi",
  "ENABLE_GERRIT_PUSH_REF": "Käytä Gerrit-yhteensopivaa push ref",
  "ENTER_NEW_USER_EMAIL": "Anna sähköpostiosoite",
  "ENTER_NEW_USER_NAME": "Anna käyttäjänimi",
  "ENTER_PASSWORD": "Anna salasana:",
  "ENTER_REMOTE_GIT_URL": "Anna kloonattavan arkiston Git-URL-osoite:",
  "ENTER_REMOTE_NAME": "Anna uuden kaukosäätimen nimi:",
  "ENTER_REMOTE_URL": "Anna uuden kaukosäätimen URL-osoite:",
  "ENTER_USERNAME": "Anna käyttäjänimi:",
  "ERROR_NOTHING_SELECTED": "Mitään ei ole valittu!",
  "ERROR_SAVE_FIRST": "Tallenna asiakirja ensin!",
  "ERROR_TERMINAL_NOT_FOUND": "Päätettä ei löytynyt käyttöjärjestelmällesi, voit määrittää mukautetun Terminal-komennon asetuksissa",
  "EXTENDED_COMMIT_MESSAGE": "LAAJENNETTU",
  "GETTING_STAGED_DIFF_PROGRESS": "Haetaan vaiheittaisten tiedostojen eroa…",
  "GIT_COMMIT": "Sitoudu…",
  ...
  "GUTTER_CLICK_DETAILS": "Napsauta saadaksesi lisätietoja",
  "HIDE_UNTRACKED": "Piilota jäljittämättömät tiedostot paneelissa",
  "HISTORY": "Historia",
  "HISTORY_COMMIT_BY": "kirjoittaja",
  "LINES": "Linjat",
  "_LINES": "rivit",
  "MARK_MODIFIED_FILES_IN_TREE": "Merkitse muokatut tiedostot tiedostopuuhun",
  "MERGE_BRANCH": "Yhdistä haara",
  "MERGE_MESSAGE": "Yhdistä viesti",
  "MERGE_RESULT": "Yhdistä tulos",
  "NORMALIZE_LINE_ENDINGS": "Normalisoi rivinpäätteet (\\n)",
  "NOTHING_TO_COMMIT": "Ei mitään sitovaa, toimiva hakemisto puhdas.",
  "OPERATION_IN_PROGRESS_TITLE": "Git-toiminta käynnissä…",
  "ORIGIN_BRANCH": "Alkuperähaara",
  "ON_BRANCH": "'{0}' - Nykyinen Git-haara",
  "PANEL_COMMAND": "Näytä Git-paneeli",
  "PASSWORD": "Salasana",
  "PASSWORDS": "Salasanat",
  "PATH_TO_GIT_EXECUTABLE": "Polku Git-suoritettavaan tiedostoon",
  "PULL_AVOID_MERGING": "Vältä manuaalista yhdistämistä",
  "PULL_DEFAULT": "Oletusyhdistäminen",
  "PULL_FROM": "Vedä pois",
  "PULL_MERGE_NOCOMMIT": "Yhdistä ilman sitoutumista",
  "PULL_REBASE": "Käytä kettua",
  "PULL_RESET": "Käytä pehmeää palautusta",
  "PULL_SHORTCUT": "Vedä kaukosäätimestä…",
  "PULL_SHORTCUT_BEHIND": "Vedä kaukosäätimestä ({0} takana)…",
  "PULL_BEHAVIOR": "Vetokäyttäytyminen",
  "FETCH_SHORTCUT": "Hae kaukosäätimestä",
  "PUSH_DEFAULT": "Oletustyöntö",
  "PUSH_DELETE_BRANCH": "Poista etähaara",
  "PUSH_SEND_TAGS": "Lähetä tunnisteet",
  "PUSH_FORCED": "Pakotettu työntö",
  "PUSH_SHORTCUT": "Työnnä kaukosäätimeen…",
  "PUSH_SHORTCUT_AHEAD": "Työnnä kaukosäätimeen ({0} eteenpäin)…",
  "PUSH_TO": "Työnnä",
  "PUSH_BEHAVIOR": "Työntökäyttäytyminen",
  "Q_UNDO_CHANGES": "Nollataanko muutokset tiedostoon <span class='dialog-filename'>{0}</span> ?",
  "REBASE_RESULT": "Fox tulos",
  "REFRESH_GIT": "Päivitä Git",
  "REMOVE_BOM": "Poista BOM tiedostoista",
  "REMOVE_FROM_GITIGNORE": "Poista tiedostosta .gitignore",
  "RESET_LOCAL_REPO": "Hylkää kaikki muutokset edellisen vahvistuksen jälkeen…",
  "DISCARD_CHANGES": "Hylkää muutokset",
  "RESET_LOCAL_REPO_CONFIRM": "Haluatko hylätä kaikki muutokset, jotka on tehty edellisen vahvistuksen jälkeen? Tätä toimintoa ei voi peruuttaa.",
  "UNDO_LOCAL_COMMIT_CONFIRM": "Oletko varma, että haluat kumota viimeisen ei-työnnetyn sitoumuksen?",
  "MORE_OPTIONS": "Lisää vaihtoehtoja",
  "CREDENTIALS": "Valtuustiedot",
  "SAVE_CREDENTIALS_HELP": "Sinun ei tarvitse täyttää käyttäjätunnusta/salasanaa, jos tunnistetietojasi hallitaan muualla. Käytä tätä vain, kun toimintasi aikakatkaisee jatkuvasti.",
  "SAVE_CREDENTIALS_IN_URL": "Tallenna tunnistetiedot etä-URL-osoitteeseen (pelkkä teksti)",
  "SET_THIS_BRANCH_AS_TRACKING": "Aseta tämä haara uudeksi seurantahaaraksi",
  "STRIP_WHITESPACE_FROM_COMMITS": "Poista loput välilyönnit sitoumuksista",
  "TARGET_BRANCH": "Kohdehaara",
  "TITLE_CHECKOUT": "Checkout Sitoudu?",
  "TOOLTIP_CLONE": "Kloonaa olemassa oleva arkisto",
  "TOOLTIP_COMMIT": "Sitouta valitut tiedostot",
  "TOOLTIP_FETCH": "Hae kaikki kaukosäätimet ja päivitä laskurit",
  "TOOLTIP_FIND_CONFLICTS": "Aloittaa Gitin yhdistämis-/uudelleenpohja-ristiriitojen haun projektissa",
  "TOOLTIP_HIDE_FILE_HISTORY": "Piilota tiedostohistoria",
  "TOOLTIP_HIDE_HISTORY": "Piilota historia",
  "TOOLTIP_INIT": "Alusta arkisto",
  "TOOLTIP_MERGE_ABORT": "Keskeytä yhdistämistoiminto ja palauta HEAD viimeiseen paikalliseen vahvistukseen",
  "TOOLTIP_PICK_REMOTE": "Valitse haluamasi kaukosäädin",
  "TOOLTIP_PULL": "Git Pull",
  "TOOLTIP_PUSH": "Git Push",
  "TOOLTIP_REBASE_ABORT": "Keskeytä rebase-toiminto ja palauta HEAD alkuperäiseen haaraan",
  "TOOLTIP_REBASE_CONTINUE": "Aloita uudelleenpohjausprosessi uudelleen, kun olet ratkaissut yhdistämisristiriidan",
  "TOOLTIP_REBASE_SKIP": "Aloita uudelleenasennusprosessi uudelleen ohittamalla nykyinen korjaustiedosto",
  "TOOLTIP_REFRESH_PANEL": "Päivitä paneeli",
  "TOOLTIP_SHOW_FILE_HISTORY": "Näytä tiedostohistoria",
  "TOOLTIP_SHOW_HISTORY": "Näytä historia",
  "UNDO_CHANGES": "Hylkää muutokset",
  "UNDO_CHANGES_BTN": "Hylkää muutokset…",
  "UNDO_LAST_LOCAL_COMMIT": "Kumoa viimeinen paikallinen (ei työnnetty) sitoumus…",
  "UNDO_COMMIT": "Kumoa sitoumus",
  "URL": "URL-osoite",
  "USERNAME": "Käyttäjätunnus",
  "USER_ABORTED": "Käyttäjä keskeytetty!",
  "USE_GIT_GUTTER": "Käytä Gitin kourujälkiä",
  "USE_NOFF": "Luo yhdistämistoimitus, vaikka yhdistäminen ratkeaisi pikakelauksena (--no-ff)",
  "USE_REBASE": "Käytä FOXia",
  "USE_VERBOSE_DIFF": "Näytä monisanainen tulos diff-muodossa",
  "USE_DIFFTOOL": "Käytä diftool-työkalua erotuksiin",
  "VIEW_AUTHORS_FILE": "Näytä tiedoston kirjoittajat…",
  "VIEW_AUTHORS_SELECTION": "Katso valinnan kirjoittajat…",
  "VIEW_THIS_FILE": "Näytä tämä tiedosto",
  "TAG_NAME_PLACEHOLDER": "Kirjoita tunnisteen nimi tähän…",
  "TAG_NAME": "Tag",
  ...
  "FILE_STAGED": "Lavastettu",
  "FILE_UNMERGED": "Yhdistetty",
  "FILE_UNMODIFIED": "Muokkaamaton",
  "FILE_UNTRACKED": "Seuraamaton",
  "GIT_PUSH_SUCCESS_MSG": "Pikakelaus onnistuneesti eteenpäin",
  "GIT_PUSH_FORCE_UPDATED_MSG": "Onnistui pakotettu päivitys",
  "GIT_PUSH_DELETED_MSG": "Viitenumeron poistaminen onnistui",
  "GIT_PUSH_NEW_REF_MSG": "Uusi ref. työnnetty onnistuneesti",
  "GIT_PUSH_REJECTED_MSG": "Ref hylättiin tai työntö epäonnistui",
  "GIT_PUSH_UP_TO_DATE_MSG": "Ref oli ajan tasalla, eikä sitä tarvinnut työntää",
  "GIT_PULL_SUCCESS": "Git pull suoritettu onnistuneesti",
  "GIT_MERGE_SUCCESS": "Git-yhdistäminen suoritettu onnistuneesti",
  "GIT_REBASE_SUCCESS": "Git-rebase suoritettu onnistuneesti",
  "GIT_BRANCH_DELETE_SUCCESS": "Git-haaran poisto onnistui",
  "INIT_NEW_REPO_FAILED": "Uuden arkiston alustaminen epäonnistui",
  "GIT_CLONE_REMOTE_FAILED": "Etävaraston kloonaus epäonnistui!",
  "GIT_CLONE_ERROR_EXPLAIN": "Valittu hakemisto `{0}`\n ei ole tyhjä. Git-klooni vaatii puhtaan, tyhjän hakemiston.\nJos se näyttää tyhjältä, tarkista piilotetut tiedostot.",
  "FOLDER_NOT_WRITABLE": "Valittu hakemisto `{0}`\n ei ole kirjoitettava.",
  "GIT_NOT_FOUND_MESSAGE": "Gitiä ei ole asennettu tai sitä ei löydy järjestelmästäsi. Asenna Git tai anna oikea polku Git-suoritettavaan tiedostoon alla olevaan tekstikenttään.",
  "ERROR_GETTING_BRANCH_LIST": "Haaraluettelon hakeminen epäonnistui",
  "ERROR_READING_GIT_HEAD": ".git/HEAD-tiedoston lukeminen epäonnistui",
  "ERROR_PARSING_BRANCH_NAME": "Haaran nimen jäsennys epäonnistui kohteesta {0}",
  "ERROR_READING_GIT_STATE": ".git-tilan lukeminen epäonnistui",
  "ERROR_GETTING_DELETED_FILES": "Poistettujen tiedostojen luettelon hakeminen epäonnistui",
  "ERROR_SWITCHING_BRANCHES": "Haarojen vaihto epäonnistui",
  "ERROR_GETTING_CURRENT_BRANCH": "Nykyisen haaran nimen hakeminen epäonnistui",
  "ERROR_REBASE_FAILED": "Rebase epäonnistui",
  "ERROR_MERGE_FAILED": "Yhdistäminen epäonnistui",
  "ERROR_BRANCH_DELETE_FORCED": "Haarojen pakotettu poisto epäonnistui",
  "ERROR_FETCH_REMOTE_INFO": "Etätietojen hakeminen epäonnistui",
  "ERROR_CREATE_BRANCH": "Uuden haaran luominen epäonnistui",
  "ERROR_REFRESH_GUTTER": "Kourujen virkistys epäonnistui!",
  "ERROR_GET_HISTORY": "Historian hakeminen epäonnistui",
  "ERROR_GET_MORE_HISTORY": "Lisää historiarivejä ei voitu ladata",
  "ERROR_GET_CURRENT_BRANCH": "Nykyisen haaran nimen hakeminen epäonnistui",
  "ERROR_GET_DIFF_FILE_COMMIT": "Eron saaminen epäonnistui",
  "ERROR_GET_DIFF_FILES": "Diff-tiedostojen luettelon lataaminen epäonnistui",
  "ERROR_MODIFY_GITIGNORE": ".gitignore-tiedoston muokkaaminen epäonnistui",
  "ERROR_UNDO_LAST_COMMIT_FAILED": "Viimeistä sitoumusta ei voi kumota",
  "ERROR_MODIFY_FILE_STATUS_FAILED": "Tiedoston tilan muokkaaminen epäonnistui",
  "ERROR_CHANGE_USERNAME_FAILED": "Käyttäjänimen vaihtaminen on mahdotonta",
  "ERROR_CHANGE_EMAIL_FAILED": "Käyttäjän sähköpostiosoitteen vaihtaminen on mahdotonta",
  "ERROR_TOGGLE_GERRIT_PUSH_REF_FAILED": "Ei voida vaihtaa gerrit push ref",
  "ERROR_RESET_LOCAL_REPO_FAILED": "Paikallisen arkiston nollaus epäonnistui",
  "ERROR_CREATE_TAG": "Tunnisteen luominen epäonnistui",
  "ERROR_CODE_INSPECTION_FAILED": "CodeInspection.inspectFilea ei voitu suorittaa tiedostolle",
  "ERROR_CANT_GET_STAGED_DIFF": "Vaiheittaisille tiedostoille ei voi saada eroa",
  "ERROR_GIT_COMMIT_FAILED": "Git Commit epäonnistui",
  "ERROR_GIT_BLAME_FAILED": "Git Blame epäonnistui",
  "ERROR_GIT_DIFF_FAILED": "Git Diff epäonnistui",
  "ERROR_DISCARD_CHANGES_FAILED": "Tiedostoon tehtyjen muutosten hylkääminen epäonnistui",
  "ERROR_COULD_NOT_RESOLVE_FILE": "Tiedostoa ei voitu ratkaista",
  "ERROR_MERGE_ABORT_FAILED": "Yhdistämisen keskeytys epäonnistui",
  "ERROR_MODIFIED_DIALOG_FILES": "Toimitettavat tiedostot muokattiin, kun toimitusikkuna oli näkyvissä. Toimituksen keskeyttäminen, koska tulos olisi erilainen kuin mitä dialogissa näytettiin.",
  "ERROR_GETTING_REMOTES": "Kaukosäätimen saaminen epäonnistui!",
  "ERROR_REMOTE_CREATION": "Etäluonti epäonnistui",
  "ERROR_PUSHING_REMOTE": "Kaukosäätimeen työntäminen epäonnistui",
  "ERROR_PULLING_REMOTE": "Kaukosäätimestä vetäminen epäonnistui",
  "ERROR_PULLING_OPERATION": "Vetotoiminto epäonnistui",
  "ERROR_PUSHING_OPERATION": "Työntötoiminto epäonnistui",
  "ERROR_NO_REMOTE_SELECTED": "Kaukosäädintä ei ole valittu kohteelle {0}!",
  "ERROR_BRANCH_LIST": "Haaraluettelon hakeminen epäonnistui",
  "ERROR_FETCH_REMOTE": "Etätietojen hakeminen epäonnistui"
});