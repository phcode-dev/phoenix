...
define({
  ...
  "UPDATE_READY_RESTART_MESSAGE": "Sulje kaikki {APP_NAME}-ikkunat ja käynnistä sovellus uudelleen käynnistääksesi päivitetyn version.",
  "UPDATE_FAILED_TITLE": "Päivitys epäonnistui",
  "UPDATE_FAILED_MESSAGE": "Sulje kaikki {APP_NAME}-ikkunat ja avaa sovellus uudelleen yrittääksesi päivittää uudelleen.",
