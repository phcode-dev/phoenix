...
define({
  ...
  "LIVE_DEV_SETTINGS_ELEMENT_HIGHLIGHT_PREFERENCE": "Näytä live-esikatselun elementtien korostukset osoitettaessa ('hover') tai napsautettaessa ('click'). Oletusarvo on 'hover'.",
  ...
  "LIVE_DEV_MORE_OPTIONS_EDIT_HYPERLINK": "Muokkaa hyperlinkkiä",
  ...
  "LIVE_DEV_MORE_OPTIONS_MORE": "Lisää vaihtoehtoja",
  ...
  "IMAGE_SEARCH_MONTHLY_LIMIT_MESSAGE": "Olet käyttänyt kaikki {0} tämän kuun kuvahakua.<br>Aloita maksullinen Phoenix Pro -tilaus poistaaksesi kokeilurajoitukset ja jatkaaksesi hakua."
});