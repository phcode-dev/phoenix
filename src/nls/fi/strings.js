...
define({
  ...
  "AI_CHAT_DESKTOP_ONLY": "Tekoälyominaisuudet vaativat Phoenix-työpöytäsovelluksen. Lataa se, niin pääset alkuun.",
  ...
  "AI_CHAT_UPSELL_MESSAGE": "Tekoälyominaisuudet ovat saatavilla Phoenix Pro:lla.",
  ...
  "AI_CHAT_HISTORY_DAYS_AGO": "{0} p sitten",
  ...
  "AI_CHAT_SWITCH_PROJECT_MSG": "Tekoäly käsittelee parhaillaan tehtävää. Projektin vaihtaminen keskeyttää sen. Jatketaanko?"
});