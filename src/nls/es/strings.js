...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "El archivo <code>package.json</code> no se detectó en el proyecto actual. ¿El proyecto actual es una extensión válida de {APP_NAME}?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "El archivo <code>package.json</code> no es JSON válido.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "Faltan campos obligatorios en <code>package.json</code> : [{0}]",
