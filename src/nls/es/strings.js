...
define({
  ...
  "CMD_HOMEPAGE": "Página de inicio - Descargar aplicaciones",
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME} <strong>no recopila ni procesa ninguna información de identificación personal</strong> , pero <strong>recopila estadísticas de uso anónimas</strong> para proteger su privacidad. Los datos anónimos están exentos de los requisitos de notificación del RGPD/CCPA, pero creemos que usted debe tener la opción de optar por no participar en la recopilación de datos anónimos.<br> Estas estadísticas <strong>anónimas</strong> de uso de aplicaciones e informes de errores ayudan a priorizar funciones, encontrar errores y detectar problemas de usabilidad para tu experiencia con {APP_NAME}.</p><p> A continuación se muestra una vista previa de los datos que se enviarán en su próximo Informe de salud <em>si</em> está habilitado. (Consulte también la consola del desarrollador para ver los registros de errores marcados como &quot;Error crítico detectado&quot;).</p>",
  ...
  "VIEW_MORE": "Ver más...",
  "NEW_PROJECT_NOTIFICATION": "Haga clic en este icono para crear un nuevo proyecto.</br><img src=\"styles/images/new_project.png\"><br/> <a href='#' style='float:right;'>OK</a>",
  ...
  "POWER_USER_POPUP_TITLE": "¿Cómo podemos mejorar {APP_NAME} para ti?",
  "POWER_USER_POPUP_TEXT": "<div>Nos encantaría recibir sus comentarios. Sus comentarios nos ayudan a decidir qué características crear y qué mejoras se deben realizar en nuestra plataforma.<br/> <a>Por favor complete esta breve encuesta.</a></div>",
