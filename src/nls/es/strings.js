...
define({
  ...
  "INCLUDE_FILE_FILTER": "Incluir {0}",
  "EXCLUDE_FILE_FILTER_DROPDOWN": "Excluir",
  "INCLUDE_FILE_FILTER_DROPDOWN": "Incluir",
  "EDIT_FILE_FILTER": "Editar…",
  "FILE_FILTER_DIALOG": "Editar filtro de exclusión",
  "FILE_FILTER_INSTRUCTIONS": "Excluya archivos y carpetas que coincidan con cualquiera de los siguientes <a href='{0}' title=\"{0}\">, ignore los comodines</a> . Ingrese cada cadena en una nueva línea. P.ej<ul><li> <code>*.js</code> coincidirá con <code>a/b/x.js</code> , <code>xyx.js</code> , etc.</li><li> <code>./*.css</code> solo coincidirá <code>x.css</code> en la raíz del proyecto, pero no con <code>y/x.css</code> en la subcarpeta.</li></ul>",
  "FILE_FILTER_INSTRUCTIONS_INCLUDE": "Incluya sólo archivos y carpetas que coincidan con cualquiera de los siguientes, <a href='{0}' title=\"{0}\">ignore los comodines</a> . Ingrese cada cadena en una nueva línea. P.ej<ul><li> <code>*.js</code> coincidirá con <code>a/b/x.js</code> , <code>xyx.js</code> , etc.</li><li> <code>./*.css</code> solo coincidirá <code>x.css</code> en la raíz del proyecto, pero no con <code>y/x.css</code> en la subcarpeta.</li></ul>",
  ...
  "UPDATE_UP_TO_DATE": "¡Tu versión de {APP_NAME} es la última y mejor!",
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "Con el fin de mejorar {APP_NAME}, periódicamente enviamos estadísticas limitadas y <strong>seudónimas</strong> e informes de errores a phcode.dev sobre cómo usas {APP_NAME}. Esta información ayuda a priorizar funciones, encontrar errores y detectar problemas de usabilidad mientras protege su privacidad.<br><br> Puede ver sus datos o elegir no compartirlos seleccionando <strong>Ayuda &gt; Informe de salud</strong> .<br><br>",
  "HEALTH_DATA_PREVIEW": "Reporte de estadísticas de {APP_NAME}",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Con el fin de mejorar {APP_NAME}, periódicamente enviamos estadísticas limitadas y <strong>seudónimas</strong> e informes de errores a phcode.dev sobre cómo usas {APP_NAME}. Esta información ayuda a priorizar funciones, encontrar errores y detectar problemas de usabilidad.</p><p> A continuación se muestra una vista previa de los datos que se enviarán en su próximo informe de salud <em>si</em> está habilitado. (Consulte también la consola del desarrollador para ver los registros de errores marcados como &quot;Error crítico capturado&quot;).</p>",
