...
define({
  ...
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>Safari elimina automáticamente los datos del sitio web si no se vuelve a visitar un sitio dentro de los 7 días. {APP_NAME} depende del almacenamiento del navegador para guardar sus proyectos, que pueden eliminarse debido a esta política.<br/><br/> <strong>Para evitar la pérdida de datos</strong> , <strong>descargue</strong> sus proyectos antes de cerrar la pestaña o esté atento a nuestras <strong>próximas aplicaciones web y nativas para Mac/iOS</strong> .</span>",
