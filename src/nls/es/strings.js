...
define({
  ...
  "ERR_TYPE_PASTE_FAILED": "Se ha producido un error al pegar <span class='dialog-filename'>{0}</span> en <span class='dialog-filename'>{1}</span>",
  "CANNOT_DUPLICATE_TITLE": "No puede duplicarse",
  "ERR_TYPE_DUPLICATE_FAILED": "Se ha producido un error al duplicar <span class='dialog-filename'>{0}</span>",
  ...
  "EXTRACTING_FILES_PROGRESS": "Extracción de {0} de {1} archivos.",
  ...
  "GUIDED_LIVE_PREVIEW_POPOUT": "Haga clic en este botón para mostrar la vista previa en vivo en una nueva pestaña. </br><a href='#' style='float:right;'>ok</a>",
  "TEST_TRANSLATE": "usa esto para probar las traducciones",
  "BEAUTIFY_ERROR": "No se pudo embellecer el código Compruebe la sintaxis.",
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "No se pudo embellecer. El texto del editor cambió tras embellecerlo.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Archivo embellecedor {0}",
  "BEAUTIFY_ERROR_SELECTION": "No se pudo embellecer. </br>Se seleccionó un bloque de código incompleto o sintaxis no",
  "BEAUTIFY_OPTIONS": "Opciones que controlan cómo funciona Beautify Code",
  "BEAUTIFY_OPTION_PRINT_WIDTH": "Especificar la longitud de línea que se ajustará el embellecedor",
  ...
  "BEAUTIFY_OPTION_BRACKET_SAME_LINE": "Coloque el > de un elemento HTML multilínea (HTML, JSX, Vue, Angular) al final de la última línea en lugar de estar solo en la siguiente línea (no se aplica a los elementos de cierre automático)",
  "BEAUTIFY_OPTION_SINGLE_ATTRIBUTE_PER_LINE": "Aplicar un solo atributo por línea en HTML, Vue y JSX",
  "BEAUTIFY_OPTION_PROSE_WRAP": "Ajustar la prosa si supera el ancho de impresión en los archivos markdown",
  "BEAUTIFY_OPTION_PRINT_TRAILING_COMMAS": "Imprima comas finales siempre que sea posible en estructuras sintácticas de varias líneas separadas por comas"
});