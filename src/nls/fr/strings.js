...
define({
  ...
  "DEVICE_SIZE_LIMIT_TITLE": "Disponible dans Phoenix Pro",
  ...
  "LIVE_PREVIEW_SYNC_SOURCE_AND_PREVIEW": "Synchroniser le code et l'aperçu",
  "LIVE_DEV_SETTINGS_SYNC_SOURCE_AND_PREVIEW_PREFERENCE": "Synchronise le curseur du code source avec la mise en surbrillance de l'élément dans l'aperçu en direct. Lorsque cette option est activée, le déplacement du curseur dans l'éditeur met en surbrillance l'élément correspondant dans l'aperçu en direct, et un clic sur un élément dans l'aperçu en direct place le curseur sur son code source. Activé par défaut.",
