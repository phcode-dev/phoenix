...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "Fichier <code>package.json</code> non détecté dans le projet en cours. Le projet actuel est-il une extension {APP_NAME} valide ?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "Le fichier <code>package.json</code> est un JSON non valide.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "Champs obligatoires manquants dans <code>package.json</code> : [{0}]",
