...
define({
  ...
  "AI_CHAT_TITLE_NO_AI": "IA Phoenix Code",
  ...
  "AI_CHAT_CLI_INSTALL_MSG": "L'interface de ligne de commande (CLI) de Claude Code doit être installée sur votre système pour utiliser les fonctionnalités d'IA dans {APP_NAME}. <a class='ai-learn-more-link' href='#'>En savoir plus</a>",
  ...
  "AI_CHAT_CLAUDE_LOGIN_MSG": "Claude Code est installé mais doit être configuré. <a class='ai-learn-more-link' href='#'>En savoir plus</a>",
  ...
  "AI_CHAT_DESKTOP_ONLY": "Les fonctionnalités d'IA nécessitent l'application de bureau Phoenix. Téléchargez-la pour commencer.",
  "AI_CHAT_DOWNLOAD_BTN": "Télécharger l'application de bureau",
  "AI_CHAT_LOGIN_TITLE": "Connectez-vous pour utiliser l'IA",
  ...
  "AI_CHAT_INTRO_CONFIGURE_DESC": "Regardez cette courte vidéo sur la configuration de l'IA",
  ...
  "PROMO_CARD_2": "L'IA dans votre éditeur",
  "PROMO_CARD_2_MESSAGE": "Demandez à l'IA d'écrire du code, de corriger des bogues ou de refactoriser votre projet. Elle fait le travail pour vous.",
  "PROMO_CARD_3": "Aperçu sur n'importe quel appareil",
  "PROMO_CARD_3_MESSAGE": "Redimensionnez l'aperçu en direct pour l'adapter à n'importe quel téléphone, tablette ou fenêtre d'affichage personnalisée - détectez les problèmes d'affichage adaptatif avant la mise en production.",
  "PROMO_CARD_4": "Markdown enrichi, en direct",
  "PROMO_CARD_4_MESSAGE": "Un aperçu Markdown côte à côte soigné avec des diagrammes, des tableaux et des blocs de code, affiché au fur et à mesure de votre frappe."
});