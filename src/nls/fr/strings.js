...
define({
  ...
  "UPDATE_CLOSE_TO_UPDATE_TITLE": "Impossible de mettre à jour",
  "UPDATE_CLOSE_TO_UPDATE": "Plusieurs fenêtres de l'éditeur sont ouvertes. Veuillez vous assurer que toutes les autres fenêtres de l'éditeur {APP_NAME} sont fermées avant de tenter la mise à jour. Fermez toutes les fenêtres {APP_NAME} supplémentaires et réessayez de mettre à jour.",
