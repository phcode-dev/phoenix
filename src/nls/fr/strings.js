...
define({
  ...
  "AI_CHAT_CLI_INSTALL_MSG": "Le CLI de Claude Code doit être installé sur votre système pour utiliser les fonctionnalités d'IA dans {APP_NAME}. <a class='ai-learn-more-link' href='#'>En savoir plus</a>",
  "AI_CHAT_CLI_INSTALL_BTN": "Installer Claude Code",
  "AI_CHAT_CLI_INSTALLING": "Installation en cours…",
  "AI_CHAT_CLI_INSTALLING_MSG": "Installation de Claude Code, veuillez patienter. Cela peut prendre un certain temps...",
