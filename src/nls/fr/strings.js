...
define({
  ...
  "DESCRIPTION_LIVEDEV_MAIN_HEADING": "Oh non ! Votre navigateur actuel ne prend pas en charge l'aperçu en direct.",
  "DESCRIPTION_LIVEDEV_MAIN_SPAN": "Obtenez la meilleure expérience d'aperçu en direct en téléchargeant nos applications natives pour Windows, Mac et Linux à partir de {0}.",
  ...
  "AI_CHAT_TOOL_REJECTED_REASON": "Raison : {0}",
  ...
  "AI_CHAT_DIFF_EXPAND_ALL": "Développer tout",
  "AI_CHAT_DIFF_COLLAPSE_ALL": "Réduire tout",
  "AI_CHAT_DIFF_ALWAYS_SHOW": "Toujours afficher",
  "AI_CHAT_PLAN_WRITE_CONFIRM_TITLE": "Passer en mode édition ?",
  "AI_CHAT_PLAN_WRITE_CONFIRM_BODY": "Claude veut modifier {0}. Vous êtes actuellement en mode planification.",
  "AI_CHAT_PLAN_WRITE_ALLOW": "Autoriser et passer en mode édition",
  "AI_CHAT_PLAN_WRITE_STAY": "Rester en mode planification",
  "AI_CHAT_PLAN_WRITE_ALLOWED": "Passage en mode édition",
  "AI_CHAT_PLAN_WRITE_STAYED": "Maintien du mode planification"
});