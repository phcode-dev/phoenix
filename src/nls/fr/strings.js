...
define({
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "Un objet avec les options par défaut pour JShint. Veuillez consulter l'URL suivante pour connaître toutes les options JSHint disponibles : https://jshint.com/docs/options/",
  ...
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Impossible de l'embellir. Texte de l'éditeur modifié après l'embellissement.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Fichier d'embellissement {0}",
  "BEAUTIFY_ERROR_SELECTION": "Impossible de l'embellir. </br>Bloc de code sélectionné incomplet ou syntaxe non valide.",
  "BEAUTIFY_OPTIONS": "Options qui contrôlent le fonctionnement de Beautify Code",
  "BEAUTIFY_OPTION_PRINT_WIDTH": "Spécifiez la longueur de ligne sur laquelle l'embellisseur va envelopper",
  "BEAUTIFY_OPTION_SEMICOLON": "Ajoutez un point-virgule à la fin de chaque instruction",
  "BEAUTIFY_OPTION_SINGLE_QUOTE": "Utilisez des guillemets simples au lieu de guille",
  "BEAUTIFY_OPTION_QUOTE_PROPS": "Modifier le moment où les propriétés des objets sont citées",
  "BEAUTIFY_OPTION_BRACKET_SAME_LINE": "Placer le > d'un élément HTML multiligne (HTML, JSX, Vue, Angular) à la fin de la dernière ligne au lieu d'être seul sur la ligne suivante (ne s'applique pas aux éléments à fermeture automatique)",
  "BEAUTIFY_OPTION_SINGLE_ATTRIBUTE_PER_LINE": "Appliquer un seul attribut par ligne dans HTML, Vue et JSX",
  "BEAUTIFY_OPTION_PROSE_WRAP": "Envelopper la prose si elle dépasse la largeur d'impression dans les fichiers Markdown",
  "BEAUTIFY_OPTION_PRINT_TRAILING_COMMAS": "Imprimez des virgules de fin dans la mesure du possible dans des structures syntaxiques séparées par des virgules sur plusieurs lignes"
});