...
define({
  ...
  "DELETE_TO_TRASH": "Déplacer {0} vers la corbeille",
  "DELETE_TO_RECYCLE_BIN": "Déplacer {0} vers la corbeille",
  "RENAMING": "Renommer",
  "STORED_IN_YOUR_BROWSER": "Stocké dans votre navigateur",
  "SUPPORT_US_OPEN_COLLECTIVE": "Soutenez-nous sur les sponsors GitHub",
  ...
  "DROP_TO_OPEN_PROJECT": "Déposer dans le dossier ouvert `{0}` en tant que projet",
  ...
  "UNSUPPORTED_DOM_APIS_CONFIRM": "Les API « window.confirm » et « window.prompt » ne sont pas disponibles dans l'aperçu en direct intégré de {APP_NAME}. Veuillez ouvrir l'aperçu en direct pour utiliser ces API dans le navigateur.",
  ...
  "LIVE_DEV_SETTINGS": "Paramètres d'aperçu en direct…",
  "LIVE_DEV_SETTINGS_BANNER": "Configurez un serveur personnalisé pour prévisualiser en direct `<b> {0}</b> ` et d&#39;autres fichiers rendus par le serveur (PHP, JSP, etc.)",
  "LIVE_DEV_SETTINGS_TITLE": "Paramètres d'aperçu en direct",
  ...
  "LIVE_DEV_SETTINGS_STARTUP_PREFERENCE": "true pour afficher le panneau de prévisualisation en direct au démarrage",
  "LIVE_DEV_SETTINGS_HOT_RELOAD_PREFERENCE": "vrai si le serveur prend en charge le rechargement à chaud et désactive le rechargement de l'aperçu en direct lors de l'enregistrement",
  "LIVE_DEV_SETTINGS_USE_SERVER": "Utiliser un serveur de développement personnalisé pour ce projet",
  "LIVE_DEV_SETTINGS_SERVE_PREFERENCE": "L'URL de votre serveur de développement pour le projet, par exemple. http://localhost:8000/php",
  "LIVE_DEV_SETTINGS_SERVER_INBUILT": "Par exemple. http://localhost:8000/php - Utilise actuellement le serveur intégré.",
  "LIVE_DEV_SETTINGS_SERVER_ROOT": "Servir le dossier dans le projet",
  "LIVE_DEV_SETTINGS_SERVER_ROOT_HELP": "Par exemple. www/ (La valeur par défaut est /)",
  "LIVE_DEV_SETTINGS_SERVER_ROOT_PREF": "Chemin dans le projet servi par Development Server, par exemple. www/ (La valeur par défaut est /)",
  "LIVE_DEV_SETTINGS_RELOAD": "Le serveur prend en charge le rechargement à chaud",
  "LIVE_DEV_SETTINGS_RELOAD_HELP": "Certains serveurs prennent en charge le rechargement à chaud où les modifications de code sont poussées vers la page sans rechargement complet de la page.\nActivez cette fonctionnalité si vous ne souhaitez pas que {APP_NAME} recharge la page à chaque sauvegarde.",
  "LIVE_DEV_SETTINGS_FRAMEWORK": "Cadre de serveur",
  "LIVE_DEV_SETTINGS_FRAMEWORK_CUSTOM": "Coutume",
  "LIVE_DEV_SETTINGS_FRAMEWORK_PREFERENCES": "Server Framework, ne prend actuellement en charge que Docusaurus",
  "LIVE_PREVIEW_CUSTOM_SERVER_BANNER": "Obtenir un aperçu à partir de votre serveur personnalisé {0}",
  ...
  "CONFIRM_FILE_DELETE_TRASH": "Etes-vous sûr de vouloir supprimer le fichier <span class='dialog-filename'>{0}</span> ?<br> Vous pouvez restaurer ce fichier depuis la corbeille.",
  "CONFIRM_FOLDER_DELETE_TRASH": "Etes-vous sûr de vouloir supprimer le dossier <span class='dialog-filename'>{0}</span> ?<br> Vous pouvez restaurer ce dossier depuis la corbeille.",
  "CONFIRM_FILE_DELETE_RECYCLE_BIN": "Etes-vous sûr de vouloir supprimer le fichier <span class='dialog-filename'>{0}</span> ?<br> Vous pouvez restaurer ce fichier depuis la corbeille.",
  "CONFIRM_FOLDER_DELETE_RECYCLE_BIN": "Etes-vous sûr de vouloir supprimer le dossier <span class='dialog-filename'>{0}</span> ?<br> Vous pouvez restaurer ce dossier depuis la corbeille.",
  ...
  "KEYBOARD_SHORTCUT_PRESET_TOOLTIP": "Utilisez les raccourcis clavier d'éditeurs comme VSCode, WebStorm ou Sublime Text",
  "KEYBOARD_SHORTCUT_PRESET_SELECT": "Sélectionnez les préréglages de raccourci",
  "KEYBOARD_SHORTCUT_PRESET_USING": "Utiliser {0}",
  "DEFAULT": "Par défaut",
  ...
  "KEYBOARD_SHORTCUT_SRC_PRESET": "{0} Préréglage",
  "STATUSBAR_CURSOR_POSITION": "Ligne {0}, colonne {1}",
  "STATUSBAR_CURSOR_POSITION_SHORT": "{0} : {1}",
  "STATUSBAR_CURSOR_GOTO": "Cliquez pour aller à une autre : ligne",
  ...
  "STATUSBAR_SELECTION_MULTIPLE": "— {0} Sélections multiples de curseur",
  ...
  "STATUSBAR_AUTO_INDENT": "<span title=\"Cliquez pour passer aux retraits fixes. Actuellement configuré pour détecter et appliquer automatiquement les retraits en fonction du fichier actuel.\">Auto</span>",
  "STATUSBAR_FIXED_INDENT": "<span title=\"Cliquez pour passer à la détection automatique du retrait. Actuellement défini sur Retrait fixe.\">Fixé</span>",
  ...
  "ERRORS_PANEL_TITLE_MULTIPLE_FIXABLE": "{0} Problèmes, {1} Réparables – {2}",
  "SINGLE_ERROR": "1 {0} Problème – {1}",
  "SINGLE_ERROR_FIXABLE": "1 {0} Problème, {1} Réparable – {2}",
  "MULTIPLE_ERRORS": "{0} {1} Problèmes – {2}",
  "MULTIPLE_ERRORS_FIXABLE": "{0} {1} Problèmes, {2} Réparables – {3}",
  ...
  "COPY_ERROR": "Problème de copie",
  "FIX": "Réparer",
  "CANNOT_FIX_TITLE": "Échec de l'application du correctif",
  "CANNOT_FIX_SOME_TITLE": "Échec de l'application de certains correctifs",
  "CANNOT_FIX_MESSAGE": "Le document a été modifié depuis la préparation du correctif. Veuillez réessayer.",
  ...
  "CMD_LIVE_FILE_PREVIEW_SETTINGS": "Paramètres d'aperçu en direct",
  ...
  "CMD_SHOW_IN_FINDER": "Recherche macOS",
  "CMD_SHOW_IN_FILE_MANAGER": "Gestionnaire de fichiers",
  "CMD_OPEN_IN_CMD": "Invite de commande",
  ...
  "CMD_ENABLE_DRAG_AND_DROP": "Glisser-déposer des fichiers",
  ...
  "UPDATE_WHATS_NEW": "Quoi de neuf dans {APP_NAME}",
  "UPDATE_READY_RESTART_TITLE": "Redémarrez l'application pour mettre à jour",
  ...
  "UPDATE_FAILED_MESSAGE": "Veuillez fermer toutes les fenêtres de l&#39;application {APP_NAME} et rouvrir l&#39;application pour tenter à nouveau la mise à jour.<br/> Vous pouvez également installer la mise à jour en téléchargeant le programme d&#39;installation depuis <a href='https://phcode.io'>phcode.io</a>",
  ...
  "EXTENSIONS_REGISTRY_TASK_MESSAGE": "Téléchargement…",
  ...
  "CMD_ENABLE_GIT_LOGS": "Journaux détaillés de Git",
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME} <strong>ne collecte ni ne traite aucune information personnelle identifiable</strong> , mais <strong>collecte des statistiques d&#39;utilisation anonymes</strong> pour protéger votre vie privée. Ces statistiques <strong>anonymes</strong> d&#39;utilisation des applications et ces rapports d&#39;erreurs permettent de hiérarchiser les fonctionnalités, de détecter les bugs et de repérer les problèmes d&#39;utilisation afin d&#39;améliorer votre expérience avec {APP_NAME}.</p><p> Vous trouverez ci-dessous un aperçu des données qui seront envoyées dans votre prochain rapport de santé <em>si</em> elles sont activées. (Voir également la console du développeur pour les journaux d&#39;erreurs marqués « Erreur critique détectée ».)</p>",
  ...
  "JSHINT_NAME": "JSHint",
  "JSHINT_CONFIG_ERROR": "Erreur de lecture du fichier de configuration JSHint : {0}",
  "JSHINT_CONFIG_JSON_ERROR": "Erreur : le fichier de configuration JSHint `{0}` n'est pas un JSON valide",
  "ESLINT_NAME": "ESLint",
  "CSS_LINT_NAME": "{0}",
  "HTML_LINT_NAME": "HTML",
  "HTML_LINT_CONFIG_JSON_ERROR": "Erreur : le fichier de configuration du validateur HTML `{0}` n'est pas un JSON valide",
  "HTML_LINT_CONFIG_UNSUPPORTED": "Erreur : format de configuration `{0}` non pris en charge. Utilisez la configuration JSON `.htmlvalidate.json`",
  ...
  "DESCRIPTION_JSHINT_DISABLE": "true pour désactiver le linter JSHints dans le panneau des problèmes",
  ...
  "DESCRIPTION_ESLINT_FAILED": "Échec d&#39;ESLint ({0}). Assurez-vous que le projet contient <a href='https://eslint.org/docs/latest/use/configure/configuration-files'>des fichiers de configuration</a> valides",
  "DESCRIPTION_ESLINT_USE_NATIVE_APP": "ESLint est uniquement disponible dans l&#39;application de bureau. Téléchargez-le depuis <a href='https://phcode.io'>phcode.io</a>",
  "DESCRIPTION_ESLINT_LOAD_FAILED": "Échec du chargement d'ESLint pour ce projet. {APP_NAME} prend en charge uniquement les versions ESLint supérieures à 7.",
  ...
  "DESCRIPTION_RULERS_COLUMNS": "Un tableau de numéros de colonnes pour dessiner des règles verticales dans l'éditeur. Par exemple : [80, 100]",
  "DESCRIPTION_RULERS_COLORS": "Un tableau de couleurs de règle correspondant à l’option de règles dans l’éditeur. Par exemple : [\"#3d3d3d\", \"rouge\"]",
  "DESCRIPTION_RULERS_ENABLED": "true pour activer les règles de l'éditeur, sinon false",
  "DESCRIPTION_AUTO_RENAME_TAGS": "true pour renommer automatiquement la balise HTML/XML appariée, sinon false",
  "DESCRIPTION_DRAG_AND_DROP_ENABLED": "true pour activer la fonctionnalité glisser-déposer pour les fichiers et dossiers à partir de l'explorateur de fichiers ou du Finder",
  "DESCRIPTION_TRIPLE_CTRL_PALETTE": "true pour activer l'affichage de la superposition de commandes visuelles en appuyant sur la touche Ctrl/Cmd 3 fois consécutives",
  ...
  "DESCRIPTION_AUTO_TAB_SPACE": "vrai pour détecter automatiquement les tabulations et les espaces utilisés dans le fichier actuel",
  ...
  "DESCRIPTION_LIVEDEV_NO_PREVIEW_EXCLUDED": "Les paramètres d'aperçu en direct sont configurés pour diffuser uniquement les fichiers du dossier « {0} »",
  ...
  "PUBLISH": "Publier",
  "PUBLISH_CONSENT_MESSAGE": "Prévisualisez rapidement les modifications et partagez votre site Web avec d’autres. {APP_NAME} peut publier ce site Web pour vous sur {0}. Les liens publiés seront valables pour une durée de 3 jours. </br>Vous souhaitez publier et partager votre site internet ?",
  ...
  "GIT_PROJECT": "Obtenir depuis Git",
  "NEW_PROJECT_FROM_GIT": "Nouveau projet de Git",
  ...
  "ERROR_ONLY_GITHUB": "La version du navigateur de {APP_NAME} ne prend en charge que les URL GitHub. Pour travailler avec d'autres URL Git, veuillez utiliser l'application de bureau.",
  "ERROR_GIT_URL_INVALID": "Veuillez saisir une URL de clone Git valide.",
  ...
  "DOWNLOAD_FAILED_MESSAGE": "Assurez-vous que l'URL de téléchargement est valide. </br>NB : Phoenix étant gratuit, les dépôts privés et les URL GitHub supérieurs à 25 Mo ne sont pas autorisés.",
  ...
  "VIEW_MORE": "Voir plus...",
  "NEW_PROJECT_NOTIFICATION": "Cliquez sur cette icône pour ouvrir à nouveau la fenêtre « Nouveau projet ».</br> Voir Projets récents, Ouvrir un dossier ou démarrer des projets à partir de modèles.</br><img src=\"styles/images/new_project.png\"><br/> <a href='#' style='float:right;'>d&#39;accord</a>",
  ...
  "DEFAULT_PROJECT_HTML_CLICK_HERE": "Cliquez ici pour localiser cette &lt;span&gt; dans le fichier HTML",
  ...
  "GITHUB_STARS_POPUP": "<div>Votre soutien aide notre petite équipe à se motiver pour rendre <b style='color: darkblue'>phcode.dev</b> encore meilleur.<br/> Veuillez nous mettre en vedette ou envisager de nous parrainer sur GitHub :",
  ...
  "ADD_ENDLINE_TO_THE_END_OF_FILE": "Ajouter une ligne de fin à la fin du fichier",
  "ADD_TO_GITIGNORE": "Ajouter à .gitignore",
  "AMEND_COMMIT": "Modifier le dernier commit",
  "SKIP_COMMIT_CHECKS": "Ignorer les vérifications préalables à la validation (--no-verify)",
  "AMEND_COMMIT_FORBIDDEN": "Impossible de modifier le commit lorsqu'il n'y a aucun commit non poussé",
  ...
  "CHECKOUT_COMMIT": "Vérifier",
  "CHECKOUT_COMMIT_DETAIL": "<b>Message de validation :</b> {0}<br> <b>Valider le hachage :</b> {1}",
  "GIT_CLONE": "Cloner",
  "BUTTON_CLOSE": "Fermer",
  "BUTTON_COMMIT": "Commettre",
  "BUTTON_DEFAULTS": "Restaurer les valeurs par défaut",
  "BUTTON_FIND_CONFLICTS": "Trouver des conflits…",
  "GIT_INIT": "Chaleur",
  "BUTTON_MERGE_ABORT": "Annuler la fusion",
  "BUTTON_OK": "OK",
  "BUTTON_REBASE_ABORT": "Avorter",
  "BUTTON_REBASE_CONTINUE": "Continuer le rebasement",
  "BUTTON_REBASE_SKIP": "Sauter",
  "MENU_RESET_HARD": "Annuler les modifications et les validations après cela (réinitialisation matérielle)",
  "MENU_RESET_MIXED": "Annuler les commits après cela, mais conserver les modifications non mises en scène (réinitialisation mixte)",
  "MENU_RESET_SOFT": "Annuler les commits après cela, mais conserver les modifications par étapes (réinitialisation logicielle)",
  "MENU_TAG_COMMIT": "Validation de la balise",
  "RESET_HARD_TITLE": "Confirmer la réinitialisation matérielle",
  "RESET_MIXED_TITLE": "Confirmer la réinitialisation mixte",
  "RESET_SOFT_TITLE": "Confirmer la réinitialisation logicielle",
  "RESET_DETAIL": "<b>Les commits après les suivants seront rejetés :</b><br> <b>Message de validation :</b> {0}<br> <b>Commande Git :</b> {1}",
  "RESET_HARD_MESSAGE": "Cette action annulera toutes les modifications et validations après la validation sélectionnée. <b>Cette opération ne peut pas être annulée facilement.</b> Êtes-vous sûr de vouloir continuer ?<br><br> ⚠️ Avertissement : cela réécrit l&#39;historique et ne doit pas être utilisé sur des commits qui ont été poussés vers une branche partagée.",
  "RESET_MIXED_MESSAGE": "Cette action annulera tous les commits après le commit sélectionné, mais conservera toutes les modifications non mises en scène. <b>Cette opération ne peut pas être annulée facilement.</b> Êtes-vous sûr de vouloir continuer ?<br><br> ⚠️ Avertissement : cela réécrit l&#39;historique et ne doit pas être utilisé sur des commits qui ont été poussés vers une branche partagée.",
  "RESET_SOFT_MESSAGE": "Cette action annulera tous les commits après le commit sélectionné, mais conservera toutes les modifications préparées pour un nouveau commit. <b>Cette opération ne peut pas être annulée facilement.</b> Êtes-vous sûr de vouloir continuer ?<br><br> ⚠️ Avertissement : cela réécrit l&#39;historique et ne doit pas être utilisé sur des commits qui ont été poussés vers une branche partagée.",
  "BUTTON_SAVE": "Enregistrer",
  "RESET": "Réinitialiser",
  "CHANGE_USER_EMAIL_TITLE": "Changer l'email git",
  "CHANGE_USER_EMAIL": "Changer l'email git…",
  "CHANGE_USER_EMAIL_MENU": "Modifier l'email git ({0})…",
  "CHANGE_USER_NAME_TITLE": "Changer le nom d'utilisateur git",
  ...
  "CLEANING_WHITESPACE_PROGRESS": "Nettoyage des espaces blancs des fichiers…",
  "CLEAR_WHITESPACE_ON_FILE_SAVE": "Effacer les espaces lors de l'enregistrement du fichier",
  "CLONE_REPOSITORY": "Cloner le dépôt",
  "CODE_INSPECTION_PROBLEMS": "Problèmes d'inspection de code",
  "CODE_INSPECTION_IN_PROGRESS": "Inspection du code en cours…",
  "CODE_INSPECTION_PROBLEMS_NONE": "Aucun problème détecté",
  "CODE_INSPECTION_DONE_FILES": "{0} des {1} fichiers terminés…",
  ...
  "COMMIT_MESSAGE_PLACEHOLDER": "Entrez le message de validation ici…",
  ...
  "CREATE_NEW_REMOTE": "Créer une nouvelle télécommande…",
  "CURRENT_TRACKING_BRANCH": "Branche de suivi actuelle",
  "_CURRENT_TRACKING_BRANCH": "branche de suivi actuelle",
  "DEFAULT_GIT_TIMEOUT": "Délai d'expiration par défaut de l'opération Git (en secondes)",
  "DELETE_FILE_BTN": "Supprimer le fichier…",
  "DELETE_LOCAL_BRANCH": "Supprimer la branche locale",
  "DELETE_LOCAL_BRANCH_NAME": "Souhaitez-vous vraiment supprimer la branche locale « {0} » ?",
  "DELETE_REMOTE": "Supprimer la télécommande",
  "DELETE_REMOTE_NAME": "Souhaitez-vous vraiment supprimer la télécommande « {0} » ?",
  "DELETE_SCOPE": "Supprimer la portée Git-FTP",
  "DELETE_SCOPE_NAME": "Souhaitez-vous vraiment supprimer la portée Git-FTP « {0} » ?",
  "DIALOG_CHECKOUT": "Lors de l'extraction d'un commit, le dépôt passe à l'état DETACHED HEAD. Vous ne pouvez pas effectuer de commits à moins de créer une branche basée sur cela.",
  "DIALOG_PULL_TITLE": "Tirer depuis la télécommande",
  "DIALOG_PUSH_TITLE": "Pousser vers la télécommande",
  "SKIP_PRE_PUSH_CHECKS": "Ignorer les vérifications préalables à l'envoi (--no-verify)",
  "DIFF": "Diff",
  "DIFFTOOL": "Comparaison avec difftool",
  "DIFF_FAILED_SEE_FILES": "Git diff n'a pas réussi à fournir les résultats de la comparaison. Voici la liste des fichiers intermédiaires à valider :",
  "DIFF_TOO_LONG": "Diff trop long à afficher",
  "ENABLE_GERRIT_PUSH_REF": "Utiliser la référence push compatible Gerrit",
  "ENTER_NEW_USER_EMAIL": "Entrez l'email",
  "ENTER_NEW_USER_NAME": "Entrez le nom d'utilisateur",
  "ENTER_PASSWORD": "Entrez le mot de passe:",
  "ENTER_REMOTE_GIT_URL": "Entrez l'URL Git du dépôt que vous souhaitez cloner :",
  "ENTER_REMOTE_NAME": "Entrez le nom de la nouvelle télécommande :",
  "ENTER_REMOTE_URL": "Entrez l'URL de la nouvelle télécommande :",
  ...
  "ERROR_TERMINAL_NOT_FOUND": "Le terminal n'a pas été trouvé pour votre système d'exploitation, vous pouvez définir une commande de terminal personnalisée dans les paramètres",
  "EXTENDED_COMMIT_MESSAGE": "ÉTENDU",
  "GETTING_STAGED_DIFF_PROGRESS": "Obtenir les différences entre les fichiers mis en scène…",
  "GIT_COMMIT": "Validation Git…",
  "GIT_COMMIT_IN_PROGRESS": "Git Commit en cours",
  "GIT_DIFF": "Git diff &mdash;",
  "GIT_PULL_RESPONSE": "Réponse à Git Pull",
  "GIT_PUSH_RESPONSE": "Réponse Git Push",
  "GIT_REMOTES": "Télécommandes Git",
  "GIT_SETTINGS": "Paramètres Git…",
  "GIT_SETTINGS_TITLE": "Paramètres Git",
  "GOTO_NEXT_GIT_CHANGE": "Aller au prochain changement de Git",
  "GOTO_PREVIOUS_GIT_CHANGE": "Accéder au changement Git précédent",
  ...
  "LINES": "Lignes",
  "_LINES": "lignes",
  "MARK_MODIFIED_FILES_IN_TREE": "Marquer les fichiers modifiés dans l'arborescence des fichiers",
  "MERGE_BRANCH": "Fusionner la branche",
  "MERGE_MESSAGE": "Fusionner les messages",
  "MERGE_RESULT": "Résultat de la fusion",
  "NORMALIZE_LINE_ENDINGS": "Normaliser les fins de ligne (en \\n)",
  "NOTHING_TO_COMMIT": "Rien à valider, répertoire de travail propre.",
  ...
  "PATH_TO_GIT_EXECUTABLE": "Chemin vers l'exécutable Git",
  "PULL_AVOID_MERGING": "Éviter la fusion manuelle",
  "PULL_DEFAULT": "Fusion par défaut",
  "PULL_FROM": "Tirer de",
  "PULL_MERGE_NOCOMMIT": "Fusionner sans valider",
  "PULL_REBASE": "Utilisez le renard",
  "PULL_RESET": "Utiliser la réinitialisation logicielle",
  "PULL_SHORTCUT": "Tirer depuis la télécommande…",
  "PULL_SHORTCUT_BEHIND": "Tirer depuis la télécommande ({0} derrière)…",
  "PULL_BEHAVIOR": "Comportement de traction",
  "FETCH_SHORTCUT": "Récupérer à distance",
  "PUSH_DEFAULT": "Push par défaut",
  "PUSH_DELETE_BRANCH": "Supprimer la branche distante",
  "PUSH_SEND_TAGS": "Envoyer des tags",
  "PUSH_FORCED": "Poussée forcée",
  "PUSH_SHORTCUT": "Appuyez sur pour contrôler à distance…",
  "PUSH_SHORTCUT_AHEAD": "Appuyez sur la télécommande ({0} en avant)…",
  "PUSH_TO": "Pousser vers",
  "PUSH_BEHAVIOR": "Comportement de poussée",
  "Q_UNDO_CHANGES": "Réinitialiser les modifications apportées au fichier <span class='dialog-filename'>{0}</span> ?",
  "REBASE_RESULT": "Résultat Renard",
  "REFRESH_GIT": "Actualiser Git",
  "REMOVE_BOM": "Supprimer la nomenclature des fichiers",
  "REMOVE_FROM_GITIGNORE": "Supprimer de .gitignore",
  "RESET_LOCAL_REPO": "Annuler toutes les modifications depuis la dernière validation…",
  "DISCARD_CHANGES": "Annuler les modifications",
  "RESET_LOCAL_REPO_CONFIRM": "Souhaitez-vous annuler toutes les modifications effectuées depuis la dernière validation ? Cette action ne peut pas être annulée.",
  "UNDO_LOCAL_COMMIT_CONFIRM": "Êtes-vous sûr de vouloir annuler le dernier commit non poussé ?",
  "MORE_OPTIONS": "Plus d'options",
  "CREDENTIALS": "Informations d'identification",
  "SAVE_CREDENTIALS_HELP": "Vous n'avez pas besoin de saisir le nom d'utilisateur/mot de passe si vos informations d'identification sont gérées ailleurs. N'utilisez cette option que lorsque votre opération expire sans cesse.",
  "SAVE_CREDENTIALS_IN_URL": "Enregistrer les informations d'identification sur l'URL distante (en texte brut)",
  "SET_THIS_BRANCH_AS_TRACKING": "Définir cette branche comme une nouvelle branche de suivi",
  "STRIP_WHITESPACE_FROM_COMMITS": "Supprimer les espaces de fin des commits",
  "TARGET_BRANCH": "Filiale cible",
  "TITLE_CHECKOUT": "Valider la commande ?",
  "TOOLTIP_CLONE": "Cloner un référentiel existant",
  "TOOLTIP_COMMIT": "Valider les fichiers sélectionnés",
  "TOOLTIP_FETCH": "Récupérer toutes les télécommandes et actualiser les compteurs",
  "TOOLTIP_FIND_CONFLICTS": "Lance une recherche de conflits de fusion/refonte Git dans le projet",
  "TOOLTIP_HIDE_FILE_HISTORY": "Masquer l'historique des fichiers",
  "TOOLTIP_HIDE_HISTORY": "Masquer l'historique",
  "TOOLTIP_INIT": "Initialiser le référentiel",
  "TOOLTIP_MERGE_ABORT": "Annuler l'opération de fusion et réinitialiser HEAD au dernier commit local",
  "TOOLTIP_PICK_REMOTE": "Choisissez la télécommande préférée",
  "TOOLTIP_PULL": "Extraction de Git",
  "TOOLTIP_PUSH": "Git Push",
  "TOOLTIP_REBASE_ABORT": "Annuler l'opération de rebase et réinitialiser HEAD à la branche d'origine",
  "TOOLTIP_REBASE_CONTINUE": "Redémarrer le processus de rebasage après avoir résolu un conflit de fusion",
  "TOOLTIP_REBASE_SKIP": "Redémarrez le processus de rebasage en ignorant le patch actuel",
  "TOOLTIP_REFRESH_PANEL": "Rafraîchir le panneau",
  ...
  "UNDO_COMMIT": "Annuler la validation",
  "URL": "URL",
  "USERNAME": "Nom d'utilisateur",
  "USER_ABORTED": "Utilisateur abandonné !",
  "USE_GIT_GUTTER": "Utiliser les marques de gouttière Git",
  "USE_NOFF": "Créer un commit de fusion même lorsque la fusion se résout en tant qu'avance rapide (--no-ff)",
  "USE_REBASE": "Utiliser FOX",
  "USE_VERBOSE_DIFF": "Afficher une sortie détaillée dans les différences",
  "USE_DIFFTOOL": "Utiliser Difftool pour les différences",
  "VIEW_AUTHORS_FILE": "Afficher les auteurs du fichier…",
  "VIEW_AUTHORS_SELECTION": "Voir les auteurs de la sélection…",
  "VIEW_THIS_FILE": "Voir ce fichier",
  "TAG_NAME_PLACEHOLDER": "Entrez le nom du tag ici…",
  "TAG_NAME": "Étiqueter",
  ...
  "FILE_STAGED": "Mise en scène",
  "FILE_UNMERGED": "Non fusionné",
  "FILE_UNMODIFIED": "Non modifié",
  "FILE_UNTRACKED": "Non suivi",
  "GIT_PUSH_SUCCESS_MSG": "Avance rapide réussie",
  "GIT_PUSH_FORCE_UPDATED_MSG": "Mise à jour forcée réussie",
  "GIT_PUSH_DELETED_MSG": "Référence supprimée avec succès",
  "GIT_PUSH_NEW_REF_MSG": "A réussi à pousser un nouvel arbitre",
  "GIT_PUSH_REJECTED_MSG": "L'arbitre a été rejeté ou n'a pas poussé",
  "GIT_PUSH_UP_TO_DATE_MSG": "L'arbitre était à jour et n'avait pas besoin d'être poussé",
  "GIT_PULL_SUCCESS": "Git pull terminé avec succès",
  "GIT_MERGE_SUCCESS": "Fusion git terminée avec succès",
  "GIT_REBASE_SUCCESS": "Git rebase terminé avec succès",
  "GIT_BRANCH_DELETE_SUCCESS": "Branche git supprimée avec succès",
  "INIT_NEW_REPO_FAILED": "Échec de l'initialisation du nouveau référentiel",
  "GIT_CLONE_REMOTE_FAILED": "Le clonage du référentiel distant a échoué !",
  "GIT_CLONE_ERROR_EXPLAIN": "Le répertoire sélectionné `{0}`\nn'est pas vide. Git clone nécessite un répertoire propre et vide.\nS'il semble vide, recherchez les fichiers cachés.",
  "FOLDER_NOT_WRITABLE": "Le répertoire sélectionné `{0}`\nn'est pas accessible en écriture.",
  "GIT_NOT_FOUND_MESSAGE": "Git n'est pas installé ou est introuvable sur votre système. Veuillez installer Git ou fournir le chemin correct vers l'exécutable Git dans le champ de texte ci-dessous.",
  "ERROR_GETTING_BRANCH_LIST": "Échec de l'obtention de la liste des succursales",
  "ERROR_READING_GIT_HEAD": "La lecture du fichier .git/HEAD a échoué",
  "ERROR_PARSING_BRANCH_NAME": "Échec de l'analyse du nom de la branche de {0}",
  "ERROR_READING_GIT_STATE": "La lecture de l'état .git a échoué",
  "ERROR_GETTING_DELETED_FILES": "Échec de l'obtention de la liste des fichiers supprimés",
  "ERROR_SWITCHING_BRANCHES": "Le changement de branche a échoué",
  "ERROR_GETTING_CURRENT_BRANCH": "L'obtention du nom de la branche actuelle a échoué",
  "ERROR_REBASE_FAILED": "La rebase a échoué",
  "ERROR_MERGE_FAILED": "La fusion a échoué",
  "ERROR_BRANCH_DELETE_FORCED": "La suppression forcée de la branche a échoué",
  "ERROR_FETCH_REMOTE_INFO": "La récupération des informations à distance a échoué",
  "ERROR_CREATE_BRANCH": "La création d'une nouvelle branche a échoué",
  "ERROR_REFRESH_GUTTER": "Le rafraîchissement de la gouttière a échoué !",
  "ERROR_GET_HISTORY": "Impossible d'obtenir l'historique",
  "ERROR_GET_MORE_HISTORY": "Impossible de charger plus de lignes d'historique",
  "ERROR_GET_CURRENT_BRANCH": "Impossible d'obtenir le nom de la branche actuelle",
  "ERROR_GET_DIFF_FILE_COMMIT": "Impossible d'obtenir la différence",
  ...
  "ERROR_MODIFY_FILE_STATUS_FAILED": "Impossible de modifier l'état du fichier",
  "ERROR_CHANGE_USERNAME_FAILED": "Impossible de changer le nom d'utilisateur",
  "ERROR_CHANGE_EMAIL_FAILED": "Impossible de changer l'email de l'utilisateur",
  "ERROR_TOGGLE_GERRIT_PUSH_REF_FAILED": "Impossible de basculer la poussée de Gerrit",
  "ERROR_RESET_LOCAL_REPO_FAILED": "La réinitialisation du référentiel local a échoué",
  "ERROR_CREATE_TAG": "La création de la balise a échoué",
  "ERROR_CODE_INSPECTION_FAILED": "CodeInspection.inspectFile n'a pas pu s'exécuter pour le fichier",
  "ERROR_CANT_GET_STAGED_DIFF": "Impossible d'obtenir la différence pour les fichiers mis en scène",
  "ERROR_GIT_COMMIT_FAILED": "Échec de la validation Git",
  "ERROR_GIT_BLAME_FAILED": "Git Blame a échoué",
  "ERROR_GIT_DIFF_FAILED": "Git Diff a échoué",
  "ERROR_DISCARD_CHANGES_FAILED": "L'annulation des modifications apportées à un fichier a échoué",
  "ERROR_COULD_NOT_RESOLVE_FILE": "Impossible de résoudre le fichier",
  "ERROR_MERGE_ABORT_FAILED": "L'abandon de la fusion a échoué",
  "ERROR_MODIFIED_DIALOG_FILES": "Les fichiers que vous alliez valider ont été modifiés pendant que la boîte de dialogue de validation était affichée. Abandonner la validation car le résultat serait différent de ce qui était affiché dans la boîte de dialogue.",
  "ERROR_GETTING_REMOTES": "L'obtention des télécommandes a échoué !",
  "ERROR_REMOTE_CREATION": "La création à distance a échoué",
  "ERROR_PUSHING_REMOTE": "La transmission à distance a échoué",
  "ERROR_PULLING_REMOTE": "L'extraction à distance a échoué",
  "ERROR_PULLING_OPERATION": "L'opération de traction a échoué",
  "ERROR_PUSHING_OPERATION": "L'opération de poussée a échoué",
  "ERROR_NO_REMOTE_SELECTED": "Aucune télécommande n'a été sélectionnée pour {0} !",
  "ERROR_BRANCH_LIST": "Échec de l'obtention de la liste des succursales",
  "ERROR_FETCH_REMOTE": "La récupération des informations à distance a échoué"
});