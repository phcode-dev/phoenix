...
define({
  ...
  "UNSUPPORTED_BROWSER_MOBILE": "Les appareils mobiles et tablettes ne sont actuellement pas entièrement pris en charge. Vous pouvez fermer cette boîte de dialogue, mais certaines fonctionnalités de Phoenix ne fonctionneront pas dans ce navigateur.",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Le navigateur ne prend pas en charge le dossier ouvert. Veuillez utiliser Chrome, Edge ou Opera pour ouvrir les dossiers locaux.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Veuillez utiliser l'un des navigateurs pris en charge ci-dessous.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Nous travaillons dur pour rendre Phoenix disponible dans plus de navigateurs. Vous pouvez fermer cette boîte de dialogue, mais certaines fonctionnalités de Phoenix ne fonctionneront pas dans ce navigateur.",
