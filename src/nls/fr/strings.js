...
define({
  ...
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>Safari supprime automatiquement les données du site Web si un site n&#39;est pas revisité dans les 7 jours. {APP_NAME} s&#39;appuie sur le stockage du navigateur pour enregistrer vos projets, qui peuvent être supprimés en raison de cette politique.<br/><br/> <strong>Pour éviter la perte de données</strong> , veuillez <strong>télécharger</strong> vos projets avant de fermer l&#39;onglet ou restez à l&#39;écoute pour nos <strong>prochaines applications Web et Mac/iOS natives</strong> .</span>",
