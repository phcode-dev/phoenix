...
define({
  ...
  "INCLUDE_FILE_FILTER": "Inclure {0}",
  "EXCLUDE_FILE_FILTER_DROPDOWN": "Exclure",
  "INCLUDE_FILE_FILTER_DROPDOWN": "Inclure",
  "EDIT_FILE_FILTER": "Modifier…",
  "FILE_FILTER_DIALOG": "Modifier le filtre d'exclusion",
  "FILE_FILTER_INSTRUCTIONS": "Excluez les fichiers et dossiers correspondant à l&#39;un des <a href='{0}' title=\"{0}\">caractères génériques ignorés</a> suivants. Entrez chaque chaîne sur une nouvelle ligne. Par exemple<ul><li> <code>*.js</code> correspondra <code>a/b/x.js</code> , <code>xyx.js</code> , etc.</li><li> <code>./*.css</code> ne correspondra qu&#39;à <code>x.css</code> à la racine du projet, mais pas à <code>y/x.css</code> dans le sous-dossier.</li></ul>",
  "FILE_FILTER_INSTRUCTIONS_INCLUDE": "Incluez uniquement les fichiers et dossiers correspondant à l&#39;un des <a href='{0}' title=\"{0}\">caractères génériques ignorés</a> suivants. Entrez chaque chaîne sur une nouvelle ligne. Par exemple<ul><li> <code>*.js</code> correspondra <code>a/b/x.js</code> , <code>xyx.js</code> , etc.</li><li> <code>./*.css</code> ne correspondra qu&#39;à <code>x.css</code> à la racine du projet, mais pas à <code>y/x.css</code> dans le sous-dossier.</li></ul>",
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "Afin d&#39;améliorer {APP_NAME}, nous envoyons périodiquement des statistiques limitées et <strong>pseudonymes</strong> et des rapports d&#39;erreurs à phcode.dev sur la façon dont vous utilisez {APP_NAME}. Ces informations permettent de hiérarchiser les fonctionnalités, de trouver des bogues et de repérer les problèmes d&#39;utilisation tout en protégeant votre vie privée.<br><br> Vous pouvez voir vos données ou choisir de ne pas partager les données en sélectionnant <strong>Aide &gt; Rapport de santé</strong> .<br><br>",
  "HEALTH_DATA_PREVIEW": "Rapport d’intégrité de {APP_NAME}",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Afin d&#39;améliorer {APP_NAME}, nous envoyons périodiquement des statistiques limitées et <strong>pseudonymes</strong> et des rapports d&#39;erreurs à phcode.dev sur la façon dont vous utilisez {APP_NAME}. Ces informations permettent de hiérarchiser les fonctionnalités, de trouver des bogues et de repérer les problèmes d&#39;utilisabilité.</p><p> Vous trouverez ci-dessous un aperçu des données qui seront envoyées dans votre prochain rapport de santé <em>si</em> elles sont activées. (Consultez également la console du développeur pour les journaux d&#39;erreurs marqués &quot;Erreur critique détectée&quot;.)</p>",
