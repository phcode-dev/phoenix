...
define({
  ...
  "UPDATE_READY_RESTART_MESSAGE": "Fermez toutes les fenêtres {APP_NAME} et redémarrez l'application pour lancer la version mise à jour.",
  "UPDATE_FAILED_TITLE": "Mise à jour a échoué",
  "UPDATE_FAILED_MESSAGE": "Veuillez fermer toutes les fenêtres de {APP_NAME} et rouvrir l'application pour tenter à nouveau la mise à jour.",
