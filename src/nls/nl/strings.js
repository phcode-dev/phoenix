...
define({
  ...
  "CMD_HOMEPAGE": "Startpagina - Apps downloaden",
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME} <strong>verzamelt of verwerkt geen persoonlijk identificeerbare informatie</strong> , maar <strong>verzamelt anonieme gebruiksstatistieken</strong> om uw privacy te beschermen. Anonieme gegevens zijn vrijgesteld van de AVG/CCPA-meldingsvereisten, maar wij zijn van mening dat u de keuze moet hebben om u af te melden voor het verzamelen van anonieme gegevens.<br> Met deze <strong>anonieme</strong> app-gebruiksstatistieken en foutrapporten kunt u functies prioriteren, bugs opsporen en bruikbaarheidsproblemen opsporen voor uw ervaring met {APP_NAME}.</p><p> Hieronder ziet u een voorbeeld van de gegevens die in uw volgende gezondheidsrapport worden verzonden <em>als</em> dit is ingeschakeld. (Zie ook de ontwikkelaarsconsole voor foutenlogboeken gemarkeerd met &#39;Caught Critical error&#39;.)</p>",
  ...
  "NEW_PROJECT_NOTIFICATION": "Klik op dit pictogram om een nieuw project aan te maken.</br><img src=\"styles/images/new_project.png\"><br/> <a href='#' style='float:right;'>OK</a>",
