...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "<code>package.json</code> -bestand niet gedetecteerd in huidig project. Is het huidige project een geldige {APP_NAME}-extensie?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "<code>package.json</code> bestand is ongeldig JSON.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "Vereiste velden ontbreken in <code>package.json</code> : [{0}]",
