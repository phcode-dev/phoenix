...
define({
  ...
  "ATTENTION_SAFARI_USERS_MESSAGE": "<span>Safari verwijdert automatisch websitegegevens als een site niet binnen 7 dagen opnieuw wordt bezocht. {APP_NAME} vertrouwt op browseropslag om je projecten op te slaan, die vanwege dit beleid kunnen worden verwijderd.<br/><br/> <strong>Download</strong> uw projecten voordat u het tabblad sluit of blijf op de hoogte van onze <strong>aankomende web- en native Mac/iOS-apps</strong> <strong>om gegevensverlies te voorkomen</strong> .</span>",
