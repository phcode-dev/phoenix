...
define({
  ...
  "UPDATE_READY_RESTART_MESSAGE": "Sluit alle {APP_NAME}-vensters en start de app opnieuw om de bijgewerkte versie te starten.",
  "UPDATE_FAILED_TITLE": "Update mislukt",
  "UPDATE_FAILED_MESSAGE": "Sluit alle {APP_NAME}-vensters en open de applicatie opnieuw om de update opnieuw te proberen.",
