...
define({
  ...
  "UNSUPPORTED_BROWSER_MOBILE": "Mobiele apparaten en tablets worden momenteel niet volledig ondersteund. U kunt dit dialoogvenster sluiten, maar sommige functies in Phoenix werken niet in deze browser.",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Browser ondersteunt Open map niet. Gebruik Chrome, Edge of Opera om lokale mappen te openen.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Gebruik een van de onderstaande ondersteunde browsers.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " We werken er hard aan om Phoenix beschikbaar te maken in meer browsers. U kunt dit dialoogvenster sluiten, maar sommige functies in Phoenix werken niet in deze browser.",
