...
define({
  ...
  "INCLUDE_FILE_FILTER": "Inclusief {0}",
  "EXCLUDE_FILE_FILTER_DROPDOWN": "Uitsluiten",
  "INCLUDE_FILE_FILTER_DROPDOWN": "Erbij betrekken",
  "EDIT_FILE_FILTER": "Bewerk…",
  "FILE_FILTER_DIALOG": "Uitsluitingsfilter bewerken",
  "FILE_FILTER_INSTRUCTIONS": "Sluit bestanden en mappen uit die overeenkomen met een van de volgende <a href='{0}' title=\"{0}\">negeer-jokertekens</a> . Voer elke tekenreeks op een nieuwe regel in. Bijv<ul><li> <code>*.js</code> komt overeen met <code>a/b/x.js</code> , <code>xyx.js</code> , enz..</li><li> <code>./*.css</code> komt alleen overeen met <code>x.css</code> in de hoofdmap van het project, maar niet <code>y/x.css</code> in de submap.</li></ul>",
  "FILE_FILTER_INSTRUCTIONS_INCLUDE": "Neem alleen bestanden en mappen op die overeenkomen met een van de volgende <a href='{0}' title=\"{0}\">negeer-jokertekens</a> . Voer elke tekenreeks op een nieuwe regel in. Bijv<ul><li> <code>*.js</code> komt overeen met <code>a/b/x.js</code> , <code>xyx.js</code> , enz..</li><li> <code>./*.css</code> komt alleen overeen met <code>x.css</code> in de hoofdmap van het project, maar niet <code>y/x.css</code> in de submap.</li></ul>",
  ...
  "UPDATE_UP_TO_DATE": "Jouw versie van {APP_NAME} is de nieuwste en beste!",
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "Om {APP_NAME} te verbeteren, sturen we periodiek beperkte, <strong>pseudonieme</strong> statistieken en foutmeldingen naar phcode.dev over hoe je {APP_NAME} gebruikt. Deze informatie helpt bij het prioriteren van functies, het vinden van bugs en het opsporen van bruikbaarheidsproblemen terwijl uw privacy wordt beschermd.<br><br> U kunt uw gegevens bekijken of ervoor kiezen om gegevens niet te delen door <strong>Help &gt; Gezondheidsrapport</strong> te selecteren.<br><br>",
  "HEALTH_DATA_PREVIEW": "{APP_NAME} statusrapport",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Om {APP_NAME} te verbeteren, sturen we periodiek beperkte, <strong>pseudonieme</strong> statistieken en foutmeldingen naar phcode.dev over hoe je {APP_NAME} gebruikt. Deze informatie helpt bij het prioriteren van functies, het vinden van bugs en het opsporen van bruikbaarheidsproblemen.</p><p> Hieronder ziet u een voorbeeld van de gegevens die in uw volgende gezondheidsrapport worden verzonden <em>als</em> deze is ingeschakeld. (Zie ook de ontwikkelaarsconsole voor foutenlogboeken die zijn gemarkeerd als &#39;Caught Critical error&#39;.)</p>",
