...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "datoteka <code>package.json</code> nije otkrivena u trenutnom projektu. Je li trenutni projekt valjano proširenje {APP_NAME}?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "<code>package.json</code> datoteka je nevažeći JSON.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "U <code>package.json</code> nedostaju obavezna polja: [{0}]",
