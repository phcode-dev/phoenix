...
define({
  ...
  "UPDATE_CLOSE_TO_UPDATE_TITLE": "Неможливо оновити",
  "UPDATE_CLOSE_TO_UPDATE": "Відкрито кілька вікон редактора. Перш ніж намагатися оновити, переконайтеся, що всі інші вікна редактора {APP_NAME} закрито. Закрийте всі додаткові вікна {APP_NAME} і повторіть спробу оновлення.",
