...
define({
  ...
  "DESCRIPTION_LIVEDEV_SECURITY": "Попередження безпеки від phcode.dev<br><br> У цьому попередньому перегляді в реальному часі зроблено спробу отримати доступ до файлу, який не є проектом. Заради вашої безпеки доступ заборонено. Будьте обережні, працюючи над ненадійними проектами.",
