...
define({
  ...
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Наступні типи файлів успішно пов’язані з програмами за замовчуванням.<br/> {0} У вас є можливість змінити параметри видалення/додавання нових асоціацій типів файлів у brackets.json, перейшовши в меню «Налагодження-&gt;Відкрити файл налаштувань».",
  ...
  "NEW_PROJECT_NOTIFICATION": "Натисніть цей значок, щоб створити новий проект.</br><img src=\"extensions/default/Phoenix/images/new_project.png\"><br/> <a href='#' style='float:right;'>в порядку</a>",
  "BEAUTIFY_CODE_NOTIFICATION": "Натисніть тут або натисніть <b>`{0}`</b> , щоб прикрасити код.</br><img src=\"extensions/default/Phoenix/images/beautify.gif\"><br/> <a href='#' style='float:right;'>добре</a>",
