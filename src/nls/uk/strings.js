...
define({
  ...
  "WEBPAGE_HOME_PAGE": "Макети домашньої сторінки",
  "WEBPAGE_BLOG": "Сторінка блогу",
  "WEBPAGE_DASHBOARD": "Інформаційна панель HTML",
  "WEBPAGE_BOOTSTRAP_EXAMPLES": "Приклади Bootstrap",
  "GUIDED_FILES_SIDEBAR": "Виберіть файл HTML</br> <a href='#' style='float:right;'>в порядку</a>",
  "GUIDED_LIVE_PREVIEW": "Внесіть деякі зміни в код і збережіть файл, щоб переглянути попередній перегляд.</br> <a href='#' style='float:right;'>в порядку</a>",
