...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "файл <code>package.json</code> не виявлено в поточному проекті. Чи є поточний проект дійсним розширенням {APP_NAME}?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "файл <code>package.json</code> недійсний JSON.",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "У <code>package.json</code> відсутні обов’язкові поля: [{0}]",
