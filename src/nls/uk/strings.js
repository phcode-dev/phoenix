...
define({
  ...
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "Щоб покращити {APP_NAME}, ми періодично надсилаємо на core.ai обмежену статистику під <strong>псевдонімом</strong> про те, як ви використовуєте {APP_NAME}. Ця інформація допомагає визначати пріоритети функцій, знаходити помилки та виявляти проблеми з зручністю використання, зберігаючи вашу конфіденційність.<br><br> Ви можете переглянути свої дані або не ділитися даними, вибравши « <strong>Довідка» &gt; «Звіт про стан здоров’я»</strong> .<br><br>",
  "HEALTH_DATA_PREVIEW": "Звіт про стан {APP_NAME}",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Щоб покращити {APP_NAME}, ми періодично надсилаємо на core.ai обмежену статистику під <strong>псевдонімом</strong> про те, як ви використовуєте {APP_NAME}. Ця інформація допомагає визначати пріоритети функцій, знаходити помилки та виявляти проблеми зручності використання.</p><p> Нижче наведено попередній перегляд даних, які буде надіслано у вашому наступному звіті про стан здоров’я, <em>якщо</em> його ввімкнено.</p>",
