...
define({
  ...
  "CMD_ENABLE_SELECTION_VIEW": "Виділення Подання",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "Об'єкт з параметрами за замовчуванням для JSHint. Будь ласка, перегляньте наступну URL-адресу для всіх доступних параметрів JSHint: https://jshint.com/docs/options/",
  ...
  "EXTRACTING_FILES_PROGRESS": "Вилучення {0} з {1} файлів.",
  ...
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Не зміг прикрасити. Текст редактора змінився після благоустрою.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Прикрашаючи файл {0}",
  "BEAUTIFY_ERROR_SELECTION": "Не зміг прикрасити. </br>Неповнийблок коду обраний або неправильний синтаксис.",
