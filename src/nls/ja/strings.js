...
define({
  ...
  "ERROR_NO_EXTENSION_PACKAGE": "<code>package.json</code>ファイルが現在のプロジェクトで検出されませんでした。現在のプロジェクトは有効な {APP_NAME} 拡張機能ですか?",
  "ERROR_INVALID_EXTENSION_PACKAGE": "<code>package.json</code>ファイルが無効な JSON です。",
  "ERROR_INVALID_EXTENSION_PACKAGE_FIELDS": "<code>package.json</code>に必須フィールドがありません: [{0}]",
