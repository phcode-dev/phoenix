...
define({
  ...
  "LIVE_DEV_SETTINGS_ELEMENT_HIGHLIGHT_PREFERENCE": "「ホバー」または「クリック」時にライブプレビュー要素のハイライトを表示します。デフォルトは「ホバー」です",
  ...
  "LIVE_DEV_MORE_OPTIONS_EDIT_HYPERLINK": "ハイパーリンクを編集",
  ...
  "LIVE_DEV_MORE_OPTIONS_MORE": "その他のオプション",
  ...
  "IMAGE_SEARCH_MONTHLY_LIMIT_MESSAGE": "今月の画像検索の上限{0}回分をすべて使用しました。<br>トライアル制限を解除して検索を続けるには、Phoenix Proの有料プランを開始してください。"
});