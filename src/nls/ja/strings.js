...
define({
  ...
  "PHOENIX_TOUR_DESIGN_MODE": "ここをクリックしてデザインモードに入ります。フルスクリーンでページを視覚的に編集できます。",
  "PHOENIX_TOUR_AI_PANEL": "ここをクリックしてAIパネルを開きます。",
  "PHOENIX_TOUR_NEW_PROJECT": "ここから新規プロジェクトを開く、または作成します。",
