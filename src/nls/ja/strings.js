...
define({
  ...
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "固定解除プレビューページに固定",
  ...
  "CMD_BEAUTIFY_CODE_ON_SAVE": "保存後にコードを美化",
  "FIND_MENU": "検索",
  "CMD_FIND": "検索",
  "CMD_FIND_NEXT": "次を検索",
  ...
  "ABOUT_TEXT_LINE3": "当社が使用する第三者ライブラリ-<a href='https://github.com/phcode-dev/phoenix/tree/main/src/thirdparty/licences'>ライセンスと帰属</a>。 ",
  "ABOUT_TEXT_LINE4": "ドキュメンテーションとソース <a href='https://github.com/phcode-dev/phoenix/'>https://github.com/phcode-dev/phoenix/</a>",
  "ABOUT_TEXT_LINE5": "❤ とJavaScriptで以下のように作られました",
  "ABOUT_TEXT_LINE6": "たくさんの人がいます（しかし、今そのデータを読み込むのに問題があります）。",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "JSHint のデフォルトオプションを持つオブジェクト。利用可能なすべての JSHint オプションについては、次の URL を参照してください。https://jshint.com/docs/options/",
  ...
  "DESCRIPTION_SELECTION_VIEW_ENABLED": "true に設定すると、選択ビューが有効になります",
  ...
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "ブラウザはフォルダを開くをサポートしていません",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "以下のサポートされているブラウザのいずれかを使用してください。",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Phoenixをより多くのブラウザで利用できるように努力しています。このダイアログを閉じてもかまいませんが、Phoenixの一部の機能はこのブラウザでは動作しません。",
  "CANNOT_PUBLISH_LARGE_PROJECT": "大規模プロジェクトは公開できません",
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "フェニックスはまだ実験的なアルファ版です。500 ファイルを超えるプロジェクトの同期はまだ有効になっていません。",
  "SHARE_WEBSITE": "ウェブサイトを公開して共有しますか？",
  "PUBLISH": "公開する",
  "PUBLISH_CONSENT_MESSAGE": "変更をすばやくプレビューし、Web サイトを他のユーザーと共有します。Phoenix は {0} でこのウェブサイトを公開できます。公開されたリンクは7日間有効です。</br>ウェブサイトを公開して共有しますか？",
  "PUBLISH_SYNC_IN_PROGRESS": "プレビューのために同期中...",
  "PUBLISH_PAGE": "このサイトを公開して共有するにはクリックしてください",
  "PUBLISH_VIEW_PAGE": "クリックして公開ページを表示",
  "MISSING_FIELDS": "欠落しているフィールド",
  "PLEASE_FILL_ALL_REQUIRED": "赤で強調表示されている必須フィールドをすべて入力してください",
  ...
  "UNZIP_FAILED": "エラー:解凍できませんでした。",
  "CONFIRM_REPLACE_TITLE": "交換を確認",
  "KEEP_BOTH": "両方保持",
  "EXPLORE": "HTML ゲーム",
  "BLOG": "ブログ",
  "PHOENIX_DEFAULT_PROJECT": "デフォルトプロジェクト",
  "PROJECT_NAME": "プロジェクト名:",
  "NEW_HTML": "新規 HTML プロジェクト",
  "LICENSE": "ライセンス:",
  "CREDITS": "クレジット:",
  "PREVIEW": "プレビュー",
  ...
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "美化できませんでした。ビューティフィケーション後にエディタのテキストが変更されました。",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "美化ファイル {0}",
  "BEAUTIFY_ERROR_SELECTION": "美化できませんでした。</br>不完全なコードブロックが選択されているか、構文が無効です。",
