...
define({
  ...
  "ERROR_GIT_FOLDER_NOT_EMPTY": "選択したフォルダは空ではないか、読み取りできないため、Gitクローンに使用できません。",
  "ERROR_GIT_FOLDER_NOT_EXIST": "選択したフォルダは存在しないため、Gitクローンに使用できません。",
  "ERROR_CLONING_TITLE": "Gitクローンに失敗しました",
  "DOWNLOADING": "ダウンロード中…",
  ...
  "MENU_RESET_MIXED": "このコミット以降のコミットを破棄し、変更をステージングしない（ミックスリセット）",
  "MENU_RESET_SOFT": "このコミット以降のコミットを破棄し、変更をステージングする（ソフトリセット）",
  ...
  "RESET_HARD_MESSAGE": "この操作を実行すると、選択したコミット以降のすべての変更とコミットが破棄されます。<b>この操作は簡単には元に戻せません。</b>続行しますか？<br><br>⚠️ 警告: この操作は履歴を書き換えるため、共有ブランチにプッシュされたコミットには使用しないでください。",
  "RESET_MIXED_MESSAGE": "この操作を実行すると、選択したコミット以降のすべてのコミットが破棄されますが、すべての変更はステージされていない状態のまま保持されます。<b>この操作は簡単には元に戻せません。</b>続行しますか？<br><br>⚠️ 警告: この操作は履歴を書き換えるため、共有ブランチにプッシュされたコミットには使用しないでください。",
  "RESET_SOFT_MESSAGE": "この操作を実行すると、選択したコミット以降のすべてのコミットが破棄されますが、すべての変更は新しいコミットのためにステージされた状態のまま保持されます。<b>この操作は簡単には元に戻せません。</b>続行しますか？<br><br>⚠️ 警告: この操作は履歴を書き換えるため、共有ブランチにプッシュされたコミットには使用しないでください。",
  "BUTTON_SAVE": "保存",
  "RESET": "リセット",
  ...
  "CODE_INSPECTION_PROBLEMS": "コード検査で問題が見つかりました",
  ...
  "CREATE_NEW_BRANCH_TITLE": "新しいブランチの作成",
  ...
  "DIALOG_CHECKOUT": "コミットをチェックアウトすると、リポジトリはデタッチドHEAD状態になります。この状態に基づいてブランチを作成しない限り、コミットを作成できません。",
  "DIALOG_PULL_TITLE": "リモートからプル",
  "DIALOG_PUSH_TITLE": "リモートへプッシュ",
  "SKIP_PRE_PUSH_CHECKS": "プッシュ前のチェックをスキップ (--no-verify)",
  "DIFF": "差分",
  "DIFFTOOL": "difftoolで差分を表示",
  "DIFF_FAILED_SEE_FILES": "Git diff が差分結果の提供に失敗しました。コミットされるステージングファイルのリストは次のとおりです：",
  "DIFF_TOO_LONG": "差分が長すぎて表示できません",
  "ENABLE_GERRIT_PUSH_REF": "Gerrit互換のプッシュrefを使用する",
  ...
  "PASSWORD": "パスワード",
  "PASSWORDS": "パスワード",
  "PATH_TO_GIT_EXECUTABLE": "Git実行ファイルのパス",
  ...
  "RESET_LOCAL_REPO_CONFIRM": "最後のコミットからのすべての変更を破棄しますか？ この操作は元に戻せません。",
  "UNDO_LOCAL_COMMIT_CONFIRM": "最後のプッシュされていないコミットを元に戻してもよろしいですか？",
  "MORE_OPTIONS": "その他のオプション",
  "CREDENTIALS": "資格情報",
  "SAVE_CREDENTIALS_HELP": "資格情報が他の場所で管理されている場合は、ユーザー名/パスワードを入力する必要はありません。操作がタイムアウトし続ける場合にのみ使用してください。",
  "SAVE_CREDENTIALS_IN_URL": "リモートURLに認証情報を保存（平文）",
  "SET_THIS_BRANCH_AS_TRACKING": "このブランチを新しい追跡ブランチとして設定",
  ...
  "TAG_NAME": "タグ",
  "CMD_CLOSE_UNMODIFIED": "変更されていないファイルを閉じる",
  "FILE_ADDED": "新規ファイル",
  "FILE_COPIED": "コピー済み",
  "FILE_DELETED": "削除済み",
  "FILE_IGNORED": "無視済み",
  ...
  "GIT_PUSH_SUCCESS_MSG": "ファーストフォワードプッシュに成功しました",
  ...
  "GIT_PUSH_UP_TO_DATE_MSG": "参照は最新で、プッシュする必要がありませんでした",
  ...
  "ERROR_CREATE_BRANCH": "新しいブランチの作成に失敗しました",
  ...
  "ERROR_CHANGE_EMAIL_FAILED": "ユーザーメールアドレスの変更ができません",
  ...
  "ERROR_DISCARD_CHANGES_FAILED": "ファイルの変更を破棄できませんでした",
  "ERROR_COULD_NOT_RESOLVE_FILE": "ファイルを解決できませんでした",
  "ERROR_MERGE_ABORT_FAILED": "マージの中止に失敗しました",
  "ERROR_MODIFIED_DIALOG_FILES": "コミットダイアログが表示されている間に、コミットしようとしていたファイルが変更されました。ダイアログに表示されていた内容と結果が異なるため、コミットを中止します。",
