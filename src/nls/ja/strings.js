...
define({
  ...
  "CMD_HOMEPAGE": "ホームページ - アプリのダウンロード",
  ...
  "HEALTH_DATA_PREVIEW_INTRO": "<p>{APP_NAME}<strong>は個人を特定できる情報を収集または処理しませんが</strong>、プライバシーを保護するために<strong>匿名の使用統計を収集します</strong>。匿名データは GDPR/CCPA 通知要件から免除されますが、匿名データの収集を適切にオプトアウトする選択肢が必要であると考えられます。<br>これらの<strong>匿名の</strong>アプリ使用統計とエラー レポートは、機能の優先順位付け、バグの発見、{APP_NAME} の操作性に関するユーザビリティの問題の特定に役立ちます。</p><p>以下は、次回のヘルス レポートが有効になっている<em>場合</em>に送信されるデータのプレビューです。 (「Caught Critical error」とマークされたエラー ログについては、開発者コンソールも参照してください。)</p>",
  ...
  "VIEW_MORE": "もっと見る...",
  "NEW_PROJECT_NOTIFICATION": "新しいプロジェクトを作成するには、このアイコンをクリックします。</br><img src=\"styles/images/new_project.png\"><br/><a href='#' style='float:right;'>わかりました</a>",
