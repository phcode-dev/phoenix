...
define({
  ...
  "AI_CHAT_TITLE": "クロード・コード",
  "AI_CHAT_CLI_NOT_FOUND": "クロード・コードがインストールされていません",
  "AI_CHAT_CLI_INSTALL_MSG": "{APP_NAME}でAI機能を使用するには、システムにクロード・コードCLIをインストールする必要があります。<a class='ai-learn-more-link' href='#'>詳細はこちら</a>",
  "AI_CHAT_CLI_INSTALL_BTN": "クロード・コードをインストール",
  "AI_CHAT_CLI_INSTALLING": "インストール中…",
  "AI_CHAT_CLI_INSTALLING_MSG": "クロード・コードをインストールしています。しばらくお待ちください。この処理には時間がかかる場合があります…",
  "AI_CHAT_CLI_RESTART_NOTE": "インストールが完了したら、{APP_NAME}を再起動してください。",
  "AI_CHAT_CLAUDE_LOGIN_TITLE": "クロード・コードのセットアップ",
  "AI_CHAT_CLAUDE_LOGIN_MSG": "Claude Codeはインストールされていますが、設定が必要です。<a class='ai-learn-more-link' href='#'>詳細はこちら</a>",
  ...
  "AI_CHAT_PLAN_FEEDBACK_PLACEHOLDER": "変更したい内容を入力"
});