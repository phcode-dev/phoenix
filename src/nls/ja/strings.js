...
define({
  ...
  "KEYBOARD_SHORTCUT_CMENU_OVERRIDE": "コマンドの上書きショートカット",
  "KEYBOARD_SHORTCUT_CMENU_DISABLE": "ショートカットを無効にする",
  ...
  "UPDATE_RELOAD_APP": "{APP_NAME} のすべてのウィンドウ/タブを閉じて、{APP_NAME} を再度開いて最新バージョンを取得してください。",
