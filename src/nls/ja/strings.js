...
define({
  ...
  "AI_CHAT_CLI_INSTALL_MSG": "{APP_NAME}でAI機能を使用するには、システムにClaude Code CLIをインストールする必要があります。<a class='ai-learn-more-link' href='#'>詳細はこちら</a>",
  ...
  "AI_CHAT_CLAUDE_LOGIN_MSG": "Claude Codeはインストールされていますが、設定が必要です。<a class='ai-learn-more-link' href='#'>詳細</a>",
  "AI_CHAT_CLAUDE_LOGIN_BTN": "Claude Codeをセットアップ",
  "AI_CHAT_ADD_PROVIDER_BTN": "カスタムプロバイダーを追加",
  "AI_CHAT_RETRY": "再試行",
  "AI_CHAT_DESKTOP_ONLY": "ＡＩ機能にはPhoenixデスクトップアプリが必要です。ダウンロードして始めましょう。",
  "AI_CHAT_DOWNLOAD_BTN": "デスクトップアプリをダウンロード",
  "AI_CHAT_LOGIN_TITLE": "ＡＩを利用するためにサインイン",
  ...
  "AI_CHAT_INTRO_CONFIGURE_DESC": "AIのセットアップ方法を、この短い動画でご覧ください。",
  ...
  "PROMO_CARD_2": "エディター内のAI",
  "PROMO_CARD_2_MESSAGE": "AIにコードの記述、バグの修正、プロジェクトのリファクタリングを依頼。あなたに代わって作業をこなします。",
  "PROMO_CARD_3": "あらゆるデバイスでプレビュー",
  "PROMO_CARD_3_MESSAGE": "ライブプレビューをスマートフォン、タブレット、またはカスタムのビューポートに合わせてリサイズ。レスポンシブの問題をリリース前に見つけ出します。",
  "PROMO_CARD_4": "リッチなMarkdownをライブで",
  "PROMO_CARD_4_MESSAGE": "図、表、コードブロックに対応した、洗練されたサイドバイサイドのMarkdownプレビュー。入力と同時にレンダリングされます。"
});