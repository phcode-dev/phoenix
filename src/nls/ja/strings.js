...
define({
  ...
  "DEVICE_SIZE_LIMIT_TITLE": "Phoenix Proで利用可能",
  ...
  "LIVE_PREVIEW_SYNC_SOURCE_AND_PREVIEW": "コードとプレビューの同期",
  "LIVE_DEV_SETTINGS_SYNC_SOURCE_AND_PREVIEW_PREFERENCE": "ソースコードのカーソルとライブプレビューの要素ハイライトを同期します。有効にすると、エディターでカーソルを移動した際にライブプレビューで対応する要素がハイライトされ、ライブプレビューで要素をクリックするとカーソルがそのソースコードにジャンプします。デフォルトは「true」です。",
