...
define({
  ...
  "UPDATE_CLOSE_TO_UPDATE_TITLE": "更新できません",
  "UPDATE_CLOSE_TO_UPDATE": "複数のエディタ ウィンドウが開いています。更新を試みる前に、他のすべての {APP_NAME} エディタ ウィンドウが閉じられていることを確認してください。追加の {APP_NAME} ウィンドウを閉じて、もう一度更新してみてください。",
