...
define({
  ...
  "DESCRIPTION_LIVEDEV_MAIN_HEADING": "おっと！お使いのブラウザーはライブプレビューに対応していません。",
  "DESCRIPTION_LIVEDEV_MAIN_SPAN": "最高のライブプレビューを体験するには、{0}からWindows、Mac、Linux用のネイティブアプリをダウンロードしてください。",
  "AI_CHAT_TOOL_READ_FILE_RANGE": "{0}の{1}～{2}行目を読み込みました",
  "AI_CHAT_TOOL_READ_FILE_FROM": "{0}の{1}行目から読み込みました",
  "AI_CHAT_TOOL_APPLIED_DIRECTLY": "ディスクに直接適用済み・diffは利用できません",
  "AI_CHAT_TOOL_REJECTED": "編集は拒否されました―ファイルは変更されていません",
  "AI_CHAT_TOOL_REJECTED_REASON": "理由：{0}",
  "AI_CHAT_FILE_NOT_FOUND_TITLE": "ファイルが見つかりません",
  "AI_CHAT_FILE_NOT_FOUND_MSG": "<span class=\"dialog-filename\">{0}</span>を開けませんでした。ファイルが移動されたか、削除された可能性があります。",
  "AI_CHAT_DIFF_MORE_TITLE": "diffオプション",
  ...
  "AI_CHAT_PLAN_WRITE_CONFIRM_BODY": "Claudeが{0}を編集しようとしています。現在、プランモード中です。",
  "AI_CHAT_PLAN_WRITE_ALLOW": "許可して編集モードに切り替える",
