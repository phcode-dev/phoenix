...
define({
  ...
  "LIVE_DEV_ELEMENT_PROPS_NO_CLASSES": "クラスなし",
  "LIVE_DEV_ELEMENT_PROPS_NO_ATTRIBUTES": "属性がありません",
  ...
  "PHOENIX_TOUR_EDIT_MODE": "編集モードでは、ライブプレビューで直接ページを調整できます。要素をクリックして、インラインで調査・編集が可能です。",
  "PROMO_CARD_2": "あなたと同じ視点を持つAI",
  "PROMO_CARD_2_MESSAGE": "AIを使ってUIのアイデアを探求し、アプリを構築し、問題を修正しましょう。AIはコードだけでなく、あなたと同じようにページを視覚的に認識します。",
  "PROMO_CARD_3": "あらゆるデバイスでページを確認",
  "PROMO_CARD_3_MESSAGE": "スマートフォン、タブレット、デスクトップの表示を瞬時に切り替えて、レスポンシブに関する問題を早期に発見できます。",
  "PROMO_CARD_4": "あなたのMarkdownを、本物のドキュメントのように",
  "PROMO_CARD_4_MESSAGE": "表、画像、書式設定を視覚的に編集。Markdownをより簡単に扱うための新しい方法です。",
  "AI_CHAT_SURPRISE_ME_USER_MSG": "おまかせで！",
  "AI_CHAT_CLI_INSTALL_MSG": "{APP_NAME}でAI機能を使用するには、システムにClaude Code CLIをインストールする必要があります。",
  "AI_CHAT_CLAUDE_LOGIN_MSG": "Claude Codeはインストールされていますが、設定が必要です。",
  "AI_CHAT_SETUP_NEED_HELP": "お困りですか？",
  "AI_CHAT_SETUP_LEARN_MORE": "詳細はこちら",
  "AI_CHAT_DESKTOP_ONLY": "AI機能には{APP_NAME}デスクトップアプリが必要です。利用を開始するには、ダウンロードしてください。",
  "AI_CHAT_PLACEHOLDER_TITLE": "AIで設計、構築、修正をより速く",
  "AI_CHAT_PLACEHOLDER_SUBTITLE": "プレビューと連携するAI",
  "AI_CHAT_PLACEHOLDER_CARD_LAYOUT_TITLE": "レイアウトを生成",
  "AI_CHAT_PLACEHOLDER_CARD_LAYOUT_DESC": "セクションを記述",
  "AI_CHAT_PLACEHOLDER_CARD_BUGS_TITLE": "バグを修正",
  "AI_CHAT_PLACEHOLDER_CARD_BUGS_DESC": "問題をスキャン",
  "AI_CHAT_PLACEHOLDER_CARD_IMPROVE_TITLE": "改善点を提案",
  "AI_CHAT_PLACEHOLDER_CARD_IMPROVE_DESC": "ＵＸとパフォーマンスのヒント",
  "AI_CHAT_LOGIN_TITLE": "サインインしてＡＩを始めましょう",
  "AI_CHAT_INTRO_CONFIGURE_DESC": "この短い動画を見て{APP_NAME}でＡＩを設定します"
});