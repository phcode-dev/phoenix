...
define({
  ...
  "AI_CHAT_CLI_NOT_FOUND": "Claude CLIが見つかりません",
  "AI_CHAT_CLI_INSTALL_MSG": "AI機能を使用するには、Claude CLIをインストールしてください:<br><code>npm install -g @anthropic-ai/claude-code</code><br><br>その後、<code>claude login</code>を実行して認証してください。",
  "AI_CHAT_RETRY": "再試行",
