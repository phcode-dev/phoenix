...
define({
  ...
  "UPDATE_READY_RESTART_INSTALL_MESSAGE": "アップデートが正常にダウンロードされました: 最新のアップデートを適用するには、すべての {APP_NAME} アプリ ウィンドウを閉じてください。",
  ...
  "UPDATE_FAILED_MESSAGE": "すべての {APP_NAME} アプリ ウィンドウを閉じ、アプリケーションを再度開き、アップデートを再試行してください。",
