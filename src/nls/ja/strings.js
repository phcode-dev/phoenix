...
define({
  ...
  "LIVE_DEV_STYLES_COMPUTED_NO_RESULTS": "結果が見つかりません",
  ...
  "LIVE_DEV_ELEMENT_PROPS_TITLE": "要素プロパティ",
  ...
  "LIVE_DEV_CB_LABEL_ALIGN": "テキストの配置",
  ...
  "LIVE_DEV_CB_TRANSFORM_UPPERCASE": "すべて大文字",
  "LIVE_DEV_CB_TRANSFORM_LOWERCASE": "すべて小文字",
  ...
  "LIVE_DEV_CB_LIST_DECIMAL": "アラビア数字",
  "LIVE_DEV_CB_LIST_LOWER_ALPHA": "英小文字",
  "LIVE_DEV_CB_LIST_UPPER_ALPHA": "英大文字",
  ...
  "LIVE_DEV_CB_TIP_SPACING": "マージンとパディング",
  ...
  "LIVE_DEV_CB_DIM_W": "幅",
  "LIVE_DEV_CB_DIM_H": "高",
  "LIVE_DEV_CB_MINMAX_TOOLTIP": "最小/最大の制約",
  ...
  "LIVE_DEV_SETTINGS_SHOW_SPACING_HANDLES_PREFERENCE": "ライブプレビューの編集モードで要素が選択されている場合に、間隔ハンドルを表示します。デフォルトは「true」です。",
  "LIVE_PREVIEW_SYNC_SOURCE_AND_PREVIEW": "コードとプレビューを同期",
  "LIVE_DEV_SETTINGS_SYNC_SOURCE_AND_PREVIEW_PREFERENCE": "ソースコードのカーソルとライブプレビューの要素ハイライトを同期します。有効にすると、エディターでカーソルを移動するとライブプレビューの対応する要素がハイライトされ、ライブプレビューで要素をクリックするとそのソースコードにカーソルがジャンプします。デフォルトは「true」です。"
});