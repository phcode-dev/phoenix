...
define({
  ...
  "DESCRIPTION_LIVEDEV_SECURITY": "phcode.dev からのセキュリティ警告<br><br>このライブ プレビューは、非プロジェクト ファイルにアクセスしようとしました。安全のためアクセスが拒否されました。信頼できないプロジェクトに取り組む場合は注意してください。",
