...
define({
  ...
  "DROP_TO_OPEN_PROJECT": "ドロップするとフォルダー `{0}` がプロジェクトとして開きます",
  ...
  "ERROR_PREFS_CORRUPT_RESET": "{APP_NAME} の設定が破損しているためリセットされました。変更を有効にするには、{APP_NAME} を再起動してください。",
  ...
  "UNSUPPORTED_DOM_APIS_CONFIRM": "`window.confirm` および `window.prompt` API は、{APP_NAME} の埋め込みライブ プレビューでは使用できません。ブラウザでこれらの API を使用するには、ライブ プレビューをポップアウトしてください。",
  ...
  "KEYBOARD_SHORTCUT_PRESET_TOOLTIP": "VSCode、WebStorm、Sublime Textなどのエディターのキーボードショートカットを使用する",
  "KEYBOARD_SHORTCUT_PRESET_SELECT": "ショートカットプリセットを選択",
  "KEYBOARD_SHORTCUT_PRESET_USING": "{0} の使用",
  "DEFAULT": "デフォルト",
  ...
  "KEYBOARD_SHORTCUT_SRC_USER": "ユーザー定義の",
  ...
  "STATUSBAR_SELECTION_MULTIPLE": "— {0} 複数のカーソル選択",
  ...
  "STATUSBAR_AUTO_INDENT": "<span title=\"クリックすると固定インデントに切り替わります。現在は、現在のファイルに基づいてインデントを自動的に検出して適用するように設定されています。\">オート</span>",
  "STATUSBAR_FIXED_INDENT": "<span title=\"クリックすると自動インデント検出に切り替わります。現在は固定インデントに設定されています。\">修理済み</span>",
  ...
  "CLICK_VIEW_PROBLEM": "クリックするとパネルに問題が表示されます",
  "FILE_MENU": "ファイル",
  ...
  "CMD_AUTO_RENAME_TAGS": "HTML タグの自動名前変更",
  "FIND_MENU": "検索",
  "CMD_FIND": "検索",
  "CMD_FIND_NEXT": "次を検索",
  ...
  "CMD_SHOW_IN_EXPLORER": "Windows ファイルエクスプローラー",
  "CMD_SHOW_IN_FINDER": "macOS ファインダー",
  "CMD_SHOW_IN_FILE_MANAGER": "ファイルマネージャー",
  "CMD_OPEN_IN_CMD": "コマンドプロンプト",
  "CMD_OPEN_IN_POWER_SHELL": "パワーシェル",
  "CMD_OPEN_IN_DEFAULT_APP": "システムのデフォルトアプリ",
  "CMD_SWITCH_PANE_FOCUS": "ペインフォーカスの切り替え",
  "CMD_OPEN_VFS": "仮想ファイル システムを開く",
  "CMD_DIAGNOSTIC_TOOLS": "{APP_NAME} 診断ツール",
  "CMD_EXPERIMENTAL_FEATURES": "実験的な機能",
  "CMD_ENABLE_DRAG_AND_DROP": "ファイルをドラッグアンドドロップ",
  ...
  "JSHINT_NAME": "JSHint",
  "JSHINT_CONFIG_ERROR": "JSHint 構成ファイルの読み取りエラー: {0}",
  "JSHINT_CONFIG_JSON_ERROR": "エラー: JSHint 構成ファイル `{0}` は有効な JSON ではありません",
  "ESLINT_NAME": "ESLint",
  "CSS_LINT_NAME": "{0}",
  "HTML_LINT_NAME": "html",
  "HTML_LINT_CONFIG_JSON_ERROR": "エラー: HTML バリデーター構成ファイル `{0}` は有効な JSON ではありません",
  "HTML_LINT_CONFIG_UNSUPPORTED": "エラー: サポートされていない設定形式 `{0}`。JSON 設定 `.htmlvalidate.json` を使用してください",
  ...
  "DESCRIPTION_HTML_LINT_DISABLE": "問題パネルで HTML リンターを無効にするには true にします",
  ...
  "DESCRIPTION_AUTO_RENAME_TAGS": "ペアになった HTML/XML タグの名前を自動的に変更する場合は true、そうでない場合は false",
  "DESCRIPTION_DRAG_AND_DROP_ENABLED": "ファイルエクスプローラーまたは Finder からファイルやフォルダをドラッグ アンド ドロップする機能を有効にするには true にします。",
  "DESCRIPTION_TRIPLE_CTRL_PALETTE": "true にすると、Ctrl/Cmd キーを 3 回連続して押すとビジュアル コマンド オーバーレイが表示されます。",
  ...
  "DESCRIPTION_AUTO_TAB_SPACE": "現在のファイルで使用されているタブとスペースを自動検出するには true にします",
  ...
  "DESCRIPTION_EDITOR_LINE_HEIGHT": "エディター内のコード行間の垂直間隔を調整します。1～3 の値を選択します。デフォルトは 1.5 です。",
  ...
  "PUBLISH": "公開",
  "PUBLISH_CONSENT_MESSAGE": "変更内容をすばやくプレビューし、Web サイトを他のユーザーと共有します。{APP_NAME} は、この Web サイトを {0} に公開できます。公開されたリンクは 3 日間有効です。</br>Web サイトを公開して共有しますか?",
  ...
  "GIT_PROJECT": "Gitから取得",
  "NEW_PROJECT_FROM_GIT": "Gitからの新しいプロジェクト",
  "GIT_REPO_URL": "GitリポジトリURL:",
  "GIT_CLONE_URL": "Git クローン URL:",
  ...
  "LOCATION": "位置 ：",
  "ERROR_ONLY_GITHUB": "{APP_NAME} のブラウザ バージョンは GitHub URL のみをサポートしています。他の Git URL を操作するには、デスクトップ アプリを使用してください。",
  "ERROR_GIT_URL_INVALID": "有効な Git クローン URL を入力してください。",
  "ERROR_GIT_FOLDER_NOT_EMPTY": "選択したフォルダーは空でないか読み取り不可能であるため、Git クローンには使用できません。",
  "ERROR_GIT_FOLDER_NOT_EXIST": "選択したフォルダーは存在しないため、Git クローンには使用できません。",
  ...
  "DOWNLOAD_FAILED_MESSAGE": "ダウンロード URL が有効であることを確認してください。</br>注意: Phoenix は無料なので、25 MB を超えるプライベート リポジトリと GitHub URL は許可されません。",
  ...
  "DEFAULT_PROJECT_HTML_CLICK_HERE": "HTML ファイル内でこの &lt;span&gt; を見つけるには、ここをクリックしてください",
  ...
  "ADD_ENDLINE_TO_THE_END_OF_FILE": "ファイルの最後にエンドラインを追加する",
  "ADD_TO_GITIGNORE": ".gitignore に追加",
  "AMEND_COMMIT": "最後のコミットを修正",
  "SKIP_COMMIT_CHECKS": "コミット前のチェックをスキップする (--no-verify)",
  "AMEND_COMMIT_FORBIDDEN": "プッシュされていないコミットがない場合、コミットを修正することはできません",
  "_ANOTHER_BRANCH": "別の支店",
  "AUTHOR": "作成者",
  "AUTHORS_OF": "著者",
  "SYSTEM_CONFIGURATION": "システム構成",
  "BRACKETS_GIT_ERROR": "Git でエラーが発生しました…",
  "BRANCH_NAME": "支店名",
  "BUTTON_CANCEL": "キャンセル",
  ...
  "BUTTON_FIND_CONFLICTS": "競合を見つける…",
  "GIT_INIT": "熱",
  "BUTTON_MERGE_ABORT": "マージを中止",
  "BUTTON_OK": "OK",
  "BUTTON_REBASE_ABORT": "アボート",
  "BUTTON_REBASE_CONTINUE": "リベースを続行する",
  "BUTTON_REBASE_SKIP": "スキップ",
  "MENU_RESET_HARD": "これ以降の変更とコミットを破棄します（ハードリセット）",
  "MENU_RESET_MIXED": "これ以降のコミットは破棄しますが、変更はステージングせずに保持します (混合リセット)",
  "MENU_RESET_SOFT": "これ以降のコミットは破棄しますが、変更はステージングされたままにします (ソフト リセット)",
  "MENU_TAG_COMMIT": "タグコミット",
  "RESET_HARD_TITLE": "ハードリセットの確認",
  "RESET_MIXED_TITLE": "混合リセットの確認",
  "RESET_SOFT_TITLE": "ソフトリセットの確認",
  "RESET_DETAIL": "<b>以下のコミット以降は破棄されます:</b><br><b>コミットメッセージ:</b> {0}<br> <b>Git コマンド:</b> {1}",
  "RESET_HARD_MESSAGE": "このアクションは、選択したコミット以降のすべての変更とコミットを破棄します。<b>この操作は簡単に元に戻すことはできません。</b>続行してもよろしいですか?<br><br> ⚠️ 警告: これは履歴を書き換えるため、共有ブランチにプッシュされたコミットには使用しないでください。",
  "RESET_MIXED_MESSAGE": "このアクションは、選択したコミット以降のすべてのコミットを破棄しますが、すべての変更はステージングされないままになります。<b>この操作は簡単に元に戻すことはできません。</b>続行してもよろしいですか?<br><br> ⚠️ 警告: これは履歴を書き換えるため、共有ブランチにプッシュされたコミットには使用しないでください。",
  "RESET_SOFT_MESSAGE": "このアクションは、選択したコミット以降のすべてのコミットを破棄しますが、すべての変更は新しいコミット用にステージングされたままになります。<b>この操作は簡単に元に戻すことはできません。</b>続行してもよろしいですか?<br><br> ⚠️ 警告: これは履歴を書き換えるため、共有ブランチにプッシュされたコミットには使用しないでください。",
  "BUTTON_SAVE": "保存",
  "RESET": "リセット",
  "CHANGE_USER_EMAIL_TITLE": "Gitメールを変更する",
  "CHANGE_USER_EMAIL": "Git メールを変更する…",
  "CHANGE_USER_EMAIL_MENU": "Git のメール ({0}) を変更します…",
  "CHANGE_USER_NAME_TITLE": "Gitユーザー名を変更する",
  "CHANGE_USER_NAME": "Git ユーザー名を変更します…",
  "CHANGE_USER_NAME_MENU": "Git ユーザー名 ({0}) を変更します…",
  "REQUIRES_APP_RESTART_SETTING": "この設定を変更するにはアプリを再起動する必要があります",
  "CLEAN_FILE_END": "ファイルをクリーンアップしました",
  "CLEAN_FILE_START": "クリーニングファイル",
  "CLEANING_WHITESPACE_PROGRESS": "ファイルから空白を削除しています…",
  "CLEAR_WHITESPACE_ON_FILE_SAVE": "ファイル保存時に空白をクリアする",
  "CLONE_REPOSITORY": "リポジトリのクローン",
  "CODE_INSPECTION_PROBLEMS": "コード検査の問題",
  "CODE_INSPECTION_IN_PROGRESS": "コード検査中…",
  "CODE_INSPECTION_PROBLEMS_NONE": "問題は検出されませんでした",
  "CODE_INSPECTION_DONE_FILES": "{1} 件中 {0} 件のファイルが完了しました…",
  "PLEASE_WAIT": "お待ちください…",
  "COMMIT": "専念",
  "COMMIT_ALL_SHORTCUT": "すべてのファイルをコミットします…",
  "COMMIT_CURRENT_SHORTCUT": "現在のファイルをコミットします…",
  "COMMIT_MESSAGE_PLACEHOLDER": "ここにコミットメッセージを入力してください…",
  "CREATE_NEW_BRANCH": "新しいブランチを作成…",
  "CREATE_NEW_BRANCH_TITLE": "新しいブランチを作成",
  "CREATE_NEW_GITFTP_SCOPE": "新しい Git-FTP リモートを作成します…",
  "CREATE_NEW_REMOTE": "新しいリモートを作成…",
  "CURRENT_TRACKING_BRANCH": "現在の追跡ブランチ",
  "_CURRENT_TRACKING_BRANCH": "現在の追跡ブランチ",
  "DEFAULT_GIT_TIMEOUT": "デフォルトの Git 操作タイムアウト (秒単位)",
  "DELETE_FILE_BTN": "ファイルを削除…",
  "DELETE_LOCAL_BRANCH": "ローカルブランチを削除する",
  "DELETE_LOCAL_BRANCH_NAME": "ローカル ブランチ \"{0}\" を本当に削除しますか?",
  "DELETE_REMOTE": "リモコンを削除",
  "DELETE_REMOTE_NAME": "本当にリモート「{0}」を削除しますか?",
  "DELETE_SCOPE": "Git-FTPスコープを削除する",
  "DELETE_SCOPE_NAME": "本当に Git-FTP スコープ \"{0}\" を削除しますか?",
  "DIALOG_CHECKOUT": "コミットをチェックアウトすると、リポジトリは DETACHED HEAD 状態になります。これに基づいてブランチを作成しない限り、コミットを行うことはできません。",
  "DIALOG_PULL_TITLE": "リモートからプル",
  "DIALOG_PUSH_TITLE": "リモートにプッシュ",
  "SKIP_PRE_PUSH_CHECKS": "プッシュ前のチェックをスキップする (--no-verify)",
  "DIFF": "差分",
  "DIFFTOOL": "difftool で比較する",
  "DIFF_FAILED_SEE_FILES": "Git diff は diff 結果を提供できませんでした。これはコミットされるステージングされたファイルのリストです:",
  "DIFF_TOO_LONG": "差分が長すぎて表示できません",
  "ENABLE_GERRIT_PUSH_REF": "Gerrit互換のpush refを使用する",
  "ENTER_NEW_USER_EMAIL": "メールアドレスを入力",
  "ENTER_NEW_USER_NAME": "ユーザー名を入力してください",
  "ENTER_PASSWORD": "パスワードを入力してください:",
  "ENTER_REMOTE_GIT_URL": "クローンするリポジトリの Git URL を入力します:",
  "ENTER_REMOTE_NAME": "新しいリモコンの名前を入力してください:",
  "ENTER_REMOTE_URL": "新しいリモコンの URL を入力してください:",
  "ENTER_USERNAME": "ユーザー名を入力してください:",
  "ERROR_NOTHING_SELECTED": "何も選択されていません!",
  "ERROR_SAVE_FIRST": "まずドキュメントを保存してください。",
  "ERROR_TERMINAL_NOT_FOUND": "お使いのOS用のターミナルが見つかりませんでした。設定でカスタムターミナルコマンドを定義できます。",
  "EXTENDED_COMMIT_MESSAGE": "延長",
  "GETTING_STAGED_DIFF_PROGRESS": "ステージングされたファイルの差分を取得しています…",
  "GIT_COMMIT": "Git コミット…",
  "GIT_COMMIT_IN_PROGRESS": "Git コミット進行中",
  "GIT_DIFF": "Git diff - 差分",
  "GIT_PULL_RESPONSE": "Git プルレスポンス",
  "GIT_PUSH_RESPONSE": "Git プッシュ応答",
  "GIT_REMOTES": "Git リモート",
  "GIT_SETTINGS": "Git 設定…",
  "GIT_SETTINGS_TITLE": "Git設定",
  "GOTO_NEXT_GIT_CHANGE": "次のGit変更へ進む",
  "GOTO_PREVIOUS_GIT_CHANGE": "前の Git 変更へ移動",
  "GUTTER_CLICK_DETAILS": "詳細はクリックしてください",
  "HIDE_UNTRACKED": "パネル内の追跡されていないファイルを非表示にする",
  "HISTORY": "歴史",
  "HISTORY_COMMIT_BY": "による",
  "LINES": "ライン",
  "_LINES": "行",
  "MARK_MODIFIED_FILES_IN_TREE": "ファイルツリー内の変更されたファイルをマークする",
  "MERGE_BRANCH": "ブランチをマージ",
  "MERGE_MESSAGE": "メッセージを結合",
  "MERGE_RESULT": "マージ結果",
  "NORMALIZE_LINE_ENDINGS": "行末を正規化する（\\n に）",
  "NOTHING_TO_COMMIT": "コミットするものはありません。作業ディレクトリはクリーンです。",
  "OPERATION_IN_PROGRESS_TITLE": "Git 操作が進行中です…",
  "ORIGIN_BRANCH": "起源ブランチ",
  "ON_BRANCH": "'{0}' - 現在の Git ブランチ",
  "PANEL_COMMAND": "Gitパネルを表示",
  "PASSWORD": "パスワード",
  "PASSWORDS": "パスワード",
  "PATH_TO_GIT_EXECUTABLE": "Git 実行ファイルへのパス",
  "PULL_AVOID_MERGING": "手動マージを避ける",
  "PULL_DEFAULT": "デフォルトのマージ",
  "PULL_FROM": "引き出す",
  "PULL_MERGE_NOCOMMIT": "コミットなしでマージする",
  "PULL_REBASE": "キツネを使おう",
  "PULL_RESET": "ソフトリセットを使用する",
  "PULL_SHORTCUT": "リモートからプル…",
  "PULL_SHORTCUT_BEHIND": "リモートからプル ({0} 後ろ)…",
  "PULL_BEHAVIOR": "プル動作",
  "FETCH_SHORTCUT": "リモートから取得",
  "PUSH_DEFAULT": "デフォルトのプッシュ",
  "PUSH_DELETE_BRANCH": "リモートブランチを削除する",
  "PUSH_SEND_TAGS": "タグを送信",
  "PUSH_FORCED": "強制プッシュ",
  "PUSH_SHORTCUT": "リモートにプッシュ…",
  "PUSH_SHORTCUT_AHEAD": "リモートにプッシュ ({0} 先)…",
  "PUSH_TO": "プッシュする",
  "PUSH_BEHAVIOR": "プッシュ動作",
  "Q_UNDO_CHANGES": "ファイル<span class='dialog-filename'>{0}</span>への変更をリセットしますか?",
  "REBASE_RESULT": "フォックスの結果",
  "REFRESH_GIT": "Git を更新する",
  "REMOVE_BOM": "ファイルからBOMを削除する",
  "REMOVE_FROM_GITIGNORE": ".gitignore から削除",
  "RESET_LOCAL_REPO": "最後のコミット以降のすべての変更を破棄します…",
  "DISCARD_CHANGES": "変更を破棄",
  "RESET_LOCAL_REPO_CONFIRM": "最後のコミット以降に行われたすべての変更を破棄しますか? このアクションは元に戻せません。",
  "UNDO_LOCAL_COMMIT_CONFIRM": "最後にプッシュされなかったコミットを元に戻してもよろしいですか?",
  "MORE_OPTIONS": "その他のオプション",
  "CREDENTIALS": "資格",
  "SAVE_CREDENTIALS_HELP": "資格情報が他の場所で管理されている場合は、ユーザー名/パスワードを入力する必要はありません。操作がタイムアウトし続ける場合にのみ、これを使用してください。",
  "SAVE_CREDENTIALS_IN_URL": "資格情報をリモート URL に保存する (プレーンテキスト)",
  "SET_THIS_BRANCH_AS_TRACKING": "このブランチを新しい追跡ブランチとして設定する",
  "STRIP_WHITESPACE_FROM_COMMITS": "コミットから末尾の空白を削除する",
  "TARGET_BRANCH": "対象ブランチ",
  "TITLE_CHECKOUT": "チェックアウトコミット?",
  "TOOLTIP_CLONE": "既存のリポジトリをクローンする",
  "TOOLTIP_COMMIT": "選択したファイルをコミットする",
  "TOOLTIP_FETCH": "すべてのリモートを取得し、カウンターを更新する",
  "TOOLTIP_FIND_CONFLICTS": "プロジェクト内のGitマージ/リベースの競合の検索を開始します",
  "TOOLTIP_HIDE_FILE_HISTORY": "ファイル履歴を非表示",
  "TOOLTIP_HIDE_HISTORY": "履歴を非表示",
  "TOOLTIP_INIT": "リポジトリを初期化する",
  "TOOLTIP_MERGE_ABORT": "マージ操作を中止し、HEADを最後のローカルコミットにリセットします。",
  "TOOLTIP_PICK_REMOTE": "優先リモコンを選択",
  "TOOLTIP_PULL": "Git プル",
  "TOOLTIP_PUSH": "Gitプッシュ",
  "TOOLTIP_REBASE_ABORT": "リベース操作を中止し、HEADを元のブランチにリセットします。",
  "TOOLTIP_REBASE_CONTINUE": "マージ競合を解決した後、リベースプロセスを再開します。",
  "TOOLTIP_REBASE_SKIP": "現在のパッチをスキップしてリベースプロセスを再開します",
  "TOOLTIP_REFRESH_PANEL": "パネルを更新",
  "TOOLTIP_SHOW_FILE_HISTORY": "ファイル履歴を表示",
  "TOOLTIP_SHOW_HISTORY": "履歴を表示",
  "UNDO_CHANGES": "変更を破棄",
  "UNDO_CHANGES_BTN": "変更を破棄…",
  "UNDO_LAST_LOCAL_COMMIT": "最後のローカル（プッシュされていない）コミットを元に戻す...",
  "UNDO_COMMIT": "コミットを元に戻す",
  "URL": "メールアドレス",
  "USERNAME": "ユーザー名",
  "USER_ABORTED": "ユーザーが中止しました!",
  "USE_GIT_GUTTER": "Gitガターマークを使用する",
  "USE_NOFF": "マージが早送りとして解決される場合でもマージコミットを作成する (--no-ff)",
  "USE_REBASE": "FOXを使用する",
  "USE_VERBOSE_DIFF": "差分で詳細な出力を表示する",
  "USE_DIFFTOOL": "difftool を使って差分を表示する",
  "VIEW_AUTHORS_FILE": "ファイルの作成者を表示…",
  "VIEW_AUTHORS_SELECTION": "選択した著者を表示...",
  "VIEW_THIS_FILE": "このファイルを表示",
  "TAG_NAME_PLACEHOLDER": "ここにタグ名を入力してください…",
  "TAG_NAME": "タグ",
  ...
  "FILE_RENAMED": "名前を変更",
  "FILE_STAGED": "ステージング",
  "FILE_UNMERGED": "統合されていない",
  "FILE_UNMODIFIED": "未修正",
  "FILE_UNTRACKED": "未追跡",
  "GIT_PUSH_SUCCESS_MSG": "早送りに成功しました",
  "GIT_PUSH_FORCE_UPDATED_MSG": "強制更新に成功しました",
  "GIT_PUSH_DELETED_MSG": "参照を削除しました",
  "GIT_PUSH_NEW_REF_MSG": "新しい参照を正常にプッシュしました",
  "GIT_PUSH_REJECTED_MSG": "審判が拒否されたか、プッシュに失敗した",
  "GIT_PUSH_UP_TO_DATE_MSG": "Refは最新であり、プッシュする必要はありませんでした",
  "GIT_PULL_SUCCESS": "git pull が正常に完了しました",
  "GIT_MERGE_SUCCESS": "git マージが正常に完了しました",
  "GIT_REBASE_SUCCESS": "git rebaseが正常に完了しました",
  "GIT_BRANCH_DELETE_SUCCESS": "Git ブランチを正常に削除しました",
  "INIT_NEW_REPO_FAILED": "新しいリポジトリの初期化に失敗しました",
  "GIT_CLONE_REMOTE_FAILED": "リモート リポジトリのクローン作成に失敗しました。",
  "GIT_CLONE_ERROR_EXPLAIN": "選択されたディレクトリ `{0}`\nは空ではありません。Git クローンにはクリーンな空のディレクトリが必要です。\n空の場合は、隠しファイルを確認してください。",
  "FOLDER_NOT_WRITABLE": "選択されたディレクトリ `{0}`\nは書き込み可能ではありません。",
  "GIT_NOT_FOUND_MESSAGE": "Git がインストールされていないか、システムに見つかりません。Git をインストールするか、下のテキスト フィールドに Git 実行可能ファイルへの正しいパスを入力してください。",
  "ERROR_GETTING_BRANCH_LIST": "ブランチリストの取得に失敗しました",
  "ERROR_READING_GIT_HEAD": ".git/HEAD ファイルの読み取りに失敗しました",
  "ERROR_PARSING_BRANCH_NAME": "{0} からのブランチ名の解析に失敗しました",
  "ERROR_READING_GIT_STATE": ".git の状態の読み取りに失敗しました",
  "ERROR_GETTING_DELETED_FILES": "削除されたファイルのリストを取得できませんでした",
  ...
  "ERROR_BRANCH_DELETE_FORCED": "強制ブランチ削除に失敗しました",
  "ERROR_FETCH_REMOTE_INFO": "リモート情報の取得に失敗しました",
  "ERROR_CREATE_BRANCH": "新しいブランチの作成に失敗しました",
  "ERROR_REFRESH_GUTTER": "ガターのリフレッシュに失敗しました!",
  "ERROR_GET_HISTORY": "履歴を取得できませんでした",
  "ERROR_GET_MORE_HISTORY": "履歴行をさらに読み込むことができませんでした",
  "ERROR_GET_CURRENT_BRANCH": "現在のブランチ名を取得できませんでした",
  "ERROR_GET_DIFF_FILE_COMMIT": "差分を取得できませんでした",
  "ERROR_GET_DIFF_FILES": "差分ファイルのリストを読み込めませんでした",
  "ERROR_MODIFY_GITIGNORE": ".gitignore の変更に失敗しました",
  "ERROR_UNDO_LAST_COMMIT_FAILED": "最後のコミットを元に戻すことはできません",
  "ERROR_MODIFY_FILE_STATUS_FAILED": "ファイルステータスの変更に失敗しました",
  "ERROR_CHANGE_USERNAME_FAILED": "ユーザー名を変更できません",
  "ERROR_CHANGE_EMAIL_FAILED": "ユーザーのメールアドレスを変更できません",
  "ERROR_TOGGLE_GERRIT_PUSH_REF_FAILED": "gerrit push ref を切り替えることができません",
  "ERROR_RESET_LOCAL_REPO_FAILED": "ローカルリポジトリのリセットに失敗しました",
  "ERROR_CREATE_TAG": "タグの作成に失敗しました",
  "ERROR_CODE_INSPECTION_FAILED": "CodeInspection.inspectFile がファイルに対して実行できませんでした",
  "ERROR_CANT_GET_STAGED_DIFF": "ステージングされたファイルの差分を取得できません",
  "ERROR_GIT_COMMIT_FAILED": "Gitコミットに失敗しました",
  "ERROR_GIT_BLAME_FAILED": "Git Blame が失敗しました",
  "ERROR_GIT_DIFF_FAILED": "Git Diff に失敗しました",
  "ERROR_DISCARD_CHANGES_FAILED": "ファイルの変更を破棄できませんでした",
  "ERROR_COULD_NOT_RESOLVE_FILE": "ファイルを解決できませんでした",
  "ERROR_MERGE_ABORT_FAILED": "マージ中止に失敗しました",
  "ERROR_MODIFIED_DIALOG_FILES": "コミット ダイアログが表示されている間に、コミットしようとしていたファイルが変更されました。結果がダイアログに表示されたものと異なるため、コミットを中止します。",
  "ERROR_GETTING_REMOTES": "リモコンの取得に失敗しました。",
  ...
  "ERROR_NO_REMOTE_SELECTED": "{0} にリモートが選択されていません。",
