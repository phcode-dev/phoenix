...
define({
  ...
  "UNSUPPORTED_BROWSER_MOBILE": "現在、モバイル デバイスとタブレット デバイスは完全にはサポートされていません。このダイアログを閉じることはできますが、このブラウザでは Phoenix の一部の機能が動作しません。",
  ...
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " より多くのブラウザーで Phoenix を利用できるようにするために、私たちは懸命に取り組んでいます。このダイアログを閉じることはできますが、このブラウザでは Phoenix の一部の機能が動作しません。",
