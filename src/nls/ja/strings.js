...
define({
  ...
  "BOTTOM_PANEL_HIDE": "パネルを非表示",
  "BOTTOM_PANEL_SHOW": "下部パネルを表示",
  "BOTTOM_PANEL_HIDE_TOGGLE": "下部パネルを非表示",
  "BOTTOM_PANEL_DEFAULT_TITLE": "クイックアクセス",
  ...
  "AI_CHAT_DESKTOP_ONLY": "AI機能を利用するには、Phoenixデスクトップアプリが必要です。ダウンロードして開始してください。",
  "AI_CHAT_DOWNLOAD_BTN": "デスクトップアプリをダウンロード",
  "AI_CHAT_LOGIN_TITLE": "AIを利用するためにログイン",
  "AI_CHAT_LOGIN_MESSAGE": "AI機能にアクセスするには、{APP_NAME}アカウントにログインしてください。",
  "AI_CHAT_LOGIN_BTN": "ログイン",
  "AI_CHAT_UPSELL_TITLE": "Phoenix Pro + AI",
  "AI_CHAT_UPSELL_MESSAGE": "AI機能はPhoenix Proで利用できます。",
  "AI_CHAT_UPSELL_BTN": "Phoenix Proを入手",
  "AI_CHAT_ADMIN_DISABLED_TITLE": "AIが無効です",
  "AI_CHAT_ADMIN_DISABLED_MESSAGE": "AI機能はシステム管理者によって無効化されています。",
  ...
  "AI_CHAT_HISTORY_CLEAR_ALL": "すべて削除",
  "AI_CHAT_HISTORY_DELETE_CONFIRM": "このセッションを削除しますか？",
  "AI_CHAT_SWITCH_PROJECT_TITLE": "AIが処理中です",
  "AI_CHAT_SWITCH_PROJECT_MSG": "現在、AIがタスクを実行中です。プロジェクトを切り替えると、この処理は中断されます。続行しますか？"
});