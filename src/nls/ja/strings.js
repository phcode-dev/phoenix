...
define({
  ...
  "BOTTOM_PANEL_DEFAULT_HEADING": "パネルを開く",
  "BOTTOM_PANEL_OPEN_PANEL": "パネルを開く",
  ...
  "DEVICE_SIZE_LIMIT_MESSAGE": "携帯電話、タブレット、デスクトップ、およびCSSブレークポイントでページがどのように表示されるかを確認できます。Phoenix Proにアップグレードしてください。",
  "DEVICE_SIZE_NOT_ENOUGH_SPACE": "この画面サイズを表示するスペースが足りません。ズームアウトしてみてください。",
  "DEVICE_SIZE_CYCLE_TOOLTIP": "モバイル、タブレット、デスクトップ表示を切り替える",
  "DEVICE_SIZE_DROPDOWN_TOOLTIP": "すべてのデバイスサイズ",
  "DEVICE_SIZE_FIT_TO_PANEL": "パネルに合わせる",
  "BOTTOM_PANEL_DEFAULT_TITLE": "クイックアクセス - ツール"
});