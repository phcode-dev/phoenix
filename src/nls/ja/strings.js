...
define({
  ...
  "PROMO_CARD_2_MESSAGE": "セクションを視覚的に再配置 - コーディングに数分かけるのではなく、数秒でより多くのレイアウトアイデアを試せます。",
  "PROMO_CARD_3": "ストック画像ライブラリ",
  "PROMO_CARD_3_MESSAGE": "ロイヤリティフリーの画像を閲覧 - ホバーしてすぐにプレビュー、クリックして適用。より多くの選択肢を、より速く試せます。",
