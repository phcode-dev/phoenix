...
"use strict";var t=require("./constants.js"),i=require("./path.js");function e(t){return null==t?null:new Date(Number(t))}function s(t,s,n){this.dev=n,this.node=s.id,this.type=s.type,this.size=s.size,this.nlinks=s.nlinks,this.atime=e(s.atime),this.mtime=e(s.mtime),this.ctime=e(s.ctime),this.atimeMs=s.atime,this.mtimeMs=s.mtime,this.ctimeMs=s.ctime,this.version=s.version,this.mode=s.mode,this.uid=s.uid,this.gid=s.gid,this.name=i.basename(t)}s.prototype.isFile=function(){return this.type===t.NODE_TYPE_FILE},s.prototype.isDirectory=function(){return this.type===t.NODE_TYPE_DIRECTORY},s.prototype.isSymbolicLink=function(){return this.type===t.NODE_TYPE_SYMBOLIC_LINK},s.prototype.isSocket=s.prototype.isFIFO=s.prototype.isCharacterDevice=s.prototype.isBlockDevice=function(){return!1},module.exports=s;
...
function e(e,t,n,r,i,u,s){try{var a=e[u](s),c=a.value}catch(o){return void n(o)}a.done?t(c):Promise.resolve(c).then(r,i)}function t(t){return function(){var n=this,r=arguments;return new Promise(function(i,u){var s=t.apply(n,r);function a(t){e(s,i,u,a,c,"next",t)}function c(t){e(s,i,u,a,c,"throw",t)}a(void 0)})}}var n=require("../stats.js"),r=require("../constants.js"),i="nativeFsAccess",u=require("regenerator-runtime");function s(e,t){return e?"function"==typeof e?e={encoding:t}:"string"==typeof e&&(e={encoding:e}):e={encoding:t},e}function a(e){switch(e.kind){case r.KIND_FILE:return r.NODE_TYPE_FILE;case r.KIND_DIRECTORY:return r.NODE_TYPE_DIRECTORY;default:return null}}function c(e){return o.apply(this,arguments)}function o(){return(o=t(u.mark(function e(t){var n,i;return u.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:n=null,i={},e.t0=t.kind,e.next=e.t0===r.KIND_FILE?5:(e.t0,r.KIND_DIRECTORY,11);break;case 5:return e.next=7,t.getFile();case 7:return n=e.sent,i.size=n.size,i.mtime=n.lastModified,e.abrupt("return",i);case 11:return e.abrupt("return",i);case 12:case"end":return e.stop()}},e)}))).apply(this,arguments)}function p(e,t){return f.apply(this,arguments)}function f(){return(f=t(u.mark(function e(t,r){var s,o;return u.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,c(r);case 2:return s=e.sent,o={type:a(r),size:s.size,mtime:s.mtime},e.abrupt("return",new n(t,o,i));case 5:case"end":return e.stop()}},e)}))).apply(this,arguments)}module.exports={validate_directory_options:s,createStatObject:p};
},{"../stats.js":"dsCT","../constants.js":"iJA9","regenerator-runtime":"QVnC"}],"sfbT":[function(require,module,exports) {
function n(n,t,e,r,o,i,u){try{var a=n[i](u),c=a.value}catch(s){return void e(s)}a.done?t(c):Promise.resolve(c).then(r,o)}function t(t){return function(){var e=this,r=arguments;return new Promise(function(o,i){var u=t.apply(e,r);function a(t){n(u,o,i,a,c,"next",t)}function c(t){n(u,o,i,a,c,"throw",t)}a(void 0)})}}function e(n,t){return a(n)||u(n,t)||o(n,t)||r()}function r(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function o(n,t){if(n){if("string"==typeof n)return i(n,t);var e=Object.prototype.toString.call(n).slice(8,-1);return"Object"===e&&n.constructor&&(e=n.constructor.name),"Map"===e||"Set"===e?Array.from(e):"Arguments"===e||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)?i(n,t):void 0}}function i(n,t){(null==t||t>n.length)&&(t=n.length);for(var e=0,r=new Array(t);e<t;e++)r[e]=n[e];return r}function u(n,t){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(n)){var e=[],r=!0,o=!1,i=void 0;try{for(var u,a=n[Symbol.iterator]();!(r=(u=a.next()).done)&&(e.push(u.value),!t||e.length!==t);r=!0);}catch(c){o=!0,i=c}finally{try{r||null==a.return||a.return()}finally{if(o)throw i}}return e}}function a(n){if(Array.isArray(n))return n}function c(n){var t;if("undefined"!=typeof Symbol){if(Symbol.asyncIterator&&null!=(t=n[Symbol.asyncIterator]))return t.call(n);if(Symbol.iterator&&null!=(t=n[Symbol.iterator]))return t.call(n)}throw new TypeError("Object is not async iterable")}var s=require("../errors.js"),f=require("../path.js"),l=require("./utils"),p=require("../constants.js"),w=require("regenerator-runtime"),d=f.normalize,h="NATIVE_FILE_SYSTEM_ACCESS_MOUNTS",v="FILER_MOUNT_POINT_CHANGED_NOTIFICATION",y="/mnt",S={},m=1e6;function E(n){return!(!n||!(n=d(n)).startsWith("/mnt/"))}function O(n){return!(!n||"/mnt"!==(n=d(n)))}function N(n){return new Promise(function(t,e){n.provider.openReadOnlyContext().getObject(h,function(r,o){r?e(r):(o&&(S=o),t(n))})})}function x(){"undefined"!=typeof BroadcastChannel?new BroadcastChannel(v).postMessage(v):console.warn("window.BroadcastChannel not supported. Mount point changes wont reflect across tabs.")}function F(n){var t=n.provider;"undefined"!=typeof BroadcastChannel?new BroadcastChannel(v).onmessage=function(n){n.data===v&&N(t.openReadOnlyContext())}:console.warn("window.BroadcastChannel not supported. Mount point changes wont reflect across tabs.")}function b(n){return new Promise(function(t,e){n.provider.openReadWriteContext().putObject(h,S,function(r){r?e(r):t(n)})})}function Y(n){for(var t=[],r=function(){var r=e(i[o],2),u=r[0],a=r[1];t.push(new Promise(function(t){var e=a.isSameEntry(n),r=a.resolve(n);Promise.all([e,r]).then(function(n){var e=n[0]||!1,r=n[1]||[];t({existingMountName:u,isSameEntry:e,subPath:r.join("/")})})}))},o=0,i=Object.entries(S);o<i.length;o++)r();return t}function k(n){return new Promise(function(t){var e=Y(n);Promise.all(e).then(function(n){for(var e=0;e<n.length;e++){var r=n[e].existingMountName;if(n[e].isSameEntry)return void t("".concat(y,"/").concat(r));if(n[e].subPath.length>=1)return void t("".concat(y,"/").concat(r,"/").concat(n[e].subPath))}t(null)})})}function g(n){var t=n.name;if(!S[t])return t;for(var e=0;e<m;e++){var r="".concat(t,"_").concat(e);if(!S[r])return r}}function I(n){return new Promise(function(t,e){k(n).then(function(r){if(r)t(r);else{var o=g(n);o?(S[o]=n,t("".concat(y,"/").concat(o))):e("Mount name not fount")}})})}function P(n,t,e){e||(e=t,t=null);var r=null,o=null;N(n).then(function(){return t||window.showDirectoryPicker()}).then(function(n){return I(n)}).then(function(n){return r=n}).then(function(){return b(n)}).then(function(){return x()}).catch(function(n){o=new s.ENOTMOUNTED(n)}).finally(function(){if(e)e(o,[r]);else if(o)throw new s.ENOTMOUNTED(o)})}function T(n,t,e,r){return C.apply(this,arguments)}function C(){return(C=t(w.mark(function n(t,e,r,o){var i,u,a,c,f;return w.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:if(i=e.length,r!==i){n.next=5;break}o(null,t),n.next=25;break;case 5:return u=e[r],a=null,c=null,n.prev=8,n.next=11,t.getDirectoryHandle(u);case 11:a=n.sent,n.next=16;break;case 14:n.prev=14,n.t0=n.catch(8);case 16:return n.prev=16,n.next=19,t.getFileHandle(u);case 19:c=n.sent,n.next=24;break;case 22:n.prev=22,n.t1=n.catch(16);case 24:c&&r===i-1?o(null,c):a?T(a,e,r+1,o):(f=e.join("/"),o(new s.ENOENT("File/Dir does not exist: ",f)));case 25:case"end":return n.stop()}},n,null,[[8,14],[16,22]])}))).apply(this,arguments)}function D(n,t){return M.apply(this,arguments)}function M(){return(M=t(w.mark(function n(t,e){var r,o;return w.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:return r={mode:"readwrite"},n.prev=1,n.next=4,t.queryPermission(r);case 4:if("granted"!==(o=n.sent)){n.next=8;break}return e(!0),n.abrupt("return");case 8:return n.next=10,t.requestPermission(r);case 10:o=n.sent,e("granted"===o),n.next=17;break;case 14:n.prev=14,n.t0=n.catch(1),e(!1);case 17:case"end":return n.stop()}},n,null,[[1,14]])}))).apply(this,arguments)}function j(n,t){var e=n.split("/");(e.length<3||""!==e[0]||"mnt"!==e[1])&&t(new s.EINVAL("Cannot operate on path "+n));var r=S[e[2]];r?D(r,function(o){o?T(r,e,3,t):t(new s.EACCES("permission denied on path: "+n))}):t(new s.ENOENT("Path does not exist: ",n))}function _(n,t){return R.apply(this,arguments)}function R(){return(R=t(w.mark(function n(t,r){var o,i,u,a,s,f,l,p,d;return w.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:o=[],i=!0,u=!1,n.prev=3,s=c(t.entries());case 5:return n.next=7,s.next();case 7:return f=n.sent,i=f.done,n.next=11,f.value;case 11:if(l=n.sent,i){n.next=18;break}p=e(l,1),d=p[0],o.push(d);case 15:i=!0,n.next=5;break;case 18:n.next=24;break;case 20:n.prev=20,n.t0=n.catch(3),u=!0,a=n.t0;case 24:if(n.prev=24,n.prev=25,i||null==s.return){n.next=29;break}return n.next=29,s.return();case 29:if(n.prev=29,!u){n.next=32;break}throw a;case 32:return n.finish(29);case 33:return n.finish(24);case 34:r(null,o);case 35:case"end":return n.stop()}},n,null,[[3,20,24,34],[25,,29,33]])}))).apply(this,arguments)}function A(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function B(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function q(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function L(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function U(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function H(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function K(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function W(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function V(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function z(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function G(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function $(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function J(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function Q(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function X(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function Z(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function nn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function tn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function en(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function rn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function on(n,t,e){return un.apply(this,arguments)}function un(){return(un=t(w.mark(function n(t,e,r){return w.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:return n.prev=0,n.next=3,t.getDirectoryHandle(e,{create:!0});case 3:r(null),n.next=9;break;case 6:n.prev=6,n.t0=n.catch(0),r(new s.EIO("Filer native fs function not yet supported.",n.t0));case 9:case"end":return n.stop()}},n,null,[[0,6]])}))).apply(this,arguments)}function an(n,t,e,r){t=d(t);var o=f.dirname(t),i=f.basename(t);j(o,function(n,t){n?r(n):t.kind===p.KIND_FILE?r(new s.ENOTDIR("Parent path is not a directory.")):on(t,i,r)})}function cn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function sn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function fn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function ln(n,t,e,r){if(t=d(t),"function"!=typeof e)throw new s.ENOSYS("Filer readdir options are not yet supported");if(r=e,t===y){var o=Object.keys(S);r(null,o)}else j(t,function(n,t){n?r(n):t.kind===p.KIND_FILE?r(new s.ENOTDIR("Path is not a directory.")):_(t,r)})}function pn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function wn(n,t,e){return dn.apply(this,arguments)}function dn(){return(dn=t(w.mark(function n(t,e,r){var o,i,u,a;return w.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:return e=e||"utf-8",n.prev=1,n.next=4,t.getFile();case 4:return o=n.sent,n.t0=Blob,n.next=8,o.text();case 8:return n.t1=n.sent,n.t2=[n.t1],i=new n.t0(n.t2),n.next=13,new Response(i).arrayBuffer();case 13:u=n.sent,a=new TextDecoder(e).decode(u),r(null,a),n.next=21;break;case 18:n.prev=18,n.t3=n.catch(1),r(n.t3);case 21:case"end":return n.stop()}},n,null,[[1,18]])}))).apply(this,arguments)}function hn(n,t,e,r){j(t=d(t),function(n,t){n?r(n):t.kind===p.KIND_DIRECTORY?r(new s.EISDIR("Path is a directory.")):wn(t,e.encoding,r)})}function vn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function yn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function Sn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function mn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function En(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function On(n,t,e){j(t=d(t),function(n,r){n?e(n):l.createStatObject(t,r).then(function(n){e(null,n)}).catch(function(n){e(n)})})}function Nn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function xn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function Fn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function bn(){throw new s.ENOSYS("Filer native fs function not yet supported.")}function Yn(n,t,e,r,o){return kn.apply(this,arguments)}function kn(){return(kn=t(w.mark(function n(t,e,r,o,i){var u,a;return w.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:return r=r||"utf-8",n.prev=1,n.next=4,t.getFileHandle(e,{create:!0});case 4:return u=n.sent,n.next=7,u.createWritable();case 7:return a=n.sent,n.next=10,a.write(o);case 10:return n.next=12,a.close();case 12:i(null),n.next=18;break;case 15:n.prev=15,n.t0=n.catch(1),i(n.t0);case 18:case"end":return n.stop()}},n,null,[[1,15]])}))).apply(this,arguments)}function gn(n,t,e,r,o){t=d(t);var i=f.dirname(t),u=f.basename(t);j(i,function(n,t){n?o(n):t.kind===p.KIND_FILE?o(new s.ENOTDIR("Parent path is not a directory.")):Yn(t,u,r.encoding,e,o)})}function In(){throw new s.ENOSYS("Filer native fs function not yet supported.")}module.exports={appendFile:B,access:q,chown:L,chmod:U,close:H,ensureRootDirectory:A,exists:K,fchown:W,fchmod:V,fgetxattr:z,fremovexattr:G,fsetxattr:$,fstat:J,fsync:Q,ftruncate:X,futimes:Z,getxattr:nn,link:tn,lseek:en,lstat:rn,mkdir:an,mkdtemp:cn,mknod:sn,open:fn,readdir:ln,read:pn,readFile:hn,readlink:vn,removexattr:yn,rename:Sn,rmdir:mn,setxattr:En,stat:On,symlink:Nn,truncate:xn,unlink:Fn,utimes:bn,writeFile:gn,write:In,mountNativeFolder:P,refreshMountPoints:N,listenToMountPointChanges:F,MOUNT_POINT_ROOT:y,isMountPath:O,isMountSubPath:E};
},{"../errors.js":"p8GN","../path.js":"UzoP","./utils":"MmBs","../constants.js":"iJA9","regenerator-runtime":"QVnC"}],"bsBG":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer;function t(e){return(t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}var n=require("../path.js"),i=n.normalize,o=n.dirname,r=n.basename,u=n.isAbsolute,a=require("../shared.js"),c=require("../../lib/async.js"),f=require("../constants.js"),l=f.NODE_TYPE_FILE,s=f.NODE_TYPE_DIRECTORY,d=f.NODE_TYPE_SYMBOLIC_LINK,p=f.NODE_TYPE_META,m=f.FULL_READ_WRITE_EXEC_PERMISSIONS,E=f.ROOT_DIRECTORY_NAME,g=f.SUPER_NODE_ID,w=f.SYMLOOP_MAX,O=f.O_READ,b=f.O_WRITE,v=f.O_CREATE,y=f.O_EXCLUSIVE,h=f.O_APPEND,N=f.O_FLAGS,I=f.XATTR_CREATE,j=f.XATTR_REPLACE,A=f.FS_NOMTIME,D=f.FS_NOCTIME,T=require("../errors.js"),R=require("../directory-entry.js"),L=require("../open-files.js"),_=require("../open-file-description.js"),F=require("../super-node.js"),S=require("../node.js"),P=require("../dirent.js"),V=require("../stats.js"),B=require("./native-fs-implementation"),x=require("./utils");function C(e,t,n,i,o){var r=e.flags;r.includes(D)&&delete i.ctime,r.includes(A)&&delete i.mtime;var u=!1;function a(n){e.changes.push({event:"change",path:t}),o(n)}i.ctime&&(n.ctime=i.ctime,n.atime=i.ctime,u=!0),i.atime&&(n.atime=i.atime,u=!0),i.mtime&&(n.mtime=i.mtime,u=!0),u?e.putObject(n.id,n,a):a()}function M(e,t,n,u){if(n!==s&&n!==l)return u(new T.EINVAL("type must be a directory or file",t));t=i(t);var a,c,f,d=r(t),p=o(t);function m(n,i){!n&&i?u(new T.EEXIST("path name already exists",t)):!n||n instanceof T.ENOENT?e.getObject(a.data,E):u(n)}function E(t,i){t?u(t):(c=i,S.create({guid:e.guid,type:n},function(t,n){t?u(t):((f=n).nlinks+=1,e.putObject(f.id,f,w))}))}function g(t){if(t)u(t);else{var n=Date.now();C(e,p,f,{mtime:n,ctime:n},u)}}function w(t){t?u(t):(c[d]=new R(f.id,n),e.putObject(a.data,c,g))}k(e,p,function(n,i){n?u(n):i.type!==s?u(new T.ENOTDIR("a component of the path prefix is not a directory",t)):(a=i,k(e,t,m))})}function k(e,t,n){if(!(t=i(t)))return n(new T.ENOENT("path is an empty string"));var u=r(t),a=o(t),c=0;function f(t,i){if(t)return n(t);var o=new F(i);o&&o.type===p&&o.rnode?e.getObject(o.rnode,l):n(new T.EFILESYSTEMERROR)}function l(e,t){e?n(e):t?S.create(t,n):n(new T.ENOENT)}function m(i,o){i?n(i):o.type===s&&o.data?e.getObject(o.data,O):n(new T.ENOTDIR("a component of the path prefix is not a directory",t))}function O(i,o){if(i)n(i);else if(Object.prototype.hasOwnProperty.call(o,u)){var r=o[u].id;e.getObject(r,b)}else n(new T.ENOENT(null,t))}function b(e,t){if(e)return n(e);S.create(t,v)}function v(l,s){var p;l?n(l):s.type===d?++c>w?n(new T.ELOOP(null,t)):(p=s.data,p=i(p),a=o(p),u=r(p),E===u?e.getObject(g,f):k(e,a,m)):n(null,s)}E===u?e.getObject(g,f):k(e,a,m)}function X(e,t,n,i,o,r,u){var a=n.xattrs;r===I&&Object.prototype.hasOwnProperty.call(a,i)?u(new T.EEXIST("attribute already exists",t)):r!==j||Object.prototype.hasOwnProperty.call(a,i)?(a[i]=o,e.putObject(n.id,n,function(i){i?u(i):C(e,t,n,{ctime:Date.now()},u)})):u(new T.ENOATTR(null,t))}function q(e,t){var n,i,o;function r(o){o?t(o):S.create({guid:e.guid,id:n.rnode,type:s},function(n,o){n?t(n):((i=o).nlinks+=1,e.putObject(i.id,i,u))})}function u(n){n?t(n):(o={},e.putObject(i.data,o,t))}e.getObject(g,function(i,o){!i&&o?t():!i||i instanceof T.ENOENT?F.create({guid:e.guid},function(i,o){i?t(i):(n=o,e.putObject(n.id,n,r))}):t(i)})}function z(e,t,n){t=i(t);var u,a,c,f,l=r(t),d=o(t);function p(t,i){t?n(t):(c=i,e.getObject(c.data,m))}function m(t,i){t?n(t):(f=i,S.create({guid:e.guid,type:s},function(t,i){t?n(t):((u=i).nlinks+=1,e.putObject(u.id,u,E))}))}function E(t){t?n(t):(a={},e.putObject(u.data,a,w))}function g(t){if(t)n(t);else{var i=Date.now();C(e,d,c,{mtime:i,ctime:i},n)}}function w(t){t?n(t):(f[l]=new R(u.id,s),e.putObject(c.data,f,g))}k(e,t,function(i,o){!i&&o?n(new T.EEXIST(null,t)):!i||i instanceof T.ENOENT?k(e,d,p):n(i)})}function Y(e,t,n,o){var r=f.fsConstants,u=r.F_OK,a=r.R_OK,c=r.W_OK,l=r.X_OK,s=r.S_IXUSR,d=r.S_IXGRP,p=r.S_IXOTH;k(e,t=i(t),function(e,i){if(e)return o(e);if(n===u)return o(null);var r=Ce(i.mode,o);return r?n&(a|c)?o(null):n&l&&r&(s|d|p)?o(null):void o(new T.EACCES("permission denied",t)):void 0})}function U(e,t,n){t=i(t);var u,a,c,f,l=r(t),d=o(t);function p(i,o){i?n(i):E===l?n(new T.EBUSY(null,t)):Object.prototype.hasOwnProperty.call(o,l)?(u=(f=o)[l].id,e.getObject(u,m)):n(new T.ENOENT(null,t))}function m(i,o){i?n(i):o.type!==s?n(new T.ENOTDIR(null,t)):(u=o,e.getObject(u.data,g))}function g(i,o){i?n(i):(a=o,Object.keys(a).length>0?n(new T.ENOTEMPTY(null,t)):(delete f[l],e.putObject(c.data,f,w)))}function w(t){if(t)n(t);else{var i=Date.now();C(e,d,c,{mtime:i,ctime:i},O)}}function O(t){t?n(t):e.delete(u.id,b)}function b(t){t?n(t):e.delete(u.data,n)}k(e,d,function(t,i){t?n(t):(c=i,e.getObject(c.data,p))})}function K(t,n,u,a,c){"function"==typeof a&&(c=a,a=null),n=i(n);var f,p,m,g,O,h=r(n),N=o(n),I=0;function j(e,i){e?c(e):i.type!==s?c(new T.ENOENT(null,n)):(f=i,t.getObject(f.data,A))}function A(e,i){e?c(e):(p=i,Object.prototype.hasOwnProperty.call(p,h)?u.includes(y)?c(new T.EEXIST("O_CREATE and O_EXCLUSIVE are set, and the named file exists",n)):(m=p[h]).type===s&&u.includes(b)?c(new T.EISDIR("the named file is a directory and O_WRITE is set",n)):t.getObject(m.id,D):u.includes(v)?S.create({guid:t.guid,type:l},function(e,n){e?c(e):((g=n).nlinks+=1,a&&(g.mode=a),t.putObject(g.id,g,_))}):c(new T.ENOENT("O_CREATE is not set and the named file does not exist",n)))}function D(e,a){if(e)c(e);else{var f=a;f.type===d?++I>w?c(new T.ELOOP(null,n)):function(e){e=i(e),N=o(e),h=r(e),E===h&&(u.includes(b)?c(new T.EISDIR("the named file is a directory and O_WRITE is set",n)):k(t,n,L));k(t,N,j)}(f.data):L(void 0,f)}}function L(e,t){e?c(e):c(null,g=t)}function _(n){n?c(n):(O=e.alloc(0),t.putBuffer(g.data,O,P))}function F(e){if(e)c(e);else{var n=Date.now();C(t,N,f,{mtime:n,ctime:n},V)}}function P(e){e?c(e):(p[h]=new R(g.id,l),t.putObject(f.data,p,F))}function V(e){e?c(e):c(null,g)}E===h?u.includes(b)?c(new T.EISDIR("the named file is a directory and O_WRITE is set",n)):k(t,n,L):k(t,N,j)}function W(t,n,i,o,r,u){var a;function c(e){e?u(e):u(null,r)}function f(e){if(e)u(e);else{var i=Date.now();C(t,n.path,a,{mtime:i,ctime:i},c)}}function l(e){e?u(e):t.putObject(a.id,a,f)}t.getObject(n.id,function(c,f){if(c)u(c);else{a=f;var s=e.alloc(r);i.copy(s,0,o,o+r),n.position=r,a.size=r,a.version+=1,t.putBuffer(a.data,s,l)}})}function G(t,n,i,o,r,u,a){var c,f;function l(e){e?a(e):a(null,r)}function s(e){if(e)a(e);else{var i=Date.now();C(t,n.path,c,{mtime:i,ctime:i},l)}}function d(e){e?a(e):t.putObject(c.id,c,s)}function p(l,s){if(l)a(l);else{if(!(f=s))return a(new T.EIO("Expected Buffer"));var p=null!=u?u:n.position,m=Math.max(f.length,p+r),E=e.alloc(m);f&&f.copy(E),i.copy(E,p,o,o+r),void 0===u&&(n.position+=r),c.size=m,c.version+=1,t.putBuffer(c.data,E,d)}}t.getObject(n.id,function(e,n){e?a(e):(c=n,t.getBuffer(c.data,p))})}function H(e,t,n,i,o,r,u){var a,c;function f(e,a){if(e)u(e);else{if(!(c=a))return u(new T.EIO("Expected Buffer"));var f=null!=r?r:t.position;o=f+o>n.length?o-f:o,c.copy(n,i,f,f+o),void 0===r&&(t.position+=o),u(null,o)}}e.getObject(t.id,function(n,i){n?u(n):i.type===s?u(new T.EISDIR("the named file is a directory",t.path)):(a=i,e.getBuffer(a.data,f))})}function $(e,t,n){k(e,t=i(t),n)}function J(e,t,n){t.getNode(e,n)}function Q(e,t,n){t=i(t);var u,a,c=r(t),f=o(t);function l(e,t){if(e)return n(e);S.create(t,n)}function s(i,o){i?n(i):(a=o,Object.prototype.hasOwnProperty.call(a,c)?e.getObject(a[c].id,l):n(new T.ENOENT("a component of the path does not name an existing file",t)))}E===c?k(e,t,n):k(e,f,function(t,i){t?n(t):(u=i,e.getObject(u.data,s))})}function Z(e,t,n,u){t=i(t);var a=r(t),c=o(t);n=i(n);var f,l,d,p,m,E,g=r(n),w=o(n),O=Date.now();function b(t){t?u(t):C(e,n,E,{ctime:O},u)}function v(t,n){t?u(t):((E=n).nlinks+=1,e.putObject(E.id,E,b))}function y(t){t?u(t):e.getObject(m,v)}function h(t,n){t?u(t):(p=n,Object.prototype.hasOwnProperty.call(p,g)?u(new T.EEXIST("newpath resolves to an existing file",g)):(p[g]=l[a],m=p[g].id,e.putObject(d.data,p,y)))}function N(t,n){t?u(t):(d=n,e.getObject(d.data,h))}function I(t,n){t?u(t):(l=n,Object.prototype.hasOwnProperty.call(l,a)?l[a].type===s?u(new T.EPERM("oldpath refers to a directory")):k(e,w,N):u(new T.ENOENT("a component of either path prefix does not exist",a)))}k(e,c,function(t,n){t?u(t):(f=n,e.getObject(f.data,I))})}function ee(e,t,n){t=i(t);var u,a,c,f=r(t),l=o(t);function d(t){t?n(t):(delete a[f],e.putObject(u.data,a,function(t){if(t)n(t);else{var i=Date.now();C(e,l,u,{mtime:i,ctime:i},n)}}))}function p(t){t?n(t):e.delete(c.data,d)}function m(i,o){i?n(i):o.type===s?n(new T.EPERM("unlink not permitted on directories",f)):function(i,o){i?n(i):((c=o).nlinks-=1,c.nlinks<1?e.delete(c.id,p):e.putObject(c.id,c,function(i){i?n(i):C(e,t,c,{ctime:Date.now()},d)}))}(null,o)}function E(t,i){t?n(t):(a=i,Object.prototype.hasOwnProperty.call(a,f)?e.getObject(a[f].id,m):n(new T.ENOENT("a component of the path does not name an existing file",f)))}k(e,l,function(t,i){t?n(t):(u=i,e.getObject(u.data,E))})}function te(t,o,r,u){var a,f;function l(i,a){if(i)u(i);else{f=a;var l=Object.keys(f);if(r.encoding){var s=l.map(function(t){return e.from(t)});l="buffer"===r.encoding?s:s.map(function(e){return e.toString(r.encoding)})}if(r.withFileTypes){var d=[];c.eachSeries(l,function(i,u){var a=e.from(i,r.encoding).toString(),c=n.join(o,a);ne(t,c,function(e,t){e&&u(e),t.name=i,d.push(t),u()})},function(e){u(e,d)})}else u(null,l)}}o=i(o),"function"==typeof r&&(u=r,r={}),r=x.validate_directory_options(r),k(t,o,function(e,n){e?u(e):n.type!==s?u(new T.ENOTDIR(null,o)):(a=n,t.getObject(a.data,l))})}function ne(e,t,n){Q(e,t,function(i,o){if(i)n(i);else{var r=new P(t,o,e.name);n(null,r)}})}function ie(e,t,a,c){a=i(a);var f,l,s,p=r(a),m=o(a);function g(i,o){i?c(i):(l=o,Object.prototype.hasOwnProperty.call(l,p)?c(new T.EEXIST(null,p)):S.create({guid:e.guid,type:d},function(i,o){i?c(i):((s=o).nlinks+=1,u(t)||(s.symlink_relpath=t,t=n.resolve(m,t)),s.size=t.length,s.data=t,e.putObject(s.id,s,O))}))}function w(t){if(t)c(t);else{var n=Date.now();C(e,m,f,{mtime:n,ctime:n},c)}}function O(t){t?c(t):(l[p]=new R(s.id,d),e.putObject(f.data,l,w))}E===p?c(new T.EEXIST(null,p)):k(e,m,function(t,n){t?c(t):(f=n,e.getObject(f.data,g))})}function oe(e,t,n){t=i(t);var u,a,c=r(t),f=o(t);function l(t,i){t?n(t):(a=i,Object.prototype.hasOwnProperty.call(a,c)?e.getObject(a[c].id,s):n(new T.ENOENT("a component of the path does not name an existing file",c)))}function s(e,i){if(e)n(e);else if(i.type!==d)n(new T.EINVAL("path not a symbolic link",t));else{var o=i.symlink_relpath?i.symlink_relpath:i.data;n(null,o)}}k(e,f,function(t,i){t?n(t):(u=i,e.getObject(u.data,l))})}function re(t,n,o,r){var u;function a(n,i){if(n)r(n);else{if(!i)return r(new T.EIO("Expected Buffer"));var a=e.alloc(o);i&&i.copy(a),t.putBuffer(u.data,a,f)}}function c(e){if(e)r(e);else{var i=Date.now();C(t,n,u,{mtime:i,ctime:i},r)}}function f(e){e?r(e):(u.size=o,u.version+=1,t.putObject(u.id,u,c))}n=i(n),o<0?r(new T.EINVAL("length cannot be negative")):k(t,n,function(e,i){e?r(e):i.type===s?r(new T.EISDIR(null,n)):(u=i,t.getBuffer(u.data,a))})}function ue(t,n,i,o){var r;function u(n,u){if(n)o(n);else{var a;if(!u)return o(new T.EIO("Expected Buffer"));a=u?u.slice(0,i):e.alloc(i),t.putBuffer(r.data,a,c)}}function a(e){if(e)o(e);else{var i=Date.now();C(t,n.path,r,{mtime:i,ctime:i},o)}}function c(e){e?o(e):(r.size=i,r.version+=1,t.putObject(r.id,r,a))}i<0?o(new T.EINVAL("length cannot be negative")):n.getNode(t,function(e,n){e?o(e):n.type===s?o(new T.EISDIR):(r=n,t.getBuffer(r.data,u))})}function ae(e,t,n,o,r){t=i(t),"number"!=typeof n||"number"!=typeof o?r(new T.EINVAL("atime and mtime must be number",t)):n<0||o<0?r(new T.EINVAL("atime and mtime must be positive integers",t)):k(e,t,function(i,u){i?r(i):C(e,t,u,{atime:n,ctime:o,mtime:o},r)})}function ce(e,t,n,i,o){"number"!=typeof n||"number"!=typeof i?o(new T.EINVAL("atime and mtime must be a number")):n<0||i<0?o(new T.EINVAL("atime and mtime must be positive integers")):t.getNode(e,function(r,u){r?o(r):C(e,t.path,u,{atime:n,ctime:i,mtime:i},o)})}function fe(e,t,n,o,r,u){t=i(t),"string"!=typeof n?u(new T.EINVAL("attribute name must be a string",t)):n?null!==r&&r!==I&&r!==j?u(new T.EINVAL("invalid flag, must be null, XATTR_CREATE or XATTR_REPLACE",t)):k(e,t,function(i,a){if(i)return u(i);X(e,t,a,n,o,r,u)}):u(new T.EINVAL("attribute name cannot be an empty string",t))}function le(e,t,n,i,o,r){"string"!=typeof n?r(new T.EINVAL("attribute name must be a string")):n?null!==o&&o!==I&&o!==j?r(new T.EINVAL("invalid flag, must be null, XATTR_CREATE or XATTR_REPLACE")):t.getNode(e,function(u,a){if(u)return r(u);X(e,t.path,a,n,i,o,r)}):r(new T.EINVAL("attribute name cannot be an empty string"))}function se(e,t,n,o){t=i(t),"string"!=typeof n?o(new T.EINVAL("attribute name must be a string",t)):n?k(e,t,function(e,i){if(e)return o(e);var r=i.xattrs;Object.prototype.hasOwnProperty.call(r,n)?o(null,r[n]):o(new T.ENOATTR(null,t))}):o(new T.EINVAL("attribute name cannot be an empty string",t))}function de(e,t,n,i){"string"!=typeof n?i(new T.EINVAL):n?t.getNode(e,function(e,t){if(e)return i(e);var o=t.xattrs;Object.prototype.hasOwnProperty.call(o,n)?i(null,o[n]):i(new T.ENOATTR)}):i(new T.EINVAL("attribute name cannot be an empty string"))}function pe(e,t,n,o){t=i(t),"string"!=typeof n?o(new T.EINVAL("attribute name must be a string",t)):n?k(e,t,function(i,r){if(i)return o(i);var u=r.xattrs;Object.prototype.hasOwnProperty.call(u,n)?(delete u[n],e.putObject(r.id,r,function(n){n?o(n):C(e,t,r,{ctime:Date.now()},o)})):o(new T.ENOATTR(null,t))}):o(new T.EINVAL("attribute name cannot be an empty string",t))}function me(e,t,n,i){"string"!=typeof n?i(new T.EINVAL("attribute name must be a string")):n?t.getNode(e,function(o,r){if(o)return i(o);var u=r.xattrs;Object.prototype.hasOwnProperty.call(u,n)?(delete u[n],e.putObject(r.id,r,function(n){n?i(n):C(e,t.path,r,{ctime:Date.now()},i)})):i(new T.ENOATTR)}):i(new T.EINVAL("attribute name cannot be an empty string"))}function Ee(e){return Object.prototype.hasOwnProperty.call(N,e)?N[e]:null}function ge(e,t,n){return e?"function"==typeof e?e={encoding:t,flag:n}:"string"==typeof e&&(e={encoding:e,flag:n}):e={encoding:t,flag:n},e}function we(e,t,n,i,o){if(arguments.length<5?(o=arguments[arguments.length-1],i=420):i=Ce(i,m,o),!(n=Ee(n)))return o(new T.EINVAL("flags is not valid"),t);K(e,t,n,i,function(e,i){if(e)o(e);else{var r;r=n.includes(h)?i.size:0;var u=new _(t,i.id,n,r),a=L.allocDescriptor(u);o(null,a)}})}function Oe(e,t,n){L.getOpenFileDescription(t)?(L.releaseDescriptor(t),n(null)):n(new T.EBADF)}function be(e,t,n,i){M(e,t,n,i)}function ve(e,t,n,i){if(arguments.length<4)i=n,n=m;else if(!(n=Ce(n,m,i)))return;if(B.isMountSubPath(t))return B.mkdir(e,t,n,i);z(e,t,i)}function ye(e,t,n,i){"function"==typeof n&&(i=n,n=f.fsConstants.F_OK),Y(e,t,n|=f.fsConstants.F_OK,i)}function he(e,t,n,i){if(i=arguments[arguments.length-1],!t)return i(new Error("filename prefix is required"));var o=t+"-"+a.randomChars(6);z(e,o,function(e){i(e,o)})}function Ne(e,t,n){U(e,t,n)}function Ie(e,t,n){if(B.isMountSubPath(t))return B.stat(e,t,n);$(e,t,function(i,o){if(i)n(i);else{var r=new V(t,o,e.name);n(null,r)}})}function je(e,t,n){var i=L.getOpenFileDescription(t);i?J(e,i,function(t,o){if(t)n(t);else{var r=new V(i.path,o,e.name);n(null,r)}}):n(new T.EBADF)}function Ae(e,t,n,i){Z(e,t,n,i)}function De(e,t,n){ee(e,t,n)}function Te(e,t,n,i,o,r,u){i=void 0===i?0:i,o=void 0===o?n.length-i:o,u=arguments[arguments.length-1];var a=L.getOpenFileDescription(t);a?a.flags.includes(O)?H(e,a,n,i,o,r,function(e,t){u(e,t||0,n)}):u(new T.EBADF("descriptor does not permit reading")):u(new T.EBADF)}function Re(e,t,n){Ve(t,n)===t&&(L.getOpenFileDescription(t)?n():n(new T.EBADF))}function Le(t,n,i,o){o=arguments[arguments.length-1];var r=Ee((i=ge(i,null,"r")).flag||"r");return r?B.isMountSubPath(n)?B.readFile(t,n,i,o):void K(t,n,r,function(u,a){if(u)return o(u);var c=new _(n,a.id,r,0),f=L.allocDescriptor(c);function l(){L.releaseDescriptor(f)}J(t,c,function(r,u){if(r)return l(),o(r);var a=new V(c.path,u,t.name);if(a.isDirectory())return l(),o(new T.EISDIR("illegal operation on directory",n));var f=a.size,s=e.alloc(f);H(t,c,s,0,f,0,function(e){if(l(),e)return o(e);var t;t="utf8"===i.encoding||"utf16"===i.encoding?s.toString(i.encoding):s,o(null,t)})})}):o(new T.EINVAL("flags is not valid",n))}function _e(e,t,n,i,o,r,u){u=arguments[arguments.length-1],i=void 0===i?0:i,o=void 0===o?n.length-i:o;var a=L.getOpenFileDescription(t);a?a.flags.includes(b)?n.length-i<o?u(new T.EIO("input buffer is too small")):G(e,a,n,i,o,r,u):u(new T.EBADF("descriptor does not permit writing")):u(new T.EBADF)}function Fe(t,n,i,o,r){r=arguments[arguments.length-1];var u=Ee((o=ge(o,"utf8","w")).flag||"w");return u?(e.isBuffer(i)||("number"==typeof i&&(i=""+i),i="string"!=typeof(i=i||"")?e.from(i.toString()):e.from(i||"",o.encoding||"utf8")),B.isMountSubPath(n)?B.writeFile(t,n,i,o,r):void K(t,n,u,function(e,o){if(e)return r(e);var a=new _(n,o.id,u,0),c=L.allocDescriptor(a);W(t,a,i,0,i.length,function(e){if(L.releaseDescriptor(c),e)return r(e);r(null)})})):r(new T.EINVAL("flags is not valid",n))}function Se(t,n,i,o,r){r=arguments[arguments.length-1];var u=Ee((o=ge(o,"utf8","a")).flag||"a");if(!u)return r(new T.EINVAL("flags is not valid",n));"number"==typeof(i=i||"")&&(i=""+i),"string"==typeof i&&"utf8"===o.encoding&&(i=e.from(i)),K(t,n,u,function(e,o){if(e)return r(e);var a=new _(n,o.id,u,o.size),c=L.allocDescriptor(a);G(t,a,i,0,i.length,a.position,function(e){if(L.releaseDescriptor(c),e)return r(e);r(null)})})}function Pe(e,t,n){Ie(e,t,function(e){n(!e)})}function Ve(e,t){if("number"==typeof e)return e;t(new T.EINVAL("Expected integer",e))}var Be=/^[0-7]+$/;function xe(e){return e===e>>>0}function Ce(e,t,n){return"function"==typeof t&&(n=t,t=void 0),xe(e)?e&m:"number"==typeof e?(Number.isInteger(e),n(new T.EINVAL("mode not a valid an integer value",e)),!1):"string"==typeof e?Be.test(e)?parseInt(e,8)&m:(n(new T.EINVAL("mode not a valid octal string",e)),!1):void 0!==t?t:(n(new T.EINVAL("mode not valid",e)),!1)}function Me(e,t,n,o){t=i(t),"number"!=typeof n?o(new T.EINVAL("mode must be number",t)):k(e,t,function(i,r){i?o(i):(r.mode=n,C(e,t,r,{mtime:Date.now()},o))})}function ke(e,t,n,i){"number"!=typeof n?i(new T.EINVAL("mode must be a number")):t.getNode(e,function(o,r){o?i(o):(r.mode=n,C(e,t.path,r,{mtime:Date.now()},i))})}function Xe(e,t,n,o,r){t=i(t),k(e,t,function(i,u){i?r(i):(u.uid=n,u.gid=o,C(e,t,u,{mtime:Date.now()},r))})}function qe(e,t,n,i,o){t.getNode(e,function(r,u){r?o(r):(u.uid=n,u.gid=i,C(e,t.path,u,{mtime:Date.now()},o))})}function ze(e,t,n,i){se(e,t,n,i)}function Ye(e,t,n,i){var o=L.getOpenFileDescription(t);o?de(e,o,n,i):i(new T.EBADF)}function Ue(e,t,n,i,o,r){"function"==typeof o&&(r=o,o=null),fe(e,t,n,i,o,r)}function Ke(e,t,n,i,o,r){"function"==typeof o&&(r=o,o=null);var u=L.getOpenFileDescription(t);u?u.flags.includes(b)?le(e,u,n,i,o,r):r(new T.EBADF("descriptor does not permit writing")):r(new T.EBADF)}function We(e,t,n,i){pe(e,t,n,i)}function Ge(e,t,n,i){var o=L.getOpenFileDescription(t);o?o.flags.includes(b)?me(e,o,n,i):i(new T.EBADF("descriptor does not permit writing")):i(new T.EBADF)}function He(e,t,n,i,o){var r=L.getOpenFileDescription(t);r||o(new T.EBADF),"SET"===i?n<0?o(new T.EINVAL("resulting file offset would be negative")):(r.position=n,o(null,r.position)):"CUR"===i?r.position+n<0?o(new T.EINVAL("resulting file offset would be negative")):(r.position+=n,o(null,r.position)):"END"===i?J(e,r,function(e,t){e?o(e):t.size+n<0?o(new T.EINVAL("resulting file offset would be negative")):(r.position=t.size+n,o(null,r.position))}):o(new T.EINVAL("whence argument is not a proper value"))}function $e(e,t,n,i){if(B.isMountPath(t)||B.isMountSubPath(t))return B.readdir(e,t,n,i);te(e,t,n,i)}function Je(e){return"number"==typeof e?e:"object"===t(e)&&"function"==typeof e.getTime?e.getTime():void 0}function Qe(e,t,n,i,o){var r=Date.now();ae(e,t,n=Je(n||r),i=Je(i||r),o)}function Ze(e,t,n,i,o){var r=Date.now();n=Je(n||r),i=Je(i||r);var u=L.getOpenFileDescription(t);u?u.flags.includes(b)?ce(e,u,n,i,o):o(new T.EBADF("descriptor does not permit writing")):o(new T.EBADF)}function et(e,t,n,i){(n=Ce(n,i))&&Me(e,t,n,i)}function tt(e,t,n,i){if(n=Ce(n,i)){var o=L.getOpenFileDescription(t);o?o.flags.includes(b)?ke(e,o,n,i):i(new T.EBADF("descriptor does not permit writing")):i(new T.EBADF)}}function nt(e,t,n,i,o){return xe(n)?xe(i)?void Xe(e,t,n,i,o):o(new T.EINVAL("gid must be a valid integer",i)):o(new T.EINVAL("uid must be a valid integer",n))}function it(e,t,n,i,o){if(!xe(n))return o(new T.EINVAL("uid must be a valid integer",n));if(!xe(i))return o(new T.EINVAL("gid must be a valid integer",i));var r=L.getOpenFileDescription(t);r?r.flags.includes(b)?qe(e,r,n,i,o):o(new T.EBADF("descriptor does not permit writing")):o(new T.EBADF)}function ot(e,t,o,r){t=i(t),o=i(o);var u,a,c,f,l=n.dirname(t),d=n.dirname(t),p=n.basename(t),m=n.basename(o),E=Date.now();function g(t,n){t?r(t):C(e,o,n,{ctime:E},r)}function w(t){t?r(t):e.getObject(f[m].id,g)}function O(t){t?r(t):(u.id===c.id&&(a=f),delete a[p],e.putObject(u.data,a,w))}function b(t){t?r(t):(f[m]=a[p],e.putObject(c.data,f,O))}function v(t,n){t?r(t):(f=n,Object.prototype.hasOwnProperty.call(f,m)?U(e,o,b):b())}function y(t,n){t?r(t):(c=n,e.getObject(c.data,v))}function h(t,n){t?r(t):(a=n,k(e,d,y))}function N(t,n){t?r(t):(u=n,e.getObject(n.data,h))}function I(n){n?r(n):ee(e,t,r)}k(e,t,function(n,i){n?r(n):i.type===s?k(e,l,N):Z(e,t,o,I)})}function rt(e,t,n,i,o){ie(e,t,n,o=arguments[arguments.length-1])}function ut(e,t,n){oe(e,t,n)}function at(e,t,n){Q(e,t,function(i,o){if(i)n(i);else{var r=new V(t,o,e.name);n(null,r)}})}function ct(e,t,n,i){Ve(n=n||0,i=arguments[arguments.length-1])===n&&re(e,t,n,i)}function ft(e,t,n,i){i=arguments[arguments.length-1],n=n||0;var o=L.getOpenFileDescription(t);if(o)if(o.flags.includes(b)){if(Ve(n,i)!==n)return;ue(e,o,n,i)}else i(new T.EBADF("descriptor does not permit writing"));else i(new T.EBADF)}function lt(e,t,n){ve(e,B.MOUNT_POINT_ROOT,function(i){!i||i instanceof T.EEXIST?B.mountNativeFolder(e,t,n):n(i)})}function st(e,t){var n=B.refreshMountPoints(e);t&&n.then(function(){return t(null)}).catch(function(e){return t(e)})}function dt(e){return B.listenToMountPointChanges(e)}module.exports={appendFile:Se,access:ye,chown:nt,chmod:et,close:Oe,ensureRootDirectory:q,exists:Pe,fchown:it,fchmod:tt,fgetxattr:Ye,fremovexattr:Ge,fsetxattr:Ke,fstat:je,fsync:Re,ftruncate:ft,futimes:Ze,getxattr:ze,link:Ae,lseek:He,lstat:at,mkdir:ve,mkdtemp:he,mknod:be,open:we,readdir:$e,read:Te,readFile:Le,readlink:ut,removexattr:We,rename:ot,rmdir:Ne,setxattr:Ue,stat:Ie,symlink:rt,truncate:ct,unlink:De,utimes:Qe,writeFile:Fe,write:_e,mountNativeFolder:lt,refreshNativeMountPoints:st,listenToMountPointChanges:dt};
...
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer,r=require("es6-promisify"),t=r.promisify,n=require("../path.js"),a=require("../providers/index.js"),s=require("../shell/shell.js"),o=require("../../lib/intercom.js"),i=require("../fs-watcher.js"),u=require("../errors.js"),m=require("../shared.js"),l=m.nop,c=m.guid,f=require("../constants.js"),h=f.fsConstants,p=f.FILE_SYSTEM_NAME,d=f.FS_FORMAT,g=f.FS_READY,b=f.FS_PENDING,A=f.FS_ERROR,P=f.FS_NODUPEIDCHECK,v=f.STDIN,R=f.STDOUT,y=f.STDERR,E=require("./implementation.js");function w(e){return"function"==typeof e?e:function(e){if(e)throw e}}function S(e){e&&console.error("Filer error: ",e)}function O(e){if(!(e&&e.protocol&&e.pathname))return e;if("file:"!==e.protocol)throw new u.EINVAL("only file: URLs are supported for paths",e);for(var r=e.pathname,t=0;t<r.length;t++)if("%"===r[t]){var n=32|r.codePointAt(t+2);if("2"===r[t+1]&&102===n)throw new u.EINVAL("file: URLs must not include encoded / characters",e)}return decodeURIComponent(r)}function F(r){return e.isBuffer(r)?r.toString():r}function x(e,r){return e?n.isNull(e)?new u.EINVAL("Path must be a string without null bytes.",e):r||n.isAbsolute(e)?void 0:new u.EINVAL("Path must be absolute.",e):new u.EINVAL("Path must be a string",e)}function _(e,r,t){var n=e[r],a=x(n=F(n=O(n)),t);if(a)throw a;e[r]=n}function C(e,r){r=r||S;var m=(e=e||{}).flags||[],f=e.guid?e.guid:c,O=e.provider||new a.Default(e.name||p),F=e.name||O.name,x=m.includes(d),N=this;N.readyState=b,N.name=F,N.error=null,N.stdin=v,N.stdout=R,N.stderr=y,N.constants=h,N.F_OK=h.F_OK,N.R_OK=h.R_OK,N.W_OK=h.W_OK,N.X_OK=h.X_OK,this.Shell=s.bind(void 0,this);var q=[];function I(e){return function(r){m.includes(P)?r(null,f()):function r(t){var n=f();e.getObject(n,function(e,a){e?t(e):a?r(t):t(null,n)})}(r)}}this.queueOrRun=function(e){var r;return g===N.readyState?e.call(N):A===N.readyState?r=new u.EFILESYSTEMERROR("unknown error"):q.push(e),r},this.watch=function(e,r,t){if(n.isNull(e))throw new Error("Path must be a string without null bytes.");"function"==typeof r&&(t=r,r={}),r=r||{},t=t||l;var a=new i;return a.start(e,!1,r.recursive),a.on("change",t),a},O.open(function(e){function t(e){function t(e){var r=O[e]();return r.name=F,r.flags=m,r.changes=[],r.provider=N.provider,r.guid=I(r),r.close=function(){var e=r.changes;!function(e){if(e.length){var r=o.getInstance();e.forEach(function(e){r.emit(e.event,e.path)})}}(e),e.length=0},r}N.provider={openReadWriteContext:function(){return t("getReadWriteContext")},openReadOnlyContext:function(){return t("getReadOnlyContext")}},N.readyState=e?A:g,q.forEach(function(e){e.call(this)}.bind(N)),q=null,n.provider=N.provider,E.refreshNativeMountPoints(n),r(e,N)}if(e)return t(e);var n=O.getReadWriteContext();n.guid=I(n),x?n.clear(function(e){if(e)return t(e);E.ensureRootDirectory(n,t)}):E.ensureRootDirectory(n,t),N.listenToMountPointChanges&&N.listenToMountPointChanges(O.getReadWriteContext())}),C.prototype.promises={},[{name:"appendFile",promises:!0,absPathArgs:[0]},{name:"access",promises:!0,absPathArgs:[0]},{name:"chown",promises:!0,absPathArgs:[0]},{name:"chmod",promises:!0,absPathArgs:[0]},{name:"close"},{name:"exists",absPathArgs:[0]},{name:"fchown"},{name:"fchmod"},{name:"fgetxattr"},{name:"fremovexattr"},{name:"fsetxattr"},{name:"fstat"},{name:"fsync"},{name:"ftruncate"},{name:"futimes"},{name:"getxattr",promises:!0,absPathArgs:[0]},{name:"link",promises:!0,absPathArgs:[0,1]},{name:"lseek"},{name:"lstat",promises:!0},{name:"mkdir",promises:!0,absPathArgs:[0]},{name:"mkdtemp",promises:!0},{name:"mknod",promises:!0,absPathArgs:[0]},{name:"open",promises:!0,absPathArgs:[0]},{name:"readdir",promises:!0,absPathArgs:[0]},{name:"read"},{name:"readFile",promises:!0,absPathArgs:[0]},{name:"readlink",promises:!0,absPathArgs:[0]},{name:"removexattr",promises:!0,absPathArgs:[0]},{name:"rename",promises:!0,absPathArgs:[0,1]},{name:"rmdir",promises:!0,absPathArgs:[0]},{name:"setxattr",promises:!0,absPathArgs:[0]},{name:"stat",promises:!0,absPathArgs:[0]},{name:"symlink",promises:!0,relPathArgs:[0],absPathArgs:[1]},{name:"truncate",promises:!0,absPathArgs:[0]},{name:"unlink",promises:!0,absPathArgs:[0]},{name:"utimes",promises:!0,absPathArgs:[0]},{name:"writeFile",promises:!0,absPathArgs:[0]},{name:"write"},{name:"mountNativeFolder"},{name:"listenToMountPointChanges"}].forEach(function(e){var r=e.name,n=!0===e.promises;C.prototype[r]=function(){var t=this,n=Array.prototype.slice.call(arguments,0),a=n.length-1,s="function"!=typeof n[a],o=w(n[a]);e.absPathArgs&&e.absPathArgs.forEach(function(e){return _(n,e,!1)}),e.relPathArgs&&e.relPathArgs.forEach(function(e){return _(n,e,!0)});var i=t.queueOrRun(function(){var e=t.provider.openReadWriteContext();if(A===t.readyState){var i=new u.EFILESYSTEMERROR("filesystem unavailable, operation canceled");return o.call(t,i)}function m(){e.close(),o.apply(t,arguments)}s?n.push(m):n[a]=m;var l=[e].concat(n);E[r]?E[r].apply(null,l):console.warn("Filer: fs method, "+r+" not implemented. operation canceled")});i&&o(i)},n&&(C.prototype.promises[r]=t(C.prototype[r].bind(N)))})}C.providers=a,module.exports=C;
