...
define({
  ...
  "DECODE_FILE_FAILED_ERR": "{APP_NAME} не вдалося декодувати вміст файлу.",
  "UNSUPPORTED_UTF16_ENCODING_ERR": "{APP_NAME} наразі не підтримує кодовані UTF-16 текстові файли.",
  ...
  "ERROR_MOVING_FILE": "Сталася помилка при спробі перемістити {2} <span class='dialog-filename'>{0}</span>. {1}",
  "ERROR_MOVING_NOT_IN_PROJECT": "Неможливо перемістити файл/теку, оскільки вони не є частиною поточного проекту.",
  ...
  "ERROR_PROJ_PREFS_CORRUPT": "Ваш файл налаштувань проекту не є коректним JSON. Файл відкриється для того, щоб можна було виправити формат. Вам потрібно буде перезавантажити проект, щоб зміни вступили в силу.",
  ...
  "LIVE_DEV_SELECT_FILE_TO_PREVIEW": "Виберіть файл для динамічного перегляду",
  "LIVE_DEV_CLICK_TO_RELOAD_PAGE": "Перезавантажити сторінку",
  "LIVE_DEV_CLICK_POPOUT": "Спливаючі Live Preview до нового вікна",
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "Закріпити на Відкріпити сторінку попереднього перегляду",
  ...
  "CONFIRM_FILE_DELETE": "Ви дійсно хочете видалити файл <span class='dialog-filename'>{0}</span>?",
  ...
  "WINDOW_UNLOAD_WARNING": "Ви впевнені, що хочете перейти до іншої URL-адреси та залишити дужки?",
  "WINDOW_UNLOAD_WARNING_WITH_UNSAVED_CHANGES": "У вас є незбережені зміни! Ви впевнені, що хочете перейти до іншої URL-адреси та залишити дужки?",
  "DONE": "Готово",
  "OK": "OK",
  "CANCEL": "Скасувати",
  ...
  "FILTER_NAME_REMAINING": "{0} символів, що залишилися",
  ...
  "CMD_TOGGLE_LIVE_PREVIEW_MB_MODE": "Включити експериментальний попередній перегляд",
  ...
  "CMD_TOGGLE_SIDEBAR": "Перемикання бічній панелі",
  ...
  "CMD_GOTO_DEFINITION_PROJECT": "Швидке визначення пошуку в проекті",
  ...
  "CMD_SWITCH_PANE_FOCUS": "Перемкнути фокус на панелі",
  ...
  "CMD_HOMEPAGE": "{APP_NAME} Домашня сторінка",
  ...
  "ABOUT": "Про програму",
  "CLOSE": "Закрити",
  "ABOUT_TEXT_LINE1": "Випуск {ВЕРСІОНА_ОСНОВНІ}. {ВЕРСІЯ МІНОР} {BUILD_TYPE} {ВЕРСІЯ}",
  "ABOUT_TEXT_BUILD_TIMESTAMP": "мітка часу збирання: ",
  "ABOUT_TEXT_LINE3": "Бібліотеки третіх сторін, які ми використовуємо - <a href='https://github.com/phcode-dev/phoenix/tree/main/src/thirdparty/licences'> Ліцензії та Атрибуції</a> . ",
  ...
  "ABOUT_TEXT_LINE5": "Зроблено за допомогою ❤ та JavaScript шляхом:",
  "ABOUT_TEXT_LINE6": "Багато людей (але у нас виникли проблеми із завантаженням цих даних прямо зараз).",
  ...
  "FLIPVIEW_BTN_TOOLTIP": "Перевернути цей вигляд на панель {0}",
  ...
  "SORT_EXTENSION_METHOD": "Сортування розширень за допомогою DownloadCount або Pub",
  "INVALID_ZIP_FILE": "Завантажені дані не є zip-архівом.",
  "MISSING_PACKAGE_JSON": "Пакунок не має файлу package.json.",
  ...
  "NPM_INSTALL_FAILED": "Команда встановлення npm зазнала невдачі: {0}",
  ...
  "EXTENSION_MANAGER_DISABLE": "Відключити розширення",
  "EXTENSION_MANAGER_DISABLE_ERROR": "Неможливо вимкнути одне або декілька розширень: {0}. {APP_NAME} все одно перезавантажиться.",
  ...
  "MARKED_FOR_DISABLING": "Позначений для відключення",
  ...
  "DISABLE_AND_RELOAD": "Відключення розширень і перезавантаження",
  ...
  "EXTENSIONS_DEFAULT_TITLE": "Типове",
  ...
  "CMD_LAUNCH_SCRIPT_MAC": "Встановити клавіатурне скорочення командного рядка",
  ...
  "CREATING_LAUNCH_SCRIPT_TITLE": "{APP_NAME} Комбінація клавіш командного рядка",
  "ERROR_CREATING_LAUNCH_SCRIPT": "Сталася помилка при установці ярлика командного рядка. Спробуйте <a href='https://github.com/adobe/brackets/wiki/Command-Line-Arguments#troubleshooting'>ці пропозиції щодо усунення неполадок</a>. <br/><br/>Причина: {0}",
  "ERROR_CLTOOLS_RMFAILED": "Не вдалося вилучити існуюче символічне посилання <code>/usr/local/bin/дужки</code> .",
  "ERROR_CLTOOLS_MKDIRFAILED": "Неможливо створити каталог <code>/usr/local/bin</code> .",
  "ERROR_CLTOOLS_LNFAILED": "Не вдалося створити символічне посилання <code>/usr/local/bin/дужки</code> .",
  "ERROR_CLTOOLS_SERVFAILED": "Внутрішня помилка.",
  "ERROR_CLTOOLS_NOTSUPPORTED": "Ярлик командного рядка не підтримується в цій ОС.",
  "LAUNCH_SCRIPT_CREATE_SUCCESS": "Успіхів! Тепер ви можете легко запустити {APP_NAME} з командного рядка: <code>дужки myFile.txt</code> , щоб відкрити файл або <code>дужки MyFolder</code> для перемикання проектів. <br/><br/><a href='https://github.com/adobe/brackets/wiki/Command-Line-Arguments'>Докладніше</a> про використання {APP_NAME} можна дізнатися з командного рядка.",
  ...
  "HEALTH_DATA_NOTIFICATION": "Налаштування звіту про стан здоров'я",
  "HEALTH_FIRST_POPUP_TITLE": "{APP_NAME} Звіт про стан здоров'я",
  "HEALTH_DATA_DO_TRACK": "Поділіться псевдонімною інформацією про те, як я використовую {APP_NAME}",
  "HEALTH_DATA_NOTIFICATION_MESSAGE": "Щоб покращити {APP_NAME}, ми періодично надсилаємо обмежену <strong>псевдонімну</strong> статистику до core.ai про те, як ви використовуєте {APP_NAME}. Ця інформація допомагає визначати пріоритети функцій, знаходити помилки та визначати проблеми з юзабіліті, захищаючи вашу конфіденційність. <br><br>Виможете переглянути свої дані або не передавати дані, вибравши <strong>Довідка > Звіт про стан здоров'я</strong>. <br><br>",
  "HEALTH_DATA_PREVIEW": "{APP_NAME} Звіт про стан здоров'я",
  "HEALTH_DATA_PREVIEW_INTRO": "<p>Щобпокращити {APP_NAME}, ми періодично надсилаємо обмежену <strong>псевдонімну</strong> статистику до core.ai про те, як ви використовуєте {APP_NAME}. Ця інформація допомагає визначити пріоритети функцій, знайти помилки та визначити проблеми з юзабіліті. </p><p>Нижченаведено попередній перегляд даних, які будуть надіслані у наступному звіті про стан здоров'я, <em>якщо</em> він увімкнений. </p>",
  ...
  "CMD_REFACTOR": "Рефакторинт",
  "CMD_EXTRACTTO_VARIABLE": "Витяг до змінної",
  "CMD_EXTRACTTO_FUNCTION": "Витяг до функції",
  "ERROR_TERN_FAILED": "Неможливо отримати дані від крячок",
  "ERROR_EXTRACTTO_VARIABLE_NOT_VALID": "Виділення не утворює виразу",
  "ERROR_EXTRACTTO_FUNCTION_NOT_VALID": "Обраний блок повинен представляти набір операторів або вираз",
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "Витяг до змінної не працює в мультивюрсорах",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "Витяг до функції не працює в мультивюрсорах",
  "EXTRACTTO_FUNCTION_SELECT_SCOPE": "Виберіть область призначення",
  "EXTRACTTO_VARIABLE_SELECT_EXPRESSION": "Вибрати вираз",
  "CMD_REFACTORING_RENAME": "Перейменувати",
  "CMD_REFACTORING_TRY_CATCH": "Загорніть у Спробуйте зловити",
  "CMD_REFACTORING_CONDITION": "Обгорнути в умові",
  "CMD_REFACTORING_GETTERS_SETTERS": "Створення геттерів/сеттерів",
  "CMD_REFACTORING_ARROW_FUNCTION": "Перетворити на функцію стрілок",
  "DESCRIPTION_CODE_REFACTORING": "Включення/вимикання рефакторингу коду JavaScript",
  "ERROR_TRY_CATCH": "Виберіть коректний код, щоб обернути блок Try-catch",
  "ERROR_WRAP_IN_CONDITION": "Виберіть коректний код, який потрібно обернути в блок «Стан»",
  "ERROR_ARROW_FUNCTION": "Помістити курсор всередині функціонального виразу",
  "ERROR_GETTERS_SETTERS": "Помістити курсор на член об'єктного виразу",
  "ERROR_RENAME_MULTICURSOR": "Неможливо перейменувати під час використання декількох курсорів",
  "ERROR_RENAME_QUICKEDIT": "Неможливо перейменувати цей ідентифікатор, оскільки на нього посилається інше місце поза цією функцією",
  ...
  "COLLAPSE_ALL": "Згорнути всі",
  "EXPAND_ALL": "Розгорнути всі",
  "COLLAPSE_CURRENT": "Згорнути поточний",
  "EXPAND_CURRENT": "Розгорнути поточний",
  "RECENT_FILES_DLG_HEADER": "Нещодавні файли",
  "RECENT_FILES_DLG_CLEAR_BUTTON_LABEL": "Ясно",
  "RECENT_FILES_DLG_CLEAR_BUTTON_TITLE": "Очистити файли, які не в робочому наборі",
  "DESCRIPTION_CLOSE_BRACKETS": "true для автоматичного закриття дужок, дужок і дужок",
  "DESCRIPTION_CLOSE_OTHERS_ABOVE": "false, щоб видалити «Закрити інші вище» з контекстного меню Робочі файли",
  "DESCRIPTION_CLOSE_OTHERS_BELOW": "false, щоб видалити «Закрити інші нижче» з контекстного меню Робочі файли",
  "DESCRIPTION_CLOSE_OTHERS": "false, щоб видалити «Закрити інші» з контекстного меню Робочих файлів",
  "DESCRIPTION_CLOSE_TAGS": "Встановлює параметри закриття міток",
  "DESCRIPTION_CLOSE_TAGS_DONT_CLOSE_TAGS": "Масив тегів, які не слід автоматично закривати",
  "DESCRIPTION_CLOSE_TAGS_WHEN_OPENING": "Закрити, коли набирається > відкриття тега",
  "DESCRIPTION_CLOSE_TAGS_WHEN_CLOSING": "Закрити, коли введено/завершальний тег",
  "DESCRIPTION_CLOSE_TAGS_INDENT_TAGS": "Масив тегів, який при відкритті має порожній рядок",
  "DESCRIPTION_CODE_FOLDING_ALWAY_USE_INDENT_FOLD": "true, щоб завжди створювати складні маркери розділів, коли змінюється рівень відступу",
  "DESCRIPTION_CODE_FOLDING_ENABLED": "true, щоб увімкнути згортання коду",
  "DESCRIPTION_CODE_FOLDING_HIDE_UNTIL_MOUSEOVER": "true, щоб зробити розмітки розділу, що згортаються, видимими лише тоді, коли ви наведете курсор миші на жолоби",
  "DESCRIPTION_CODE_FOLDING_MAX_FOLD_LEVEL": "Обмежує кількість рівнів глибоко Згорнути Все застосовується",
  "DESCRIPTION_CODE_FOLDING_MIN_FOLD_SIZE": "Мінімум рядків перед тим, як з'явиться значок розбірного розділу",
  "DESCRIPTION_CODE_FOLDING_SAVE_FOLD_STATES": "true, щоб запам'ятати згорнуті розділи, якщо ви закриваєте і знову відкриваєте файл або проект",
  "DESCRIPTION_CODE_FOLDING_MAKE_SELECTIONS_FOLDABLE": "true, щоб увімкнути згортання коду на вибраному тексті у редакторі",
  "DESCRIPTION_DISABLED_DEFAULT_EXTENSIONS": "Розширення за замовчуванням, які вимкнено",
  "DESCRIPTION_ATTR_HINTS": "Включення/вимикання HTML атрибут підказки",
  "DESCRIPTION_CSS_PROP_HINTS": "Включення/вимикання CSS/LESS/SCSS властивості підказки",
  "DESCRIPTION_JS_HINTS": "Включення/вимикання підказок коду JavaScript",
  "DESCRIPTION_JS_HINTS_TYPE_DETAILS": "Включення/вимикання відомостей про тип даних у підказках коду JavaScript",
  "DESCRIPTION_PREF_HINTS": "Включення/вимикання підказок коду налаштувань",
  "DESCRIPTION_SPECIAL_CHAR_HINTS": "Включення/вимикання HTML-сутностей підказки",
  "DESCRIPTION_SVG_HINTS": "Включення/вимикання підказок коду SVG",
  "DESCRIPTION_HTML_TAG_HINTS": "Включення/вимикання підказок тегів HTML",
  "DESCRIPTION_URL_CODE_HINTS": "Включення/вимикання URL підказки в HTML і CSS/МЕНШЕ/SCSS",
  "DESCRIPTION_DRAG_DROP_TEXT": "Включення/вимикання Drag & Drop функціональність",
  "DESCRIPTION_HEALTH_DATA_TRACKING": "Увімкніть відстеження даних про стан здоров'я",
  "DESCRIPTION_HIGHLIGHT_MATCHES": "Вмикає автоматичне підсвічування відповідних рядків у документі",
  "DESCRIPTION_HIGHLIGHT_MATCHES_SHOW_TOKEN": "Виділити всі рядки, які відповідають маркеру, у якому зараз знаходиться курсор (вибір не потрібен)",
  "DESCRIPTION_HIGHLIGHT_MATCHES_WORDS_ONLY": "Виділіть лише тоді, коли вибір є повним маркером",
  "DESCRIPTION_INSERT_HINT_ON_TAB": "true, щоб вставити поточний вибраний код підказки на вкладці",
  "DESCRIPTION_NO_HINTS_ON_DOT": "правда, щоб не автоматично показувати підказки коду JS, коли. набирається",
  "DESCRIPTION_JSLINT_OPTIONS": "Об'єкт з параметрами за замовчуванням для JSLint",
  "DESCRIPTION_JSLINT_OPTIONS_ASS": "true, щоб дозволити присвоєння вира",
  "DESCRIPTION_JSLINT_OPTIONS_BITWISE": "true, щоб дозволити побітові оператори",
  "DESCRIPTION_JSLINT_OPTIONS_BROWSER": "true, якщо стандартні глобальні переглядачі повинні бути зумовлені",
  "DESCRIPTION_JSLINT_OPTIONS_CLOSURE": "правда, щоб дозволити ідіоми Google Closure",
  "DESCRIPTION_JSLINT_OPTIONS_CONTINUE": "true, щоб дозволити «продовжити» твердження",
  "DESCRIPTION_JSLINT_OPTIONS_COUCH": "true, якщо глобальні значення CouchDB повинні бути заздалегідь визначеними",
  "DESCRIPTION_JSLINT_OPTIONS_DEBUG": "true, щоб дозволити оператори відладчика",
  "DESCRIPTION_JSLINT_OPTIONS_DEVEL": "true, якщо глобальні переглядачі, корисні в розробці, повинні бути зумовлені",
  "DESCRIPTION_JSLINT_OPTIONS_EQEQ": "правда, щоб дозволити == і! =",
  "DESCRIPTION_JSLINT_OPTIONS_ES6": "true, якщо глобальні значення ES6 повинні бути зумовлені",
  "DESCRIPTION_JSLINT_OPTIONS_EVIL": "правда, щоб дозволити eval",
  "DESCRIPTION_JSLINT_OPTIONS_FORIN": "правда, щоб дозволити нефільтроване «для... в»",
  "DESCRIPTION_JSLINT_OPTIONS_INDENT": "Встановити певну ширину табуляції",
  "DESCRIPTION_JSLINT_OPTIONS_MAXERR": "Максимальна кількість попереджень",
  "DESCRIPTION_JSLINT_OPTIONS_MAXLEN": "Максимальна кількість символів у рядку",
  "DESCRIPTION_JSLINT_OPTIONS_NEWCAP": "true, щоб дозволити некапіталізовані конструктори",
  "DESCRIPTION_JSLINT_OPTIONS_NODE": "true, якщо Node.js глобальні значення повинні бути зумовлені",
  "DESCRIPTION_JSLINT_OPTIONS_NOMEN": "true, щоб дозволити зависання підкреслення в ідентифікаторах",
  "DESCRIPTION_JSLINT_OPTIONS_PASSFAIL": "правда, щоб зупинитися на першій помилці",
  "DESCRIPTION_JSLINT_OPTIONS_PLUSPLUS": "правда, щоб дозволити ++ і —",
  "DESCRIPTION_JSLINT_OPTIONS_REGEXP": "правда, щоб дозволити. і [^...]. в RegExp",
  "DESCRIPTION_JSLINT_OPTIONS_RHINO": "true, якщо глобальні Rhino повинні бути зумовлені",
  "DESCRIPTION_JSLINT_OPTIONS_SLOPPY": "правда, щоб дозволити відсутню `використовувати строгій` прагма",
  "DESCRIPTION_JSLINT_OPTIONS_STUPID": "true, якщо можна використовувати методи blocking ('... Sync').",
  "DESCRIPTION_JSLINT_OPTIONS_SUB": "правда, щоб дозволити неефективну підписку",
  "DESCRIPTION_JSLINT_OPTIONS_TODO": "правда, щоб дозволити коментарі TODO",
  "DESCRIPTION_JSLINT_OPTIONS_UNPARAM": "true, щоб дозволити невикористані параметри",
  "DESCRIPTION_JSLINT_OPTIONS_VARS": "true, щоб дозволити більше 1 варів у функції",
  "DESCRIPTION_JSLINT_OPTIONS_WHITE": "true, щоб ігнорувати правила пробілів",
  "DESCRIPTION_LANGUAGE": "Налаштування, специфічні для мови",
  "DESCRIPTION_LANGUAGE_FILE_EXTENSIONS": "Додаткові зіставлення з розширення файлу до назви мови",
  "DESCRIPTION_LANGUAGE_FILE_NAMES": "Додаткові зіставлення від імені файлу до назви мови",
  "DESCRIPTION_LINEWISE_COPY_CUT": "Виконання копіювання та вирізання, коли немає виділення, буде копіювати або вирізати цілі лінії, які мають курсори в них",
  "DESCRIPTION_INPUT_STYLE": "Вибирає спосіб обробки CodeMirror введення і фокусування. Це може бути текстове поле, яке за замовчуванням, або contenteditable, що краще для читання з екрана (нестабільно)",
  "DESCRIPTION_LINTING_ENABLED": "true, щоб увімкнути перевірку коду",
  "DESCRIPTION_ASYNC_TIMEOUT": "Час у мілісекундах, після якого асинхронний лінтер тайм-аут",
  "DESCRIPTION_LINTING_PREFER": "Масив збірів для запуску першим",
  "DESCRIPTION_LIVE_DEV_MULTIBROWSER": "правда, щоб включити експериментальні Live Preview",
  "DESCRIPTION_USE_PREFERED_ONLY": "правда для запуску провайдерів, зазначених у linting.felert only",
  "DESCRIPTION_MAX_CODE_HINTS": "Максимальна кількість підказок коду відображається відразу",
  "DESCRIPTION_PATH": "Конкретні параметри шляху",
  "DESCRIPTION_PROXY": "URL проксі-сервера, який використовується для встановлення розширення",
  "DESCRIPTION_SCROLL_PAST_END": "true, щоб увімкнути прокрутку за межі кінця документа",
  "DESCRIPTION_SHOW_CODE_HINTS": "false, щоб відключити всі підказки коду",
  "DESCRIPTION_SHOW_CURSOR_WHEN_SELECTING": "Зберігає миготливий курсор видимим, коли у вас є виділення тексту",
  "DESCRIPTION_SHOW_LINE_NUMBERS": "true, щоб показати номери рядків у «жолобі» зліва від коду",
  "DESCRIPTION_SMART_INDENT": "Автоматичний відступ при створенні нового блоку",
  "DESCRIPTION_SOFT_TABS": "false, щоб вимкнути поведінку м'яких вкладок",
  "DESCRIPTION_SORT_DIRECTORIES_FIRST": "true, щоб спочатку сортувати каталоги у дереві проекту",
  "DESCRIPTION_SPACE_UNITS": "Кількість пробілів, які слід використовувати для відступів на основі пробілів",
  "DESCRIPTION_STATIC_SERVER_PORT": "Номер порту, який вбудований сервер повинен використовувати для динамічного перегляду",
  "DESCRIPTION_STYLE_ACTIVE_LINE": "true, щоб виділити колір тла рядка, на який знаходиться курсор",
  "DESCRIPTION_TAB_SIZE": "Кількість пробілів для показу вкладок",
  "DESCRIPTION_USE_TAB_CHAR": "true для використання табуляції замість пробілів",
  "DESCRIPTION_UPPERCASE_COLORS": "true для створення шістнадцяткових кольорів у рядковому редакторі кольорів",
  "DESCRIPTION_WORD_WRAP": "Переносити рядки, що перевищують ширину вікна перегляду",
  "DESCRIPTION_SEARCH_AUTOHIDE": "Закрийте пошук, як тільки редактор буде сфокусований",
  "DESCRIPTION_DETECTED_EXCLUSIONS": "Список файлів, які були виявлені, щоб змусити крячок закінчитися з-під контролю",
  "DESCRIPTION_INFERENCE_TIMEOUT": "Кількість часу, через яке крячок буде тайм-аут при спробі розібратися в файлах",
  "DESCRIPTION_SHOW_ERRORS_IN_STATUS_BAR": "true, щоб показати помилки в рядку стану",
  "DESCRIPTION_QUICK_VIEW_ENABLED": "правда, щоб увімкнути швидкий перегляд",
  "DESCRIPTION_EXTENSION_LESS_IMAGE_PREVIEW": "правда, щоб показати попередній перегляд зображень для URL-адрес відсутніх розширень",
  "DESCRIPTION_THEME": "Виберіть тему {APP_NAME}",
  "DESCRIPTION_USE_THEME_SCROLLBARS": "правда, щоб дозволити користувальницькі смуги прокрутки",
  "DESCRIPTION_LINTING_COLLAPSED": "true, щоб згорнути панель підкладки",
  ...
  "DESCRIPTION_FIND_IN_FILES_INSTANT": "правда, щоб увімкнути миттєвий пошук",
  "DESCRIPTION_FONT_SMOOTHING": "Лише для MAC-файлів: «subpixel-згладжування», щоб увімкнути суб-піксельне згладжування або «згладжування» для згладжування шкали сірого",
  "DESCRIPTION_OPEN_PREFS_IN_SPLIT_VIEW": "false, щоб вимкнути відкриття файлу налаштувань у розділеному перегляді",
  "DESCRIPTION_OPEN_USER_PREFS_IN_SECOND_PANE": "false, щоб відкрити файл налаштувань користувача в лівій/верхній панелі",
  "DESCRIPTION_MERGE_PANES_WHEN_LAST_FILE_CLOSED": "true для згортання панелей після закриття останнього файлу з панелі за допомогою кнопки закриття заголовка панелі",
  "DESCRIPTION_SHOW_PANE_HEADER_BUTTONS": "Перемикач показу кнопок закриття та перегляду на заголовку.",
  "DEFAULT_PREFERENCES_JSON_HEADER_COMMENT": "/*\n * Це файл лише для читання з підтримуваними налаштуваннями\n * по {APP_NAME}.\n * Використовуйте цей файл як посилання, щоб змінити свої налаштування\n * Файл «brackets.json» відкритий в іншій панелі.\n * Для отримання додаткової інформації про те, як використовувати налаштування всередині\n * {APP_NAME}, зверніться до веб-сторінки за адресою https://github.com/adobe/brackets/wiki/How-to-Use-Brackets#preferences\n */",
  "DEFAULT_PREFERENCES_JSON_DEFAULT": "Типове",
  ...
  "DESCRIPTION_INDENT_LINE_COMMENT": "true, щоб увімкнути відступ лінійних коментарів",
  "DESCRIPTION_RECENT_FILES_NAV": "Включення/вимикання навігації в останніх файлах",
  "DESCRIPTION_LIVEDEV_WEBSOCKET_PORT": "Порт, на якому WebSocket Server працює для перегляду в режимі реального часу",
  "DESCRIPTION_LIVE_DEV_HIGHLIGHT_SETTINGS": "Live Preview Налаштування Виділіть",
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "false, щоб відключити попередній перегляд зворотного огляду",
  "DOWNLOAD_FAILED": "Не вдалося завантажити файл.",
  "DOWNLOAD_COMPLETE": "Завантажити завершено!",
  "UPDATE_SUCCESSFUL": "Оновлення успішно!",
  "UPDATE_FAILED": "Оновлення зазнало невдачі!",
  "VALIDATION_FAILED": "Перевірка зазнала невдачі!",
  "INITIALISATION_FAILED": "Помилка ініціалізації!",
  "CLEANUP_FAILED": "Очищення не вдалося!",
  "WARNING_TYPE": "Увага!",
  "CLICK_RESTART_TO_UPDATE": "Натисніть кнопку Перезавантажити, щоб оновити дужки.",
  "UPDATE_ON_NEXT_LAUNCH": "Оновлення буде застосовано під час перезапуску.",
  "GO_TO_SITE": "Перейдіть до <a href = \"http://brackets.io/ «> дужки, щоб </a> повторити спробу.",
  ...
  "INITIAL_DOWNLOAD": "Звантаження Оновити...",
  "RETRY_DOWNLOAD": "Не вдалося завантажити файл. Повторне спроби... Спроба ",
  "VALIDATING_INSTALLER": "Завантажити завершено! Перевірка інсталятора...",
  "CHECKSUM_DID_NOT_MATCH": "Контрольна сума не збіглася.",
  "INSTALLER_NOT_FOUND": "Установник не знайдено.",
  ...
  "DESCRIPTION_AUTO_UPDATE": "Включення/вимикання кронштейнів Автоматичне оновлення",
  ...
  "PHP_VERSION_INVALID": "Помилка синтаксичного аналізу версії PHP. Будь ласка, перевірте вихід команди «php —version».",
  "PHP_UNSUPPORTED_VERSION": "Встановіть PHP7 виконання для ввімкнення інструментів, пов'язаних з PHP, таких як підказки коду, підказки параметрів, перехід до визначення та багато іншого. Знайдено версію: {0}",
  "PHP_EXECUTABLE_NOT_FOUND": "Час виконання PHP не знайдено. Встановіть час виконання PHP7 та оновіть «ExecutablePath» у налаштуваннях PHP належним чином. Це дозволяє інструменти, пов'язані з PHP, такі як підказки коду, підказки параметрів, перехід до визначення та багато іншого.",
  "PHP_PROCESS_SPAWN_ERROR": "Код помилки {0} зіткнувся під час запуску процесу PHP.",
  "PHP_SERVER_ERROR_TITLE": "Помилка",
  "PHP_SERVER_MEMORY_LIMIT_INVALID": "Обмеження пам'яті, яке ви вказали, є недійсним. Перегляньте налаштування PHP, щоб встановити правильне значення.",
  "DESCRIPTION_PHP_TOOLING_CONFIGURATION": "Налаштування конфігурації за замовчуванням PHP Tooling",
  "OPEN_PREFERENNCES": "Відкрити налаштування",
  "LANGUAGE_TOOLS_PREFERENCES": "Параметри для мовних інструментів",
  "FIND_ALL_REFERENCES": "Знайти всі посилання",
  "REFERENCES_IN_FILES": "посилання",
  "REFERENCE_IN_FILES": "довідник",
  ...
  "REMOTE_DEBUGGING_ENABLED": "Віддалене налагодження включено на localhost:",
  "REMOTE_DEBUGGING_PORT_INVALID": "Не вдається увімкнути віддалене зневаджування на порту {0}. Номери портів повинні бути між {1} і {2}.",
  "DESCRIPTION_EXTERNAL_APPLICATION_ASSOCIATE": "Відповідності для розширення файлу зовнішнім додаткам. Синтаксис: \"<file_type>«: «<default|ApplicationName|ApplicationPath>», Використовуйте «default» для відкриття файлів у типовій системній програмі для типу файлів.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "Відкрийте графічні файли у зовнішніх редакторах.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "Ваша поточна тека має графічні типи файлів, які не підтримуються {APP_NAME}. <br/>Теперви можете пов'язати певні типи файлів із зовнішніми редакторами. Після зв'язування ви можете відкрити графічні файли, як.xd, .psd, .jpg, .png, .ai, .svg у програмах за замовчуванням, двічі клацнувши на файловому дереві. <br/><br/>Будьласка, натисніть кнопку «Ok», щоб пов'язати типи графічних файлів з відповідними програмами за замовчуванням.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Наступні типи файлів були успішно пов'язані з додатками за замовчуванням. <br/>{0} У вас є можливість змінити ваші уподобання щодо того, видалити/додати нові асоціації типів файлів у дужках.json, перейшовши в меню «Дебют->Відкрити файл налаштувань».",
  "UNSUPPORTED_BROWSER": "Браузер не підтримується",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Браузер не підтримує Відкрити папку",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Будь ласка, використовуйте один з підтримуваних браузерів нижче.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Ми докладаємо всіх зусиль, щоб зробити Phoenix доступним у більшості браузерів. Ви можете закрити цей діалог, але деякі функції у Phoenix не працюватимуть у цьому браузері.",
  "CANNOT_PUBLISH_LARGE_PROJECT": "Неможливо опублікувати великий проект",
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "Фенікс все ще знаходиться в експериментальній альфі. Ми ще не ввімкнули синхронізацію проектів з більш ніж 500 файлами.",
  "SHARE_WEBSITE": "Опублікувати та поділитися веб-сайтом?",
  "PUBLISH": "Опублікувати",
  "PUBLISH_CONSENT_MESSAGE": "Швидко переглядайте зміни та діліться своїм веб-сайтом з іншими. Phoenix може опублікувати цей веб-сайт для вас за адресою {0}. Опубліковані посилання будуть дійсні протягом 7 днів. </br>Вихочете опублікувати та поділитися своїм веб-сайтом?",
  "PUBLISH_SYNC_IN_PROGRESS": "Синхронізація триває для попереднього перегляду...",
  "PUBLISH_PAGE": "Натисніть, щоб опублікувати і поділитися цим сайтом",
  ...
  "BUILD_THE_WEB": "Побудуйте Інтернет",
  "IMPORT_PROJECT": "Імпортувати проект",
  "GITHUB_PROJECT": "Проект Github",
  "NEW_PROJECT_FROM_GITHUB": "Новий проект від Github",
  "GITHUB_REPO_URL": "URL репо Github:",
  "CREATE_PROJECT": "Створити проект",
  "SETTING_UP_PROJECT": "Налаштування проекту",
  "LOCATION": "Розташування:",
  "DOWNLOADING": "Звантаження...",
  "DOWNLOAD_FAILED_MESSAGE": "Переконайтеся, що URL-адреса завантаження дійсна. </br>NB: Оскільки Phoenix знаходиться в альфа, приватні репозиторії та URL-адреси Github розміром більше 25 МБ не допускаються.",
  "PLEASE_SELECT_A_FOLDER": "Будь ласка, виберіть теку...",
  "UNZIP_IN_PROGRESS": "Розпакування файлів...",
  "UNZIP_FAILED": "Помилка: Не вдалося розпакувати.",
  "CONFIRM_REPLACE_TITLE": "Підтвердити заміну",
  "KEEP_BOTH": "Тримайте обидва",
  "EXPLORE": "HTML Ігри",
  "BLOG": "Блог",
  "PHOENIX_DEFAULT_PROJECT": "Типовий проект",
  ...
  "WEBPAGE_HOME_PAGE": "Головна сторінка Макети",
  "WEBPAGE_BLOG": "Блог Сторінка",
  "WEBPAGE_DASHBOARD": "HTML приладової панелі",
