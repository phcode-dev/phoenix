...
define({
  ...
  "CMD_HOMEPAGE": "{APP_NAME} Startpagina",
  ...
  "CMD_ENABLE_SELECTION_VIEW": "Selectie weergave",
  ...
  "DESCRIPTION_SELECTION_VIEW_ENABLED": "true om de selectieweergave in te schakelen",
  ...
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "Phoenix zit nog steeds in experimentele alfa. We hebben de synchronisatie van projecten met meer dan 500 bestanden nog niet ingeschakeld.",
  "SHARE_WEBSITE": "Website publiceren en delen?",
  "PUBLISH": "Publiceren",
  "PUBLISH_CONSENT_MESSAGE": "Bekijk snel een voorbeeld van wijzigingen en deel je website met anderen. Phoenix kan deze website voor je publiceren op {0}. De gepubliceerde links zijn 7 dagen geldig. </br>Wilt u uw website publiceren en delen?",
  "PUBLISH_SYNC_IN_PROGRESS": "Synchronisatie aan de gang voor preview...",
  ...
  "BLOG": "Blog",
  "PHOENIX_DEFAULT_PROJECT": "Standaard project",
  ...
  "WEBPAGE_HOME_PAGE": "Startpagina lay-outs",
  "WEBPAGE_BLOG": "Blog pagina",
  ...
  "BEAUTIFY_ERROR": "Kon de code niet verfraaien. Controleer de syntaxis.",
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Kon niet verfraaien. Tekst van de editor gewijzigd na verfraaiing.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Bestand {0} verfraaien",
  "BEAUTIFY_ERROR_SELECTION": "Kon niet verfraaien. </br>Incompleet codeblok geselecteerd of ongeldige syntaxis.",
  "BEAUTIFY_OPTIONS": "Opties die bepalen hoe Beautify Code werkt",
  "BEAUTIFY_OPTION_PRINT_WIDTH": "Specificeer de lijnlengte waarop de verfraaier zich zal wikkelen",
  "BEAUTIFY_OPTION_SEMICOLON": "Voeg een puntkomma toe aan het einde van elke instructie",
  "BEAUTIFY_OPTION_SINGLE_QUOTE": "Gebruik enkele aanhalingstekens in plaats van dubbele",
  "BEAUTIFY_OPTION_QUOTE_PROPS": "Wijzigen wanneer eigenschappen in objecten worden aangehaald",
  "BEAUTIFY_OPTION_BRACKET_SAME_LINE": "Zet de > van een HTML-element met meerdere regels (HTML, JSX, Vue, Angular) aan het einde van de laatste regel in plaats van alleen op de volgende regel te staan (geldt niet voor zelfsluitende elementen)",
  "BEAUTIFY_OPTION_SINGLE_ATTRIBUTE_PER_LINE": "Eén kenmerk per regel afdwingen in HTML, Vue en JSX",
  "BEAUTIFY_OPTION_PROSE_WRAP": "Verpak proza als het de afdrukbreedte in markdownbestanden overschrijdt",
  "BEAUTIFY_OPTION_PRINT_TRAILING_COMMAS": "Druk waar mogelijk achterliggende komma's af in syntactische structuren met meerdere regels, gescheiden door komma's"
});