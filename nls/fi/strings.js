...
define({
  ...
  "ERROR_MOVING_FILE_TITLE": "Virhe siirrettäessä {0}",
  "ERROR_MOVING_FILE": "Virhe yritettäessä siirtää {2} <span class='dialog-filename'>{0}</span>. {1}",
  "ERROR_MOVING_NOT_IN_PROJECT": "Tiedostoa/kansiota ei voi siirtää, koska ne eivät kuulu nykyiseen projektiin.",
  ...
  "LIVE_DEV_CLICK_POPOUT": "Popout Live Preview uuteen ikkunaan",
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "Pin Unpin Preview Page",
  ...
  "WINDOW_UNLOAD_WARNING": "Haluatko varmasti siirtyä toiseen URL-osoitteeseen ja jättää suluissa?",
  "WINDOW_UNLOAD_WARNING_WITH_UNSAVED_CHANGES": "Sinulla on tallentamattomia muutoksia! Haluatko varmasti siirtyä toiseen URL-osoitteeseen ja jättää suluissa?",
  "DONE": "Valmis",
  "OK": "OK",
  "CANCEL": "Peruuta",
  ...
  "CMD_GOTO_DEFINITION_PROJECT": "Pikahaku määritelmä projektissa",
  ...
  "CMD_OPEN_VIRTUAL_SERVER": "Avaa virtuaalinen palvelin",
  "HELP_MENU": "Ohje",
  ...
  "CMD_HOMEPAGE": "{APP_NAME} Kotisivu",
  ...
  "PRERELEASE_BUILD": "ennakkojulkaisu rakentaa",
  ...
  "ABOUT": "Tietoja",
  "CLOSE": "Sulje",
  "ABOUT_TEXT_LINE1": "Vapauta {VERSION_MAJOR}. {VERSION_MINOR} {BUILD_TYPE} {VERSIO}",
  "ABOUT_TEXT_BUILD_TIMESTAMP": "rakentaa aikaleima: ",
  "ABOUT_TEXT_LINE3": "Kolmannen osapuolen kirjastot, joita käytämme - <a href='https://github.com/phcode-dev/phoenix/tree/main/src/thirdparty/licences'> Lisenssit ja Attribuutiot</a> . ",
  ...
  "ABOUT_TEXT_LINE5": "Valmistettu ❤: lla ja JavaScriptillä:",
  "ABOUT_TEXT_LINE6": "Paljon ihmisiä (mutta meillä on vaikeuksia ladata näitä tietoja juuri nyt).",
  ...
  "CMD_EXTRACTTO_VARIABLE": "Ote muuttujaan",
  "CMD_EXTRACTTO_FUNCTION": "Pura funktioon",
  "ERROR_TERN_FAILED": "Tiernistä ei voi saada tietoja",
  "ERROR_EXTRACTTO_VARIABLE_NOT_VALID": "Valinta ei muodosta lauseketta",
  "ERROR_EXTRACTTO_FUNCTION_NOT_VALID": "Valitun lohkon tulisi edustaa joukko lauseita tai lauseke",
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "Ote muuttujaan ei toimi monikansallisissa",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "Extract to Function ei toimi monikansallisissa",
  ...
  "CMD_REFACTORING_TRY_CATCH": "Kääri sisään Kokeile Catch",
  "CMD_REFACTORING_CONDITION": "Kääri kunnossa",
  "CMD_REFACTORING_GETTERS_SETTERS": "Luo Getters/Setters",
  "CMD_REFACTORING_ARROW_FUNCTION": "Muunna nuolitoiminnoksi",
  "DESCRIPTION_CODE_REFACTORING": "Ota käyttöön/poista käytöstä JavaScript Code Refactoring",
  "ERROR_TRY_CATCH": "Valitse kelvollinen koodi, joka kääritään TRY-Catch-lohkoon",
  "ERROR_WRAP_IN_CONDITION": "Valitse kelvollinen koodi käärittäväksi Ehto-lohkoon",
  "ERROR_ARROW_FUNCTION": "Aseta kohdistin funktion lausekkeen sisään",
  "ERROR_GETTERS_SETTERS": "Kohdistimen sijoittaminen objektin lausekkeen jäsenen kohdalle",
  "ERROR_RENAME_MULTICURSOR": "Ei voi nimetä uudelleen, kun käytät usean kohdistimen",
  ...
  "ERROR_RENAME_GENERAL": "Ei voi nimetä uudelleen valittua tekstiä",
  "JSHINT_NAME": "JShint",
  ...
  "DESCRIPTION_DISABLED_DEFAULT_EXTENSIONS": "Oletuslaajennukset, jotka ovat poissa",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "Objekti, jolla on JShintin oletusasetukset. Katso seuraava URL-osoite kaikista käytettävissä olevista JShint-vaihtoehdoista: https://jshint.com/docs/options/",
  ...
  "DESCRIPTION_SEARCH_AUTOHIDE": "Sulje haku heti, kun editori on keskittynyt",
  ...
  "DESCRIPTION_SELECTION_VIEW_ENABLED": "true, jotta valintanäkymä otetaan käyttöön",
  ...
  "DESCRIPTION_LIVEDEV_ENABLE_REVERSE_INSPECT": "vääriä poistaa live preview reverse tarkastaa",
  "DOWNLOAD_FAILED": "Lataus epäonnistui.",
  "DOWNLOAD_COMPLETE": "Lataa valmis!",
  ...
  "CLICK_RESTART_TO_UPDATE": "Päivitä suluissa valitsemalla Käynnistä uudelleen.",
  "UPDATE_ON_NEXT_LAUNCH": "Päivitys otetaan käyttöön uudelleenkäynnistyksen yhteydessä.",
  "GO_TO_SITE": "Mene <a href = \"http://brackets.io/ ”> brackets.io </a> yrittää uudelleen.",
  ...
  "INITIAL_DOWNLOAD": "Ladataan päivitys...",
  "RETRY_DOWNLOAD": "Lataus epäonnistui. Yritetään uudelleen... Yrittää ",
  "VALIDATING_INSTALLER": "Lataa valmis! Vahvistus Installer...",
  "CHECKSUM_DID_NOT_MATCH": "Tarkistussumma ei täsmää.",
  "INSTALLER_NOT_FOUND": "Asennusohjelmaa ei löydy.",
  "DOWNLOAD_ERROR": "Virhe tapahtui lataamisen aikana.",
  "NETWORK_SLOW_OR_DISCONNECTED": "Verkko on katkaistu tai liian hidas.",
  "RESTART_BUTTON": "Käynnistä",
  "LATER_BUTTON": "Myöhemmin",
  "DESCRIPTION_AUTO_UPDATE": "Ota sulkujen automaattinen päivitys käyttöön/poista se käytöstä",
  ...
  "PHP_VERSION_INVALID": "Virhe jäsentämiseen PHP-versio. Tarkista ”php —version” -komennon lähtö.",
  "PHP_UNSUPPORTED_VERSION": "Asenna PHP7 runtime mahdollistaa PHP liittyvät työkalut, kuten Code Vihjeitä, Parametri Vihjeitä, Jump to Definition ja enemmän. Löydetty versio: {0}",
  "PHP_EXECUTABLE_NOT_FOUND": "PHP runtime ei löytynyt. Asenna PHP7 runtime ja päivittää ”ExecutablePath” PHP Asetukset asianmukaisesti. Tämä mahdollistaa PHP-työkalujen, kuten koodivinkit, parametrivihjeet, Jump to Definition ja paljon muuta.",
  "PHP_PROCESS_SPAWN_ERROR": "Virhekoodi {0} havaittu käynnistettäessä PHP prosessi.",
  "PHP_SERVER_ERROR_TITLE": "Virhe",
  "PHP_SERVER_MEMORY_LIMIT_INVALID": "Antamasi muistirajoitus on virheellinen. Tarkista PHP-asetukset asettamaan oikea arvo.",
  ...
  "FIND_ALL_REFERENCES": "Etsi kaikki viitteet",
  "REFERENCES_IN_FILES": "viittaukset",
  "REFERENCE_IN_FILES": "viite",
  "REFERENCES_NO_RESULTS": "Nykyiselle kohdistimen sijainnille ei ole käytettävissä viitteitä",
  "CMD_FIND_DOCUMENT_SYMBOLS": "Etsi asiakirjan symboleja",
  "CMD_FIND_PROJECT_SYMBOLS": "Etsi projektin symboleja",
  "REMOTE_DEBUGGING_ENABLED": "Etävirheenkorjaus käytössä localhostissa:",
  "REMOTE_DEBUGGING_PORT_INVALID": "Etävirheenkorjausta ei voi ottaa käyttöön portissa {0}. Porttinumeroiden tulee olla välillä {1} ja {2}.",
  "DESCRIPTION_EXTERNAL_APPLICATION_ASSOCIATE": "Mappings varten tiedostopääte ulkoisiin sovelluksiin. Syntax: \"<file_type>”: ”<Default|ApplicationName|ApplicationPath>”, Käytä ”oletus” avataksesi tiedostoja tiedostotyypin järjestelmän oletussovelluksessa.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "Avaa graafiset tiedostot ulkoisissa toimittajissa.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "Nykyisessä kansiossasi on graafisia tiedostotyyppejä, joita {APP_NAME} ei tue. <br/>Voitnyt liittää tiettyjä tiedostotyyppejä ulkoisiin toimittajiin. Kun se on liittynyt, voit avata graafisia tiedostoja, kuten.xd, .psd, .jpg, .png, .ai, .svg niiden oletussovelluksissa kaksoisnapsauttamalla tiedostoja File Tree. <br/><br/>Napsauta'Ok' -painiketta yhdistääksesi graafiset tiedostotyypit niiden oletussovelluksiin.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "Seuraavat tiedostotyypit on liitetty onnistuneesti oletussovelluksiin. <br/>{0} Sinulla on mahdollisuus muuttaa asetuksiasi siitä, poistatko tai lisäätkö uusia tiedostotyyppiyhdistyksiä suluissa.json siirtymällä ”Debug->Avaa Asetukset-tiedosto” -valikkoon.",
  "UNSUPPORTED_BROWSER": "Selainta ei tueta",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Selain ei tue Avaa kansio",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Käytä yhtä alla olevista tuetuista selaimista.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Teemme kovasti töitä saadaksemme Phoenixin saataville useammissa selaimissa. Voit sulkea tämän vuoropuhelun, mutta jotkut Phoenixin ominaisuudet eivät toimi tässä selaimessa.",
  "CANNOT_PUBLISH_LARGE_PROJECT": "Suurta projektia ei julkaista",
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "Phoenix on edelleen kokeellisessa alfassa. Emme ole vielä ottaneet käyttöön synkronointia projekteissa, joissa on yli 500 tiedostoa.",
  "SHARE_WEBSITE": "Julkaise ja jaa verkkosivusto?",
  "PUBLISH": "Julkaise",
  "PUBLISH_CONSENT_MESSAGE": "Esikatsele muutoksia nopeasti ja jaa verkkosivustosi muiden kanssa. Phoenix voi julkaista tämän verkkosivuston sinulle osoitteessa {0}. Julkaistut linkit ovat voimassa 7 päivää. </br>Haluatkojulkaista ja jakaa verkkosivustosi?",
  "PUBLISH_SYNC_IN_PROGRESS": "Synkronoi käynnissä esikatselua varten...",
  "PUBLISH_PAGE": "Klikkaa julkaista ja jakaa tämän sivuston",
  "PUBLISH_VIEW_PAGE": "Napsauta nähdäksesi julkaistun sivun",
  "MISSING_FIELDS": "puuttuvat kentät",
  "PLEASE_FILL_ALL_REQUIRED": "Täytä kaikki pakolliset kentät, jotka on korostettu punaisella",
  ...
  "GITHUB_REPO_URL": "Github Repo Verkko-osoite:",
  ...
  "UNZIP_FAILED": "Virhe: Unzipping epäonnistui.",
  "CONFIRM_REPLACE_TITLE": "Vahvista Vaihda",
  "KEEP_BOTH": "Pidä molemmat",
  "EXPLORE": "HTML-pelit",
  "BLOG": "blogi",
  "PHOENIX_DEFAULT_PROJECT": "Oletus Project",
  ...
  "WEBPAGE_HOME_PAGE": "Etusivu Layouts",
  "WEBPAGE_BLOG": "Blogi Sivu",
  ...
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Ei voinut kaunistaa. Editorin teksti muuttui kaunistamisen jälkeen.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Kaunistava tiedosto {0}",
  "BEAUTIFY_ERROR_SELECTION": "Ei voinut kaunistaa. </br>Epätäydellinenkoodilohko valittu tai virheellinen syntaksi.",
  "BEAUTIFY_OPTIONS": "Vaihtoehdot, jotka ohjaavat kaunistuskoodin toimintaa",
  "BEAUTIFY_OPTION_PRINT_WIDTH": "Määritä viivan pituus, johon kaunistaja kääri",
  "BEAUTIFY_OPTION_SEMICOLON": "Lisää puolipiste jokaisen lauseen loppuun",
  "BEAUTIFY_OPTION_SINGLE_QUOTE": "Käytä yksittäisiä lainausmerkkejä kaksinkertaisten lainausmerkkien sijaan",
  "BEAUTIFY_OPTION_QUOTE_PROPS": "Muuta, kun objektien ominaisuuksia lainataan",
  "BEAUTIFY_OPTION_BRACKET_SAME_LINE": "Laittaa> on multi-line HTML (HTML, JSX, Vue, Kulmikas) elementti lopussa viimeisen rivin sijaan yksin seuraavalla rivillä (ei koske itse sulkeutuvat elementit)",
  "BEAUTIFY_OPTION_SINGLE_ATTRIBUTE_PER_LINE": "Valvoa yksittäinen attribuutti riviä kohti HTML, Vue ja JSX",
  "BEAUTIFY_OPTION_PROSE_WRAP": "Kääri proosaa, jos se ylittää tulostusleveyden markdown-tiedostoissa",
  "BEAUTIFY_OPTION_PRINT_TRAILING_COMMAS": "Tulosta perään pilkkuja mahdollisuuksien mukaan monirivisissä pilkuilla erotetuissa syntaktisissa rakenteissa"
});