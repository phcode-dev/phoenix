...
define({
  ...
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "Phoenix sigue en fase alfa experimental. Aún no hemos habilitado la sincronización de proyectos con más de 500 archivos.",
  "SHARE_WEBSITE": "¿Publicar y compartir sitio web?",
  "PUBLISH": "Publicar",
  "PUBLISH_CONSENT_MESSAGE": "Previsualice rápidamente los cambios y comparta su sitio web con otras personas. Phoenix puede publicar este sitio web para usted en {0}. Los enlaces publicados tendrán una validez de 7 días. </br>¿Desea publicar y compartir su sitio web?",
  "PUBLISH_SYNC_IN_PROGRESS": "Sincronización en curso para vista previa...",
