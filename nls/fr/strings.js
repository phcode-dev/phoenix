...
define({
  ...
  "CANNOT_DUPLICATE_TITLE": "Impossible de dupli",
  ...
  "LIVE_DEV_SELECT_FILE_TO_PREVIEW": "Sélectionnez le fichier à prévisualiser en direct",
  "LIVE_DEV_CLICK_TO_RELOAD_PAGE": "Recharger la page",
  "LIVE_DEV_CLICK_POPOUT": "Afficher l'aperçu en direct dans une nouvelle fenêtre",
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "Épingler sur la page d'aperçu",
  ...
  "FIND_IN_FILES_INDEXING_PROGRESS": "Indexation de {0} de {1} fichiers pour la recherche instantanée...",
  ...
  "CMD_OPEN_VFS": "Système de fichiers virtuel ouvert",
  "CMD_OPEN_VIRTUAL_SERVER": "Serveur virtuel ouvert",
  "HELP_MENU": "Aide",
  ...
  "CMD_HOMEPAGE": "Page d'accueil de {APP_NAME}",
  ...
  "ABOUT_TEXT_LINE4": "Documentation et source à l'<a href='https://github.com/phcode-dev/phoenix/'>adresse https://github.com/phcode-dev/phoenix/</a>",
  "ABOUT_TEXT_LINE5": "Fabriqué avec ❤ et JavaScript par :",
  "ABOUT_TEXT_LINE6": "Beaucoup de personnes (mais nous avons du mal à charger ces données en ce moment).",
  ...
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Le navigateur ne prend pas en charge le dossier ouvert",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Veuillez utiliser l'un des navigateurs pris en charge ci-dessous.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Nous travaillons d'arrache-pied pour rendre Phoenix disponible dans davantage de navigateurs. Vous pouvez fermer cette boîte de dialogue, mais certaines fonctionnalités de Phoenix ne fonctionneront pas dans ce navigateur.",
  "CANNOT_PUBLISH_LARGE_PROJECT": "Impossible de publier un projet volumineux",
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "Phoenix est toujours en phase alpha expérimentale. Nous n'avons pas encore activé la synchronisation des projets contenant plus de 500 fichiers.",
  "SHARE_WEBSITE": "Publier et partager un site Web ?",
  "PUBLISH": "Publier",
  "PUBLISH_CONSENT_MESSAGE": "Prévisualisez rapidement les modifications et partagez votre site Web avec d'autres personnes. Phoenix peut publier ce site Web pour vous à l'adresse {0}. Les liens publiés seront valables pendant une période de 7 jours. </br>Vous souhaitez publier et partager votre site Web ?",
  ...
  "BUILD_THE_WEB": "Construisez le Web",
  ...
  "WEBPAGE_HOME_PAGE": "Mises en page d'accueil",
  "WEBPAGE_BLOG": "Page du blog",
