...
define({
  ...
  "UNSUPPORTED_UTF16_ENCODING_ERR": "{APP_NAME} attualmente non supporta i file di testo codificati UTF-16.",
  ...
  "ERROR_RENAMING_NOT_IN_PROJECT": "Il file o la directory non fanno parte del progetto attualmente aperto. Sfortunatamente, solo i file di progetto possono essere rinominati a questo punto.",
  "ERROR_MOVING_FILE_TITLE": "Errore durante lo spostamento {0}",
  ...
  "LIVE_DEV_SELECT_FILE_TO_PREVIEW": "Seleziona file per l'anteprima dal vivo",
  "LIVE_DEV_CLICK_TO_RELOAD_PAGE": "Pagina Reload",
  "LIVE_DEV_CLICK_POPOUT": "Visualizza l'anteprima dal vivo in una nuova finestra",
  "LIVE_DEV_CLICK_TO_PIN_UNPIN": "Aggiungi alla pagina di anteprima di Unpin",
  ...
  "WINDOW_UNLOAD_WARNING": "Sei sicuro di voler passare a un URL diverso e lasciare Brackets?",
  "WINDOW_UNLOAD_WARNING_WITH_UNSAVED_CHANGES": "Hai modifiche non salvate! Sei sicuro di voler passare a un URL diverso e lasciare Brackets?",
  "DONE": "Fatto",
  "OK": "OK",
  "CANCEL": "Annulla",
  ...
  "CMD_FILE_OPEN": "Apri…",
  "CMD_RECENT_FILES_OPEN": "Apri recente...",
  ...
  "CMD_NAVIGATE_BACKWARD": "Navigazione all'indietro",
  ...
  "CMD_SWITCH_PANE_FOCUS": "Attivazione riquadro di commutazione",
  ...
  "CMD_HOMEPAGE": "Home page di {APP_NAME}",
  ...
  "ABOUT": "Informazioni",
  "CLOSE": "Chiudi",
  "ABOUT_TEXT_LINE1": "Rilascia {VERSION_MAJOR} {VERSION_MINOR} {BUILD_TYPE} {VERSIONE}",
  "ABOUT_TEXT_BUILD_TIMESTAMP": "timestamp di compilazione: ",
  ...
  "ABOUT_TEXT_LINE4": "Documentazione e fonte all'indirizzo <a href='https://github.com/phcode-dev/phoenix/'>https://github.com/phcode-dev/phoenix/</a>",
  "ABOUT_TEXT_LINE5": "Realizzato con ❤ e JavaScript da:",
  "ABOUT_TEXT_LINE6": "Molte persone (ma stiamo riscontrando problemi nel caricare quei dati in questo momento).",
  ...
  "SORT_EXTENSION_METHOD": "Ordinare le estensioni utilizzando DownloadCount o PublishedDate",
  ...
  "NPM_INSTALL_FAILED": "comando npm install non riuscito: {0}",
  ...
  "ERROR_EXTRACTTO_VARIABLE_MULTICURSORS": "Extract to Variable non funziona nei multicursori",
  "ERROR_EXTRACTTO_FUNCTION_MULTICURSORS": "Extract to Function non funziona nei multicursori",
  ...
  "CMD_REFACTORING_TRY_CATCH": "Avvolgi in Prova cattura",
  "CMD_REFACTORING_CONDITION": "Condizione avvolgente",
  "CMD_REFACTORING_GETTERS_SETTERS": "Crea getter/setter",
  "CMD_REFACTORING_ARROW_FUNCTION": "Funzione Converti in freccia",
  "DESCRIPTION_CODE_REFACTORING": "Abilita/disabilita il refactoring del codice JavaScript",
  "ERROR_TRY_CATCH": "Seleziona un codice valido da avvolgere in un blocco Try-catch",
  "ERROR_WRAP_IN_CONDITION": "Seleziona un codice valido da racchiudere in un blocco Condition",
  "ERROR_ARROW_FUNCTION": "Posiziona il cursore all'interno di un'espressione funzione",
  ...
  "CMD_ENABLE_SELECTION_VIEW": "Vista selezione",
  ...
  "RECENT_FILES_DLG_CLEAR_BUTTON_TITLE": "Cancella i file non presenti nel Working Set",
  ...
  "DESCRIPTION_DISABLED_DEFAULT_EXTENSIONS": "Estensioni predefinite disattivate",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "Un oggetto con le opzioni predefinite per JSHint. Consultare il seguente URL per tutte le opzioni JSHint disponibili: https://jshint.com/docs/options/",
  ...
  "DESCRIPTION_LINEWISE_COPY_CUT": "Copia e taglia quando non c'è selezione copierà o taglierà tutte le linee che contengono cursori",
  "DESCRIPTION_INPUT_STYLE": "Seleziona il modo in cui CodeMirror gestisce input e focus. Può essere textarea, che è l'impostazione predefinita, o contenteditable che è meglio per gli screen reader (unstable)",
  ...
  "DESCRIPTION_SEARCH_AUTOHIDE": "Chiudi la ricerca non appena l'editor è concentrato",
  ...
  "DESCRIPTION_SELECTION_VIEW_ENABLED": "true per abilitare la vista di selezione",
  ...
  "DESCRIPTION_LIVEDEV_WEBSOCKET_PORT": "Porta su cui viene eseguito WebSocket Server per Live Preview",
  "DESCRIPTION_LIVE_DEV_HIGHLIGHT_SETTINGS": "Impostazioni evidenziazione anteprima dal vivo",
  ...
  "CLICK_RESTART_TO_UPDATE": "Clicca su Riavvia per aggiornare le parentesi.",
  "UPDATE_ON_NEXT_LAUNCH": "L'aggiornamento verrà applicato al rilancio.",
  ...
  "INITIAL_DOWNLOAD": "Download aggiornamento in corso...",
  "RETRY_DOWNLOAD": "Download non riuscito. Nuovo tentativo... Tentativo ",
  "VALIDATING_INSTALLER": "Download completo! Convalida dell'installatore...",
  "CHECKSUM_DID_NOT_MATCH": "Il checksum non corrispondeva.",
  "INSTALLER_NOT_FOUND": "Installer non trovato.",
  "DOWNLOAD_ERROR": "Errore durante il download.",
  "NETWORK_SLOW_OR_DISCONNECTED": "La rete è disconnessa o è troppo lenta.",
  ...
  "PHP_VERSION_INVALID": "Errore durante l'analisi della versione di PHP. Controlla l'output del comando «php —version».",
  "PHP_UNSUPPORTED_VERSION": "Installa il runtime PHP7 per abilitare gli strumenti relativi a PHP come Code Hints, Parameter Hints, Jump To Definition e altro ancora. Versione trovata: {0}",
  "PHP_EXECUTABLE_NOT_FOUND": "Runtime PHP non trovato. Installare il runtime PHP7 e aggiornare «ExecutablePath» nelle preferenze PHP in modo appropriato. Ciò consente strumenti relativi a PHP come Code Hints, Parameter Hints, Jump To Definition e altro ancora.",
  "PHP_PROCESS_SPAWN_ERROR": "È stato rilevato il codice di errore {0} durante l'avvio del processo PHP.",
  "PHP_SERVER_ERROR_TITLE": "Errore",
  "PHP_SERVER_MEMORY_LIMIT_INVALID": "Il limite di memoria fornito non è valido. Controlla le preferenze PHP per impostare il valore corretto.",
  ...
  "FIND_ALL_REFERENCES": "Trova tutte le referenze",
  ...
  "CMD_FIND_DOCUMENT_SYMBOLS": "Trova simboli documento",
  "CMD_FIND_PROJECT_SYMBOLS": "Trova simboli di progetto",
  ...
  "DESCRIPTION_EXTERNAL_APPLICATION_ASSOCIATE": "Mapping per l'estensione di file ad applicazioni esterne. Sintassi: \"<file_type>«: «<default|ApplicationName|ApplicationPath>», Usa «default» per aprire i file nell'applicazione predefinita di sistema per il tipo di file.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_TITLE": "Apri file grafici in editor esterni.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_MSG": "La tua cartella attuale ha tipi di file grafici che non sono supportati da {APP_NAME}. <br/>Ora è possibile associare tipi di file specifici a editor esterni. Una volta associati, è possibile aprire file grafici come .xd, .psd, .jpg, .png, .ai, .svg nelle loro applicazioni predefinite facendo doppio clic sui file nell'albero dei file. <br/><br/>Fare clic sul pulsante «OK» per associare i tipi di file grafici alle rispettive applicazioni predefinite.",
  "ASSOCIATE_GRAPHICS_FILE_TO_DEFAULT_APP_CNF_MSG": "I seguenti tipi di file sono stati associati con successo alle applicazioni predefinite. <br/>{0} Hai la possibilità di modificare le tue preferenze sull'eliminazione/aggiunta di nuove associazioni di tipi di file in brackets.json andando al menu «Debug-> Apri file delle preferenze».",
  "UNSUPPORTED_BROWSER": "Il browser non è supportato",
  "UNSUPPORTED_BROWSER_OPEN_FOLDER": "Il browser non supporta la cartella Apri",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE1": "Utilizzare uno dei browser supportati di seguito.",
  "UNSUPPORTED_BROWSER_MESSAGE_LINE2": " Stiamo lavorando duramente per rendere Phoenix disponibile in più browser. Puoi chiudere questa finestra di dialogo, ma alcune funzionalità di Phoenix non funzioneranno in questo browser.",
  "CANNOT_PUBLISH_LARGE_PROJECT": "Impossibile pubblicare progetti di grandi dimensioni",
  "CANNOT_PUBLISH_LARGE_PROJECT_MESSAGE": "Phoenix è ancora in fase sperimentale. Non abbiamo ancora abilitato la sincronizzazione di progetti con più di 500 file.",
  "SHARE_WEBSITE": "Pubblicare e condividere il sito Web?",
  "PUBLISH": "Pubblica",
  "PUBLISH_CONSENT_MESSAGE": "Visualizza rapidamente in anteprima le modifiche e condividi il tuo sito web con altri. Phoenix può pubblicare questo sito Web per te all'indirizzo {0}. I link pubblicati saranno validi per un periodo di 7 giorni. </br>Vuoi pubblicare e condividere il tuo sito web?",
  "PUBLISH_SYNC_IN_PROGRESS": "Sincronizzazione in corso per anteprima...",
  ...
  "GITHUB_REPO_URL": "URL Repo Github:",
  "CREATE_PROJECT": "Crea progetto",
  "SETTING_UP_PROJECT": "Impostazione del progetto",
  "LOCATION": "Ubicazione:",
  "DOWNLOADING": "Download in corso...",
  "EXTRACTING_FILES_PROGRESS": "Estrazione di {0} di {1} file.",
  "DOWNLOAD_FAILED_MESSAGE": "Assicurati che l'URL di download sia valido. </br>NB: Poiché Phoenix è in alpha, non sono consentiti repository privati e URL Github più grandi di 25 MB.",
  ...
  "DEFAULT_PROJECT_NOTIFICATION": "Clicca qui per aprire il <b>progetto<br/> predefinito</b> in phoenix. </br><a href='#' style='float:right;'>ok</a>",
  ...
  "LEARN_SECTION": "Impara con esempi",
  "WEBPAGE_HOME_PAGE": "Layout della home page",
  "WEBPAGE_BLOG": "Pagina blog",
  ...
  "BEAUTIFY_ERROR": "Impossibile abbellire il codice. Controllare la sintassi.",
  "BEAUTIFY_ERROR_ORIGINAL_CHANGED": "Non potevo abbellire. Testo dell'editor modificato dopo l'abbellimento.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Abbellire il file {0}",
  "BEAUTIFY_ERROR_SELECTION": "Non potevo abbellire. </br>Blocco di codice incompleto selezionato o sintassi non valida.",
