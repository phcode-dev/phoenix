...
define({
  ...
  "CMD_BEAUTIFY_CODE": "Uljepšajte kod",
  "CMD_BEAUTIFY_CODE_ON_SAVE": "Uljepšati kod na spremanje",
  "FIND_MENU": "Pronađi",
  "CMD_FIND": "Pronađi",
  ...
  "CMD_ENABLE_SELECTION_VIEW": "Prikaz odabira",
  ...
  "DESCRIPTION_JSHINT_OPTIONS": "Objekt sa zadanim opcijama za JShint. Molimo pogledajte sljedeći URL za sve dostupne JShint opcije: https://jshint.com/docs/options/",
  ...
  "DESCRIPTION_SELECTION_VIEW_ENABLED": "istinito za omogućavanje prikaza odabira",
  ...
  "BEAUTIFY_ERROR": "Ne mogu uljepšati kod. Provjerite sintaksu.",
  "BEAUTIFY_PROJECT_BUSY_MESSAGE": "Uljepšavanje datoteke {0}",
  "BEAUTIFY_ERROR_SELECTION": "Ne mogu uljepšati. </br>Odabraniblok koda nepotpuna ili nevažeća sintaksa.",
  "BEAUTIFY_OPTIONS": "Opcije koje kontroliraju kako funkcionira Beautify Code",
  "BEAUTIFY_OPTION_PRINT_WIDTH": "Navedite duljinu linije na koju će uljepšavanje završiti",
  "BEAUTIFY_OPTION_SEMICOLON": "Dodajte točku sa zarezom na kraju svake izjave",
  "BEAUTIFY_OPTION_SINGLE_QUOTE": "Upotrijebite pojedinačne citate umjesto dvostrukih citata",
  "BEAUTIFY_OPTION_QUOTE_PROPS": "Promijenite kada se citiraju svojstva u objektima",
  "BEAUTIFY_OPTION_BRACKET_SAME_LINE": "Staviti> od multi-line HTML (HTML, JSX, Vue, Angular) element na kraju posljednjeg retka umjesto da bude sam na sljedećem retku (ne odnosi se na samo zatvaranje elemenata)",
  "BEAUTIFY_OPTION_SINGLE_ATTRIBUTE_PER_LINE": "Provođenje jednog atributa po retku u HTML, Vue i JSX",
  "BEAUTIFY_OPTION_PROSE_WRAP": "Zamotajte prozu ako prelazi širinu ispisa u datotekama s oznakama",
  "BEAUTIFY_OPTION_PRINT_TRAILING_COMMAS": "Ispiši zareze gdje god je to moguće u sintaktičkim strukturama odvojenim zarezima s više linija"
});