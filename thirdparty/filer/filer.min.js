...
var Buffer = require("buffer").Buffer;
var r=require("buffer").Buffer,e={Object:Object,Array:Array,Function:Function,Number:Number,String:String,Date:Date,RegExp:RegExp};module.exports=function n(t){return void 0!==r&&(e.Buffer=r),"undefined"!=typeof Promise&&(e.Promise=Promise),n.definition={compile:function(r){if("string"==typeof r){var e=i(r);return function(r){return r instanceof e}}var n=r.map(i);return function(r){for(var e=0;e<n.length;e++)if(r instanceof n[e])return!0;return!1}},CONSTRUCTORS:e,metaSchema:{anyOf:[{type:"string"},{type:"array",items:{type:"string"}}]}},t.addKeyword("instanceof",n.definition),t;function i(r){var n=e[r];if(n)return n;throw new Error('invalid "instanceof" keyword value '+r)}};
},{"buffer":"dskh"}],"uBCt":[function(require,module,exports) {
"use strict";module.exports=function e(n){return e.definition={type:"number",macro:function(e,n){var r=e[0],i=e[1],o=n.exclusiveRange;return function(e,n,r){if(void 0!==r&&"boolean"!=typeof r)throw new Error("Invalid schema for exclusiveRange keyword, should be boolean");if(e>n||r&&e==n)throw new Error("There are no numbers in range")}(r,i,o),!0===o?{exclusiveMinimum:r,exclusiveMaximum:i}:{minimum:r,maximum:i}},metaSchema:{type:"array",minItems:2,maxItems:2,items:{type:"number"}}},n.addKeyword("range",e.definition),n.addKeyword("exclusiveRange"),n};
...
"use strict";var e=["number","integer","string","boolean","null"];function r(r,t){return r.map(function(r){var n=t.items&&t.items.properties,i=n&&n[r]&&n[r].type;return Array.isArray(i)?i.indexOf("object")<0&&i.indexOf("array")<0:e.indexOf(i)>=0})}module.exports=function e(t){return e.definition={type:"array",compile:function(e,t,n){var i=n.util.equal,o=r(e,t);return function(r){if(r.length>1)for(var t=0;t<e.length;t++){var n,f=e[t];if(o[t]){var a={};for(n=r.length;n--;)if(r[n]&&"object"==typeof r[n]){var u=r[n][f];if(!u||"object"!=typeof u){if("string"==typeof u&&(u='"'+u),a[u])return!1;a[u]=!0}}}else for(n=r.length;n--;)if(r[n]&&"object"==typeof r[n])for(var p=n;p--;)if(r[p]&&"object"==typeof r[p]&&i(r[n][f],r[p][f]))return!1}return!0}},metaSchema:{type:"array",items:{type:"string"}}},t.addKeyword("uniqueItemProperties",e.definition),t};
},{}],"R4Fp":[function(require,module,exports) {
"use strict";module.exports={metaSchemaRef:t};var e="http://json-schema.org/draft-07/schema";function t(t){var a=t._opts.defaultMeta;return"string"==typeof a?{$ref:a}:t.getSchema(e)?{$ref:e}:(console.warn("meta schema not defined"),{})}
},{}],"kIuQ":[function(require,module,exports) {
"use strict";var e=require("./_util");function r(e,r){for(var i=e.split("/"),o={},n=o,a=1;a<i.length;a++){var p=i[a],s=a==i.length-1;p=t(p);var u=n.properties={},f=void 0;if(/[0-9]+/.test(p)){var c=+p;for(f=n.items=[];c--;)f.push({})}n=s?r:{},u[p]=n,f&&f.push(n)}return o}function t(e){return e.replace(/~1/g,"/").replace(/~0/g,"~")}module.exports=function t(i){return t.definition={type:"object",macro:function(e){var t=[];for(var i in e)t.push(r(i,e[i]));return{allOf:t}},metaSchema:{type:"object",propertyNames:{type:"string",format:"json-pointer"},additionalProperties:e.metaSchemaRef(i)}},i.addKeyword("deepProperties",t.definition),i};
},{"./_util":"R4Fp"}],"KB8y":[function(require,module,exports) {
"use strict";function e(e,t){var r="data"+(t||"");if(!e)return r;for(var n=r,o=e.split("/"),u=1;u<o.length;u++){n+=" && "+(r+=i(a(o[u])))}return n}module.exports=function t(r){return t.definition={type:"object",inline:function(t,r,n){for(var i="",a=0;a<n.length;a++)a&&(i+=" && "),i+="("+e(n[a],t.dataLevel)+" !== undefined)";return i},metaSchema:{type:"array",items:{type:"string",format:"json-pointer"}}},r.addKeyword("deepRequired",t.definition),r};var t=/^[a-z$_][a-z$_0-9]*$/i,r=/^[0-9]+$/,n=/'|\\/g;function i(e){return r.test(e)?"["+e+"]":t.test(e)?"."+e:"['"+e.replace(n,"\\$&")+"']"}function a(e){return e.replace(/~1/g,"/").replace(/~0/g,"~")}
},{}],"KeB4":[function(require,module,exports) {
"use strict";module.exports=function(e,a,r){var t=" ",s=e.level,o=e.dataLevel,i=e.schema[a],l=e.schemaPath+e.util.getProperty(a),u=e.errSchemaPath+"/"+a,d=!e.opts.allErrors,m="data"+(o||""),f="valid"+s;if(t+="var "+f+" = undefined;",!1===e.opts.format)return t+=" "+f+" = true; ";var n=e.schema.format,h=e.opts.$data&&n.$data,c="";if(h){t+=" var "+(v="format"+s)+" = formats["+e.util.getData(n.$data,o,e.dataPathArr)+"] , "+(p="compare"+s)+" = "+v+" && "+v+".compare;"}else{var v;if(!(v=e.formats[n])||!v.compare)return t+="  "+f+" = true; ";var p="formats"+e.util.getProperty(n)+".compare"}var g,P="formatMaximum"==a,E="formatExclusive"+(P?"Maximum":"Minimum"),x=e.schema[E],y=e.opts.$data&&x&&x.$data,S=P?"<":">",$="result"+s,Q=e.opts.$data&&i&&i.$data;if(Q?(t+=" var schema"+s+" = "+e.util.getData(i.$data,o,e.dataPathArr)+"; ",g="schema"+s):g=i,y){var b=e.util.getData(x.$data,o,e.dataPathArr),w="exclusive"+s,A="' + "+(M="op"+s)+" + '";t+=" var schemaExcl"+s+" = "+b+"; ",t+=" if (typeof "+(b="schemaExcl"+s)+" != 'boolean' && "+b+" !== undefined) { "+f+" = false; ";var D=E;(k=k||[]).push(t),t="",!1!==e.createErrors?(t+=" { keyword: '"+(D||"_formatExclusiveLimit")+"' , dataPath: (dataPath || '') + "+e.errorPath+" , schemaPath: "+e.util.toQuotedString(u)+" , params: {} ",!1!==e.opts.messages&&(t+=" , message: '"+E+" should be boolean' "),e.opts.verbose&&(t+=" , schema: validate.schema"+l+" , parentSchema: validate.schema"+e.schemaPath+" , data: "+m+" "),t+=" } "):t+=" {} ";var L=t;t=k.pop(),!e.compositeRule&&d?e.async?t+=" throw new ValidationError(["+L+"]); ":t+=" validate.errors = ["+L+"]; return false; ":t+=" var err = "+L+";  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; ",t+=" }  ",d&&(c+="}",t+=" else { "),Q&&(t+=" if ("+g+" === undefined) "+f+" = true; else if (typeof "+g+" != 'string') "+f+" = false; else { ",c+="}"),h&&(t+=" if (!"+p+") "+f+" = true; else { ",c+="}"),t+=" var "+$+" = "+p+"("+m+",  ",t+=Q?""+g:""+e.util.toQuotedString(i),t+=" ); if ("+$+" === undefined) "+f+" = false; var "+w+" = "+b+" === true; if ("+f+" === undefined) { "+f+" = "+w+" ? "+$+" "+S+" 0 : "+$+" "+S+"= 0; } if (!"+f+") var op"+s+" = "+w+" ? '"+S+"' : '"+S+"=';"}else{A=S;(w=!0===x)||(A+="=");var M="'"+A+"'";Q&&(t+=" if ("+g+" === undefined) "+f+" = true; else if (typeof "+g+" != 'string') "+f+" = false; else { ",c+="}"),h&&(t+=" if (!"+p+") "+f+" = true; else { ",c+="}"),t+=" var "+$+" = "+p+"("+m+",  ",t+=Q?""+g:""+e.util.toQuotedString(i),t+=" ); if ("+$+" === undefined) "+f+" = false; if ("+f+" === undefined) "+f+" = "+$+" "+S,w||(t+="="),t+=" 0;"}t+=c+"if (!"+f+") { ";var k;D=a;(k=k||[]).push(t),t="",!1!==e.createErrors?(t+=" { keyword: '"+(D||"_formatLimit")+"' , dataPath: (dataPath || '') + "+e.errorPath+" , schemaPath: "+e.util.toQuotedString(u)+" , params: { comparison: "+M+", limit:  ",t+=Q?""+g:""+e.util.toQuotedString(i),t+=" , exclusive: "+w+" } ",!1!==e.opts.messages&&(t+=" , message: 'should be "+A+' "',t+=Q?"' + "+g+" + '":""+e.util.escapeQuotes(i),t+="\"' "),e.opts.verbose&&(t+=" , schema:  ",t+=Q?"validate.schema"+l:""+e.util.toQuotedString(i),t+="         , parentSchema: validate.schema"+e.schemaPath+" , data: "+m+" "),t+=" } "):t+=" {} ";L=t;return t=k.pop(),!e.compositeRule&&d?e.async?t+=" throw new ValidationError(["+L+"]); ":t+=" validate.errors = ["+L+"]; return false; ":t+=" var err = "+L+";  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; ",t+="}"};
},{}],"mYD7":[function(require,module,exports) {
"use strict";var t=/^(\d\d):(\d\d):(\d\d)(\.\d+)?(z|[+-]\d\d:\d\d)?$/i,e=/t|\s/i,i={date:n,time:o,"date-time":d},r={type:"object",required:["$data"],properties:{$data:{type:"string",anyOf:[{format:"relative-json-pointer"},{format:"json-pointer"}]}},additionalProperties:!1};function a(t){var e=t._formats;for(var r in i){var a=e[r];("object"!=typeof a||a instanceof RegExp||!a.validate)&&(a=e[r]={validate:a}),a.compare||(a.compare=i[r])}}function n(t,e){if(t&&e)return t>e?1:t<e?-1:t===e?0:void 0}function o(e,i){if(e&&i&&(e=e.match(t),i=i.match(t),e&&i))return(e=e[1]+e[2]+e[3]+(e[4]||""))>(i=i[1]+i[2]+i[3]+(i[4]||""))?1:e<i?-1:e===i?0:void 0}function d(t,i){if(t&&i){t=t.split(e),i=i.split(e);var r=n(t[0],i[0]);if(void 0!==r)return r||o(t[1],i[1])}}module.exports=function(t){var e="format"+t;return function i(n){return i.definition={type:"string",inline:require("./dotjs/_formatLimit"),statements:!0,errors:"full",dependencies:["format"],metaSchema:{anyOf:[{type:"string"},r]}},n.addKeyword(e,i.definition),n.addKeyword("formatExclusive"+t,{dependencies:["format"+t],metaSchema:{anyOf:[{type:"boolean"},r]}}),a(n),n}};
},{"./dotjs/_formatLimit":"KeB4"}],"J927":[function(require,module,exports) {
"use strict";module.exports=require("./_formatLimit")("Minimum");
},{"./_formatLimit":"mYD7"}],"dgLz":[function(require,module,exports) {
"use strict";module.exports=require("./_formatLimit")("Maximum");
},{"./_formatLimit":"mYD7"}],"OTUE":[function(require,module,exports) {
"use strict";module.exports=function(e,r,a){var t=" ",s=e.level,o=e.dataLevel,h=e.schema[r],i=e.schemaPath+e.util.getProperty(r),l=e.errSchemaPath+"/"+r,v=!e.opts.allErrors,n="data"+(o||""),d="valid"+s,p="key"+s,c="idx"+s,u="patternMatched"+s,m="dataProperties"+s,P="",f=e.opts.ownProperties;t+="var "+d+" = true;",f&&(t+=" var "+m+" = undefined;");var g=h;if(g)for(var y,E=-1,k=g.length-1;E<k;){y=g[E+=1],t+=" var "+u+" = false;  ",t+=f?" "+m+" = "+m+" || Object.keys("+n+"); for (var "+c+"=0; "+c+"<"+m+".length; "+c+"++) { var "+p+" = "+m+"["+c+"]; ":" for (var "+p+" in "+n+") { ",t+=" "+u+" = "+e.usePattern(y)+".test("+p+"); if ("+u+") break; } ";var b=e.util.escapeQuotes(y);t+=" if (!"+u+") { "+d+" = false;  var err =   ",!1!==e.createErrors?(t+=" { keyword: 'patternRequired' , dataPath: (dataPath || '') + "+e.errorPath+" , schemaPath: "+e.util.toQuotedString(l)+" , params: { missingPattern: '"+b+"' } ",!1!==e.opts.messages&&(t+=" , message: 'should have property matching pattern \\'"+b+"\\'' "),e.opts.verbose&&(t+=" , schema: validate.schema"+i+" , parentSchema: validate.schema"+e.schemaPath+" , data: "+n+" "),t+=" } "):t+=" {} ",t+=";  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; }   ",v&&(P+="}",t+=" else { ")}return t+=""+P};
},{}],"u2zM":[function(require,module,exports) {
"use strict";module.exports=function e(t){return e.definition={type:"object",inline:require("./dotjs/patternRequired"),statements:!0,errors:"full",metaSchema:{type:"array",items:{type:"string",format:"regex"},uniqueItems:!0}},t.addKeyword("patternRequired",e.definition),t};
},{"./dotjs/patternRequired":"OTUE"}],"mlCb":[function(require,module,exports) {
"use strict";module.exports=function(e,r,a){var s=" ",t=e.level,o=e.dataLevel,h=e.schema[r],l=e.schemaPath+e.util.getProperty(r),i=e.errSchemaPath+"/"+r,c=!e.opts.allErrors,v="data"+(o||""),n="valid"+t,d="errs__"+t,m=e.util.copy(e),p="";m.level++;var u,f="valid"+m.level,P="ifPassed"+e.level,E=m.baseId;s+="var "+P+";";var w=h;if(w)for(var y,b=-1,g=w.length-1;b<g;){if(y=w[b+=1],b&&!u&&(s+=" if (!"+P+") { ",p+="}"),y.if&&(e.opts.strictKeywords?"object"==typeof y.if&&Object.keys(y.if).length>0:e.util.schemaHasRules(y.if,e.RULES.all))){s+=" var "+d+" = errors;   ";var R=e.compositeRule;if(e.compositeRule=m.compositeRule=!0,m.createErrors=!1,m.schema=y.if,m.schemaPath=l+"["+b+"].if",m.errSchemaPath=i+"/"+b+"/if",s+="  "+e.validate(m)+" ",m.baseId=E,m.createErrors=!0,e.compositeRule=m.compositeRule=R,s+=" "+P+" = "+f+"; if ("+P+") {  ","boolean"==typeof y.then){if(!1===y.then){(I=I||[]).push(s),s="",!1!==e.createErrors?(s+=" { keyword: 'switch' , dataPath: (dataPath || '') + "+e.errorPath+" , schemaPath: "+e.util.toQuotedString(i)+" , params: { caseIndex: "+b+" } ",!1!==e.opts.messages&&(s+=" , message: 'should pass \"switch\" keyword validation' "),e.opts.verbose&&(s+=" , schema: validate.schema"+l+" , parentSchema: validate.schema"+e.schemaPath+" , data: "+v+" "),s+=" } "):s+=" {} ";var S=s;s=I.pop(),!e.compositeRule&&c?e.async?s+=" throw new ValidationError(["+S+"]); ":s+=" validate.errors = ["+S+"]; return false; ":s+=" var err = "+S+";  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; "}s+=" var "+f+" = "+y.then+"; "}else m.schema=y.then,m.schemaPath=l+"["+b+"].then",m.errSchemaPath=i+"/"+b+"/then",s+="  "+e.validate(m)+" ",m.baseId=E;s+="  } else {  errors = "+d+"; if (vErrors !== null) { if ("+d+") vErrors.length = "+d+"; else vErrors = null; } } "}else if(s+=" "+P+" = true;  ","boolean"==typeof y.then){if(!1===y.then){var I;(I=I||[]).push(s),s="",!1!==e.createErrors?(s+=" { keyword: 'switch' , dataPath: (dataPath || '') + "+e.errorPath+" , schemaPath: "+e.util.toQuotedString(i)+" , params: { caseIndex: "+b+" } ",!1!==e.opts.messages&&(s+=" , message: 'should pass \"switch\" keyword validation' "),e.opts.verbose&&(s+=" , schema: validate.schema"+l+" , parentSchema: validate.schema"+e.schemaPath+" , data: "+v+" "),s+=" } "):s+=" {} ";S=s;s=I.pop(),!e.compositeRule&&c?e.async?s+=" throw new ValidationError(["+S+"]); ":s+=" validate.errors = ["+S+"]; return false; ":s+=" var err = "+S+";  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; "}s+=" var "+f+" = "+y.then+"; "}else m.schema=y.then,m.schemaPath=l+"["+b+"].then",m.errSchemaPath=i+"/"+b+"/then",s+="  "+e.validate(m)+" ",m.baseId=E;u=y.continue}return s+=p+"var "+n+" = "+f+";"};
...
function r(r,n){return i(r)||o(r,n)||e(r,n)||t()}function t(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function e(r,t){if(r){if("string"==typeof r)return n(r,t);var e=Object.prototype.toString.call(r).slice(8,-1);return"Object"===e&&r.constructor&&(e=r.constructor.name),"Map"===e||"Set"===e?Array.from(e):"Arguments"===e||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)?n(r,t):void 0}}function n(r,t){(null==t||t>r.length)&&(t=r.length);for(var e=0,n=new Array(t);e<t;e++)n[e]=r[e];return n}function o(r,t){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(r)){var e=[],n=!0,o=!1,i=void 0;try{for(var a,u=r[Symbol.iterator]();!(n=(a=u.next()).done)&&(e.push(a.value),!t||e.length!==t);n=!0);}catch(l){o=!0,i=l}finally{try{n||null==u.return||u.return()}finally{if(o)throw i}}return e}}function i(r){if(Array.isArray(r))return r}var a=require("schema-utils"),u=a.validate;function l(r,t){u(t,r)}function c(t,e){for(var n={},o=0,i=Object.entries(e);o<i.length;o++){var a=r(i[o],2),u=a[0],l=a[1];n[u]=t[u],void 0===n[u]&&(n[u]=l.default),l.process&&(n[u]=l.process(n[u]))}return n}module.exports={validateOptions:l,processOptions:c};
